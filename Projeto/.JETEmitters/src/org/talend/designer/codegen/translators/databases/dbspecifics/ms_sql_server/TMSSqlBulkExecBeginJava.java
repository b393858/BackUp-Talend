...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_46 = NL + "int deletedCount_";
  protected final String TEXT_47 = "=0;";
  protected final String TEXT_48 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_49 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_51 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_52 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_53 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_54 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_55 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_60 = " - Written records count: \" + nb_line_";
  protected final String TEXT_61 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_62 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_63 = " = new StringBuffer();" + NL + "\t\t\t";
  ...
  protected final String TEXT_68 = " - Writing the record \" + nb_line_";
  protected final String TEXT_69 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_71 = " - Processing the record \" + nb_line_";
  ...
  protected final String TEXT_77 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_78 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_80 = " - Uses an existing connection ";
  protected final String TEXT_81 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_83 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_84 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_86 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_87 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_88 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_131 = NL + "\t" + NL + "\tStringBuffer command_";
  protected final String TEXT_132 = " = new StringBuffer();" + NL + "\tcommand_";
  protected final String TEXT_133 = ".append(";
  protected final String TEXT_134 = ")" + NL + "\t\t.append(\" \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_135 = ")" + NL + "\t\t.append(\"\\\" queryout \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_136 = ")" + NL + "\t\t.append(\"\\\" \")" + NL + "\t\t.append(\"";
  protected final String TEXT_137 = "\")" + NL + "\t";
  protected final String TEXT_138 = NL + "\t\t.append(\" -S\")" + NL + "\t\t.append(";
  protected final String TEXT_139 = ")" + NL + "\t";
  protected final String TEXT_140 = NL + "\t\t.append(\" -T\")" + NL + "\t";
  protected final String TEXT_141 = NL + "\t\t.append(\" -U\")" + NL + "\t\t.append(";
  protected final String TEXT_142 = ")" + NL + "\t\t.append(\" -P\")" + NL + "\t\t.append(decryptedPassword_";
  protected final String TEXT_143 = ")" + NL + "\t";
  protected final String TEXT_144 = NL + "\t\t.append(\" -t\")" + NL + "\t\t.append(";
  protected final String TEXT_145 = ")" + NL + "\t\t.append(\" -r\")" + NL + "\t\t.append(";
  protected final String TEXT_146 = ");" + NL + "\t" + NL + "\tRuntime runtime_";
  protected final String TEXT_147 = " = Runtime.getRuntime();" + NL + "\t";
  protected final String TEXT_148 = NL + "\tfinal Process ps";
  protected final String TEXT_149 = " = runtime_";
  protected final String TEXT_150 = ".exec(command_";
  protected final String TEXT_151 = ".toString());" + NL + "\tThread normal_";
  ...
  protected final String TEXT_153 = ".getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_159 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_160 = ".start();" + NL + "\tThread error_";
  protected final String TEXT_161 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_162 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_165 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_166 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_167 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_169 = ".start();" + NL + "\tps";
  ...
  protected final String TEXT_173 = NL + "\tString dbschema_";
  protected final String TEXT_174 = " = \"\";" + NL + "\t";
  protected final String TEXT_175 = NL + "java.sql.Connection conn_";
  protected final String TEXT_176 = " = null;";
  protected final String TEXT_177 = NL + "String dbUser_";
  protected final String TEXT_178 = " = null;";
  protected final String TEXT_179 = NL + "\tdbschema_";
  ...
  protected final String TEXT_186 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_189 = ".get(dsAlias_";
  protected final String TEXT_190 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_191 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_192 = " = dataSources_";
  protected final String TEXT_193 = ".get(dsAlias_";
  protected final String TEXT_194 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_195 = NL + "    dbschema_";
  protected final String TEXT_196 = " = ";
  protected final String TEXT_197 = ";";
  protected final String TEXT_198 = NL + "    String driverClass_";
  protected final String TEXT_199 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_200 = NL + "    String driverClass_";
  protected final String TEXT_201 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_202 = NL + "\t";
  protected final String TEXT_203 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_204 = ");" + NL + "    String port_";
  protected final String TEXT_205 = " = ";
  protected final String TEXT_206 = ";" + NL + "    String dbname_";
  protected final String TEXT_207 = " = ";
  protected final String TEXT_208 = " ;";
  protected final String TEXT_209 = NL + "    String url_";
  protected final String TEXT_210 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_211 = " ;";
  protected final String TEXT_212 = NL + "    String url_";
  protected final String TEXT_213 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_214 = " ;";
  protected final String TEXT_215 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_216 = ")) {" + NL + "    \turl_";
  protected final String TEXT_217 = " += \":\" + ";
  protected final String TEXT_218 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_219 = ")) {";
  protected final String TEXT_220 = NL + "\t\t\t\turl_";
  protected final String TEXT_221 = " += \"//\" + ";
  protected final String TEXT_222 = "; " + NL + "\t";
  protected final String TEXT_223 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_224 = " += \";databaseName=\" + ";
  protected final String TEXT_225 = "; " + NL + "\t";
  protected final String TEXT_226 = NL + "    }" + NL + "    url_";
  protected final String TEXT_227 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_228 = ";" + NL + "    dbUser_";
  protected final String TEXT_229 = " = ";
  protected final String TEXT_230 = ";" + NL;
  protected final String TEXT_231 = NL;
  protected final String TEXT_232 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_233 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_234 = ");";
  protected final String TEXT_235 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_236 = " = ";
  protected final String TEXT_237 = "; ";
  protected final String TEXT_238 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_248 = NL + "\tString tableName_";
  protected final String TEXT_249 = " = null;\t" + NL + "\tif(dbschema_";
  protected final String TEXT_250 = " == null || dbschema_";
  protected final String TEXT_251 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_252 = " = ";
  protected final String TEXT_253 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  protected final String TEXT_254 = " = dbschema_";
  protected final String TEXT_255 = " + \"].[\" + ";
  protected final String TEXT_256 = ";" + NL + "\t}" + NL + "\t";
  protected final String TEXT_257 = "\t" + NL + "\t\t";
  protected final String TEXT_258 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_259 = " = conn_";
  protected final String TEXT_260 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_261 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_262 = " - Droping table ";
  protected final String TEXT_263 = "\" + tableName_";
  ...
  protected final String TEXT_270 = " - Drop table ";
  protected final String TEXT_271 = "\" + tableName_";
  protected final String TEXT_272 = " + \"";
  protected final String TEXT_273 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_275 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_279 = " - Creating table ";
  protected final String TEXT_280 = "\" + tableName_";
  ...
  protected final String TEXT_287 = " - Create table ";
  ...
  protected final String TEXT_339 = ".equalsIgnoreCase(";
  protected final String TEXT_340 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_341 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_342 = ") || dbschema_";
  protected final String TEXT_343 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_344 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_354 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_355 = " = rsTable_";
  protected final String TEXT_356 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_357 = ".equals(";
  protected final String TEXT_358 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_359 = ".equals(schema_";
  protected final String TEXT_360 = ") || (schema_";
  protected final String TEXT_361 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_362 = ".equalsIgnoreCase(bkSchema_";
  protected final String TEXT_363 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_364 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_365 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_370 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_371 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_372 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_373 = " == null || dbschema_";
  protected final String TEXT_374 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_375 = " = conn_";
  protected final String TEXT_376 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_377 = " = stmtSchema_";
  protected final String TEXT_378 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_379 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_380 = " = rsSchema_";
  protected final String TEXT_381 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_382 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_383 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_384 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_385 = " = rsTable_";
  protected final String TEXT_386 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_387 = " = rsTable_";
  protected final String TEXT_388 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_389 = ".equals";
  protected final String TEXT_390 = "IgnoreCase";
  protected final String TEXT_391 = "(";
  protected final String TEXT_392 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  ...
  protected final String TEXT_396 = ") || ((dbschema_";
  protected final String TEXT_397 = " ==null || dbschema_";
  protected final String TEXT_398 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_405 = NL + "            \tString tableForSearch_";
  protected final String TEXT_406 = " = ";
  protected final String TEXT_407 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_408 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_409 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_410 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_411 = " =  tableForSearch_";
  protected final String TEXT_412 = ".substring(1,tableForSearch_";
  protected final String TEXT_413 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_414 = " =  tableForSearch_";
  protected final String TEXT_415 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_419 = ".getTables(null, conn_";
  protected final String TEXT_420 = ".getSchema(), tableForSearch_";
  protected final String TEXT_421 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_422 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_423 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_424 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_425 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_427 = " = conn_";
  protected final String TEXT_428 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_429 = " = dbMetaData_";
  protected final String TEXT_430 = ".getTables(null, dbschema_";
  protected final String TEXT_431 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_432 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_433 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_434 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  protected final String TEXT_435 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_436 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_437 = ".close();";
  protected final String TEXT_438 = NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_439 = " = conn_";
  protected final String TEXT_440 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_441 = " = dbMetaData_";
  protected final String TEXT_442 = ".getTables(";
  protected final String TEXT_443 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_444 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_445 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_446 = " = rsTable_";
  protected final String TEXT_447 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  protected final String TEXT_448 = ".equals";
  protected final String TEXT_449 = "IgnoreCase";
  protected final String TEXT_450 = "(";
  protected final String TEXT_451 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_452 = " = true;" + NL + "                    break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_453 = ".close();";
  protected final String TEXT_454 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_455 = " = conn_";
  protected final String TEXT_456 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_457 = " = dbMetaData_";
  protected final String TEXT_458 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_459 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_460 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_461 = " = rsTable_";
  protected final String TEXT_462 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_463 = ".equals";
  protected final String TEXT_464 = "IgnoreCase";
  protected final String TEXT_465 = "(";
  protected final String TEXT_466 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_467 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_468 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_469 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_470 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_474 = " - Creating table ";
  protected final String TEXT_475 = "\" + tableName_";
  ...
  protected final String TEXT_482 = " - Create table ";
  ...
  protected final String TEXT_487 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_488 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_489 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_492 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_493 = " - Droping table ";
  protected final String TEXT_494 = "\" + tableName_";
  protected final String TEXT_495 = " + \"";
  protected final String TEXT_496 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_497 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_498 = ".execute(\"";
  protected final String TEXT_499 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_500 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_501 = " - Drop table ";
  protected final String TEXT_502 = "\" + tableName_";
  ...
  protected final String TEXT_510 = " - Creating table ";
  protected final String TEXT_511 = "\" + tableName_";
  protected final String TEXT_512 = " + \"";
  protected final String TEXT_513 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_514 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_515 = ".execute(\"";
  protected final String TEXT_516 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_517 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_518 = " - Create table ";
  protected final String TEXT_519 = "\" + tableName_";
  protected final String TEXT_520 = " + \"";
  protected final String TEXT_521 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_522 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_523 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_524 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_525 = " = conn_";
  protected final String TEXT_526 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_527 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_528 = " - Clearing table ";
  protected final String TEXT_529 = "\" + tableName_";
  protected final String TEXT_530 = " + \"";
  protected final String TEXT_531 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_532 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_536 = "- Clear table ";
  protected final String TEXT_537 = "\" + tableName_";
  protected final String TEXT_538 = " + \"";
  protected final String TEXT_539 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_540 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_541 = ".close();" + NL + "\t\t";
  protected final String TEXT_542 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_543 = " = conn_";
  protected final String TEXT_544 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_545 = " = stmtTruncCount_";
  protected final String TEXT_546 = ".executeQuery(\"";
  protected final String TEXT_547 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_551 = " - Trancating table ";
  ...
  protected final String TEXT_559 = " - Truncate table ";
  protected final String TEXT_560 = "\" + tableName_";
  protected final String TEXT_561 = " + \"";
  protected final String TEXT_562 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_563 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_564 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_565 = " += rsTruncCount_";
  protected final String TEXT_566 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_567 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_568 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_569 = ".close();" + NL + "\t\t";
  protected final String TEXT_570 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_571 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_572 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_573 = NL + "    \t";
  protected final String TEXT_574 = NL + "    \t\tjava.sql.Statement stmtBulkInsert_";
  protected final String TEXT_575 = " = conn_";
  protected final String TEXT_576 = ".createStatement();" + NL + "    \t\tString bulkSQL_";
  protected final String TEXT_577 = " = \"BULK INSERT ";
  protected final String TEXT_578 = "\" + tableName_";
  protected final String TEXT_579 = " + \"";
  protected final String TEXT_580 = " FROM '\" + ";
  protected final String TEXT_581 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_582 = " + \"',DATAFILETYPE='";
  protected final String TEXT_583 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_584 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_585 = " + ";
  protected final String TEXT_586 = "\",FIRE_TRIGGERS\" + ";
  protected final String TEXT_587 = " \",ROWTERMINATOR='\" + ";
  protected final String TEXT_588 = "+\"')\";" + NL + "    \t\t";
  protected final String TEXT_589 = NL + "    \t\t\tlog.debug(\"";
  protected final String TEXT_590 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_591 = "+\".\");" + NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_592 = " - Bulk inserting data into ";
  protected final String TEXT_593 = "\" + tableName_";
  protected final String TEXT_594 = " + \"";
  protected final String TEXT_595 = ".\" );" + NL + "    \t\t";
  protected final String TEXT_596 = NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_597 = ".execute(bulkSQL_";
  protected final String TEXT_598 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_599 = ".close();" + NL + "    \t\t";
  protected final String TEXT_600 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_601 = " - Bulk insert data into ";
  protected final String TEXT_602 = "\" + tableName_";
  protected final String TEXT_603 = " + \"";
  protected final String TEXT_604 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_605 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_606 = " = ";
  protected final String TEXT_607 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_608 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_609 = " = tableName_";
  protected final String TEXT_610 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_611 = " = \"tmp_";
  protected final String TEXT_612 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  protected final String TEXT_613 = " = conn_";
  protected final String TEXT_614 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_615 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_616 = " - Creating temp table ";
  protected final String TEXT_617 = "\" + tableName_";
  protected final String TEXT_618 = " + \"";
  protected final String TEXT_619 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_620 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_621 = ".execute(\"";
  protected final String TEXT_622 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_623 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_624 = " - Create temp table ";
  protected final String TEXT_625 = "\" + tableName_";
  protected final String TEXT_626 = " + \"";
  protected final String TEXT_627 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_628 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_629 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_630 = " = conn_";
  protected final String TEXT_631 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_632 = " = \"BULK INSERT ";
  protected final String TEXT_633 = "\" + tableName_";
  protected final String TEXT_634 = " + \"";
  protected final String TEXT_635 = " FROM '\" + ";
  protected final String TEXT_636 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_637 = " + \"',DATAFILETYPE='";
  protected final String TEXT_638 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_639 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_640 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_641 = "+\"')\";" + NL + "    \t\t\t";
  protected final String TEXT_642 = NL + "    \t\t\t\tlog.debug(\"";
  protected final String TEXT_643 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_644 = "+\".\");" + NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_645 = " - Bulk inserting data into ";
  protected final String TEXT_646 = "\" + tableName_";
  protected final String TEXT_647 = " + \"";
  protected final String TEXT_648 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_649 = NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_650 = ".execute(bulkSQL_";
  protected final String TEXT_651 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_652 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_653 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_654 = " - Bulk insert data into ";
  protected final String TEXT_655 = "\" + tableName_";
  protected final String TEXT_656 = " + \"";
  protected final String TEXT_657 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_658 = NL + "    \t\t\ttableName_";
  protected final String TEXT_659 = " = tmpTableName_";
  protected final String TEXT_660 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_661 = " = \"tmp_";
  protected final String TEXT_662 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_663 = " = conn_";
  protected final String TEXT_664 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_665 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_666 = " - Updating ";
  protected final String TEXT_667 = "\" + tableName_";
  protected final String TEXT_668 = " + \"";
  protected final String TEXT_669 = " from ";
  protected final String TEXT_670 = "\"+tmpTableName_";
  protected final String TEXT_671 = "+\"";
  protected final String TEXT_672 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_673 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_674 = ".executeUpdate(\"";
  protected final String TEXT_675 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_676 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_677 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_678 = " = \"tmp_";
  protected final String TEXT_679 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_680 = " = conn_";
  protected final String TEXT_681 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_682 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_683 = " - Droping temp table ";
  protected final String TEXT_684 = "\" + tableName_";
  protected final String TEXT_685 = " + \"";
  protected final String TEXT_686 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_687 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_688 = ".execute(\"";
  protected final String TEXT_689 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_690 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_691 = " - Drop temp table ";
  protected final String TEXT_692 = "\" + tableName_";
  protected final String TEXT_693 = "+ \"";
  protected final String TEXT_694 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_695 = NL + "    \t\t\tstmtTmpDrop_";
  ...
  protected final String TEXT_699 = ".isClosed()) {" + NL + "\t\t   ";
...
boolean fire_triggers = ("true").equals(ElementParameterParser.getValue(node, "__FIRE_TRIGGERS__"));
