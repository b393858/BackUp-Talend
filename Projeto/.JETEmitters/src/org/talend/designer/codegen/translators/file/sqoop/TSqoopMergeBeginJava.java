...
public class TSqoopMergeBeginJava
{
  ...
  protected final String TEXT_246 = ".set(\"mapreduce.application.classpath\", \"";
  protected final String TEXT_247 = "\");";
  protected final String TEXT_248 = NL + "\t\tconfiguration_";
  protected final String TEXT_249 = ".set(\"yarn.application.classpath\", \"";
  protected final String TEXT_250 = "\");";
  protected final String TEXT_251 = NL + "\t\t\tconfiguration_";
  protected final String TEXT_252 = ".set(\"mapreduce.map.memory.mb\", ";
  protected final String TEXT_253 = ");" + NL + "\t\t\tconfiguration_";
  protected final String TEXT_254 = ".set(\"mapreduce.reduce.memory.mb\", ";
  protected final String TEXT_255 = ");" + NL + "\t\t\tconfiguration_";
  protected final String TEXT_256 = ".set(\"yarn.app.mapreduce.am.resource.mb\", ";
  protected final String TEXT_257 = ");";
  protected final String TEXT_258 = NL + "\t\tconfiguration_";
  protected final String TEXT_259 = ".set(\"mapred.job.tracker\", ";
  protected final String TEXT_260 = ");";
  protected final String TEXT_261 = NL + "        configuration_";
  protected final String TEXT_262 = ".set(\"mapred.job.map.memory.mb\", ";
  protected final String TEXT_263 = ");" + NL + "        configuration_";
  protected final String TEXT_264 = ".set(\"mapred.job.reduce.memory.mb\", ";
  protected final String TEXT_265 = ");";
  protected final String TEXT_266 = NL + "\t\t\tconfiguration_";
  protected final String TEXT_267 = ".set(";
  protected final String TEXT_268 = " ,";
  protected final String TEXT_269 = ");";
  protected final String TEXT_270 = NL + "\t\tconfiguration_";
  protected final String TEXT_271 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_272 = ");";
  protected final String TEXT_273 = NL + "\t\t\tconfiguration_";
  protected final String TEXT_274 = ".set(\"mapreduce.jobtracker.kerberos.principal\", ";
  protected final String TEXT_275 = ");";
  protected final String TEXT_276 = NL + "\t\t\tconfiguration_";
  protected final String TEXT_277 = ".set(\"yarn.resourcemanager.principal\", ";
  protected final String TEXT_278 = ");" + NL + "\t\t\tconfiguration_";
  protected final String TEXT_279 = ".set(\"mapreduce.jobhistory.principal\", ";
  ...
  protected final String TEXT_293 = ");" + NL + "            com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_294 = " = new com.mapr.login.client.MapRLoginHttpsClient();";
  protected final String TEXT_295 = NL + "                System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_296 = ");";
  protected final String TEXT_297 = NL + "                maprLogin_";
  protected final String TEXT_298 = ".setCheckUGI(false);";
  protected final String TEXT_299 = " " + NL + "                final String decryptedMapRPassword_";
  protected final String TEXT_300 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_301 = ");";
  protected final String TEXT_302 = NL + "                final String decryptedMapRPassword_";
  protected final String TEXT_303 = " = ";
  protected final String TEXT_304 = "; ";
  protected final String TEXT_305 = NL;
  protected final String TEXT_306 = NL + "            \tmaprLogin_";
  protected final String TEXT_307 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_308 = ", ";
  protected final String TEXT_309 = ", decryptedMapRPassword_";
  protected final String TEXT_310 = ", ";
  protected final String TEXT_311 = ", \"\");" + NL + "            \t";
  protected final String TEXT_312 = NL + "            \tmaprLogin_";
  protected final String TEXT_313 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_314 = ", ";
  protected final String TEXT_315 = ", decryptedMapRPassword_";
  protected final String TEXT_316 = ", ";
  protected final String TEXT_317 = ");" + NL + "            \t";
  protected final String TEXT_318 = NL + "        configuration_";
  protected final String TEXT_319 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_320 = NL + "\t//check whether we can connect to the fs?" + NL + "\torg.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_321 = " = org.apache.hadoop.fs.FileSystem.get(configuration_";
  protected final String TEXT_322 = ");" + NL + "\tString jarFileName_";
  protected final String TEXT_323 = " = ";
  protected final String TEXT_324 = ";";
  protected final String TEXT_325 = NL + "        com.cloudera.sqoop.SqoopOptions needGenereateJarSqoopOptions_";
  protected final String TEXT_326 = " = new com.cloudera.sqoop.SqoopOptions(configuration_";
  protected final String TEXT_327 = ");" + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_328 = ".setConnectString(";
  protected final String TEXT_329 = "); // __CONNECTION__" + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_330 = ".setUsername(";
  protected final String TEXT_331 = ");" + NL + "        if((";
  protected final String TEXT_332 = " != null) && !\"\".equals(";
  protected final String TEXT_333 = ")) {" + NL + "        \tcom.cloudera.sqoop.metastore.JobData jobData_";
  protected final String TEXT_334 = " = new com.cloudera.sqoop.metastore.JobData(needGenereateJarSqoopOptions_";
  protected final String TEXT_335 = ", null);" + NL + "        \torg.apache.sqoop.manager.DefaultManagerFactory defaultManagerFactory_";
  protected final String TEXT_336 = " = new org.apache.sqoop.manager.DefaultManagerFactory();" + NL + "        \tif(null == defaultManagerFactory_";
  protected final String TEXT_337 = ".accept(jobData_";
  protected final String TEXT_338 = ")) {" + NL + "        \t\tneedGenereateJarSqoopOptions_";
  protected final String TEXT_339 = ".setDriverClassName(";
  protected final String TEXT_340 = ");//driver class name" + NL + "        \t}" + NL + "        }";
  protected final String TEXT_341 = NL + "        ";
  protected final String TEXT_342 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_343 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_344 = ");";
  protected final String TEXT_345 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_346 = " = ";
  protected final String TEXT_347 = "; ";
  protected final String TEXT_348 = NL + "\t\t        " + NL + "        " + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_349 = ".setPassword(decryptedPassword_";
  protected final String TEXT_350 = ");" + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_351 = ".setTableName(";
  protected final String TEXT_352 = ");";
  protected final String TEXT_353 = NL + "            needGenereateJarSqoopOptions_";
  protected final String TEXT_354 = ".setClassName(";
  protected final String TEXT_355 = ");";
  protected final String TEXT_356 = NL + "            needGenereateJarSqoopOptions_";
  protected final String TEXT_357 = ".setClassName(\"SqoopMerge_";
  protected final String TEXT_358 = "\");";
  protected final String TEXT_359 = NL + NL + "\tjava.util.Properties generateJarAdditionalProperties_";
  protected final String TEXT_360 = " = new java.util.Properties();" + NL + "\t";
  protected final String TEXT_361 = NL + "\t\tgenerateJarAdditionalProperties_";
  protected final String TEXT_362 = ".put(\"customtool.options.jsonmap\", \"{\\\"\\\":\\\"\\\"}\");" + NL + "" + NL + "\t";
  protected final String TEXT_363 = " " + NL + "                    generateJarAdditionalProperties_";
  protected final String TEXT_364 = ".put(";
  protected final String TEXT_365 = ", \"\"+";
  protected final String TEXT_366 = ".codePointAt(0)); ";
  protected final String TEXT_367 = " " + NL + "                    generateJarAdditionalProperties_";
  protected final String TEXT_368 = ".put(";
  protected final String TEXT_369 = ", ";
  protected final String TEXT_370 = "); ";
  protected final String TEXT_371 = NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_372 = ".loadProperties(generateJarAdditionalProperties_";
  protected final String TEXT_373 = ");" + NL + "        " + NL + "        com.cloudera.sqoop.tool.CodeGenTool codeGen_";
  protected final String TEXT_374 = " = new com.cloudera.sqoop.tool.CodeGenTool();" + NL + "        com.cloudera.sqoop.Sqoop codeGenerator_";
  protected final String TEXT_375 = " = new com.cloudera.sqoop.Sqoop(codeGen_";
  protected final String TEXT_376 = ",configuration_";
  protected final String TEXT_377 = ", needGenereateJarSqoopOptions_";
  protected final String TEXT_378 = ");" + NL + "        " + NL + "\t\ttry {" + NL + "\t\t\tint ret_";
  protected final String TEXT_379 = " = com.cloudera.sqoop.Sqoop.runSqoop(codeGenerator_";
  protected final String TEXT_380 = ", new String[0]);" + NL + "       \tif (0 != ret_";
  protected final String TEXT_381 = ") {";
  protected final String TEXT_382 = NL + "\t\t\t\t\tthrow new Exception(\"The Sqoop jar generation has failed with the following code:\" + ret_";
  protected final String TEXT_383 = ");";
  protected final String TEXT_384 = NL + "\t\t\t\t\tSystem.err.println(\"The Sqoop jar generation has failed with the following code:\" + ret_";
  protected final String TEXT_385 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_387 = " - The Sqoop jar generation has failed with the following code:\" + ret_";
  protected final String TEXT_388 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_389 = NL + "        \t}" + NL + "        " + NL + "        List<String> jars_";
  protected final String TEXT_390 = " = codeGen_";
  protected final String TEXT_391 = ".getGeneratedJarFiles();" + NL + "        jarFileName_";
  protected final String TEXT_392 = " = jars_";
  protected final String TEXT_393 = ".get(0);" + NL + "\t\t} catch (Exception e) {";
  protected final String TEXT_394 = NL + "\t\t\t\tthrow e;";
  ...
  protected final String TEXT_399 = NL + NL + "    java.net.URLClassLoader sysloader_";
  protected final String TEXT_400 = " = (java.net.URLClassLoader) ClassLoader.getSystemClassLoader();" + NL + "    java.lang.reflect.Method method_";
  protected final String TEXT_401 = " = java.net.URLClassLoader.class.getDeclaredMethod(\"addURL\", new Class[] { java.net.URL.class});" + NL + "    method_";
  protected final String TEXT_402 = ".setAccessible(true);" + NL + "    try {" + NL + "\t\tmethod_";
  protected final String TEXT_403 = ".invoke(sysloader_";
  protected final String TEXT_404 = ", new Object[] { new java.io.File(jarFileName_";
  protected final String TEXT_405 = ").toURL()});" + NL + "    } catch (Exception e) {";
  protected final String TEXT_406 = NL + "\t\t\tthrow e;";
  protected final String TEXT_407 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_409 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_410 = NL + "    }" + NL + "    " + NL + "    com.cloudera.sqoop.tool.SqoopTool sqoopTool_";
  protected final String TEXT_411 = " = com.cloudera.sqoop.tool.SqoopTool.getTool(\"merge\");" + NL + "" + NL + "    com.cloudera.sqoop.SqoopOptions sqoopOptions_";
  protected final String TEXT_412 = " = new com.cloudera.sqoop.SqoopOptions(configuration_";
  protected final String TEXT_413 = ");" + NL + "" + NL + "\tsqoopOptions_";
  protected final String TEXT_414 = ".setMergeOldPath(";
  protected final String TEXT_415 = ");" + NL + "\tsqoopOptions_";
  protected final String TEXT_416 = ".setMergeNewPath(";
  protected final String TEXT_417 = ");" + NL + "\tsqoopOptions_";
  protected final String TEXT_418 = ".setMergeKeyCol(";
  protected final String TEXT_419 = ");" + NL + "\tsqoopOptions_";
  protected final String TEXT_420 = ".setTargetDir(";
  protected final String TEXT_421 = "); ";
  protected final String TEXT_422 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_423 = ".setClassName(";
  protected final String TEXT_424 = ");";
  protected final String TEXT_425 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_426 = ".setClassName(\"SqoopMerge_";
  protected final String TEXT_427 = "\");";
  protected final String TEXT_428 = NL + "\t\t" + NL + "\torg.apache.sqoop.Sqoop sqoop_";
  protected final String TEXT_429 = " = new org.apache.sqoop.Sqoop(sqoopTool_";
  protected final String TEXT_430 = ", configuration_";
  protected final String TEXT_431 = ", sqoopOptions_";
  protected final String TEXT_432 = ");" + NL + "\ttry {" + NL + "\t\tint result_";
  protected final String TEXT_433 = " = sqoop_";
  protected final String TEXT_434 = ".run(null);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_435 = "_EXIT_CODE\", result_";
  protected final String TEXT_436 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_437 = " != 0) {";
  protected final String TEXT_438 = NL + "\t\t\t\tthrow new Exception(\"The Sqoop merge job has failed. Please check the logs.\");";
  protected final String TEXT_439 = NL + "\t\t\t\tSystem.err.println(\"The Sqoop merge job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_440 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_441 = " - The Sqoop merge job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_442 = NL + "\t\t}" + NL + "\t} catch (Exception e) {";
  protected final String TEXT_443 = NL + "\t\t\tthrow e;";
  protected final String TEXT_444 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_445 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_446 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_447 = NL + "\t}" + NL + "\t" + NL + "\t";
  protected final String TEXT_448 = NL + "String currentClientPathSeparator_";
  protected final String TEXT_449 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_450 = "!=null) {" + NL + "\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_451 = ");" + NL + "\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_452 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_453 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_454 = "!=null) {" + NL + "\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_455 = ");" + NL + "\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_456 = "\", null);" + NL + "} else {" + NL + "\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
