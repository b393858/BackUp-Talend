...
public class TTeradataRollbackMainJava
{
  ...
  protected final String TEXT_123 = "\");" + NL + "" + NL + "if(conn_";
  protected final String TEXT_124 = " != null && !conn_";
  protected final String TEXT_125 = ".isClosed()) {";
  ...
  protected final String TEXT_135 = NL + "                    System.err.println(e.getMessage());" + NL + "             }";
