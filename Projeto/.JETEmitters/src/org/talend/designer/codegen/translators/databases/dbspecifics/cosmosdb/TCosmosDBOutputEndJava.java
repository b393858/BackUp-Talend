...
public class TCosmosDBOutputEndJava
{
  protected static String nl;
  public static synchronized TCosmosDBOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBOutputEndJava result = new TCosmosDBOutputEndJava();
    nl = null;
    return result;
  }
