...
public class TSasOutputMainJava {
  ...
  protected final String TEXT_117 = ".errorMessage = e.getMessage();";
  protected final String TEXT_118 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_119 = NL + "            }";
  protected final String TEXT_120 = NL + "                    ";
  protected final String TEXT_121 = NL + "            int checkCount_";
  protected final String TEXT_122 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_123 = " = pstmt_";
  protected final String TEXT_124 = ".executeQuery() {" + NL + "                while(rs_";
  protected final String TEXT_125 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_126 = " = rs_";
  protected final String TEXT_127 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_138 = "_QUERY\", query_";
  protected final String TEXT_139 = ".toString().trim());";
  ...
  protected final String TEXT_161 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_162 = NL + "                            ";
  protected final String TEXT_163 = ".errorMessage = e.getMessage();";
  protected final String TEXT_164 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_191 = NL + "                        \tnb_line_rejected_";
  protected final String TEXT_192 = "++;";
  protected final String TEXT_193 = NL + "                            ";
  protected final String TEXT_194 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_195 = NL + "                            ";
  protected final String TEXT_196 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_214 = ".executeUpdate();" + NL + "                if(updateFlag_";
  protected final String TEXT_215 = " != 0) {" + NL + "            \t\tnb_line_";
  protected final String TEXT_216 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_217 = NL + "                }" + NL + "                updatedCount_";
  protected final String TEXT_218 = " = updatedCount_";
  protected final String TEXT_219 = " + updateFlag_";
  protected final String TEXT_220 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_231 = NL + "                        nb_line_rejected_";
  protected final String TEXT_232 = "++;";
  protected final String TEXT_233 = NL + "                        ";
  protected final String TEXT_234 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_235 = NL + "                        ";
  protected final String TEXT_236 = ".errorMessage = e.getMessage();";
  protected final String TEXT_237 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_238 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_239 = " == 0) {" + NL + "            \t";
  protected final String TEXT_240 = NL + "\t\t\t\tquery_";
  protected final String TEXT_241 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_270 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_271 = NL + "                            ";
  protected final String TEXT_272 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_282 = NL + "            try {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_305 = ".errorMessage = e.getMessage();";
  protected final String TEXT_306 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_307 = NL + "            }";
  protected final String TEXT_308 = NL + "            if(!whetherReject_";
  protected final String TEXT_309 = ") {";
  protected final String TEXT_310 = NL + "                            ";
  protected final String TEXT_311 = " = new ";
  protected final String TEXT_312 = "Struct();";
  ...
  protected final String TEXT_319 = NL + "                commitCounter_";
  protected final String TEXT_320 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_321 = " <= commitCounter_";
  protected final String TEXT_322 = ") {" + NL + "    \t\t\t\t";
  protected final String TEXT_323 = NL + "                    connection_";
  protected final String TEXT_324 = ".commit();";
