...
public class TKafkaOutputBeginJava
{
  ...
  protected final String TEXT_50 = "_kafkaProducer);" + NL + "}" + NL + "" + NL + "final java.util.Set<Exception> ";
  protected final String TEXT_51 = "_producerExceptions = java.util.Collections.newSetFromMap(new java.util.concurrent.ConcurrentHashMap<Exception, Boolean>());" + NL + "final int ";
  protected final String TEXT_52 = "_EXCEPTION_CATCH_TIMEOUT = 5;" + NL + "int ";
  protected final String TEXT_53 = "_counter_send = 0;" + NL + "final java.util.concurrent.atomic.AtomicInteger ";
  protected final String TEXT_54 = "_counter_rev = new java.util.concurrent.atomic.AtomicInteger();";
