...
public class TSAPHanaConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_34 = " + \":\" + ";
  protected final String TEXT_35 = " ;" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_36 = " = ";
  protected final String TEXT_37 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_38 = " != null && dbProperties_";
  protected final String TEXT_39 = ".trim().length() > 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_40 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_41 = " + \":\" + ";
  protected final String TEXT_42 = " + \"/?\" + dbProperties_";
  protected final String TEXT_43 = ";" + NL + "\t\t\t}";
  protected final String TEXT_44 = NL + "\t\t\tglobalMap.put(\"dbschema_\" + \"";
  ...
  protected final String TEXT_164 = NL + NL + "\tglobalMap.put(\"conn_";
