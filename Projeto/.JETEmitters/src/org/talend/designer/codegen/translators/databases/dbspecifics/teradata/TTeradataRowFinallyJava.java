...
public class TTeradataRowFinallyJava
{
  protected static String nl;
  public static synchronized TTeradataRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataRowFinallyJava result = new TTeradataRowFinallyJava();
    nl = null;
    return result;
  }
