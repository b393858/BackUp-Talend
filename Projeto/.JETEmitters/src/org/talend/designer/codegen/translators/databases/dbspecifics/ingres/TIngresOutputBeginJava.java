...
public class TIngresOutputBeginJava {
  ...
  protected final String TEXT_59 = " = false;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_60 = " = 0;" + NL;
  protected final String TEXT_61 = NL + "       int batchSize_";
  protected final String TEXT_62 = " = ";
  protected final String TEXT_63 = ";" + NL + "       int batchSizeCounter_";
  ...
  protected final String TEXT_80 = NL + "\tjava.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "\t";
  protected final String TEXT_81 = NL + "\tString url_";
  protected final String TEXT_82 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_106 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_107 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_110 = " = conn_";
  protected final String TEXT_111 = ".createStatement()) {";
  protected final String TEXT_112 = NL + "                stmtDrop_";
  ...
  protected final String TEXT_119 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_128 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_129 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_130 = " = dbMetaData_";
  protected final String TEXT_131 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_137 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_147 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_153 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_160 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_161 = " = conn_";
  protected final String TEXT_162 = ".createStatement()) {";
  protected final String TEXT_163 = NL + "                deletedCount_";
  protected final String TEXT_164 = " = deletedCount_";
  protected final String TEXT_165 = " + stmtClear_";
  protected final String TEXT_166 = ".executeUpdate(\"";
  protected final String TEXT_167 = "\");";
  protected final String TEXT_168 = NL + "            }";
  protected final String TEXT_169 = NL + "\t    String insert_";
  protected final String TEXT_170 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_171 = " + \"\\\" (";
  protected final String TEXT_172 = ") VALUES (";
  protected final String TEXT_173 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".prepareStatement(insert_";
  protected final String TEXT_176 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_177 = "\", pstmt_";
  protected final String TEXT_178 = ");" + NL + "\t    ";
  protected final String TEXT_179 = NL + "\t    String update_";
  protected final String TEXT_180 = " = \"UPDATE \\\"\" + ";
  ...
  protected final String TEXT_185 = ".prepareStatement(update_";
  ...
  protected final String TEXT_193 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_202 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_211 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_223 = ");" + NL + "\t    String insert_";
  protected final String TEXT_224 = " = \"INSERT INTO \\\"\" + ";
  ...
  protected final String TEXT_229 = ".prepareStatement(insert_";
  protected final String TEXT_230 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_231 = "\", pstmtInsert_";
  ...
  protected final String TEXT_275 = " = 0;" + NL + "" + NL + "\t    \t";
