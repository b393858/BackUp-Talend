...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_63 = NL + "\t    try {" + NL + "\t    \tif(pstmt_";
  ...
  protected final String TEXT_67 = ".executeBatch();" + NL + "\t\t\t\t";
  protected final String TEXT_68 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_69 = ".clearBatch();" + NL + "\t\t    \t";
  protected final String TEXT_70 = NL + "\t\t    \tinsertedCount_";
  protected final String TEXT_71 = " +=pstmt_";
  protected final String TEXT_72 = ".getUpdateCount();" + NL + "\t\t    \t";
  protected final String TEXT_73 = NL + "\t\t    \tupdatedCount_";
  protected final String TEXT_74 = " += pstmt_";
  protected final String TEXT_75 = ".getUpdateCount();" + NL + "\t\t    \t";
  protected final String TEXT_76 = NL + "\t\t    \tdeletedCount_";
  protected final String TEXT_77 = " += pstmt_";
  protected final String TEXT_78 = ".getUpdateCount();" + NL + "\t\t    \t";
  protected final String TEXT_79 = NL + "\t\t    }" + NL + "\t    }catch (java.sql.BatchUpdateException e){" + NL + "\t    \t";
  protected final String TEXT_80 = NL + "\t    \t\tthrow(e);" + NL + "\t    \t";
  protected final String TEXT_81 = NL + "\t    \tSystem.err.println(e.getMessage());" + NL + "\t    \t";
  protected final String TEXT_82 = NL + "\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\tthrow(e);" + NL + "\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t\t}" + NL + "\t    ";
  protected final String TEXT_86 = NL + NL + "        if(pstmt_";
  protected final String TEXT_87 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_88 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_89 = "\");" + NL + "        }" + NL + "\t        ";
  protected final String TEXT_90 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_91 = "\", true);";
  protected final String TEXT_92 = NL + "\t\t\tif(commitCounter_";
  protected final String TEXT_93 = " > 0){" + NL + "\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\tconn_";
  protected final String TEXT_95 = ".commit();" + NL + "\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t}" + NL + "    \t\t";
  protected final String TEXT_97 = NL + "\t\t";
  protected final String TEXT_98 = NL + "\t\tconn_";
  protected final String TEXT_99 = " .close();" + NL + "\t\t";
  protected final String TEXT_100 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_101 = "\", true);" + NL + "    \t";
  protected final String TEXT_102 = NL;
  protected final String TEXT_103 = NL + "\tnb_line_deleted_";
  protected final String TEXT_104 = "=nb_line_deleted_";
  protected final String TEXT_105 = "+ deletedCount_";
  protected final String TEXT_106 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_107 = "=nb_line_update_";
  protected final String TEXT_108 = " + updatedCount_";
  protected final String TEXT_109 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_110 = "=nb_line_inserted_";
  protected final String TEXT_111 = " + insertedCount_";
  protected final String TEXT_112 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_113 = "=nb_line_rejected_";
  protected final String TEXT_114 = " + rejectedCount_";
  protected final String TEXT_115 = ";" + NL + "\t";
  protected final String TEXT_116 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_117 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_118 = "_NB_LINE\",nb_line_";
  protected final String TEXT_119 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_120 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_121 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_122 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_123 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_124 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_125 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_126 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_127 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_128 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_129 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_132 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_133 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_134 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_135 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_136 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_137 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_139 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_140 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_141 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_142 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_143 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_144 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_145 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
