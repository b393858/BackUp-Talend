...
public class TAmazonMysqlInputBeginJava
{
  ...
  protected final String TEXT_193 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_194 = " + \":\" + ";
  protected final String TEXT_195 = " + \"/\" + ";
  protected final String TEXT_196 = ";";
  protected final String TEXT_197 = NL + "\t\t\t\tString url_";
  protected final String TEXT_198 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_199 = " + \":\" + ";
  protected final String TEXT_200 = " + \"/\" + ";
  protected final String TEXT_201 = " + \"?\" + ";
  protected final String TEXT_202 = ";";
  protected final String TEXT_203 = NL + "\t\t        if(stmt_";
  protected final String TEXT_204 = " instanceof com.mysql.jdbc.Statement){" + NL + "\t\t\t\t    ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_205 = ").enableStreamingResults();" + NL + "\t\t\t\t}else if(stmt_";
  protected final String TEXT_206 = " instanceof com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper){" + NL + "\t\t\t\t    ((com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper)stmt_";
  protected final String TEXT_207 = ").enableStreamingResults();" + NL + "\t\t\t\t}";
  protected final String TEXT_208 = NL + "\t        if(rs_";
  protected final String TEXT_209 = ".getString(";
  protected final String TEXT_210 = "column_index_";
  protected final String TEXT_211 = ") != null) {" + NL + "\t            String dateString_";
  protected final String TEXT_212 = " = rs_";
  protected final String TEXT_213 = ".getString(";
  protected final String TEXT_214 = "column_index_";
  protected final String TEXT_215 = ");" + NL + "\t            if (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_216 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  ...
  protected final String TEXT_222 = ");" + NL + "\t            } else {" + NL + "\t                ";
  protected final String TEXT_223 = ".";
  protected final String TEXT_224 = " = (java.util.Date) year0_";
  protected final String TEXT_225 = ".clone();" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            ";
  protected final String TEXT_226 = ".";
  protected final String TEXT_227 = " =  null;" + NL + "\t        }\t\t\t ";
  protected final String TEXT_228 = NL + "    " + NL + "\t";
  protected final String TEXT_229 = NL + "\t\t    int nb_line_";
  protected final String TEXT_230 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_231 = " = null;";
  protected final String TEXT_232 = NL + "\t\t        conn_";
  protected final String TEXT_233 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_234 = "\");";
  protected final String TEXT_235 = NL + "\t\t\t\t";
  protected final String TEXT_236 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_237 = " =  conn_";
  protected final String TEXT_238 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_239 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_240 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_241 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_242 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_243 = NL + "                 conn_";
  protected final String TEXT_244 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_245 = NL + "               ";
  protected final String TEXT_246 = " + \"=\" + ";
  protected final String TEXT_247 = " + \";\" +";
  protected final String TEXT_248 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_249 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_250 = ");";
  protected final String TEXT_251 = NL + "\t\t    ";
  protected final String TEXT_252 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_253 = " = ";
  protected final String TEXT_254 = ";" + NL + "\t\t\t";
  protected final String TEXT_255 = NL + "                log.debug(\"";
  protected final String TEXT_256 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_257 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_258 = NL;
  protected final String TEXT_259 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_260 = "_QUERY\",dbquery_";
  protected final String TEXT_261 = ");";
  protected final String TEXT_262 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_263 = "_QUERY\",dbquery_";
  protected final String TEXT_264 = ");";
  protected final String TEXT_265 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_266 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_267 = " = stmt_";
  protected final String TEXT_268 = ".executeQuery(dbquery_";
  protected final String TEXT_269 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_270 = " = rs_";
  protected final String TEXT_271 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_272 = " = rsmd_";
  protected final String TEXT_273 = ".getColumnCount();" + NL;
  protected final String TEXT_274 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_275 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_276 = ".setDbmsId(\"";
  protected final String TEXT_277 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_278 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_279 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_280 = ".add(\"";
  protected final String TEXT_281 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_282 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_283 = " = ";
  protected final String TEXT_284 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_285 = "; i <= rsmd_";
  protected final String TEXT_286 = ".getColumnCount()-";
  protected final String TEXT_287 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_288 = ".contains(rsmd_";
  protected final String TEXT_289 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_290 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setName(rsmd_";
  protected final String TEXT_292 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_293 = ".setDbName(rsmd_";
  protected final String TEXT_294 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_295 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_296 = "\", rsmd_";
  protected final String TEXT_297 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_298 = ".getPrecision(i), rsmd_";
  protected final String TEXT_299 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_300 = ".setDbType(rsmd_";
  protected final String TEXT_301 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_302 = ".setDbTypeId(rsmd_";
  protected final String TEXT_303 = ".getColumnType(i));";
  protected final String TEXT_304 = NL + "                \tdcm_";
  protected final String TEXT_305 = ".setFormat(";
  protected final String TEXT_306 = ");";
  protected final String TEXT_307 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_308 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_309 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_310 = ".setLength(rsmd_";
  protected final String TEXT_311 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_312 = ".setLength(rsmd_";
  protected final String TEXT_313 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_314 = NL + "\t\t\tdcm_";
  protected final String TEXT_315 = ".setLength(rsmd_";
  protected final String TEXT_316 = ".getPrecision(i));";
  protected final String TEXT_317 = NL + "                \tdcm_";
  protected final String TEXT_318 = ".setPrecision(rsmd_";
  protected final String TEXT_319 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_320 = ".setNullable(rsmd_";
  protected final String TEXT_321 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_322 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_323 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_324 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_325 = ".metadatas.add(dcm_";
  protected final String TEXT_326 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_327 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_328 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_329 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_330 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_331 = NL + "\t\t    ";
  protected final String TEXT_332 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_333 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_334 = NL + "\t\t    while (rs_";
  protected final String TEXT_335 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_336 = "++;" + NL + "\t\t        ";
  protected final String TEXT_337 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_338 = " = ";
  protected final String TEXT_339 = " + dcg_";
  protected final String TEXT_340 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_342 = " = ";
  protected final String TEXT_343 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_345 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_404 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_405 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_406 = ".getColumnTypeName(i_";
  protected final String TEXT_407 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_408 = ".add(rs_";
  protected final String TEXT_409 = ".getString(i_";
  protected final String TEXT_410 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_411 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
