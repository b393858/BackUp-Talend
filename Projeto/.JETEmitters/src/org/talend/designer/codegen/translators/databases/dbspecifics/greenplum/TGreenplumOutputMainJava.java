...
public class TGreenplumOutputMainJava {
  ...
  protected final String TEXT_96 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_97 = "++;" + NL + "                       nb_line_";
  ...
  protected final String TEXT_115 = NL + "                                rejectedCount_";
  ...
  protected final String TEXT_129 = NL + "            int checkCount_";
  protected final String TEXT_130 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_131 = " = pstmt_";
  protected final String TEXT_132 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_133 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_134 = " = rs_";
  protected final String TEXT_135 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_143 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_144 = " = updatedCount_";
  protected final String TEXT_145 = " + pstmtUpdate_";
  protected final String TEXT_146 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_147 = "++;";
  protected final String TEXT_148 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_161 = NL + "                            rejectedCount_";
  protected final String TEXT_162 = " =  rejectedCount_";
  protected final String TEXT_163 = " + 1;";
  ...
  protected final String TEXT_214 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_224 = NL + "                }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
