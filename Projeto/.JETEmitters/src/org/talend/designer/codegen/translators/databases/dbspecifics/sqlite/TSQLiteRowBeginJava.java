...
public class TSQLiteRowBeginJava
{
  ...
  protected final String TEXT_124 = " = \"jdbc:sqlite:\" + \"/\" + ";
  ...
  protected final String TEXT_141 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_142 = "\", stmt_";
