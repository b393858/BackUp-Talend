...
public class TFirebirdRowFinallyJava
{
  protected static String nl;
  public static synchronized TFirebirdRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFirebirdRowFinallyJava result = new TFirebirdRowFinallyJava();
    nl = null;
    return result;
  }
