...
public class ComponentBegin
{
  ...
  protected final String TEXT_185 = NL + NL + "org.talend.components.api.component.ComponentDefinition def_";
  protected final String TEXT_186 = " =" + NL + "        new ";
  protected final String TEXT_187 = "();";
  protected final String TEXT_188 = NL;
  protected final String TEXT_189 = NL;
  protected final String TEXT_190 = " props_";
  protected final String TEXT_191 = " =" + NL + "        (";
  protected final String TEXT_192 = ") def_";
  protected final String TEXT_193 = ".createRuntimeProperties();";
  protected final String TEXT_194 = NL + "    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_";
  protected final String TEXT_195 = ".referenceType.getValue()) {" + NL + "        final String referencedComponentInstanceId_";
  protected final String TEXT_196 = " = props_";
  protected final String TEXT_197 = ".componentInstanceId.getStringValue();" + NL + "        if (referencedComponentInstanceId_";
  protected final String TEXT_198 = " != null) {" + NL + "            org.talend.daikon.properties.Properties referencedComponentProperties_";
  protected final String TEXT_199 = " = (org.talend.daikon.properties.Properties) globalMap.get(" + NL + "                referencedComponentInstanceId_";
  protected final String TEXT_200 = " + \"_COMPONENT_RUNTIME_PROPERTIES\");" + NL + "            props_";
  protected final String TEXT_201 = ".setReference(referencedComponentProperties_";
  protected final String TEXT_202 = ");" + NL + "        }" + NL + "    }";
  protected final String TEXT_203 = NL + "globalMap.put(\"";
  protected final String TEXT_204 = "_COMPONENT_RUNTIME_PROPERTIES\", props_";
  protected final String TEXT_205 = ");" + NL + "globalMap.putIfAbsent(\"TALEND_PRODUCT_VERSION\", \"";
  protected final String TEXT_206 = "\");" + NL + "globalMap.put(\"TALEND_COMPONENTS_VERSION\", \"";
  protected final String TEXT_207 = "\");";
  protected final String TEXT_208 = NL + "final String buffersSizeKey_";
  protected final String TEXT_209 = " = \"buffersSizeKey_";
  protected final String TEXT_210 = "_\" + Thread.currentThread().getId(); ";
  protected final String TEXT_211 = NL + "java.net.URL mappings_url_";
  protected final String TEXT_212 = "= this.getClass().getResource(\"/xmlMappings\");" + NL + "globalMap.put(\"";
  protected final String TEXT_213 = "_MAPPINGS_URL\", mappings_url_";
  protected final String TEXT_214 = ");" + NL + "" + NL + "org.talend.components.api.container.RuntimeContainer container_";
  protected final String TEXT_215 = " = new org.talend.components.api.container.RuntimeContainer() {" + NL + "    public Object getComponentData(String componentId, String key) {" + NL + "        return globalMap.get(componentId + \"_\" + key);" + NL + "    }" + NL + "" + NL + "    public void setComponentData(String componentId, String key, Object data) {" + NL + "        globalMap.put(componentId + \"_\" + key, data);" + NL + "    }" + NL + "" + NL + "    public String getCurrentComponentId() {" + NL + "        return \"";
  protected final String TEXT_216 = "\";" + NL + "    }" + NL + "" + NL + "    public Object getGlobalData(String key) {" + NL + "    \treturn globalMap.get(key);" + NL + "    }" + NL + "};" + NL + "" + NL + "int nb_line_";
  protected final String TEXT_217 = " = 0;" + NL + "" + NL + "org.talend.components.api.component.ConnectorTopology topology_";
  protected final String TEXT_218 = " = null;";
  protected final String TEXT_219 = NL + "topology_";
  protected final String TEXT_220 = " = org.talend.components.api.component.ConnectorTopology.INCOMING_AND_OUTGOING;";
  protected final String TEXT_221 = NL + "topology_";
  protected final String TEXT_222 = " = org.talend.components.api.component.ConnectorTopology.INCOMING;";
  protected final String TEXT_223 = NL + "topology_";
  protected final String TEXT_224 = " = org.talend.components.api.component.ConnectorTopology.OUTGOING;";
  protected final String TEXT_225 = NL + "topology_";
  protected final String TEXT_226 = " = org.talend.components.api.component.ConnectorTopology.NONE;";
  protected final String TEXT_227 = NL + NL + "org.talend.daikon.runtime.RuntimeInfo runtime_info_";
  protected final String TEXT_228 = " = def_";
  protected final String TEXT_229 = ".getRuntimeInfo(" + NL + "    org.talend.components.api.component.runtime.ExecutionEngine.DI, props_";
  protected final String TEXT_230 = ", topology_";
  protected final String TEXT_231 = ");" + NL + "java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_";
  protected final String TEXT_232 = " = def_";
  protected final String TEXT_233 = ".getSupportedConnectorTopologies();" + NL + "" + NL + "org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_";
  protected final String TEXT_234 = " = (org.talend.components.api.component.runtime.RuntimableRuntime)(Class.forName(runtime_info_";
  protected final String TEXT_235 = ".getRuntimeClassName()).newInstance());" + NL + "org.talend.daikon.properties.ValidationResult initVr_";
  protected final String TEXT_236 = " = componentRuntime_";
  protected final String TEXT_237 = ".initialize(container_";
  protected final String TEXT_238 = ", props_";
  protected final String TEXT_239 = ");" + NL + "" + NL + "if (initVr_";
  protected final String TEXT_240 = ".getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR ) {" + NL + "    throw new RuntimeException(initVr_";
  protected final String TEXT_241 = ".getMessage());" + NL + "}" + NL + "" + NL + "if(componentRuntime_";
  protected final String TEXT_242 = " instanceof org.talend.components.api.component.runtime.ComponentDriverInitialization) {" + NL + "\torg.talend.components.api.component.runtime.ComponentDriverInitialization compDriverInitialization_";
  protected final String TEXT_243 = " = (org.talend.components.api.component.runtime.ComponentDriverInitialization)componentRuntime_";
  protected final String TEXT_244 = ";" + NL + "\tcompDriverInitialization_";
  protected final String TEXT_245 = ".runAtDriver(container_";
  protected final String TEXT_246 = ");" + NL + "}" + NL + "" + NL + "org.talend.components.api.component.runtime.SourceOrSink sourceOrSink_";
  protected final String TEXT_247 = " = null;" + NL + "if(componentRuntime_";
  protected final String TEXT_248 = " instanceof org.talend.components.api.component.runtime.SourceOrSink) {" + NL + "\tsourceOrSink_";
  protected final String TEXT_249 = " = (org.talend.components.api.component.runtime.SourceOrSink)componentRuntime_";
  protected final String TEXT_250 = ";" + NL + "\torg.talend.daikon.properties.ValidationResult vr_";
  protected final String TEXT_251 = " = sourceOrSink_";
  protected final String TEXT_252 = ".validate(container_";
  protected final String TEXT_253 = ");" + NL + "\tif (vr_";
  protected final String TEXT_254 = ".getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR ) {" + NL + "    \tthrow new RuntimeException(vr_";
  protected final String TEXT_255 = ".getMessage());" + NL + "\t}" + NL + "}" + NL;
  protected final String TEXT_256 = NL + "    org.talend.components.api.component.runtime.Source source_";
  protected final String TEXT_257 = " =" + NL + "            (org.talend.components.api.component.runtime.Source)sourceOrSink_";
  protected final String TEXT_258 = ";" + NL + "    org.talend.components.api.component.runtime.Reader reader_";
  protected final String TEXT_259 = " =" + NL + "            source_";
  protected final String TEXT_260 = ".createReader(container_";
  protected final String TEXT_261 = ");" + NL + "\treader_";
  protected final String TEXT_262 = " = new org.talend.codegen.flowvariables.runtime.FlowVariablesReader(reader_";
  protected final String TEXT_263 = ", container_";
  protected final String TEXT_264 = ");" + NL;
  protected final String TEXT_265 = NL + "        boolean multi_output_is_allowed_";
  protected final String TEXT_266 = " = false;";
  protected final String TEXT_267 = NL + "        org.talend.components.api.component.Connector c_";
  protected final String TEXT_268 = " = null;" + NL + "        for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_269 = ".getAvailableConnectors(null, true)) {" + NL + "            if (currentConnector.getName().equals(\"";
  protected final String TEXT_270 = "\")) {" + NL + "                c_";
  protected final String TEXT_271 = " = currentConnector;" + NL + "            }" + NL + "" + NL + "            if (currentConnector.getName().equals(\"REJECT\")) {//it's better to move the code to javajet" + NL + "                multi_output_is_allowed_";
  protected final String TEXT_272 = " = true;" + NL + "            }" + NL + "        }" + NL + "        org.apache.avro.Schema schema_";
  protected final String TEXT_273 = " = props_";
  protected final String TEXT_274 = ".getSchema(c_";
  protected final String TEXT_275 = ", true);" + NL;
  protected final String TEXT_276 = NL + NL + "    // Iterate through the incoming data." + NL + "    boolean available_";
  protected final String TEXT_277 = " = reader_";
  protected final String TEXT_278 = ".start();" + NL + "" + NL + "    resourceMap.put(\"reader_";
  protected final String TEXT_279 = "\", reader_";
  protected final String TEXT_280 = ");" + NL + "" + NL + "    for (; available_";
  protected final String TEXT_281 = "; available_";
  protected final String TEXT_282 = " = reader_";
  protected final String TEXT_283 = ".advance()) {" + NL + "    \tnb_line_";
  protected final String TEXT_284 = "++;" + NL + "" + NL + "    \t";
  protected final String TEXT_285 = NL + "        if (multi_output_is_allowed_";
  ...
  protected final String TEXT_293 = NL + NL + "        try {" + NL + "            Object data_";
  protected final String TEXT_294 = " = reader_";
  protected final String TEXT_295 = ".getCurrent();";
  protected final String TEXT_296 = NL + NL + "                if(multi_output_is_allowed_";
  protected final String TEXT_297 = ") {";
  protected final String TEXT_298 = NL + "                    ";
  protected final String TEXT_299 = " = new ";
  protected final String TEXT_300 = "Struct();" + NL + "                }" + NL;
  protected final String TEXT_301 = NL + "        } catch (org.talend.components.api.exception.DataRejectException e_";
  protected final String TEXT_302 = ") {" + NL + "        \tjava.util.Map<String,Object> info_";
  protected final String TEXT_303 = " = e_";
  protected final String TEXT_304 = ".getRejectInfo();";
  protected final String TEXT_305 = NL + "                Object data_";
  protected final String TEXT_306 = " = info_";
  protected final String TEXT_307 = ".get(\"talend_record\");" + NL + "" + NL + "                if (multi_output_is_allowed_";
  protected final String TEXT_308 = ") {";
  protected final String TEXT_309 = NL + "                    ";
  protected final String TEXT_310 = " = new ";
  protected final String TEXT_311 = "Struct();" + NL + "                }" + NL + "\t\t\t\ttry{";
  protected final String TEXT_312 = NL + "                }catch(java.lang.Exception e){" + NL + "                \t// do nothing" + NL + "                }";
  protected final String TEXT_313 = NL + "                        ";
  protected final String TEXT_314 = ".";
  protected final String TEXT_315 = " = (";
  protected final String TEXT_316 = ")info_";
  protected final String TEXT_317 = ".get(\"";
  protected final String TEXT_318 = "\");";
  protected final String TEXT_319 = NL + "            \t//TODO use a method instead of getting method by the special key \"error/errorMessage\"" + NL + "            \tObject errorMessage_";
  protected final String TEXT_320 = " = null;" + NL + "            \tif(info_";
  protected final String TEXT_321 = ".containsKey(\"error\")){" + NL + "            \t\terrorMessage_";
  protected final String TEXT_322 = " = info_";
  protected final String TEXT_323 = ".get(\"error\");" + NL + "        \t\t}else if(info_";
  protected final String TEXT_324 = ".containsKey(\"errorMessage\")){" + NL + "            \t\terrorMessage_";
  protected final String TEXT_325 = " = info_";
  protected final String TEXT_326 = ".get(\"errorMessage\");" + NL + "        \t\t}else{" + NL + "        \t\t\terrorMessage_";
  protected final String TEXT_327 = " = \"Rejected but error message missing\";" + NL + "        \t\t}" + NL + "        \t\terrorMessage_";
  protected final String TEXT_328 = " = \"Row \"+ nb_line_";
  protected final String TEXT_329 = " + \": \"+errorMessage_";
  protected final String TEXT_330 = ";" + NL + "    \t\t\tSystem.err.println(errorMessage_";
  protected final String TEXT_331 = ");";
  protected final String TEXT_332 = NL + "            \t// If the record is reject, the main line record should put NULL" + NL + "            \t";
  protected final String TEXT_333 = " = null;";
  protected final String TEXT_334 = NL + "    }";
  protected final String TEXT_335 = NL + "    org.talend.components.api.component.runtime.Sink sink_";
  protected final String TEXT_336 = " =" + NL + "            (org.talend.components.api.component.runtime.Sink)sourceOrSink_";
  protected final String TEXT_337 = ";" + NL + "    org.talend.components.api.component.runtime.WriteOperation writeOperation_";
  protected final String TEXT_338 = " = sink_";
  protected final String TEXT_339 = ".createWriteOperation();" + NL + "    writeOperation_";
  protected final String TEXT_340 = ".initialize(container_";
  protected final String TEXT_341 = ");" + NL + "    org.talend.components.api.component.runtime.Writer writer_";
  protected final String TEXT_342 = " = writeOperation_";
  protected final String TEXT_343 = ".createWriter(container_";
  protected final String TEXT_344 = ");" + NL + "    writer_";
  protected final String TEXT_345 = ".open(\"";
  protected final String TEXT_346 = "\");" + NL + "" + NL + "    resourceMap.put(\"writer_";
  protected final String TEXT_347 = "\", writer_";
  protected final String TEXT_348 = ");" + NL + "" + NL + "    org.talend.components.api.component.Connector c_";
  protected final String TEXT_349 = " = null;" + NL + "    for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_350 = ".getAvailableConnectors(null, false)) {" + NL + "        if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "            c_";
  protected final String TEXT_351 = " = currentConnector;" + NL + "            break;" + NL + "        }" + NL + "    }" + NL + "    org.apache.avro.Schema designSchema_";
  protected final String TEXT_352 = " = props_";
  protected final String TEXT_353 = ".getSchema(c_";
  protected final String TEXT_354 = ", false);" + NL + "    org.talend.codegen.enforcer.IncomingSchemaEnforcer incomingEnforcer_";
  protected final String TEXT_355 = NL + "            = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(designSchema_";
  protected final String TEXT_356 = ");";
  protected final String TEXT_357 = NL + "                c_";
  protected final String TEXT_358 = " = null;" + NL + "                for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_359 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "                        c_";
  protected final String TEXT_360 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema mainSchema_";
  protected final String TEXT_361 = " = props_";
  protected final String TEXT_362 = ".getSchema(c_";
  protected final String TEXT_363 = ", true);";
  protected final String TEXT_364 = NL + "                c_";
  protected final String TEXT_365 = " = null;" + NL + "                for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_366 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"REJECT\")) {" + NL + "                        c_";
  protected final String TEXT_367 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema rejectSchema_";
  protected final String TEXT_368 = " = props_";
  protected final String TEXT_369 = ".getSchema(c_";
  protected final String TEXT_370 = ", true);";
  protected final String TEXT_371 = NL + "                java.lang.Iterable<?> outgoingMainRecordsList_";
  protected final String TEXT_372 = " = new java.util.ArrayList<Object>();" + NL + "                java.util.Iterator outgoingMainRecordsIt_";
...
for (final String fieldString : referenceProperties) {
    ...
    stringBuffer.append(org.talend.core.utils.TrackerUtil.getVersion());
