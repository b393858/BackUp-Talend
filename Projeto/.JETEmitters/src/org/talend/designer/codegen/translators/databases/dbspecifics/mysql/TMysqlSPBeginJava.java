...
public class TMysqlSPBeginJava
{
  ...
  protected final String TEXT_51 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_52 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_53 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_56 = ".get(dsAlias_";
  protected final String TEXT_57 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_58 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconnection_";
  protected final String TEXT_59 = " = dataSources_";
  protected final String TEXT_60 = ".get(dsAlias_";
  protected final String TEXT_61 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_62 = NL + "    String dbProperties_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "    String connectionString_";
  protected final String TEXT_65 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_66 = " == null || dbProperties_";
  protected final String TEXT_67 = ".trim().length() == 0) {" + NL + "        connectionString_";
  protected final String TEXT_68 = " = \"";
  protected final String TEXT_69 = "://\" + ";
  protected final String TEXT_70 = " + \":\" + ";
  protected final String TEXT_71 = " + \"/\" + ";
  protected final String TEXT_72 = ";" + NL + "    } else {" + NL + "        connectionString_";
  protected final String TEXT_73 = " = \"";
  protected final String TEXT_74 = "://\" + ";
  protected final String TEXT_75 = " + \":\" + ";
  protected final String TEXT_76 = " + \"/\" + ";
  protected final String TEXT_77 = " + \"?\" + dbProperties_";
  ...
  protected final String TEXT_90 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_91 = "\");";
  protected final String TEXT_92 = NL + "    connection_";
  protected final String TEXT_93 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_94 = ", dbUser_";
  protected final String TEXT_95 = ", dbPwd_";
  protected final String TEXT_96 = ");";
  protected final String TEXT_97 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_98 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_99 = " = connection_";
  protected final String TEXT_100 = ".prepareCall(\"{";
  protected final String TEXT_101 = "call \" + ";
  protected final String TEXT_102 = " + \"(";
  protected final String TEXT_103 = "?";
  protected final String TEXT_104 = ",?";
  protected final String TEXT_105 = ")}\");" + NL + "" + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_106 = ";" + NL + "String tmpString_";
