...
public class TELTHiveMapMainJava
{
  ...
  protected final String TEXT_70 = NL + "\t\t\tclass SQLBuilder_";
  protected final String TEXT_71 = "_";
  protected final String TEXT_72 = " {//avoid 65535 issue in a separate class" + NL + "\t\t\t" + NL + "\t\t\t\tString getQuerySegments() {" + NL + "\t\t\t\t\treturn new StringBuilder()" + NL + "    \t\t\t\t\t";
  protected final String TEXT_73 = NL + "    \t\t\t\t\t.append(\"";
  protected final String TEXT_74 = "\")" + NL + "    \t\t\t\t\t";
  protected final String TEXT_75 = NL + "    \t\t\t\t\t.toString();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\tString getQueryColumnsSegments() {" + NL + "\t\t\t\t\treturn new StringBuilder()" + NL + "        \t\t\t\t";
  protected final String TEXT_76 = NL + "        \t\t\t\t.append(\"";
  protected final String TEXT_77 = "\")" + NL + "        \t\t\t\t";
  protected final String TEXT_78 = NL + "        \t\t\t\t.toString();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tSQLBuilder_";
  protected final String TEXT_79 = "_";
  protected final String TEXT_80 = " sqlBuilder_";
  protected final String TEXT_81 = "_";
  protected final String TEXT_82 = " = new SQLBuilder_";
  protected final String TEXT_83 = "_";
  protected final String TEXT_84 = "();" + NL + "\t\t\t" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_85 = "\"+\"QUERY\" + \"";
  protected final String TEXT_86 = "\", sqlBuilder_";
  protected final String TEXT_87 = "_";
  protected final String TEXT_88 = ".getQuerySegments());" + NL + "\t\t\t" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_89 = "\"+\"QUERY_COLUMNS_NAME\" + \"";
  protected final String TEXT_90 = "\", sqlBuilder_";
  protected final String TEXT_91 = "_";
  protected final String TEXT_92 = ".getQueryColumnsSegments());" + NL + "\t\t\t";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    stringBuffer.append(segment.replaceAll("[\r\n]", " "));
