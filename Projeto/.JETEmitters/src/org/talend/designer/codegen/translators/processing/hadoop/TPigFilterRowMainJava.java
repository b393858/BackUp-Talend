...
public class TPigFilterRowMainJava
{
  ...
  protected final String TEXT_60 = NL + "        \tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> s3Objects_";
  protected final String TEXT_61 = " = s3Client_";
  protected final String TEXT_62 = ".listObjectsV2(";
  protected final String TEXT_63 = ").getObjectSummaries();" + NL + "        \tjava.util.Set<String> s3Keys_";
  protected final String TEXT_64 = " = s3Objects_";
  protected final String TEXT_65 = ".stream().map(obj -> obj.getKey()).collect(java.util.stream.Collectors.toSet());";
  protected final String TEXT_66 = NL + NL + "\t\tfor(String[] pigLatin_";
  protected final String TEXT_67 = " : pigLatins_";
  protected final String TEXT_68 = ") {" + NL + "\t\t\tString type_";
  protected final String TEXT_69 = " = pigLatin_";
  protected final String TEXT_70 = "[0];" + NL + "\t\t\t";
  protected final String TEXT_71 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_72 = " - register \" + type_";
  protected final String TEXT_73 = " + \": \" + pigLatin_";
  protected final String TEXT_74 = "[1]);" + NL + "\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\tif(\"query\".equals(type_";
  protected final String TEXT_76 = ")) {";
  protected final String TEXT_77 = NL + "\t\t\t\t\tbw_";
  protected final String TEXT_78 = ".write(pigLatin_";
  protected final String TEXT_79 = "[1]);";
  protected final String TEXT_80 = NL + "\t\t\t\t\tstatements_";
  protected final String TEXT_81 = ".append(pigLatin_";
  protected final String TEXT_82 = "[1]);" + NL + "\t\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_84 = ".registerQuery(pigLatin_";
  protected final String TEXT_85 = "[1]);";
  protected final String TEXT_86 = NL + "\t\t\t} else if (\"jar\".equals(type_";
  protected final String TEXT_87 = ")) {";
  protected final String TEXT_88 = NL + "\t\t\t\t\tbw_";
  protected final String TEXT_89 = ".write(\"REGISTER \" + wasbPath_";
  protected final String TEXT_90 = " + new java.io.File(pigLatin_";
  protected final String TEXT_91 = "[1]).getName() + \";\");" + NL + "\t\t\t\t\tlibjars_";
  protected final String TEXT_92 = ".append(pigLatin_";
  protected final String TEXT_93 = "[1] + \",\");";
  protected final String TEXT_94 = NL + "\t\t\t\t\tString jarName_";
  protected final String TEXT_95 = " = new String();" + NL + "\t\t\t\t\tString[] pathSplit = pigLatin_";
  protected final String TEXT_96 = "[1].split(\"/\");" + NL + "            \t\tjarName_";
  protected final String TEXT_97 = " = pathSplit[pathSplit.length - 1];" + NL + "            \t\tjava.util.regex.Pattern jarPattern = java.util.regex.Pattern.compile(\".*\\\\.jar\");" + NL + "\t\t\t\t\tif (!jarPattern.matcher(jarName_";
  protected final String TEXT_98 = ").matches()) {" + NL + "            \t\t\tthrow new IllegalArgumentException(\"";
  protected final String TEXT_99 = " - Incorrect jar path: \" + pigLatin_";
  protected final String TEXT_100 = "[1]);" + NL + "        \t\t\t}" + NL + "        \t\t\tboolean exist = s3Keys_";
  protected final String TEXT_101 = ".contains(";
  protected final String TEXT_102 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_103 = ");" + NL + "        \t\t\tif (!exist) {" + NL + "\t\t\t\t\t\ts3Client_";
  protected final String TEXT_104 = ".putObject(";
  protected final String TEXT_105 = ", ";
  protected final String TEXT_106 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_107 = ", new java.io.File(pigLatin_";
  protected final String TEXT_108 = "[1]));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tstatements_";
  protected final String TEXT_109 = ".append(\"REGISTER s3a://\" + ";
  ...
  protected final String TEXT_116 = " - upload jar to S3: \" + pigLatin_";
  protected final String TEXT_117 = "[1] + \" --> s3a://\" + ";
  protected final String TEXT_118 = " + \"/\" + ";
  protected final String TEXT_119 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_120 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_122 = ".registerJar(pigLatin_";
  protected final String TEXT_123 = "[1]);";
  protected final String TEXT_124 = NL + "\t\t\t} else if (\"script\".equals(type_";
  protected final String TEXT_125 = ")) {";
  protected final String TEXT_126 = NL + "\t\t\t\t\t\tbw_";
  protected final String TEXT_127 = ".write(pigLatin_";
  protected final String TEXT_128 = "[1]);";
  protected final String TEXT_129 = NL + "\t\t\t\t\t\t// Script is not supported on qubole.";
  protected final String TEXT_130 = NL + "\t\t\t\t\t\tpigServer_";
  protected final String TEXT_131 = ".registerScript(new java.io.ByteArrayInputStream(pigLatin_";
  protected final String TEXT_132 = "[1].getBytes()));";
  protected final String TEXT_133 = NL + "\t\t\t} else if (\"function\".equals(type_";
  protected final String TEXT_134 = ")) {";
  protected final String TEXT_135 = NL + "\t\t\t\t\tbw_";
  protected final String TEXT_136 = ".write(\"DEFINE \" + pigLatin_";
  protected final String TEXT_137 = "[1] + \" \" + pigLatin_";
  protected final String TEXT_138 = "[2] + \";\");";
  protected final String TEXT_139 = NL + "\t\t\t\t\t\t// DEFINE is not supported on qubole.";
  protected final String TEXT_140 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_141 = ".registerFunction(pigLatin_";
  protected final String TEXT_142 = "[1], new org.apache.pig.FuncSpec(pigLatin_";
  protected final String TEXT_143 = "[2]));";
  protected final String TEXT_144 = NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_145 = NL + "    \tpigScript_";
  protected final String TEXT_146 = ".addAll(pigLatins_";
  protected final String TEXT_147 = ");";
  protected final String TEXT_148 = NL + "\tpigLatins_";
  protected final String TEXT_149 = ".clear();";
