...
public class TPigSortMainJava
{
  ...
  protected final String TEXT_58 = NL + "        \tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> s3Objects_";
  protected final String TEXT_59 = " = s3Client_";
  protected final String TEXT_60 = ".listObjectsV2(";
  protected final String TEXT_61 = ").getObjectSummaries();" + NL + "        \tjava.util.Set<String> s3Keys_";
  protected final String TEXT_62 = " = s3Objects_";
  protected final String TEXT_63 = ".stream().map(obj -> obj.getKey()).collect(java.util.stream.Collectors.toSet());";
  protected final String TEXT_64 = NL + NL + "\t\tfor(String[] pigLatin_";
  protected final String TEXT_65 = " : pigLatins_";
  protected final String TEXT_66 = ") {" + NL + "\t\t\tString type_";
  protected final String TEXT_67 = " = pigLatin_";
  protected final String TEXT_68 = "[0];" + NL + "\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_70 = " - register \" + type_";
  protected final String TEXT_71 = " + \": \" + pigLatin_";
  protected final String TEXT_72 = "[1]);" + NL + "\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\tif(\"query\".equals(type_";
  ...
  protected final String TEXT_78 = NL + "\t\t\t\t\tstatements_";
  protected final String TEXT_79 = ".append(pigLatin_";
  protected final String TEXT_80 = "[1]);" + NL + "\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_82 = ".registerQuery(pigLatin_";
  protected final String TEXT_83 = "[1]);";
  protected final String TEXT_84 = NL + "\t\t\t} else if (\"jar\".equals(type_";
  protected final String TEXT_85 = ")) {";
  protected final String TEXT_86 = NL + "\t\t\t\t\tbw_";
  protected final String TEXT_87 = ".write(\"REGISTER \" + wasbPath_";
  protected final String TEXT_88 = " + new java.io.File(pigLatin_";
  protected final String TEXT_89 = "[1]).getName() + \";\");" + NL + "\t\t\t\t\tlibjars_";
  protected final String TEXT_90 = ".append(pigLatin_";
  protected final String TEXT_91 = "[1] + \",\");";
  protected final String TEXT_92 = NL + "\t\t\t\t\tString jarName_";
  protected final String TEXT_93 = " = new String();" + NL + "\t\t\t\t\tString[] pathSplit = pigLatin_";
  protected final String TEXT_94 = "[1].split(\"/\");" + NL + "            \t\tjarName_";
  protected final String TEXT_95 = " = pathSplit[pathSplit.length - 1];" + NL + "            \t\tjava.util.regex.Pattern jarPattern = java.util.regex.Pattern.compile(\".*\\\\.jar\");" + NL + "\t\t\t\t\tif (!jarPattern.matcher(jarName_";
  protected final String TEXT_96 = ").matches()) {" + NL + "            \t\t\tthrow new IllegalArgumentException(\"";
  protected final String TEXT_97 = " - Incorrect jar path: \" + pigLatin_";
  protected final String TEXT_98 = "[1]);" + NL + "        \t\t\t}" + NL + "        \t\t\tboolean exist = s3Keys_";
  protected final String TEXT_99 = ".contains(";
  protected final String TEXT_100 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_101 = ");" + NL + "        \t\t\tif (!exist) {" + NL + "\t\t\t\t\t\ts3Client_";
  protected final String TEXT_102 = ".putObject(";
  protected final String TEXT_103 = ", ";
  protected final String TEXT_104 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_105 = ", new java.io.File(pigLatin_";
  protected final String TEXT_106 = "[1]));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tstatements_";
  protected final String TEXT_107 = ".append(\"REGISTER s3a://\" + ";
  protected final String TEXT_108 = " + \":\" + routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_109 = ") + \"@\" + ";
  protected final String TEXT_110 = " + \"/\" + ";
  protected final String TEXT_111 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_112 = " + \";\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_114 = " - upload jar to S3: \" + pigLatin_";
  protected final String TEXT_115 = "[1] + \" --> s3a://\" + ";
  protected final String TEXT_116 = " + \"/\" + ";
  protected final String TEXT_117 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_118 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_120 = ".registerJar(pigLatin_";
  protected final String TEXT_121 = "[1]);";
  protected final String TEXT_122 = NL + "\t\t\t} else if (\"script\".equals(type_";
  protected final String TEXT_123 = ")) {";
  protected final String TEXT_124 = NL + "\t\t\t\t\t\tbw_";
  protected final String TEXT_125 = ".write(pigLatin_";
  protected final String TEXT_126 = "[1]);";
  protected final String TEXT_127 = NL + "\t\t\t\t\t\t// Script is not supported on qubole.";
  protected final String TEXT_128 = NL + "\t\t\t\t\t\tpigServer_";
  protected final String TEXT_129 = ".registerScript(new java.io.ByteArrayInputStream(pigLatin_";
  protected final String TEXT_130 = "[1].getBytes()));";
  protected final String TEXT_131 = NL + "\t\t\t} else if (\"function\".equals(type_";
  protected final String TEXT_132 = ")) {";
  protected final String TEXT_133 = NL + "\t\t\t\t\tbw_";
  protected final String TEXT_134 = ".write(\"DEFINE \" + pigLatin_";
  protected final String TEXT_135 = "[1] + \" \" + pigLatin_";
  protected final String TEXT_136 = "[2] + \";\");";
  protected final String TEXT_137 = NL + "\t\t\t\t\t\t// DEFINE is not supported on qubole.";
  protected final String TEXT_138 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_139 = ".registerFunction(pigLatin_";
  protected final String TEXT_140 = "[1], new org.apache.pig.FuncSpec(pigLatin_";
  protected final String TEXT_141 = "[2]));";
  protected final String TEXT_142 = NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_143 = NL + "    \tpigScript_";
  protected final String TEXT_144 = ".addAll(pigLatins_";
  protected final String TEXT_145 = ");";
  protected final String TEXT_146 = NL + "\tpigLatins_";
  protected final String TEXT_147 = ".clear();";
