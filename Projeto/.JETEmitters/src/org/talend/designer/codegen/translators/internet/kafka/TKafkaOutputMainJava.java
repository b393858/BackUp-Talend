...
public class TKafkaOutputMainJava
{
  ...
  protected final String TEXT_9 = "), new org.apache.kafka.clients.producer.Callback() {" + NL + "\tpublic void onCompletion(org.apache.kafka.clients.producer.RecordMetadata metadata, Exception e) {" + NL + "\t\tif (e != null) {" + NL + "\t\t\t";
  protected final String TEXT_10 = "_producerExceptions.add(e);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_11 = "_counter_rev.getAndIncrement();" + NL + "\t}" + NL + "});";
  protected final String TEXT_12 = NL;
  protected final String TEXT_13 = "_counter_send++;" + NL + "" + NL + "if (!";
  protected final String TEXT_14 = "_producerExceptions.isEmpty()) {" + NL + "\tException e = ";
  protected final String TEXT_15 = "_producerExceptions.iterator().next();" + NL + "\t";
  protected final String TEXT_16 = NL + "\t\tthrow e;" + NL + "\t";
