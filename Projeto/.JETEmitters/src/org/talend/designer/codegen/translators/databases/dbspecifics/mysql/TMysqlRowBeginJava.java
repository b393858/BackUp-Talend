...
public class TMysqlRowBeginJava
{
  ...
  protected final String TEXT_136 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_137 = " = null;" + NL + "\tString query_";
  protected final String TEXT_138 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_139 = " = false;";
  ...
  protected final String TEXT_149 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
