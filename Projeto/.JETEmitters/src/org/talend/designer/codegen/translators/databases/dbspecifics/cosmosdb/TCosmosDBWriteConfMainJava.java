...
public class TCosmosDBWriteConfMainJava
{
  protected static String nl;
  public static synchronized TCosmosDBWriteConfMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBWriteConfMainJava result = new TCosmosDBWriteConfMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_232 = NL + "\t\t\t\t\tthrow new Exception(\"There no data in json,Please check the json configuration\");" + NL + "\t\t\t\t";
  protected final String TEXT_233 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_234 = " - There no data in json,Please check the json configuration\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\t\tSystem.err.println(\"There no data in json,Please check the json configuration\");" + NL + "\t\t\t\t";
