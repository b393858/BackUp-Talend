...
public class TBigQueryInputEndJava
{
  ...
  protected final String TEXT_31 = NL + "\t\t\t}" + NL + "\t\tpageToken_";
  protected final String TEXT_32 = " = dataList_";
  protected final String TEXT_33 = ".getPageToken();" + NL + "\t\tif (null == pageToken_";
  protected final String TEXT_34 = ") {" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t}" + NL + "\tbigQueryUtil_";
  protected final String TEXT_35 = ".cleanup();" + NL + "  \t";
