...
public class TSQLiteRowFinallyJava
{
  protected static String nl;
  public static synchronized TSQLiteRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLiteRowFinallyJava result = new TSQLiteRowFinallyJava();
    nl = null;
    return result;
  }
