...
public class THiveConnectionBeginJava
{
  ...
  protected final String TEXT_162 = " - Connection is set auto commit to '";
  protected final String TEXT_163 = "'.\");";
  protected final String TEXT_164 = NL + "\t\t\tconn_";
  protected final String TEXT_165 = ".setAutoCommit(";
  protected final String TEXT_166 = ");";
  protected final String TEXT_167 = NL + "\t\t\t\tconn_";
  protected final String TEXT_168 = " = java.sql.DriverManager.getConnection(url_";
  ...
  protected final String TEXT_175 = NL + "          org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_176 = " = new org.apache.hadoop.conf.Configuration();";
  protected final String TEXT_177 = NL + "          System.setProperty(";
  protected final String TEXT_178 = " ,";
  protected final String TEXT_179 = ");";
  protected final String TEXT_180 = NL + "            conf_";
  protected final String TEXT_181 = ".set(";
  protected final String TEXT_182 = " ,";
  protected final String TEXT_183 = ");";
  protected final String TEXT_184 = NL + "          org.apache.hadoop.security.UserGroupInformation.setConfiguration(conf_";
  protected final String TEXT_185 = ");" + NL + "          org.apache.hadoop.security.UserGroupInformation.getLoginUser();";
  protected final String TEXT_186 = NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.sasl.enabled\", \"true\");" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionDriverName\", ";
  protected final String TEXT_187 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\t\tSystem.setProperty(\"hive.security.authorization.enabled\", \"false\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\t\t\tSystem.setProperty(\"hive.security.authorization.enabled\", \"true\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionURL\", ";
  protected final String TEXT_191 = ");" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionUserName\", ";
  ...
  protected final String TEXT_197 = NL + "            \tString decryptedMetastorePassword_";
  protected final String TEXT_198 = " = ";
  protected final String TEXT_199 = ";" + NL + "    \t\t\t";
  protected final String TEXT_200 = NL + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionPassword\", decryptedMetastorePassword_";
  protected final String TEXT_201 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.kerberos.principal\", ";
  protected final String TEXT_202 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t\t\tSystem.setProperty(\"hive.server2.authentication.kerberos.principal\", ";
  protected final String TEXT_204 = ");" + NL + "\t\t\t\t\tSystem.setProperty(\"hive.server2.authentication.kerberos.keytab\", ";
  protected final String TEXT_205 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_206 = NL + "\t\t\t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_207 = ", ";
  protected final String TEXT_208 = ");";
  protected final String TEXT_209 = NL + "\t\t\t\tSystem.setProperty(\"mapred.job.tracker\", ";
  protected final String TEXT_210 = ");";
  protected final String TEXT_211 = NL + "\t\t\t\tSystem.setProperty(\"";
  protected final String TEXT_212 = "\", ";
  protected final String TEXT_213 = ");";
  protected final String TEXT_214 = NL + "                String username_";
  protected final String TEXT_215 = " = ";
  protected final String TEXT_216 = ";" + NL + "                if(username_";
  protected final String TEXT_217 = "!=null && !\"\".equals(username_";
  protected final String TEXT_218 = ".trim())) {" + NL + "                    System.setProperty(\"HADOOP_USER_NAME\",username_";
  protected final String TEXT_219 = ");" + NL + "                }";
  protected final String TEXT_220 = NL + "\t\t\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_221 = "\", System.getProperty(\"HADOOP_USER_NAME\"));" + NL + "\t\t\t";
  protected final String TEXT_222 = NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.local\", \"false\");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.uris\", \"thrift://\" + ";
  protected final String TEXT_223 = " + \":\" + ";
  protected final String TEXT_224 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.execute.setugi\", \"true\");" + NL + "\t\t\t\tString url_";
  protected final String TEXT_225 = " = \"jdbc:";
  protected final String TEXT_226 = "://\";";
  protected final String TEXT_227 = NL + "\t\t\t\t\tString dbUserName_";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = ";" + NL + "\t\t\t\t\tif(dbUserName_";
  protected final String TEXT_230 = "!=null && !\"\".equals(dbUserName_";
  protected final String TEXT_231 = ".trim())) {" + NL + "\t\t\t\t\t\tSystem.setProperty(\"HADOOP_USER_NAME\",dbUserName_";
  protected final String TEXT_232 = ");" + NL + "\t\t\t\t\t\t//make relative file path work for hive" + NL + "\t\t\t\t\t\tglobalMap.put(\"current_client_user_name\", System.getProperty(\"user.name\"));" + NL + "\t\t\t\t\t\tSystem.setProperty(\"user.name\",dbUserName_";
  protected final String TEXT_233 = ");" + NL + "\t\t\t\t\t\tglobalMap.put(\"dbUser_";
  protected final String TEXT_234 = "\",dbUserName_";
  protected final String TEXT_235 = ");" + NL + "\t\t\t\t\t}";
  protected final String TEXT_236 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_237 = " = \"jdbc:";
  protected final String TEXT_238 = "://\" + ";
  protected final String TEXT_239 = " + \":\" + ";
  protected final String TEXT_240 = " + \"/\" + ";
  protected final String TEXT_241 = " + \";\";" + NL + "" + NL + "\t\t\t\t\t// Add HADOOP_CONF_DIR to the classpath if it's present" + NL + "\t\t\t\t\tString hadoopConfDir_";
  protected final String TEXT_242 = " = System.getenv(\"HADOOP_CONF_DIR\");" + NL + "\t\t\t\t\tif(hadoopConfDir_";
  ...
  protected final String TEXT_244 = ").toURI().toURL() });" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\torg.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_245 = " = new org.apache.hadoop.conf.Configuration();" + NL + "" + NL + "\t\t\t\t\t// Adding any talend-site.xml files on the classpath" + NL + "\t\t\t\t\tconf_";
  protected final String TEXT_246 = ".addResource(\"talend-site.xml\");" + NL + "\t\t\t\t\tString tldHiveKerberosAuth = conf_";
  protected final String TEXT_247 = ".get(\"talend.kerberos.authentication\", \"\");" + NL + "\t\t\t\t\tString tldHiveKerberosKtPrincipal = conf_";
  protected final String TEXT_248 = ".get(\"talend.kerberos.keytab.principal\", \"\");" + NL + "\t\t\t\t\tString tldHiveKerberosKtPath = conf_";
  protected final String TEXT_249 = ".get(\"talend.kerberos.keytab.path\", \"\");" + NL + "\t\t\t\t\tString tldHiveEnc = conf_";
  protected final String TEXT_250 = ".get(\"talend.encryption\", \"\");" + NL + "\t\t\t\t\tString tldHiveSslTsPath = conf_";
  protected final String TEXT_251 = ".get(\"talend.ssl.trustStore.path\", \"\");" + NL + "\t\t\t\t\tString tldHiveSslTsPassword = conf_";
  protected final String TEXT_252 = ".get(\"talend.ssl.trustStore.password\", \"\");" + NL + "" + NL + "\t\t\t\t\t// Add configurations from hive-site.xml" + NL + "\t\t\t\t\tconf_";
  protected final String TEXT_253 = ".addResource(\"hive-site.xml\");" + NL + "" + NL + "\t\t\t\t\t// Add configurations from yarn-site.xml" + NL + "\t\t\t\t\tconf_";
  protected final String TEXT_254 = ".addResource(\"yarn-site.xml\");" + NL + "" + NL + "\t\t\t\t\t// Add configurations from mapred-site.xml" + NL + "\t\t\t\t\tconf_";
  protected final String TEXT_255 = ".addResource(\"mapred-site.xml\");" + NL + "" + NL + "\t\t\t\t\t// Add configurations from hdfs-site.xml" + NL + "\t\t\t\t\tconf_";
  protected final String TEXT_256 = ".addResource(\"hdfs-site.xml\");";
  protected final String TEXT_257 = NL + "\t\t\t\t\t\t// Add configurations from hbase-site.xml" + NL + "\t\t\t\t\t\tconf_";
  protected final String TEXT_258 = ".addResource(\"hbase-site.xml\");";
  protected final String TEXT_259 = NL + "\t\t\t\t\t\tconf_";
  protected final String TEXT_260 = ".set(";
  protected final String TEXT_261 = " ,";
  protected final String TEXT_262 = ");";
  protected final String TEXT_263 = NL + "\t\t\t\t\t\tlog.debug(\"CLASSPATH_CONFIGURATION_";
  protected final String TEXT_264 = "\" + \" Loaded : \" + conf_";
  protected final String TEXT_265 = ");" + NL + "\t\t\t\t\t\tlog.debug(\"CLASSPATH_CONFIGURATION_";
  protected final String TEXT_266 = "\" + \" key value pairs : \");" + NL + "\t\t\t\t\t\tjava.util.Iterator<java.util.Map.Entry<String,String>> iterator_log_";
  protected final String TEXT_267 = " = conf_";
  protected final String TEXT_268 = ".iterator();" + NL + "\t\t\t\t\t\twhile(iterator_log_";
  protected final String TEXT_269 = ".hasNext()){" + NL + "\t\t\t\t\t\t\tjava.util.Map.Entry<String,String> property = iterator_log_";
  protected final String TEXT_270 = ".next();" + NL + "\t\t\t\t\t\t\tlog.debug(\"CLASSPATH_CONFIGURATION_";
  protected final String TEXT_271 = " \" + property.getKey() + \" : \" + property.getValue());" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_272 = NL + "\t\t\t\t\tif(org.apache.hadoop.security.UserGroupInformation.isSecurityEnabled()){" + NL + "" + NL + "" + NL + "\t\t\t\t\t\tString hiveServer2KerberosPrincipal = conf_";
  protected final String TEXT_273 = ".get(\"hive.server2.authentication.kerberos.principal\", \"\");" + NL + "\t\t\t\t\t\tString urlKerberosParameter = \"principal=\" + hiveServer2KerberosPrincipal;" + NL + "" + NL + "\t\t\t\t\t\t// Keytab configurations" + NL + "\t\t\t\t\t\tif(tldHiveKerberosAuth.equalsIgnoreCase(\"keytab\")){" + NL + "\t\t\t\t\t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(tldHiveKerberosKtPrincipal, tldHiveKerberosKtPath);" + NL + "\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t\t// SSL configurations" + NL + "\t\t\t\t\t\tif(tldHiveEnc.equalsIgnoreCase(\"ssl\")){";
  protected final String TEXT_274 = NL + "\t\t\t\t\t\t\t\turl_";
  protected final String TEXT_275 = " += urlKerberosParameter + \";ssl=true\" +\";sslTrustStore=\" + tldHiveSslTsPath + \";trustStorePassword=\" + tldHiveSslTsPassword;";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\t\t\turl_";
  protected final String TEXT_277 = " += urlKerberosParameter + \";sasl.qop=auth-conf\";";
  protected final String TEXT_278 = NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\turl_";
  protected final String TEXT_279 = " += urlKerberosParameter;" + NL + "\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t// SSL configurations" + NL + "\t\t\t\t\t\tif(tldHiveEnc.equalsIgnoreCase(\"ssl\")){" + NL + "\t\t\t\t\t\t\turl_";
  protected final String TEXT_280 = " += \";ssl=true\" +\";sslTrustStore=\" + tldHiveSslTsPath + \";trustStorePassword=\" + tldHiveSslTsPassword;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}";
  ...
  protected final String TEXT_287 = NL + "                            com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_288 = " = new com.mapr.login.client.MapRLoginHttpsClient();" + NL + "                            maprLogin_";
  protected final String TEXT_289 = ".getMapRCredentialsViaKerberos(";
  ...
  protected final String TEXT_298 = NL + "\t\t\t\t\t\t\t\tString url_";
  protected final String TEXT_299 = " = \"jdbc:";
  protected final String TEXT_300 = "://\" + ";
  protected final String TEXT_301 = " + \":\" + ";
  protected final String TEXT_302 = " + \"/\" + ";
  protected final String TEXT_303 = " + \";principal=\" + ";
  protected final String TEXT_304 = "+\";ssl=true\" +\";sslTrustStore=\" + ";
  protected final String TEXT_305 = " + \";trustStorePassword=\" + decryptedSslStorePassword_";
  ...
  protected final String TEXT_313 = "+\";sasl.qop=auth-conf\";";
  protected final String TEXT_314 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_315 = " = \"jdbc:";
  protected final String TEXT_316 = "://\" + ";
  protected final String TEXT_317 = " + \":\" + ";
  protected final String TEXT_318 = " + \"/\" + ";
  protected final String TEXT_319 = " + \";principal=\" + ";
  ...
  protected final String TEXT_323 = " = new com.mapr.login.client.MapRLoginHttpsClient();" + NL + "\t\t\t\t            ";
  protected final String TEXT_324 = NL + "\t\t\t\t                System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_325 = ");" + NL + "\t\t\t\t                ";
  protected final String TEXT_326 = NL + "\t\t\t\t                maprLogin_";
  protected final String TEXT_327 = ".setCheckUGI(false);" + NL + "\t\t\t\t                ";
  ...
  protected final String TEXT_375 = NL + "\t\t\tconn_";
  protected final String TEXT_376 = ".setAutoCommit(";
  protected final String TEXT_377 = ");";
  protected final String TEXT_378 = NL + NL + "\t";
  protected final String TEXT_379 = NL + "\t\tString dbUser_";
  protected final String TEXT_380 = " = ";
  protected final String TEXT_381 = ";";
  protected final String TEXT_382 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_383 = NL + "\t\t\tString dbPwd_";
  protected final String TEXT_384 = " = null;" + NL + "\t\t";
  ...
  protected final String TEXT_392 = NL + "\t\t\tString dbPwd_";
  protected final String TEXT_393 = " = decryptedPassword_";
  protected final String TEXT_394 = ";" + NL + "\t\t";
  protected final String TEXT_395 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_396 = " = null;" + NL + "\t";
  protected final String TEXT_397 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_398 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_400 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_401 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_403 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_404 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_406 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_407 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_409 = " - Written records count: \" + nb_line_";
  protected final String TEXT_410 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_412 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_414 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_415 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_416 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_417 = " - Writing the record \" + nb_line_";
  protected final String TEXT_418 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_419 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_420 = " - Processing the record \" + nb_line_";
  protected final String TEXT_421 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_422 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_423 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_424 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_426 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_427 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_429 = " - Uses an existing connection ";
  protected final String TEXT_430 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_432 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_433 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_434 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_435 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_436 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_437 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_445 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_446 = ");" + NL + "\t\t\t";
  protected final String TEXT_447 = NL + "\t\t\tconn_";
  protected final String TEXT_448 = ".rollback();" + NL + "\t\t\t";
  ...
  protected final String TEXT_454 = ".setAutoCommit(";
  protected final String TEXT_455 = ");" + NL + "\t\t\t";
  protected final String TEXT_456 = NL + "\t\t\t\tlog.";
  protected final String TEXT_457 = "(\"";
  protected final String TEXT_458 = " - \" + ";
  protected final String TEXT_459 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_460 = NL + "\t    \t\tlog.";
  protected final String TEXT_461 = "(\"";
  protected final String TEXT_462 = "\");" + NL + "\t\t\t";
  protected final String TEXT_463 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_464 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_465 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_466 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_467 = ": pstmt_";
  protected final String TEXT_468 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_469 = " += (countEach_";
  protected final String TEXT_470 = " < 0 ? 0 : ";
  protected final String TEXT_471 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_472 = NL + "\t";
  protected final String TEXT_473 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_474 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_475 = " == null) {";
  protected final String TEXT_476 = NL + "\t\t";
  protected final String TEXT_477 = NL + "\t\t";
  protected final String TEXT_478 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_479 = "\", conn_";
  protected final String TEXT_480 = ");";
  protected final String TEXT_481 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_482 = " = ";
  protected final String TEXT_483 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_484 = ".get(dsAlias_";
  protected final String TEXT_485 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_486 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_487 = " = dataSources_";
  protected final String TEXT_488 = ".get(dsAlias_";
  protected final String TEXT_489 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_490 = "\", conn_";
  protected final String TEXT_491 = ");" + NL + "\t}";
  protected final String TEXT_492 = NL + "\tif (null != conn_";
  protected final String TEXT_493 = ") {" + NL + "\t\t";
  protected final String TEXT_494 = NL + "\t}";
  protected final String TEXT_495 = NL;
  protected final String TEXT_496 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_497 = ");" + NL + "" + NL + "\tjava.sql.Statement init_";
  protected final String TEXT_498 = " = conn_";
  protected final String TEXT_499 = ".createStatement();";
  protected final String TEXT_500 = NL + "        init_";
  protected final String TEXT_501 = ".execute(\"SET mapred.job.map.memory.mb=\" + ";
  protected final String TEXT_502 = ");" + NL + "\t    init_";
  protected final String TEXT_503 = ".execute(\"SET mapred.job.reduce.memory.mb=\" + ";
  protected final String TEXT_504 = ");";
  protected final String TEXT_505 = NL + "\t\tinit_";
  protected final String TEXT_506 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_507 = ");";
  protected final String TEXT_508 = NL + "\t\t\tinit_";
  protected final String TEXT_509 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_510 = ");";
  protected final String TEXT_511 = NL + "\t\t\tinit_";
  protected final String TEXT_512 = ".execute(\"SET yarn.resourcemanager.principal=\" + ";
  protected final String TEXT_513 = ");";
  protected final String TEXT_514 = NL + "    \t\tinit_";
  protected final String TEXT_515 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "    \t\tinit_";
  protected final String TEXT_516 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_517 = ");";
  protected final String TEXT_518 = NL + "\t\t\tinit_";
  protected final String TEXT_519 = ".execute(\"SET mapreduce.jobhistory.address=\" + ";
  protected final String TEXT_520 = ");" + NL + "\t\t\t";
  protected final String TEXT_521 = NL + "\t\t\tinit_";
  protected final String TEXT_522 = ".execute(\"SET dfs.client.use.datanode.hostname=true\");";
  protected final String TEXT_523 = NL + "\t\t\tinit_";
  protected final String TEXT_524 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_525 = ");";
  protected final String TEXT_526 = NL + "\t\t\tinit_";
  protected final String TEXT_527 = ".execute(\"SET fs.default.name=\" + ";
  protected final String TEXT_528 = ");";
  protected final String TEXT_529 = NL + "\t\t\t\tinit_";
  protected final String TEXT_530 = ".execute(\"SET mapreduce.app-submission.cross-platform=true\");";
  protected final String TEXT_531 = NL + "\t\t\t\tinit_";
  protected final String TEXT_532 = ".execute(\"SET mapreduce.job.map.output.collector.class=org.apache.hadoop.mapred.MapRFsOutputBuffer\");" + NL + "\t\t\t\tinit_";
  protected final String TEXT_533 = ".execute(\"SET mapreduce.job.reduce.shuffle.consumer.plugin.class=org.apache.hadoop.mapreduce.task.reduce.DirectShuffle\");";
  protected final String TEXT_534 = NL + "\t\t\t\tinit_";
  protected final String TEXT_535 = ".execute(\"SET mapreduce.application.classpath=";
  protected final String TEXT_536 = "\");";
  protected final String TEXT_537 = NL + "\t\t\tinit_";
  protected final String TEXT_538 = ".execute(\"SET yarn.application.classpath=";
  protected final String TEXT_539 = "\");";
  protected final String TEXT_540 = NL + "\t\t\tinit_";
  protected final String TEXT_541 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_542 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_543 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_544 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_545 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_546 = ");";
  protected final String TEXT_547 = NL + "\t\t\tinit_";
  protected final String TEXT_548 = ".execute(\"SET \"+";
  protected final String TEXT_549 = "+\"=\"+";
  protected final String TEXT_550 = ");";
  protected final String TEXT_551 = NL + NL + "\t";
  protected final String TEXT_552 = NL;
  protected final String TEXT_553 = NL + "    \t\tinit_";
  protected final String TEXT_554 = ".execute(\"SET hive.execution.engine=tez\");";
  protected final String TEXT_555 = NL + "                        System.err.println(\"Please set the path of Tez lib in 'Tez lib path'!\");";
  ...
  protected final String TEXT_597 = NL + "                    String hdfsUserName_";
  protected final String TEXT_598 = " = (";
  protected final String TEXT_599 = " != null && !\"\".equals(";
  protected final String TEXT_600 = ")) ? ";
  protected final String TEXT_601 = " : System.getProperty(\"user.name\");" + NL + "                    String tezLibPath_";
  protected final String TEXT_602 = " = \"/tmp/\" + hdfsUserName_";
  protected final String TEXT_603 = " + \"/talend_tez_libs/";
  protected final String TEXT_604 = "\";";
  protected final String TEXT_605 = NL + "                    String tezLibPath_";
  protected final String TEXT_606 = " = ";
  protected final String TEXT_607 = ";";
  protected final String TEXT_608 = NL + "                fs_";
  protected final String TEXT_609 = ".mkdirs(new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_610 = "));";
  protected final String TEXT_611 = NL + "                String[] classPaths_";
  protected final String TEXT_612 = " = System.getProperty(\"java.class.path\").split(";
  protected final String TEXT_613 = "String.valueOf(globalMap.get(\"current_client_path_separator\"))";
  protected final String TEXT_614 = "System.getProperty(\"path.separator\")";
  protected final String TEXT_615 = ");" + NL + "                String tezLibLocalPath_";
  protected final String TEXT_616 = " = null;" + NL + "                for(String classPath_";
  protected final String TEXT_617 = " : classPaths_";
  protected final String TEXT_618 = "){";
  protected final String TEXT_619 = NL + "                        if(classPath_";
  protected final String TEXT_620 = ".endsWith(\"";
  protected final String TEXT_621 = "\")){" + NL + "                            org.apache.hadoop.fs.Path tezJarPath_";
  protected final String TEXT_622 = " = new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_623 = " + \"/";
  protected final String TEXT_624 = "\");" + NL + "                            if(!fs_";
  protected final String TEXT_625 = ".exists(tezJarPath_";
  protected final String TEXT_626 = ")){" + NL + "                                fs_";
  protected final String TEXT_627 = ".copyFromLocalFile(false, false, new org.apache.hadoop.fs.Path(classPath_";
  protected final String TEXT_628 = "), tezJarPath_";
  protected final String TEXT_629 = ");" + NL + "                            }" + NL + "                        }";
  protected final String TEXT_630 = NL + "                }";
  protected final String TEXT_631 = NL + "                String tezLibPath_";
  protected final String TEXT_632 = " = ";
  protected final String TEXT_633 = ";";
  protected final String TEXT_634 = NL + "\t\t\tStringBuilder script_";
  protected final String TEXT_635 = " = new StringBuilder();" + NL + "\t\t\tString[] tezLibPaths_";
  protected final String TEXT_636 = " = tezLibPath_";
  protected final String TEXT_637 = ".split(\",\");" + NL + "\t\t\tscript_";
  protected final String TEXT_638 = ".append(\"SET tez.lib.uris=\");" + NL + "\t\t\tint tezLibPathCount_";
  protected final String TEXT_639 = " = 1;" + NL + "\t\t\tfor(String tezLibPathKey_";
  protected final String TEXT_640 = " : tezLibPaths_";
  protected final String TEXT_641 = "){" + NL + "\t\t\t\t script_";
  protected final String TEXT_642 = ".append(";
  protected final String TEXT_643 = " + \"/\" + tezLibPathKey_";
  protected final String TEXT_644 = ");" + NL + "\t\t\t\t if(tezLibPathCount_";
  protected final String TEXT_645 = " < tezLibPaths_";
  protected final String TEXT_646 = ".length){" + NL + "\t\t\t\t \tscript_";
  protected final String TEXT_647 = ".append(\",\");" + NL + "\t\t\t\t }" + NL + "\t\t\t\t tezLibPathCount_";
  protected final String TEXT_648 = "++;" + NL + "\t\t\t}" + NL + "\t\t\tinit_";
  protected final String TEXT_649 = ".execute(script_";
  protected final String TEXT_650 = ".toString());" + NL + "\t\t";
  protected final String TEXT_651 = NL + "\t";
  protected final String TEXT_652 = NL + NL + "\tinit_";
  protected final String TEXT_653 = ".close();" + NL + "" + NL + "\t";
  protected final String TEXT_654 = NL + "\t\tjava.sql.Statement statement_";
  protected final String TEXT_655 = " = conn_";
  protected final String TEXT_656 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_657 = NL + "\t\t\tstatement_";
  protected final String TEXT_658 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_659 = ");" + NL + "\t\t";
  protected final String TEXT_660 = NL + NL + "\t\t";
  protected final String TEXT_661 = NL + "\t\t\tstatement_";
  protected final String TEXT_662 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_663 = ");" + NL + "\t\t";
  protected final String TEXT_664 = NL + NL + "\t\t";
  protected final String TEXT_665 = NL + "\t\t\tstatement_";
  protected final String TEXT_666 = ".execute(\"SET zookeeper.znode.parent=\"+";
  protected final String TEXT_667 = ");" + NL + "\t\t";
  protected final String TEXT_668 = NL + NL + "\t\t";
  protected final String TEXT_669 = NL + "\t\t\tstatement_";
  protected final String TEXT_670 = ".execute(\"SET hbase.security.authentication=kerberos\");" + NL + "\t\t\tstatement_";
  protected final String TEXT_671 = ".execute(\"SET hbase.rpc.engine=org.apache.hadoop.hbase.ipc.SecureRpcEngine\");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_672 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_673 = ".execute(\"SET hbase.master.kerberos.principal=\"+";
  protected final String TEXT_674 = ");" + NL + "\t\t\t";
  protected final String TEXT_675 = NL + "\t\t\t";
  protected final String TEXT_676 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_677 = ".execute(\"SET hbase.regionserver.kerberos.principal=\"+";
  protected final String TEXT_678 = ");" + NL + "\t\t\t";
  protected final String TEXT_679 = NL + "\t\t";
  protected final String TEXT_680 = NL + NL + "\t\t";
  protected final String TEXT_681 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_682 = ".execute(\"add jar \"+";
  protected final String TEXT_683 = ");" + NL + "\t\t";
  protected final String TEXT_684 = NL + "\t\tstatement_";
  protected final String TEXT_685 = ".close();" + NL + "\t";
  protected final String TEXT_686 = NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_687 = "\",conn_";
  protected final String TEXT_688 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
