...
public class TNeo4jBatchOutputMainJava
{
  protected static String nl;
  public static synchronized TNeo4jBatchOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNeo4jBatchOutputMainJava result = new TNeo4jBatchOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = NL + NL + "    // Insert the node" + NL + "    neo4jBatchNodeInserter_";
