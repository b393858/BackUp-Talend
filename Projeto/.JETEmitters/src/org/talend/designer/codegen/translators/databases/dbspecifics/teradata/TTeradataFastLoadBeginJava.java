...
public class TTeradataFastLoadBeginJava
{
  ...
  protected final String TEXT_79 = "=0;" + NL + "\t" + NL + "\tString driverClass_";
  protected final String TEXT_80 = " = \"com.teradata.jdbc.TeraDriver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_81 = ");" + NL + "\tString url_";
  protected final String TEXT_82 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_83 = "+\"/TYPE=FASTLOAD\";" + NL + "\t" + NL + "\tString dbProperties_";
  protected final String TEXT_84 = " = ";
  protected final String TEXT_85 = ";" + NL + "\tif(dbProperties_";
  protected final String TEXT_86 = " != null && dbProperties_";
  protected final String TEXT_87 = ".trim().length() > 0) {" + NL + "\t\turl_";
  protected final String TEXT_88 = " +=\",\"+dbProperties_";
  protected final String TEXT_89 = ";" + NL + "\t}" + NL + "" + NL + "\tString dbUser_";
  ...
  protected final String TEXT_101 = ";" + NL + "" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_102 = " = null;" + NL + "\t";
  protected final String TEXT_103 = NL + "\t" + NL + "\tString tableName_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "\tString dbname_";
  protected final String TEXT_106 = " = ";
  protected final String TEXT_107 = ";" + NL + "\tif(dbname_";
  protected final String TEXT_108 = " == null || dbname_";
  protected final String TEXT_109 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_110 = " = ";
  protected final String TEXT_111 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  protected final String TEXT_112 = " = dbname_";
  protected final String TEXT_113 = " + \".\" + ";
  protected final String TEXT_114 = ";" + NL + "\t}" + NL + "" + NL + "\tint commitCounter_";
  protected final String TEXT_115 = " = 0;";
  protected final String TEXT_116 = NL + "\tint commitEvery_";
  ...
  protected final String TEXT_122 = NL + NL + "\tpstmt_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".prepareStatement(\"INSERT INTO \" + tableName_";
