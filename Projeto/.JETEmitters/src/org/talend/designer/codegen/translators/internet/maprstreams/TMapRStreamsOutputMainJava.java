...
public class TMapRStreamsOutputMainJava
{
  ...
  protected final String TEXT_9 = ")," + NL + "(recordMetadata, exception) -> {" + NL + "\trev_cnt_";
  protected final String TEXT_10 = ".getAndIncrement();" + NL + "\tif (exception != null) {" + NL + "\t\texceptions_";
  protected final String TEXT_11 = ".add(exception);" + NL + "\t}" + NL + "});" + NL + "" + NL + "for (Exception e : exceptions_";
