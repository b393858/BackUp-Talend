...
public class TJDBCColumnListEndJava
{
  ...
  protected final String TEXT_76 = NL + "}" + NL + "}catch(Exception e_";
  protected final String TEXT_77 = "){";
  protected final String TEXT_78 = NL + "        throw(e_";
  protected final String TEXT_79 = ");";
  protected final String TEXT_80 = NL + "        System.err.println(e_";
  protected final String TEXT_81 = ".getMessage());";
  protected final String TEXT_82 = NL + "}finally{" + NL + "    try{" + NL + "        if(stmt2_";
  protected final String TEXT_83 = "!=null){" + NL + "            stmt2_";
  protected final String TEXT_84 = ".close();" + NL + "        }" + NL + "    }catch(Exception e2_";
  protected final String TEXT_85 = "){";
  protected final String TEXT_86 = NL + "            throw(e2_";
  protected final String TEXT_87 = ");";
  protected final String TEXT_88 = NL + "            System.err.println(e2_";
  protected final String TEXT_89 = ".getMessage());";
  protected final String TEXT_90 = NL + "    }" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_91 = "_NB_COLUMN\", nb_column_";
