...
public class TImpalaConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " = \"jdbc:hive2://\"+";
  ...
  protected final String TEXT_92 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_93 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_133 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_134 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  ...
  protected final String TEXT_141 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_144 = ".get(dsAlias_";
  protected final String TEXT_145 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_146 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_147 = " = dataSources_";
  protected final String TEXT_148 = ".get(dsAlias_";
  protected final String TEXT_149 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_150 = "\", conn_";
  protected final String TEXT_151 = ");" + NL + "\t}";
  protected final String TEXT_152 = NL + "\tif (null != conn_";
  protected final String TEXT_153 = ") {" + NL + "\t\t";
  protected final String TEXT_154 = NL + "\t}";
  protected final String TEXT_155 = NL + "\t" + NL + "\tglobalMap.put(\"db_";
