...
public class TPostgresPlusRowFinallyJava
{
  protected static String nl;
  public static synchronized TPostgresPlusRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusRowFinallyJava result = new TPostgresPlusRowFinallyJava();
    nl = null;
    return result;
  }
