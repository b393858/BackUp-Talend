...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_76 = NL + "\tString file_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "\tfile_";
  protected final String TEXT_79 = " = file_";
  protected final String TEXT_80 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "\tString fileName_";
  protected final String TEXT_81 = " = file_";
  protected final String TEXT_82 = ".substring(file_";
  protected final String TEXT_83 = ".lastIndexOf(\"/\")+1);" + NL + "\tString fileDirectory_";
  protected final String TEXT_84 = " = file_";
  protected final String TEXT_85 = ".substring(0,file_";
  protected final String TEXT_86 = ".lastIndexOf(\"/\"));" + NL + "\t" + NL + "\tString tableName_";
  protected final String TEXT_87 = " = ";
  protected final String TEXT_88 = ";" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_89 = " = null;" + NL + "\t";
  protected final String TEXT_90 = NL + "\t\tconn_";
  protected final String TEXT_91 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_92 = "\");" + NL + "\t";
  protected final String TEXT_93 = NL + "\t\tString driverClass_";
  protected final String TEXT_94 = " = \"sun.jdbc.odbc.JdbcOdbcDriver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_95 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_96 = NL + "\t\t\tString url_";
  protected final String TEXT_97 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_98 = ";" + NL + "\t\t";
  protected final String TEXT_99 = NL + "\t\t\tString url_";
  protected final String TEXT_100 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  ...
  protected final String TEXT_120 = NL + "\t\tString atnParams_";
  protected final String TEXT_121 = " = ";
  protected final String TEXT_122 = ";" + NL + "\t\tatnParams_";
  protected final String TEXT_123 = " = atnParams_";
  protected final String TEXT_124 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_125 = " = new java.util.Properties();" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_126 = ".put(\"user\",dbUser_";
  protected final String TEXT_127 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_128 = ".put(\"password\",dbPwd_";
  protected final String TEXT_129 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_130 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_131 = ".getBytes()));" + NL + "\t  " + NL + "\t\tconn_";
  protected final String TEXT_132 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_133 = ", atnParamsPrope_";
  ...
  protected final String TEXT_308 = ".getTables(null, dbschema_";
  protected final String TEXT_309 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_310 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_311 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_312 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_320 = ".getTables(";
  protected final String TEXT_321 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_348 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_365 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_384 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_388 = " - Creating table ";
  ...
  protected final String TEXT_396 = " - Create table ";
  ...
  protected final String TEXT_406 = " - Clearing table ";
  protected final String TEXT_407 = "\" + tableName_";
  protected final String TEXT_408 = " + \"";
  protected final String TEXT_409 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_410 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_411 = ".executeUpdate(\"";
  protected final String TEXT_412 = "\");" + NL + "\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_414 = "- Clear table ";
  ...
  protected final String TEXT_429 = " - Trancating table ";
  ...
  protected final String TEXT_437 = " - Truncate table ";
  ...
  protected final String TEXT_448 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_449 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_450 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_451 = " " + NL;
  protected final String TEXT_452 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_453 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_454 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_455 = " + \";HDR=";
  protected final String TEXT_456 = "].[\" + fileName_";
  protected final String TEXT_457 = " + \"]\";" + NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_460 = NL + "    \t\tlog.debug(\"";
  protected final String TEXT_461 = " - Bulk SQL:\"+bulkInsert_";
  protected final String TEXT_462 = "+\".\");" + NL + "    \t\tlog.info(\"";
  protected final String TEXT_463 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_464 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_465 = NL + "\t\tstmt_";
  protected final String TEXT_466 = ".execute(bulkInsert_";
  protected final String TEXT_467 = ");" + NL + "" + NL + "\t\tstmt_";
  protected final String TEXT_468 = ".close();" + NL + "\t\t";
  protected final String TEXT_469 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_470 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_471 = " + \" has finished.\");" + NL + "    \t";
