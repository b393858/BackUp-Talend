...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_82 = NL + "\tString dbProperties_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "\tString url_";
  protected final String TEXT_85 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_86 = " == null || dbProperties_";
  protected final String TEXT_87 = ".trim().length() == 0) {" + NL + "\t    url_";
  protected final String TEXT_88 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_89 = " + \":\" + ";
  protected final String TEXT_90 = " + \"/\" + ";
  protected final String TEXT_91 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t} else {" + NL + "\t\tString properties_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = ";" + NL + "\t\tif (!properties_";
  protected final String TEXT_94 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_95 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "" + NL + "\t    url_";
  protected final String TEXT_96 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_97 = " + \":\" + ";
  protected final String TEXT_98 = " + \"/\" + ";
  protected final String TEXT_99 = " + \"?\" + properties_";
  ...
  protected final String TEXT_112 = ";" + NL + "\tjava.lang.Class.forName(\"";
  ...
  protected final String TEXT_136 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_140 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_168 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_188 = NL + "                    String keyCheckTable_";
  protected final String TEXT_189 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_190 = "+\"][\"+";
  protected final String TEXT_191 = "+\"][\"+";
  protected final String TEXT_192 = "+\"][\"+";
  protected final String TEXT_193 = "+\"][\"+";
  protected final String TEXT_194 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_195 = " + \"]\";";
  protected final String TEXT_196 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_199 = " + \"]\";";
  protected final String TEXT_200 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_201 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_202 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_203 = ")== null){//}";
  protected final String TEXT_204 = NL + "                                boolean whetherExist_";
  protected final String TEXT_205 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_208 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_209 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_210 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_211 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_220 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_221 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_222 = " = dbMetaData_";
  protected final String TEXT_223 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_224 = ", tableNameForSearch_";
  protected final String TEXT_225 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_226 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_227 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_233 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_251 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_252 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_253 = " = dbMetaData_";
  protected final String TEXT_254 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_279 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_280 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_281 = " == null || dbschema_";
  protected final String TEXT_282 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_283 = " = conn_";
  protected final String TEXT_284 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_285 = " = stmtSchema_";
  protected final String TEXT_286 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_287 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_288 = " = rsSchema_";
  protected final String TEXT_289 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_309 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_327 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_328 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_329 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_330 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_331 = " = conn_";
  protected final String TEXT_332 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_333 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_334 = " = dbMetaData_";
  protected final String TEXT_335 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_336 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_337 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_338 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_339 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_340 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_341 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_342 = " = conn_";
  protected final String TEXT_343 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_344 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_345 = " = dbMetaData_";
  protected final String TEXT_346 = ".getTables(";
  protected final String TEXT_347 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_348 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_349 = " = rsTable_";
  protected final String TEXT_350 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_351 = ".equalsIgnoreCase(";
  protected final String TEXT_352 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_353 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_354 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_355 = " = conn_";
  protected final String TEXT_356 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_357 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_358 = " = dbMetaData_";
  protected final String TEXT_359 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_363 = ".equalsIgnoreCase(";
  protected final String TEXT_364 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_365 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_366 = NL + "                                if(!whetherExist_";
  protected final String TEXT_367 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_375 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_382 = NL + "                                        stmtCreate_";
  protected final String TEXT_383 = ".execute(\"";
  protected final String TEXT_384 = ")\");";
  protected final String TEXT_385 = NL + "                                    }" + NL + "                                }";
  protected final String TEXT_386 = NL + "                                if(whetherExist_";
  protected final String TEXT_387 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_400 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_408 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_419 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_420 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_421 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_432 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_433 = " = conn_";
  protected final String TEXT_434 = ".createStatement()) {";
  protected final String TEXT_435 = NL + "                              stmtTruncCount_";
  protected final String TEXT_436 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_437 = "));";
  protected final String TEXT_438 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_439 = " = stmtTruncCount_";
  protected final String TEXT_440 = ".executeQuery(\"";
  protected final String TEXT_441 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_442 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_443 = " = rsTruncCount_";
  protected final String TEXT_444 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_450 = NL + "                conn_";
  protected final String TEXT_451 = ".commit();";
  protected final String TEXT_452 = NL + "                stmtTrunc_";
  protected final String TEXT_453 = ".executeUpdate(\"";
  protected final String TEXT_454 = "\");";
  protected final String TEXT_455 = NL + "                    if(!conn_";
  protected final String TEXT_456 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_457 = ".commit();" + NL + "                    }";
  protected final String TEXT_458 = NL + "                deletedCount_";
  protected final String TEXT_459 = " += rsTruncCountNumber_";
  protected final String TEXT_460 = ";" + NL + "            }";
  protected final String TEXT_461 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_477 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_478 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_479 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_480 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_481 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_482 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_483 = ".append (\"`\" +  ";
  protected final String TEXT_484 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_485 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_506 = "    " + NL + "" + NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_507 = " = conn_";
  protected final String TEXT_508 = ".prepareStatement(insert_";
  protected final String TEXT_509 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_510 = "\", pstmt_";
  protected final String TEXT_511 = ");" + NL;
  protected final String TEXT_512 = NL + "\t            class BufferLine_";
  protected final String TEXT_513 = " {" + NL + "    \t            ";
  protected final String TEXT_514 = NL + "                            ";
  protected final String TEXT_515 = " ";
  protected final String TEXT_516 = ";";
  protected final String TEXT_517 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_518 = "(";
  protected final String TEXT_519 = NL + "                                ,";
  protected final String TEXT_520 = NL + "                            ";
  protected final String TEXT_521 = " ";
  protected final String TEXT_522 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_523 = NL + "                                this.";
  protected final String TEXT_524 = " = ";
  protected final String TEXT_525 = ";";
  protected final String TEXT_526 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_527 = "> exInsertColValueList";
  protected final String TEXT_528 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_529 = " exInsertColValue";
  protected final String TEXT_530 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_531 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_532 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_533 = ".append(\"(";
  protected final String TEXT_534 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_535 = "-1) extendInsertValueStmt_";
  protected final String TEXT_536 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_537 = " = \"INSERT INTO `\"+";
  protected final String TEXT_538 = "+\"` (";
  protected final String TEXT_539 = ") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_556 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_557 = "\", pstmt_";
  protected final String TEXT_558 = ");" + NL + "\t            String insertColName";
  protected final String TEXT_559 = " = \"";
  protected final String TEXT_560 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_561 = " =  \"";
  protected final String TEXT_562 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_563 = " = 0;";
  protected final String TEXT_564 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_565 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_566 = " + \"` (";
  protected final String TEXT_567 = ") VALUES (";
  protected final String TEXT_568 = ")\";";
  protected final String TEXT_569 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_570 = " += \tduplidateClause_";
  protected final String TEXT_571 = ".toString();";
  protected final String TEXT_572 = NL + "\t\t        int batchSize_";
  protected final String TEXT_573 = " = ";
  protected final String TEXT_574 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_575 = "=0;" + NL + "\t\t        ";
  ...
  protected final String TEXT_591 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_603 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_609 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_613 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_614 = "\", pstmt_";
  protected final String TEXT_615 = ");" + NL + "\t    String insert_";
  protected final String TEXT_616 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_617 = " + \"` (";
  protected final String TEXT_618 = ") VALUES (";
  ...
  protected final String TEXT_628 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_629 = " = conn_";
  protected final String TEXT_630 = ".prepareStatement(insert_";
  protected final String TEXT_631 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_632 = "\", pstmtInsert_";
  protected final String TEXT_633 = ");" + NL + "\t    String update_";
  protected final String TEXT_634 = " = \"UPDATE `\" + ";
  protected final String TEXT_635 = " + \"` SET ";
  protected final String TEXT_636 = " WHERE ";
  protected final String TEXT_637 = "\";" + NL + "\t    ";
  protected final String TEXT_638 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_639 = " = new StringBuffer(update_";
  protected final String TEXT_640 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_641 = ".insert(update_";
  protected final String TEXT_642 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_643 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_644 = " =updateStringBuffer_";
  protected final String TEXT_645 = ".toString(); ";
  protected final String TEXT_646 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_647 = " = conn_";
  protected final String TEXT_648 = ".prepareStatement(update_";
  protected final String TEXT_649 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_650 = "\", pstmtUpdate_";
  protected final String TEXT_651 = ");";
  protected final String TEXT_652 = NL + "\t    String update_";
  protected final String TEXT_653 = " = \"UPDATE `\" + ";
  protected final String TEXT_654 = " + \"` SET ";
  protected final String TEXT_655 = " WHERE ";
  protected final String TEXT_656 = "\";" + NL + "\t    ";
  protected final String TEXT_657 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_658 = " = new StringBuffer(update_";
  protected final String TEXT_659 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_660 = ".insert(update_";
  protected final String TEXT_661 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_662 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_663 = " =updateStringBuffer_";
  protected final String TEXT_664 = ".toString(); ";
  protected final String TEXT_665 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_666 = " = conn_";
  protected final String TEXT_667 = ".prepareStatement(update_";
  protected final String TEXT_668 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_669 = "\", pstmtUpdate_";
  protected final String TEXT_670 = ");" + NL + "\t    String insert_";
  protected final String TEXT_671 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_683 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_684 = " = conn_";
  protected final String TEXT_685 = ".prepareStatement(insert_";
  protected final String TEXT_686 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_687 = "\", pstmtInsert_";
  protected final String TEXT_688 = ");";
  protected final String TEXT_689 = NL + "\t    String delete_";
  protected final String TEXT_690 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_691 = " + \"` WHERE ";
  protected final String TEXT_692 = "\";" + NL + "\t    ";
  protected final String TEXT_693 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_694 = " = new StringBuffer(delete_";
  protected final String TEXT_695 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_696 = ".insert(delete_";
  protected final String TEXT_697 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_698 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_699 = " =deleteStringBuffer_";
  protected final String TEXT_700 = ".toString();  ";
  protected final String TEXT_701 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_702 = " = conn_";
  protected final String TEXT_703 = ".prepareStatement(delete_";
  protected final String TEXT_704 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_705 = "\", pstmt_";
  protected final String TEXT_706 = ");";
  protected final String TEXT_707 = NL + "\t    String replace_";
  protected final String TEXT_708 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_709 = " + \"` (";
  protected final String TEXT_710 = ") VALUES (";
  protected final String TEXT_711 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_712 = " = conn_";
  protected final String TEXT_713 = ".prepareStatement(replace_";
  protected final String TEXT_714 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_725 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_726 = "\", pstmt_";
  protected final String TEXT_727 = ");";
  protected final String TEXT_728 = NL + "\t    String insert_";
  ...
  protected final String TEXT_733 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_734 = " = new StringBuffer(insert_";
  protected final String TEXT_735 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_736 = ".insert(insert_";
  protected final String TEXT_737 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_738 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_739 = " =insertStringBuffer_";
  protected final String TEXT_740 = ".toString(); ";
  protected final String TEXT_741 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_742 = " = conn_";
  protected final String TEXT_743 = ".prepareStatement(insert_";
  protected final String TEXT_744 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_745 = "\", pstmt_";
  protected final String TEXT_746 = ");";
  protected final String TEXT_747 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_756 = NL + "\t\t\tupdate_";
  protected final String TEXT_757 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_758 = " = update_";
  protected final String TEXT_759 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_760 = " = insert_";
  protected final String TEXT_761 = ".split(\"\\\\?\");";
  protected final String TEXT_762 = NL + "\t\t\tdelete_";
  protected final String TEXT_763 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_764 = " = delete_";
  protected final String TEXT_765 = ".split(\"\\\\?\");";
  protected final String TEXT_766 = NL + "\t\t\treplace_";
  protected final String TEXT_767 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_768 = " = replace_";
  protected final String TEXT_769 = ".split(\"\\\\?\");";
  protected final String TEXT_770 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_771 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_772 = " = insertIgnore_";
  protected final String TEXT_773 = ".split(\"\\\\?\");";
  protected final String TEXT_774 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_775 = " = insert_";
  protected final String TEXT_776 = ".split(\"\\\\?\");";
  protected final String TEXT_777 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_778 = " {" + NL + "    \t            ";
  protected final String TEXT_779 = NL + "                            ";
  protected final String TEXT_780 = " ";
  protected final String TEXT_781 = ";";
  protected final String TEXT_782 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_783 = ";" + NL + "\t\t\t";
  protected final String TEXT_784 = NL + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_792 = NL + "                                this.";
  protected final String TEXT_793 = " = ";
  protected final String TEXT_794 = ";";
  protected final String TEXT_795 = NL + "\t\t\t\tthis.";
  protected final String TEXT_796 = "=";
  protected final String TEXT_797 = ";" + NL + "\t\t\t";
  protected final String TEXT_798 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_799 = "> exInsertColValueList";
  protected final String TEXT_800 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_801 = " exInsertColValue";
  protected final String TEXT_802 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_803 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_804 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_805 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_806 = "=1;";
  protected final String TEXT_807 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_808 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_809 = "=0;";
  protected final String TEXT_810 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_811 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_812 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_813 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_814 = "=0;" + NL + "\t";
  protected final String TEXT_815 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_816 = " = null;" + NL + "\t\t";
  protected final String TEXT_817 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_818 = " = null;";
  protected final String TEXT_819 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_820 = " =  null;";
  protected final String TEXT_821 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_822 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_823 = " = null;";
  protected final String TEXT_824 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_825 = " = null;";
  protected final String TEXT_826 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_830 = NL + "\t\t \tString[] insertSQLSplits_";
