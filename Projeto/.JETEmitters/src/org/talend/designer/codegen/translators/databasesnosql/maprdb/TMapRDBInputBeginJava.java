...
public class TMapRDBInputBeginJava
{
  protected static String nl;
  public static synchronized TMapRDBInputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapRDBInputBeginJava result = new TMapRDBInputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_275 = " = rr_";
  protected final String TEXT_276 = ".getColumnLatest(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_277 = "),org.apache.hadoop.hbase.util.Bytes.toBytes(\"";
  protected final String TEXT_278 = "\")).getTimestamp();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"Output Timestamp Column should be long-typed\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_288 = NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_289 = "' in '";
  protected final String TEXT_290 = "' connection, value is invalid or this column should be nullable or have a default value.\");\t\t\t\t\t\t\t\t\t";
...
if ((metadatas!=null) && (metadatas.size() > 0)) {
    ...
    stringBuffer.append(timestampColumn );
