...
public class TIngresInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_229 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_230 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_296 = NL + "\t\t    \tlog.debug(\"";
  ...
  protected final String TEXT_357 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_358 = ".getColumnTypeName(i_";
  protected final String TEXT_359 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_360 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_361 = ".getClob(i_";
  protected final String TEXT_362 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_363 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_364 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_365 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_366 = ".add(tNTextImpl_";
  protected final String TEXT_367 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_368 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_369 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_370 = ".getColumnTypeName(i_";
  protected final String TEXT_371 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_372 = ".add(rs_";
  protected final String TEXT_373 = ".getString(i_";
  protected final String TEXT_374 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_375 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_376 = ".";
  protected final String TEXT_377 = ", rs_";
  protected final String TEXT_378 = ", fixedColumnCount_";
  protected final String TEXT_379 = ",list_";
  protected final String TEXT_380 = ",";
  protected final String TEXT_381 = ");";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_383 = ".";
  protected final String TEXT_384 = ", rs_";
  protected final String TEXT_385 = ", fixedColumnCount_";
  protected final String TEXT_386 = ",";
  protected final String TEXT_387 = ");";
  protected final String TEXT_388 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_389 = ".";
  protected final String TEXT_390 = ", rs_";
  protected final String TEXT_391 = ", fixedColumnCount_";
  protected final String TEXT_392 = ",";
  protected final String TEXT_393 = ");";
  protected final String TEXT_394 = NL + "                                  Object geom = rs_";
  protected final String TEXT_395 = ".getObject(";
  protected final String TEXT_396 = "column_index_";
  protected final String TEXT_397 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_406 = " - Retrieving the record \" + nb_line_";
