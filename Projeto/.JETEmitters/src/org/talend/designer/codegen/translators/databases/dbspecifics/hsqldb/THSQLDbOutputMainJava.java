...
public class THSQLDbOutputMainJava {
  ...
  protected final String TEXT_99 = "_QUERY\", query_";
  protected final String TEXT_100 = ".toString().trim());";
  ...
  protected final String TEXT_128 = NL + "            int checkCount_";
  protected final String TEXT_129 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_130 = " = pstmt_";
  protected final String TEXT_131 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_132 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_133 = " = rs_";
  protected final String TEXT_134 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_146 = ".toString().trim());";
  ...
  protected final String TEXT_165 = NL + "                            rejectedCount_";
  protected final String TEXT_166 = " = rejectedCount_";
  protected final String TEXT_167 = " + 1;";
  protected final String TEXT_168 = NL + "                            ";
  protected final String TEXT_169 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_174 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_175 = NL + "                        ";
  protected final String TEXT_176 = NL + "                            query_";
  protected final String TEXT_177 = " = ";
  protected final String TEXT_178 = ";";
  protected final String TEXT_179 = NL + "                    globalMap.put(\"";
  protected final String TEXT_180 = "_QUERY\", query_";
  protected final String TEXT_181 = ".toString().trim());";
  protected final String TEXT_182 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_183 = " = insertedCount_";
  protected final String TEXT_184 = " + pstmtInsert_";
  protected final String TEXT_185 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_186 = "++;";
  protected final String TEXT_187 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_188 = " = true;";
  protected final String TEXT_189 = NL + "                        throw(e);";
  protected final String TEXT_190 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_206 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_207 = ";";
  protected final String TEXT_208 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_209 = NL + "                }" + NL + "            }";
  protected final String TEXT_210 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_217 = NL + "                        query_";
  protected final String TEXT_218 = " = ";
  protected final String TEXT_219 = ";";
  protected final String TEXT_220 = NL + "                globalMap.put(\"";
  protected final String TEXT_221 = "_QUERY\", query_";
  protected final String TEXT_222 = ".toString().trim());";
  protected final String TEXT_223 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_224 = "=pstmtUpdate_";
  protected final String TEXT_225 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_226 = " = updatedCount_";
  protected final String TEXT_227 = " + updateFlag_";
  protected final String TEXT_228 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_239 = NL + "                    insertedCount_";
  protected final String TEXT_240 = " = insertedCount_";
  protected final String TEXT_241 = " + pstmtInsert_";
  protected final String TEXT_242 = ".executeUpdate();  " + NL + "         \t\t\tnb_line_";
  protected final String TEXT_243 = "++;";
  protected final String TEXT_244 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_245 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_246 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_259 = NL + "                            rejectedCount_";
  protected final String TEXT_260 = " = rejectedCount_";
  ...
  protected final String TEXT_276 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_277 = " = deletedCount_";
  protected final String TEXT_278 = " + pstmt_";
  protected final String TEXT_279 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_280 = "++;";
  protected final String TEXT_281 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_294 = NL + "                        rejectedCount_";
  protected final String TEXT_295 = " = rejectedCount_";
  protected final String TEXT_296 = " + 1;";
  protected final String TEXT_297 = NL + "                        ";
  protected final String TEXT_298 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_299 = NL + "                        ";
  protected final String TEXT_300 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_301 = ";";
  protected final String TEXT_302 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_303 = NL + "            }";
  protected final String TEXT_304 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_316 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_317 = " <= commitCounter_";
  protected final String TEXT_318 = ") {" + NL + "            \t";
  protected final String TEXT_319 = NL + "                conn_";
  protected final String TEXT_320 = ".commit();" + NL + "\t\t\t\t";
  protected final String TEXT_321 = "                " + NL + "                commitCounter_";
  protected final String TEXT_322 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
