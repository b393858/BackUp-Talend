...
public class TSQLiteOutputMainJava {
  ...
  protected final String TEXT_145 = NL + "            int checkCount_";
  protected final String TEXT_146 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_147 = " = pstmt_";
  protected final String TEXT_148 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_149 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_150 = " = rs_";
  protected final String TEXT_151 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_187 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_221 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_253 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_309 = NL + "                }" + NL + "            }else{" + NL + "            \tnb_line_";
  protected final String TEXT_310 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_311 = NL + "            }";
  protected final String TEXT_312 = NL + "\t\t\t\t\t";
  protected final String TEXT_313 = NL + "                    \t";
  protected final String TEXT_314 = NL + "\t                        query_";
  protected final String TEXT_315 = " = ";
  protected final String TEXT_316 = ";" + NL + "\t                        ";
  protected final String TEXT_317 = NL + "                    ";
  protected final String TEXT_318 = NL + "                        query_";
  protected final String TEXT_319 = " = ";
  protected final String TEXT_320 = ";";
  protected final String TEXT_321 = NL + "                globalMap.put(\"";
  protected final String TEXT_322 = "_QUERY\", query_";
  protected final String TEXT_323 = ".toString().trim());";
  protected final String TEXT_324 = NL + "                     pstmt_";
  protected final String TEXT_325 = ".addBatch();" + NL + "                     batchSizeCounter_";
  protected final String TEXT_326 = "++;" + NL + "                     nb_line_";
  protected final String TEXT_327 = "++;";
  protected final String TEXT_328 = NL + "                      try {" + NL + "                          deletedCount_";
  protected final String TEXT_329 = " = deletedCount_";
  protected final String TEXT_330 = " + pstmt_";
  protected final String TEXT_331 = ".executeUpdate();" + NL + "                          nb_line_";
  protected final String TEXT_332 = "++;";
  protected final String TEXT_333 = NL + "                      } catch(java.lang.Exception e) {" + NL + "                          whetherReject_";
  protected final String TEXT_334 = " = true;";
  protected final String TEXT_335 = NL + "                              throw(e);";
  protected final String TEXT_336 = NL + "                               nb_line_";
  protected final String TEXT_337 = "++;";
  protected final String TEXT_338 = NL + "                                  ";
  protected final String TEXT_339 = " = new ";
  protected final String TEXT_340 = "Struct();";
  protected final String TEXT_341 = NL + "                                      ";
  protected final String TEXT_342 = ".";
  protected final String TEXT_343 = " = ";
  protected final String TEXT_344 = ".";
  protected final String TEXT_345 = ";";
  protected final String TEXT_346 = NL + "                                  nb_line_rejected_";
  protected final String TEXT_347 = "++;";
  protected final String TEXT_348 = NL + "                                  ";
  protected final String TEXT_349 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_350 = NL + "                                  ";
  protected final String TEXT_351 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_352 = ";";
  protected final String TEXT_353 = NL + "                                  System.err.print(e.getMessage());";
  protected final String TEXT_354 = NL + "                      }";
  protected final String TEXT_355 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_366 = NL + "                if ((batchSize_";
  protected final String TEXT_367 = " > 0) && (batchSize_";
  protected final String TEXT_368 = " <= batchSizeCounter_";
  protected final String TEXT_369 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_370 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_371 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_372 = " = 0;";
  protected final String TEXT_373 = NL + "                        status_";
  protected final String TEXT_374 = " = pstmt_";
  protected final String TEXT_375 = ".executeBatch();";
  protected final String TEXT_376 = NL + "                        for(int countEach_";
  protected final String TEXT_377 = ": status_";
  protected final String TEXT_378 = ") {" + NL + "                            countSum_";
  protected final String TEXT_379 = " += (countEach_";
  protected final String TEXT_380 = " < 0 ? 0 : countEach_";
  protected final String TEXT_381 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_382 = NL + "                            throw(e);";
  protected final String TEXT_383 = NL + "                        for(int countEach_";
  protected final String TEXT_384 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_385 = " += (countEach_";
  protected final String TEXT_386 = " < 0 ? 0 : countEach_";
  protected final String TEXT_387 = ");" + NL + "                        }";
  protected final String TEXT_388 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_389 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_390 = " = pstmt_";
  protected final String TEXT_391 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_392 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_393 = " = tmp_batchUpdateCount_";
  protected final String TEXT_394 = " > countSum_";
  protected final String TEXT_395 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_396 = " : countSum_";
  ...
  protected final String TEXT_405 = " += tmp_batchUpdateCount_";
  protected final String TEXT_406 = ";";
  protected final String TEXT_407 = NL + "               }";
  protected final String TEXT_408 = NL + "                commitCounter_";
  protected final String TEXT_409 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_410 = " <= commitCounter_";
  protected final String TEXT_411 = ") {";
  protected final String TEXT_412 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_413 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_414 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_415 = NL + "\t                    for(int countEach_";
  protected final String TEXT_416 = ": pstmt_";
  protected final String TEXT_417 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_418 = " += (countEach_";
  protected final String TEXT_419 = " < 0 ? 0 : countEach_";
  protected final String TEXT_420 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_421 = NL + "\t                    ";
  protected final String TEXT_422 = NL + "\t                        insertedCount_";
  protected final String TEXT_423 = " += countSum_";
  protected final String TEXT_424 = ";" + NL + "\t                    ";
  protected final String TEXT_425 = NL + "\t                        updatedCount_";
  protected final String TEXT_426 = " += countSum_";
  protected final String TEXT_427 = ";" + NL + "\t                    ";
  protected final String TEXT_428 = NL + "\t                        deletedCount_";
  protected final String TEXT_429 = " += countSum_";
  protected final String TEXT_430 = ";" + NL + "\t                    ";
  protected final String TEXT_431 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_432 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_433 = NL + "                        throw(e);";
  protected final String TEXT_434 = NL + "                        int countSum_";
  protected final String TEXT_435 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_436 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_437 = " += (countEach_";
  protected final String TEXT_438 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_446 = NL + "                            deletedCount_";
  protected final String TEXT_447 = " += countSum_";
  protected final String TEXT_448 = ";";
  protected final String TEXT_449 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_454 = NL + "                commitCounter_";
