...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_50 = NL + NL + "            if(dbschema_";
  ...
  protected final String TEXT_60 = NL + "  \ttableName_";
  protected final String TEXT_61 = " += \" \" +";
  protected final String TEXT_62 = ";";
  protected final String TEXT_63 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_67 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_68 = ")));";
  protected final String TEXT_69 = NL + "                stmtDrop_";
  protected final String TEXT_70 = ".execute(\"";
  protected final String TEXT_71 = "\" ";
  protected final String TEXT_72 = ");";
  protected final String TEXT_73 = NL + "            }";
  protected final String TEXT_74 = NL + "                 conn_";
  protected final String TEXT_75 = ".commit();";
  protected final String TEXT_76 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_80 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_81 = "));";
  protected final String TEXT_82 = NL + "                        stmtCreate_";
  protected final String TEXT_83 = ".execute(((\"";
  protected final String TEXT_84 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_85 = ".";
  protected final String TEXT_86 = ", \"";
  protected final String TEXT_87 = "\")";
  protected final String TEXT_88 = ".toUpperCase()";
  ...
  protected final String TEXT_95 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_115 = NL + "                    String keyCheckTable_";
  protected final String TEXT_116 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_123 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_126 = " + \"]\";";
  protected final String TEXT_127 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_128 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_129 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_130 = ")== null){//}";
  protected final String TEXT_131 = NL + "                                boolean whetherExist_";
  protected final String TEXT_132 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_133 = " = conn_";
  protected final String TEXT_134 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_138 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_139 = NL + "                                ";
  protected final String TEXT_140 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_143 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_144 = " = tableNameForSearch_";
  protected final String TEXT_145 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_146 = " = tableNameForSearch_";
  protected final String TEXT_147 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_148 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_152 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_153 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_154 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_155 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_156 = " = conn_";
  protected final String TEXT_157 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_158 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_171 = "IgnoreCase";
  protected final String TEXT_172 = "(dbschema_";
  protected final String TEXT_173 = ") || dbschema_";
  protected final String TEXT_174 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_175 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_176 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_179 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_180 = " = dbMetaData_";
  protected final String TEXT_181 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_200 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_201 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_204 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_211 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_212 = " = stmtSchema_";
  protected final String TEXT_213 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_214 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_215 = " = rsSchema_";
  protected final String TEXT_216 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_236 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_237 = NL + "                                String tableForSearch_";
  protected final String TEXT_238 = " = ";
  protected final String TEXT_239 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_240 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_241 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_242 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_243 = " =  tableForSearch_";
  protected final String TEXT_244 = ".substring(1,tableForSearch_";
  protected final String TEXT_245 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_246 = " =  tableForSearch_";
  protected final String TEXT_247 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_250 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_251 = " = dbMetaData_";
  protected final String TEXT_252 = ".getTables(null, conn_";
  protected final String TEXT_253 = ".getSchema(), tableForSearch_";
  protected final String TEXT_254 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_255 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_256 = " = true;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_273 = ".getTables(";
  protected final String TEXT_274 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_283 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_284 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_285 = " = dbMetaData_";
  protected final String TEXT_286 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_292 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_293 = NL + "                                if(!whetherExist_";
  protected final String TEXT_294 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_295 = " = conn_";
  protected final String TEXT_296 = ".createStatement()) {";
  protected final String TEXT_297 = NL + "                                                      stmtCreate_";
  protected final String TEXT_298 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_299 = "));";
  protected final String TEXT_300 = NL + "                                            stmtCreate_";
  protected final String TEXT_301 = ".execute(((\"";
  protected final String TEXT_302 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_314 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".createStatement()) {";
  protected final String TEXT_317 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_326 = ".commit();";
  protected final String TEXT_327 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_331 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_332 = "));";
  protected final String TEXT_333 = NL + "                                        stmtCreate_";
  protected final String TEXT_334 = ".execute(((\"";
  protected final String TEXT_335 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_336 = ".";
  protected final String TEXT_337 = ", \"";
  protected final String TEXT_338 = "\")";
  protected final String TEXT_339 = ".toUpperCase()";
  ...
  protected final String TEXT_346 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_347 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_348 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_354 = NL + "                stmtClear_";
  protected final String TEXT_355 = ".executeUpdate(\"";
  protected final String TEXT_356 = "\");";
  protected final String TEXT_357 = NL + "            }";
  protected final String TEXT_358 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_359 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_360 = " = conn_";
  protected final String TEXT_361 = ".createStatement()) {";
  protected final String TEXT_362 = NL + "                              stmtTruncCount_";
  protected final String TEXT_363 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_364 = "));";
  protected final String TEXT_365 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_366 = " = stmtTruncCount_";
  protected final String TEXT_367 = ".executeQuery(\"";
  protected final String TEXT_368 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_369 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_370 = " = rsTruncCount_";
  protected final String TEXT_371 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_378 = ".commit();";
  protected final String TEXT_379 = NL + "                stmtTrunc_";
  protected final String TEXT_380 = ".executeUpdate(\"";
  protected final String TEXT_381 = "\");";
  protected final String TEXT_382 = NL + "                    if(!conn_";
  protected final String TEXT_383 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_384 = ".commit();" + NL + "                    }";
  protected final String TEXT_385 = NL + "                deletedCount_";
  protected final String TEXT_386 = " += rsTruncCountNumber_";
  protected final String TEXT_387 = ";" + NL + "            }";
  protected final String TEXT_388 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_404 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_439 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_440 = "\", pstmt_";
  ...
  protected final String TEXT_453 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_454 = ", pstmt_";
  protected final String TEXT_455 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_456 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_478 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_479 = " = new StringBuffer(update_";
  protected final String TEXT_480 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_481 = ".insert(update_";
  protected final String TEXT_482 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_483 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_484 = " =updateStringBuffer_";
  protected final String TEXT_485 = ".toString(); ";
  protected final String TEXT_486 = NL + "                    pstmt_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".prepareStatement(update_";
  protected final String TEXT_489 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_494 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_495 = " + \" WHERE ";
  protected final String TEXT_496 = "\");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_497 = "\", pstmt_";
  ...
  protected final String TEXT_548 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_549 = " = conn_";
  protected final String TEXT_550 = ".prepareStatement(insert_";
  protected final String TEXT_551 = ");" + NL + "                    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_552 = "\", pstmtInsert_";
  protected final String TEXT_553 = ");";
  protected final String TEXT_554 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_555 = " = new StringBuffer(update_";
  protected final String TEXT_556 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_557 = ".insert(update_";
  protected final String TEXT_558 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_559 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_560 = " =updateStringBuffer_";
  ...
  protected final String TEXT_565 = ");" + NL + "                    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_566 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_587 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_593 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_594 = ".";
  protected final String TEXT_595 = ", \"";
  protected final String TEXT_596 = "\")";
  protected final String TEXT_597 = ".toUpperCase()";
  ...
  protected final String TEXT_602 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_603 = ".";
  protected final String TEXT_604 = ", \"";
  protected final String TEXT_605 = "\")";
  protected final String TEXT_606 = ".toUpperCase()";
  protected final String TEXT_607 = "+\" WHERE ";
  protected final String TEXT_608 = "\";";
  protected final String TEXT_609 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_610 = " = new StringBuffer(update_";
  protected final String TEXT_611 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_612 = ".insert(update_";
  protected final String TEXT_613 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_614 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_615 = " =updateStringBuffer_";
  protected final String TEXT_616 = ".toString(); ";
  protected final String TEXT_617 = NL + "                    pstmtUpdate_";
  protected final String TEXT_618 = " = conn_";
  protected final String TEXT_619 = ".prepareStatement(update_";
  protected final String TEXT_620 = ");" + NL + "                    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_621 = "\", pstmtUpdate_";
  protected final String TEXT_622 = ");";
  protected final String TEXT_623 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_624 = " = new StringBuffer(insert_";
  protected final String TEXT_625 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_626 = ".insert(insert_";
  protected final String TEXT_627 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_628 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_629 = " =insertStringBuffer_";
  protected final String TEXT_630 = ".toString(); ";
  protected final String TEXT_631 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_632 = " = conn_";
  protected final String TEXT_633 = ".prepareStatement(insert_";
  protected final String TEXT_634 = ");" + NL + "                    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_635 = "\", pstmtInsert_";
  protected final String TEXT_636 = ");";
  protected final String TEXT_637 = NL + "                    String delete_";
  protected final String TEXT_638 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_639 = " + \" WHERE ";
  protected final String TEXT_640 = "\";";
  protected final String TEXT_641 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_642 = " = new StringBuffer(delete_";
  protected final String TEXT_643 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_644 = ".insert(delete_";
  protected final String TEXT_645 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_646 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_647 = " =deleteStringBuffer_";
  protected final String TEXT_648 = ".toString();  ";
  protected final String TEXT_649 = NL + "                    pstmt_";
  protected final String TEXT_650 = " = conn_";
  protected final String TEXT_651 = ".prepareStatement(delete_";
  protected final String TEXT_652 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_653 = "\", pstmt_";
  protected final String TEXT_654 = ");";
  protected final String TEXT_655 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_656 = " = insert_";
  protected final String TEXT_657 = ".split(\"\\\\?\");";
  protected final String TEXT_658 = NL + "\t\t\tupdate_";
  protected final String TEXT_659 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_660 = " = update_";
  protected final String TEXT_661 = ".split(\"\\\\?\");";
  protected final String TEXT_662 = NL + "\t\t\tupdate_";
  protected final String TEXT_663 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_664 = " = update_";
  protected final String TEXT_665 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_666 = " = insert_";
  protected final String TEXT_667 = ".split(\"\\\\?\");";
  protected final String TEXT_668 = NL + "\t\t\tdelete_";
  protected final String TEXT_669 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_670 = " = delete_";
  protected final String TEXT_671 = ".split(\"\\\\?\");";
  protected final String TEXT_672 = NL + "\t\t\treplace_";
  protected final String TEXT_673 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_674 = " = replace_";
  protected final String TEXT_675 = ".split(\"\\\\?\");";
  protected final String TEXT_676 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_677 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_678 = " = insertIgnore_";
  protected final String TEXT_679 = ".split(\"\\\\?\");";
  protected final String TEXT_680 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_681 = " = insert_";
  protected final String TEXT_682 = ".split(\"\\\\?\");";
  protected final String TEXT_683 = NL + "        }";
  protected final String TEXT_684 = NL + "        query_";
  protected final String TEXT_685 = " = new StringBuffer(\"\");";
  protected final String TEXT_686 = NL + "                commitEvery_";
  protected final String TEXT_687 = " = buffersSize_";
  protected final String TEXT_688 = ";";
  protected final String TEXT_689 = NL + "            batchSize_";
  protected final String TEXT_690 = " = buffersSize_";
  protected final String TEXT_691 = ";";
  protected final String TEXT_692 = NL + "        whetherReject_";
  protected final String TEXT_693 = " = false;";
  protected final String TEXT_694 = NL + "                            // TODO unable to parse integer: ";
  protected final String TEXT_695 = NL + "                            // TODO error: ";
  protected final String TEXT_696 = NL + "                        org.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_697 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_698 = ".";
  protected final String TEXT_699 = ";" + NL + "                        com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_700 = " = tGeometry_";
  protected final String TEXT_701 = "._getInternalGeometry();" + NL + "" + NL + "                        com.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_702 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_703 = "\");" + NL + "                        if (extends_";
  protected final String TEXT_704 = " == null) {" + NL + "                            geometryColumnToExtends.put(\"";
  protected final String TEXT_705 = "\", geometry_";
  protected final String TEXT_706 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "                        else {" + NL + "                            extends_";
  protected final String TEXT_707 = ".expandToInclude(geometry_";
  protected final String TEXT_708 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "" + NL + "                        String wkt_";
  protected final String TEXT_709 = " = geometry_";
  protected final String TEXT_710 = ".toText();" + NL + "                        oracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_711 = " = new oracle.spatial.util.WKT();" + NL + "                        oracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_712 = " = oracle_wkt_";
  protected final String TEXT_713 = ".toJGeometry(wkt_";
  protected final String TEXT_714 = ".getBytes());" + NL;
  protected final String TEXT_715 = NL + "                            jgeometry_";
  protected final String TEXT_716 = ".setSRID(";
  protected final String TEXT_717 = ");";
  protected final String TEXT_718 = NL + "                        pstmt_";
  protected final String TEXT_719 = ".setObject(";
  protected final String TEXT_720 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_727 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_728 = ",";
  protected final String TEXT_729 = ".";
  protected final String TEXT_730 = ", ";
  protected final String TEXT_731 = ",insertSQLSplits_";
  protected final String TEXT_732 = ");";
  protected final String TEXT_733 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_734 = ".";
  protected final String TEXT_735 = ", pstmt_";
  ...
  protected final String TEXT_743 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_744 = "++;";
  protected final String TEXT_745 = NL + "                batchSizeCounter_";
  protected final String TEXT_746 = "++;";
  protected final String TEXT_747 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_748 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_749 = " = insertedCount_";
  protected final String TEXT_750 = " + pstmt_";
  protected final String TEXT_751 = ".executeUpdate();";
  protected final String TEXT_752 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_753 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_754 = " = true;";
  protected final String TEXT_755 = NL + "                        throw(e_";
  ...
  protected final String TEXT_769 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_770 = ").getSQLState();";
  ...
  protected final String TEXT_786 = ",updateSQLSplits_";
  protected final String TEXT_787 = ");";
  protected final String TEXT_788 = NL + "                    int count_";
  protected final String TEXT_789 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_811 = NL + "                globalMap.put(\"";
  protected final String TEXT_812 = "_QUERY\", query_";
  protected final String TEXT_813 = ".toString().trim());";
  protected final String TEXT_814 = NL + "                pstmt_";
  protected final String TEXT_815 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_816 = "++;";
  protected final String TEXT_817 = NL + "                batchSizeCounter_";
  protected final String TEXT_818 = "++;";
  protected final String TEXT_819 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_820 = "++;" + NL + "                    updatedCount_";
  protected final String TEXT_821 = " = updatedCount_";
  protected final String TEXT_822 = " + pstmt_";
  protected final String TEXT_823 = ".executeUpdate();";
  protected final String TEXT_824 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_825 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_826 = " = true;";
  protected final String TEXT_827 = NL + "                        throw(e_";
  ...
  protected final String TEXT_841 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_842 = ").getSQLState();";
  protected final String TEXT_843 = NL + "                            ";
  protected final String TEXT_844 = ".errorMessage = e_";
  protected final String TEXT_845 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_846 = ";";
  protected final String TEXT_847 = NL + "                            System.err.print(e_";
  protected final String TEXT_848 = ".getMessage());";
  protected final String TEXT_849 = NL + "                }";
  protected final String TEXT_850 = NL + "                        ";
  protected final String TEXT_851 = NL + "                    ";
  protected final String TEXT_852 = NL + "            int checkCount_";
  protected final String TEXT_853 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_854 = " = pstmt_";
  protected final String TEXT_855 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_856 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_857 = " = rs_";
  protected final String TEXT_858 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_859 = " > 0) {";
  protected final String TEXT_860 = NL + "                        ";
  protected final String TEXT_861 = NL + "                            query_";
  protected final String TEXT_862 = " = ";
  protected final String TEXT_863 = ";";
  protected final String TEXT_864 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_865 = ",";
  protected final String TEXT_866 = ".";
  protected final String TEXT_867 = ", ";
  protected final String TEXT_868 = ",updateSQLSplits_";
  protected final String TEXT_869 = ");";
  protected final String TEXT_870 = NL + "                        int count_";
  protected final String TEXT_871 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_872 = ".";
  protected final String TEXT_873 = ", pstmtUpdate_";
  ...
  protected final String TEXT_895 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_896 = " = updatedCount_";
  protected final String TEXT_897 = " + pstmtUpdate_";
  protected final String TEXT_898 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_899 = "++;";
  protected final String TEXT_900 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_901 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_902 = " = true;";
  protected final String TEXT_903 = NL + "                        throw(e_";
  protected final String TEXT_904 = ");";
  protected final String TEXT_905 = NL + "                        nb_line_";
  protected final String TEXT_906 = "++;";
  protected final String TEXT_907 = NL + "                            ";
  protected final String TEXT_908 = " = new ";
  protected final String TEXT_909 = "Struct();";
  protected final String TEXT_910 = NL + "                                ";
  protected final String TEXT_911 = ".";
  protected final String TEXT_912 = " = ";
  protected final String TEXT_913 = ".";
  protected final String TEXT_914 = ";";
  protected final String TEXT_915 = NL + "                            rejectedCount_";
  protected final String TEXT_916 = " = rejectedCount_";
  protected final String TEXT_917 = " + 1;";
  protected final String TEXT_918 = NL + "                            ";
  protected final String TEXT_919 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_920 = ").getSQLState();";
  protected final String TEXT_921 = NL + "                            ";
  protected final String TEXT_922 = ".errorMessage = e_";
  protected final String TEXT_923 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_924 = ";";
  protected final String TEXT_925 = NL + "                            System.err.print(e_";
  protected final String TEXT_926 = ".getMessage());";
  protected final String TEXT_927 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_928 = NL + "                        ";
  protected final String TEXT_929 = NL + "                            query_";
  protected final String TEXT_930 = " = ";
  protected final String TEXT_931 = ";";
  protected final String TEXT_932 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_933 = ",";
  protected final String TEXT_934 = ".";
  protected final String TEXT_935 = ", ";
  protected final String TEXT_936 = ",insertSQLSplits_";
  protected final String TEXT_937 = ");";
  protected final String TEXT_938 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_939 = ".";
  protected final String TEXT_940 = ", pstmtInsert_";
  ...
  protected final String TEXT_947 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_948 = " = insertedCount_";
  protected final String TEXT_949 = " + pstmtInsert_";
  protected final String TEXT_950 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_951 = "++;";
  protected final String TEXT_952 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_953 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_954 = " = true;";
  protected final String TEXT_955 = NL + "                        throw(e_";
  protected final String TEXT_956 = ");";
  protected final String TEXT_957 = NL + "                        nb_line_";
  ...
  protected final String TEXT_967 = NL + "                            rejectedCount_";
  protected final String TEXT_968 = " = rejectedCount_";
  protected final String TEXT_969 = " + 1;";
  protected final String TEXT_970 = NL + "                            ";
  protected final String TEXT_971 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_972 = ").getSQLState();";
  protected final String TEXT_973 = NL + "                            ";
  protected final String TEXT_974 = ".errorMessage = e_";
  protected final String TEXT_975 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_976 = ";";
  protected final String TEXT_977 = NL + "                            System.err.print(e_";
  protected final String TEXT_978 = ".getMessage());";
  protected final String TEXT_979 = NL + "                }" + NL + "            }";
  protected final String TEXT_980 = NL + "            int updateFlag_";
  protected final String TEXT_981 = " = 0;";
  ...
  protected final String TEXT_990 = ",updateSQLSplits_";
  protected final String TEXT_991 = ");";
  protected final String TEXT_992 = NL + NL + "                    int count_";
  protected final String TEXT_993 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_994 = ".";
  protected final String TEXT_995 = ", pstmtUpdate_";
  ...
  protected final String TEXT_1023 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_1024 = " == 0) {";
  protected final String TEXT_1025 = NL + "                        query_";
  protected final String TEXT_1026 = " = new StringBuffer(\"\");";
  protected final String TEXT_1027 = NL + "                            ";
  protected final String TEXT_1028 = NL + "                                query_";
  protected final String TEXT_1029 = " = ";
  protected final String TEXT_1030 = ";";
  protected final String TEXT_1031 = NL + "                                routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1032 = ",";
  protected final String TEXT_1033 = ".";
  protected final String TEXT_1034 = ", ";
  protected final String TEXT_1035 = ",insertSQLSplits_";
  protected final String TEXT_1036 = ");";
  protected final String TEXT_1037 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1038 = ".";
  protected final String TEXT_1039 = ", pstmtInsert_";
  ...
  protected final String TEXT_1046 = NL + "                    insertedCount_";
  protected final String TEXT_1047 = " = insertedCount_";
  protected final String TEXT_1048 = " + pstmtInsert_";
  protected final String TEXT_1049 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1050 = "++;";
  protected final String TEXT_1051 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_1052 = "++;";
  protected final String TEXT_1053 = NL + "                }" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_1054 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_1055 = " = true;";
  protected final String TEXT_1056 = NL + "                    throw(e_";
  ...
  protected final String TEXT_1072 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1073 = ").getSQLState();";
  protected final String TEXT_1074 = NL + "                        ";
  protected final String TEXT_1075 = ".errorMessage = e_";
  protected final String TEXT_1076 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1077 = ";";
  protected final String TEXT_1078 = NL + "                        System.err.print(e_";
  ...
  protected final String TEXT_1086 = NL + "                        query_";
  protected final String TEXT_1087 = " = ";
  protected final String TEXT_1088 = ";";
  protected final String TEXT_1089 = NL + "                globalMap.put(\"";
  protected final String TEXT_1090 = "_QUERY\", query_";
  protected final String TEXT_1091 = ".toString().trim());";
  ...
  protected final String TEXT_1097 = NL + "                try {" + NL + "                    deletedCount_";
  protected final String TEXT_1098 = " = deletedCount_";
  protected final String TEXT_1099 = " + pstmt_";
  protected final String TEXT_1100 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1101 = "++;";
  protected final String TEXT_1102 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_1103 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_1104 = " = true;";
  protected final String TEXT_1105 = NL + "                        throw(e_";
  protected final String TEXT_1106 = ");";
  protected final String TEXT_1107 = NL + "                        nb_line_";
  protected final String TEXT_1108 = "++;";
  protected final String TEXT_1109 = NL + "                            ";
  protected final String TEXT_1110 = " = new ";
  protected final String TEXT_1111 = "Struct();";
  ...
  protected final String TEXT_1117 = NL + "                            rejectedCount_";
  protected final String TEXT_1118 = " = rejectedCount_";
  protected final String TEXT_1119 = " + 1;";
  protected final String TEXT_1120 = NL + "                            ";
  protected final String TEXT_1121 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1122 = ").getSQLState();";
  protected final String TEXT_1123 = NL + "                            ";
  protected final String TEXT_1124 = ".errorMessage = e_";
  protected final String TEXT_1125 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1126 = ";";
  protected final String TEXT_1127 = NL + "                            System.err.print(e_";
  protected final String TEXT_1128 = ".getMessage());";
  protected final String TEXT_1129 = NL + "                }";
  protected final String TEXT_1130 = NL + "            if(!whetherReject_";
  protected final String TEXT_1131 = ") {";
  protected final String TEXT_1132 = NL + "                            ";
  protected final String TEXT_1133 = " = new ";
  protected final String TEXT_1134 = "Struct();";
  ...
  protected final String TEXT_1141 = NL + "            if (batchSize_";
  protected final String TEXT_1142 = " > 0 &&  batchSize_";
  protected final String TEXT_1143 = " <= batchSizeCounter_";
  protected final String TEXT_1144 = ") {" + NL + "                try {";
  protected final String TEXT_1145 = NL + "                    pstmt_";
  protected final String TEXT_1146 = ".executeBatch();";
  protected final String TEXT_1147 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1148 = "){" + NL + "\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_1149 = " = e_";
  protected final String TEXT_1150 = ".getNextException(),sqle_";
  protected final String TEXT_1151 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_1152 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1153 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_1154 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1155 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1156 = ".getMessage(), ne_";
  protected final String TEXT_1157 = ".getSQLState(), ne_";
  protected final String TEXT_1158 = ".getErrorCode(), ne_";
  protected final String TEXT_1159 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1160 = " = sqle_";
  protected final String TEXT_1161 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1162 = " = e_";
  protected final String TEXT_1163 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t            \t";
  protected final String TEXT_1164 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1165 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1166 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_1167 = ");" + NL + "\t\t\t            }" + NL + "\t            \t";
  protected final String TEXT_1168 = NL + "\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_1169 = ");" + NL + "\t            \t";
  protected final String TEXT_1170 = NL + "\t        \t}" + NL + "                tmp_batchUpdateCount_";
  protected final String TEXT_1171 = " = pstmt_";
  protected final String TEXT_1172 = ".getUpdateCount();";
  protected final String TEXT_1173 = NL + "                    insertedCount_";
  protected final String TEXT_1174 = NL + "                    updatedCount_";
  protected final String TEXT_1175 = NL + "                    deletedCount_";
  protected final String TEXT_1176 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_1177 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1178 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_1179 = " = 0;" + NL + "            }";
  ...
  protected final String TEXT_1184 = NL + "                        try {";
  protected final String TEXT_1185 = NL + "                            pstmt_";
  protected final String TEXT_1186 = ".executeBatch();";
  protected final String TEXT_1187 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1188 = "){" + NL + "\t\t\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_1189 = " = e_";
  protected final String TEXT_1190 = ".getNextException(),sqle_";
  protected final String TEXT_1191 = "=null;" + NL + "\t\t\t\t\t    \tString errormessage_";
  protected final String TEXT_1192 = ";" + NL + "\t\t\t\t\t\t\tif (ne_";
  protected final String TEXT_1193 = " != null) {" + NL + "\t\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_1194 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1195 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1196 = ".getMessage(), ne_";
  protected final String TEXT_1197 = ".getSQLState(), ne_";
  protected final String TEXT_1198 = ".getErrorCode(), ne_";
  protected final String TEXT_1199 = ");" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1200 = " = sqle_";
  protected final String TEXT_1201 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1202 = " = e_";
  protected final String TEXT_1203 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t            \t";
  protected final String TEXT_1204 = NL + "\t\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_1205 = " != null) {" + NL + "\t\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1206 = ");" + NL + "\t\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t\t            \tthrow(e_";
  protected final String TEXT_1207 = ");" + NL + "\t\t\t\t\t            }" + NL + "\t\t\t            \t";
  protected final String TEXT_1208 = NL + "\t\t\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_1209 = ");" + NL + "\t\t\t            \t";
  protected final String TEXT_1210 = NL + "\t\t\t        \t}" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_1211 = " = pstmt_";
  protected final String TEXT_1212 = ".getUpdateCount();";
  protected final String TEXT_1213 = NL + "                            insertedCount_";
  protected final String TEXT_1214 = NL + "                            updatedCount_";
  protected final String TEXT_1215 = NL + "                            deletedCount_";
  protected final String TEXT_1216 = NL + "                        += (tmp_batchUpdateCount_";
  protected final String TEXT_1217 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1218 = ":0);";
  protected final String TEXT_1219 = NL + "                    conn_";
  protected final String TEXT_1220 = ".commit();";
  protected final String TEXT_1221 = NL + "                    commitCounter_";
