...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_209 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_210 = " = ";
  protected final String TEXT_211 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_212 = "!=null && key_";
  protected final String TEXT_213 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_214 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_215 = " - Deleting an object with key:\" + ";
  protected final String TEXT_216 = ");" + NL + "\t\t\t";
  protected final String TEXT_217 = NL + "\t\t\tconn_";
  protected final String TEXT_218 = ".deleteObject(";
  protected final String TEXT_219 = ", key_";
  protected final String TEXT_220 = ");" + NL + "\t\t\t";
  protected final String TEXT_221 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_222 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_223 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_224 = "){" + NL + "\t\t";
  protected final String TEXT_225 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_226 = ");" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_228 = " - \" + e_";
  protected final String TEXT_229 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_230 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_231 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_232 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_233 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_234 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
