...
public class TGreenplumRowFinallyJava
{
  protected static String nl;
  public static synchronized TGreenplumRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumRowFinallyJava result = new TGreenplumRowFinallyJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_77 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_78 = "\") == null) {";
  protected final String TEXT_79 = NL + "            java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_80 = " = null;" + NL + "            if ((pstmtToClose_";
  protected final String TEXT_81 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_82 = "\")) != null) {" + NL + "                pstmtToClose_";
  protected final String TEXT_83 = ".close();" + NL + "            }";
  protected final String TEXT_84 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_85 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_86 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_87 = "\")) != null) {" + NL + "                stmtToClose_";
  protected final String TEXT_88 = ".close();" + NL + "            }";
  protected final String TEXT_89 = NL + "    }";
  protected final String TEXT_90 = NL + "} finally {" + NL + "        if(resourceMap.get(\"finish_";
  protected final String TEXT_91 = "\") == null){" + NL + "            java.sql.Connection ctn_";
  protected final String TEXT_92 = " = null;" + NL + "            if((ctn_";
  protected final String TEXT_93 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_94 = "\")) != null){" + NL + "                try {";
  protected final String TEXT_95 = NL + "                    ctn_";
  protected final String TEXT_96 = ".close();";
  protected final String TEXT_97 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_98 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_99 = " = \"failed to close the connection in ";
  protected final String TEXT_100 = " :\" + sqlEx_";
  protected final String TEXT_101 = ".getMessage();";
  protected final String TEXT_102 = NL + "                    System.err.println(errorMessage_";
