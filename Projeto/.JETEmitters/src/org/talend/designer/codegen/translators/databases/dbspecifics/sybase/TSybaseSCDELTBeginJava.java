...
public class TSybaseSCDELTBeginJava {
  ...
  protected final String TEXT_5 = NL + "\t\t\tjava.lang.Class.forName(\"sap.jdbc4.sqlanywhere.IDriver\");";
  protected final String TEXT_6 = NL + "\t\t\t\tString url_";
  protected final String TEXT_7 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_8 = " + \":\" + ";
  protected final String TEXT_9 = " + \";DatabaseName=\" + ";
  protected final String TEXT_10 = "; ";
  protected final String TEXT_11 = NL + "\t\t\t\tString url_";
  protected final String TEXT_12 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_13 = " + \":\" + ";
  protected final String TEXT_14 = " + \";DatabaseName\" + ";
  protected final String TEXT_15 = " + \";\" + ";
  protected final String TEXT_16 = ";";
  protected final String TEXT_17 = NL + "\t\t\t\tjava.lang.Class.forName(\"com.sybase.jdbc4.jdbc.SybDriver\");" + NL + "\t\t\t";
  protected final String TEXT_18 = NL + "\t\t\t\tjava.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t\t\t";
  protected final String TEXT_19 = NL + "\t\t\t\tString url_";
  protected final String TEXT_20 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_40 = NL + NL + "        String dbPwd_";
  ...
  protected final String TEXT_69 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_70 = " = conn_";
  protected final String TEXT_71 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_72 = " = dbMetaData_";
  protected final String TEXT_73 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_74 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_75 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_76 = " = rsTable_";
  protected final String TEXT_77 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_78 = ".equalsIgnoreCase(";
  protected final String TEXT_79 = ")) {" + NL + "                    whetherExist_";
  ...
  protected final String TEXT_89 = NL + "                if(whetherExist_";
  protected final String TEXT_90 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_91 = " = conn_";
  protected final String TEXT_92 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_93 = ".execute(\"";
  protected final String TEXT_94 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_95 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_101 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_104 = ".executeUpdate(\"";
  protected final String TEXT_105 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_106 = ".close();";
  protected final String TEXT_107 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_110 = ".executeUpdate(\"";
  protected final String TEXT_111 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_112 = ".close();";
  protected final String TEXT_113 = NL + "        System.out.println(\"[";
  protected final String TEXT_114 = "] table action ";
  protected final String TEXT_115 = " done\\n\");";
  protected final String TEXT_116 = NL + "        String updateForType1_";
  protected final String TEXT_117 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_118 = " + \" SET ";
  protected final String TEXT_119 = " FROM \" + sourceTable_";
  protected final String TEXT_120 = " + \" t WHERE ";
  protected final String TEXT_121 = " AND (";
  protected final String TEXT_122 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_125 = ".executeUpdate(updateForType1_";
  protected final String TEXT_126 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_127 = ".close();";
  protected final String TEXT_128 = NL + "            System.out.println(\"[";
  protected final String TEXT_129 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_130 = " + \"\\ndone\");";
  protected final String TEXT_131 = NL + "        String updateForType2_";
  protected final String TEXT_132 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_133 = " + \" SET ";
  protected final String TEXT_134 = " = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_135 = "\"))) + \"'";
  protected final String TEXT_136 = ", ";
  protected final String TEXT_137 = " = 0";
  protected final String TEXT_138 = " FROM \" + sourceTable_";
  protected final String TEXT_139 = " + \" t WHERE ";
  protected final String TEXT_140 = " AND (";
  protected final String TEXT_141 = ") AND \" + tableName_";
  protected final String TEXT_142 = " + \".";
  protected final String TEXT_143 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_146 = ".executeUpdate(updateForType2_";
  protected final String TEXT_147 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_148 = ".close();";
  protected final String TEXT_149 = NL + "            System.out.println(\"[";
  protected final String TEXT_150 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_151 = " + \"\\ndone\");";
  protected final String TEXT_152 = NL + "        String insertForType2_";
  protected final String TEXT_153 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_154 = " + \"(";
  protected final String TEXT_155 = ", ";
  protected final String TEXT_156 = ") SELECT ";
  protected final String TEXT_157 = "\" + ";
  protected final String TEXT_158 = " + \".NEXTVAL, ";
  protected final String TEXT_159 = "t.";
  protected final String TEXT_160 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_161 = "\"))) + \"', NULL";
  protected final String TEXT_162 = ", 1";
  protected final String TEXT_163 = ", d.";
  protected final String TEXT_164 = " + 1";
  protected final String TEXT_165 = " FROM \" + " + NL + "        sourceTable_";
  protected final String TEXT_166 = " + \" t, \" + tableName_";
  protected final String TEXT_167 = " + \" d WHERE ";
  protected final String TEXT_168 = " AND (";
  protected final String TEXT_169 = ") AND d.";
  protected final String TEXT_170 = " = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_171 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_174 = ".executeUpdate(insertForType2_";
  protected final String TEXT_175 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_176 = ".close();";
  protected final String TEXT_177 = NL + "            System.out.println(\"[";
  protected final String TEXT_178 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_179 = " + \"\\ndone\");";
  protected final String TEXT_180 = NL + "    String insert_";
  protected final String TEXT_181 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_182 = " + \"(";
  protected final String TEXT_183 = ", ";
  protected final String TEXT_184 = ") SELECT ";
  protected final String TEXT_185 = "\" + ";
  protected final String TEXT_186 = " + \".NEXTVAL, ";
  protected final String TEXT_187 = "t.";
  protected final String TEXT_188 = "\"";
  protected final String TEXT_189 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_190 = "\"))) + \"', NULL\"";
  protected final String TEXT_191 = NL + "    + \"";
  protected final String TEXT_192 = ", 1";
  protected final String TEXT_193 = ", 1";
  protected final String TEXT_194 = " FROM \" + " + NL + "    sourceTable_";
  protected final String TEXT_195 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_196 = " + \" d ON ";
  protected final String TEXT_197 = " WHERE (";
  protected final String TEXT_198 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_201 = ".executeUpdate(insert_";
  protected final String TEXT_202 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_203 = ".close();";
  protected final String TEXT_204 = NL + "        System.out.println(\"[";
  protected final String TEXT_205 = "] new rows sql\\n\" + insert_";
