...
public class TDynamoDBInputEndJava
{
  protected static String nl;
  public static synchronized TDynamoDBInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDynamoDBInputEndJava result = new TDynamoDBInputEndJava();
    nl = null;
    return result;
  }
