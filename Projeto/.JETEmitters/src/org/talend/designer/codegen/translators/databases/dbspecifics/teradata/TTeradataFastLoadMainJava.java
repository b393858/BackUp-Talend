...
public class TTeradataFastLoadMainJava {
  ...
  protected final String TEXT_81 = ",java.sql.Types.CHAR);" + NL + "\t";
  protected final String TEXT_82 = NL + "if(";
  protected final String TEXT_83 = ".";
  protected final String TEXT_84 = "==null){" + NL + "\t";
  protected final String TEXT_85 = ".setNull(";
  protected final String TEXT_86 = ",java.sql.Types.TIMESTAMP);" + NL + "\t";
  protected final String TEXT_87 = NL + "if(";
  protected final String TEXT_88 = ".";
  protected final String TEXT_89 = "==null){";
  protected final String TEXT_90 = NL + "    ";
  protected final String TEXT_91 = ".setNull(";
  protected final String TEXT_92 = ",java.sql.Types.TIMESTAMP);";
  protected final String TEXT_93 = NL + "if(";
  protected final String TEXT_94 = ".";
  protected final String TEXT_95 = "==null){" + NL + "\t";
  protected final String TEXT_96 = ".setNull(";
  protected final String TEXT_97 = ",java.sql.Types.ARRAY);\t\t\t" + NL + "\t";
  protected final String TEXT_98 = NL + "if(";
  protected final String TEXT_99 = ".";
  protected final String TEXT_100 = "==null){" + NL + "\t";
  protected final String TEXT_101 = ".setNull(";
  protected final String TEXT_102 = ",java.sql.Types.INTEGER);" + NL + "\t";
  protected final String TEXT_103 = NL + "if(";
  protected final String TEXT_104 = ".";
  protected final String TEXT_105 = "==null){" + NL + "\t";
  protected final String TEXT_106 = ".setNull(";
  protected final String TEXT_107 = ",java.sql.Types.VARCHAR);" + NL + "\t";
  protected final String TEXT_108 = NL + "if(";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = "==null){" + NL + "\t";
  protected final String TEXT_111 = ".setNull(";
  protected final String TEXT_112 = ",java.sql.Types.OTHER);" + NL + "\t";
  protected final String TEXT_113 = NL + "if(";
  protected final String TEXT_114 = ".";
  protected final String TEXT_115 = "==null){" + NL + "\t";
  protected final String TEXT_116 = ".setNull(";
  protected final String TEXT_117 = ",java.sql.Types.BOOLEAN);\t" + NL + "\t";
  protected final String TEXT_118 = NL + "if(";
  protected final String TEXT_119 = ".";
  protected final String TEXT_120 = "==null){" + NL + "\t";
  protected final String TEXT_121 = ".setNull(";
  protected final String TEXT_122 = ",java.sql.Types.DOUBLE);\t" + NL + "\t";
  protected final String TEXT_123 = NL + "if(";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = "==null){" + NL + "\t";
  protected final String TEXT_126 = ".setNull(";
  protected final String TEXT_127 = ",java.sql.Types.FLOAT);\t" + NL + "\t";
  ...
  protected final String TEXT_133 = NL + "\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_134 = ".";
  protected final String TEXT_135 = ").toLowerCase())){" + NL + "\t";
  protected final String TEXT_136 = NL + "\t\t";
  protected final String TEXT_137 = ".setNull(";
  protected final String TEXT_138 = ",java.sql.Types.CHAR);" + NL + "\t\t" + NL + "\t}else if(";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = " == '\\0'){" + NL + "\t" + NL + "\t\t";
  protected final String TEXT_141 = ".setString(";
  protected final String TEXT_142 = ",\"\");" + NL + "\t\t" + NL + "\t}else{" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_143 = ".setString(";
  protected final String TEXT_144 = ",String.valueOf(";
  ...
  protected final String TEXT_150 = ".setTimestamp(";
  protected final String TEXT_151 = ",new java.sql.Timestamp(";
  protected final String TEXT_152 = ".";
  protected final String TEXT_153 = ".getTime()));" + NL + "\t\t" + NL + "\t}else{" + NL + "\t" + NL + "\t\t";
  protected final String TEXT_154 = ".setNull(";
  protected final String TEXT_155 = ",java.sql.Types.TIMESTAMP);" + NL + "\t\t" + NL + "\t}" + NL + "\t";
  protected final String TEXT_156 = NL + "\tif(";
  protected final String TEXT_157 = ".";
  protected final String TEXT_158 = "!=null){" + NL + "\t    " + NL + "\t   ";
  protected final String TEXT_159 = ".setTimestamp(";
  protected final String TEXT_160 = ",new java.sql.Timestamp(";
  protected final String TEXT_161 = ".";
  protected final String TEXT_162 = ".getTime()));" + NL + "\t        " + NL + "\t}else{" + NL + "\t    " + NL + "\t   ";
  protected final String TEXT_163 = ".setNull(";
  protected final String TEXT_164 = ",java.sql.Types.TIMESTAMP);" + NL + "\t        " + NL + "    }" + NL + "\t";
  ...
  protected final String TEXT_172 = NL + "\t\t\tif (nb_line_";
  protected final String TEXT_173 = " == 0) {" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_174 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_175 = " + \" (";
  protected final String TEXT_176 = " \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_177 = ".";
  protected final String TEXT_178 = ", \"teradata_id\")+\") VALUES (";
  protected final String TEXT_179 = "\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_180 = ".";
  protected final String TEXT_181 = ", \"teradata_id\")+\")\";" + NL + "\t\t\t\tpstmt_";
  ...
  protected final String TEXT_185 = NL + "\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_186 = ".";
  protected final String TEXT_187 = ", pstmt_";
  protected final String TEXT_188 = ", ";
  protected final String TEXT_189 = ", \"teradata_id\");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\t" + NL + "\t\ttry{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_191 = ".addBatch();" + NL + "\t\t   }catch(java.lang.Exception e){" + NL + "\t\t            ";
  protected final String TEXT_192 = NL + "\t\t                throw(e);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_201 = NL + "\t\t                    System.err.print(e.getMessage());" + NL + "\t\t                    ";
  ...
  protected final String TEXT_208 = NL + "\t    commitCounter_";
  protected final String TEXT_209 = "++;" + NL + "\t    nb_line_";
  protected final String TEXT_210 = "++;";
  protected final String TEXT_211 = NL + "        if(commitEvery_";
  protected final String TEXT_212 = " <= commitCounter_";
  protected final String TEXT_213 = "){" + NL + "\t\t\tint[] resultArr = pstmt_";
  protected final String TEXT_214 = ".executeBatch();" + NL + "\t\t\tpstmt_";
  protected final String TEXT_215 = ".clearBatch();" + NL + "        \tcommitCounter_";
  protected final String TEXT_216 = "=0;" + NL + "        \tint sum = 0;" + NL + "        \tfor(int i : resultArr){" + NL + "  \t\t    \tsum += (i<0 ? 0 : i);" + NL + "        \t}" + NL + "        \tinsertedCount_";
  protected final String TEXT_217 = " += sum;" + NL + "        }" + NL + "\t";
