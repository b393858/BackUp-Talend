...
public class TTeradataSCDELTBeginJava {
  ...
  protected final String TEXT_46 = NL + "    String dbUser_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "    String dbschema_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "    String tableName_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "    String sourceTable_";
  ...
  protected final String TEXT_59 = NL + "        java.lang.Class.forName(\"com.teradata.jdbc.TeraDriver\");";
  protected final String TEXT_60 = NL + "        String url_";
  protected final String TEXT_61 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_62 = " + \"/DATABASE=\" + ";
  protected final String TEXT_63 = ";";
  protected final String TEXT_64 = NL + "        String url_";
  protected final String TEXT_65 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_66 = " + \"/DATABASE=\" + ";
  ...
  protected final String TEXT_79 = ", dbUser_";
  protected final String TEXT_80 = ", dbPwd_";
  protected final String TEXT_81 = ");";
  protected final String TEXT_82 = NL;
  protected final String TEXT_83 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_87 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_95 = ".commit();";
  protected final String TEXT_96 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_100 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_101 = "));";
  protected final String TEXT_102 = NL + "                        stmtCreate_";
  protected final String TEXT_103 = ".execute(((\"";
  protected final String TEXT_104 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_105 = ".";
  protected final String TEXT_106 = ", \"";
  protected final String TEXT_107 = "\")";
  protected final String TEXT_108 = ".toUpperCase()";
  ...
  protected final String TEXT_115 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_151 = NL + "                                boolean whetherExist_";
  protected final String TEXT_152 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_153 = " = conn_";
  protected final String TEXT_154 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_155 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_156 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_157 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_162 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_163 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_164 = " = tableNameForSearch_";
  protected final String TEXT_165 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_166 = " = tableNameForSearch_";
  protected final String TEXT_167 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_168 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_169 = " = dbMetaData_";
  protected final String TEXT_170 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_171 = ", tableNameForSearch_";
  protected final String TEXT_172 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_173 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_174 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_175 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_178 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_179 = " = dbMetaData_";
  protected final String TEXT_180 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_194 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_195 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_220 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_221 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_222 = " = conn_";
  protected final String TEXT_223 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_224 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_225 = " = dbMetaData_";
  protected final String TEXT_226 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_227 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_228 = " == null || dbschema_";
  protected final String TEXT_229 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_232 = " = stmtSchema_";
  protected final String TEXT_233 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_234 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_235 = " = rsSchema_";
  protected final String TEXT_236 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_251 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_252 = ".equals";
  protected final String TEXT_253 = "IgnoreCase";
  protected final String TEXT_254 = "(schema_";
  protected final String TEXT_255 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_256 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_272 = ".getTables(null, conn_";
  protected final String TEXT_273 = ".getSchema(), tableForSearch_";
  protected final String TEXT_274 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  ...
  protected final String TEXT_279 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_280 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_281 = " = dbMetaData_";
  protected final String TEXT_282 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_283 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_284 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_285 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_286 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_287 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_293 = ".getTables(";
  protected final String TEXT_294 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_300 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_301 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_302 = " = conn_";
  protected final String TEXT_303 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_304 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_305 = " = dbMetaData_";
  protected final String TEXT_306 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_307 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_308 = " = rsTable_";
  protected final String TEXT_309 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_310 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_314 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_334 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_347 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_359 = ".toUpperCase()";
  ...
  protected final String TEXT_366 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_367 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_368 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_378 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_379 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_380 = " = conn_";
  protected final String TEXT_381 = ".createStatement()) {";
  protected final String TEXT_382 = NL + "                              stmtTruncCount_";
  protected final String TEXT_383 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_384 = "));";
  protected final String TEXT_385 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_386 = " = stmtTruncCount_";
  protected final String TEXT_387 = ".executeQuery(\"";
  protected final String TEXT_388 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_389 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_390 = " = rsTruncCount_";
  protected final String TEXT_391 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_402 = NL + "                    if(!conn_";
  protected final String TEXT_403 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_404 = ".commit();" + NL + "                    }";
  protected final String TEXT_405 = NL + "                deletedCount_";
  protected final String TEXT_406 = " += rsTruncCountNumber_";
  protected final String TEXT_407 = ";" + NL + "            }";
  protected final String TEXT_408 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_409 = " = conn_";
  protected final String TEXT_410 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_411 = " = stmtTruncCount_";
  protected final String TEXT_412 = ".executeQuery(\"";
  protected final String TEXT_413 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_424 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_425 = NL;
  protected final String TEXT_426 = NL + "        String updateForType1_";
  protected final String TEXT_427 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_428 = " +\" FROM \"+ sourceTable_";
  protected final String TEXT_429 = " + \" t SET ";
  protected final String TEXT_430 = " WHERE ";
  protected final String TEXT_431 = " AND (";
  protected final String TEXT_432 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_433 = " = conn_";
  protected final String TEXT_434 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_435 = ".executeUpdate(updateForType1_";
  protected final String TEXT_436 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_437 = ".close();";
  protected final String TEXT_438 = NL + "        String updateForType2_";
  protected final String TEXT_439 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_440 = NL + "                                        + \" FROM \" + sourceTable_";
  protected final String TEXT_441 = " + \" t\"" + NL + "                                        + \" SET ";
  protected final String TEXT_442 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_443 = "\")))" + NL + "                                        + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')";
  protected final String TEXT_444 = ", ";
  protected final String TEXT_445 = " = 0";
  protected final String TEXT_446 = " \"" + NL + "                                        + \" WHERE ";
  protected final String TEXT_447 = " AND (";
  protected final String TEXT_448 = ") AND \" + tableName_";
  protected final String TEXT_449 = " + \".";
  protected final String TEXT_450 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_451 = " = conn_";
  protected final String TEXT_452 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_453 = ".executeUpdate(updateForType2_";
  protected final String TEXT_454 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_455 = ".close();";
  protected final String TEXT_456 = NL + "        String insertForType2_";
  protected final String TEXT_457 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_458 = " + \"(";
  protected final String TEXT_459 = ", ";
  protected final String TEXT_460 = ") SELECT ";
  protected final String TEXT_461 = "\" + ";
  protected final String TEXT_462 = " + \".NEXTVAL, ";
  protected final String TEXT_463 = "t.";
  protected final String TEXT_464 = ", cast('\" +" + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_465 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL";
  protected final String TEXT_466 = ", 1";
  protected final String TEXT_467 = ", d.";
  protected final String TEXT_468 = " + 1";
  protected final String TEXT_469 = " FROM \" +" + NL + "        sourceTable_";
  protected final String TEXT_470 = " + \" t, \" + tableName_";
  protected final String TEXT_471 = " + \" d WHERE ";
  protected final String TEXT_472 = " AND (";
  protected final String TEXT_473 = ") AND d.";
  protected final String TEXT_474 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_475 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_476 = " = conn_";
  protected final String TEXT_477 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_478 = ".executeUpdate(insertForType2_";
  protected final String TEXT_479 = ");" + NL + "        stmtType2Insert_";
  ...
  protected final String TEXT_485 = ") SELECT ";
  protected final String TEXT_486 = "\" + ";
  protected final String TEXT_487 = " + \".NEXTVAL, ";
  protected final String TEXT_488 = "t.";
  protected final String TEXT_489 = "\"";
  protected final String TEXT_490 = " + \", cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_491 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL\"";
  protected final String TEXT_492 = NL + "    + \"";
  protected final String TEXT_493 = ", 1";
  protected final String TEXT_494 = ", 1";
  protected final String TEXT_495 = " FROM \" +" + NL + "    sourceTable_";
  protected final String TEXT_496 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_497 = " + \" d ON ";
  protected final String TEXT_498 = " WHERE (";
  protected final String TEXT_499 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_500 = " = conn_";
  protected final String TEXT_501 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_502 = ".executeUpdate(insert_";
  protected final String TEXT_503 = ");" + NL + "    stmtInsert_";
