...
public class TBigQueryInputBeginJava
{
  ...
  protected final String TEXT_187 = NL + "\t\tString pageToken_";
  protected final String TEXT_188 = " = null;" + NL + "\t";
  protected final String TEXT_189 = NL + "\t\tcom.google.auth.oauth2.GoogleCredentials credentials_";
  protected final String TEXT_190 = ";" + NL + "\t\tjava.io.File credentialsFile_";
  protected final String TEXT_191 = " = new java.io.File(";
  protected final String TEXT_192 = ");" + NL + "\t\ttry(java.io.FileInputStream credentialsStream_";
  protected final String TEXT_193 = " = new java.io.FileInputStream(credentialsFile_";
  protected final String TEXT_194 = ")) {" + NL + "\t\t    credentials_";
  protected final String TEXT_195 = " = com.google.auth.oauth2.ServiceAccountCredentials.fromStream(credentialsStream_";
  protected final String TEXT_196 = ");" + NL + "\t\t}" + NL + "" + NL + "\t\tcom.google.cloud.bigquery.BigQuery bigquery_";
  protected final String TEXT_197 = " = com.google.cloud.bigquery.BigQueryOptions.newBuilder()" + NL + "\t\t\t\t.setCredentials(credentials_";
  protected final String TEXT_198 = ")" + NL + "\t\t\t\t.setProjectId(";
  protected final String TEXT_199 = ")" + NL + "\t\t\t\t.build()" + NL + "\t\t\t\t.getService();" + NL + "\t\t\t\t" + NL + "\t\tcom.google.cloud.bigquery.QueryJobConfiguration queryConfiguration_";
  protected final String TEXT_200 = " = com.google.cloud.bigquery.QueryJobConfiguration.newBuilder(";
  protected final String TEXT_201 = ").setUseLegacySql(";
  protected final String TEXT_202 = ").build();" + NL + "\t\tcom.google.cloud.bigquery.JobId jobId_tBigQueryInput_1 = com.google.cloud.bigquery.JobId.of(java.util.UUID.randomUUID().toString());" + NL + "\t\tcom.google.cloud.bigquery.Job job_";
  protected final String TEXT_203 = " = bigquery_";
  protected final String TEXT_204 = ".create(com.google.cloud.bigquery.JobInfo.newBuilder(queryConfiguration_";
  protected final String TEXT_205 = ").setJobId(jobId_";
  protected final String TEXT_206 = ").build());" + NL + "" + NL + "\t\t";
  protected final String TEXT_207 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_208 = " - Sending job \" + jobId_";
  protected final String TEXT_209 = " + \" with query: \" + ";
  protected final String TEXT_210 = ");" + NL + "\t\t";
  protected final String TEXT_211 = NL + "\t\tjob_";
  protected final String TEXT_212 = " = job_";
  protected final String TEXT_213 = ".waitFor();" + NL + "" + NL + "\t\tif (job_";
  protected final String TEXT_214 = " == null) {" + NL + "\t\t\tthrow new RuntimeException(\"Job no longer exists\");" + NL + "\t\t} else if (job_";
  protected final String TEXT_215 = ".getStatus().getError() != null) {" + NL + "\t\t\tthrow new RuntimeException(job_";
  protected final String TEXT_216 = ".getStatus().getError().toString());" + NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_217 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_218 = " - Job \" + jobId_";
  protected final String TEXT_219 = " + \" finished successfully.\");" + NL + "\t\t";
  protected final String TEXT_220 = NL + "\t\t" + NL + "\t\tcom.google.cloud.bigquery.TableResult result_";
  protected final String TEXT_221 = " = job_";
  protected final String TEXT_222 = ".getQueryResults();" + NL + "" + NL + "\t\tlong nb_line_";
  protected final String TEXT_223 = " = 0;" + NL + "\t";
  protected final String TEXT_224 = NL + "\twhile (true) {" + NL + "\t\t// Fetch Results" + NL + "\t\tcom.google.api.services.bigquery.model.TableDataList dataList_";
  protected final String TEXT_225 = " = bigqueryclient_";
  protected final String TEXT_226 = ".tabledata()" + NL + "\t\t\t\t\t.list(PROJECT_ID_";
  protected final String TEXT_227 = "," + NL + "\t\t\t\t\t\t\tinsert_";
  protected final String TEXT_228 = ".getConfiguration().getQuery()" + NL + "\t\t\t\t\t\t\t\t\t.getDestinationTable().getDatasetId()," + NL + "\t\t\t\t\t\t\tinsert_";
  protected final String TEXT_229 = ".getConfiguration().getQuery()" + NL + "\t\t\t\t\t\t\t\t\t.getDestinationTable().getTableId())" + NL + "\t\t\t\t\t.setPageToken(pageToken_";
  protected final String TEXT_230 = ").execute();" + NL + "\t\t" + NL + "\t\tList<com.google.api.services.bigquery.model.TableRow> rows_";
  protected final String TEXT_231 = " = dataList_";
  protected final String TEXT_232 = ".getRows();" + NL + "" + NL + "\t\tif(rows_";
  protected final String TEXT_233 = " == null) {" + NL + "\t\t\t// Means there is no record." + NL + "\t\t\trows_";
  protected final String TEXT_234 = " = new java.util.ArrayList<com.google.api.services.bigquery.model.TableRow>();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tfor (com.google.api.services.bigquery.model.TableRow row_";
  protected final String TEXT_235 = " : rows_";
  protected final String TEXT_236 = ") {" + NL + "\t\t\tjava.util.List<com.google.api.services.bigquery.model.TableCell> field_";
  protected final String TEXT_237 = " = row_";
  protected final String TEXT_238 = ".getF();" + NL + "\t\t\tObject value_";
  protected final String TEXT_239 = " = null;" + NL + "\t\t\tnb_line_";
  protected final String TEXT_240 = " ++;" + NL + "\t\t";
  protected final String TEXT_241 = NL + "\t\tfor (com.google.cloud.bigquery.FieldValueList field_";
  protected final String TEXT_242 = " : result_";
  protected final String TEXT_243 = ".iterateAll()) {" + NL + "\t\t\tObject value_";
  protected final String TEXT_244 = ";" + NL + "\t\t\tnb_line_";
  protected final String TEXT_245 = " ++;" + NL + "\t";
  protected final String TEXT_246 = NL + "\t\t\t\t\t\t\t\tvalue_";
  protected final String TEXT_247 = " = field_";
  protected final String TEXT_248 = ".get(";
  protected final String TEXT_249 = ").getV();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\t\t\t\t\t\tvalue_";
  protected final String TEXT_251 = " = field_";
  protected final String TEXT_252 = ".get(";
  protected final String TEXT_253 = ").getValue();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\t\t\tif(com.google.api.client.util.Data.isNull(value_";
  protected final String TEXT_255 = ")) value_";
  protected final String TEXT_256 = " = null;" + NL + "\t\t\t\t\t\t\t\tif(value_";
  protected final String TEXT_257 = " != null){" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_259 = ".";
  protected final String TEXT_260 = " = value_";
  ...
  protected final String TEXT_268 = " = ParserUtils.parseTo_Date(value_";
  protected final String TEXT_269 = ".toString());\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_271 = ".";
  protected final String TEXT_272 = " = ParserUtils.parseTo_";
  protected final String TEXT_273 = "(ParserUtils.parseTo_Number(value_";
  ...
  protected final String TEXT_280 = ".toString().getBytes(";
  protected final String TEXT_281 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_282 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_283 = ".";
  protected final String TEXT_284 = " = ParserUtils.parseTo_";
  protected final String TEXT_285 = "(value_";
  protected final String TEXT_286 = ".toString());" + NL + "\t\t\t\t\t\t\t\t\t";
