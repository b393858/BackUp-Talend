...
public class TAmazonMysqlOutputEndJava {
  ...
  protected final String TEXT_162 = ");" + NL + "\t        resourceMap.put(\"pstmt_";
  protected final String TEXT_163 = "\", pstmt_";
  protected final String TEXT_164 = ");" + NL + "" + NL + "\t        int row2Count";
  protected final String TEXT_165 = " = 0;";
  protected final String TEXT_166 = NL + "\t        \tint count";
  protected final String TEXT_167 = " = 1;";
  protected final String TEXT_168 = NL + "\t\t\tint count";
  protected final String TEXT_169 = " = 0;";
  protected final String TEXT_170 = NL + NL + "\t        for(BufferLine_";
  protected final String TEXT_171 = " bufferL";
  protected final String TEXT_172 = " : exInsertColValueList";
  protected final String TEXT_173 = "){";
  protected final String TEXT_174 = NL + "\t            count";
  protected final String TEXT_175 = " = row2Count";
  protected final String TEXT_176 = "*";
  protected final String TEXT_177 = "+1;";
  protected final String TEXT_178 = NL + "\t                    count";
  protected final String TEXT_179 = "++;" + NL + "\t                    ";
  protected final String TEXT_180 = NL + "\t\t\t\t\tint count_dyn_";
  protected final String TEXT_181 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_182 = ".";
  protected final String TEXT_183 = ", pstmt_";
  protected final String TEXT_184 = ", count";
  protected final String TEXT_185 = "-1, \"";
  protected final String TEXT_186 = "\");" + NL + "\t\t\t\t\tcount";
  protected final String TEXT_187 = "+=count_dyn_";
  protected final String TEXT_188 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_189 = NL + NL + "\t            row2Count";
  protected final String TEXT_190 = "++;" + NL + "\t        }" + NL + "\t        insertedCount_";
  protected final String TEXT_191 = " = insertedCount_";
  protected final String TEXT_192 = " + pstmt_";
  protected final String TEXT_193 = ".executeUpdate();" + NL + "\t    }";
  protected final String TEXT_194 = NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_195 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_196 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_198 = ": pstmt_";
  protected final String TEXT_199 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_200 = " += (countEach_";
  protected final String TEXT_201 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_202 = NL + "\t            \t    \t";
  protected final String TEXT_203 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_204 = " += countSum_";
  protected final String TEXT_205 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_206 = NL + "            \t    \t}" + NL + "" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_207 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_208 = NL + "                \tint countSum_";
  protected final String TEXT_209 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_210 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_211 = " += (countEach_";
  protected final String TEXT_212 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_218 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_219 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_220 = " = 0;";
  protected final String TEXT_221 = NL + "    \t\t";
  protected final String TEXT_222 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_223 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_224 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_225 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_226 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_227 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_228 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_229 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_230 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_231 = "\");" + NL + "        }";
  protected final String TEXT_232 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_233 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_234 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_235 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_236 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_237 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_238 = "\");" + NL + "        }";
  protected final String TEXT_239 = NL + "    try {" + NL + "\t\t\tint countSum_";
  protected final String TEXT_240 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_242 = ": pstmt_";
  protected final String TEXT_243 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_244 = " += (countEach_";
  protected final String TEXT_245 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_275 = NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_276 = NL + "\t}";
  protected final String TEXT_277 = NL + "        if(pstmt_";
  protected final String TEXT_278 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_279 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_280 = "\");" + NL + "        }";
  protected final String TEXT_281 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_282 = "\", true);";
  protected final String TEXT_283 = NL + "    \t\tif (commitCounter_";
  protected final String TEXT_284 = " > 0) {" + NL + "        \t\t";
  protected final String TEXT_285 = NL + "        \t\tconn_";
  protected final String TEXT_286 = ".commit();" + NL + "        \t\t";
  ...
  protected final String TEXT_291 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_292 = "\", true);" + NL + "    \t";
  protected final String TEXT_293 = NL;
  protected final String TEXT_294 = NL + "\tnb_line_deleted_";
  protected final String TEXT_295 = "=nb_line_deleted_";
  protected final String TEXT_296 = "+ deletedCount_";
  protected final String TEXT_297 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_298 = "=nb_line_update_";
  protected final String TEXT_299 = " + updatedCount_";
  protected final String TEXT_300 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_301 = "=nb_line_inserted_";
  protected final String TEXT_302 = " + insertedCount_";
  protected final String TEXT_303 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_304 = "=nb_line_rejected_";
  protected final String TEXT_305 = " + rejectedCount_";
  protected final String TEXT_306 = ";" + NL + "\t";
  protected final String TEXT_307 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_308 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_309 = "_NB_LINE\",nb_line_";
  protected final String TEXT_310 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_311 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_312 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_313 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_314 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_315 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_316 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_317 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_318 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_319 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_320 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_323 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_324 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_325 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_326 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_327 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_328 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_329 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_330 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_331 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_332 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_333 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_334 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_335 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_339 = "_NB_LINE\",nb_line_";
  protected final String TEXT_340 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_341 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_342 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_343 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_344 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_345 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_346 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_347 = "_NB_LINE_REJECTED\", nb_line_rejected_";
