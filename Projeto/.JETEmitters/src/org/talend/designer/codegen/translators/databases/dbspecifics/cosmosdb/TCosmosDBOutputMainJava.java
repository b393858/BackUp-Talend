...
public class TCosmosDBOutputMainJava
{
  protected static String nl;
  public static synchronized TCosmosDBOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBOutputMainJava result = new TCosmosDBOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_189 = "] - Writing the record \" + nb_line_";
  protected final String TEXT_190 = " + \" into database.\");" + NL + "\t\t\t\t";
