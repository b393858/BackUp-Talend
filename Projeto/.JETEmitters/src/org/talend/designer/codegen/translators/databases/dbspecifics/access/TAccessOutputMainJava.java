...
public class TAccessOutputMainJava {
  ...
  protected final String TEXT_53 = " = new StringBuffer(\"\");";
  protected final String TEXT_54 = NL + "\t\t\t\t\tcommitEvery_";
  ...
  protected final String TEXT_82 = NL + "                        nb_line_rejected_";
  ...
  protected final String TEXT_137 = NL + "    " + NL + "            int checkCount_";
  protected final String TEXT_138 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_139 = " = pstmt_";
  protected final String TEXT_140 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_141 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_142 = " = rs_";
  protected final String TEXT_143 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_240 = NL + "    " + NL + "             try {" + NL + "                 updateFlag_";
  protected final String TEXT_241 = "=pstmtUpdate_";
  protected final String TEXT_242 = ".executeUpdate();" + NL + "                 if(updateFlag_";
  protected final String TEXT_243 = " != 0) {" + NL + "            \t\tnb_line_";
  protected final String TEXT_244 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_245 = NL + "                 }" + NL + "                 updatedCount_";
  protected final String TEXT_246 = " = updatedCount_";
  protected final String TEXT_247 = "+updateFlag_";
  protected final String TEXT_248 = ";" + NL + "             } catch(java.lang.Exception e) {" + NL + "                 whetherReject_";
  protected final String TEXT_249 = " = true;";
  protected final String TEXT_250 = NL + "                     throw(e);";
  ...
  protected final String TEXT_259 = NL + "                         nb_line_rejected_";
  protected final String TEXT_260 = "++;";
  protected final String TEXT_261 = NL + "                         ";
  protected final String TEXT_262 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_267 = NL + "             }" + NL + "             if(updateFlag_";
  protected final String TEXT_268 = " == 0) {" + NL + "\t\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\t\tquery_";
  protected final String TEXT_270 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_271 = NL + "                         ";
  protected final String TEXT_272 = NL + "                             query_";
  protected final String TEXT_273 = " = ";
  protected final String TEXT_274 = ";";
  protected final String TEXT_275 = NL + "                     globalMap.put(\"";
  protected final String TEXT_276 = "_QUERY\", query_";
  protected final String TEXT_277 = ".toString().trim());";
  ...
  protected final String TEXT_281 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_282 = "++;" + NL + "                \t";
  protected final String TEXT_283 = NL + "                 } catch(java.lang.Exception e) {" + NL + "                     whetherReject_";
  protected final String TEXT_284 = " = true;";
  protected final String TEXT_285 = NL + "                         throw(e);";
  ...
  protected final String TEXT_356 = NL + "\t            commitCounter_";
  protected final String TEXT_357 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_358 = "<=commitCounter_";
  protected final String TEXT_359 = ") {" + NL + "\t            \t";
  protected final String TEXT_360 = NL + "\t            \tconn_";
  protected final String TEXT_361 = ".commit();" + NL + "\t            \t";
  protected final String TEXT_362 = "    " + NL + "\t            \tcommitCounter_";
  protected final String TEXT_363 = "=0;\t" + NL + "\t            }\t" + NL + "\t            ";
