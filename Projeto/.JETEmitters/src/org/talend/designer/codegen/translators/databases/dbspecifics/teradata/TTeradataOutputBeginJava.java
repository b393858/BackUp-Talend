...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_78 = NL + "                if(log.is";
  protected final String TEXT_79 = "Enabled())";
  protected final String TEXT_80 = NL + "            log.";
  protected final String TEXT_81 = "(\"";
  protected final String TEXT_82 = " - \" ";
  protected final String TEXT_83 = " + (";
  protected final String TEXT_84 = ") ";
  protected final String TEXT_85 = ");";
  protected final String TEXT_86 = NL + "            if (log.isDebugEnabled()) {" + NL + "                class BytesLimit65535_";
  protected final String TEXT_87 = "{" + NL + "                    public void limitLog4jByte() throws Exception{" + NL + "                    StringBuilder ";
  protected final String TEXT_88 = " = new StringBuilder();";
  protected final String TEXT_89 = NL + "                    ";
  protected final String TEXT_90 = ".append(\"Parameters:\");";
  protected final String TEXT_91 = NL + "                            ";
  protected final String TEXT_92 = ".append(\"";
  protected final String TEXT_93 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_94 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_101 = NL + "                    } " + NL + "                } " + NL + "            new BytesLimit65535_";
  protected final String TEXT_102 = "().limitLog4jByte();" + NL + "            }";
  protected final String TEXT_103 = NL + "            StringBuilder ";
  protected final String TEXT_104 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_113 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_121 = NL + NL + "int nb_line_";
  protected final String TEXT_122 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_123 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_124 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_125 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_126 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_127 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_128 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_129 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_130 = "=0;" + NL + "" + NL + "String tableName_";
  ...
  protected final String TEXT_139 = NL + "        int updateKeyCount_";
  protected final String TEXT_140 = " = ";
  protected final String TEXT_141 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_142 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_143 = NL + "        int deleteKeyCount_";
  protected final String TEXT_144 = " = ";
  protected final String TEXT_145 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_146 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_147 = NL + "\t String dbname_";
  protected final String TEXT_148 = " = (String)globalMap.get(\"";
  protected final String TEXT_149 = "\");" + NL + "\t String dbUser_";
  protected final String TEXT_150 = " = (String)globalMap.get(\"";
  protected final String TEXT_151 = "\");" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_152 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_153 = "\");" + NL + "\t";
  protected final String TEXT_154 = NL + "\t";
  protected final String TEXT_155 = NL + "    String dbname_";
  protected final String TEXT_156 = " = ";
  protected final String TEXT_157 = ";" + NL + "    String driverClass_";
  protected final String TEXT_158 = " = \"com.teradata.jdbc.TeraDriver\";";
  protected final String TEXT_159 = NL + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_166 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_167 = ";" + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_168 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_169 = " + \"/\" + ";
  protected final String TEXT_170 = ";" + NL + "\t}" + NL + "    String dbUser_";
  protected final String TEXT_171 = " = ";
  protected final String TEXT_172 = ";";
  protected final String TEXT_173 = NL;
  protected final String TEXT_174 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_175 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_176 = ");";
  protected final String TEXT_177 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = "; ";
  protected final String TEXT_180 = NL + NL + "    String dbPwd_";
  protected final String TEXT_181 = " = decryptedPassword_";
  protected final String TEXT_182 = ";" + NL + "" + NL + "\t";
  protected final String TEXT_183 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_184 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_185 = ",dbUser_";
  protected final String TEXT_186 = ",dbPwd_";
  protected final String TEXT_187 = ");";
  protected final String TEXT_188 = NL;
  protected final String TEXT_189 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_190 = " =  conn_";
  protected final String TEXT_191 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_192 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_193 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_194 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_195 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_196 = NL + "                 conn_";
  protected final String TEXT_197 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_198 = NL + "               ";
  protected final String TEXT_199 = " + \"=\" + ";
  protected final String TEXT_200 = " + \";\" +";
  protected final String TEXT_201 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_202 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_203 = ");";
  protected final String TEXT_204 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_205 = "\", conn_";
  protected final String TEXT_206 = ");";
  protected final String TEXT_207 = NL + "        conn_";
  protected final String TEXT_208 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_209 = " = ";
  protected final String TEXT_210 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_211 = " = 0;";
  protected final String TEXT_212 = NL + "String dbschema_";
  protected final String TEXT_213 = " = dbname_";
  protected final String TEXT_214 = ";" + NL + "if(dbname_";
  protected final String TEXT_215 = " == null || dbname_";
  protected final String TEXT_216 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_217 = " = ";
  protected final String TEXT_218 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_219 = " = dbname_";
  protected final String TEXT_220 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_221 = ";" + NL + "}";
  protected final String TEXT_222 = NL + "int count_";
  protected final String TEXT_223 = "=0;";
  protected final String TEXT_224 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".createStatement()) {";
  protected final String TEXT_227 = NL + "                              stmtDrop_";
  protected final String TEXT_228 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_236 = ".commit();";
  protected final String TEXT_237 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_241 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_256 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_260 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_261 = "));";
  protected final String TEXT_262 = NL + "                    stmtCreate_";
  protected final String TEXT_263 = ".execute(((\"";
  protected final String TEXT_264 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_276 = NL + "                    String keyCheckTable_";
  protected final String TEXT_277 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_278 = "+\"][\"+";
  protected final String TEXT_279 = "+\"][\"+";
  protected final String TEXT_280 = "+\"][\"+";
  protected final String TEXT_281 = "+\"][\"+";
  protected final String TEXT_282 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_283 = " + \"]\";";
  protected final String TEXT_284 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_285 = " = conn_";
  protected final String TEXT_286 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_287 = " + \"]\";";
  protected final String TEXT_288 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_289 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_290 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_291 = ")== null){//}";
  protected final String TEXT_292 = NL + "                                boolean whetherExist_";
  protected final String TEXT_293 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_294 = " = conn_";
  protected final String TEXT_295 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_296 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_297 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_298 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_299 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_308 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_309 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_310 = " = dbMetaData_";
  protected final String TEXT_311 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_312 = ", tableNameForSearch_";
  protected final String TEXT_313 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_314 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_315 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_316 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_317 = " = conn_";
  protected final String TEXT_318 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_319 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_320 = " = dbMetaData_";
  protected final String TEXT_321 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_322 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_323 = " = rsTable_";
  protected final String TEXT_324 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_325 = " = rsTable_";
  protected final String TEXT_326 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  protected final String TEXT_327 = ".equals";
  protected final String TEXT_328 = "IgnoreCase";
  protected final String TEXT_329 = "(";
  protected final String TEXT_330 = ")" + NL + "                                            && (schema_";
  protected final String TEXT_331 = ".equals";
  protected final String TEXT_332 = "IgnoreCase";
  protected final String TEXT_333 = "(dbschema_";
  protected final String TEXT_334 = ") || dbschema_";
  protected final String TEXT_335 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_336 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_337 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_338 = " = conn_";
  protected final String TEXT_339 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_340 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_341 = " = dbMetaData_";
  protected final String TEXT_342 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_352 = ".toUpperCase()";
  ...
  protected final String TEXT_361 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_362 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_363 = " = conn_";
  protected final String TEXT_364 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_365 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_366 = " = dbMetaData_";
  protected final String TEXT_367 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_368 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_369 = " == null || dbschema_";
  protected final String TEXT_370 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_371 = " = conn_";
  protected final String TEXT_372 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_373 = " = stmtSchema_";
  protected final String TEXT_374 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_375 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_376 = " = rsSchema_";
  protected final String TEXT_377 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_378 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_379 = " = rsTable_";
  protected final String TEXT_380 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_381 = " = rsTable_";
  protected final String TEXT_382 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  protected final String TEXT_383 = ".equals";
  protected final String TEXT_384 = "IgnoreCase";
  protected final String TEXT_385 = "(";
  protected final String TEXT_386 = ")" + NL + "                                            && (schema_";
  protected final String TEXT_387 = ".equals";
  protected final String TEXT_388 = "IgnoreCase";
  protected final String TEXT_389 = "(dbschema_";
  protected final String TEXT_390 = ") || ((dbschema_";
  protected final String TEXT_391 = " ==null || dbschema_";
  protected final String TEXT_392 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_397 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_398 = NL + "                                String tableForSearch_";
  protected final String TEXT_399 = " = ";
  protected final String TEXT_400 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_401 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_402 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_403 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_404 = " =  tableForSearch_";
  protected final String TEXT_405 = ".substring(1,tableForSearch_";
  protected final String TEXT_406 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_407 = " =  tableForSearch_";
  protected final String TEXT_408 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_409 = " = conn_";
  protected final String TEXT_410 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_411 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_412 = " = dbMetaData_";
  protected final String TEXT_413 = ".getTables(null, conn_";
  protected final String TEXT_414 = ".getSchema(), tableForSearch_";
  protected final String TEXT_415 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_416 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_417 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_418 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_419 = " = conn_";
  protected final String TEXT_420 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_421 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_422 = " = dbMetaData_";
  protected final String TEXT_423 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_424 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_425 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_426 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_427 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_428 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_429 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_430 = " = conn_";
  protected final String TEXT_431 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_432 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_433 = " = dbMetaData_";
  protected final String TEXT_434 = ".getTables(";
  protected final String TEXT_435 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_436 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_437 = " = rsTable_";
  protected final String TEXT_438 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_439 = ".equalsIgnoreCase(";
  protected final String TEXT_440 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_441 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_442 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_443 = " = conn_";
  protected final String TEXT_444 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_445 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_446 = " = dbMetaData_";
  protected final String TEXT_447 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_448 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_449 = " = rsTable_";
  protected final String TEXT_450 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_451 = ".equalsIgnoreCase(";
  protected final String TEXT_452 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_453 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_454 = NL + "                                if(!whetherExist_";
  protected final String TEXT_455 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_456 = " = conn_";
  protected final String TEXT_457 = ".createStatement()) {";
  protected final String TEXT_458 = NL + "                                                      stmtCreate_";
  protected final String TEXT_459 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_460 = "));";
  protected final String TEXT_461 = NL + "                                            stmtCreate_";
  protected final String TEXT_462 = ".execute(((\"";
  protected final String TEXT_463 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_470 = NL + "                                        stmtCreate_";
  protected final String TEXT_471 = ".execute(\"";
  protected final String TEXT_472 = ")\");";
  protected final String TEXT_473 = NL + "                                    }" + NL + "                                }";
  protected final String TEXT_474 = NL + "                                if(whetherExist_";
  protected final String TEXT_475 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_476 = " = conn_";
  protected final String TEXT_477 = ".createStatement()) {";
  protected final String TEXT_478 = NL + "                                                      stmtDrop_";
  protected final String TEXT_479 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_480 = "));";
  protected final String TEXT_481 = NL + "                                        stmtDrop_";
  protected final String TEXT_482 = ".execute(\"";
  protected final String TEXT_483 = "\" ";
  protected final String TEXT_484 = ");";
  protected final String TEXT_485 = NL + "                                    }";
  protected final String TEXT_486 = NL + "                                            conn_";
  protected final String TEXT_487 = ".commit();";
  protected final String TEXT_488 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_492 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_493 = "));";
  protected final String TEXT_494 = NL + "                                        stmtCreate_";
  protected final String TEXT_495 = ".execute(((\"";
  protected final String TEXT_496 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_497 = ".";
  protected final String TEXT_498 = ", \"";
  protected final String TEXT_499 = "\")";
  protected final String TEXT_500 = ".toUpperCase()";
  protected final String TEXT_501 = ")+\")";
  protected final String TEXT_502 = "\"));";
  protected final String TEXT_503 = NL + "                                    stmtCreate_";
  protected final String TEXT_504 = ".execute(\"";
  protected final String TEXT_505 = ")\");";
  protected final String TEXT_506 = NL + "                                }";
  protected final String TEXT_507 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_508 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_509 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_510 = " = conn_";
  protected final String TEXT_511 = ".createStatement()) {";
  protected final String TEXT_512 = NL + "                              stmtClear_";
  protected final String TEXT_513 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_514 = "));";
  protected final String TEXT_515 = NL + "                stmtClear_";
  protected final String TEXT_516 = ".executeUpdate(\"";
  protected final String TEXT_517 = "\");";
  protected final String TEXT_518 = NL + "            }";
  protected final String TEXT_519 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_520 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_521 = " = conn_";
  protected final String TEXT_522 = ".createStatement()) {";
  protected final String TEXT_523 = NL + "                              stmtTruncCount_";
  protected final String TEXT_524 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_525 = "));";
  protected final String TEXT_526 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_527 = " = stmtTruncCount_";
  protected final String TEXT_528 = ".executeQuery(\"";
  protected final String TEXT_529 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_530 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_531 = " = rsTruncCount_";
  protected final String TEXT_532 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_533 = " = conn_";
  protected final String TEXT_534 = ".createStatement()) {";
  protected final String TEXT_535 = NL + "                              stmtTrunc_";
  protected final String TEXT_536 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_537 = "));";
  protected final String TEXT_538 = NL + "                conn_";
  protected final String TEXT_539 = ".commit();";
  protected final String TEXT_540 = NL + "                stmtTrunc_";
  protected final String TEXT_541 = ".executeUpdate(\"";
  ...
  protected final String TEXT_546 = NL + "                deletedCount_";
  protected final String TEXT_547 = " += rsTruncCountNumber_";
  protected final String TEXT_548 = ";" + NL + "            }";
  protected final String TEXT_549 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_556 = ".createStatement()) {";
  protected final String TEXT_557 = NL + "                conn_";
  protected final String TEXT_558 = ".commit();";
  protected final String TEXT_559 = NL + "                stmtTrunc_";
  protected final String TEXT_560 = ".executeUpdate(\"";
  protected final String TEXT_561 = "\");";
  protected final String TEXT_562 = NL + "                while(rsTruncCount_";
  protected final String TEXT_563 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_564 = " += rsTruncCount_";
  protected final String TEXT_565 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_566 = NL + "\t conn_";
  protected final String TEXT_567 = ".commit();";
  ...
  protected final String TEXT_572 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_573 = " = conn_";
  protected final String TEXT_574 = ".prepareStatement(insert_";
  protected final String TEXT_575 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_585 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_592 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_607 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_608 = " = conn_";
  protected final String TEXT_609 = ".prepareStatement(update_";
  protected final String TEXT_610 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_611 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_617 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_626 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_627 = " = conn_";
  protected final String TEXT_628 = ".prepareStatement(insert_";
  protected final String TEXT_629 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_630 = "\", pstmtInsert_";
  ...
  protected final String TEXT_665 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_672 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_673 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_674 = " =null;" + NL + "\t";
  protected final String TEXT_675 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_676 = " = null;" + NL + "\t\t";
  protected final String TEXT_677 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_678 = " = null;";
  protected final String TEXT_679 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_680 = " =  null;";
  protected final String TEXT_681 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_682 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_683 = " = null;";
  protected final String TEXT_684 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_688 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_689 = " = null;";
  protected final String TEXT_690 = NL + "\t\t \tString[] insertSQLSplits_";
