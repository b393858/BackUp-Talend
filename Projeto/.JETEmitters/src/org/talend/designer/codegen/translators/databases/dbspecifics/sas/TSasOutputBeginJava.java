...
public class TSasOutputBeginJava {
  ...
  protected final String TEXT_62 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_63 = " = false;" + NL;
  protected final String TEXT_64 = NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_65 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_66 = "\");" + NL + "\t";
  protected final String TEXT_67 = NL + "\t";
  protected final String TEXT_68 = NL + "    java.lang.Class.forName(";
  protected final String TEXT_69 = ");";
  protected final String TEXT_70 = NL + "    String connectionString_";
  ...
  protected final String TEXT_84 = ";" + NL + "\tjava.util.Properties property_";
  protected final String TEXT_85 = " = new java.util.Properties();" + NL + "\t" + NL + "\t";
  protected final String TEXT_86 = NL + "\t\tString librefs_";
  protected final String TEXT_87 = " = ";
  protected final String TEXT_88 = ";" + NL + "\t\tproperty_";
  protected final String TEXT_89 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_90 = ");" + NL + "\t";
  protected final String TEXT_91 = NL + "\tproperty_";
  protected final String TEXT_92 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_93 = ");" + NL + "\tproperty_";
  protected final String TEXT_94 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_95 = ");" + NL + "\t";
  protected final String TEXT_96 = NL + "\t\t\tproperty_";
  protected final String TEXT_97 = ".setProperty(String.valueOf(";
  protected final String TEXT_98 = "), String.valueOf(";
  protected final String TEXT_99 = "));" + NL + "\t\t";
  protected final String TEXT_100 = "\t" + NL + "    java.sql.Connection connection_";
  protected final String TEXT_101 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_102 = ", property_";
  protected final String TEXT_103 = ");" + NL + "\t";
  protected final String TEXT_104 = "    " + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_105 = "\", connection_";
  protected final String TEXT_106 = ");";
  protected final String TEXT_107 = NL + "//        connection_";
  ...
  protected final String TEXT_112 = NL + "    try (java.sql.Statement statementClear_";
  protected final String TEXT_113 = " = connection_";
  protected final String TEXT_114 = ".createStatement()) {" + NL + "        deletedCount_";
  protected final String TEXT_115 = " = deletedCount_";
  protected final String TEXT_116 = " + statementClear_";
  protected final String TEXT_117 = ".executeUpdate(\"delete from \" + ";
  ...
  protected final String TEXT_123 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_124 = " = connection_";
  protected final String TEXT_125 = ".prepareStatement(insert_";
  protected final String TEXT_126 = ");" + NL + "\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_127 = "\", pstmt_";
  protected final String TEXT_128 = ");" + NL + "\t\t";
  protected final String TEXT_129 = NL + "\t\tString update_";
  protected final String TEXT_130 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_135 = ".prepareStatement(update_";
  protected final String TEXT_136 = ");" + NL + "\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_143 = "\");" + NL + "\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_152 = ");" + NL + "\t\tresourceMap.put(\"pstmtInsert_";
  protected final String TEXT_153 = "\", pstmtInsert_";
  protected final String TEXT_154 = ");" + NL + "\t\tString update_";
  protected final String TEXT_155 = " = \"UPDATE \" + ";
  protected final String TEXT_156 = " + \" SET ";
  protected final String TEXT_157 = " WHERE ";
  protected final String TEXT_158 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_159 = " = connection_";
  protected final String TEXT_160 = ".prepareStatement(update_";
  protected final String TEXT_161 = ");" + NL + "\t\tresourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_162 = "\", pstmtUpdate_";
  protected final String TEXT_163 = ");" + NL + "\t\t";
  protected final String TEXT_164 = NL + "\t\tString update_";
  protected final String TEXT_165 = " = \"UPDATE \" + ";
  protected final String TEXT_166 = " + \" SET ";
  protected final String TEXT_167 = " WHERE ";
  protected final String TEXT_168 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_169 = " = connection_";
  protected final String TEXT_170 = ".prepareStatement(update_";
  protected final String TEXT_171 = ");" + NL + "\t\tresourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_180 = ");" + NL + "\t\tresourceMap.put(\"pstmtInsert_";
  protected final String TEXT_181 = "\", pstmtInsert_";
  protected final String TEXT_182 = ");" + NL + "\t\t";
  protected final String TEXT_183 = NL + "\t\tString delete_";
  protected final String TEXT_184 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_188 = ".prepareStatement(delete_";
