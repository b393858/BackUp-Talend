...
public class TAccessRowFinallyJava
{
  protected static String nl;
  public static synchronized TAccessRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessRowFinallyJava result = new TAccessRowFinallyJava();
    nl = null;
    return result;
  }
