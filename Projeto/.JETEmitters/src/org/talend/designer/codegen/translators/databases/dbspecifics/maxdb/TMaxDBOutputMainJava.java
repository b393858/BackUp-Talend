...
public class TMaxDBOutputMainJava {
  ...
  protected final String TEXT_127 = NL + "    " + NL + "            int checkCount_";
  protected final String TEXT_128 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_129 = " = pstmt_";
  protected final String TEXT_130 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_131 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_132 = " = rs_";
  protected final String TEXT_133 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_149 = "_QUERY\", query_";
  protected final String TEXT_150 = ".toString().trim());";
  protected final String TEXT_151 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_152 = " = updatedCount_";
  protected final String TEXT_153 = " + pstmtUpdate_";
  protected final String TEXT_154 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_155 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_156 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_174 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_229 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_245 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_279 = NL + "                }" + NL + "            }else{" + NL + "                 nb_line_";
  ...
  protected final String TEXT_288 = NL + "                        query_";
  protected final String TEXT_289 = " = ";
  protected final String TEXT_290 = ";";
  protected final String TEXT_291 = NL + "                globalMap.put(\"";
  protected final String TEXT_292 = "_QUERY\", query_";
  protected final String TEXT_293 = ".toString().trim());";
  protected final String TEXT_294 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_295 = " = deletedCount_";
  protected final String TEXT_296 = " + pstmt_";
  protected final String TEXT_297 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_298 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_299 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_300 = " = true;";
  protected final String TEXT_301 = NL + "                    throw(e);";
  ...
  protected final String TEXT_327 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_328 = " <= commitCounter_";
  protected final String TEXT_329 = ") {" + NL + "            " + NL + "            \t";
  protected final String TEXT_330 = NL + "            \tconn_";
  protected final String TEXT_331 = ".commit();" + NL + "            \t";
  protected final String TEXT_332 = NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_333 = "=0;" + NL + "            " + NL + "            }\t" + NL + "    \t";
