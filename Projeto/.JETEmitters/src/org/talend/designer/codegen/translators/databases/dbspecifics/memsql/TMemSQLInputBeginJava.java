...
public class TMemSQLInputBeginJava
{
  ...
  protected final String TEXT_188 = " =\"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_233 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_234 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_300 = NL + "\t\t    \tlog.debug(\"";
  ...
  protected final String TEXT_372 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_373 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_374 = ".getColumnTypeName(i_";
  protected final String TEXT_375 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_376 = ".add(rs_";
  protected final String TEXT_377 = ".getString(i_";
  protected final String TEXT_378 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_379 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
