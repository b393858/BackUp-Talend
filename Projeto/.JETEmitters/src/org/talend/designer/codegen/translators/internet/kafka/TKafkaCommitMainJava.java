...
public class TKafkaCommitMainJava
{
  ...
  protected final String TEXT_3 = NL + "\tif (globalMap.containsKey(\"";
  protected final String TEXT_4 = "_consumerConnector\")) {" + NL + "\t    ((kafka.javaapi.consumer.ConsumerConnector) globalMap.get(\"";
  protected final String TEXT_5 = "_consumerConnector\")).commitOffsets();" + NL + "\t} else {" + NL + "\t    throw new RuntimeException(\"Could not commit offsets : no consumer has been found from ";
  protected final String TEXT_6 = "\");" + NL + "\t}";
  protected final String TEXT_7 = NL + "\tif (globalMap.containsKey(\"";
  protected final String TEXT_8 = "_kafkaConsumer\")) {" + NL + "\t    ((org.apache.kafka.clients.consumer.KafkaConsumer) globalMap.get(\"";
  protected final String TEXT_9 = "_kafkaConsumer\")).commitSync();" + NL + "\t} else {" + NL + "\t    throw new RuntimeException(\"Could not commit offsets : no consumer has been found from ";
