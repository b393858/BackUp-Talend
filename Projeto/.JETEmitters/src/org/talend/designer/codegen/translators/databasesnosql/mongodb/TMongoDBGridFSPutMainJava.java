...
public class TMongoDBGridFSPutMainJava
{
  ...
  protected final String TEXT_94 = "].getName();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\t\ttry (java.io.InputStream streamToUploadFrom_";
  protected final String TEXT_96 = " = new java.io.FileInputStream(listings_";
  protected final String TEXT_97 = "[m_";
  protected final String TEXT_98 = "])){" + NL + "\t\t    \t\t\t\t// Create some custom options" + NL + "\t\t    \t\t\tcom.mongodb.client.gridfs.model.GridFSUploadOptions options_";
  protected final String TEXT_99 = " = new com.mongodb.client.gridfs.model.GridFSUploadOptions()" + NL + "\t\t    \t\t\t\t.chunkSizeBytes(358400);" + NL + "\t\t    \t\t\tif(info_";
  protected final String TEXT_100 = ".setMetadata) {" + NL + "\t\t\t\t\t\t\toptions_";
  protected final String TEXT_101 = ".metadata(org.bson.Document.parse(info_";
  protected final String TEXT_102 = ".metadataJson));" + NL + "\t\t\t\t\t}" + NL + "\t\t    \t\t    gridfs_";
  protected final String TEXT_103 = ".uploadFromStream(gridfsFilename_";
  protected final String TEXT_104 = ", streamToUploadFrom_";
  protected final String TEXT_105 = ", options_";
  protected final String TEXT_106 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\t\tcom.mongodb.gridfs.GridFSInputFile gridfsFile_";
  protected final String TEXT_108 = " = gridfs_";
  protected final String TEXT_109 = ".createFile(listings_";
  protected final String TEXT_110 = "[m_";
  protected final String TEXT_111 = "]);" + NL + "\t\t\t\t\tgridfsFile_";
  protected final String TEXT_112 = ".setFilename(gridfsFilename_";
  protected final String TEXT_113 = ");" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tif(info_";
  protected final String TEXT_114 = ".setMetadata) {" + NL + "\t\t\t\t\t\tcom.mongodb.DBObject metadata_";
  protected final String TEXT_115 = " = com.mongodb.BasicDBObject.parse(info_";
  protected final String TEXT_116 = ".metadataJson);" + NL + "\t\t\t\t\t\tgridfsFile_";
  protected final String TEXT_117 = ".setMetaData(metadata_";
  protected final String TEXT_118 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tgridfsFile_";
  protected final String TEXT_119 = ".save();" + NL + "\t\t\t\t";
  protected final String TEXT_120 = NL + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_121 = "++;";
  protected final String TEXT_122 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_123 = " \" + \"file: \" + listings_";
  protected final String TEXT_124 = "[m_";
  protected final String TEXT_125 = "].getAbsolutePath() + \", size: \" + listings_";
  protected final String TEXT_126 = "[m_";
  protected final String TEXT_127 = "].length() + \" bytes upload successfully\");";
