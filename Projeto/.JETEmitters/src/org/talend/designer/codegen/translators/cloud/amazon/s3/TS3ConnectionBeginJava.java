...
public class TS3ConnectionBeginJava
{
  ...
  protected final String TEXT_210 = NL + "\t//This method is just for test connection." + NL + "\tconn_";
  protected final String TEXT_211 = ".getS3AccountOwner();" + NL + "\t";
  protected final String TEXT_212 = NL + "\t" + NL + "\tglobalMap.put(\"conn_\" + \"";
