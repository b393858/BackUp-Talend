...
public class TMapRDBCloseMainJava
{
  protected static String nl;
  public static synchronized TMapRDBCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapRDBCloseMainJava result = new TMapRDBCloseMainJava();
    nl = null;
    return result;
  }
