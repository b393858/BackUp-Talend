...
public class TJavaDBOutputMainJava {
  ...
  protected final String TEXT_98 = ".toString().trim());";
  ...
  protected final String TEXT_125 = NL + "            int checkCount_";
  protected final String TEXT_126 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_127 = " = pstmt_";
  protected final String TEXT_128 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_129 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_130 = " = rs_";
  protected final String TEXT_131 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_165 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_166 = NL + "                            ";
  protected final String TEXT_167 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_168 = ";";
  protected final String TEXT_169 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_170 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_171 = NL + "                        ";
  protected final String TEXT_172 = NL + "                            query_";
  protected final String TEXT_173 = " = ";
  protected final String TEXT_174 = ";";
  protected final String TEXT_175 = NL + "                    globalMap.put(\"";
  protected final String TEXT_176 = "_QUERY\", query_";
  protected final String TEXT_177 = ".toString().trim());";
  ...
  protected final String TEXT_181 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_182 = "++;";
  protected final String TEXT_183 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_196 = NL + "                            nb_line_rejected_";
  protected final String TEXT_197 = "++;";
  protected final String TEXT_198 = NL + "                            ";
  protected final String TEXT_199 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_205 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_216 = "_QUERY\", query_";
  protected final String TEXT_217 = ".toString().trim());";
  protected final String TEXT_218 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_219 = "=pstmtUpdate_";
  protected final String TEXT_220 = ".executeUpdate();" + NL + "                if(updateFlag_";
  protected final String TEXT_221 = " != 0){" + NL + "                \tnb_line_";
  protected final String TEXT_222 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_223 = NL + "                }" + NL + "                updatedCount_";
  ...
  protected final String TEXT_237 = NL + "                        nb_line_rejected_";
  ...
  protected final String TEXT_245 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_246 = " == 0) {" + NL + "            \t";
  protected final String TEXT_247 = NL + "\t\t\t\tquery_";
  protected final String TEXT_248 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_249 = NL + "                        ";
  protected final String TEXT_250 = NL + "                            query_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";";
  protected final String TEXT_253 = NL + "                    globalMap.put(\"";
  protected final String TEXT_254 = "_QUERY\", query_";
  protected final String TEXT_255 = ".toString().trim());";
  protected final String TEXT_256 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_257 = " = insertedCount_";
  protected final String TEXT_258 = " + pstmtInsert_";
  ...
  protected final String TEXT_274 = NL + "                            nb_line_rejected_";
  protected final String TEXT_275 = "++;";
  protected final String TEXT_276 = NL + "                            ";
  protected final String TEXT_277 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_278 = NL + "                            ";
  protected final String TEXT_279 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_280 = ";";
  protected final String TEXT_281 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_282 = NL + "                }" + NL + "\t\t\t}";
  protected final String TEXT_283 = NL + "                    ";
  protected final String TEXT_284 = NL + "                        query_";
  protected final String TEXT_285 = " = ";
  protected final String TEXT_286 = ";";
  protected final String TEXT_287 = NL + "                globalMap.put(\"";
  protected final String TEXT_288 = "_QUERY\", query_";
  protected final String TEXT_289 = ".toString().trim());";
  ...
  protected final String TEXT_308 = NL + "                        nb_line_rejected_";
  protected final String TEXT_309 = "++;";
  protected final String TEXT_310 = NL + "                        ";
  protected final String TEXT_311 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_312 = NL + "                        ";
  protected final String TEXT_313 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_314 = ";";
  protected final String TEXT_315 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_316 = NL + "            }";
  protected final String TEXT_317 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_328 = NL + "            commitCounter_";
  protected final String TEXT_329 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_330 = " <= commitCounter_";
  protected final String TEXT_331 = ") {" + NL + "            \t";
  protected final String TEXT_332 = NL + "                conn_";
  protected final String TEXT_333 = ".commit();" + NL + "            \t";
  protected final String TEXT_334 = NL + "                commitCounter_";
  protected final String TEXT_335 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
