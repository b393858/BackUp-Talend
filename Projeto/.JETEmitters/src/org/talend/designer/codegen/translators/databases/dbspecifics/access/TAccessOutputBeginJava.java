package org.talend.designer.codegen.translators.databases.dbspecifics.access;
...
public class TAccessOutputBeginJava {
  ...
  protected final String TEXT_64 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_67 = " = false;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_73 = NL + "java.lang.Class.forName(\"net.ucanaccess.jdbc.UcanaccessDriver\");";
  protected final String TEXT_74 = NL + "String url_";
  protected final String TEXT_75 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_76 = " + \";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true\";" + NL + "" + NL + "String dbUser_";
  ...
  protected final String TEXT_95 = NL + "\tString atnParams_";
  protected final String TEXT_96 = " = ";
  protected final String TEXT_97 = ";" + NL + "\tatnParams_";
  protected final String TEXT_98 = " = atnParams_";
  protected final String TEXT_99 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_100 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_101 = ".put(\"user\",dbUser_";
  protected final String TEXT_102 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_103 = ".put(\"password\",dbPwd_";
  protected final String TEXT_104 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_105 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_106 = ".getBytes()));" + NL + "  " + NL + "\tconn_";
  protected final String TEXT_107 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_108 = ", atnParamsPrope_";
  ...
  protected final String TEXT_114 = ".setAutoCommit(false);\t" + NL + "\t    int commitEvery_";
  protected final String TEXT_115 = " = ";
  protected final String TEXT_116 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_117 = " = 0;" + NL + "" + NL + "\t    ";
  protected final String TEXT_118 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "                 java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_137 = NL + "            boolean whetherExist_";
  protected final String TEXT_138 = " = false;" + NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = ".getMetaData();" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_141 = " = dbMetaData_";
  protected final String TEXT_142 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_148 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  protected final String TEXT_149 = NL + "                if(!whetherExist_";
  protected final String TEXT_150 = ") {" + NL + "                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_158 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_164 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_171 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_187 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_204 = "\");\t" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_205 = "\", pstmt_";
  protected final String TEXT_206 = ");" + NL + "\t    String insert_";
  protected final String TEXT_207 = " = \"INSERT INTO [\" + ";
  protected final String TEXT_208 = "+\"] (";
  protected final String TEXT_209 = ") VALUES (";
  ...
  protected final String TEXT_213 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_214 = "\", pstmtInsert_";
  ...
  protected final String TEXT_222 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_223 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_235 = " = \"INSERT INTO [\" + ";
  protected final String TEXT_236 = "+\"] (";
  protected final String TEXT_237 = ") VALUES (";
  protected final String TEXT_238 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".prepareStatement(insert_";
  protected final String TEXT_241 = ");\t\t" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_242 = "\", pstmtInsert_";
  protected final String TEXT_243 = ");" + NL + "\t    ";
  protected final String TEXT_244 = NL + "\t    String delete_";
  protected final String TEXT_245 = " = \"DELETE  FROM [\" + ";
  protected final String TEXT_246 = " + \"] WHERE ";
  protected final String TEXT_247 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".prepareStatement(delete_";
  protected final String TEXT_250 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_251 = "\", pstmt_";
  protected final String TEXT_252 = ");";
  protected final String TEXT_253 = NL + "        StringBuffer query_";
  protected final String TEXT_254 = " = null;" + NL + "       \t";
  protected final String TEXT_255 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_256 = " = insert_";
  protected final String TEXT_257 = ".split(\"\\\\?\");";
  protected final String TEXT_258 = NL + "\t\t\tupdate_";
  protected final String TEXT_259 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_260 = " = update_";
  protected final String TEXT_261 = ".split(\"\\\\?\");";
  protected final String TEXT_262 = NL + "\t\t\tupdate_";
  protected final String TEXT_263 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_264 = " = update_";
  protected final String TEXT_265 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_266 = " = insert_";
  protected final String TEXT_267 = ".split(\"\\\\?\");";
  protected final String TEXT_268 = NL + "\t\t\tdelete_";
  protected final String TEXT_269 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_270 = " = delete_";
  protected final String TEXT_271 = ".split(\"\\\\?\");";
  protected final String TEXT_272 = NL + "\t\t\treplace_";
  protected final String TEXT_273 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_274 = " = replace_";
  protected final String TEXT_275 = ".split(\"\\\\?\");";
  protected final String TEXT_276 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_277 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_278 = " = insertIgnore_";
  protected final String TEXT_279 = ".split(\"\\\\?\");";
  protected final String TEXT_280 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_281 = " = insert_";
  protected final String TEXT_282 = ".split(\"\\\\?\");";
