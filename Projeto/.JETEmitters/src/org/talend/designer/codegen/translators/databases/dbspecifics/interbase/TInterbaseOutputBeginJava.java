package org.talend.designer.codegen.translators.databases.dbspecifics.interbase;
...
public class TInterbaseOutputBeginJava {
  ...
  protected final String TEXT_78 = NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_79 = "\");";
  protected final String TEXT_80 = NL + "    String url_";
  protected final String TEXT_81 = " = \"jdbc:interbase://\" + ";
  protected final String TEXT_82 = " + \"/\" + ";
  protected final String TEXT_83 = ";" + NL + "    String dbUser_";
  ...
  protected final String TEXT_93 = NL + NL + "    String dbPwd_";
  protected final String TEXT_94 = " = decryptedPassword_";
  protected final String TEXT_95 = ";";
  protected final String TEXT_96 = NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_110 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_111 = " = conn_";
  protected final String TEXT_112 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_122 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_131 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_132 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_133 = " = dbMetaData_";
  protected final String TEXT_134 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_140 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_150 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_156 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_163 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".createStatement()) {";
  protected final String TEXT_166 = NL + "                deletedCount_";
  protected final String TEXT_167 = " = deletedCount_";
  protected final String TEXT_168 = " + stmtClear_";
  ...
  protected final String TEXT_179 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_180 = "\", pstmt_";
  protected final String TEXT_181 = ");" + NL + "\t    ";
  protected final String TEXT_182 = NL + "\t    String update_";
  protected final String TEXT_183 = " = \"UPDATE \\\"\" + ";
  ...
  protected final String TEXT_188 = ".prepareStatement(update_";
  protected final String TEXT_189 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_190 = "\", pstmt_";
  ...
  protected final String TEXT_205 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_206 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_217 = NL + "\t    String update_";
  protected final String TEXT_218 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_219 = " + \"\\\" SET ";
  ...
  protected final String TEXT_223 = ".prepareStatement(update_";
  protected final String TEXT_224 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_233 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_234 = "\", pstmtInsert_";
  protected final String TEXT_235 = ");" + NL + "\t    ";
  protected final String TEXT_236 = NL + "\t    String delete_";
  protected final String TEXT_237 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_238 = " + \"\\\" WHERE ";
  protected final String TEXT_239 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".prepareStatement(delete_";
  protected final String TEXT_242 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_243 = "\", pstmt_";
  protected final String TEXT_244 = ");" + NL + "\t    ";
  protected final String TEXT_245 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_254 = NL + "\t\t\tupdate_";
  protected final String TEXT_255 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_256 = " = update_";
  protected final String TEXT_257 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_258 = " = insert_";
  protected final String TEXT_259 = ".split(\"\\\\?\");";
  protected final String TEXT_260 = NL + "\t\t\tdelete_";
  protected final String TEXT_261 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_262 = " = delete_";
  protected final String TEXT_263 = ".split(\"\\\\?\");";
  protected final String TEXT_264 = NL + "\t\t\treplace_";
  protected final String TEXT_265 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_266 = " = replace_";
  protected final String TEXT_267 = ".split(\"\\\\?\");";
  protected final String TEXT_268 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_269 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_270 = " = insertIgnore_";
  protected final String TEXT_271 = ".split(\"\\\\?\");";
  protected final String TEXT_272 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_273 = " = insert_";
