...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_136 = "!=0){" + NL + "" + NL + "\t        StringBuilder extendInsertValueStmt = new StringBuilder();" + NL + "\t        for(int i=0 ; i < rowCount";
  protected final String TEXT_137 = " ; i++){" + NL + "\t             extendInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_138 = "+\")\");" + NL + "\t             if (i != rowCount";
  protected final String TEXT_139 = " - 1) extendInsertValueStmt.append(\",\");" + NL + "\t        }" + NL + "" + NL + "" + NL + "\t\t\t\t   insert_";
  protected final String TEXT_140 = " = \"INSERT INTO `\"+";
  protected final String TEXT_141 = "+\"` (\"+insertColName";
  protected final String TEXT_142 = "+\") VALUES \"+extendInsertValueStmt.toString();" + NL + "\t\t\t\t   ";
  protected final String TEXT_143 = NL + "\t\t\t\t    ";
  protected final String TEXT_144 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_145 = " += \" ON DUPLICATE KEY UPDATE \";" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_146 = " = new StringBuffer(\"\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_148 = ".append(\",\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_150 = ".append (\"`\" +  ";
  protected final String TEXT_151 = " + \"`\");" + NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_152 = ".append (\"=\");" + NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_153 = ".append (";
  protected final String TEXT_154 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_156 = " += \tduplidateClause_";
  protected final String TEXT_157 = ".toString();" + NL + "\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t        ";
  protected final String TEXT_159 = NL + NL + NL + "\t        pstmt_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".prepareStatement(insert_";
  protected final String TEXT_162 = ");" + NL + "" + NL + "\t        int row2Count";
  protected final String TEXT_163 = " = 0;";
  protected final String TEXT_164 = NL + "\t        \tint count";
  protected final String TEXT_165 = " = 1;";
  protected final String TEXT_166 = NL + "\t\t\t    int count";
  protected final String TEXT_167 = " = 0;";
  protected final String TEXT_168 = NL + NL + "\t        for(BufferLine_";
  protected final String TEXT_169 = " bufferL";
  protected final String TEXT_170 = " : exInsertColValueList";
  protected final String TEXT_171 = "){";
  protected final String TEXT_172 = NL + "                    count";
  protected final String TEXT_173 = " = row2Count";
  protected final String TEXT_174 = "*";
  protected final String TEXT_175 = "+1;";
  protected final String TEXT_176 = NL + "\t                    count";
  protected final String TEXT_177 = "++;" + NL + "\t                    ";
  protected final String TEXT_178 = NL + "                        int count_dyn_";
  protected final String TEXT_179 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_180 = ".";
  protected final String TEXT_181 = ", pstmt_";
  protected final String TEXT_182 = ", count";
  protected final String TEXT_183 = "-1, \"";
  protected final String TEXT_184 = "\");" + NL + "                        count";
  protected final String TEXT_185 = "+=count_dyn_";
  protected final String TEXT_186 = ";";
  protected final String TEXT_187 = NL + "\t            row2Count";
  protected final String TEXT_188 = "++;";
  protected final String TEXT_189 = NL + "                    commitCounter_";
  protected final String TEXT_190 = " += exInsertColValueList";
  protected final String TEXT_191 = ".size();";
  protected final String TEXT_192 = NL + "\t        }" + NL + "\t        try{" + NL + "\t        \tinsertedCount_";
  protected final String TEXT_193 = " = insertedCount_";
  protected final String TEXT_194 = " + pstmt_";
  protected final String TEXT_195 = ".executeUpdate();" + NL + "\t        }catch(java.lang.Exception e){" + NL + "\t        \t";
  ...
  protected final String TEXT_199 = NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_200 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_201 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_203 = ": pstmt_";
  protected final String TEXT_204 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_205 = " += (countEach_";
  protected final String TEXT_206 = " == java.sql.Statement.EXECUTE_FAILED ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_207 = NL + "\t            \t    \t";
  protected final String TEXT_208 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_209 = " += countSum_";
  protected final String TEXT_210 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_211 = NL + "            \t    \t}" + NL + "" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_212 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_213 = NL + "                \tint countSum_";
  protected final String TEXT_214 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_215 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_216 = " += (countEach_";
  protected final String TEXT_217 = " < 0 ? 0 : countEach_";
  protected final String TEXT_218 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_219 = NL + "            \t    insertedCount_";
  protected final String TEXT_220 = " += countSum_";
  protected final String TEXT_221 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_222 = NL + "\t\t\t\t\tglobalMap.put(currentComponent+\"_ERROR_MESSAGE\",e.getMessage());" + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_223 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_224 = " = 0;";
  protected final String TEXT_225 = NL + "    \t\t";
  protected final String TEXT_226 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_227 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_228 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_229 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_230 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_231 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_232 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_233 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_234 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_235 = "\");" + NL + "        }";
  protected final String TEXT_236 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_237 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_238 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_239 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_240 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_241 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_242 = "\");" + NL + "        }";
  protected final String TEXT_243 = NL + "\t";
  protected final String TEXT_244 = NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_245 = " != null){" + NL + "\t\t\tint countSum_";
  protected final String TEXT_246 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_248 = ": pstmt_";
  protected final String TEXT_249 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_250 = " += (countEach_";
  protected final String TEXT_251 = " < 0 ? 0 : countEach_";
  protected final String TEXT_252 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_253 = NL + "\t    \t";
  protected final String TEXT_254 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_255 = " += countSum_";
  protected final String TEXT_256 = ";" + NL + "\t    \t";
  protected final String TEXT_257 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_258 = " += countSum_";
  protected final String TEXT_259 = ";" + NL + "\t    \t";
  protected final String TEXT_260 = NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_261 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_262 = NL + "    \tint countSum_";
  protected final String TEXT_263 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_264 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_265 = " += (countEach_";
  protected final String TEXT_266 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_276 = NL + NL + "        if(pstmt_";
  ...
  protected final String TEXT_284 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_285 = "\", true);";
  protected final String TEXT_286 = NL + "    \tif (commitCounter_";
  protected final String TEXT_287 = " > 0) {" + NL + "    \t\t";
  protected final String TEXT_288 = NL + "    \t\tconn_";
  protected final String TEXT_289 = ".commit();" + NL + "    \t\t";
  ...
  protected final String TEXT_294 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_295 = "\", true);" + NL + "    \t";
  protected final String TEXT_296 = NL;
  protected final String TEXT_297 = NL + "\tnb_line_deleted_";
  protected final String TEXT_298 = "=nb_line_deleted_";
  protected final String TEXT_299 = "+ deletedCount_";
  protected final String TEXT_300 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_301 = "=nb_line_update_";
  protected final String TEXT_302 = " + updatedCount_";
  protected final String TEXT_303 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_304 = "=nb_line_inserted_";
  protected final String TEXT_305 = " + insertedCount_";
  protected final String TEXT_306 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_307 = "=nb_line_rejected_";
  protected final String TEXT_308 = " + rejectedCount_";
  protected final String TEXT_309 = ";" + NL + "\t";
  protected final String TEXT_310 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_311 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_312 = "_NB_LINE\",nb_line_";
  protected final String TEXT_313 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_314 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_315 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_316 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_317 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_318 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_319 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_320 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_321 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_322 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_323 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_324 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_325 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_326 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_327 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_328 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_329 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_330 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_331 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_332 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_333 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_334 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_335 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_336 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_337 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_338 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_342 = "_NB_LINE\",nb_line_";
  protected final String TEXT_343 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_344 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_345 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_346 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_347 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_348 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_349 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_350 = "_NB_LINE_REJECTED\", nb_line_rejected_";
