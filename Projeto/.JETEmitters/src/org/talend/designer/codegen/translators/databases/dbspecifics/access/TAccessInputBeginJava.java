...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_189 = " + \";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true\";";
  ...
  protected final String TEXT_208 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_209 = ",dbUser_";
  protected final String TEXT_210 = ",dbPwd_";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_213 = " = ";
  protected final String TEXT_214 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_215 = " = atnParams_";
  protected final String TEXT_216 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_217 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_218 = ".put(\"user\",dbUser_";
  protected final String TEXT_219 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_220 = ".put(\"password\",dbPwd_";
  protected final String TEXT_221 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_222 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_223 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_224 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_225 = ", atnParamsPrope_";
  protected final String TEXT_226 = ");";
  protected final String TEXT_227 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_228 = " = rs_";
  protected final String TEXT_229 = ".getTimestamp(";
  protected final String TEXT_230 = "column_index_";
  protected final String TEXT_231 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_232 = " != null) {";
  protected final String TEXT_233 = NL + "                ";
  protected final String TEXT_234 = ".";
  protected final String TEXT_235 = " = new java.util.Date(timestamp_";
  ...
  protected final String TEXT_241 = NL + "\t\t    int nb_line_";
  protected final String TEXT_242 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_277 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_278 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_306 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_376 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_377 = ".getObject(";
  protected final String TEXT_378 = "column_index_";
  protected final String TEXT_379 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_380 = NL + "                                    ";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_398 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_399 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_407 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_408 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_409 = ".getClob(i_";
  protected final String TEXT_410 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_411 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_412 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_413 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_414 = ".add(tNTextImpl_";
  protected final String TEXT_415 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_416 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_417 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_418 = ".getColumnTypeName(i_";
  protected final String TEXT_419 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_420 = ".add(rs_";
  protected final String TEXT_421 = ".getString(i_";
  protected final String TEXT_422 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_423 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_424 = ".";
  protected final String TEXT_425 = ", rs_";
  protected final String TEXT_426 = ", fixedColumnCount_";
  protected final String TEXT_427 = ",list_";
  protected final String TEXT_428 = ",";
  protected final String TEXT_429 = ");";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_431 = ".";
  protected final String TEXT_432 = ", rs_";
  protected final String TEXT_433 = ", fixedColumnCount_";
  protected final String TEXT_434 = ",";
  protected final String TEXT_435 = ");";
  protected final String TEXT_436 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_437 = ".";
  protected final String TEXT_438 = ", rs_";
  protected final String TEXT_439 = ", fixedColumnCount_";
  protected final String TEXT_440 = ",";
  protected final String TEXT_441 = ");";
  protected final String TEXT_442 = NL + "                                  Object geom = rs_";
  ...
  protected final String TEXT_447 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_448 = ".";
  protected final String TEXT_449 = " = null;" + NL + "                                  }";
  protected final String TEXT_450 = NL + "\t\t                          ";
  protected final String TEXT_451 = NL + "\t\t                    }";
  protected final String TEXT_452 = NL + "\t\t\t\t\t";
  protected final String TEXT_453 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_454 = " - Retrieving the record \" + nb_line_";
