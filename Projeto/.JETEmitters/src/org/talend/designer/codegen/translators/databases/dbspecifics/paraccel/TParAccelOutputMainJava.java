...
public class TParAccelOutputMainJava {
  ...
  protected final String TEXT_130 = NL + "            int checkCount_";
  protected final String TEXT_131 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_132 = " = pstmt_";
  protected final String TEXT_133 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_134 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_135 = " = rs_";
  protected final String TEXT_136 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_211 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_212 = "=pstmtUpdate_";
  protected final String TEXT_213 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_214 = " = updatedCount_";
  protected final String TEXT_215 = "+updateFlag_";
  protected final String TEXT_216 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_217 = " == 0) {";
  protected final String TEXT_218 = NL + "                        ";
  protected final String TEXT_219 = NL + "                    insertedCount_";
  protected final String TEXT_220 = " = insertedCount_";
  protected final String TEXT_221 = " + pstmtInsert_";
  protected final String TEXT_222 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_223 = "++;";
  protected final String TEXT_224 = NL + "             }else{" + NL + "             \t   nb_line_";
  protected final String TEXT_225 = "++;" + NL + "             \t   ";
  protected final String TEXT_226 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_256 = ".addBatch();" + NL + "                           batchSizeCounter_";
  protected final String TEXT_257 = "++;" + NL + "                           nb_line_";
  protected final String TEXT_258 = "++;";
  protected final String TEXT_259 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_260 = " = deletedCount_";
  protected final String TEXT_261 = " + pstmt_";
  protected final String TEXT_262 = ".executeUpdate();" + NL + "                           nb_line_";
  ...
  protected final String TEXT_277 = NL + "                                   rejectedCount_";
  protected final String TEXT_278 = " = rejectedCount_";
  protected final String TEXT_279 = " + 1;";
  protected final String TEXT_280 = NL + "                                   ";
  protected final String TEXT_281 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_282 = NL + "                                   ";
  protected final String TEXT_283 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_284 = ";";
  protected final String TEXT_285 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_286 = NL + "                       }";
  protected final String TEXT_287 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_298 = NL + "                if ((batchSize_";
  protected final String TEXT_299 = " > 0) && (batchSize_";
  protected final String TEXT_300 = " <= batchSizeCounter_";
  protected final String TEXT_301 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_302 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_303 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_304 = " = 0;";
  protected final String TEXT_305 = NL + "                        status_";
  protected final String TEXT_306 = " = pstmt_";
  protected final String TEXT_307 = ".executeBatch();";
  protected final String TEXT_308 = NL + "                        for(int countEach_";
  protected final String TEXT_309 = ": status_";
  protected final String TEXT_310 = ") {" + NL + "                            countSum_";
  protected final String TEXT_311 = " += (countEach_";
  protected final String TEXT_312 = " < 0 ? 0 : countEach_";
  protected final String TEXT_313 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_314 = NL + "                            throw(e);";
  protected final String TEXT_315 = NL + "                        for(int countEach_";
  protected final String TEXT_316 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_317 = " += (countEach_";
  protected final String TEXT_318 = " < 0 ? 0 : countEach_";
  protected final String TEXT_319 = ");" + NL + "                        }";
  protected final String TEXT_320 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_321 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_322 = " = pstmt_";
  protected final String TEXT_323 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_324 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_325 = " = tmp_batchUpdateCount_";
  protected final String TEXT_326 = " > countSum_";
  protected final String TEXT_327 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_328 = " : countSum_";
  protected final String TEXT_329 = ";";
  protected final String TEXT_330 = NL + "                        insertedCount_";
  protected final String TEXT_331 = " += tmp_batchUpdateCount_";
  protected final String TEXT_332 = ";";
  protected final String TEXT_333 = NL + "                        updatedCount_";
  protected final String TEXT_334 = " += tmp_batchUpdateCount_";
  protected final String TEXT_335 = ";";
  protected final String TEXT_336 = NL + "                        deletedCount_";
  protected final String TEXT_337 = " += tmp_batchUpdateCount_";
  protected final String TEXT_338 = ";";
  protected final String TEXT_339 = NL + "               }";
  protected final String TEXT_340 = NL + "                commitCounter_";
  protected final String TEXT_341 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_342 = " <= commitCounter_";
  protected final String TEXT_343 = ") {";
  protected final String TEXT_344 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_345 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_346 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_347 = NL + "\t                    for(int countEach_";
  protected final String TEXT_348 = ": pstmt_";
  protected final String TEXT_349 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_350 = " += (countEach_";
  protected final String TEXT_351 = " < 0 ? 0 : countEach_";
  protected final String TEXT_352 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_353 = NL + "\t                    ";
  protected final String TEXT_354 = NL + "\t                        insertedCount_";
  protected final String TEXT_355 = " += countSum_";
  protected final String TEXT_356 = ";" + NL + "\t                    ";
  protected final String TEXT_357 = NL + "\t                        updatedCount_";
  protected final String TEXT_358 = " += countSum_";
  protected final String TEXT_359 = ";" + NL + "\t                    ";
  protected final String TEXT_360 = NL + "\t                        deletedCount_";
  protected final String TEXT_361 = " += countSum_";
  protected final String TEXT_362 = ";" + NL + "\t                    ";
  protected final String TEXT_363 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_364 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_365 = NL + "                        throw(e);";
  protected final String TEXT_366 = NL + "                        int countSum_";
  protected final String TEXT_367 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_368 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_369 = " += (countEach_";
  protected final String TEXT_370 = " < 0 ? 0 : countEach_";
  protected final String TEXT_371 = ");" + NL + "                        }";
  protected final String TEXT_372 = NL + "                            insertedCount_";
  protected final String TEXT_373 = " += countSum_";
  protected final String TEXT_374 = ";";
  protected final String TEXT_375 = NL + "                            updatedCount_";
  protected final String TEXT_376 = " += countSum_";
  protected final String TEXT_377 = ";";
  protected final String TEXT_378 = NL + "                            deletedCount_";
  ...
  protected final String TEXT_387 = "=0;" + NL + "            }";
