...
public class TRESTClientMainJava
{
  ...
  protected final String TEXT_207 = NL + "\t        org.apache.cxf.configuration.jsse.TLSClientParameters clientParameters = new org.apache.cxf.configuration.jsse.TLSClientParameters();" + NL + "\t        clientParameters.setUseHttpsURLConnectionDefaultHostnameVerifier(true);" + NL + "\t        conduit_";
  protected final String TEXT_208 = ".setTlsClientParameters(clientParameters);" + NL + "\t";
  protected final String TEXT_209 = NL + "\t";
  protected final String TEXT_210 = NL + "\t\tconduit_";
  protected final String TEXT_211 = ".getClient().setAutoRedirect(true);" + NL + "\t\tclientConfig_";
  protected final String TEXT_212 = ".getRequestContext().put(\"http.redirect.relative.uri\", true);" + NL + "\t\tclientConfig_";
  protected final String TEXT_213 = ".getRequestContext().put(\"http.redirect.same.host.only\", ";
  protected final String TEXT_214 = ");" + NL + "\t";
  protected final String TEXT_215 = NL + NL + "\t";
  protected final String TEXT_216 = NL + "\t\tconduit_";
  protected final String TEXT_217 = ".getClient().setAllowChunking(false);" + NL + "\t";
  protected final String TEXT_218 = NL + NL + "\t";
  protected final String TEXT_219 = NL + "\t\t// set Content-Type" + NL + "\t\twebClient_";
  protected final String TEXT_220 = ".type(\"";
  protected final String TEXT_221 = "\");" + NL + "\t";
  protected final String TEXT_222 = NL + NL + "\t";
  protected final String TEXT_223 = NL + "\t\t// set Accept-Type" + NL + "\t\twebClient_";
  protected final String TEXT_224 = ".accept(\"";
  protected final String TEXT_225 = "\");" + NL + "\t";
  protected final String TEXT_226 = NL + NL + "\t";
  protected final String TEXT_227 = NL + "\t\t// set optional query and header properties if any" + NL + "\t";
  protected final String TEXT_228 = NL + "\t\twebClient_";
  protected final String TEXT_229 = ".header(";
  protected final String TEXT_230 = ", ";
  protected final String TEXT_231 = ");" + NL + "\t";
  protected final String TEXT_232 = NL + "\tif (use_auth_";
  protected final String TEXT_233 = " && \"OAUTH2_BEARER\".equals(";
  protected final String TEXT_234 = ")) {" + NL + "\t\t// set oAuth2 bearer token" + NL + "\t\twebClient_";
  protected final String TEXT_235 = ".header(\"Authorization\", \"Bearer \" + ";
  protected final String TEXT_236 = ");" + NL + "\t}" + NL + "\t" + NL + "\tif (use_auth_";
  protected final String TEXT_237 = " && \"OIDC_PASSWORD_GRANT\".equals(";
  ...
  protected final String TEXT_242 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_243 = " = ";
  protected final String TEXT_244 = "; ";
  protected final String TEXT_245 = NL + NL + "        String username_";
  protected final String TEXT_246 = " = ";
  protected final String TEXT_247 = ";" + NL + "        String password_";
  protected final String TEXT_248 = " = decryptedPassword_";
  protected final String TEXT_249 = ";" + NL + "" + NL + "        String bearerHeader_";
  protected final String TEXT_250 = " = null;" + NL + "" + NL + "        try {" + NL + "\t\t\tif (!inOSGi) {" + NL + "\t\t\t\torg.springframework.context.support.ClassPathXmlApplicationContext context_";
  protected final String TEXT_251 = " =" + NL + "\t\t\t\t\tnew org.springframework.context.support.ClassPathXmlApplicationContext(\"META-INF/tesb/oidc-context.xml\");" + NL + "\t\t\t\torg.talend.esb.security.oidc.OidcConfiguration oidcConfiguration_";
  protected final String TEXT_252 = " = context_";
  protected final String TEXT_253 = ".getBean(org.talend.esb.security.oidc.OidcConfiguration.class);" + NL + "\t\t\t\tbearerHeader_";
  protected final String TEXT_254 = " = org.talend.esb.security.oidc.OidcClientUtils.oidcClientBearer(username_";
  protected final String TEXT_255 = ", password_";
  protected final String TEXT_256 = ", oidcConfiguration_";
  protected final String TEXT_257 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tbearerHeader_";
  protected final String TEXT_258 = " = org.talend.esb.security.oidc.OidcClientUtils.oidcClientBearer(username_";
  protected final String TEXT_259 = ", password_";
  protected final String TEXT_260 = ");" + NL + "\t\t\t}" + NL + "\t\t} catch (Exception ex) {" + NL + "            throw new javax.ws.rs.WebApplicationException(\"Failed to get OIDC access token: \", ex);" + NL + "        }" + NL + "" + NL + "\t\twebClient_";
  protected final String TEXT_261 = ".header(\"Authorization\", bearerHeader_";
  protected final String TEXT_262 = ");" + NL + "\t}" + NL + "    " + NL + "\t// if FORM request then capture query parameters into Form, otherwise set them as queries" + NL + "\t";
  protected final String TEXT_263 = NL + "\t\tjavax.ws.rs.core.Form form_";
  protected final String TEXT_264 = " = new javax.ws.rs.core.Form();" + NL + "\t\t";
  protected final String TEXT_265 = NL + "\t\t\tform_";
  protected final String TEXT_266 = ".param(";
  protected final String TEXT_267 = " ,";
  protected final String TEXT_268 = ");" + NL + "\t\t";
  protected final String TEXT_269 = NL + "\t\trequestBody_";
  protected final String TEXT_270 = " = form_";
  protected final String TEXT_271 = ";" + NL + "\t";
  protected final String TEXT_272 = NL + "\t\t";
  protected final String TEXT_273 = NL + "\t\t\twebClient_";
  protected final String TEXT_274 = ".query(";
  protected final String TEXT_275 = " ,";
  protected final String TEXT_276 = ");" + NL + "\t\t";
  protected final String TEXT_277 = NL + "\t";
  protected final String TEXT_278 = NL + NL + NL + "\ttry {" + NL + "\t\t// start send request" + NL + "\t\t";
  protected final String TEXT_279 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_280 = " = webClient_";
  protected final String TEXT_281 = ".get";
  protected final String TEXT_282 = "Collection";
  protected final String TEXT_283 = "(responseClass_";
  protected final String TEXT_284 = ");" + NL + "\t\t";
  protected final String TEXT_285 = NL + "\t\t\t";
  protected final String TEXT_286 = NL + "\t\t\t\tresponseDoc_";
  protected final String TEXT_287 = " = webClient_";
  protected final String TEXT_288 = ".postObjectGetCollection(requestBody_";
  protected final String TEXT_289 = ", responseClass_";
  protected final String TEXT_290 = ");" + NL + "\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\tresponseDoc_";
  protected final String TEXT_292 = " = webClient_";
  protected final String TEXT_293 = ".post(requestBody_";
  protected final String TEXT_294 = ");" + NL + "\t\t\t";
  protected final String TEXT_295 = NL + "\t\t";
  protected final String TEXT_296 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_297 = " = webClient_";
  protected final String TEXT_298 = ".put(requestBody_";
  protected final String TEXT_299 = ");" + NL + "\t\t";
  protected final String TEXT_300 = NL + "\t\t\torg.apache.cxf.jaxrs.client.WebClient.getConfig(webClient_";
  protected final String TEXT_301 = ").getRequestContext().put(\"use.httpurlconnection.method.reflection\", true);" + NL + "\t\t\tresponseDoc_";
  protected final String TEXT_302 = " = webClient_";
  protected final String TEXT_303 = ".invoke(\"PATCH\", requestBody_";
  protected final String TEXT_304 = ");" + NL + "\t\t";
  protected final String TEXT_305 = NL + "\t\t    responseDoc_";
  protected final String TEXT_306 = " = webClient_";
  protected final String TEXT_307 = ".invoke(\"";
  protected final String TEXT_308 = "\", requestBody_";
  protected final String TEXT_309 = ");" + NL + "\t\t";
  protected final String TEXT_310 = NL + "\t\t\twebClient_";
  protected final String TEXT_311 = ".invoke(\"";
  protected final String TEXT_312 = "\", requestBody_";
  protected final String TEXT_313 = ");" + NL + "\t\t";
  protected final String TEXT_314 = NL + NL + NL + "\t\tint webClientResponseStatus_";
  protected final String TEXT_315 = " = webClient_";
  protected final String TEXT_316 = ".getResponse().getStatus();" + NL + "\t\tif (webClientResponseStatus_";
  protected final String TEXT_317 = " >= 300) {" + NL + "\t\t\tthrow new javax.ws.rs.WebApplicationException(webClient_";
  protected final String TEXT_318 = ".getResponse());" + NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_319 = NL + "\t\t\tif (";
  protected final String TEXT_320 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_321 = " = new ";
  protected final String TEXT_322 = "Struct();" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_323 = ".statusCode = webClientResponseStatus_";
  protected final String TEXT_324 = ";" + NL + "\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tObject responseObj_";
  protected final String TEXT_327 = " = responseDoc_";
  protected final String TEXT_328 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_329 = NL + "\t\t\t\tObject responseObj_";
  protected final String TEXT_330 = " = null;" + NL + "\t\t\t\tif(responseDoc_";
  protected final String TEXT_331 = " != null && responseDoc_";
  protected final String TEXT_332 = ".hasEntity()){" + NL + "\t\t\t\t\tresponseObj_";
  protected final String TEXT_333 = " = responseDoc_";
  protected final String TEXT_334 = ".readEntity(responseClass_";
  protected final String TEXT_335 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_336 = NL + "\t\t\t\tif(responseObj_";
  protected final String TEXT_337 = " != null){" + NL + "\t\t\t\t\tif (responseClass_";
  protected final String TEXT_338 = " == String.class) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_339 = ".string = (String) responseObj_";
  protected final String TEXT_340 = ";" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\troutines.system.Document responseTalendDoc_";
  protected final String TEXT_341 = " = null;" + NL + "\t\t\t\t\t\tif (null != responseObj_";
  protected final String TEXT_342 = ") {" + NL + "\t\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_343 = " = new routines.system.Document();" + NL + "\t\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_344 = ".setDocument((org.dom4j.Document) responseObj_";
  protected final String TEXT_345 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_346 = ".body = responseTalendDoc_";
  protected final String TEXT_347 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_348 = NL + NL + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_349 = "_HEADERS\", webClient_";
  protected final String TEXT_350 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_352 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_353 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_354 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t// handle \"oneway\" for PUT, POST and PATCH with empty response payload" + NL + "\t\t\tif (webClientResponseStatus_";
  protected final String TEXT_357 = " == 202 && responseObj_";
  protected final String TEXT_358 = " == null){" + NL + "\t\t\t\t";
  protected final String TEXT_359 = ".string = \"\";" + NL + "\t\t\t\treturn;" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_360 = NL + "\t\t";
  protected final String TEXT_361 = NL + NL + "\t} catch (javax.ws.rs.WebApplicationException ex_";
  protected final String TEXT_362 = ") {" + NL + "\t\t";
  protected final String TEXT_363 = NL + "\t\t\tif (";
  protected final String TEXT_364 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_365 = " = new ";
  protected final String TEXT_366 = "Struct();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_367 = ".errorCode = ex_";
  protected final String TEXT_368 = ".getResponse().getStatus();" + NL + "" + NL + "\t\t\tString errorMessage_";
  protected final String TEXT_369 = " = null;" + NL + "\t\t\ttry {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_370 = " = ex_";
  protected final String TEXT_371 = ".getResponse().readEntity(String.class);" + NL + "\t\t\t} catch (Exception exe_";
  protected final String TEXT_372 = ") {" + NL + "\t\t\t\t// ignore" + NL + "\t\t\t}" + NL + "\t\t\tif (null == errorMessage_";
  protected final String TEXT_373 = " || 0 == errorMessage_";
  protected final String TEXT_374 = ".trim().length()) {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_375 = " = ex_";
  protected final String TEXT_376 = ".getMessage();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_377 = ".errorMessage = errorMessage_";
  protected final String TEXT_378 = ";" + NL + "" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_379 = "_HEADERS\", ex_";
  protected final String TEXT_380 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_381 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_382 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_383 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_384 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_385 = NL + "\t\t";
  protected final String TEXT_386 = NL + "\t\t\tthrow ex_";
  protected final String TEXT_387 = ";" + NL + "\t\t";
  protected final String TEXT_388 = NL + "\t}" + NL + "" + NL + "} catch(Exception e_";
  protected final String TEXT_389 = ") {" + NL + "\t";
  protected final String TEXT_390 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_391 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_392 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_393 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_394 = NL + "}" + NL;
  protected final String TEXT_395 = NL + "java.util.Collection<String> responseParts_";
  protected final String TEXT_396 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_397 = NL + "org.apache.cxf.jaxrs.ext.multipart.MultipartBody multipartBody_";
  protected final String TEXT_398 = " =responseDoc_";
  protected final String TEXT_399 = ".readEntity(org.apache.cxf.jaxrs.ext.multipart.MultipartBody.class);" + NL + "try {" + NL + "\tfor (org.apache.cxf.jaxrs.ext.multipart.Attachment att_";
  protected final String TEXT_400 = " : multipartBody_";
  protected final String TEXT_401 = ".getAllAttachments()) {" + NL + "       java.io.InputStream is_";
  protected final String TEXT_402 = " = att_";
  protected final String TEXT_403 = ".getDataHandler().getInputStream();" + NL + "       java.util.Scanner s_";
  protected final String TEXT_404 = " = new java.util.Scanner(is_";
  protected final String TEXT_405 = ").useDelimiter(\"\\\\A\");" + NL + "       responseParts_";
  protected final String TEXT_406 = ".add(s_";
  protected final String TEXT_407 = ".hasNext() ? s_";
  protected final String TEXT_408 = ".next() : \"\");" + NL + "       is_";
  protected final String TEXT_409 = ".close();" + NL + "   }" + NL + "} catch (java.io.IOException e_";
  protected final String TEXT_410 = ") {" + NL + "\t";
  protected final String TEXT_411 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_412 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_413 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_414 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_415 = NL + "}";
  protected final String TEXT_416 = NL + "for (String responsePart_";
  protected final String TEXT_417 = " : responseDoc_";
  protected final String TEXT_418 = ") {" + NL + "    responseParts_";
  protected final String TEXT_419 = ".add(responsePart_";
  protected final String TEXT_420 = ");" + NL + "}";
  protected final String TEXT_421 = NL + "for (String responsePart_";
  protected final String TEXT_422 = " : responseParts_";
  protected final String TEXT_423 = ") {" + NL + "    row1 = new row1Struct();" + NL + "    row1.string = responsePart_";
