...
public class TRedshiftConnectionBeginJava
{
  ...
  protected final String TEXT_31 = NL + "\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_32 = " = new java.io.FileWriter(";
  protected final String TEXT_33 = ", true);" + NL + "\t\t\t\tjava.io.PrintWriter logWriter_";
  protected final String TEXT_34 = " = new java.io.PrintWriter(output_";
  protected final String TEXT_35 = ",true);" + NL + "\t\t\t\tglobalMap.put(\"logWriter_";
  protected final String TEXT_36 = "\", logWriter_";
  protected final String TEXT_37 = ");" + NL + "\t\t\t\tjava.sql.DriverManager.setLogWriter(logWriter_";
  protected final String TEXT_38 = ");";
  protected final String TEXT_39 = NL + "            StringBuilder sbuilder_";
  protected final String TEXT_40 = " = new StringBuilder();" + NL + "            sbuilder_";
  protected final String TEXT_41 = ".append(\"jdbc:redshift:\");";
  protected final String TEXT_42 = NL + "                sbuilder_";
  protected final String TEXT_43 = ".append(\"iam:\");";
  protected final String TEXT_44 = NL + "            sbuilder_";
  protected final String TEXT_45 = ".append(\"//\")" + NL + "                             .append(";
  protected final String TEXT_46 = ")" + NL + "                             .append(\":\")" + NL + "                             .append(";
  protected final String TEXT_47 = ")" + NL + "                             .append(\"/\")" + NL + "                             .append(";
  protected final String TEXT_48 = ")" + NL + "                             .append(\"?loglevel=\")" + NL + "                             .append(";
  protected final String TEXT_49 = ");";
  protected final String TEXT_50 = NL + "                sbuilder_";
  protected final String TEXT_51 = ".append(\"&\").append(";
  protected final String TEXT_52 = ");";
  protected final String TEXT_53 = NL + "            String url_";
  protected final String TEXT_54 = " = sbuilder_";
  ...
  protected final String TEXT_173 = NL + "\tglobalMap.put(\"schema_\" + \"";
  protected final String TEXT_174 = "\",";
  protected final String TEXT_175 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_\" + \"";
