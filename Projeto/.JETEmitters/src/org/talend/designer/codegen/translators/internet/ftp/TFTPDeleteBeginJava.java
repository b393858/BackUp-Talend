...
public class TFTPDeleteBeginJava
{
  ...
  protected final String TEXT_134 = "\t" + NL + "\t\t    \t" + NL + "\t\t    \t" + NL + "\t\t";
  ...
  protected final String TEXT_141 = " - Uses an existing connection. Connection username: \" + c_";
  ...
  protected final String TEXT_162 = " - Deleting file from server.\");" + NL + "\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_164 = " - Deleting directory from server.\");" + NL + "\t\t\t";
  protected final String TEXT_165 = NL + "\t\t";
  protected final String TEXT_166 = NL + "\t\tfor (java.util.Map<String, String> map";
  protected final String TEXT_167 = " : list";
  protected final String TEXT_168 = ") {" + NL;
  protected final String TEXT_169 = NL + "\t\t\t";
  protected final String TEXT_170 = NL + NL + "\tclass MyTrust_";
  ...
  protected final String TEXT_178 = NL + "\t\t\tks.load(new java.io.FileInputStream(";
  protected final String TEXT_179 = "), decryptedKeyStorePassword_";
  protected final String TEXT_180 = ".toCharArray());" + NL + "\t\t\tjavax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "\t\t\ttmf.init(ks);" + NL + "\t\t\treturn tmf.getTrustManagers();" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t\tclass SSLSessionReuseFTPSClient_";
  protected final String TEXT_181 = " extends org.apache.commons.net.ftp.FTPSClient {" + NL + "" + NL + "\t\tpublic SSLSessionReuseFTPSClient_";
  ...
  protected final String TEXT_183 = NL + "\t\t\t\t\t\tlog.error(\"Can't adapt ftps client to support TLS session resumption\");";
  protected final String TEXT_184 = NL + "\t\t\t\t\tthrow new RuntimeException(e);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t\t\tjavax.net.ssl.SSLContext sslContext_";
  protected final String TEXT_185 = " = null;" + NL + "\t\t\tjavax.net.ssl.TrustManager[] trustManager_";
  protected final String TEXT_186 = " = null;" + NL + "\t\t\tjavax.net.ssl.SSLSocketFactory sslSocketFactory_";
  protected final String TEXT_187 = " = null;" + NL + "\t\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_188 = " =null;" + NL + "\t\t\tMyTrust_";
  protected final String TEXT_189 = " myTrust_";
  protected final String TEXT_190 = " = null;" + NL + "" + NL + "\t\t\ttry {" + NL + "\t\t\t\tsslContext_";
  protected final String TEXT_191 = " = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "\t\t\t\tmyTrust_";
  protected final String TEXT_192 = " = new MyTrust_";
  protected final String TEXT_193 = "();" + NL + "\t\t\t\ttrustManager_";
  protected final String TEXT_194 = " = myTrust_";
  protected final String TEXT_195 = ".getTrustManagers();" + NL + "\t\t\t\tsslContext_";
  protected final String TEXT_196 = ".init(null, trustManager_";
  protected final String TEXT_197 = ", new java.security.SecureRandom());" + NL + "\t\t\t\tsslSocketFactory_";
  protected final String TEXT_198 = " = sslContext_";
  protected final String TEXT_199 = ".getSocketFactory();" + NL + "\t\t\t\tftp_";
  protected final String TEXT_200 = " = new SSLSessionReuseFTPSClient_";
  protected final String TEXT_201 = "(";
  protected final String TEXT_202 = ", sslContext_";
  protected final String TEXT_203 = ");" + NL + "\t\t\t\tftp_";
  protected final String TEXT_204 = ".setControlEncoding(";
  protected final String TEXT_205 = ");" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_206 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_207 = " -FTPS security Mode is ";
  protected final String TEXT_208 = ".\");" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_209 = " - Attempt to connect to '\" + ";
  protected final String TEXT_210 = " + \"' with username '\" + ";
  protected final String TEXT_211 = "+ \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_212 = NL + "\t\t\t\tftp_";
  protected final String TEXT_213 = ".connect(";
  ...
  protected final String TEXT_219 = NL + "\t\t\t\tftp_";
  protected final String TEXT_220 = ".setRemoteVerificationEnabled(";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_223 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_224 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_225 = ");";
  protected final String TEXT_226 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_227 = " = ";
  protected final String TEXT_228 = "; ";
  protected final String TEXT_229 = NL + NL + "\t\t\t\tboolean isLoginSuccessful_";
  protected final String TEXT_230 = " = ftp_";
  protected final String TEXT_231 = ".login(";
  protected final String TEXT_232 = ", decryptedPassword_";
  protected final String TEXT_233 = ");" + NL + "" + NL + "\t\t\t\tif (!isLoginSuccessful_";
  protected final String TEXT_234 = ") {" + NL + "\t\t\t\t\tthrow new RuntimeException(\"Login failed\");" + NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t\tftp_";
  ...
  protected final String TEXT_241 = NL + "\t\t\t\t\tthrow e;";
  protected final String TEXT_242 = NL + "\t\t\t\t\te.printStackTrace();";
  protected final String TEXT_243 = NL + "\t\t\t}" + NL;
  protected final String TEXT_244 = NL + "\t\t\t\tftp_";
  protected final String TEXT_245 = ".enterLocalPassiveMode();";
  protected final String TEXT_246 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_247 = " - Using the passive mode.\");";
  protected final String TEXT_248 = NL + "\t\t\torg.apache.commons.net.ftp.FTPSClient ftp_";
  protected final String TEXT_249 = " = (org.apache.commons.net.ftp.FTPSClient) globalMap.get(\"";
  protected final String TEXT_250 = "\");";
  protected final String TEXT_251 = NL + "\t\t\t\tboolean cwdSuccess_";
  protected final String TEXT_252 = " = ftp_";
  protected final String TEXT_253 = ".changeWorkingDirectory(";
  protected final String TEXT_254 = ");" + NL + "" + NL + "\t\t\t\tif (!cwdSuccess_";
  protected final String TEXT_255 = ") {" + NL + "\t\t\t\t\tthrow new RuntimeException(\"Failed to change remote directory. \" + ftp_";
  protected final String TEXT_256 = ".getReplyString());" + NL + "\t\t\t\t}";
  protected final String TEXT_257 = NL + "\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\tString rootWorkDir_";
  protected final String TEXT_259 = " = ftp_";
  protected final String TEXT_260 = ".printWorkingDirectory();" + NL + "\t\t\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_261 = " = new java.util.ArrayList<>();";
  protected final String TEXT_262 = NL + "\t\t\t\tjava.util.Map<String,String> map";
  protected final String TEXT_263 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tmap";
  protected final String TEXT_264 = ".put(";
  protected final String TEXT_265 = ",\"\");" + NL + "\t\t\t\tlist";
  protected final String TEXT_266 = ".add(map";
  protected final String TEXT_267 = ");";
  protected final String TEXT_268 = "  " + NL + "\t\t\tfor (java.util.Map<String, String> map";
  protected final String TEXT_269 = " : list";
  protected final String TEXT_270 = ") {";
  protected final String TEXT_271 = NL + "\t\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_272 = " =null;" + NL + "" + NL + "\t\t";
  protected final String TEXT_273 = NL + "    \t\tftp_";
  protected final String TEXT_274 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_275 = "\");" + NL + "\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\tif(ftp_";
  protected final String TEXT_277 = "!=null) {" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_278 = " - Uses an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_279 = ".getRemoteHost() + \",Connection port: \" + ftp_";
  protected final String TEXT_280 = ".getRemotePort() + \".\"); " + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_281 = NL + "\t\t  \t";
  protected final String TEXT_282 = NL + "\t\t  \t\tString rootDir_";
  protected final String TEXT_283 = " = ftp_";
  protected final String TEXT_284 = ".pwd();" + NL + "\t\t  \t";
  protected final String TEXT_285 = NL + "  \t\t";
  protected final String TEXT_286 = "    " + NL + "\t\t    ftp_";
  protected final String TEXT_287 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t\t    ftp_";
  protected final String TEXT_288 = ".setRemoteHost(";
  protected final String TEXT_289 = ");" + NL + "\t\t    ftp_";
  protected final String TEXT_290 = ".setRemotePort(";
  ...
  protected final String TEXT_297 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t\t    ";
  protected final String TEXT_298 = NL + "\t\t      ftp_";
  protected final String TEXT_299 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t\t    ";
  protected final String TEXT_300 = NL + "\t\t    ftp_";
  protected final String TEXT_301 = ".setControlEncoding(";
  protected final String TEXT_302 = ");" + NL + "\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_304 = " - Attempt to connect to '\" + ";
  protected final String TEXT_305 = " + \"' with username: '\" +";
  protected final String TEXT_306 = "+ \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_307 = NL + "\t\t    ftp_";
  protected final String TEXT_308 = ".connect();  " + NL + "\t\t    " + NL + "\t\t    ";
  ...
  protected final String TEXT_316 = NL + "\t\t    " + NL + "\t\t    ftp_";
  protected final String TEXT_317 = ".login(";
  protected final String TEXT_318 = ", decryptedPassword_";
  protected final String TEXT_319 = ");" + NL + "\t\t\t";
  protected final String TEXT_320 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_321 = " - Connect to '\" + ";
  protected final String TEXT_322 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_323 = "  " + NL + "  \t\t";
  protected final String TEXT_324 = "  " + NL + "  \t\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_325 = " = new java.util.ArrayList<java.util.Map<String,String>>();  " + NL + "" + NL + "\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\tjava.util.Map<String,String> map";
  protected final String TEXT_327 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tmap";
  protected final String TEXT_328 = ".put(";
  protected final String TEXT_329 = ",\"\");" + NL + "\t\t\t\tlist";
  protected final String TEXT_330 = ".add(map";
  protected final String TEXT_331 = ");       " + NL + "  \t\t";
  protected final String TEXT_332 = "  " + NL + "\t\t\tString remotedir";
  protected final String TEXT_333 = " = ";
  protected final String TEXT_334 = ";" + NL + "\t\t\tftp_";
  protected final String TEXT_335 = ".chdir(remotedir";
  protected final String TEXT_336 = ");" + NL + "\t\t\tString root";
  protected final String TEXT_337 = " = ftp_";
  protected final String TEXT_338 = ".pwd();" + NL + "" + NL + "\t\t";
  protected final String TEXT_339 = NL + "\t\t\t";
  protected final String TEXT_340 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_341 = " - Deleting file from server.\");" + NL + "\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_343 = " - Deleting directory from server.\");" + NL + "\t\t\t";
  protected final String TEXT_344 = NL + "\t\t";
  protected final String TEXT_345 = NL + "\t\t\tfor (java.util.Map<String, String> map";
