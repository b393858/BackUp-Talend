...
public class TParAccelOutputBeginJava {
  ...
  protected final String TEXT_95 = NL + NL + "    java.lang.Class.forName(\"com.paraccel.Driver\");";
  protected final String TEXT_96 = NL + NL + "    String url_";
  protected final String TEXT_97 = " = \"jdbc:paraccel://\"+";
  ...
  protected final String TEXT_117 = NL + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_118 = "\", conn_";
  protected final String TEXT_119 = ");" + NL;
  protected final String TEXT_120 = NL + "            conn_";
  protected final String TEXT_121 = ".setAutoCommit(false);";
  protected final String TEXT_122 = NL + NL + "\t";
  protected final String TEXT_123 = NL;
  protected final String TEXT_124 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_125 = " = conn_";
  protected final String TEXT_126 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_154 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_164 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_170 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_177 = NL + "            try (java.sql.Statement stmtClearCount_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".createStatement();" + NL + "                    java.sql.ResultSet rsClearCount_";
  protected final String TEXT_180 = " = stmtClearCount_";
  protected final String TEXT_181 = ".executeQuery(\"";
  ...
  protected final String TEXT_188 = NL + "                while(rsClearCount_";
  protected final String TEXT_189 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_190 = " += rsClearCount_";
  protected final String TEXT_191 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_192 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_202 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_203 = " + \"\\\" SET ";
  protected final String TEXT_204 = " WHERE ";
  protected final String TEXT_205 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_206 = "\", pstmt_";
  protected final String TEXT_207 = ");" + NL + "\t    ";
  protected final String TEXT_208 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_211 = " + \"\\\" WHERE ";
  protected final String TEXT_212 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_213 = "\", pstmt_";
  protected final String TEXT_214 = ");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_217 = " + \"\\\" (";
  protected final String TEXT_218 = ") VALUES (";
  protected final String TEXT_219 = ")\");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_220 = "\", pstmtInsert_";
  protected final String TEXT_221 = ");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_222 = " = conn_";
  protected final String TEXT_223 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_231 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_232 = " + \"\\\" SET ";
  protected final String TEXT_233 = " WHERE ";
  protected final String TEXT_234 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_235 = "\", pstmtUpdate_";
  protected final String TEXT_236 = ");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_244 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_245 = " = conn_";
  protected final String TEXT_246 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_247 = " + \"\\\" WHERE ";
  protected final String TEXT_248 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
