...
public class TDB2ConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_34 = " + \":\" + ";
  protected final String TEXT_35 = " + \"/\" + ";
  protected final String TEXT_36 = ";";
  protected final String TEXT_37 = NL + "\t\tString url_";
  protected final String TEXT_38 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_39 = " + \":\" + ";
  protected final String TEXT_40 = " + \"/\" + ";
  protected final String TEXT_41 = " + \":\" + ";
  protected final String TEXT_42 = ";";
  protected final String TEXT_43 = NL + "\t\t\tglobalMap.put(\"tableschema_";
  ...
  protected final String TEXT_60 = NL + "\t\t\tString dbPwd_";
  ...
  protected final String TEXT_66 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_71 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_72 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_77 = " - Written records count: \" + nb_line_";
  protected final String TEXT_78 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_80 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_82 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_83 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_85 = " - Writing the record \" + nb_line_";
  protected final String TEXT_86 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_88 = " - Processing the record \" + nb_line_";
  protected final String TEXT_89 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_91 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_92 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_94 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_95 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_97 = " - Uses an existing connection ";
  protected final String TEXT_98 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_100 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_101 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_103 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_104 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_105 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_165 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_166 = "\", ";
  protected final String TEXT_167 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_168 = "\", ";
  protected final String TEXT_169 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_170 = "\", ";
  protected final String TEXT_171 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_172 = "\", dbUser_";
  protected final String TEXT_173 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_174 = "\", dbPwd_";
