...
public class TPostgresPlusOutputMainJava {
  ...
  protected final String TEXT_148 = NL + "            int checkCount_";
  protected final String TEXT_149 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_150 = " = pstmt_";
  protected final String TEXT_151 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_152 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_153 = " = rs_";
  protected final String TEXT_154 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_172 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_173 = " = updatedCount_";
  protected final String TEXT_174 = " + pstmtUpdate_";
  protected final String TEXT_175 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_176 = "++;";
  protected final String TEXT_177 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_178 = " = true;";
  protected final String TEXT_179 = NL + "                        throw(e);";
  ...
  protected final String TEXT_194 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_199 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_209 = " + pstmtInsert_";
  protected final String TEXT_210 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_211 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_212 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_213 = " = true;";
  protected final String TEXT_214 = NL + "                        throw(e);";
  protected final String TEXT_215 = NL + "                    \t\tnb_line_";
  ...
  protected final String TEXT_225 = NL + "                            rejectedCount_";
  protected final String TEXT_226 = " = rejectedCount_";
  protected final String TEXT_227 = " + 1;";
  protected final String TEXT_228 = NL + "                            ";
  protected final String TEXT_229 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_235 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_253 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_254 = "=pstmtUpdate_";
  protected final String TEXT_255 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_256 = " = updatedCount_";
  protected final String TEXT_257 = "+updateFlag_";
  protected final String TEXT_258 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_259 = " == 0) {" + NL + "            \t";
  protected final String TEXT_260 = NL + "\t\t\t\tquery_";
  protected final String TEXT_261 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_262 = NL + "                        ";
  protected final String TEXT_263 = NL + "                            query_";
  protected final String TEXT_264 = " = ";
  protected final String TEXT_265 = ";";
  protected final String TEXT_266 = NL + "                    globalMap.put(\"";
  protected final String TEXT_267 = "_QUERY\", query_";
  protected final String TEXT_268 = ".toString().trim());";
  protected final String TEXT_269 = NL + "                    insertedCount_";
  protected final String TEXT_270 = " = insertedCount_";
  protected final String TEXT_271 = " + pstmtInsert_";
  protected final String TEXT_272 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_273 = "++;";
  protected final String TEXT_274 = NL + "             }else{" + NL + "             \t   nb_line_";
  protected final String TEXT_275 = "++;" + NL + "             \t   ";
  protected final String TEXT_276 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_289 = NL + "                            rejectedCount_";
  protected final String TEXT_290 = " = rejectedCount_";
  protected final String TEXT_291 = " + 1;";
  protected final String TEXT_292 = NL + "                            ";
  protected final String TEXT_293 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_294 = NL + "                            ";
  protected final String TEXT_295 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_296 = ";";
  protected final String TEXT_297 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_298 = NL + "                }";
  protected final String TEXT_299 = NL + "\t\t\t\t\t";
  protected final String TEXT_300 = NL + "                    \t";
  protected final String TEXT_301 = NL + "\t                        query_";
  protected final String TEXT_302 = " = ";
  protected final String TEXT_303 = ";" + NL + "\t                        ";
  protected final String TEXT_304 = NL + "                    ";
  protected final String TEXT_305 = NL + "                        query_";
  protected final String TEXT_306 = " = ";
  protected final String TEXT_307 = ";";
  protected final String TEXT_308 = NL + "                globalMap.put(\"";
  protected final String TEXT_309 = "_QUERY\", query_";
  protected final String TEXT_310 = ".toString().trim());";
  ...
  protected final String TEXT_343 = NL + "            if(!whetherReject_";
  protected final String TEXT_344 = ") {";
  protected final String TEXT_345 = NL + "                            ";
  protected final String TEXT_346 = " = new ";
  protected final String TEXT_347 = "Struct();";
  ...
  protected final String TEXT_354 = NL + "                if ((batchSize_";
  protected final String TEXT_355 = " > 0) && (batchSize_";
  protected final String TEXT_356 = " <= batchSizeCounter_";
  protected final String TEXT_357 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_358 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_359 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_360 = " = 0;";
  protected final String TEXT_361 = NL + "                        status_";
  protected final String TEXT_362 = " = pstmt_";
  protected final String TEXT_363 = ".executeBatch();";
  protected final String TEXT_364 = NL + "                        for(int countEach_";
  protected final String TEXT_365 = ": status_";
  protected final String TEXT_366 = ") {" + NL + "                            countSum_";
  protected final String TEXT_367 = " += (countEach_";
  protected final String TEXT_368 = " < 0 ? 0 : countEach_";
  protected final String TEXT_369 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_370 = NL + "                            throw(e);";
  protected final String TEXT_371 = NL + "                        for(int countEach_";
  protected final String TEXT_372 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_373 = " += (countEach_";
  protected final String TEXT_374 = " < 0 ? 0 : countEach_";
  protected final String TEXT_375 = ");" + NL + "                        }";
  protected final String TEXT_376 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_377 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_378 = " = pstmt_";
  protected final String TEXT_379 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_380 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_381 = " = tmp_batchUpdateCount_";
  protected final String TEXT_382 = " > countSum_";
  protected final String TEXT_383 = " ? tmp_batchUpdateCount_";
  ...
  protected final String TEXT_393 = " += tmp_batchUpdateCount_";
  protected final String TEXT_394 = ";";
  protected final String TEXT_395 = NL + "               }";
  protected final String TEXT_396 = NL + "                commitCounter_";
  protected final String TEXT_397 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_398 = " <= commitCounter_";
  protected final String TEXT_399 = ") {";
  protected final String TEXT_400 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_401 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_402 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_403 = NL + "\t                    for(int countEach_";
  protected final String TEXT_404 = ": pstmt_";
  protected final String TEXT_405 = ".executeBatch()) {" + NL + "\t                        countSum_";
  ...
  protected final String TEXT_410 = NL + "\t                        insertedCount_";
  protected final String TEXT_411 = " += countSum_";
  protected final String TEXT_412 = ";" + NL + "\t                    ";
  protected final String TEXT_413 = NL + "\t                        updatedCount_";
  protected final String TEXT_414 = " += countSum_";
  protected final String TEXT_415 = ";" + NL + "\t                    ";
  protected final String TEXT_416 = NL + "\t                        deletedCount_";
  protected final String TEXT_417 = " += countSum_";
  protected final String TEXT_418 = ";" + NL + "\t                    ";
  protected final String TEXT_419 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_420 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_421 = NL + "                        throw(e);";
  protected final String TEXT_422 = NL + "                        int countSum_";
  protected final String TEXT_423 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_424 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_425 = " += (countEach_";
  protected final String TEXT_426 = " < 0 ? 0 : countEach_";
  protected final String TEXT_427 = ");" + NL + "                        }";
  protected final String TEXT_428 = NL + "                            insertedCount_";
  protected final String TEXT_429 = " += countSum_";
  protected final String TEXT_430 = ";";
  protected final String TEXT_431 = NL + "                            updatedCount_";
  protected final String TEXT_432 = " += countSum_";
  protected final String TEXT_433 = ";";
  protected final String TEXT_434 = NL + "                            deletedCount_";
  protected final String TEXT_435 = " += countSum_";
  protected final String TEXT_436 = ";";
  protected final String TEXT_437 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_438 = NL + "                }";
  protected final String TEXT_439 = NL + "                ";
  protected final String TEXT_440 = NL + "                conn_";
  protected final String TEXT_441 = ".commit();";
  protected final String TEXT_442 = NL + "                commitCounter_";
  protected final String TEXT_443 = "=0;" + NL + "            }";
