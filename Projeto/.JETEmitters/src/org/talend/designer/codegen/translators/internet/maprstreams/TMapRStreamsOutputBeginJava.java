...
public class TMapRStreamsOutputBeginJava
{
  ...
  protected final String TEXT_21 = "_producer);" + NL + "}" + NL + "" + NL + "int EXCEPTION_CATCH_TIMEOUT_";
  protected final String TEXT_22 = " = 5;" + NL + "java.util.concurrent.atomic.AtomicInteger rev_cnt_";
  protected final String TEXT_23 = " = new java.util.concurrent.atomic.AtomicInteger();" + NL + "java.util.Set<Exception> exceptions_";
  protected final String TEXT_24 = " = java.util.Collections.synchronizedSet(new java.util.HashSet<>());";
