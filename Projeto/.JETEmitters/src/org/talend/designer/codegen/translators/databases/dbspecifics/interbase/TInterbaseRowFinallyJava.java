...
public class TInterbaseRowFinallyJava
{
  protected static String nl;
  public static synchronized TInterbaseRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseRowFinallyJava result = new TInterbaseRowFinallyJava();
    nl = null;
    return result;
  }
