...
public class TMemSQLOutputMainJava {
  ...
  protected final String TEXT_57 = ".addBatch();" + NL + "                    batchSizeCounter_";
  ...
  protected final String TEXT_87 = "_QUERY\", query_";
  protected final String TEXT_88 = ".toString().trim());";
  ...
  protected final String TEXT_102 = NL + "                    pstmt_";
  protected final String TEXT_103 = ".addBatch();" + NL + "                    batchSizeCounter_";
  protected final String TEXT_104 = "++;" + NL + "                    nb_line_";
  protected final String TEXT_105 = "++;";
  protected final String TEXT_106 = NL + NL + "           try {" + NL + "                nb_line_";
  protected final String TEXT_107 = "++;" + NL + "                updatedCount_";
  ...
  protected final String TEXT_111 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_126 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_133 = "_QUERY\", query_";
  protected final String TEXT_134 = ".toString().trim());";
  protected final String TEXT_135 = NL + "\t\t\t\t\t";
  protected final String TEXT_136 = NL + "                    \t";
  protected final String TEXT_137 = NL + "                    ";
  protected final String TEXT_138 = NL + NL + "            int checkCount_";
  protected final String TEXT_139 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_140 = " = pstmt_";
  protected final String TEXT_141 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_142 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_143 = " = rs_";
  protected final String TEXT_144 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_161 = "_QUERY\", query_";
  protected final String TEXT_162 = ".toString().trim());";
  protected final String TEXT_163 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_164 = " = updatedCount_";
  protected final String TEXT_165 = " + pstmtUpdate_";
  protected final String TEXT_166 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_167 = "++;";
  protected final String TEXT_168 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_190 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_216 = NL + "                            rejectedCount_";
  protected final String TEXT_217 = " = rejectedCount_";
  protected final String TEXT_218 = " + 1;";
  ...
  protected final String TEXT_227 = "=0;" + NL + "    \t    ";
  ...
  protected final String TEXT_250 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_251 = " == 0) {" + NL + "            \t";
  protected final String TEXT_252 = NL + "\t\t\t\tquery_";
  protected final String TEXT_253 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_254 = NL + "                        ";
  protected final String TEXT_255 = NL + "                            query_";
  protected final String TEXT_256 = " = ";
  protected final String TEXT_257 = ";";
  protected final String TEXT_258 = NL + "                    globalMap.put(\"";
  protected final String TEXT_259 = "_QUERY\", query_";
  protected final String TEXT_260 = ".toString().trim());";
  protected final String TEXT_261 = NL + "                \tinsertedCount_";
  protected final String TEXT_262 = " = insertedCount_";
  protected final String TEXT_263 = " + pstmtInsert_";
  protected final String TEXT_264 = ".executeUpdate();" + NL + "                     nb_line_";
  protected final String TEXT_265 = "++;";
  protected final String TEXT_266 = NL + "             }else{" + NL + "                nb_line_";
  protected final String TEXT_267 = "++;";
  protected final String TEXT_268 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_285 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_286 = NL + "                            ";
  protected final String TEXT_287 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_288 = ";";
  protected final String TEXT_289 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_334 = "_QUERY\", query_";
  protected final String TEXT_335 = ".toString().trim());";
  protected final String TEXT_336 = NL + "                if ( batchSize_";
  protected final String TEXT_337 = " == batchSizeCounter_";
  protected final String TEXT_338 = ") {" + NL + "                    long countSum_";
  protected final String TEXT_339 = " = 0;" + NL + "                    int[] resultStatus = {};" + NL + "                    try {";
  protected final String TEXT_340 = NL + "                        resultStatus = pstmt_";
  protected final String TEXT_341 = ".executeBatch();";
  protected final String TEXT_342 = NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_343 = "){";
  protected final String TEXT_344 = NL + "                        throw(e_";
  protected final String TEXT_345 = ");";
  protected final String TEXT_346 = NL + "                        System.err.println(e_";
  protected final String TEXT_347 = ".getMessage());" + NL + "                        for(int countEach_";
  protected final String TEXT_348 = ": e_";
  protected final String TEXT_349 = ".getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_350 = " += (countEach_";
  protected final String TEXT_351 = " < 0 ? 0 : countEach_";
  protected final String TEXT_352 = ");" + NL + "                        }";
  protected final String TEXT_353 = NL + "                    }" + NL + "" + NL + "                    long tmp_batchUpdateCount_";
  protected final String TEXT_354 = " = 0;" + NL + "                    for(int i : resultStatus){" + NL + "                          if(i==-3){//EXECUTE_FAILED ";
  protected final String TEXT_355 = NL + "                                System.err.println(\"Query failed to execute.\");" + NL + "                          }else if(i==-2){//SUCCESS_NO_INFO";
  protected final String TEXT_356 = NL + "                                System.err.println(\"Query was processed successfully but that the number of rows affected is unknown.\");" + NL + "                          }else{" + NL + "                               tmp_batchUpdateCount_";
  protected final String TEXT_357 = " += (i<0 ? 0 : i);" + NL + "                          }" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_358 = " += countSum_";
  protected final String TEXT_359 = ";";
  protected final String TEXT_360 = NL + "                        insertedCount_";
  protected final String TEXT_361 = NL + "                        updatedCount_";
  protected final String TEXT_362 = NL + "                        deletedCount_";
  protected final String TEXT_363 = NL + "                    += tmp_batchUpdateCount_";
  protected final String TEXT_364 = ";" + NL + "                    batchSizeCounter_";
  protected final String TEXT_365 = " = 0;" + NL + "                }";
  protected final String TEXT_366 = NL + "            if(!whetherReject_";
  protected final String TEXT_367 = ") {";
  protected final String TEXT_368 = NL + "                            ";
  protected final String TEXT_369 = " = new ";
  protected final String TEXT_370 = "Struct();";
