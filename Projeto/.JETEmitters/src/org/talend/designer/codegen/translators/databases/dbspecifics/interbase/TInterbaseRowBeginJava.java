...
public class TInterbaseRowBeginJava
{
  ...
  protected final String TEXT_124 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_131 = NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_132 = "\", conn_";
  protected final String TEXT_133 = ");";
  protected final String TEXT_134 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".prepareStatement(";
  protected final String TEXT_137 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_142 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
