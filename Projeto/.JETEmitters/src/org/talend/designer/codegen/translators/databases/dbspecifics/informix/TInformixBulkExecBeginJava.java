...
public class TInformixBulkExecBeginJava {
  ...
  protected final String TEXT_78 = " = (String)globalMap.get(\"dbschema_";
  protected final String TEXT_79 = "\");" + NL + "\tString dbName_";
  protected final String TEXT_80 = " =  (String)globalMap.get(\"dbname_";
  protected final String TEXT_81 = "\");" + NL + "\tString dbServer_";
  protected final String TEXT_82 = " = (String)globalMap.get(\"dbserver_";
  ...
  protected final String TEXT_99 = NL + "\tString driverClass_";
  protected final String TEXT_100 = " = \"com.informix.jdbc.IfxDriver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_101 = ");" + NL + "\tString dbschema_";
  protected final String TEXT_102 = " = ";
  protected final String TEXT_103 = ";" + NL + "\tString dbName_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "\tString dbServer_";
  ...
  protected final String TEXT_121 = NL + "\t\tString tableName_";
  protected final String TEXT_122 = " = null;" + NL + "\t\tif(dbschema_";
  protected final String TEXT_123 = " == null || dbschema_";
  protected final String TEXT_124 = ".trim().length() == 0) {" + NL + "    \t\ttableName_";
  protected final String TEXT_125 = " = ";
  protected final String TEXT_126 = ";" + NL + "\t\t} else {" + NL + "\t\t    tableName_";
  ...
  protected final String TEXT_445 = NL + NL + "\t\tString fileName_";
  protected final String TEXT_446 = " = ";
  protected final String TEXT_447 = ";" + NL + "\t\tString cmdFile_";
  protected final String TEXT_448 = " = fileName_";
  protected final String TEXT_449 = " + \".cmd\";" + NL + "\t\tString logFile_";
  protected final String TEXT_450 = " = fileName_";
  protected final String TEXT_451 = " + \".log\";" + NL + "\t\tCharacter field_separator_";
  protected final String TEXT_452 = " = (";
  protected final String TEXT_453 = ").charAt(0);" + NL + " \t\tjava.io.BufferedWriter bw_";
  protected final String TEXT_454 = " = new java.io.BufferedWriter(new java.io.FileWriter(cmdFile_";
  protected final String TEXT_455 = "));" + NL + "    \tjava.io.PrintWriter pw_";
  protected final String TEXT_456 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_457 = " ,false) ;" + NL + "    \t//file \"c:\\informix_bulk.txt\" delimiter \"|\" 7 ;insert into feature9999;" + NL + "    \tpw_";
  protected final String TEXT_458 = ".print(\"FILE \\\"\" + ";
  protected final String TEXT_459 = " + \"\\\"\" );" + NL + "    \tpw_";
  protected final String TEXT_460 = ".print(\" DELIMITER \\\"\" + field_separator_";
  protected final String TEXT_461 = " + \"\\\"\");" + NL + "    \tpw_";
  protected final String TEXT_462 = ".println(\" \" + ";
  protected final String TEXT_463 = " +\" ;\" );";
  protected final String TEXT_464 = NL + "\t\tpw_";
  protected final String TEXT_465 = ".println(\"INSERT INTO \" + tableName_";
  protected final String TEXT_466 = " + \"(";
  protected final String TEXT_467 = ");\" );";
  protected final String TEXT_468 = NL + "\tbw_";
  protected final String TEXT_469 = ".close();" + NL + "\tpw_";
  protected final String TEXT_470 = ".close();" + NL + "\t//-----------------------dbload command" + NL + "\tStringBuilder command_";
  protected final String TEXT_471 = " =  new StringBuilder();" + NL + "\t//-------------------------1. add dbload cmd";
  protected final String TEXT_472 = NL + "\tcommand_";
  protected final String TEXT_473 = ".append(\"dbload \");";
  protected final String TEXT_474 = NL + "\tcommand_";
  protected final String TEXT_475 = ".append(\"./dbload \");";
  protected final String TEXT_476 = NL + "\t//-------------------------2.add database name" + NL + "\tcommand_";
  protected final String TEXT_477 = ".append(\"-d \" + dbName_";
  protected final String TEXT_478 = " + \" \");" + NL + "\t//-------------------------3.add command file" + NL + "\tcommand_";
  protected final String TEXT_479 = ".append(\"-c \" + cmdFile_";
  protected final String TEXT_480 = " + \" \");" + NL + "\t//-------------------------4.add  error log file" + NL + "\tcommand_";
  protected final String TEXT_481 = ".append(\"-l \" + logFile_";
  protected final String TEXT_482 = " + \" \");" + NL + "\t//-------------------------5.add  bad rows before abort" + NL + "\tcommand_";
  protected final String TEXT_483 = ".append(\"-e \" + ";
  protected final String TEXT_484 = " + \" \");" + NL + "\t//-------------------------6.add commit interval" + NL + "\tcommand_";
  protected final String TEXT_485 = ".append(\"-n \" + ";
  protected final String TEXT_486 = " + \";\"); " + NL + "\t" + NL + "\t//----------------get envionment variables";
  protected final String TEXT_487 = NL + "\tProcess ev_";
  protected final String TEXT_488 = " = Runtime.getRuntime().exec(\"cmd /c set\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_489 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_490 = ".getInputStream()));";
  protected final String TEXT_491 = NL + NL + "\tProcess ev_";
  protected final String TEXT_492 = " = Runtime.getRuntime().exec(\"env\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_493 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_494 = ".getInputStream()));";
  protected final String TEXT_495 = NL + "\tjava.util.List<String> evPara_";
  protected final String TEXT_496 = " = new java.util.ArrayList();" + NL + "\tString line_";
  protected final String TEXT_497 = " = null;" + NL + "\twhile((line_";
  protected final String TEXT_498 = " = evReader_";
  protected final String TEXT_499 = ".readLine()) != null) {" + NL + "\t   evPara_";
  protected final String TEXT_500 = ".add(line_";
  protected final String TEXT_501 = ");" + NL + "\t}" + NL + "\tevReader_";
  protected final String TEXT_502 = ".close();" + NL + "" + NL + "\tevPara_";
  protected final String TEXT_503 = ".add(\"INFORMIXDIR=\" + ";
  protected final String TEXT_504 = ");" + NL + "\tevPara_";
  protected final String TEXT_505 = ".add(\"INFORMIXSERVER=\" + dbServer_";
  protected final String TEXT_506 = ");" + NL + "\tevPara_";
  protected final String TEXT_507 = ".add(\"DBDATE=\" + \"";
  protected final String TEXT_508 = "\");" + NL + "\t";
  protected final String TEXT_509 = NL + "\tevPara_";
  protected final String TEXT_510 = ".add(\"DBMONEY=\" + ";
  protected final String TEXT_511 = ");";
  protected final String TEXT_512 = NL + "\t//----------------get envionment variables end" + NL + "\t" + NL + "\t//------------------get dbload directory" + NL + "\tjava.io.File dbLoadDirectory_";
  protected final String TEXT_513 = " = new java.io.File (";
  protected final String TEXT_514 = "+\"/bin\");" + NL + "\tboolean dbloadExist_";
  protected final String TEXT_515 = " = dbLoadDirectory_";
  protected final String TEXT_516 = ".exists();" + NL + "\tif(!dbloadExist_";
  protected final String TEXT_517 = "){" + NL + "\t\tthrow new RuntimeException(dbLoadDirectory_";
  protected final String TEXT_518 = "+\"' is not exist!\");" + NL + "\t}" + NL + "\t";
  protected final String TEXT_519 = NL + "\t\tlog.info(\"";
  protected final String TEXT_520 = " - Executing '\"+command_";
  protected final String TEXT_521 = ".toString()+\"'.\");" + NL + "\t";
  protected final String TEXT_522 = NL + " \tRuntime runtime_";
  protected final String TEXT_523 = " = Runtime.getRuntime();";
  protected final String TEXT_524 = NL + "\tfinal Process ps_";
  protected final String TEXT_525 = " = runtime_";
  protected final String TEXT_526 = ".exec(new String[]{\"cmd.exe\",\"/c\",command_";
  protected final String TEXT_527 = ".toString()}," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_528 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_529 = ");";
  protected final String TEXT_530 = NL + "\tfinal Process ps_";
  protected final String TEXT_531 = " = runtime_";
  protected final String TEXT_532 = ".exec(command_";
  protected final String TEXT_533 = ".toString()," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_534 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_535 = ");";
  protected final String TEXT_536 = NL;
  protected final String TEXT_537 = NL + NL + "Thread normal_";
  protected final String TEXT_538 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_539 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_540 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_541 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_542 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_543 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_544 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_545 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_546 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_547 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_548 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_549 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_550 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_551 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_552 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_553 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_554 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_555 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_556 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_557 = ".interrupt();" + NL + "error_";
  protected final String TEXT_558 = ".interrupt();";
  protected final String TEXT_559 = NL + "        log.info(\"";
  protected final String TEXT_560 = " - Execute '\"+command_";
  protected final String TEXT_561 = ".toString()+\"' has finished。\");";
  protected final String TEXT_562 = NL + NL + NL + NL;
