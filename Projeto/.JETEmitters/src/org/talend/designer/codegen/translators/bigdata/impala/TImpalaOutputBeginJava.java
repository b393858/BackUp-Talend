...
public class TImpalaOutputBeginJava {
  ...
  protected final String TEXT_175 = NL + "\tString tableName_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ";" + NL + "\tint nb_line_";
  protected final String TEXT_178 = " = 0;";
  protected final String TEXT_179 = NL + "    String insertPrefix_";
  protected final String TEXT_180 = " = \"INSERT ";
  protected final String TEXT_181 = " \" + tableName_";
  protected final String TEXT_182 = " + \" (";
  protected final String TEXT_183 = ") VALUES \";\t\t" + NL + "\tjava.lang.StringBuilder sbValue_";
  protected final String TEXT_184 = " = null;" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".createStatement();" + NL + "    int rowCount";
  protected final String TEXT_187 = " = 0;" + NL + "    boolean needInitialization_";
