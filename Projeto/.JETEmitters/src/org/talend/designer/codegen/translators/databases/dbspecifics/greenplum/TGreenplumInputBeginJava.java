...
public class TGreenplumInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_189 = " + \":\" + ";
  protected final String TEXT_190 = " + \"/\" + ";
  protected final String TEXT_191 = ";" + NL + "\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\tString url_";
  protected final String TEXT_193 = " = \"jdbc:pivotal:greenplum://\"+";
  ...
  protected final String TEXT_201 = NL + "\t\t    int nb_line_";
  protected final String TEXT_202 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_203 = " = null;";
  protected final String TEXT_204 = NL + "\t\t        conn_";
  protected final String TEXT_205 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_237 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_238 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_336 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_337 = ".getObject(";
  protected final String TEXT_338 = "column_index_";
  protected final String TEXT_339 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_340 = NL + "                                    ";
  protected final String TEXT_341 = ".";
  protected final String TEXT_342 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_351 = ".setEPSG(";
  ...
  protected final String TEXT_358 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_359 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_360 = " = ";
  protected final String TEXT_361 = "; i_";
  protected final String TEXT_362 = "  <= rsmd_";
  protected final String TEXT_363 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_376 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_377 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_378 = ".getColumnTypeName(i_";
  protected final String TEXT_379 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_380 = ".add(rs_";
  protected final String TEXT_381 = ".getString(i_";
  protected final String TEXT_382 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_383 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_384 = ".";
  protected final String TEXT_385 = ", rs_";
  protected final String TEXT_386 = ", fixedColumnCount_";
  protected final String TEXT_387 = ",list_";
  protected final String TEXT_388 = ",";
  protected final String TEXT_389 = ");";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_391 = ".";
  protected final String TEXT_392 = ", rs_";
  protected final String TEXT_393 = ", fixedColumnCount_";
  protected final String TEXT_394 = ",";
  protected final String TEXT_395 = ");";
  protected final String TEXT_396 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_397 = ".";
  protected final String TEXT_398 = ", rs_";
  protected final String TEXT_399 = ", fixedColumnCount_";
  protected final String TEXT_400 = ",";
  protected final String TEXT_401 = ");";
  protected final String TEXT_402 = NL + "                                  Object geom = rs_";
  protected final String TEXT_403 = ".getObject(";
  protected final String TEXT_404 = "column_index_";
  protected final String TEXT_405 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
