...
public class TRedshiftOutputEndJava {
  ...
  protected final String TEXT_46 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_47 = ".";
  protected final String TEXT_48 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_49 = ".setNull(count";
  protected final String TEXT_50 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_52 = ".";
  protected final String TEXT_53 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_54 = ".setNull(count";
  protected final String TEXT_55 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_57 = ".";
  protected final String TEXT_58 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_59 = ".setNull(count";
  protected final String TEXT_60 = ",java.sql.Types.ARRAY);" + NL + "\t\t\t\t\t";
  protected final String TEXT_61 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_62 = ".";
  protected final String TEXT_63 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_64 = ".setNull(count";
  protected final String TEXT_65 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t";
  protected final String TEXT_66 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_67 = ".";
  protected final String TEXT_68 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_69 = ".setNull(count";
  protected final String TEXT_70 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t";
  protected final String TEXT_71 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_72 = ".";
  protected final String TEXT_73 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_74 = ".setNull(count";
  protected final String TEXT_75 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_77 = ".";
  protected final String TEXT_78 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_79 = ".setNull(count";
  protected final String TEXT_80 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_82 = ".";
  protected final String TEXT_83 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_84 = ".setNull(count";
  protected final String TEXT_85 = ",java.sql.Types.DOUBLE);" + NL + "\t\t\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_87 = ".";
  protected final String TEXT_88 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_89 = ".setNull(count";
  protected final String TEXT_90 = ",java.sql.Types.FLOAT);" + NL + "\t\t\t\t\t";
  protected final String TEXT_91 = NL + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_94 = ".";
  protected final String TEXT_95 = "==null){" + NL + "\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t\tif((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_97 = ".";
  protected final String TEXT_98 = ").toLowerCase())){" + NL + "\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t";
  protected final String TEXT_100 = ".setNull(count";
  protected final String TEXT_101 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t\t\t} else if(bufferL";
  protected final String TEXT_102 = ".";
  protected final String TEXT_103 = " == '\\0') {" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_104 = ".setString(count";
  protected final String TEXT_105 = ",\"\");" + NL + "" + NL + "\t\t\t\t} else {" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_106 = ".setString(count";
  protected final String TEXT_107 = ",String.valueOf(bufferL";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = "));" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_111 = ".";
  protected final String TEXT_112 = "!=null){" + NL + "\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\tdate_";
  protected final String TEXT_113 = " = bufferL";
  protected final String TEXT_114 = ".";
  protected final String TEXT_115 = ".getTime();" + NL + "\t\t\t\t\t\tif (date_";
  protected final String TEXT_116 = " < year1_";
  protected final String TEXT_117 = " || date_";
  protected final String TEXT_118 = " >= year10000_";
  protected final String TEXT_119 = ") {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_120 = ".setString(count";
  protected final String TEXT_121 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_122 = ".setTimestamp(count";
  protected final String TEXT_123 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_124 = "));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_125 = ".setNull(count";
  protected final String TEXT_126 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\t\t";
  protected final String TEXT_128 = ".set";
  protected final String TEXT_129 = "(count";
  protected final String TEXT_130 = ",bufferL";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_133 = NL + NL + "\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_134 = NL + "            commitCounter_";
  protected final String TEXT_135 = " = rowCount";
  protected final String TEXT_136 = ";//correct the commit counter as commit can happen before executing the sql for extend insert";
  protected final String TEXT_137 = NL + NL + "\t    if(rowCount";
  protected final String TEXT_138 = "!=0){" + NL + "" + NL + "\t        StringBuilder extendInsertValue_";
  protected final String TEXT_139 = " = new StringBuilder();" + NL + "\t        for(int i_";
  protected final String TEXT_140 = "=0 ; i_";
  protected final String TEXT_141 = " < rowCount";
  protected final String TEXT_142 = " ; i_";
  protected final String TEXT_143 = "++){";
  protected final String TEXT_144 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_145 = ".append(\"(";
  protected final String TEXT_146 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_147 = ".";
  protected final String TEXT_148 = ")+\")\");";
  protected final String TEXT_149 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_150 = ".append(\"(\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_151 = ".";
  protected final String TEXT_152 = ")+\")\");";
  protected final String TEXT_153 = NL + "\t\t\t\textendInsertValue_";
  protected final String TEXT_154 = ".append(\"(";
  protected final String TEXT_155 = ")\");";
  protected final String TEXT_156 = NL + "     \t\t\tif (i_";
  protected final String TEXT_157 = " != rowCount";
  protected final String TEXT_158 = " - 1) extendInsertValue_";
  protected final String TEXT_159 = ".append(\",\");" + NL + "\t        }" + NL;
  protected final String TEXT_160 = NL + "                \tinsert_";
  protected final String TEXT_161 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_162 = " + \"\\\" (";
  protected final String TEXT_163 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = ", \"";
  protected final String TEXT_166 = "\")+\") VALUES \" + extendInsertValue_";
  protected final String TEXT_167 = ".toString();";
  protected final String TEXT_168 = NL + "                \tinsert_";
  protected final String TEXT_169 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_170 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_171 = ".";
  protected final String TEXT_172 = ", \"";
  protected final String TEXT_173 = "\")+\") VALUES \" + extendInsertValue_";
  protected final String TEXT_174 = ".toString();";
  protected final String TEXT_175 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_176 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_177 = " + \"\\\" (";
  protected final String TEXT_178 = ") VALUES \"+extendInsertValue_";
  ...
  protected final String TEXT_184 = NL + "\t\t\trowCount";
  protected final String TEXT_185 = " = 0;" + NL + "\t        for(BufferLine_";
  protected final String TEXT_186 = " bufferL";
  protected final String TEXT_187 = " : exInsertColValueList";
  protected final String TEXT_188 = "){" + NL + "\t\t\t\tint count";
  protected final String TEXT_189 = " = rowCount";
  protected final String TEXT_190 = " *" + NL + "\t\t\t\t\t(";
  protected final String TEXT_191 = NL + "\t\t\t\t\t\t+ bufferL";
  protected final String TEXT_192 = ".";
  protected final String TEXT_193 = ".getColumnCount()";
  protected final String TEXT_194 = NL + "\t\t\t\t\t)" + NL + "\t\t\t\t+ 1;";
  protected final String TEXT_195 = NL + "\t                    count";
  protected final String TEXT_196 = "++;" + NL + "\t                    ";
  protected final String TEXT_197 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(bufferL";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = ", pstmt_";
  protected final String TEXT_200 = ", count";
  protected final String TEXT_201 = "-1, \"";
  protected final String TEXT_202 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_203 = NL + NL + "\t            rowCount";
  protected final String TEXT_204 = "++;" + NL + "\t        }" + NL + "\t        insertedCount_";
  protected final String TEXT_205 = " = insertedCount_";
  protected final String TEXT_206 = " + pstmt_";
  protected final String TEXT_207 = ".executeUpdate();" + NL + "\t    }" + NL + "\t";
  protected final String TEXT_208 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_209 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_210 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_211 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_212 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_213 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_214 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_215 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_216 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_217 = "\");" + NL + "        }";
  protected final String TEXT_218 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_219 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_220 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_221 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_222 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_223 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_224 = "\");" + NL + "        }";
  protected final String TEXT_225 = NL + "                        int[] status_";
  protected final String TEXT_226 = " = null;" + NL + "                        int countSum_";
  protected final String TEXT_227 = " = 0;" + NL + "                        try {" + NL + "                            if(pstmt_";
  protected final String TEXT_228 = "!=null && batchSizeCounter_";
  protected final String TEXT_229 = " > 0 ){";
  protected final String TEXT_230 = NL + "                                status_";
  protected final String TEXT_231 = " = pstmt_";
  protected final String TEXT_232 = ".executeBatch();";
  protected final String TEXT_233 = NL + "                                for(int countEach_";
  protected final String TEXT_234 = ": status_";
  protected final String TEXT_235 = ") {" + NL + "                                    countSum_";
  protected final String TEXT_236 = " += (countEach_";
  protected final String TEXT_237 = " < 0 ? 0 : countEach_";
  protected final String TEXT_238 = ");" + NL + "                                }" + NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_239 = NL + "                                throw(e);";
  protected final String TEXT_240 = NL + "                            for(int countEach_";
  protected final String TEXT_241 = ": e.getUpdateCounts()) {" + NL + "                                countSum_";
  protected final String TEXT_242 = " += (countEach_";
  protected final String TEXT_243 = " < 0 ? 0 : countEach_";
  protected final String TEXT_244 = ");" + NL + "                            }" + NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_245 = NL + "                        }" + NL + "                        if(pstmt_";
  protected final String TEXT_246 = "!=null && batchSizeCounter_";
  protected final String TEXT_247 = " > 0 ){" + NL + "                            try {" + NL + "                                tmp_batchUpdateCount_";
  protected final String TEXT_248 = " = pstmt_";
  protected final String TEXT_249 = ".getUpdateCount();" + NL + "                            }catch (java.sql.SQLException e){" + NL + "" + NL + "                            }" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_250 = " = tmp_batchUpdateCount_";
  protected final String TEXT_251 = " > countSum_";
  protected final String TEXT_252 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_253 = " : countSum_";
  protected final String TEXT_254 = ";";
  protected final String TEXT_255 = NL + "                                insertedCount_";
  protected final String TEXT_256 = " += tmp_batchUpdateCount_";
  protected final String TEXT_257 = ";";
  protected final String TEXT_258 = NL + "                                updatedCount_";
  protected final String TEXT_259 = " += tmp_batchUpdateCount_";
  protected final String TEXT_260 = ";";
  protected final String TEXT_261 = NL + "                                deletedCount_";
  protected final String TEXT_262 = " += tmp_batchUpdateCount_";
  protected final String TEXT_263 = ";";
  protected final String TEXT_264 = NL + "                        }";
  protected final String TEXT_265 = NL + "        if(pstmt_";
  protected final String TEXT_266 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_267 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_268 = "\");" + NL + "        }";
  protected final String TEXT_269 = NL + "    resourceMap.put(\"statementClosed_";
  ...
  protected final String TEXT_281 = NL + "\tnb_line_deleted_";
  protected final String TEXT_282 = "=nb_line_deleted_";
  protected final String TEXT_283 = "+ deletedCount_";
  protected final String TEXT_284 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_285 = "=nb_line_update_";
  protected final String TEXT_286 = " + updatedCount_";
  protected final String TEXT_287 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_288 = "=nb_line_inserted_";
  protected final String TEXT_289 = " + insertedCount_";
  protected final String TEXT_290 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_291 = "=nb_line_rejected_";
  protected final String TEXT_292 = " + rejectedCount_";
  protected final String TEXT_293 = ";" + NL + "\t";
  protected final String TEXT_294 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_295 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_296 = "_NB_LINE\",nb_line_";
  protected final String TEXT_297 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_298 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_299 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_300 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_301 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_302 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_303 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_304 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_305 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_306 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_307 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_308 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_309 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_310 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_311 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_312 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_313 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_314 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_315 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_316 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_317 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_318 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_319 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_320 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_321 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_322 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_323 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_324 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_325 = NL + "        globalMap.put(\"";
  protected final String TEXT_326 = "_NB_LINE\",nb_line_";
  protected final String TEXT_327 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_328 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_329 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_330 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_331 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_332 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_333 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_334 = "_NB_LINE_REJECTED\", nb_line_rejected_";
