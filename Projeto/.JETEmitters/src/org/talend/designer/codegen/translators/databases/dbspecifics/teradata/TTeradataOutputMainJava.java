...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_599 = ".addBatch();" + NL + "                batchSizeCounter_";
  protected final String TEXT_600 = "++;" + NL + "                nb_line_";
  protected final String TEXT_601 = "++;";
  protected final String TEXT_602 = NL + "            ////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_603 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_604 = " = insertedCount_";
  protected final String TEXT_605 = " + pstmt_";
  protected final String TEXT_606 = ".executeUpdate();";
  protected final String TEXT_607 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_608 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_609 = " = true;";
  protected final String TEXT_610 = NL + "                    throw(e_";
  protected final String TEXT_611 = ");";
  protected final String TEXT_612 = NL + "                        ";
  protected final String TEXT_613 = " = new ";
  protected final String TEXT_614 = "Struct();";
  protected final String TEXT_615 = NL + "                            ";
  protected final String TEXT_616 = ".";
  protected final String TEXT_617 = " = ";
  protected final String TEXT_618 = ".";
  protected final String TEXT_619 = ";";
  protected final String TEXT_620 = NL + "                        rejectedCount_";
  protected final String TEXT_621 = " = rejectedCount_";
  protected final String TEXT_622 = " + 1;";
  protected final String TEXT_623 = NL + "                        ";
  protected final String TEXT_624 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_625 = ").getSQLState();";
  protected final String TEXT_626 = NL + "                        ";
  protected final String TEXT_627 = ".errorMessage = e_";
  protected final String TEXT_628 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_629 = ";";
  protected final String TEXT_630 = NL + "                        System.err.print(e_";
  protected final String TEXT_631 = ".getMessage());";
  ...
  protected final String TEXT_637 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_638 = ",";
  protected final String TEXT_639 = ".";
  protected final String TEXT_640 = ", ";
  protected final String TEXT_641 = ",updateSQLSplits_";
  protected final String TEXT_642 = ");";
  protected final String TEXT_643 = NL + "                    int count_";
  protected final String TEXT_644 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_669 = ".addBatch();" + NL + "                batchSizeCounter_";
  protected final String TEXT_670 = "++;" + NL + "                nb_line_";
  protected final String TEXT_671 = "++;";
  protected final String TEXT_672 = NL + "            //////////////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_676 = ".executeUpdate();";
  ...
  protected final String TEXT_705 = NL + "            int checkCount_";
  protected final String TEXT_706 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_707 = " = pstmt_";
  protected final String TEXT_708 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_709 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_710 = " = rs_";
  protected final String TEXT_711 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_712 = " > 0) {";
  protected final String TEXT_713 = NL + "                        ";
  protected final String TEXT_714 = NL + "                            query_";
  protected final String TEXT_715 = " = ";
  protected final String TEXT_716 = ";";
  protected final String TEXT_717 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_718 = ",";
  protected final String TEXT_719 = ".";
  protected final String TEXT_720 = ", ";
  protected final String TEXT_721 = ",updateSQLSplits_";
  ...
  protected final String TEXT_748 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_749 = " = updatedCount_";
  protected final String TEXT_750 = " + pstmtUpdate_";
  protected final String TEXT_751 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_752 = "++;";
  protected final String TEXT_753 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_754 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_755 = " = true;";
  protected final String TEXT_756 = NL + "                        throw(e_";
  protected final String TEXT_757 = ");";
  protected final String TEXT_758 = NL + "                        nb_line_";
  ...
  protected final String TEXT_773 = ").getSQLState();";
  protected final String TEXT_774 = NL + "                            ";
  protected final String TEXT_775 = ".errorMessage = e_";
  protected final String TEXT_776 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_777 = ";";
  protected final String TEXT_778 = NL + "                            System.err.print(e_";
  protected final String TEXT_779 = ".getMessage());";
  ...
  protected final String TEXT_800 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_801 = " = insertedCount_";
  protected final String TEXT_802 = " + pstmtInsert_";
  protected final String TEXT_803 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_804 = "++;";
  protected final String TEXT_805 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_806 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_807 = " = true;";
  protected final String TEXT_808 = NL + "                        throw(e_";
  protected final String TEXT_809 = ");";
  protected final String TEXT_810 = NL + "                          nb_line_";
  ...
  protected final String TEXT_833 = NL + "            int updateFlag_";
  protected final String TEXT_834 = "=0;";
  protected final String TEXT_835 = NL + "                    ";
  protected final String TEXT_836 = NL + "                        query_";
  protected final String TEXT_837 = " = ";
  protected final String TEXT_838 = ";";
  protected final String TEXT_839 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_840 = ",";
  protected final String TEXT_841 = ".";
  protected final String TEXT_842 = ", ";
  protected final String TEXT_843 = ",updateSQLSplits_";
  protected final String TEXT_844 = ");";
  protected final String TEXT_845 = NL + NL + "                    int count_";
  protected final String TEXT_846 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_867 = NL + "                globalMap.put(\"";
  protected final String TEXT_868 = "_QUERY\", query_";
  protected final String TEXT_869 = ".toString().trim());";
  protected final String TEXT_870 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_871 = "=pstmtUpdate_";
  protected final String TEXT_872 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_873 = " = updatedCount_";
  protected final String TEXT_874 = " + updateFlag_";
  protected final String TEXT_875 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_876 = " == 0) {";
  protected final String TEXT_877 = NL + "                query_";
  protected final String TEXT_878 = " = new StringBuffer(\"\");";
  protected final String TEXT_879 = NL + "                        ";
  protected final String TEXT_880 = NL + "                            query_";
  protected final String TEXT_881 = " = ";
  protected final String TEXT_882 = ";";
  protected final String TEXT_883 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_884 = ",";
  protected final String TEXT_885 = ".";
  protected final String TEXT_886 = ", ";
  protected final String TEXT_887 = ",insertSQLSplits_";
  protected final String TEXT_888 = ");";
  protected final String TEXT_889 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_890 = ".";
  protected final String TEXT_891 = ", pstmtInsert_";
  protected final String TEXT_892 = ", ";
  protected final String TEXT_893 = ", \"";
  protected final String TEXT_894 = "\");";
  protected final String TEXT_895 = NL + "                    globalMap.put(\"";
  protected final String TEXT_896 = "_QUERY\", query_";
  protected final String TEXT_897 = ".toString().trim());";
  protected final String TEXT_898 = NL + "                    insertedCount_";
  protected final String TEXT_899 = " = insertedCount_";
  protected final String TEXT_900 = " + pstmtInsert_";
  protected final String TEXT_901 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_902 = "++;";
  protected final String TEXT_903 = NL + "             }else{" + NL + "                nb_line_";
  protected final String TEXT_904 = "++;";
  protected final String TEXT_905 = NL + "             }" + NL + "                } catch(java.lang.Exception e_";
  ...
  protected final String TEXT_944 = NL + "              pstmt_";
  protected final String TEXT_945 = ".addBatch();" + NL + "              batchSizeCounter_";
  protected final String TEXT_946 = "++;" + NL + "              nb_line_";
  protected final String TEXT_947 = "++;";
  protected final String TEXT_948 = NL + "            //////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_949 = " = deletedCount_";
  protected final String TEXT_950 = " + pstmt_";
  protected final String TEXT_951 = ".executeUpdate();" + NL + "              nb_line_";
  protected final String TEXT_952 = "++;";
  protected final String TEXT_953 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_954 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_955 = " = true;";
  protected final String TEXT_956 = NL + "                    throw(e_";
  protected final String TEXT_957 = ");";
  protected final String TEXT_958 = NL + "                    nb_line_";
  ...
  protected final String TEXT_968 = NL + "                        rejectedCount_";
  protected final String TEXT_969 = " = rejectedCount_";
  protected final String TEXT_970 = " + 1;";
  protected final String TEXT_971 = NL + "                        ";
  protected final String TEXT_972 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_973 = ").getSQLState();";
  protected final String TEXT_974 = NL + "                        ";
  protected final String TEXT_975 = ".errorMessage = e_";
  protected final String TEXT_976 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_977 = ";";
  protected final String TEXT_978 = NL + "                        System.err.print(e_";
  protected final String TEXT_979 = ".getMessage());";
  protected final String TEXT_980 = NL + "            }" + NL + "            //////////////////////////////////////";
  protected final String TEXT_981 = NL + "            if(!whetherReject_";
  protected final String TEXT_982 = ") {";
  protected final String TEXT_983 = NL + "                            ";
  protected final String TEXT_984 = " = new ";
  protected final String TEXT_985 = "Struct();";
  ...
  protected final String TEXT_992 = NL + "                if ((batchSize_";
  protected final String TEXT_993 = " > 0) && (batchSize_";
  protected final String TEXT_994 = " <= batchSizeCounter_";
  protected final String TEXT_995 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_996 = " = 0;" + NL + "                        int countSum_";
  protected final String TEXT_997 = " = 0;" + NL;
  protected final String TEXT_998 = NL + "                        for(int countEach_";
  protected final String TEXT_999 = ":pstmt_";
  protected final String TEXT_1000 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1001 = " += (countEach_";
  protected final String TEXT_1002 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1003 = ");" + NL + "                        }";
  protected final String TEXT_1004 = NL;
  protected final String TEXT_1005 = NL + "                            insertedCount_";
  protected final String TEXT_1006 = " += countSum_";
  ...
  protected final String TEXT_1011 = NL + "                            deletedCount_";
  ...
  protected final String TEXT_1047 = NL + "                commitCounter_";
  protected final String TEXT_1048 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1049 = " <= commitCounter_";
  protected final String TEXT_1050 = ") {" + NL + "                        try {";
  protected final String TEXT_1051 = NL + "                                       if (batchSizeCounter_";
  protected final String TEXT_1052 = " > 0) {" + NL + "                                           int countSum_";
  protected final String TEXT_1053 = " = 0;" + NL;
  protected final String TEXT_1054 = NL + "                                           for(int countEach_";
  protected final String TEXT_1055 = ": pstmt_";
  protected final String TEXT_1056 = ".executeBatch()) {" + NL + "                                               countSum_";
  protected final String TEXT_1057 = " += (countEach_";
  protected final String TEXT_1058 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1059 = ");" + NL + "                                           }";
  protected final String TEXT_1060 = NL;
  protected final String TEXT_1061 = NL + "                                               insertedCount_";
  protected final String TEXT_1062 = " += countSum_";
  protected final String TEXT_1063 = ";";
  protected final String TEXT_1064 = NL + "                                               updatedCount_";
  protected final String TEXT_1065 = " += countSum_";
  protected final String TEXT_1066 = ";";
  protected final String TEXT_1067 = NL + "                                               deletedCount_";
  protected final String TEXT_1068 = " += countSum_";
  protected final String TEXT_1069 = ";";
  protected final String TEXT_1070 = NL + "                                           batchSizeCounter_";
  protected final String TEXT_1071 = " = 0;" + NL + "                                       }";
  protected final String TEXT_1072 = NL + "                            conn_";
  protected final String TEXT_1073 = ".commit();" + NL + "                            commitCounter_";
  protected final String TEXT_1074 = " = 0;";
  protected final String TEXT_1075 = NL + "                        }catch(java.sql.SQLException e_";
  protected final String TEXT_1076 = "){";
  protected final String TEXT_1077 = NL + "                            java.sql.SQLException e2_";
  protected final String TEXT_1078 = " = e_";
  protected final String TEXT_1079 = ";" + NL + "                            while (e2_";
  protected final String TEXT_1080 = " != null) {";
  protected final String TEXT_1081 = NL + "                                System.err.println(e_";
  protected final String TEXT_1082 = ".getMessage());" + NL + "                                e2_";
  protected final String TEXT_1083 = " = e2_";
  protected final String TEXT_1084 = ".getNextException();" + NL + "                            }";
  protected final String TEXT_1085 = NL + "                    java.sql.SQLException e3_";
  protected final String TEXT_1086 = " = e_";
  protected final String TEXT_1087 = ";" + NL + "                            boolean isFailure = false;" + NL + "                    while(e_";
  protected final String TEXT_1088 = " != null){" + NL + "                        if(e_";
  protected final String TEXT_1089 = ".getErrorCode() == -2801){";
  protected final String TEXT_1090 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1091 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1092 = ".printStackTrace();" + NL + "                            System.out.println();" + NL + "                        }" + NL + "                        else if(e_";
  protected final String TEXT_1093 = ".getErrorCode() == 1339){" + NL + "                            isFailure = true;" + NL + "                        }" + NL + "                        else{";
  protected final String TEXT_1094 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1095 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1096 = ".printStackTrace();" + NL + "                        }" + NL + "                        e_";
  protected final String TEXT_1097 = " = e_";
  protected final String TEXT_1098 = ".getNextException();" + NL + "                    }" + NL + "                    if(isFailure && e_";
  protected final String TEXT_1099 = " != null){";
  protected final String TEXT_1100 = NL + "                        System.out.println(\" Message: \" + e_";
  protected final String TEXT_1101 = ".getMessage());" + NL + "                        e_";
  protected final String TEXT_1102 = ".printStackTrace();" + NL + "                    }";
  protected final String TEXT_1103 = NL + "                        throw (e3_";
  protected final String TEXT_1104 = ");";
  protected final String TEXT_1105 = NL + "                        System.err.println(e3_";
  protected final String TEXT_1106 = ".getMessage());";
