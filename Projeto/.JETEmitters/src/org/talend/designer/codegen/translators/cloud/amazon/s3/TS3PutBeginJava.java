...
public class TS3PutBeginJava
{
  ...
  protected final String TEXT_211 = ";" + NL + "\t" + NL + "\tint partSizeInBytes_";
  protected final String TEXT_212 = " = ";
  protected final String TEXT_213 = " * 1024 * 1024;" + NL + "\t" + NL + "\tObject fileOrStream_";
  protected final String TEXT_214 = " = ";
  protected final String TEXT_215 = ";" + NL + "\t" + NL + "\tboolean useStream_";
  protected final String TEXT_216 = " = false;" + NL + "\tjava.io.InputStream uploadStream_";
  protected final String TEXT_217 = " = null;" + NL + "\t" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_218 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_219 = " - Uploading an object with key:\" + key_";
  protected final String TEXT_220 = ");" + NL + "\t\t";
  protected final String TEXT_221 = NL + "\t\t" + NL + "\t\tif(fileOrStream_";
  protected final String TEXT_222 = " instanceof String){" + NL + "\t\t    useStream_";
  protected final String TEXT_223 = " = false;" + NL + "\t\t}else if(fileOrStream_";
  protected final String TEXT_224 = " instanceof java.io.InputStream){" + NL + "\t\t    useStream_";
  protected final String TEXT_225 = " = true;" + NL + "\t\t}" + NL + "\t\t" + NL + "    com.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_226 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t\t\t\t";
  protected final String TEXT_228 = "\t" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_229 = " - No KMS - Normal SSE\");" + NL + "\t\t\t\t";
  protected final String TEXT_230 = NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_231 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t";
  protected final String TEXT_232 = NL + "\t\t" + NL + "\t\tif(!useStream_";
  protected final String TEXT_233 = ") {" + NL + "\t\t\t\tjava.io.File inputFile_";
  protected final String TEXT_234 = " = new java.io.File((String)fileOrStream_";
  protected final String TEXT_235 = ");" + NL + "\t\t\t\t" + NL + "\t\t\t\tlong multipart_upload_threshold_";
  protected final String TEXT_236 = " = 5 * 1024 * 1024;" + NL + "\t\t\t\t" + NL + "    \t\tcom.amazonaws.services.s3.transfer.TransferManager tm_";
  protected final String TEXT_237 = " = com.amazonaws.services.s3.transfer.TransferManagerBuilder" + NL + "    \t\t\t.standard()" + NL + "    \t\t\t.withMinimumUploadPartSize((long)partSizeInBytes_";
  protected final String TEXT_238 = ")" + NL + "    \t\t\t.withMultipartUploadThreshold(multipart_upload_threshold_";
  protected final String TEXT_239 = ")" + NL + "    \t\t\t.withS3Client(conn_";
  protected final String TEXT_240 = ")" + NL + "    \t\t\t.build();" + NL + "    \t\t\t" + NL + "  \t\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_241 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_242 = ", key_";
  protected final String TEXT_243 = ", inputFile_";
  protected final String TEXT_244 = ").withMetadata(objectMetadata_";
  protected final String TEXT_245 = ");" + NL + "  \t\t" + NL + "  \t\t\t";
  protected final String TEXT_246 = NL;
  protected final String TEXT_247 = NL + "\t";
  protected final String TEXT_248 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_249 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_250 = ");" + NL + "\t";
  protected final String TEXT_251 = NL + "\t";
  protected final String TEXT_252 = NL + "\t\t";
  protected final String TEXT_253 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_254 = " - No KMS key - use default\");" + NL + "\t\t";
  protected final String TEXT_255 = NL + "\t\tputRequest_";
  protected final String TEXT_256 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t";
  protected final String TEXT_257 = NL + "\t\t";
  protected final String TEXT_258 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_259 = " - Key found - use key\");" + NL + "\t\t";
  protected final String TEXT_260 = NL + "\t\tputRequest_";
  protected final String TEXT_261 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_262 = "));" + NL + "\t";
  protected final String TEXT_263 = NL + "  \t\t" + NL + "  \t\t\tcom.amazonaws.services.s3.transfer.Upload upload_";
  protected final String TEXT_264 = " = tm_";
  protected final String TEXT_265 = ".upload(putRequest_";
  protected final String TEXT_266 = ");" + NL + "  \t\t" + NL + "  \t\t\tupload_";
  protected final String TEXT_267 = ".waitForCompletion();" + NL + "\t\t} else {" + NL + "\t\t\t\tjava.io.InputStream sourceStream_";
  protected final String TEXT_268 = " = ((java.io.InputStream)fileOrStream_";
  protected final String TEXT_269 = ");" + NL + "\t\t\t\t" + NL + "  \t\t\tclass S3StreamUtil {" + NL + "    \t    public int getLength(byte[] output) {" + NL + "    \t\t    for (int i = output.length - 1; i > 0; i--) {" + NL + "    \t\t\t    if (output[i] != 0) {" + NL + "    \t\t\t\t    return i + 1;" + NL + "    \t\t\t    }" + NL + "    \t\t    }" + NL + "    \t\t    return 0;" + NL + "    \t    }" + NL + "      \t}" + NL + "      \t" + NL + "      \tS3StreamUtil streamUtil_";
  protected final String TEXT_270 = " = new S3StreamUtil();" + NL + "    \t\tbyte[] buffer_";
  protected final String TEXT_271 = " = new byte[partSizeInBytes_";
  protected final String TEXT_272 = "];" + NL + "    \t\tsourceStream_";
  protected final String TEXT_273 = ".read(buffer_";
  protected final String TEXT_274 = ");" + NL + "    \t\tlong curPartSize_";
  protected final String TEXT_275 = " = streamUtil_";
  protected final String TEXT_276 = ".getLength(buffer_";
  protected final String TEXT_277 = ");" + NL + "    \t\tboolean multiUpload_";
  protected final String TEXT_278 = " = curPartSize_";
  protected final String TEXT_279 = " == partSizeInBytes_";
  protected final String TEXT_280 = ";" + NL + "    \t\t" + NL + "    \t\tif(!multiUpload_";
  protected final String TEXT_281 = ") {" + NL + "    \t\t\t\tobjectMetadata_";
  protected final String TEXT_282 = ".setContentLength(curPartSize_";
  protected final String TEXT_283 = ");" + NL + "    \t\t\t\tuploadStream_";
  protected final String TEXT_284 = " = new java.io.ByteArrayInputStream(buffer_";
  protected final String TEXT_285 = ",0,Long.valueOf(curPartSize_";
  protected final String TEXT_286 = ").intValue());" + NL + "    \t\t\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_287 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_288 = ", key_";
  protected final String TEXT_289 = ", uploadStream_";
  ...
  protected final String TEXT_309 = NL + "    \t\t\t\t" + NL + "    \t\t\t\tconn_";
  protected final String TEXT_310 = ".putObject(putRequest_";
  protected final String TEXT_311 = ");" + NL + "    \t\t} else {" + NL + "    \t\t\t\tuploadStream_";
  protected final String TEXT_312 = " = new java.io.ByteArrayInputStream(buffer_";
  protected final String TEXT_313 = ");" + NL + "      \t\t\tjava.util.List<com.amazonaws.services.s3.model.PartETag> partTags_";
  protected final String TEXT_314 = " = new java.util.ArrayList<com.amazonaws.services.s3.model.PartETag>();" + NL + "      \t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_";
  protected final String TEXT_315 = " = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(";
  protected final String TEXT_316 = ", key_";
  protected final String TEXT_317 = ", objectMetadata_";
  protected final String TEXT_318 = ");" + NL + "      \t\t\t" + NL + "      \t\t\t";
  protected final String TEXT_319 = NL;
  protected final String TEXT_320 = NL + "\t";
  protected final String TEXT_321 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_322 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_323 = ");" + NL + "\t";
  protected final String TEXT_324 = NL + "\t";
  protected final String TEXT_325 = NL + "\t\t";
  protected final String TEXT_326 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_327 = " - No KMS key - use default\");" + NL + "\t\t";
  protected final String TEXT_328 = NL + "\t\tputRequest_";
  protected final String TEXT_329 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t";
  protected final String TEXT_330 = NL + "\t\t";
  protected final String TEXT_331 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_332 = " - Key found - use key\");" + NL + "\t\t";
  protected final String TEXT_333 = NL + "\t\tputRequest_";
  protected final String TEXT_334 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_335 = "));" + NL + "\t";
  protected final String TEXT_336 = NL + "      \t\t\t" + NL + "      \t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadResult initResponse_";
  protected final String TEXT_337 = " = conn_";
  protected final String TEXT_338 = ".initiateMultipartUpload(putRequest_";
  protected final String TEXT_339 = ");" + NL + "      \t\t\tString uploadId_";
  protected final String TEXT_340 = " = initResponse_";
  protected final String TEXT_341 = ".getUploadId();" + NL + "      \t\t\tint partNumber_";
  protected final String TEXT_342 = " = 1;" + NL + "      \t\t\tboolean streamHasNext_";
  protected final String TEXT_343 = " = true;" + NL + "      \t\t\tbyte[] probeAvailability_";
  protected final String TEXT_344 = " = new byte[1];" + NL + "      \t\t\ttry {" + NL + "  \t\t\t\t\t\t\twhile (streamHasNext_";
  protected final String TEXT_345 = ") {" + NL + "        \t\t\t\t\t\tcom.amazonaws.services.s3.model.UploadPartRequest uploadRequest_";
  protected final String TEXT_346 = " = new com.amazonaws.services.s3.model.UploadPartRequest()" + NL + "                    \t.withBucketName(";
  protected final String TEXT_347 = ")" + NL + "                    \t.withKey(key_";
  protected final String TEXT_348 = ").withUploadId(uploadId_";
  protected final String TEXT_349 = ")" + NL + "                    \t.withPartNumber(partNumber_";
  protected final String TEXT_350 = ").withPartSize(curPartSize_";
  protected final String TEXT_351 = ");" + NL + "            \t\t    uploadRequest_";
  protected final String TEXT_352 = ".setInputStream(uploadStream_";
  protected final String TEXT_353 = ");" + NL + "            \t\t    streamHasNext_";
  protected final String TEXT_354 = " = sourceStream_";
  protected final String TEXT_355 = ".read(probeAvailability_";
  protected final String TEXT_356 = ") != -1;" + NL + "            \t\t    if(!streamHasNext_";
  protected final String TEXT_357 = "){" + NL + "                    \t    uploadRequest_";
  protected final String TEXT_358 = ".setLastPart(true);" + NL + "                    \t}" + NL + "" + NL + "                \t\tpartTags_";
  protected final String TEXT_359 = ".add(conn_";
  protected final String TEXT_360 = ".uploadPart(uploadRequest_";
  protected final String TEXT_361 = ").getPartETag());" + NL + "                  \t    partNumber_";
  protected final String TEXT_362 = "++;" + NL + "" + NL + "          \t\t     \tif(uploadStream_";
  protected final String TEXT_363 = "!=null){" + NL + "      \t\t         \t\t\tuploadStream_";
  protected final String TEXT_364 = ".close();" + NL + "          \t\t     \t}" + NL + "          \t\t     \tbuffer_";
  protected final String TEXT_365 = " = new byte[partSizeInBytes_";
  protected final String TEXT_366 = "];" + NL + "          \t\t     \tsourceStream_";
  protected final String TEXT_367 = ".read(buffer_";
  protected final String TEXT_368 = ",1,partSizeInBytes_";
  protected final String TEXT_369 = "-1);" + NL + "          \t\t     \tbuffer_";
  protected final String TEXT_370 = "[0] = probeAvailability_";
  protected final String TEXT_371 = "[0];" + NL + "          \t\t     \tprobeAvailability_";
  protected final String TEXT_372 = " = new byte[1];" + NL + "          \t\t     \tcurPartSize_";
  protected final String TEXT_373 = " = streamUtil_";
  protected final String TEXT_374 = ".getLength(buffer_";
  protected final String TEXT_375 = ");" + NL + "          \t\t     \tuploadStream_";
  protected final String TEXT_376 = " = new java.io.ByteArrayInputStream(buffer_";
  protected final String TEXT_377 = ");" + NL + "        \t\t\t\t}" + NL + "        \t\t\t\t" + NL + "            \t\tcom.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_";
  protected final String TEXT_378 = " = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(";
  protected final String TEXT_379 = ", key_";
  protected final String TEXT_380 = "," + NL + "                        uploadId_";
  protected final String TEXT_381 = ", partTags_";
  protected final String TEXT_382 = ");" + NL + "            \t\tconn_";
  protected final String TEXT_383 = ".completeMultipartUpload(compRequest_";
  protected final String TEXT_384 = ");" + NL + "            } catch (java.lang.Exception uploadException_";
  protected final String TEXT_385 = ") {" + NL + "  \t\t\t\t\t\t\tconn_";
  protected final String TEXT_386 = ".abortMultipartUpload(new com.amazonaws.services.s3.model.AbortMultipartUploadRequest(";
  protected final String TEXT_387 = ", key_";
  protected final String TEXT_388 = ", uploadId_";
  protected final String TEXT_389 = "));" + NL + "    \t\t\t\t\t\tthrow uploadException_";
  protected final String TEXT_390 = ";" + NL + "            }" + NL + "    \t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_391 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_392 = " - Upload the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_393 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_394 = "){" + NL + "\t\t";
  protected final String TEXT_395 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_396 = ");" + NL + "\t\t";
  protected final String TEXT_397 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_398 = " - \" + e_";
  protected final String TEXT_399 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_401 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_402 = NL + "\t}finally{" + NL + "\t\tif(useStream_";
  protected final String TEXT_403 = " && uploadStream_";
  protected final String TEXT_404 = "!=null){" + NL + "    \tuploadStream_";
  protected final String TEXT_405 = ".close();" + NL + "    }" + NL + "\t    " + NL + "\t\t";
  protected final String TEXT_406 = NL + "\t\tif(conn_";
  protected final String TEXT_407 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_408 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
