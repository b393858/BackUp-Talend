...
public class TMemSQLOutputEndJava
{
  ...
  protected final String TEXT_64 = NL + "                    if(batchSizeCounter_";
  protected final String TEXT_65 = " > 0){" + NL + "                        long countSum_";
  protected final String TEXT_66 = " = 0;" + NL + "                        int[] resultStatus = {};" + NL + "                        try {" + NL + "                            if (pstmt_";
  protected final String TEXT_67 = " != null) {";
  protected final String TEXT_68 = NL + "                               resultStatus = pstmt_";
  protected final String TEXT_69 = ".executeBatch();";
  protected final String TEXT_70 = NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_71 = "){";
  protected final String TEXT_72 = NL + "                                throw(e_";
  protected final String TEXT_73 = ");";
  protected final String TEXT_74 = NL + "                            System.out.println(e_";
  protected final String TEXT_75 = ".getMessage());" + NL + "                            for(int countEach_";
  protected final String TEXT_76 = ": e_";
  protected final String TEXT_77 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  protected final String TEXT_78 = " += (countEach_";
  protected final String TEXT_79 = " < 0 ? 0 : countEach_";
  protected final String TEXT_80 = ");" + NL + "                                }";
  protected final String TEXT_81 = NL + "                        }" + NL + "" + NL + "                        if (pstmt_";
  protected final String TEXT_82 = " != null) {" + NL + "                        " + NL + "                            long tmp_batchUpdateCount_";
  protected final String TEXT_83 = " = 0;" + NL + "                            for(int i : resultStatus){" + NL + "                                  if(i==-3){//EXECUTE_FAILED";
  protected final String TEXT_84 = NL + "                                        System.err.println(\"Query failed to execute.\");" + NL + "                                  }else if(i==-2){//SUCCESS_NO_INFO";
  protected final String TEXT_85 = NL + "                                        System.err.println(\"Query was processed successfully but that the number of rows affected is unknown.\");" + NL + "                                  }else{" + NL + "                                       tmp_batchUpdateCount_";
  protected final String TEXT_86 = " += (i<0 ? 0 : i);" + NL + "                                  }" + NL + "                            }" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_87 = " += countSum_";
  protected final String TEXT_88 = ";" + NL + "                            ";
  protected final String TEXT_89 = NL + "                                insertedCount_";
  protected final String TEXT_90 = NL + "                                updatedCount_";
  protected final String TEXT_91 = NL + "                                deletedCount_";
  protected final String TEXT_92 = NL + "                            += tmp_batchUpdateCount_";
  protected final String TEXT_93 = ";" + NL + "                        }" + NL + "                    }";
  protected final String TEXT_94 = NL + NL + "        if(pstmt_";
  protected final String TEXT_95 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_96 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_97 = "\");" + NL + "        }";
  protected final String TEXT_98 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_99 = "\", true);";
  protected final String TEXT_100 = NL + "        if(conn_";
  protected final String TEXT_101 = " != null && !conn_";
  protected final String TEXT_102 = ".isClosed()) {";
