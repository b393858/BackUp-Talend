...
public class TJDBCSCDELTEndJava {
  protected static String nl;
  public static synchronized TJDBCSCDELTEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCSCDELTEndJava result = new TJDBCSCDELTEndJava();
    nl = null;
    return result;
  }
