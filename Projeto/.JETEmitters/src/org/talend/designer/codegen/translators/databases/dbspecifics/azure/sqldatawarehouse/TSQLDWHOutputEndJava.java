...
public class TSQLDWHOutputEndJava {
  protected static String nl;
  public static synchronized TSQLDWHOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHOutputEndJava result = new TSQLDWHOutputEndJava();
    nl = null;
    return result;
  }
