...
public class THiveRowMainJava
{
  ...
  protected final String TEXT_50 = NL + "        \t\t}" + NL + "        \t}" + NL + "\t\t    query_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "\t\t    queries_";
  protected final String TEXT_53 = " = queries_";
  protected final String TEXT_54 = " + query_";
  protected final String TEXT_55 = ".replace(\"';'\", \"'\\\\;'\") + \";\";" + NL + "" + NL + "\t\t    org.talend.bigdata.launcher.qubole.QuboleHiveClient.Job job_";
  protected final String TEXT_56 = " =" + NL + "\t\t    \tnew org.talend.bigdata.launcher.qubole.QuboleHiveClient.Job(queries_";
  protected final String TEXT_57 = ");" + NL + "\t\t\tjob_";
  protected final String TEXT_58 = ".setJobName(\"";
  protected final String TEXT_59 = "\");" + NL + "\t\t\tjob_";
  protected final String TEXT_60 = ".setUserAgent(routines.system.Constant.getUserAgent(\"";
  protected final String TEXT_61 = "\"));" + NL + "        \t";
  protected final String TEXT_62 = NL + "\t\t\tjob_";
  protected final String TEXT_63 = ".setClusterLabel(";
  protected final String TEXT_64 = ");" + NL + "\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\tString execution_result_";
  protected final String TEXT_66 = " = instance_";
  protected final String TEXT_67 = ".execute(job_";
  protected final String TEXT_68 = ");" + NL + "\t\t\t";
  protected final String TEXT_69 = "    " + NL + "\t\t\t";
  protected final String TEXT_70 = " = null;            " + NL + "\t\t\t";
  protected final String TEXT_71 = NL + "\tquery_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "\twhetherReject_";
  protected final String TEXT_74 = " = false;" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_81 = NL + NL + "java.text.DateFormat dateStrFormat_";
  protected final String TEXT_82 = " = new java.text.SimpleDateFormat(\"yyyyMMddHHmmss\");" + NL + "final String queryIdentifier_";
  protected final String TEXT_83 = " = projectName + \"_\" + jobName + \"_\" + jobVersion.replace(\".\", \"_\") + \"_";
  protected final String TEXT_84 = "_\" + dateStrFormat_";
  protected final String TEXT_85 = ".format(new Date(startTime));" + NL + "// For MapReduce Mode" + NL + "stmt_";
  protected final String TEXT_86 = ".execute(\"set mapred.job.name=\" + queryIdentifier_";
  protected final String TEXT_87 = ");";
  protected final String TEXT_88 = NL + "    // For Tez Mode" + NL + "    stmt_";
  protected final String TEXT_89 = ".execute(\"set hive.query.name=\" + queryIdentifier_";
  protected final String TEXT_90 = ");";
  protected final String TEXT_91 = NL + "\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_93 = ".setTimestamp(";
  protected final String TEXT_94 = ",new java.sql.Timestamp(";
  protected final String TEXT_95 = ".getTime()));" + NL + "\t";
  protected final String TEXT_96 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_97 = ".set";
  protected final String TEXT_98 = "(";
  protected final String TEXT_99 = ",";
  protected final String TEXT_100 = ");" + NL + "\t";
  protected final String TEXT_101 = NL + "\t\t\trs_";
  protected final String TEXT_102 = " = pstmt_";
  protected final String TEXT_103 = ".executeQuery();" + NL + "\t";
  protected final String TEXT_104 = NL + "\t    \tpstmt_";
  protected final String TEXT_105 = ".execute();" + NL + "\t    \t";
  protected final String TEXT_106 = NL + "\t\t\t\trs_";
  protected final String TEXT_107 = " = stmt_";
  protected final String TEXT_108 = ".executeQuery(query_";
  protected final String TEXT_109 = ");" + NL + "\t\t\t";
  protected final String TEXT_110 = NL + "\t\t  \tstmt_";
  protected final String TEXT_111 = ".execute(query_";
  protected final String TEXT_112 = ");" + NL + "\t    \t";
  protected final String TEXT_113 = NL + "\t\tlog.info(\"Query sent to HiveServer2 to be executed with [Application Name(MapReduce)/DAG Name(Tez): \" + queryIdentifier_";
  protected final String TEXT_114 = " + \"]\");" + NL + "\t    } catch (java.lang.Exception e) {" + NL + "\t        whetherReject_";
  protected final String TEXT_115 = " = true;" + NL + "\t        ";
  protected final String TEXT_116 = NL + "\t            throw(e);" + NL + "\t            ";
  protected final String TEXT_117 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_118 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_128 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t                ";
  protected final String TEXT_129 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_130 = ";" + NL + "\t                ";
  protected final String TEXT_131 = NL + "\t                System.err.print(e.getMessage());" + NL + "\t                ";
  protected final String TEXT_132 = NL + "\t    }" + NL + "\t\t";
  protected final String TEXT_133 = NL + "\t    if(!whetherReject_";
  protected final String TEXT_134 = ") {" + NL + "\t        ";
  protected final String TEXT_135 = NL + "\t                    ";
  protected final String TEXT_136 = " = new ";
  protected final String TEXT_137 = "Struct();" + NL + "\t                    ";
  ...
  protected final String TEXT_148 = NL + "\t        commitCounter_";
  protected final String TEXT_149 = "++;" + NL + "\t        if(commitEvery_";
  protected final String TEXT_150 = " <= commitCounter_";
  protected final String TEXT_151 = ") {" + NL + "\t        " + NL + "\t\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_153 = " - Starting to commit.\");" + NL + "\t\t\t\t";
  protected final String TEXT_154 = NL + "\t        \tconn_";
  protected final String TEXT_155 = ".commit();" + NL + "\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_157 = " - Commit has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_158 = NL + "\t        \t" + NL + "\t        \tcommitCounter_";
  protected final String TEXT_159 = "=0;" + NL + "\t        \t" + NL + "\t        }" + NL + "\t        ";
