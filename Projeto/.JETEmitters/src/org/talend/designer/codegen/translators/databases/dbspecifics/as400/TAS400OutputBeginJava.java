...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_60 = " = 0;" + NL + "" + NL + "int nb_line_rejected_";
  ...
  protected final String TEXT_69 = " = false;" + NL + NL;
  ...
  protected final String TEXT_73 = NL + "    String dbProperties_";
  ...
  protected final String TEXT_81 = ";" + NL + "    } else {" + NL + "        url_";
  protected final String TEXT_82 = " = \"jdbc:as400://\" + ";
  ...
  protected final String TEXT_97 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"com.ibm.as400.access.AS400JDBCDriver\");";
  ...
  protected final String TEXT_103 = NL + NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_117 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_121 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_134 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_135 = "));";
  protected final String TEXT_136 = NL + "                        stmtCreate_";
  protected final String TEXT_137 = ".execute(((\"";
  protected final String TEXT_138 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = ", \"";
  protected final String TEXT_141 = "\")";
  protected final String TEXT_142 = ".toUpperCase()";
  ...
  protected final String TEXT_169 = NL + "                    String keyCheckTable_";
  protected final String TEXT_170 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_177 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_180 = " + \"]\";";
  protected final String TEXT_181 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_182 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_183 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_184 = ")== null){//}";
  protected final String TEXT_185 = NL + "                                boolean whetherExist_";
  protected final String TEXT_186 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_189 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_190 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_191 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_192 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_201 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_202 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_203 = " = dbMetaData_";
  protected final String TEXT_204 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_205 = ", tableNameForSearch_";
  protected final String TEXT_206 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_207 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_208 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_209 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_212 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_228 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_229 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_230 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_233 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_234 = " = dbMetaData_";
  protected final String TEXT_235 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_254 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_260 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_261 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_262 = " == null || dbschema_";
  protected final String TEXT_263 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_266 = " = stmtSchema_";
  protected final String TEXT_267 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_268 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_269 = " = rsSchema_";
  protected final String TEXT_270 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_290 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_306 = ".getTables(null, conn_";
  protected final String TEXT_307 = ".getSchema(), tableForSearch_";
  protected final String TEXT_308 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  ...
  protected final String TEXT_313 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_314 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_315 = " = dbMetaData_";
  protected final String TEXT_316 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_317 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_318 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_319 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_320 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_321 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_327 = ".getTables(";
  protected final String TEXT_328 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_329 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_330 = " = rsTable_";
  protected final String TEXT_331 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_332 = ".equalsIgnoreCase(";
  protected final String TEXT_333 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_334 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_340 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_346 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_347 = NL + "                                if(!whetherExist_";
  protected final String TEXT_348 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_368 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_369 = " = conn_";
  protected final String TEXT_370 = ".createStatement()) {";
  protected final String TEXT_371 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_379 = NL + "                                            conn_";
  protected final String TEXT_380 = ".commit();";
  protected final String TEXT_381 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_400 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_401 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_402 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_409 = ".executeUpdate(\"";
  protected final String TEXT_410 = "\");";
  protected final String TEXT_411 = NL + "            }";
  protected final String TEXT_412 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_413 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_414 = " = conn_";
  protected final String TEXT_415 = ".createStatement()) {";
  protected final String TEXT_416 = NL + "                              stmtTruncCount_";
  protected final String TEXT_417 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_418 = "));";
  protected final String TEXT_419 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_420 = " = stmtTruncCount_";
  protected final String TEXT_421 = ".executeQuery(\"";
  protected final String TEXT_422 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_423 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_424 = " = rsTruncCount_";
  protected final String TEXT_425 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_433 = NL + "                stmtTrunc_";
  protected final String TEXT_434 = ".executeUpdate(\"";
  protected final String TEXT_435 = "\");";
  protected final String TEXT_436 = NL + "                    if(!conn_";
  protected final String TEXT_437 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_438 = ".commit();" + NL + "                    }";
  protected final String TEXT_439 = NL + "                deletedCount_";
  protected final String TEXT_440 = " += rsTruncCountNumber_";
  protected final String TEXT_441 = ";" + NL + "            }";
  protected final String TEXT_442 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_458 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_459 = NL + "\t    String insert_";
  protected final String TEXT_460 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_466 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_467 = "\", pstmt_";
  protected final String TEXT_468 = ");" + NL + "\t    ";
  protected final String TEXT_469 = NL + "\t    String update_";
  protected final String TEXT_470 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_475 = ".prepareStatement(update_";
  ...
  protected final String TEXT_481 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_486 = " = \"INSERT INTO \" + ";
  protected final String TEXT_487 = " + \" (";
  protected final String TEXT_488 = ") VALUES (";
  protected final String TEXT_489 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".prepareStatement(insert_";
  protected final String TEXT_492 = ");" + NL + "\t\tresourceMap.put(\"pstmtInsert_";
  protected final String TEXT_493 = "\", pstmtInsert_";
  protected final String TEXT_494 = ");" + NL + "\t    String update_";
  protected final String TEXT_495 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_505 = " = \"UPDATE \" + ";
  protected final String TEXT_506 = " + \" SET ";
  protected final String TEXT_507 = " WHERE ";
  protected final String TEXT_508 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_509 = " = conn_";
  protected final String TEXT_510 = ".prepareStatement(update_";
  protected final String TEXT_511 = ");" + NL + "\t\tresourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_512 = "\", pstmtUpdate_";
  protected final String TEXT_513 = ");" + NL + "\t    String insert_";
  protected final String TEXT_514 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_523 = NL + "\t    String delete_";
  protected final String TEXT_524 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_528 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_563 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_564 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_573 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_574 = " = null;";
  protected final String TEXT_575 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_576 = " = null;";
  protected final String TEXT_577 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_578 = " = null;";
  protected final String TEXT_579 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_580 = " = null;";
  protected final String TEXT_581 = NL + "\t\t \tString[] insertSQLSplits_";
