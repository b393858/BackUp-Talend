...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_77 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_78 = " = null;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_86 = " = \"com.vertica.Driver\";" + NL + "\t\t";
  protected final String TEXT_87 = NL + "\t \t\tString driverClass_";
  protected final String TEXT_88 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t";
  protected final String TEXT_89 = NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_90 = ").newInstance();" + NL + "\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_97 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_110 = NL + "\t   \t" + NL + "\t\tdbschema_";
  ...
  protected final String TEXT_117 = NL + "\tif(dbschema_";
  ...
  protected final String TEXT_129 = " - Droping table ";
  protected final String TEXT_130 = "\" + tableName_";
  ...
  protected final String TEXT_137 = " - Drop table ";
  protected final String TEXT_138 = "\" + tableName_";
  protected final String TEXT_139 = " + \"";
  protected final String TEXT_140 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_146 = " - Creating table ";
  protected final String TEXT_147 = "\" + tableName_";
  ...
  protected final String TEXT_154 = " - Create table ";
  protected final String TEXT_155 = "\" + tableName_";
  ...
  protected final String TEXT_164 = " - Creating table ";
  ...
  protected final String TEXT_172 = " - Create table ";
  protected final String TEXT_173 = "\" + tableName_";
  protected final String TEXT_174 = " + \"";
  protected final String TEXT_175 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_181 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_182 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_183 = " = tableNameForSearch_";
  protected final String TEXT_184 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_185 = " = tableNameForSearch_";
  protected final String TEXT_186 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_187 = " = dbMetaData_";
  protected final String TEXT_188 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_189 = ", tableNameForSearch_";
  protected final String TEXT_190 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_191 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_192 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_193 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_203 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_204 = " = rsTable_";
  protected final String TEXT_205 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_206 = ".equalsIgnoreCase(";
  protected final String TEXT_207 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_208 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_209 = ") || dbschema_";
  protected final String TEXT_210 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_215 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_216 = " = dbMetaData_";
  protected final String TEXT_217 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_218 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_219 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_220 = " = rsTable_";
  protected final String TEXT_221 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_222 = " = rsTable_";
  protected final String TEXT_223 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_224 = ".equals(";
  protected final String TEXT_225 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_226 = ".equals(schema_";
  protected final String TEXT_227 = ") || (schema_";
  protected final String TEXT_228 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_229 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_238 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_239 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_240 = " == null || dbschema_";
  protected final String TEXT_241 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_244 = " = stmtSchema_";
  protected final String TEXT_245 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_246 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_247 = " = rsSchema_";
  protected final String TEXT_248 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_249 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_250 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_265 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_266 = ".equals";
  protected final String TEXT_267 = "IgnoreCase";
  protected final String TEXT_268 = "(schema_";
  ...
  protected final String TEXT_272 = NL + "            \tString tableForSearch_";
  protected final String TEXT_273 = " = ";
  protected final String TEXT_274 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_275 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_276 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_277 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_278 = " =  tableForSearch_";
  protected final String TEXT_279 = ".substring(1,tableForSearch_";
  protected final String TEXT_280 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_281 = " =  tableForSearch_";
  protected final String TEXT_282 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_286 = ".getTables(null, conn_";
  protected final String TEXT_287 = ".getSchema(), tableForSearch_";
  protected final String TEXT_288 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_289 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_290 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_291 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_297 = ".getTables(null, dbschema_";
  protected final String TEXT_298 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_299 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_300 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_301 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_309 = ".getTables(";
  protected final String TEXT_310 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_314 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  ...
  protected final String TEXT_321 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_325 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_326 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_327 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_328 = " = rsTable_";
  protected final String TEXT_329 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_330 = ".equals";
  protected final String TEXT_331 = "IgnoreCase";
  protected final String TEXT_332 = "(";
  protected final String TEXT_333 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_334 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_335 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_336 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_337 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_341 = " - Creating table ";
  ...
  protected final String TEXT_349 = " - Create table ";
  ...
  protected final String TEXT_360 = " - Droping table ";
  ...
  protected final String TEXT_368 = " - Drop table ";
  ...
  protected final String TEXT_377 = " - Creating table ";
  ...
  protected final String TEXT_385 = " - Create table ";
  ...
  protected final String TEXT_391 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_395 = " - Clearing table ";
  ...
  protected final String TEXT_418 = " - Trancating table ";
  ...
  protected final String TEXT_426 = " - Truncate table ";
  protected final String TEXT_427 = "\" + tableName_";
  protected final String TEXT_428 = " + \"";
  protected final String TEXT_429 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_431 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_432 = " += rsTruncCount_";
  protected final String TEXT_433 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_434 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_435 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_436 = ".close();" + NL + "\t\t";
  protected final String TEXT_437 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_438 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_439 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_440 = NL + "try {";
  protected final String TEXT_441 = NL + "        int keyCount_";
  protected final String TEXT_442 = " = ";
  protected final String TEXT_443 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_444 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tableName_";
  protected final String TEXT_445 = " = \"tmp_";
  protected final String TEXT_446 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_447 = " != null && dbschema_";
  protected final String TEXT_448 = ".trim().length() != 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_449 = " = dbschema_";
  protected final String TEXT_450 = " + \".\" + tableName_";
  protected final String TEXT_451 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\tString sql_create_tmpdb = \"";
  protected final String TEXT_452 = ")\";" + NL;
  protected final String TEXT_453 = NL + "\t\tCharacter OUT_DELIM_";
  protected final String TEXT_454 = " = ";
  protected final String TEXT_455 = ".charAt(0);" + NL + "\t\t";
  protected final String TEXT_456 = NL + "\t\tString escapechar_";
  protected final String TEXT_457 = " = ";
  protected final String TEXT_458 = ";" + NL + "\t\tif(!escapechar_";
  protected final String TEXT_459 = ".isEmpty()){" + NL + "\t\t\tescapechar_";
  protected final String TEXT_460 = " = \"\" + escapechar_";
  protected final String TEXT_461 = ".charAt(0);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_462 = NL + "\t\t\tString copySchema_";
  protected final String TEXT_463 = " = \"";
  protected final String TEXT_464 = "\";" + NL + "\t\t\tif (\"null\".equals(copySchema_";
  protected final String TEXT_465 = ")) {" + NL + "\t\t\t\tthrow new RuntimeException(\"Schema is not defined\");" + NL + "\t\t\t}";
  protected final String TEXT_466 = NL + "\t\tString sql_";
  protected final String TEXT_467 = " = \"COPY \" + tableName_";
  protected final String TEXT_468 = " " + NL + "\t\t";
  protected final String TEXT_469 = NL + "\t\t\t+ copySchema_";
  protected final String TEXT_470 = NL + "\t\t";
  protected final String TEXT_471 = "\t\t" + NL + "\t\t+ \" FROM STDIN ";
  protected final String TEXT_472 = " ";
  protected final String TEXT_473 = " DELIMITER '\" + OUT_DELIM_";
  protected final String TEXT_474 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_475 = NL + "\t\t+ \" TRAILING NULLCOLS\"" + NL + "\t\t";
  protected final String TEXT_476 = NL + "\t\t";
  protected final String TEXT_477 = NL + "\t\t+ \" SKIP \" + ";
  protected final String TEXT_478 = NL + "\t\t";
  protected final String TEXT_479 = NL + "\t\t";
  protected final String TEXT_480 = NL + "\t\t+ \" RECORD TERMINATOR E'\" + ";
  protected final String TEXT_481 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_482 = NL + "\t\t";
  protected final String TEXT_483 = NL + "\t\t+ \" ENCLOSED BY E'\" + ";
  protected final String TEXT_484 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_485 = NL + "\t\t";
  protected final String TEXT_486 = NL + "\t\t+ \" ENFORCELENGTH\"" + NL + "\t\t";
  protected final String TEXT_487 = NL + "\t\t";
  protected final String TEXT_488 = NL + "\t\t+ \" REJECTMAX \" + ";
  protected final String TEXT_489 = NL + "\t\t";
  protected final String TEXT_490 = NL + "\t\t";
  protected final String TEXT_491 = NL + "\t\t+ \" ABORT ON ERROR\"" + NL + "\t\t";
  protected final String TEXT_492 = NL + "\t\t";
  protected final String TEXT_493 = NL + "\t\t+ \" ESCAPE AS '\" + escapechar_";
  protected final String TEXT_494 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_495 = NL + "\t\t+\" NO ESCAPE\"" + NL + "\t\t";
  ...
  protected final String TEXT_500 = " + \" DIRECT\"";
  protected final String TEXT_501 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_502 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_503 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_504 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_505 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_506 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_507 = NL + "\t    ";
  protected final String TEXT_508 = NL + "\t        + \" NO COMMIT\"" + NL + "\t    ";
  protected final String TEXT_509 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_510 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_511 = " - Bulk SQL:\"+sql_";
  protected final String TEXT_512 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_513 = " - Bulk inserting data into ";
  protected final String TEXT_514 = "\" + tableName_";
  protected final String TEXT_515 = " + \"";
  protected final String TEXT_516 = ".\" );";
  protected final String TEXT_517 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_518 = " = conn_";
  protected final String TEXT_519 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_520 = " = stmt_";
  protected final String TEXT_521 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_522 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_523 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_524 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_525 = " = rs_";
  protected final String TEXT_526 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_527 = NL + "\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_528 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_529 = ",sql_";
  protected final String TEXT_530 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_531 = ".start();";
...
if(("INSERT").equals(dataAction) || columnList != null && columnList.size() > 0) {
    ...
    stringBuffer.append(skipping_value);
    stringBuffer.append(TEXT_478);
    }
    stringBuffer.append(TEXT_479);
    if(is_version_ge_6 && has_terminator){
    stringBuffer.append(TEXT_480);
    stringBuffer.append(terminator_value);
    stringBuffer.append(TEXT_481);
    }
    stringBuffer.append(TEXT_482);
    if(is_version_ge_6 && has_enclosing_char){
    stringBuffer.append(TEXT_483);
    stringBuffer.append(enclosing_char);
    ...
    stringBuffer.append(rejected_max_value);
