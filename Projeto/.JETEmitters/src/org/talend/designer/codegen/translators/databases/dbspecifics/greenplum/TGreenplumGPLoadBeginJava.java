package org.talend.designer.codegen.translators.databases.dbspecifics.greenplum;
...
public class TGreenplumGPLoadBeginJava {
  ...
  protected final String TEXT_77 = NL + "\tint deletedCount_";
  protected final String TEXT_78 = " = 0;" + NL + "\tint insertedCount_";
  protected final String TEXT_79 = " = 0;";
  protected final String TEXT_80 = NL + "\t\tboolean missConfiguration_";
  protected final String TEXT_81 = " = true;" + NL + "\t\tString missConfigurationMsg_";
  protected final String TEXT_82 = " = \"";
  protected final String TEXT_83 = "\";" + NL + "\t\tif (missConfiguration_";
  protected final String TEXT_84 = ") {" + NL + "\t\t\tthrow new java.lang.Exception(missConfigurationMsg_";
  protected final String TEXT_85 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_86 = NL + NL + "\tString tableName_";
  protected final String TEXT_87 = " = ";
  protected final String TEXT_88 = ";" + NL + "\tString dbschema_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";" + NL + "\tString tableName4Load_";
  protected final String TEXT_91 = " = \"\\\"\" + tableName_";
  protected final String TEXT_92 = " + \"\\\"\";" + NL + "\tif(dbschema_";
  protected final String TEXT_93 = " != null && dbschema_";
  protected final String TEXT_94 = ".trim().length() > 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_95 = " = dbschema_";
  protected final String TEXT_96 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_97 = ";" + NL + "\t\ttableName4Load_";
  ...
  protected final String TEXT_103 = " = \"org.postgresql.Driver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_104 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_105 = " + \":\" + ";
  protected final String TEXT_106 = " + \"/\" + ";
  protected final String TEXT_107 = ";" + NL + "\t\t";
  protected final String TEXT_108 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_109 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_110 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_111 = "+\":\"+";
  protected final String TEXT_112 = "+\";DatabaseName=\"+";
  protected final String TEXT_113 = ";" + NL + "\t\t";
  protected final String TEXT_114 = NL + "\t\t" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_136 = ";" + NL + "\t        \t\t" + NL + "\t\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_142 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_148 = " - Drop table '\" + tableName_";
  protected final String TEXT_149 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_151 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_155 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_161 = " - Create table '\" + tableName_";
  protected final String TEXT_162 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_164 = "){" + NL + "\t\t\t\t\tthrow new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_165 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_167 = " - Table '\" + tableName4Load_";
  protected final String TEXT_168 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_170 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_171 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_175 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_181 = " - Create table '\" + tableName_";
  protected final String TEXT_182 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_184 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_185 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_187 = " - Table '\" + tableName4Load_";
  protected final String TEXT_188 = " + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_214 = ") && (schema_";
  protected final String TEXT_215 = ".equals(dbschema_";
  ...
  protected final String TEXT_228 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_234 = " - Create table '\" + tableName_";
  protected final String TEXT_235 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_236 = " " + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_237 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_238 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_240 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_241 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_242 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_243 = NL + "                if(whetherExist_";
  protected final String TEXT_244 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_245 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_257 = NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_258 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_259 = "  + \"'. process terminated.\");" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_261 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_262 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_264 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  protected final String TEXT_265 = " = conn_";
  protected final String TEXT_266 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_268 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_274 = " - Create table '\" + tableName_";
  protected final String TEXT_275 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_276 = "           " + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_277 = "){" + NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_278 = "  + \"'. process terminated.\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_280 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_281 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_282 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_283 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_286 = " = stmtClearCount_";
  protected final String TEXT_287 = ".executeQuery(\"";
  protected final String TEXT_288 = "\");" + NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_292 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_298 = " - Truncate table '\" + tableName_";
  protected final String TEXT_299 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_300 = NL + "            while(rsClearCount_";
  protected final String TEXT_301 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_302 = " = rsClearCount_";
  protected final String TEXT_303 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_304 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_305 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  protected final String TEXT_306 = " = conn_";
  protected final String TEXT_307 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_309 = " - Clearing table '\" + tableName_";
  protected final String TEXT_310 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_311 = NL + "            \tdeletedCount_";
  protected final String TEXT_312 = " = stmtClear_";
  protected final String TEXT_313 = ".executeUpdate(\"";
  protected final String TEXT_314 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_315 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_316 = "- Clear table '\" + tableName_";
  protected final String TEXT_317 = " +  \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_318 = NL + "            \tstmtClear_";
  protected final String TEXT_319 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_320 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_321 = "  + \"'. process terminated.\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_323 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_324 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_326 = NL;
  protected final String TEXT_327 = NL + "\t\tString gploadCtrlFile = ";
  protected final String TEXT_328 = ";" + NL + "\t\t";
  protected final String TEXT_329 = NL + "\t\tString gploadCtrlFile = \"gp_ctrl_\" + \"";
  protected final String TEXT_330 = "\" + pid + Thread.currentThread().getId() + \".txt\";" + NL + "" + NL + "\t\tString delim_";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = ";" + NL + "\t\tString escape_";
  protected final String TEXT_333 = " = ";
  protected final String TEXT_334 = ";" + NL + "\t\tString quote_";
  protected final String TEXT_335 = " = ";
  protected final String TEXT_336 = ";" + NL + "\t\tdelim_";
  protected final String TEXT_337 = " = \"\\t\".equals(delim_";
  protected final String TEXT_338 = ") ? \"\\\\t\" : delim_";
  protected final String TEXT_339 = ";" + NL + "\t\t" + NL + "\t\ttry (java.io.PrintWriter gpctrl_";
  protected final String TEXT_340 = " = new java.io.PrintWriter(new java.io.FileOutputStream(gploadCtrlFile, false), true)){" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_341 = ".println(\"---\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_342 = ".println(\"VERSION: 1.0.0.1\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_343 = ".println(\"DATABASE: \" + ";
  protected final String TEXT_344 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_345 = ".println(\"USER: \" + ";
  protected final String TEXT_346 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_347 = ".println(\"HOST: \" + ";
  protected final String TEXT_348 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_349 = ".println(\"PORT: \" + ";
  protected final String TEXT_350 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_351 = ".println(\"GPLOAD:\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_352 = ".println(\"  INPUT:\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_353 = ".println(\"    - SOURCE:\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_355 = ".println(\"        LOCAL_HOSTNAME:\");" + NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_356 = ".println(\"          - \" + ";
  protected final String TEXT_357 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_358 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_359 = ".println(\"        PORT: \" + ";
  protected final String TEXT_360 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_362 = ".println(\"        PORT_RANGE: [\" + ";
  protected final String TEXT_363 = " + \"]\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_365 = ".println(\"        SSL: \" + ";
  protected final String TEXT_366 = " );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_367 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_368 = ".println(\"        CERTIFICATES_PATH: \" + ";
  protected final String TEXT_369 = " );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_370 = NL + "\t\t\t" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_371 = ".println(\"        FILE:\");" + NL + "\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_373 = ".println(\"          - \" + (new com.infobright.io.NamedPipeFactory()).getNativePipeName(";
  protected final String TEXT_374 = "));" + NL + "\t\t\t";
  protected final String TEXT_375 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_376 = ".println(\"          - \" + ";
  protected final String TEXT_377 = ");" + NL + "\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_379 = ".println(\"    - DELIMITER: '\" + delim_";
  protected final String TEXT_380 = " + \"'\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_381 = ".println(\"    - ESCAPE: '\" + escape_";
  protected final String TEXT_382 = " + \"'\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_384 = ".println(\"    - NULL_AS: '\" + ";
  protected final String TEXT_385 = " + \"'\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_387 = ".println(\"    - FORCE_NOT_NULL: \" + ";
  protected final String TEXT_388 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_389 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_390 = ".println(\"    - ERROR_LIMIT: \" + ";
  protected final String TEXT_391 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_393 = ".println(\"    - ERROR_TABLE: '\" + ";
  protected final String TEXT_394 = " + \"'\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_397 = ".println(\"    - FORMAT: csv\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_398 = ".println(\"    - QUOTE: '\" + quote_";
  protected final String TEXT_399 = " + \"'\");" + NL + "\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_401 = ".println(\"    - FORMAT: text\");" + NL + "\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t";
  protected final String TEXT_403 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_404 = ".println(\"    - HEADER: true\");" + NL + "\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_406 = ".println(\"    - ENCODING: \" + ";
  protected final String TEXT_407 = ");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_408 = ".println(\"  OUTPUT: \");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_409 = ".println(\"    - TABLE: '\" + tableName4Load_";
  protected final String TEXT_410 = "+\"'\");" + NL + "\t\t\tgpctrl_";
  protected final String TEXT_411 = ".println(\"    - MODE: ";
  protected final String TEXT_412 = "\");" + NL + "\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_414 = ".println(\"    - MATCH_COLUMNS:\");" + NL + "\t\t\t\t";
  protected final String TEXT_415 = NL + "\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_416 = ".println(\"      - ";
  protected final String TEXT_417 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_418 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_419 = ".println(\"    - UPDATE_COLUMNS:\");" + NL + "\t\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\t\t\tgpctrl_";
  protected final String TEXT_421 = ".println(\"      - ";
  protected final String TEXT_422 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_424 = ".println(\"    - UPDATE_CONDITION: \" + ";
  protected final String TEXT_425 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_427 = NL;
  protected final String TEXT_428 = NL + NL + "\tfinal StringBuilder gploadOutput_";
  protected final String TEXT_429 = " = new StringBuilder(200);" + NL + "\tThread gploadThread_";
  protected final String TEXT_430 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] cmds = new String[] {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_432 = "," + NL + "\t\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_434 = NL + "\t\t\t\t\t\t, \"-f\", gploadCtrlFile" + NL + "\t\t\t\t";
  protected final String TEXT_435 = ",";
  protected final String TEXT_436 = NL + "\t\t\t\t};" + NL + "\t\t\t\tfinal Process ps = Runtime.getRuntime().exec(cmds);" + NL + "\t\t\t\t" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tgploadOutput_";
  protected final String TEXT_437 = ".append(line);" + NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_438 = "_GPLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL;
  protected final String TEXT_439 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_440 = " = new StringBuffer(";
  protected final String TEXT_441 = ");" + NL + "\t\t";
  protected final String TEXT_442 = NL + "\t\t\tcommand_";
  protected final String TEXT_443 = ".append(";
  protected final String TEXT_444 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_445 = NL + "\t";
  protected final String TEXT_446 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_447 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_448 = ", true, true, 1024000, 10000);" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_449 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by gpload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_450 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_451 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_452 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_453 = NL + "\t\t";
  protected final String TEXT_454 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_455 = " - Executing '\"+command_";
  protected final String TEXT_456 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_457 = NL + "\tgploadThread_";
  protected final String TEXT_458 = ".start();" + NL + "\tgploadThread_";
  protected final String TEXT_459 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_460 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_461 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_462 = "_NB_LINE\", insertedCount_";
  protected final String TEXT_463 = ");" + NL + "\t\t";
  protected final String TEXT_464 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_465 = " - Execute '\"+command_";
  protected final String TEXT_466 = ".toString()+\"' has finished.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_467 = " - Loaded records count:\" + insertedCount_";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(pythonPathForCMD);
    stringBuffer.append(TEXT_432);
    }
    stringBuffer.append(TEXT_433);
    stringBuffer.append(gpLoadPathForCMD);
