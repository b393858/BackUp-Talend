...
public class TRedshiftRowFinallyJava
{
  protected static String nl;
  public static synchronized TRedshiftRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftRowFinallyJava result = new TRedshiftRowFinallyJava();
    nl = null;
    return result;
  }
