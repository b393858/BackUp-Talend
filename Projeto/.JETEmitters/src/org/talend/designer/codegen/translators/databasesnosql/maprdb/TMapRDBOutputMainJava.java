...
public class TMapRDBOutputMainJava
{
  protected static String nl;
  public static synchronized TMapRDBOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapRDBOutputMainJava result = new TMapRDBOutputMainJava();
    nl = null;
    return result;
  }
