...
public class TPigDistinctMainJava
{
  ...
  protected final String TEXT_51 = NL + "        \tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> s3Objects_";
  protected final String TEXT_52 = " = s3Client_";
  protected final String TEXT_53 = ".listObjectsV2(";
  protected final String TEXT_54 = ").getObjectSummaries();" + NL + "        \tjava.util.Set<String> s3Keys_";
  protected final String TEXT_55 = " = s3Objects_";
  protected final String TEXT_56 = ".stream().map(obj -> obj.getKey()).collect(java.util.stream.Collectors.toSet());";
  protected final String TEXT_57 = NL + NL + "\t\tfor(String[] pigLatin_";
  ...
  protected final String TEXT_71 = NL + "\t\t\t\t\tstatements_";
  protected final String TEXT_72 = ".append(pigLatin_";
  protected final String TEXT_73 = "[1]);" + NL + "\t\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_75 = ".registerQuery(pigLatin_";
  protected final String TEXT_76 = "[1]);";
  protected final String TEXT_77 = NL + "\t\t\t} else if (\"jar\".equals(type_";
  protected final String TEXT_78 = ")) {";
  protected final String TEXT_79 = NL + "\t\t\t\t\tbw_";
  protected final String TEXT_80 = ".write(\"REGISTER \" + wasbPath_";
  protected final String TEXT_81 = " + new java.io.File(pigLatin_";
  protected final String TEXT_82 = "[1]).getName() + \";\");" + NL + "\t\t\t\t\tlibjars_";
  protected final String TEXT_83 = ".append(pigLatin_";
  protected final String TEXT_84 = "[1] + \",\");";
  protected final String TEXT_85 = NL + "\t\t\t\t\tString jarName_";
  protected final String TEXT_86 = " = new String();" + NL + "\t\t\t\t\tString[] pathSplit = pigLatin_";
  protected final String TEXT_87 = "[1].split(\"/\");" + NL + "            \t\tjarName_";
  protected final String TEXT_88 = " = pathSplit[pathSplit.length - 1];" + NL + "            \t\tjava.util.regex.Pattern jarPattern = java.util.regex.Pattern.compile(\".*\\\\.jar\");" + NL + "\t\t\t\t\tif (!jarPattern.matcher(jarName_";
  protected final String TEXT_89 = ").matches()) {" + NL + "            \t\t\tthrow new IllegalArgumentException(\"";
  protected final String TEXT_90 = " - Incorrect jar path: \" + pigLatin_";
  protected final String TEXT_91 = "[1]);" + NL + "        \t\t\t}" + NL + "        \t\t\tboolean exist = s3Keys_";
  protected final String TEXT_92 = ".contains(";
  protected final String TEXT_93 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_94 = ");" + NL + "        \t\t\tif (!exist) {" + NL + "\t\t\t\t\t\ts3Client_";
  protected final String TEXT_95 = ".putObject(";
  protected final String TEXT_96 = ", ";
  protected final String TEXT_97 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_98 = ", new java.io.File(pigLatin_";
  protected final String TEXT_99 = "[1]));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tstatements_";
  protected final String TEXT_100 = ".append(\"REGISTER s3a://\" + ";
  ...
  protected final String TEXT_107 = " - upload jar to S3: \" + pigLatin_";
  protected final String TEXT_108 = "[1] + \" --> s3a://\" + ";
  protected final String TEXT_109 = " + \"/\" + ";
  protected final String TEXT_110 = ".replaceAll(\"^/+|/+$\", \"\") + \"/\" + jarName_";
  protected final String TEXT_111 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_113 = ".registerJar(pigLatin_";
  protected final String TEXT_114 = "[1]);";
  protected final String TEXT_115 = NL + "\t\t\t} else if (\"script\".equals(type_";
  protected final String TEXT_116 = ")) {";
  protected final String TEXT_117 = NL + "\t\t\t\t\t\tbw_";
  protected final String TEXT_118 = ".write(pigLatin_";
  protected final String TEXT_119 = "[1]);";
  protected final String TEXT_120 = NL + "\t\t\t\t\t\t// Script is not supported on qubole.";
  protected final String TEXT_121 = NL + "\t\t\t\t\t\tpigServer_";
  protected final String TEXT_122 = ".registerScript(new java.io.ByteArrayInputStream(pigLatin_";
  protected final String TEXT_123 = "[1].getBytes()));";
  protected final String TEXT_124 = NL + "\t\t\t} else if (\"function\".equals(type_";
  protected final String TEXT_125 = ")) {";
  protected final String TEXT_126 = NL + "\t\t\t\t\tbw_";
  protected final String TEXT_127 = ".write(\"DEFINE \" + pigLatin_";
  protected final String TEXT_128 = "[1] + \" \" + pigLatin_";
  protected final String TEXT_129 = "[2] + \";\");";
  protected final String TEXT_130 = NL + "\t\t\t\t\t\t// DEFINE is not supported on qubole.";
  protected final String TEXT_131 = NL + "\t\t\t\t\tpigServer_";
  protected final String TEXT_132 = ".registerFunction(pigLatin_";
  protected final String TEXT_133 = "[1], new org.apache.pig.FuncSpec(pigLatin_";
  protected final String TEXT_134 = "[2]));";
  protected final String TEXT_135 = NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_136 = NL + "    \tpigScript_";
  protected final String TEXT_137 = ".addAll(pigLatins_";
  protected final String TEXT_138 = ");";
  protected final String TEXT_139 = NL + "\tpigLatins_";
