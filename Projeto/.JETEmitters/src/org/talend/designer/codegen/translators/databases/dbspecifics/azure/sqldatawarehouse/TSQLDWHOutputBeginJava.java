...
public class TSQLDWHOutputBeginJava {
  protected static String nl;
  public static synchronized TSQLDWHOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHOutputBeginJava result = new TSQLDWHOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_82 = NL + "\tdbschema_";
  ...
  protected final String TEXT_89 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_90 = " = ";
  protected final String TEXT_91 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_92 = ".get(dsAlias_";
  protected final String TEXT_93 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_94 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_95 = " = dataSources_";
  protected final String TEXT_96 = ".get(dsAlias_";
  protected final String TEXT_97 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_98 = NL + "    dbschema_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = ";";
  protected final String TEXT_101 = NL + "    String driverClass_";
  protected final String TEXT_102 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_103 = NL + "    String driverClass_";
  protected final String TEXT_104 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  ...
  protected final String TEXT_112 = NL + "    String url_";
  protected final String TEXT_113 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_114 = " ;";
  protected final String TEXT_115 = NL + "    String url_";
  protected final String TEXT_116 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_117 = " ;";
  protected final String TEXT_118 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_119 = ")) {" + NL + "    \turl_";
  protected final String TEXT_120 = " += \":\" + ";
  protected final String TEXT_121 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_122 = ")) {";
  protected final String TEXT_123 = NL + "\t\t\t\turl_";
  protected final String TEXT_124 = " += \"//\" + ";
  protected final String TEXT_125 = "; " + NL + "\t";
  protected final String TEXT_126 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_127 = " += \";databaseName=\" + ";
  protected final String TEXT_128 = "; " + NL + "\t";
  protected final String TEXT_129 = NL + "    }" + NL + "    url_";
  protected final String TEXT_130 = " += \";applicationName=Talend;\" + ";
  protected final String TEXT_131 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_151 = NL + "   int batchSize_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_154 = "=0;";
  protected final String TEXT_155 = NL + NL + "if(dbschema_";
  protected final String TEXT_156 = " == null || dbschema_";
  protected final String TEXT_157 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_158 = " = ";
  protected final String TEXT_159 = ";" + NL + "} else {" + NL + "    tableName_";
  ...
  protected final String TEXT_165 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_169 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_177 = ".commit();";
  protected final String TEXT_178 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_217 = NL + "                    String keyCheckTable_";
  protected final String TEXT_218 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_219 = "+\"][\"+";
  protected final String TEXT_220 = "+\"][\"+";
  protected final String TEXT_221 = "+\"][\"+";
  protected final String TEXT_222 = "+\"][\"+";
  protected final String TEXT_223 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_224 = " + \"]\";";
  protected final String TEXT_225 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_228 = " + \"]\";";
  protected final String TEXT_229 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_230 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_231 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_232 = ")== null){//}";
  protected final String TEXT_233 = NL + "                                boolean whetherExist_";
  protected final String TEXT_234 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_237 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_238 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_239 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_240 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_241 = NL + "                                ";
  protected final String TEXT_242 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_245 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_246 = " = tableNameForSearch_";
  protected final String TEXT_247 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_248 = " = tableNameForSearch_";
  protected final String TEXT_249 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_250 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_251 = " = dbMetaData_";
  protected final String TEXT_252 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_256 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_262 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_271 = ")" + NL + "                                            && (schema_";
  ...
  protected final String TEXT_275 = ") || dbschema_";
  protected final String TEXT_276 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  ...
  protected final String TEXT_280 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_281 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_282 = " = dbMetaData_";
  protected final String TEXT_283 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_299 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_300 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_301 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_302 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_303 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_304 = " = conn_";
  protected final String TEXT_305 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_306 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_307 = " = dbMetaData_";
  protected final String TEXT_308 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_309 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_310 = " == null || dbschema_";
  protected final String TEXT_311 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_312 = " = conn_";
  protected final String TEXT_313 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_314 = " = stmtSchema_";
  protected final String TEXT_315 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_316 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_317 = " = rsSchema_";
  protected final String TEXT_318 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_338 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_339 = NL + "                                String tableForSearch_";
  protected final String TEXT_340 = " = ";
  protected final String TEXT_341 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_342 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_343 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_344 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_345 = " =  tableForSearch_";
  protected final String TEXT_346 = ".substring(1,tableForSearch_";
  protected final String TEXT_347 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_348 = " =  tableForSearch_";
  protected final String TEXT_349 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_350 = " = conn_";
  protected final String TEXT_351 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_352 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_356 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_357 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_358 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_359 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_364 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_365 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_366 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_367 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_368 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_369 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_375 = ".getTables(";
  protected final String TEXT_376 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_377 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_378 = " = rsTable_";
  protected final String TEXT_379 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_380 = ".equalsIgnoreCase(";
  protected final String TEXT_381 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_382 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_388 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_389 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_390 = " = rsTable_";
  protected final String TEXT_391 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_392 = ".equalsIgnoreCase(";
  protected final String TEXT_393 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_394 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_395 = NL + "                                if(!whetherExist_";
  protected final String TEXT_396 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_416 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_422 = NL + "                                        stmtDrop_";
  ...
  protected final String TEXT_429 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_450 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_460 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_461 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_467 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_468 = " = stmtTruncCount_";
  protected final String TEXT_469 = ".executeQuery(\"";
  protected final String TEXT_470 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_471 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_472 = " = rsTruncCount_";
  protected final String TEXT_473 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_477 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_478 = "));";
  protected final String TEXT_479 = NL + "                conn_";
  protected final String TEXT_480 = ".commit();";
  protected final String TEXT_481 = NL + "                stmtTrunc_";
  protected final String TEXT_482 = ".executeUpdate(\"";
  protected final String TEXT_483 = "\");";
  protected final String TEXT_484 = NL + "                    if(!conn_";
  protected final String TEXT_485 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_486 = ".commit();" + NL + "                    }";
  protected final String TEXT_487 = NL + "                deletedCount_";
  protected final String TEXT_488 = " += rsTruncCountNumber_";
  protected final String TEXT_489 = ";" + NL + "            }";
  protected final String TEXT_490 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_491 = " = conn_";
  protected final String TEXT_492 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_493 = " = stmtTruncCount_";
  protected final String TEXT_494 = ".executeQuery(\"";
  protected final String TEXT_495 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_496 = " = conn_";
  protected final String TEXT_497 = ".createStatement()) {";
  ...
  protected final String TEXT_503 = NL + "                while(rsTruncCount_";
  protected final String TEXT_504 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_505 = " += rsTruncCount_";
  protected final String TEXT_506 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_507 = NL + "\t\tresourceMap.put(\"conn_";
  protected final String TEXT_508 = "\", conn_";
  protected final String TEXT_509 = ");" + NL + "\t";
  protected final String TEXT_510 = NL + "        conn_";
  protected final String TEXT_511 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_512 = " = ";
  protected final String TEXT_513 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_514 = " = 0;" + NL;
  ...
  protected final String TEXT_523 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_524 = "\", pstmt_";
  protected final String TEXT_525 = ");";
  protected final String TEXT_526 = NL;
  protected final String TEXT_527 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_528 = " = null;" + NL + "\t\tString keyPsmt_";
  protected final String TEXT_529 = " = conn_";
  protected final String TEXT_530 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_531 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_532 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_533 = ",insert_";
  protected final String TEXT_534 = ",keyPsmt_";
  protected final String TEXT_535 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_536 = "\", pstmt_";
  protected final String TEXT_537 = ");";
  protected final String TEXT_538 = NL + "        String update_";
  protected final String TEXT_539 = " = \"UPDATE [\" + tableName_";
  ...
  protected final String TEXT_544 = ".prepareStatement(update_";
  protected final String TEXT_545 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_552 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_558 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_559 = " = conn_";
  protected final String TEXT_560 = ".prepareStatement(insert_";
  protected final String TEXT_561 = ");" + NL + "        resourceMap.put(\"insert_";
  protected final String TEXT_562 = "\", insert_";
  ...
  protected final String TEXT_567 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_568 = " = conn_";
  protected final String TEXT_569 = ".prepareStatement(update_";
  protected final String TEXT_570 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_571 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_577 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_578 = " = conn_";
  protected final String TEXT_579 = ".prepareStatement(update_";
  protected final String TEXT_580 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_581 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_589 = ");" + NL + "        resourceMap.put(\"insert_";
  protected final String TEXT_590 = "\", insert_";
  protected final String TEXT_591 = ");";
  protected final String TEXT_592 = NL + "        String delete_";
  protected final String TEXT_593 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_594 = " + \"] WHERE ";
  protected final String TEXT_595 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_596 = " = conn_";
  protected final String TEXT_597 = ".prepareStatement(delete_";
  protected final String TEXT_598 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_599 = "\", pstmt_";
  protected final String TEXT_600 = ");";
  protected final String TEXT_601 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_602 = " = conn_";
  protected final String TEXT_603 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_604 = " + \"] WHERE ";
  protected final String TEXT_605 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_614 = ");" + NL + "        resourceMap.put(\"insert_";
  protected final String TEXT_615 = "\", insert_";
  protected final String TEXT_616 = ");";
  protected final String TEXT_617 = NL + NL + "    class BufferLine_";
  protected final String TEXT_618 = " {";
  protected final String TEXT_619 = NL + "                ";
  protected final String TEXT_620 = " ";
  protected final String TEXT_621 = ";";
  protected final String TEXT_622 = NL + NL + "        public BufferLine_";
  protected final String TEXT_623 = "(";
  protected final String TEXT_624 = NL + "                    ,";
  protected final String TEXT_625 = NL + "                ";
  protected final String TEXT_626 = " ";
  protected final String TEXT_627 = NL + "        ){";
  protected final String TEXT_628 = NL + "                    this.";
  protected final String TEXT_629 = " = ";
  protected final String TEXT_630 = ";";
  protected final String TEXT_631 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_632 = "> sInsertColValueList";
  protected final String TEXT_633 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_634 = " sInsertColValue";
  protected final String TEXT_635 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_636 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_637 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_638 = ".append(\"(";
  protected final String TEXT_639 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_640 = "-1) extendInsertValueStmt_";
  protected final String TEXT_641 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_642 = " = \"INSERT INTO \"+";
  protected final String TEXT_643 = "+\" (";
  protected final String TEXT_644 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_645 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_646 = " =  conn_";
  protected final String TEXT_647 = ".prepareStatement(insert_";
  protected final String TEXT_648 = ");" + NL + "\tresourceMap.put(\"pstmt_";
  protected final String TEXT_649 = "\", pstmt_";
  ...
  protected final String TEXT_661 = NL + "\t\t\tupdate_";
  protected final String TEXT_662 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_663 = " = update_";
  protected final String TEXT_664 = ".split(\"\\\\?\");";
  protected final String TEXT_665 = NL + "\t\t\tupdate_";
  protected final String TEXT_666 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_667 = " = update_";
  protected final String TEXT_668 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_669 = " = insert_";
  protected final String TEXT_670 = ".split(\"\\\\?\");";
  protected final String TEXT_671 = NL + "\t\t\tdelete_";
  protected final String TEXT_672 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_673 = " = delete_";
  protected final String TEXT_674 = ".split(\"\\\\?\");";
  protected final String TEXT_675 = NL + "\t\t\treplace_";
  protected final String TEXT_676 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_677 = " = replace_";
  protected final String TEXT_678 = ".split(\"\\\\?\");";
  protected final String TEXT_679 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_680 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_681 = " = insertIgnore_";
  protected final String TEXT_682 = ".split(\"\\\\?\");";
  protected final String TEXT_683 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_684 = " = insert_";
  protected final String TEXT_685 = ".split(\"\\\\?\");";
  protected final String TEXT_686 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_687 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_688 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_689 = "\") == true;";
  protected final String TEXT_690 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_691 = " = conn_";
  protected final String TEXT_692 = ".createStatement();";
  protected final String TEXT_693 = NL + "            if ( !isShareIdentity_";
  protected final String TEXT_694 = " ) {" + NL + "                stmt_";
  protected final String TEXT_695 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_696 = " +\"] ON\");" + NL + "            }";
  protected final String TEXT_697 = NL + "            stmt_";
  protected final String TEXT_698 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_699 = " +\"] ON\");";
  protected final String TEXT_700 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_701 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_702 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_703 = " =null;" + NL + "\t";
  protected final String TEXT_704 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_705 = " = null;" + NL + "\t\t";
  protected final String TEXT_706 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_707 = " = null;";
  protected final String TEXT_708 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_709 = " =  null;";
  protected final String TEXT_710 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_711 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_712 = " = null;";
  protected final String TEXT_713 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_714 = " = null;";
  protected final String TEXT_715 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_716 = " = null;";
  protected final String TEXT_717 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_718 = " = null;";
  protected final String TEXT_719 = NL + "\t\t \tString[] insertSQLSplits_";
