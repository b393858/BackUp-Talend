...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_474 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_545 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_550 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_551 = " = insert_";
  protected final String TEXT_552 = ".split(\"\\\\?\");";
  protected final String TEXT_553 = NL + "\t\t\tupdate_";
  protected final String TEXT_554 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_555 = " = update_";
  protected final String TEXT_556 = ".split(\"\\\\?\");";
  protected final String TEXT_557 = NL + "\t\t\tupdate_";
  protected final String TEXT_558 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_559 = " = update_";
  protected final String TEXT_560 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_561 = " = insert_";
  protected final String TEXT_562 = ".split(\"\\\\?\");";
  protected final String TEXT_563 = NL + "\t\t\tdelete_";
  protected final String TEXT_564 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_565 = " = delete_";
  protected final String TEXT_566 = ".split(\"\\\\?\");";
  protected final String TEXT_567 = NL + "\t\t\treplace_";
  protected final String TEXT_568 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_569 = " = replace_";
  protected final String TEXT_570 = ".split(\"\\\\?\");";
  protected final String TEXT_571 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_572 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_573 = " = insertIgnore_";
  protected final String TEXT_574 = ".split(\"\\\\?\");";
  protected final String TEXT_575 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_576 = " = insert_";
  protected final String TEXT_577 = ".split(\"\\\\?\");";
  protected final String TEXT_578 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_579 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_580 = " = buffersSize_";
  protected final String TEXT_581 = ";";
  protected final String TEXT_582 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_583 = " = buffersSize_";
  ...
  protected final String TEXT_589 = NL + "                        query_";
  protected final String TEXT_590 = " = ";
  protected final String TEXT_591 = ";";
  protected final String TEXT_592 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_593 = ",";
  protected final String TEXT_594 = ".";
  protected final String TEXT_595 = ", ";
  protected final String TEXT_596 = ",insertSQLSplits_";
  protected final String TEXT_597 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_598 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_610 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_611 = "++;";
  protected final String TEXT_612 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_613 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_614 = " = insertedCount_";
  protected final String TEXT_615 = " + pstmt_";
  protected final String TEXT_616 = ".executeUpdate();";
  protected final String TEXT_617 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_628 = NL + "                        rejectedCount_";
  protected final String TEXT_629 = " = rejectedCount_";
  protected final String TEXT_630 = " + 1;";
  protected final String TEXT_631 = NL + "                        ";
  protected final String TEXT_632 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_679 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_680 = "++;";
  protected final String TEXT_681 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_682 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_683 = " = updatedCount_";
  protected final String TEXT_684 = " + pstmt_";
  protected final String TEXT_685 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_686 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_687 = " = true;";
  protected final String TEXT_688 = NL + "                    throw(e);";
  protected final String TEXT_689 = NL + "                        ";
  protected final String TEXT_690 = " = new ";
  protected final String TEXT_691 = "Struct();";
  protected final String TEXT_692 = NL + "                            ";
  protected final String TEXT_693 = ".";
  protected final String TEXT_694 = " = ";
  protected final String TEXT_695 = ".";
  protected final String TEXT_696 = ";";
  protected final String TEXT_697 = NL + "                        rejectedCount_";
  protected final String TEXT_698 = " = rejectedCount_";
  protected final String TEXT_699 = " + 1;";
  protected final String TEXT_700 = NL + "                        ";
  protected final String TEXT_701 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_710 = NL + "            int checkCount_";
  protected final String TEXT_711 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_712 = " = pstmt_";
  protected final String TEXT_713 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_714 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_715 = " = rs_";
  protected final String TEXT_716 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_717 = " > 0) {";
  protected final String TEXT_718 = NL + "                        ";
  protected final String TEXT_719 = NL + "                            query_";
  protected final String TEXT_720 = " = ";
  protected final String TEXT_721 = ";";
  protected final String TEXT_722 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_723 = ",";
  protected final String TEXT_724 = ".";
  protected final String TEXT_725 = ", ";
  protected final String TEXT_726 = ",updateSQLSplits_";
  protected final String TEXT_727 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_728 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_729 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_752 = NL + "                    globalMap.put(\"";
  protected final String TEXT_753 = "_QUERY\", query_";
  protected final String TEXT_754 = ".toString().trim());";
  protected final String TEXT_755 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_756 = " = updatedCount_";
  protected final String TEXT_757 = " + pstmtUpdate_";
  protected final String TEXT_758 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_759 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_760 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_761 = " = true;";
  protected final String TEXT_762 = NL + "                        throw(e);";
  protected final String TEXT_763 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_773 = NL + "                            rejectedCount_";
  protected final String TEXT_774 = " = rejectedCount_";
  protected final String TEXT_775 = " + 1;";
  protected final String TEXT_776 = NL + "                            ";
  protected final String TEXT_777 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_778 = NL + "                            ";
  protected final String TEXT_779 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_780 = ";";
  protected final String TEXT_781 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_782 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_783 = NL + "                        ";
  protected final String TEXT_784 = NL + "                            query_";
  protected final String TEXT_785 = " = ";
  protected final String TEXT_786 = ";";
  protected final String TEXT_787 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_788 = ",";
  protected final String TEXT_789 = ".";
  protected final String TEXT_790 = ", ";
  protected final String TEXT_791 = ",insertSQLSplits_";
  protected final String TEXT_792 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_793 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_799 = NL + "                    globalMap.put(\"";
  protected final String TEXT_800 = "_QUERY\", query_";
  protected final String TEXT_801 = ".toString().trim());";
  protected final String TEXT_802 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_803 = " = insertedCount_";
  protected final String TEXT_804 = " + pstmtInsert_";
  protected final String TEXT_805 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_806 = "++;";
  protected final String TEXT_807 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_808 = " = true;";
  protected final String TEXT_809 = NL + "                        throw(e);";
  ...
  protected final String TEXT_824 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_825 = NL + "                            ";
  protected final String TEXT_826 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_827 = ";";
  protected final String TEXT_828 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_829 = NL + "                }" + NL + "            }";
  protected final String TEXT_830 = NL + "            int updateFlag_";
  protected final String TEXT_831 = "=0;";
  protected final String TEXT_832 = NL + "                    ";
  protected final String TEXT_833 = NL + "                        query_";
  protected final String TEXT_834 = " = ";
  protected final String TEXT_835 = ";";
  protected final String TEXT_836 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_837 = ",";
  protected final String TEXT_838 = ".";
  protected final String TEXT_839 = ", ";
  protected final String TEXT_840 = ",updateSQLSplits_";
  protected final String TEXT_841 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_842 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_843 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_844 = ".";
  protected final String TEXT_845 = ", pstmtUpdate_";
  ...
  protected final String TEXT_870 = NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_876 = " == 0) {" + NL + "            \t";
  protected final String TEXT_877 = NL + "\t\t\t\tquery_";
  protected final String TEXT_878 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_905 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_906 = " = true;";
  protected final String TEXT_907 = NL + "                        throw(e);";
  protected final String TEXT_908 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_922 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_923 = NL + "                            ";
  protected final String TEXT_924 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_925 = ";";
  protected final String TEXT_926 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_941 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_942 = ".addBatch();" + NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_943 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_944 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_945 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_946 = " = deletedCount_";
  protected final String TEXT_947 = " + pstmt_";
  protected final String TEXT_948 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_949 = "++;";
  protected final String TEXT_950 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_967 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_968 = NL + "                        ";
  protected final String TEXT_969 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_970 = ";";
  protected final String TEXT_971 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_972 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_973 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_985 = " > 0) && (batchSize_";
  protected final String TEXT_986 = " <= batchSizeCounter_";
  protected final String TEXT_987 = ")) {" + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_988 = " = 0;" + NL + "\t\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_992 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1006 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1007 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1008 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1009 = NL + "                \t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1010 = NL + "            commitCounter_";
  protected final String TEXT_1011 = "++;" + NL + "" + NL + "            if(commitEvery_";
  protected final String TEXT_1012 = "<=commitCounter_";
  protected final String TEXT_1013 = ") {" + NL + "            \t";
  protected final String TEXT_1014 = NL + "                conn_";
  protected final String TEXT_1015 = ".commit();";
  protected final String TEXT_1016 = NL + "                commitCounter_";
  protected final String TEXT_1017 = " = 0;" + NL + "" + NL + "            }" + NL;
