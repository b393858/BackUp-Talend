package org.talend.designer.codegen.translators.databases.dbspecifics.netezza;
...
public class TNetezzaNzLoadBeginJava {
  ...
  protected final String TEXT_88 = " = \"org.netezza.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_89 = ");" + NL + "\t\tString url_";
  protected final String TEXT_90 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_105 = ";" + NL + "\t        \t\t" + NL + "\t\tString tableName_";
  ...
  protected final String TEXT_115 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_121 = " - Drop table '\" + tableName_";
  protected final String TEXT_122 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_123 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_124 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_125 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_129 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_135 = " - Create table '\" + tableName_";
  protected final String TEXT_136 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_138 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_139 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure on DROP_CREATE action, process terminated.\");" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_140 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_141 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_145 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_151 = " - Create table '\" + tableName_";
  protected final String TEXT_152 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_154 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_155 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName_";
  protected final String TEXT_156 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_157 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_158 = " - Table '\" + tableName_";
  protected final String TEXT_159 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_169 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\tif(table_";
  protected final String TEXT_170 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_175 = " = null;" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".createStatement();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_178 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_179 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_188 = ".close();" + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_189 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_190 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_192 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_193 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_195 = NL + "                if(whetherExist_";
  protected final String TEXT_196 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_197 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_201 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_207 = " - Drop table '\" + tableName_";
  protected final String TEXT_208 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\t\t\t\tstmtDrop_";
  protected final String TEXT_210 = ".close();" + NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_211 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName_";
  protected final String TEXT_212 = "  + \"'. process terminated.\");" + NL + "                    \t" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_214 = " - Failure to drop table '\" + tableName_";
  protected final String TEXT_215 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_217 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_220 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_221 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_227 = " - Drop table '\" + tableName_";
  protected final String TEXT_228 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_229 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_230 = ".close();" + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_231 = "){" + NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_232 = "  + \"'. process terminated.\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_233 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_234 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_235 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_237 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_238 = " = conn_";
  protected final String TEXT_239 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_240 = " = stmtClearCount_";
  protected final String TEXT_241 = ".executeQuery(\"";
  ...
  protected final String TEXT_246 = " - Truncating table '\" + tableName_";
  protected final String TEXT_247 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_248 = NL + "            stmtClear_";
  protected final String TEXT_249 = ".executeUpdate(\"";
  protected final String TEXT_250 = "\");" + NL + "\t\t\t";
  protected final String TEXT_251 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_252 = " - Truncate table '\" + tableName_";
  protected final String TEXT_253 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_254 = NL + "            while(rsClearCount_";
  protected final String TEXT_255 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_256 = " = rsClearCount_";
  protected final String TEXT_257 = ".getInt(1);" + NL + "            }" + NL + "            stmtClearCount_";
  protected final String TEXT_258 = ".close();" + NL + "\t\t\tstmtClear_";
  protected final String TEXT_259 = ".close();";
  protected final String TEXT_260 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_261 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_265 = " - Clearing table '\" + tableName_";
  protected final String TEXT_266 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_267 = NL + "            \tdeletedCount_";
  protected final String TEXT_268 = " = stmtClear_";
  protected final String TEXT_269 = ".executeUpdate(\"";
  protected final String TEXT_270 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_272 = " - Clear table '\" + tableName_";
  protected final String TEXT_273 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_274 = NL + "            \tstmtClear_";
  protected final String TEXT_275 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_276 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName_";
  protected final String TEXT_277 = "  + \"'. process terminated.\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_279 = " - Failure to clear table '\" + tableName_";
  protected final String TEXT_280 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_282 = NL;
  protected final String TEXT_283 = NL + "\tfinal StringBuilder nzloadOutput_";
  protected final String TEXT_284 = " = new StringBuilder(200);" + NL + "\tfinal java.util.concurrent.atomic.AtomicInteger nb_line_";
  protected final String TEXT_285 = " = new java.util.concurrent.atomic.AtomicInteger();" + NL + "\t//final " + NL + "\t";
  protected final String TEXT_286 = NL + "    ";
  protected final String TEXT_287 = " " + NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_288 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_289 = ");";
  protected final String TEXT_290 = NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_291 = " = ";
  protected final String TEXT_292 = "; ";
  protected final String TEXT_293 = NL + "\t" + NL + "\tThread nzloadThread_";
  protected final String TEXT_294 = " = new Thread() {" + NL + "\t\tpublic void run() {";
  protected final String TEXT_295 = NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_296 = " ";
  protected final String TEXT_297 = ",";
  protected final String TEXT_298 = "};" + NL + "\t\t\t\t" + NL + "\t\t\t\t// added \"print command\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t    System.out.println(\"INFO: executing nzload command:\");" + NL + "\t\t\t\t    for( String cmd : cmds ) {" + NL + "\t\t\t\t\t       System.out.print(cmd + \" \");" + NL + "\t\t\t\t\t }" + NL + "\t\t\t\t";
  protected final String TEXT_300 = NL + "\t\t\t\t" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\t" + NL + "\t\t\t\tps.waitFor();" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\t// fixed no showing of error messages" + NL + "\t\t\t\tjava.io.BufferedReader errReader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getErrorStream()));" + NL + "\t\t\t\t" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\tString errLine = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_301 = ".append(line);";
  protected final String TEXT_302 = NL + "\t\t\t\t\t\tlog.info(line);";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\tSystem.out.println(line);";
  protected final String TEXT_304 = NL + "\t\t\t\t}" + NL + "\t\t\t\twhile((errLine = errReader.readLine()) != null) {" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_305 = ".append(errLine);";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\tlog.error(errLine);";
  protected final String TEXT_307 = NL + "\t\t\t\t\t\tSystem.err.println(errLine);";
  protected final String TEXT_308 = NL + "\t\t\t\t}" + NL + "" + NL + "                String tableName_";
  protected final String TEXT_309 = " = ";
  protected final String TEXT_310 = ";" + NL + "                String dbUser_";
  protected final String TEXT_311 = " = ";
  protected final String TEXT_312 = ";" + NL + "                String dbName_";
  protected final String TEXT_313 = " = ";
  protected final String TEXT_314 = ";" + NL + "\t\t\t\tString actualLogFilePath_";
  protected final String TEXT_315 = " = ";
  protected final String TEXT_316 = NL + "\t\t\t\t\t";
  protected final String TEXT_317 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_318 = NL + "\t\t\t\t\ttableName_";
  protected final String TEXT_319 = ".toUpperCase()" + NL + "\t\t\t\t\t+ \".\" + dbUser_";
  protected final String TEXT_320 = ".toUpperCase()" + NL + "\t\t\t\t\t+ \".\" + dbName_";
  protected final String TEXT_321 = ".toUpperCase()" + NL + "\t\t\t\t\t+ \".nzlog\";" + NL + "\t\t\t\t";
  protected final String TEXT_322 = NL + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_323 = ".set(getProcessedRowsCount(actualLogFilePath_";
  protected final String TEXT_324 = "));" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_325 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tprivate int getProcessedRowsCount(String pathToLogFile) {" + NL + "\t\t\tint processedRowsCount = 0;" + NL + "\t\t\ttry (org.apache.commons.io.input.ReversedLinesFileReader reversedLinesFileReader_";
  protected final String TEXT_326 = " = new org.apache.commons.io.input.ReversedLinesFileReader(new java.io.File(pathToLogFile))) {" + NL + "\t\t\t\tString logLine = null;" + NL + "\t\t\t\twhile(null != (logLine = reversedLinesFileReader_";
  protected final String TEXT_327 = ".readLine())) {" + NL + "\t\t\t\t\tif (logLine.contains(\"  number of records read:\")) {" + NL + "\t\t\t\t\t\tprocessedRowsCount = Integer.parseInt(logLine.split(\":\")[1].trim());" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch(IOException e) {";
  protected final String TEXT_328 = NL + "\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_329 = "\");";
  protected final String TEXT_330 = NL + "\t\t\t\t\tSystem.err.println(\"";
  protected final String TEXT_331 = "\");";
  protected final String TEXT_332 = NL + "\t\t\t\treturn 0;" + NL + "\t\t\t}" + NL + "\t\t\treturn processedRowsCount;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t};" + NL + "\t";
  protected final String TEXT_333 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_334 = " = new StringBuffer(";
  protected final String TEXT_335 = ");" + NL + "\t\t";
  protected final String TEXT_336 = NL + "\t\t\tcommand_";
  protected final String TEXT_337 = ".append(";
  protected final String TEXT_338 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_339 = NL + "\t";
  protected final String TEXT_340 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_341 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_342 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_343 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_344 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_345 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_346 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_347 = NL + "\t\t";
  protected final String TEXT_348 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_349 = " - Executing '\"+command_";
  protected final String TEXT_350 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_351 = NL + "\t\tnzloadThread_";
  protected final String TEXT_352 = ".start();" + NL + "\t\tnzloadThread_";
  protected final String TEXT_353 = ".join(0);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_354 = "_NB_LINE\", nb_line_";
  protected final String TEXT_355 = ".get());" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_356 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_357 = ".toString());" + NL + "\t\t";
  protected final String TEXT_358 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_359 = " - Execute '\"+command_";
  protected final String TEXT_360 = ".toString()+\"' has finished.\");" + NL + "\t\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(parametersList.get(parametersList.indexOf("\"-lf\"") + 1));
