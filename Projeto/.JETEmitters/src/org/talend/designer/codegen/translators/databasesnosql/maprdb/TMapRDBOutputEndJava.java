...
public class TMapRDBOutputEndJava
{
  protected static String nl;
  public static synchronized TMapRDBOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapRDBOutputEndJava result = new TMapRDBOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_33 = NL + "\t\t\t\tif (batchPuts_";
  protected final String TEXT_34 = ".size() > 0) {" + NL + "\t\t\t\t\ttable_";
  protected final String TEXT_35 = ".put(batchPuts_";
  protected final String TEXT_36 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_37 = NL + "\t\t\ttable_";
  protected final String TEXT_38 = ".close();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_39 = NL + "\t\tif(conn_";
  protected final String TEXT_40 = "!=null){" + NL + "\t\t\t";
  protected final String TEXT_41 = NL;
  protected final String TEXT_42 = NL + "        org.apache.hadoop.hbase.client.HConnection hConnection_";
  protected final String TEXT_43 = " = org.apache.hadoop.hbase.client.HConnectionManager.getConnection(conn_";
  protected final String TEXT_44 = ");" + NL + "        if ((hConnection_";
  protected final String TEXT_45 = " != null) && (!hConnection_";
  protected final String TEXT_46 = ".isClosed())) {" + NL + "            hConnection_";
  protected final String TEXT_47 = ".close();" + NL + "        }";
  protected final String TEXT_48 = NL + "\t\torg.apache.hadoop.hbase.client.HConnectionManager.deleteConnection(conn_";
  protected final String TEXT_49 = ",true);";
  protected final String TEXT_50 = NL + "\t\t}" + NL + "\t\tresourceMap.put(\"finish_";
