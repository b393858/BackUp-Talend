...
public class TCosmosDBRowFinallyJava
{
  protected static String nl;
  public static synchronized TCosmosDBRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBRowFinallyJava result = new TCosmosDBRowFinallyJava();
    nl = null;
    return result;
  }
