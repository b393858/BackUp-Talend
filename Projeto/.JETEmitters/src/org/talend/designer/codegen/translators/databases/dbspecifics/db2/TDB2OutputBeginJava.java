...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_51 = " = 0;" + NL + "int deletedCount_";
  ...
  protected final String TEXT_65 = NL + NL + NL + "boolean whetherReject_";
  protected final String TEXT_66 = " = false;" + NL + "java.sql.Connection conn_";
  protected final String TEXT_67 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_68 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_74 = "\");" + NL + "    dbUser_";
  ...
  protected final String TEXT_79 = ") {" + NL + "\t\t\tString dsAlias_";
  ...
  protected final String TEXT_87 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_88 = NL + "\t    String url_";
  protected final String TEXT_89 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_99 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\t";
  ...
  protected final String TEXT_112 = ";" + NL + "" + NL + "    dbschema_";
  ...
  protected final String TEXT_134 = NL + "String tableName_";
  protected final String TEXT_135 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_136 = " == null || dbschema_";
  protected final String TEXT_137 = ".trim().length() == 0) {" + NL + "    tableName_";
  ...
  protected final String TEXT_177 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_197 = NL + "                    String keyCheckTable_";
  protected final String TEXT_198 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_205 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_208 = " + \"]\";";
  protected final String TEXT_209 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_210 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_211 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_212 = ")== null){//}";
  protected final String TEXT_213 = NL + "                                boolean whetherExist_";
  protected final String TEXT_214 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_217 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_218 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_219 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_229 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_230 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_231 = " = dbMetaData_";
  protected final String TEXT_232 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_236 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_242 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_256 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_257 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_263 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_285 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_286 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_287 = " = dbMetaData_";
  protected final String TEXT_288 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_289 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_290 = " == null || dbschema_";
  protected final String TEXT_291 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_298 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_313 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_314 = ".equals";
  protected final String TEXT_315 = "IgnoreCase";
  protected final String TEXT_316 = "(schema_";
  protected final String TEXT_317 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_318 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_331 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_332 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_333 = " = dbMetaData_";
  protected final String TEXT_334 = ".getTables(null, conn_";
  protected final String TEXT_335 = ".getSchema(), tableForSearch_";
  protected final String TEXT_336 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_337 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_338 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_339 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_340 = " = conn_";
  protected final String TEXT_341 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_342 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_343 = " = dbMetaData_";
  protected final String TEXT_344 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_345 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_349 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_350 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_351 = " = conn_";
  protected final String TEXT_352 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_353 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_354 = " = dbMetaData_";
  protected final String TEXT_355 = ".getTables(";
  protected final String TEXT_356 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_365 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_366 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_367 = " = dbMetaData_";
  protected final String TEXT_368 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_376 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_384 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = ", \"";
  protected final String TEXT_387 = "\")";
  protected final String TEXT_388 = ".toUpperCase()";
  ...
  protected final String TEXT_396 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_409 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_428 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_429 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_430 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_437 = ".executeUpdate(\"";
  protected final String TEXT_438 = "\");";
  protected final String TEXT_439 = NL + "            }";
  protected final String TEXT_440 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_441 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_442 = " = conn_";
  protected final String TEXT_443 = ".createStatement()) {";
  protected final String TEXT_444 = NL + "                              stmtTruncCount_";
  protected final String TEXT_445 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_446 = "));";
  protected final String TEXT_447 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_448 = " = stmtTruncCount_";
  protected final String TEXT_449 = ".executeQuery(\"";
  protected final String TEXT_450 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_451 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_452 = " = rsTruncCount_";
  protected final String TEXT_453 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_460 = ".commit();";
  protected final String TEXT_461 = NL + "                stmtTrunc_";
  protected final String TEXT_462 = ".executeUpdate(\"";
  protected final String TEXT_463 = "\");";
  protected final String TEXT_464 = NL + "                    if(!conn_";
  protected final String TEXT_465 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_466 = ".commit();" + NL + "                    }";
  protected final String TEXT_467 = NL + "                deletedCount_";
  protected final String TEXT_468 = " += rsTruncCountNumber_";
  protected final String TEXT_469 = ";" + NL + "            }";
  protected final String TEXT_470 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_471 = " = conn_";
  protected final String TEXT_472 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_473 = " = stmtTruncCount_";
  protected final String TEXT_474 = ".executeQuery(\"";
  protected final String TEXT_475 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_476 = " = conn_";
  protected final String TEXT_477 = ".createStatement()) {";
  protected final String TEXT_478 = NL + "                conn_";
  protected final String TEXT_479 = ".commit();";
  protected final String TEXT_480 = NL + "                stmtTrunc_";
  ...
  protected final String TEXT_486 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_494 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_504 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_505 = "\", pstmt_";
  ...
  protected final String TEXT_509 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_510 = " + \"\\\" WHERE ";
  protected final String TEXT_511 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_512 = "\", pstmt_";
  ...
  protected final String TEXT_517 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_518 = " = conn_";
  protected final String TEXT_519 = ".prepareStatement(insert_";
  protected final String TEXT_520 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_521 = "\", pstmtInsert_";
  ...
  protected final String TEXT_529 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_530 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_536 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_537 = " = conn_";
  protected final String TEXT_538 = ".prepareStatement(update_";
  protected final String TEXT_539 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_540 = "\", pstmtUpdate_";
  protected final String TEXT_541 = ");" + NL + "\t    String insert_";
  protected final String TEXT_542 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_543 = " + \"\\\" (";
  protected final String TEXT_544 = ") VALUES (";
  protected final String TEXT_545 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_546 = " = conn_";
  protected final String TEXT_547 = ".prepareStatement(insert_";
  protected final String TEXT_548 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_549 = "\", pstmtInsert_";
  protected final String TEXT_550 = ");" + NL + "\t    ";
  protected final String TEXT_551 = NL + "\t    String delete_";
  protected final String TEXT_552 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_556 = ".prepareStatement(delete_";
  protected final String TEXT_557 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_558 = "\", pstmt_";
  protected final String TEXT_559 = ");" + NL + "\t    ";
  protected final String TEXT_560 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_566 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_567 = " = update_";
  protected final String TEXT_568 = ".split(\"\\\\?\");";
  protected final String TEXT_569 = NL + "\t\t\tupdate_";
  protected final String TEXT_570 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_571 = " = update_";
  protected final String TEXT_572 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_573 = " = insert_";
  protected final String TEXT_574 = ".split(\"\\\\?\");";
  protected final String TEXT_575 = NL + "\t\t\tdelete_";
  protected final String TEXT_576 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_577 = " = delete_";
  protected final String TEXT_578 = ".split(\"\\\\?\");";
  protected final String TEXT_579 = NL + "\t\t\treplace_";
  protected final String TEXT_580 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_581 = " = replace_";
  protected final String TEXT_582 = ".split(\"\\\\?\");";
  protected final String TEXT_583 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_584 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_585 = " = insertIgnore_";
  ...
  protected final String TEXT_591 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_592 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_598 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_599 = " =  null;";
  protected final String TEXT_600 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_601 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_602 = " = null;";
  protected final String TEXT_603 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_604 = " = null;";
  protected final String TEXT_605 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_606 = " = null;";
  protected final String TEXT_607 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_608 = " = null;";
  protected final String TEXT_609 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_610 = " = null;";
  protected final String TEXT_611 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_612 = " {";
  protected final String TEXT_613 = NL + "\t\t\tvoid set";
  protected final String TEXT_614 = "_";
  protected final String TEXT_615 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_616 = "Struct ";
  protected final String TEXT_617 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  protected final String TEXT_618 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_619 = NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_620 = NL + "\t\t\t\tpstmtUpdate_";
  protected final String TEXT_621 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_622 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_623 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_629 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_630 = " setPrepareStatementUtil_";
  protected final String TEXT_631 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_632 = "();" + NL;
  protected final String TEXT_633 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_634 = " {";
  protected final String TEXT_635 = NL + "\t\t\tvoid assign_";
  protected final String TEXT_636 = "_";
  protected final String TEXT_637 = "(final ";
  protected final String TEXT_638 = "Struct ";
  protected final String TEXT_639 = ",final ";
  ...
  protected final String TEXT_647 = NL + "\t\t\t//{" + NL + "\t\t\t}";
  protected final String TEXT_648 = NL + "\t\t//{" + NL + "\t\t}";
  protected final String TEXT_649 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_650 = " dataPropagateUtil_";
  protected final String TEXT_651 = " = new DataPropagateUtil_";
