package org.talend.designer.codegen.translators.databases.dbspecifics.sqlite;
...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:sqlite:\" + \"/\" + ";
  ...
  protected final String TEXT_196 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_197 = ");";
  protected final String TEXT_198 = NL + "    " + NL + "\t";
  protected final String TEXT_199 = NL + "\t\t    int nb_line_";
  protected final String TEXT_200 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_201 = " = null;";
  protected final String TEXT_202 = NL + "\t\t        conn_";
  protected final String TEXT_203 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_204 = "\");";
  protected final String TEXT_205 = NL + "\t\t\t\t";
  protected final String TEXT_206 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_207 = " =  conn_";
  protected final String TEXT_208 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_209 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_210 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_211 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_212 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  ...
  protected final String TEXT_235 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_236 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_237 = " = stmt_";
  protected final String TEXT_238 = ".executeQuery(dbquery_";
  protected final String TEXT_239 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_240 = " = rs_";
  protected final String TEXT_241 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_242 = " = rsmd_";
  protected final String TEXT_243 = ".getColumnCount();" + NL;
  protected final String TEXT_244 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_245 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_246 = ".setDbmsId(\"";
  protected final String TEXT_247 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_248 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_249 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_250 = ".add(\"";
  protected final String TEXT_251 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_252 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_253 = " = ";
  protected final String TEXT_254 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_255 = "; i <= rsmd_";
  protected final String TEXT_256 = ".getColumnCount()-";
  protected final String TEXT_257 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_258 = ".contains(rsmd_";
  protected final String TEXT_259 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_260 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_261 = ".setName(rsmd_";
  protected final String TEXT_262 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_263 = ".setDbName(rsmd_";
  protected final String TEXT_264 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_265 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_266 = "\", rsmd_";
  protected final String TEXT_267 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_268 = ".getPrecision(i), rsmd_";
  protected final String TEXT_269 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_270 = ".setDbType(rsmd_";
  protected final String TEXT_271 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_272 = ".setDbTypeId(rsmd_";
  protected final String TEXT_273 = ".getColumnType(i));";
  protected final String TEXT_274 = NL + "                \tdcm_";
  protected final String TEXT_275 = ".setFormat(";
  protected final String TEXT_276 = ");";
  protected final String TEXT_277 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_278 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_279 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_280 = ".setLength(rsmd_";
  protected final String TEXT_281 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_282 = ".setLength(rsmd_";
  protected final String TEXT_283 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_284 = NL + "\t\t\tdcm_";
  protected final String TEXT_285 = ".setLength(rsmd_";
  protected final String TEXT_286 = ".getPrecision(i));";
  protected final String TEXT_287 = NL + "                \tdcm_";
  protected final String TEXT_288 = ".setPrecision(rsmd_";
  protected final String TEXT_289 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_290 = ".setNullable(rsmd_";
  protected final String TEXT_291 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_293 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_294 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_295 = ".metadatas.add(dcm_";
  protected final String TEXT_296 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_297 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_298 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_299 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_300 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_301 = NL + "\t\t    ";
  protected final String TEXT_302 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_303 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_304 = NL + "\t\t    while (rs_";
  protected final String TEXT_305 = ".next()) {" + NL + "\t\t        nb_line_";
  ...
  protected final String TEXT_311 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_312 = " = ";
  protected final String TEXT_313 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_315 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_316 = " < ";
  protected final String TEXT_317 = "column_index_";
  ...
  protected final String TEXT_327 = " = (List)rs_";
  ...
  protected final String TEXT_374 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_375 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_376 = ".getColumnTypeName(i_";
  protected final String TEXT_377 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_378 = ".add(rs_";
  protected final String TEXT_379 = ".getString(i_";
  protected final String TEXT_380 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_381 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = ", rs_";
  protected final String TEXT_384 = ", fixedColumnCount_";
  protected final String TEXT_385 = ",list_";
  protected final String TEXT_386 = ",";
  protected final String TEXT_387 = ");";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_389 = ".";
  protected final String TEXT_390 = ", rs_";
  protected final String TEXT_391 = ", fixedColumnCount_";
  protected final String TEXT_392 = ",";
  protected final String TEXT_393 = ");";
  protected final String TEXT_394 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = ", rs_";
  protected final String TEXT_397 = ", fixedColumnCount_";
  protected final String TEXT_398 = ",";
  protected final String TEXT_399 = ");";
  protected final String TEXT_400 = NL + "                                  Object geom = rs_";
  protected final String TEXT_401 = ".getObject(";
  protected final String TEXT_402 = "column_index_";
  protected final String TEXT_403 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = " = null;" + NL + "                                  }";
  protected final String TEXT_408 = NL + "\t\t                          ";
  protected final String TEXT_409 = NL + "\t\t                    }";
  protected final String TEXT_410 = NL + "\t\t\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_412 = " - Retrieving the record \" + nb_line_";
