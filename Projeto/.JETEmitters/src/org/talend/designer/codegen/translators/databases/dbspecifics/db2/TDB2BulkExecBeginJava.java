...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_80 = "\");" + NL + "        String schema_";
  ...
  protected final String TEXT_91 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_92 = " + \":\" + ";
  protected final String TEXT_93 = " + \"/\" + ";
  protected final String TEXT_94 = " + \":\" + ";
  protected final String TEXT_95 = ";";
  protected final String TEXT_96 = NL + "        String driverClass_";
  protected final String TEXT_97 = " = \"com.ibm.db2.jcc.DB2Driver\";" + NL + "        java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_110 = ";" + NL + "        String schema_";
  ...
  protected final String TEXT_302 = ".getTables(null, dbschema_";
  protected final String TEXT_303 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_304 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_305 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_306 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_315 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_342 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_346 = " - Creating table ";
  ...
  protected final String TEXT_354 = " - Create table ";
  ...
  protected final String TEXT_359 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_365 = " - Droping table ";
  ...
  protected final String TEXT_373 = " - Drop table ";
  ...
  protected final String TEXT_380 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_381 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_382 = " - Creating table ";
  ...
  protected final String TEXT_389 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_390 = " - Create table ";
  protected final String TEXT_391 = "\" + tableName_";
  protected final String TEXT_392 = " + \"";
  protected final String TEXT_393 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_395 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_397 = " = conn_";
  protected final String TEXT_398 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_400 = " - Clearing table ";
  protected final String TEXT_401 = "\" + tableName_";
  ...
  protected final String TEXT_408 = "- Clear table ";
  protected final String TEXT_409 = "\" + tableName_";
  protected final String TEXT_410 = " + \"";
  protected final String TEXT_411 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_416 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_417 = " = stmtTruncCount_";
  protected final String TEXT_418 = ".executeQuery(\"";
  protected final String TEXT_419 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_423 = " - Trancating table ";
  ...
  protected final String TEXT_431 = " - Truncate table ";
  ...
  protected final String TEXT_442 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_443 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_444 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_445 = NL + "   FileFinder fileFinder_";
  protected final String TEXT_446 = " = new FileFinder();";
  protected final String TEXT_447 = NL + "            final String decryptedPassword_";
  protected final String TEXT_448 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_449 = ");";
  protected final String TEXT_450 = NL + "            final String decryptedPassword_";
  protected final String TEXT_451 = " = ";
  protected final String TEXT_452 = ";";
  protected final String TEXT_453 = NL + "        String dbPwd_";
  protected final String TEXT_454 = " = decryptedPassword_";
  protected final String TEXT_455 = ";";
  protected final String TEXT_456 = NL + "    String fullTableName_";
  protected final String TEXT_457 = " = ";
  protected final String TEXT_458 = ";" + NL + "    if(!\"\".equals(";
  protected final String TEXT_459 = ") && !\"\\\"\\\"\".equals(";
  protected final String TEXT_460 = ") && ";
  protected final String TEXT_461 = " != null){" + NL + "        fullTableName_";
  protected final String TEXT_462 = " = \"\\\"\" + ";
  protected final String TEXT_463 = " + \"\\\".\\\"\" + fullTableName_";
  protected final String TEXT_464 = " + \"\\\"\";" + NL + "    }";
  protected final String TEXT_465 = NL + "   String scriptPath_";
  protected final String TEXT_466 = " = ";
  protected final String TEXT_467 = ";";
  protected final String TEXT_468 = NL;
  protected final String TEXT_469 = NL + "                     String columnDelimiter_";
  protected final String TEXT_470 = " = \", \";" + NL + "                     StringBuilder ingestCmd_";
  protected final String TEXT_471 = " = new StringBuilder(\"ingest data from\");";
  protected final String TEXT_472 = NL + "                     ingestCmd_";
  protected final String TEXT_473 = ".append(\" ";
  protected final String TEXT_474 = " \");";
  protected final String TEXT_475 = NL + "                     ingestCmd_";
  protected final String TEXT_476 = ".append((";
  protected final String TEXT_477 = ").replace(" + NL + "                                                                                 fileSeparatorMapping_";
  protected final String TEXT_478 = ".get(runtimeFileSep_";
  protected final String TEXT_479 = ")" + NL + "                                                                                 , runtimeFileSep_";
  protected final String TEXT_480 = ")" + NL + "                                                                               );";
  protected final String TEXT_481 = NL + "                     ingestCmd_";
  protected final String TEXT_482 = ".append(";
  protected final String TEXT_483 = ");";
  protected final String TEXT_484 = NL + "                     ingestCmd_";
  protected final String TEXT_485 = ".append(" + NL + "                                          fileFinder_";
  protected final String TEXT_486 = ".getFilePathJoinedWithComma(" + NL + "                                          new java.io.File(";
  protected final String TEXT_487 = ")" + NL + "                                        , ";
  protected final String TEXT_488 = NL + "                                        , ";
  protected final String TEXT_489 = NL + "                                                            )" + NL + "                                                );";
  protected final String TEXT_490 = NL + "                     Compile Err: UNSUPPORTED LOAD TYPE ";
  protected final String TEXT_491 = NL + "                     ingestCmd_";
  protected final String TEXT_492 = ".append(\" format\");";
  protected final String TEXT_493 = NL + "                     ingestCmd_";
  protected final String TEXT_494 = ".append(\" delimited\");";
  protected final String TEXT_495 = NL + "                     ingestCmd_";
  protected final String TEXT_496 = ".append(\" by '\");" + NL + "                     ingestCmd_";
  protected final String TEXT_497 = ".append(";
  protected final String TEXT_498 = ");" + NL + "                     ingestCmd_";
  protected final String TEXT_499 = ".append(\"'\");";
  protected final String TEXT_500 = NL + "                     ingestCmd_";
  protected final String TEXT_501 = ".append(\" positional\");";
  protected final String TEXT_502 = NL + "                     ingestCmd_";
  protected final String TEXT_503 = ".append(\" recordlen \");" + NL + "                     ingestCmd_";
  protected final String TEXT_504 = ".append(Integer.valueOf(";
  protected final String TEXT_505 = "));";
  protected final String TEXT_506 = NL + "                     Compile Err: UNSUPPORTED DATA FORMAT ";
  protected final String TEXT_507 = NL + "                     ingestCmd_";
  protected final String TEXT_508 = ".append(\" input codepage \");" + NL + "                     ingestCmd_";
  protected final String TEXT_509 = ".append(Integer.valueOf(";
  protected final String TEXT_510 = "));";
  protected final String TEXT_511 = NL;
  protected final String TEXT_512 = NL + "StringBuilder fieldDefinition_";
  protected final String TEXT_513 = " = new StringBuilder(\" (\");";
  protected final String TEXT_514 = NL + "            fieldDefinition_";
  protected final String TEXT_515 = ".append(columnDelimiter_";
  protected final String TEXT_516 = ");";
  protected final String TEXT_517 = NL + "            fieldDefinition_";
  protected final String TEXT_518 = ".append(\"\\\"$";
  protected final String TEXT_519 = "\\\"\");";
  protected final String TEXT_520 = NL + "               fieldDefinition_";
  protected final String TEXT_521 = ".append(\" position(\");" + NL + "               fieldDefinition_";
  protected final String TEXT_522 = ".append(Integer.valueOf(";
  protected final String TEXT_523 = "));" + NL + "               fieldDefinition_";
  protected final String TEXT_524 = ".append(\":\");" + NL + "               fieldDefinition_";
  protected final String TEXT_525 = ".append(Integer.valueOf(";
  protected final String TEXT_526 = "));" + NL + "               fieldDefinition_";
  protected final String TEXT_527 = ".append(\")\");";
  protected final String TEXT_528 = NL + "               fieldDefinition_";
  protected final String TEXT_529 = ".append(\" ";
  protected final String TEXT_530 = "\");";
  protected final String TEXT_531 = NL + "               Compile Err: UNSUPPORTED DATABASE TYPE ";
  protected final String TEXT_532 = " FOR INGEST COMMAND, PLEASE TRY TO USE LOAD COMMAND.";
  protected final String TEXT_533 = NL + "            Compile Err: YOU MUST SET THE LENGTH FOR THE COLUMN ";
  protected final String TEXT_534 = ".";
  protected final String TEXT_535 = NL + "            fieldDefinition_";
  protected final String TEXT_536 = ".append(\"(";
  protected final String TEXT_537 = ")\");";
  protected final String TEXT_538 = NL + "            fieldDefinition_";
  protected final String TEXT_539 = ".append(\" OPTIONALLY ENCLOSED BY '\");" + NL + "            fieldDefinition_";
  protected final String TEXT_540 = ".append(";
  protected final String TEXT_541 = ");" + NL + "            fieldDefinition_";
  protected final String TEXT_542 = ".append(\"'\");";
  protected final String TEXT_543 = NL + "            fieldDefinition_";
  protected final String TEXT_544 = ".append(\"(";
  protected final String TEXT_545 = ",";
  protected final String TEXT_546 = ")\");";
  protected final String TEXT_547 = NL + "               fieldDefinition_";
  protected final String TEXT_548 = ".append(\" EXTERNAL\");";
  protected final String TEXT_549 = NL + "            fieldDefinition_";
  protected final String TEXT_550 = ".append(\" '\");" + NL + "            fieldDefinition_";
  protected final String TEXT_551 = ".append(";
  protected final String TEXT_552 = ");" + NL + "            fieldDefinition_";
  protected final String TEXT_553 = ".append(\"'\");";
  protected final String TEXT_554 = NL + "            fieldDefinition_";
  protected final String TEXT_555 = ".append(\" OPTIONALLY ENCLOSED BY '\");" + NL + "            fieldDefinition_";
  protected final String TEXT_556 = ".append(";
  protected final String TEXT_557 = ");" + NL + "            fieldDefinition_";
  protected final String TEXT_558 = ".append(\"'\");";
  protected final String TEXT_559 = NL + "            fieldDefinition_";
  protected final String TEXT_560 = ".append(\" EXTERNAL\");";
  protected final String TEXT_561 = NL + "           fieldDefinition_";
  protected final String TEXT_562 = ".append(\")\");" + NL + "                    ingestCmd_";
  protected final String TEXT_563 = ".append(fieldDefinition_";
  protected final String TEXT_564 = ");";
  protected final String TEXT_565 = NL;
  protected final String TEXT_566 = NL + "                    Compile Err: UNSUPPORTED ERR FILE TYPE ";
  protected final String TEXT_567 = NL + "                    ingestCmd_";
  protected final String TEXT_568 = ".append(\" ";
  protected final String TEXT_569 = "\");" + NL + "                    ingestCmd_";
  protected final String TEXT_570 = ".append(";
  protected final String TEXT_571 = ");";
  protected final String TEXT_572 = NL + "                       ingestCmd_";
  protected final String TEXT_573 = ".append(\" exception table \");" + NL + "                       ingestCmd_";
  protected final String TEXT_574 = ".append(";
  protected final String TEXT_575 = ");";
  protected final String TEXT_576 = NL + "                       ingestCmd_";
  protected final String TEXT_577 = ".append(\" warningcount \");" + NL + "                       ingestCmd_";
  protected final String TEXT_578 = ".append(Integer.valueOf(";
  protected final String TEXT_579 = "));";
  protected final String TEXT_580 = NL + "                       ingestCmd_";
  protected final String TEXT_581 = ".append(\" messages \");" + NL + "                       ingestCmd_";
  protected final String TEXT_582 = ".append(";
  protected final String TEXT_583 = ");";
  protected final String TEXT_584 = NL + "                    ingestCmd_";
  protected final String TEXT_585 = ".append(\" restart \");" + NL + "                    ingestCmd_";
  protected final String TEXT_586 = ".append(\"";
  protected final String TEXT_587 = "\");";
  protected final String TEXT_588 = NL + "                     ingestCmd_";
  protected final String TEXT_589 = ".append(\" '\");" + NL + "                     ingestCmd_";
  protected final String TEXT_590 = ".append(";
  protected final String TEXT_591 = ");" + NL + "                     ingestCmd_";
  protected final String TEXT_592 = ".append(\"'\");";
  protected final String TEXT_593 = NL + "                     ingestCmd_";
  protected final String TEXT_594 = ".append(\" '\");" + NL + "                     ingestCmd_";
  protected final String TEXT_595 = ".append(";
  protected final String TEXT_596 = ");" + NL + "                     ingestCmd_";
  protected final String TEXT_597 = ".append(\"'\");";
  protected final String TEXT_598 = NL + "                        Compile Err: JOB ID MUST NOT BE EMPTY.";
  protected final String TEXT_599 = NL;
  protected final String TEXT_600 = NL + "                     StringBuilder valStatement_";
  protected final String TEXT_601 = " = new StringBuilder(\" (\");" + NL + "                     StringBuilder valsStatement_";
  protected final String TEXT_602 = " = new StringBuilder(\"(\");";
  protected final String TEXT_603 = NL + "                              valStatement_";
  protected final String TEXT_604 = ".append(columnDelimiter_";
  protected final String TEXT_605 = ");" + NL + "                              valsStatement_";
  protected final String TEXT_606 = ".append(columnDelimiter_";
  protected final String TEXT_607 = ");";
  protected final String TEXT_608 = NL + "                             valStatement_";
  protected final String TEXT_609 = ".append(\"\\\"";
  protected final String TEXT_610 = "\\\"\");" + NL + "                             valsStatement_";
  protected final String TEXT_611 = ".append(\"$";
  protected final String TEXT_612 = "\");";
  protected final String TEXT_613 = NL + "                             valStatement_";
  protected final String TEXT_614 = ".append(\")\");" + NL + "                             valsStatement_";
  protected final String TEXT_615 = ".append(\")\");";
  protected final String TEXT_616 = NL;
  protected final String TEXT_617 = NL + "                   ingestCmd_";
  protected final String TEXT_618 = ".append(\" ";
  protected final String TEXT_619 = " into \");" + NL + "                   ingestCmd_";
  protected final String TEXT_620 = ".append(fullTableName_";
  protected final String TEXT_621 = ");";
  protected final String TEXT_622 = NL + "                      ingestCmd_";
  protected final String TEXT_623 = ".append(valStatement_";
  protected final String TEXT_624 = ");";
  protected final String TEXT_625 = NL + "                      ingestCmd_";
  protected final String TEXT_626 = ".append(\" \");" + NL + "                      ingestCmd_";
  protected final String TEXT_627 = ".append(";
  protected final String TEXT_628 = ");";
  protected final String TEXT_629 = NL + "                      ingestCmd_";
  protected final String TEXT_630 = ".append(valStatement_";
  protected final String TEXT_631 = ");" + NL + "                      ingestCmd_";
  protected final String TEXT_632 = ".append(\" values \");" + NL + "                      ingestCmd_";
  protected final String TEXT_633 = ".append(valsStatement_";
  protected final String TEXT_634 = ");";
  protected final String TEXT_635 = NL + "                   ingestCmd_";
  protected final String TEXT_636 = ".append(\" update \");" + NL + "                   ingestCmd_";
  protected final String TEXT_637 = ".append(fullTableName_";
  protected final String TEXT_638 = ");" + NL + "                   ingestCmd_";
  protected final String TEXT_639 = ".append(\" set \");" + NL + "                   StringBuilder updateKey_";
  protected final String TEXT_640 = " = new StringBuilder(\"(\");" + NL + "                   StringBuilder updateVal_";
  protected final String TEXT_641 = " = new StringBuilder(\"(\");";
  protected final String TEXT_642 = NL + "                            updateKey_";
  protected final String TEXT_643 = ".append(columnDelimiter_";
  protected final String TEXT_644 = ");" + NL + "                            updateVal_";
  protected final String TEXT_645 = ".append(columnDelimiter_";
  protected final String TEXT_646 = ");";
  protected final String TEXT_647 = NL + "                            updateKey_";
  protected final String TEXT_648 = ".append(\"";
  protected final String TEXT_649 = "\");" + NL + "                            updateVal_";
  protected final String TEXT_650 = ".append(\"";
  protected final String TEXT_651 = "\");";
  protected final String TEXT_652 = NL + "                            updateKey_";
  protected final String TEXT_653 = ".append(columnDelimiter_";
  protected final String TEXT_654 = ");" + NL + "                            updateVal_";
  protected final String TEXT_655 = ".append(columnDelimiter_";
  protected final String TEXT_656 = ");";
  protected final String TEXT_657 = NL + "                            updateKey_";
  protected final String TEXT_658 = ".append(\"";
  protected final String TEXT_659 = "\");" + NL + "                            updateVal_";
  protected final String TEXT_660 = ".append(\"$";
  protected final String TEXT_661 = "\");";
  protected final String TEXT_662 = NL + "                        updateKey_";
  protected final String TEXT_663 = ".append(\")\");" + NL + "                        updateVal_";
  protected final String TEXT_664 = ".append(\") \");" + NL + "                        ingestCmd_";
  protected final String TEXT_665 = ".append(updateKey_";
  protected final String TEXT_666 = ");" + NL + "                        ingestCmd_";
  protected final String TEXT_667 = ".append(\" = \");" + NL + "                        ingestCmd_";
  protected final String TEXT_668 = ".append(updateVal_";
  protected final String TEXT_669 = ");" + NL + "                        ingestCmd_";
  protected final String TEXT_670 = ".append(";
  protected final String TEXT_671 = ");";
  protected final String TEXT_672 = NL + "                        ingestCmd_";
  protected final String TEXT_673 = ".append(\" delete from \");" + NL + "                        ingestCmd_";
  protected final String TEXT_674 = ".append(fullTableName_";
  protected final String TEXT_675 = ");" + NL + "                        ingestCmd_";
  protected final String TEXT_676 = ".append(\" \");" + NL + "                        ingestCmd_";
  protected final String TEXT_677 = ".append(";
  protected final String TEXT_678 = ");";
  protected final String TEXT_679 = NL + "                      ingestCmd_";
  protected final String TEXT_680 = ".append(\" \");" + NL + "                      ingestCmd_";
  protected final String TEXT_681 = ".append(";
  protected final String TEXT_682 = ");";
  protected final String TEXT_683 = NL;
  protected final String TEXT_684 = NL + "                   if(!(scriptPath_";
  protected final String TEXT_685 = ".endsWith(\"/\") || scriptPath_";
  protected final String TEXT_686 = ".endsWith(\"\\\\\"))){" + NL + "                       scriptPath_";
  protected final String TEXT_687 = " = scriptPath_";
  protected final String TEXT_688 = " + java.io.File.separator;" + NL + "                    }" + NL + "                       scriptPath_";
  protected final String TEXT_689 = " = scriptPath_";
  protected final String TEXT_690 = ".replace(" + NL + "                                                     fileSeparatorMapping_";
  protected final String TEXT_691 = ".get(runtimeFileSep_";
  protected final String TEXT_692 = ")" + NL + "                                                     , runtimeFileSep_";
  protected final String TEXT_693 = ");" + NL + "                       String scriptStorageFolder_";
  protected final String TEXT_694 = " = scriptPath_";
  protected final String TEXT_695 = ";" + NL + "                       scriptPath_";
  protected final String TEXT_696 = " = scriptPath_";
  protected final String TEXT_697 = " + \"db2_ingest_cmd.db2\";" + NL + "" + NL + "                   java.io.Writer writer_";
  protected final String TEXT_698 = " = new java.io.BufferedWriter(" + NL + "                                                        new java.io.OutputStreamWriter(" + NL + "                                                            new java.io.FileOutputStream(new java.io.File(scriptPath_";
  protected final String TEXT_699 = "), false)" + NL + "                                                            , \"UTF-8\")" + NL + "                                                    );" + NL + "                  writer_";
  protected final String TEXT_700 = ".write(\"CONNECT TO \");" + NL + "                  writer_";
  protected final String TEXT_701 = ".write(";
  protected final String TEXT_702 = ");" + NL + "                  writer_";
  protected final String TEXT_703 = ".write(\" USER \");" + NL + "                  writer_";
  protected final String TEXT_704 = ".write(";
  protected final String TEXT_705 = ");" + NL + "                  writer_";
  protected final String TEXT_706 = ".write(\" USING \");" + NL + "                  writer_";
  protected final String TEXT_707 = ".write(dbPwd_";
  protected final String TEXT_708 = ");" + NL + "                  writer_";
  protected final String TEXT_709 = ".write(System.getProperty(\"line.separator\"));" + NL + "                  writer_";
  protected final String TEXT_710 = ".write(ingestCmd_";
  protected final String TEXT_711 = ".toString());" + NL + "                  writer_";
  protected final String TEXT_712 = ".close();" + NL + "" + NL + "                    Process process_";
  protected final String TEXT_713 = " = null;" + NL + "                   if(runOnWindows_";
  protected final String TEXT_714 = "){" + NL + "                        process_";
  protected final String TEXT_715 = " = Runtime.getRuntime().exec(\"cmd /c db2cmd /i db2 -f \" + scriptPath_";
  protected final String TEXT_716 = ");" + NL + "                   }else{" + NL + "                        process_";
  protected final String TEXT_717 = " = Runtime.getRuntime().exec(new String[]{" + NL + "                                               \"sh\"" + NL + "                                              ,\"-c\"" + NL + "                                              ,\"db2 -f ./db2_ingest_cmd.db2\"" + NL + "                                              }" + NL + "                                              ,null,new java.io.File(scriptStorageFolder_";
  protected final String TEXT_718 = ")" + NL + "                                              );" + NL + "                   }" + NL + "" + NL + "                   final java.io.InputStream inputStream_";
  protected final String TEXT_719 = " = process_";
  protected final String TEXT_720 = ".getInputStream();" + NL + "                   final java.io.InputStream errStream_";
  protected final String TEXT_721 = " = process_";
  protected final String TEXT_722 = ".getErrorStream();" + NL + "                   Thread normal_";
  protected final String TEXT_723 = " = new Thread() {" + NL + "                       public void run() {" + NL + "                           try {" + NL + "                               java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(inputStream_";
  protected final String TEXT_724 = "));" + NL + "                               String line = \"\";" + NL + "                               try {" + NL + "                                   while((line = reader.readLine()) != null) {" + NL + "                                      System.out.println(line);" + NL + "                                   }" + NL + "                               } finally {" + NL + "                                    reader.close();" + NL + "                               }" + NL + "                           }catch(java.io.IOException ioe) {" + NL + "                               ioe.printStackTrace();" + NL + "                           }" + NL + "                       }" + NL + "                   };" + NL + "                   normal_";
  protected final String TEXT_725 = ".start();" + NL + "" + NL + "                   Thread error_";
  protected final String TEXT_726 = " = new Thread() {" + NL + "                       public void run() {" + NL + "                           try {" + NL + "                               java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(errStream_";
  protected final String TEXT_727 = "));" + NL + "                               String line = \"\";" + NL + "                               try {" + NL + "                                   while((line = reader.readLine()) != null) {" + NL + "                                       System.err.println(line);" + NL + "                                   }" + NL + "                               } finally {" + NL + "                                   reader.close();" + NL + "                               }" + NL + "                           } catch(java.io.IOException ioe) {" + NL + "                              ioe.printStackTrace();" + NL + "                           }" + NL + "                       }" + NL + "                   };" + NL + "                   error_";
  protected final String TEXT_728 = ".start();" + NL + "                   process_";
  protected final String TEXT_729 = ".waitFor();" + NL + "                   normal_";
  protected final String TEXT_730 = ".interrupt();" + NL + "                   error_";
  protected final String TEXT_731 = ".interrupt();" + NL + "                   java.nio.file.Files.delete(new java.io.File(scriptPath_";
  protected final String TEXT_732 = ").toPath());";
  protected final String TEXT_733 = NL + NL + "String fileName_";
  protected final String TEXT_734 = " = ";
  protected final String TEXT_735 = ";" + NL;
  protected final String TEXT_736 = NL + "        String sqlLoadPending_";
  protected final String TEXT_737 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        java.sql.CallableStatement callStmtLoadPending_";
  protected final String TEXT_738 = " = conn_";
  protected final String TEXT_739 = ".prepareCall(sqlLoadPending_";
  protected final String TEXT_740 = ");" + NL + "        callStmtLoadPending_";
  protected final String TEXT_741 = ".setString(1, \"load from  /dev/null  of del terminate into \\\"\" + tableName_";
  protected final String TEXT_742 = " + \"\\\"\");" + NL + "        try {" + NL + "            callStmtLoadPending_";
  protected final String TEXT_743 = ".execute();" + NL + "        } catch (java.sql.SQLException e) {" + NL + "            //when table not in load pending mode will throw exception." + NL + "            //and do nothing.";
  protected final String TEXT_744 = NL + "        }" + NL + "        callStmtLoadPending_";
  protected final String TEXT_745 = ".close();";
  protected final String TEXT_746 = NL;
  protected final String TEXT_747 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_748 = " = conn_";
  protected final String TEXT_749 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_750 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_751 = " - Droping table ";
  protected final String TEXT_752 = "\" + tableName_";
  protected final String TEXT_753 = " + \"";
  protected final String TEXT_754 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_755 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_756 = ".execute(\"";
  protected final String TEXT_757 = "\");" + NL + "\t\t\t";
  protected final String TEXT_758 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_759 = " - Drop table ";
  protected final String TEXT_760 = "\" + tableName_";
  protected final String TEXT_761 = " + \"";
  protected final String TEXT_762 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_763 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_764 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_765 = " = conn_";
  protected final String TEXT_766 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_767 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_768 = " - Creating table ";
  protected final String TEXT_769 = "\" + tableName_";
  protected final String TEXT_770 = " + \"";
  protected final String TEXT_771 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_772 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_773 = ".execute(\"";
  protected final String TEXT_774 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_775 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_776 = " - Create table ";
  protected final String TEXT_777 = "\" + tableName_";
  protected final String TEXT_778 = " + \"";
  protected final String TEXT_779 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_780 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_781 = ".close();" + NL + "\t\t";
  protected final String TEXT_782 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_783 = " = conn_";
  protected final String TEXT_784 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_785 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_786 = " - Creating table ";
  protected final String TEXT_787 = "\" + tableName_";
  protected final String TEXT_788 = " + \"";
  protected final String TEXT_789 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_790 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_791 = ".execute(\"";
  protected final String TEXT_792 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_793 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_794 = " - Create table ";
  protected final String TEXT_795 = "\" + tableName_";
  protected final String TEXT_796 = " + \"";
  protected final String TEXT_797 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_798 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_799 = ".close();" + NL + "\t\t";
  ...
  protected final String TEXT_803 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_804 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_805 = " = tableNameForSearch_";
  protected final String TEXT_806 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_807 = " = tableNameForSearch_";
  protected final String TEXT_808 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_809 = " = dbMetaData_";
  protected final String TEXT_810 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_811 = ", tableNameForSearch_";
  protected final String TEXT_812 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_813 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_814 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_815 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_816 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_817 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_818 = " = conn_";
  protected final String TEXT_819 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_820 = " = dbMetaData_";
  protected final String TEXT_821 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_822 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_823 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_824 = " = rsTable_";
  protected final String TEXT_825 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_826 = " = rsTable_";
  protected final String TEXT_827 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_828 = ".equalsIgnoreCase(";
  protected final String TEXT_829 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_830 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_831 = ") || dbschema_";
  protected final String TEXT_832 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_833 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_834 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_835 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_836 = " = conn_";
  protected final String TEXT_837 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_838 = " = dbMetaData_";
  protected final String TEXT_839 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_840 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_841 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_842 = " = rsTable_";
  protected final String TEXT_843 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_844 = " = rsTable_";
  protected final String TEXT_845 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_846 = ".equals(";
  protected final String TEXT_847 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_848 = ".equals(schema_";
  protected final String TEXT_849 = ") || (schema_";
  protected final String TEXT_850 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_851 = ".equalsIgnoreCase(bkSchema_";
  protected final String TEXT_852 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_853 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_854 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_855 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_856 = " = conn_";
  protected final String TEXT_857 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_858 = " = dbMetaData_";
  protected final String TEXT_859 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_860 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_861 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_862 = " == null || dbschema_";
  protected final String TEXT_863 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_864 = " = conn_";
  protected final String TEXT_865 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_866 = " = stmtSchema_";
  protected final String TEXT_867 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_868 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_869 = " = rsSchema_";
  protected final String TEXT_870 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_871 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_872 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_873 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_874 = " = rsTable_";
  protected final String TEXT_875 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_876 = " = rsTable_";
  protected final String TEXT_877 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_878 = ".equals";
  protected final String TEXT_879 = "IgnoreCase";
  protected final String TEXT_880 = "(";
  protected final String TEXT_881 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_882 = ".equals";
  protected final String TEXT_883 = "IgnoreCase";
  protected final String TEXT_884 = "(dbschema_";
  protected final String TEXT_885 = ") || ((dbschema_";
  protected final String TEXT_886 = " ==null || dbschema_";
  protected final String TEXT_887 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_888 = ".equals";
  protected final String TEXT_889 = "IgnoreCase";
  protected final String TEXT_890 = "(schema_";
  protected final String TEXT_891 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_892 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_893 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_894 = NL + "            \tString tableForSearch_";
  protected final String TEXT_895 = " = ";
  protected final String TEXT_896 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_897 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_898 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_899 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_900 = " =  tableForSearch_";
  protected final String TEXT_901 = ".substring(1,tableForSearch_";
  protected final String TEXT_902 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_903 = " =  tableForSearch_";
  protected final String TEXT_904 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_905 = " = conn_";
  protected final String TEXT_906 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_907 = " = dbMetaData_";
  protected final String TEXT_908 = ".getTables(null, conn_";
  protected final String TEXT_909 = ".getSchema(), tableForSearch_";
  protected final String TEXT_910 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_911 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_912 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_913 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_914 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_915 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_916 = " = conn_";
  protected final String TEXT_917 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_918 = " = dbMetaData_";
  protected final String TEXT_919 = ".getTables(null, dbschema_";
  protected final String TEXT_920 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_921 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_922 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_923 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  protected final String TEXT_924 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_925 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_926 = ".close();";
  protected final String TEXT_927 = NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_928 = " = conn_";
  protected final String TEXT_929 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_930 = " = dbMetaData_";
  protected final String TEXT_931 = ".getTables(";
  protected final String TEXT_932 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_933 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_934 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_935 = " = rsTable_";
  protected final String TEXT_936 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  protected final String TEXT_937 = ".equals";
  protected final String TEXT_938 = "IgnoreCase";
  protected final String TEXT_939 = "(";
  protected final String TEXT_940 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_941 = " = true;" + NL + "                    break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_942 = ".close();";
  protected final String TEXT_943 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_944 = " = conn_";
  protected final String TEXT_945 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_946 = " = dbMetaData_";
  protected final String TEXT_947 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_948 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_949 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_950 = " = rsTable_";
  protected final String TEXT_951 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_952 = ".equals";
  protected final String TEXT_953 = "IgnoreCase";
  protected final String TEXT_954 = "(";
  protected final String TEXT_955 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_956 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_957 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_958 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_959 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_960 = " = conn_";
  protected final String TEXT_961 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_962 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_963 = " - Creating table ";
  protected final String TEXT_964 = "\" + tableName_";
  protected final String TEXT_965 = " + \"";
  protected final String TEXT_966 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_967 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_968 = ".execute(\"";
  protected final String TEXT_969 = ")\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_970 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_971 = " - Create table ";
  protected final String TEXT_972 = "\" + tableName_";
  protected final String TEXT_973 = " + \"";
  protected final String TEXT_974 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_975 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_976 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_977 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_978 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_979 = " = conn_";
  protected final String TEXT_980 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_981 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_982 = " - Droping table ";
  protected final String TEXT_983 = "\" + tableName_";
  protected final String TEXT_984 = " + \"";
  protected final String TEXT_985 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_986 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_987 = ".execute(\"";
  protected final String TEXT_988 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_989 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_990 = " - Drop table ";
  protected final String TEXT_991 = "\" + tableName_";
  protected final String TEXT_992 = " + \"";
  protected final String TEXT_993 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_994 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_995 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_996 = " = conn_";
  protected final String TEXT_997 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_998 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_999 = " - Creating table ";
  protected final String TEXT_1000 = "\" + tableName_";
  protected final String TEXT_1001 = " + \"";
  protected final String TEXT_1002 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_1003 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_1004 = ".execute(\"";
  protected final String TEXT_1005 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_1006 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_1007 = " - Create table ";
  protected final String TEXT_1008 = "\" + tableName_";
  protected final String TEXT_1009 = " + \"";
  protected final String TEXT_1010 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_1011 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_1012 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_1013 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_1014 = " = conn_";
  protected final String TEXT_1015 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_1016 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_1017 = " - Clearing table ";
  protected final String TEXT_1018 = "\" + tableName_";
  protected final String TEXT_1019 = " + \"";
  protected final String TEXT_1020 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_1021 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_1022 = ".executeUpdate(\"";
  protected final String TEXT_1023 = "\");" + NL + "\t\t\t";
  protected final String TEXT_1024 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_1025 = "- Clear table ";
  protected final String TEXT_1026 = "\" + tableName_";
  protected final String TEXT_1027 = " + \"";
  protected final String TEXT_1028 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_1029 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_1030 = ".close();" + NL + "\t\t";
  protected final String TEXT_1031 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_1032 = " = conn_";
  protected final String TEXT_1033 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_1034 = " = stmtTruncCount_";
  protected final String TEXT_1035 = ".executeQuery(\"";
  protected final String TEXT_1036 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_1037 = " = conn_";
  protected final String TEXT_1038 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_1039 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_1040 = " - Trancating table ";
  protected final String TEXT_1041 = "\" + tableName_";
  protected final String TEXT_1042 = " + \"";
  protected final String TEXT_1043 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_1044 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_1045 = ".executeUpdate(\"";
  protected final String TEXT_1046 = "\");" + NL + "   \t    \t";
  protected final String TEXT_1047 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_1048 = " - Truncate table ";
  protected final String TEXT_1049 = "\" + tableName_";
  protected final String TEXT_1050 = " + \"";
  protected final String TEXT_1051 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_1052 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_1053 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_1054 = " += rsTruncCount_";
  protected final String TEXT_1055 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_1056 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_1057 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_1058 = ".close();" + NL + "\t\t";
  protected final String TEXT_1059 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_1060 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_1061 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_1062 = NL;
  protected final String TEXT_1063 = NL + "Character field_separator_";
  protected final String TEXT_1064 = " = (";
  protected final String TEXT_1065 = ").charAt(0);";
  protected final String TEXT_1066 = NL + "        String action_";
  protected final String TEXT_1067 = " = \"";
  protected final String TEXT_1068 = "\";" + NL + "        java.sql.CallableStatement callStmt_";
  protected final String TEXT_1069 = " = null;" + NL + "        String sql_";
  protected final String TEXT_1070 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        String param_";
  protected final String TEXT_1071 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_1072 = " + \"\\\" OF DEL ";
  protected final String TEXT_1073 = " MODIFIED BY COLDEL\"+ field_separator_";
  protected final String TEXT_1074 = " +" + NL + "                        \" dateformat=\\\"\"+ ";
  protected final String TEXT_1075 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_1076 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_1077 = " +\"\\\" ";
  protected final String TEXT_1078 = " \" +" + NL + "                         action_";
  protected final String TEXT_1079 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_1080 = " + \"\\\" ";
  protected final String TEXT_1081 = "\";";
  protected final String TEXT_1082 = NL + "                log.debug(\"";
  protected final String TEXT_1083 = " - Bulk SQL:CALL SYSPROC.ADMIN_CMD(\"+param_";
  protected final String TEXT_1084 = "+\").\");";
  protected final String TEXT_1085 = NL + "                log.info(\"";
  protected final String TEXT_1086 = " - Bulk inserting data into ";
  protected final String TEXT_1087 = "\" + tableName_";
  protected final String TEXT_1088 = " + \"";
  protected final String TEXT_1089 = ".\" );";
  protected final String TEXT_1090 = NL + "                log.info(\"";
  protected final String TEXT_1091 = " - Bulk replacing data into ";
  ...
  protected final String TEXT_1108 = NL + "                log.info(\"";
  protected final String TEXT_1109 = " - Bulk replace data into ";
  protected final String TEXT_1110 = "\" + tableName_";
  protected final String TEXT_1111 = " + \"";
  protected final String TEXT_1112 = " has finished.\");";
  protected final String TEXT_1113 = NL + "            int keyCount_";
  protected final String TEXT_1114 = " = ";
  protected final String TEXT_1115 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_1116 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_1117 = " = tableName_";
  protected final String TEXT_1118 = ";" + NL + "            tableName_";
  protected final String TEXT_1119 = " = \"tmp_";
  protected final String TEXT_1120 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_1121 = " = conn_";
  protected final String TEXT_1122 = ".createStatement();" + NL + NL;
  protected final String TEXT_1123 = NL + "                log.info(\"";
  protected final String TEXT_1124 = " - Creating temp table ";
  protected final String TEXT_1125 = "\" + tableName_";
  protected final String TEXT_1126 = " + \"";
  protected final String TEXT_1127 = ".\" );";
  protected final String TEXT_1128 = NL + "            stmtCreateTmp_";
  protected final String TEXT_1129 = ".execute(\"";
  protected final String TEXT_1130 = ")\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_1131 = ".close();";
  protected final String TEXT_1132 = NL + "                log.info(\"";
  protected final String TEXT_1133 = " - Create temp table ";
  protected final String TEXT_1134 = "\" + tableName_";
  protected final String TEXT_1135 = " + \"";
  protected final String TEXT_1136 = " has succeeded.\");";
  protected final String TEXT_1137 = NL + "            java.sql.CallableStatement callStmt_";
  protected final String TEXT_1138 = " = null;" + NL + "            String sql_";
  protected final String TEXT_1139 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "            String param_";
  protected final String TEXT_1140 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_1141 = ".replace(\"\\\\\",\"/\") + \"\\\" OF DEL ";
  protected final String TEXT_1142 = " MODIFIED BY COLDEL\" + field_separator_";
  protected final String TEXT_1143 = " +" + NL + "                                    \" dateformat=\\\"\"+";
  protected final String TEXT_1144 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_1145 = "+ \"\\\" timestampformat=\\\"\" + ";
  ...
  protected final String TEXT_1150 = NL + "                log.debug(\"";
  protected final String TEXT_1151 = " - Bulk SQL:CALL SYSPROC.ADMIN_CMD(\"+param_";
  protected final String TEXT_1152 = "+\").\");" + NL + "                log.info(\"";
  protected final String TEXT_1153 = " - Bulk inserting data into ";
  protected final String TEXT_1154 = "\" + tableName_";
  protected final String TEXT_1155 = " + \"";
  protected final String TEXT_1156 = ".\" );";
  protected final String TEXT_1157 = NL + "            callStmt_";
  protected final String TEXT_1158 = " = conn_";
  protected final String TEXT_1159 = ".prepareCall(sql_";
  protected final String TEXT_1160 = ");" + NL + "            callStmt_";
  protected final String TEXT_1161 = ".setString(1, param_";
  protected final String TEXT_1162 = ");" + NL + "            callStmt_";
  protected final String TEXT_1163 = ".execute();" + NL + "            callStmt_";
  protected final String TEXT_1164 = ".close();";
  protected final String TEXT_1165 = NL + "                log.info(\"";
  protected final String TEXT_1166 = " - Bulk insert data into ";
  protected final String TEXT_1167 = "\" + tableName_";
  protected final String TEXT_1168 = " + \"";
  protected final String TEXT_1169 = " has finished.\");";
  protected final String TEXT_1170 = NL + "            tableName_";
  protected final String TEXT_1171 = " = tmpTableName_";
  protected final String TEXT_1172 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_1173 = " = \"tmp_";
  protected final String TEXT_1174 = "\"+ \"_\" + pid + Thread.currentThread().getId();" + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_1175 = " = conn_";
  protected final String TEXT_1176 = ".createStatement();";
  protected final String TEXT_1177 = NL + "                log.info(\"";
  protected final String TEXT_1178 = " - Updating ";
  protected final String TEXT_1179 = "\" + tableName_";
  protected final String TEXT_1180 = " + \"";
  protected final String TEXT_1181 = " from ";
  protected final String TEXT_1182 = "\"+tmpTableName_";
  protected final String TEXT_1183 = "+\"";
  protected final String TEXT_1184 = ".\");";
  protected final String TEXT_1185 = NL + "            stmtUpdateBulk_";
  protected final String TEXT_1186 = ".executeUpdate(\"";
  protected final String TEXT_1187 = "\");";
  protected final String TEXT_1188 = NL + "            stmtUpdateBulk_";
  protected final String TEXT_1189 = ".close();" + NL + "            tableName_";
  protected final String TEXT_1190 = " = \"tmp_";
  protected final String TEXT_1191 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_1192 = " = conn_";
  protected final String TEXT_1193 = ".createStatement();";
  protected final String TEXT_1194 = NL + "                log.info(\"";
  protected final String TEXT_1195 = " - Droping temp table ";
  protected final String TEXT_1196 = "\" + tableName_";
  protected final String TEXT_1197 = " + \"";
  protected final String TEXT_1198 = ".\");";
  protected final String TEXT_1199 = NL + "            stmtTmpDrop_";
  protected final String TEXT_1200 = ".execute(\"";
  protected final String TEXT_1201 = "\");";
  protected final String TEXT_1202 = NL + "                log.info(\"";
  protected final String TEXT_1203 = " - Drop temp table ";
  protected final String TEXT_1204 = "\" + tableName_";
  protected final String TEXT_1205 = "+ \"";
  protected final String TEXT_1206 = " has succeeded.\");";
  protected final String TEXT_1207 = NL + "            stmtTmpDrop_";
  protected final String TEXT_1208 = ".close();";
