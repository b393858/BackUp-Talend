...
public class TSQLDWHRollbackMainJava
{
  protected static String nl;
  public static synchronized TSQLDWHRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHRollbackMainJava result = new TSQLDWHRollbackMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_80 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_81 = NL + "\t\t\ttry{" + NL + "\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t}finally{" + NL + "\t\t    \t";
