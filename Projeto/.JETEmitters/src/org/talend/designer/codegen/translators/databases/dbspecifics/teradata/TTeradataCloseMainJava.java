...
public class TTeradataCloseMainJava
{
  ...
  protected final String TEXT_126 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_127 = ".setAutoCommit(true);" + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_128 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_129 = NL + "                             try{" + NL + "                                 conn_";
  protected final String TEXT_130 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_131 = ");" + NL + "                             }catch(Exception e){" + NL + "                                   System.err.println(e.getMessage());" + NL + "                             }";
  protected final String TEXT_132 = NL + "             }catch(Exception e){";
  protected final String TEXT_133 = NL + "                 System.err.println(e.getMessage());" + NL + "             }" + NL;
