...
public class TTeradataRowEndJava
{
  ...
  protected final String TEXT_121 = NL + "        stmt_";
  protected final String TEXT_122 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_123 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_124 = NL;
  protected final String TEXT_125 = NL + "\tpstmt_";
  protected final String TEXT_126 = ".close();" + NL + "\tresourceMap.remove(\"pstmt_";
  protected final String TEXT_127 = "\");";
  protected final String TEXT_128 = NL + "\tstmt_";
  protected final String TEXT_129 = ".close();" + NL + "\tresourceMap.remove(\"stmt_";
  protected final String TEXT_130 = "\");";
  protected final String TEXT_131 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_132 = "\", true);";
  protected final String TEXT_133 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_134 = ">commitCounter_";
  protected final String TEXT_135 = "){" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_137 = "=0;" + NL + "" + NL + "\t\t}";
  protected final String TEXT_138 = NL + "\t";
  protected final String TEXT_139 = NL;
  protected final String TEXT_140 = NL + "    conn_";
  protected final String TEXT_141 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_142 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_143 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_144 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_145 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
  protected final String TEXT_146 = NL + "     }catch(Exception e){";
  protected final String TEXT_147 = NL + "         System.err.println(e.getMessage());" + NL + "     }";
