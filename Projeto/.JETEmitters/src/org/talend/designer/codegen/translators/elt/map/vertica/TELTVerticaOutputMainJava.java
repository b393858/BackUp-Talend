...
public class TELTVerticaOutputMainJava
{
  ...
  protected final String TEXT_77 = " = null;" + NL + "\tString tableName_";
  ...
  protected final String TEXT_87 = NL + "\tString dbschema_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_90 = " != null && dbschema_";
  protected final String TEXT_91 = ".trim().length() > 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = " + \".\" + ";
  protected final String TEXT_94 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_105 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = " + \"/\" + ";
  protected final String TEXT_108 = ";";
  protected final String TEXT_109 = NL + "\t\t\tString url_";
  protected final String TEXT_110 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_129 = ";" + NL + "\t" + NL + "\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_133 = NL + "\t\tStringBuilder info_";
  protected final String TEXT_134 = " = new StringBuilder();";
  protected final String TEXT_135 = NL + "\t\tinfo_";
  protected final String TEXT_136 = ".append(\"/*\");";
  protected final String TEXT_137 = NL + "\t\tinfo_";
  protected final String TEXT_138 = ".append(\"+ direct \");";
  protected final String TEXT_139 = NL + "\t\tinfo_";
  protected final String TEXT_140 = ".append(\"+ label(\").append(";
  protected final String TEXT_141 = ").append(\") \");";
  protected final String TEXT_142 = NL + "\t\tinfo_";
  protected final String TEXT_143 = ".append(\"*/\");";
  protected final String TEXT_144 = "\t" + NL + "\t\tString insertQuery_";
  protected final String TEXT_145 = " = \"INSERT \" + info_";
  protected final String TEXT_146 = " + \" INTO \"+tableName_";
  ...
  protected final String TEXT_154 = " = \"UPDATE \" + info_";
  ...
  protected final String TEXT_161 = ".prepareStatement(updateQuery_";
  protected final String TEXT_162 = ");" + NL;
  protected final String TEXT_163 = NL + "\t\tString deleteQuery_";
  protected final String TEXT_164 = " = \"DELETE \" + info_";
  protected final String TEXT_165 = " + \" FROM \"+ tableName_";
  protected final String TEXT_166 = "+\" WHERE EXISTS (\"+ select_query_";
  protected final String TEXT_167 = ".replaceAll(selectQueryColumnsName_";
  protected final String TEXT_168 = ", \"*\")+\") \" ";
  protected final String TEXT_169 = NL + "\t\t\t+\"  AND \" + ";
  protected final String TEXT_170 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_173 = ");";
  protected final String TEXT_174 = NL + "\t\tint nb_line_";
  protected final String TEXT_175 = " = 0;" + NL + "\t\tint nb_line_updated_";
  protected final String TEXT_176 = " = 0;" + NL + "\t\tint nb_line_inserted_";
  protected final String TEXT_177 = " = 0;" + NL + "\t\tint nb_line_deleted_";
  protected final String TEXT_178 = " = 0;";
  protected final String TEXT_179 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery_";
  ...
  protected final String TEXT_185 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_186 = " + \" rows inserted. \\n\");";
  protected final String TEXT_187 = NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_188 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_189 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_190 = " += nb_line_updated_";
  protected final String TEXT_191 = " = pstmt_";
  protected final String TEXT_192 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_194 = " + \" rows updated. \\n\");";
  protected final String TEXT_195 = NL + "\t\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_196 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_197 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_198 = " += nb_line_deleted_";
  protected final String TEXT_199 = " = pstmt_";
  protected final String TEXT_200 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_201 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_202 = " + \" rows deleted. \\n\");";
  protected final String TEXT_203 = NL + NL + "\tpstmt_";
  protected final String TEXT_204 = ".close();" + NL;
  protected final String TEXT_205 = NL + "    if(conn_";
  protected final String TEXT_206 = " != null && !conn_";
  protected final String TEXT_207 = ".isClosed()) {" + NL + "\t\t";
  ...
  protected final String TEXT_212 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_219 = " - Has ";
  protected final String TEXT_220 = " records count: \" + nb_line_";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_99);
		...
		if("VERTICA_9_0".equals(db_version) || "VERTICA_7_0_X".equals(db_version) || "VERTICA_6_1_X".equals(db_version) || "VERTICA_6_0".equals(db_version) || "VERTICA_5_1".equals(db_version)){
