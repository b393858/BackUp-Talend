...
public class TMysqlOutputMainJava {
  ...
  protected final String TEXT_50 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_82 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_118 = NL + "                                boolean whetherExist_";
  protected final String TEXT_119 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_125 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_134 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_135 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_139 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_140 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_141 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_142 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_145 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_146 = " = dbMetaData_";
  protected final String TEXT_147 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_162 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_163 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_166 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_167 = " = dbMetaData_";
  protected final String TEXT_168 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_187 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_188 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_189 = " = conn_";
  protected final String TEXT_190 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_191 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_192 = " = dbMetaData_";
  protected final String TEXT_193 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_194 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_195 = " == null || dbschema_";
  protected final String TEXT_196 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_203 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_223 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_224 = NL + "                                String tableForSearch_";
  protected final String TEXT_225 = " = ";
  protected final String TEXT_226 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_227 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_228 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_229 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_230 = " =  tableForSearch_";
  protected final String TEXT_231 = ".substring(1,tableForSearch_";
  protected final String TEXT_232 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_233 = " =  tableForSearch_";
  protected final String TEXT_234 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_237 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_238 = " = dbMetaData_";
  protected final String TEXT_239 = ".getTables(null, conn_";
  protected final String TEXT_240 = ".getSchema(), tableForSearch_";
  protected final String TEXT_241 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_242 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_243 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_244 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_245 = " = conn_";
  protected final String TEXT_246 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_247 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_248 = " = dbMetaData_";
  protected final String TEXT_249 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_250 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_251 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_252 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_253 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_254 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_255 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_258 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_259 = " = dbMetaData_";
  protected final String TEXT_260 = ".getTables(";
  protected final String TEXT_261 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_262 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_263 = " = rsTable_";
  protected final String TEXT_264 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_265 = ".equalsIgnoreCase(";
  protected final String TEXT_266 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_267 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_268 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_271 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_272 = " = dbMetaData_";
  protected final String TEXT_273 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_279 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_301 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_313 = ".commit();";
  protected final String TEXT_314 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_335 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_345 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_346 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_352 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_353 = " = stmtTruncCount_";
  protected final String TEXT_354 = ".executeQuery(\"";
  protected final String TEXT_355 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_356 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_357 = " = rsTruncCount_";
  protected final String TEXT_358 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_359 = " = conn_";
  protected final String TEXT_360 = ".createStatement()) {";
  protected final String TEXT_361 = NL + "                              stmtTrunc_";
  protected final String TEXT_362 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_363 = "));";
  protected final String TEXT_364 = NL + "                conn_";
  protected final String TEXT_365 = ".commit();";
  protected final String TEXT_366 = NL + "                stmtTrunc_";
  protected final String TEXT_367 = ".executeUpdate(\"";
  protected final String TEXT_368 = "\");";
  protected final String TEXT_369 = NL + "                    if(!conn_";
  protected final String TEXT_370 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_371 = ".commit();" + NL + "                    }";
  protected final String TEXT_372 = NL + "                deletedCount_";
  protected final String TEXT_373 = " += rsTruncCountNumber_";
  protected final String TEXT_374 = ";" + NL + "            }";
  protected final String TEXT_375 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_376 = " = conn_";
  protected final String TEXT_377 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_378 = " = stmtTruncCount_";
  protected final String TEXT_379 = ".executeQuery(\"";
  protected final String TEXT_380 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_381 = " = conn_";
  protected final String TEXT_382 = ".createStatement()) {";
  protected final String TEXT_383 = NL + "                conn_";
  protected final String TEXT_384 = ".commit();";
  protected final String TEXT_385 = NL + "                stmtTrunc_";
  protected final String TEXT_386 = ".executeUpdate(\"";
  protected final String TEXT_387 = "\");";
  protected final String TEXT_388 = NL + "                while(rsTruncCount_";
  protected final String TEXT_389 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_390 = " += rsTruncCount_";
  protected final String TEXT_391 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_392 = NL + "            StringBuffer duplidateClause_";
  protected final String TEXT_393 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");";
  protected final String TEXT_394 = NL + "                        duplidateClause_";
  ...
  protected final String TEXT_399 = ".append (\"=\");" + NL + "                        duplidateClause_";
  protected final String TEXT_400 = ".append (";
  protected final String TEXT_401 = ");";
  protected final String TEXT_402 = NL;
  protected final String TEXT_403 = NL + "                    ";
  protected final String TEXT_404 = ";";
  protected final String TEXT_405 = NL + "                insert_";
  protected final String TEXT_406 = " +=  duplidateClause_";
  protected final String TEXT_407 = ".toString();";
  protected final String TEXT_408 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_409 = " = new StringBuffer(insert_";
  protected final String TEXT_410 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_411 = ".insert(insert_";
  protected final String TEXT_412 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_413 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_414 = " =insertStringBuffer_";
  ...
  protected final String TEXT_420 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_421 = "\", pstmt_";
  protected final String TEXT_422 = ");";
  protected final String TEXT_423 = NL;
  protected final String TEXT_424 = NL + "                        pstmt_";
  protected final String TEXT_425 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_426 = " = conn_";
  protected final String TEXT_427 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_428 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_429 = ")== null){" + NL + "                            pstmt_";
  protected final String TEXT_430 = " = conn_";
  protected final String TEXT_431 = ".prepareStatement(insert_";
  protected final String TEXT_432 = ");" + NL + "                            resourceMap.put(\"pstmt_";
  protected final String TEXT_433 = "\", pstmt_";
  protected final String TEXT_434 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_435 = ", pstmt_";
  protected final String TEXT_436 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_437 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_463 = " +=  duplidateClause_";
  ...
  protected final String TEXT_475 = ".prepareStatement(insert_";
  protected final String TEXT_476 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_477 = "\", pstmt_";
  protected final String TEXT_478 = ");";
  protected final String TEXT_479 = NL + NL + "                        insertColName";
  protected final String TEXT_480 = " = \"";
  protected final String TEXT_481 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_482 = ".";
  protected final String TEXT_483 = ", \"";
  protected final String TEXT_484 = "\");" + NL + "                        insertColValue";
  protected final String TEXT_485 = " = \"";
  protected final String TEXT_486 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_487 = ".";
  protected final String TEXT_488 = ");";
  protected final String TEXT_489 = NL + "                        insertColName";
  ...
  protected final String TEXT_494 = " = DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_495 = ".";
  protected final String TEXT_496 = ");";
  protected final String TEXT_497 = NL + "                rowCount";
  ...
  protected final String TEXT_504 = " +=  duplidateClause_";
  ...
  protected final String TEXT_510 = NL + "                        int batchSize_";
  protected final String TEXT_511 = " = ";
  protected final String TEXT_512 = ";" + NL + "                        int batchSizeCounter_";
  protected final String TEXT_513 = "=0;";
  protected final String TEXT_514 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_515 = " = new StringBuffer(insert_";
  protected final String TEXT_516 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_517 = ".insert(insert_";
  protected final String TEXT_518 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_519 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_520 = " =insertStringBuffer_";
  ...
  protected final String TEXT_525 = ");" + NL + "                resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_541 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_542 = "\", pstmt_";
  ...
  protected final String TEXT_550 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_551 = " + \"` WHERE \" + DynamicUtils.getUpdateWhere(";
  protected final String TEXT_552 = ".";
  protected final String TEXT_553 = ", \"";
  protected final String TEXT_554 = "\", new StringBuilder(\"";
  protected final String TEXT_555 = "\"), ";
  protected final String TEXT_556 = "));//String insert_";
  protected final String TEXT_557 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_558 = " + \"` (";
  protected final String TEXT_559 = ") VALUES (";
  protected final String TEXT_560 = ")\";" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_561 = "\", pstmt_";
  protected final String TEXT_562 = ");";
  protected final String TEXT_563 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_564 = " = new StringBuffer(insert_";
  protected final String TEXT_565 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_566 = ".insert(insert_";
  protected final String TEXT_567 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_568 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_569 = " =insertStringBuffer_";
  ...
  protected final String TEXT_574 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_585 = NL + "        pstmtUpdate_";
  protected final String TEXT_586 = " = conn_";
  protected final String TEXT_587 = ".prepareStatement(update_";
  protected final String TEXT_588 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_606 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_607 = "\", pstmtUpdate_";
  protected final String TEXT_608 = ");";
  protected final String TEXT_609 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_610 = " = new StringBuffer(insert_";
  protected final String TEXT_611 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_612 = ".insert(insert_";
  protected final String TEXT_613 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_614 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_615 = " =insertStringBuffer_";
  protected final String TEXT_616 = ".toString(); ";
  protected final String TEXT_617 = "    " + NL + "        pstmtInsert_";
  protected final String TEXT_618 = " = conn_";
  protected final String TEXT_619 = ".prepareStatement(insert_";
  protected final String TEXT_620 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_621 = "\", pstmtInsert_";
  protected final String TEXT_622 = ");";
  protected final String TEXT_623 = NL + "            String delete_";
  protected final String TEXT_624 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_625 = " + \"` WHERE \" + DynamicUtils.getUpdateWhere(";
  protected final String TEXT_626 = ".";
  protected final String TEXT_627 = ", \"";
  protected final String TEXT_628 = "\", new StringBuilder(\"";
  protected final String TEXT_629 = "\"), ";
  protected final String TEXT_630 = ");";
  protected final String TEXT_631 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_632 = " = new StringBuffer(delete_";
  protected final String TEXT_633 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_634 = ".insert(delete_";
  protected final String TEXT_635 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_636 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_637 = " =deleteStringBuffer_";
  protected final String TEXT_638 = ".toString();  ";
  protected final String TEXT_639 = NL + "        pstmt_";
  protected final String TEXT_640 = " = conn_";
  protected final String TEXT_641 = ".prepareStatement(delete_";
  protected final String TEXT_642 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_649 = ".prepareStatement(replace_";
  protected final String TEXT_650 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_651 = "\", pstmt_";
  protected final String TEXT_652 = ");";
  protected final String TEXT_653 = NL + "            ";
  protected final String TEXT_654 = ";" + NL + "            insertIgnore_";
  protected final String TEXT_655 = " = insertIgnore_";
  protected final String TEXT_656 = " + \" ON DUPLICATE KEY UPDATE \" + DynamicUtils.getUpdateSet(";
  protected final String TEXT_657 = ".";
  protected final String TEXT_658 = ", \"";
  protected final String TEXT_659 = "\", new StringBuilder(\"";
  protected final String TEXT_660 = "\"));";
  protected final String TEXT_661 = NL + "        pstmt_";
  protected final String TEXT_662 = " = conn_";
  protected final String TEXT_663 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_664 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_665 = "\", pstmt_";
  protected final String TEXT_666 = ");";
  protected final String TEXT_667 = NL + "            ";
  protected final String TEXT_668 = ";";
  protected final String TEXT_669 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_670 = " = new StringBuffer(insert_";
  protected final String TEXT_671 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_672 = ".insert(insert_";
  protected final String TEXT_673 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_674 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_675 = " =insertStringBuffer_";
  protected final String TEXT_676 = ".toString(); ";
  protected final String TEXT_677 = "    " + NL + "        pstmt_";
  protected final String TEXT_678 = " = conn_";
  protected final String TEXT_679 = ".prepareStatement(insert_";
  protected final String TEXT_680 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_681 = "\", pstmt_";
  protected final String TEXT_682 = ");";
  protected final String TEXT_683 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_684 = " = insert_";
  protected final String TEXT_685 = ".split(\"\\\\?\");";
  protected final String TEXT_686 = NL + "\t\t\tupdate_";
  protected final String TEXT_687 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_688 = " = update_";
  protected final String TEXT_689 = ".split(\"\\\\?\");";
  protected final String TEXT_690 = NL + "\t\t\tupdate_";
  protected final String TEXT_691 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_692 = " = update_";
  protected final String TEXT_693 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_694 = " = insert_";
  protected final String TEXT_695 = ".split(\"\\\\?\");";
  protected final String TEXT_696 = NL + "\t\t\tdelete_";
  protected final String TEXT_697 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_698 = " = delete_";
  protected final String TEXT_699 = ".split(\"\\\\?\");";
  protected final String TEXT_700 = NL + "\t\t\treplace_";
  protected final String TEXT_701 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_702 = " = replace_";
  protected final String TEXT_703 = ".split(\"\\\\?\");";
  protected final String TEXT_704 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_705 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_706 = " = insertIgnore_";
  protected final String TEXT_707 = ".split(\"\\\\?\");";
  protected final String TEXT_708 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_709 = " = insert_";
  ...
  protected final String TEXT_716 = ".setNull(counter";
  protected final String TEXT_717 = ",java.sql.Types.CHAR);";
  protected final String TEXT_718 = NL + "                if(";
  protected final String TEXT_719 = ".";
  protected final String TEXT_720 = "==null){";
  protected final String TEXT_721 = NL + "                    ";
  protected final String TEXT_722 = ".setNull(counter";
  protected final String TEXT_723 = ",java.sql.Types.DATE);";
  protected final String TEXT_724 = NL + "                if(";
  protected final String TEXT_725 = ".";
  protected final String TEXT_726 = "==null){";
  protected final String TEXT_727 = NL + "                    ";
  protected final String TEXT_728 = ".setNull(counter";
  protected final String TEXT_729 = ",java.sql.Types.ARRAY);";
  protected final String TEXT_730 = NL + "                if(";
  protected final String TEXT_731 = ".";
  protected final String TEXT_732 = "==null){";
  protected final String TEXT_733 = NL + "                    ";
  protected final String TEXT_734 = ".setNull(counter";
  protected final String TEXT_735 = ",java.sql.Types.INTEGER);";
  protected final String TEXT_736 = NL + "                if(";
  protected final String TEXT_737 = ".";
  protected final String TEXT_738 = "==null){";
  protected final String TEXT_739 = NL + "                    ";
  protected final String TEXT_740 = ".setNull(counter";
  protected final String TEXT_741 = ",java.sql.Types.VARCHAR);";
  protected final String TEXT_742 = NL + "                if(";
  protected final String TEXT_743 = ".";
  protected final String TEXT_744 = "==null){";
  protected final String TEXT_745 = NL + "                    ";
  protected final String TEXT_746 = ".setNull(counter";
  protected final String TEXT_747 = ",java.sql.Types.OTHER);";
  protected final String TEXT_748 = NL + "                if(";
  protected final String TEXT_749 = ".";
  protected final String TEXT_750 = "==null){";
  protected final String TEXT_751 = NL + "                    ";
  protected final String TEXT_752 = ".setNull(counter";
  protected final String TEXT_753 = ",java.sql.Types.BOOLEAN);";
  protected final String TEXT_754 = NL + "                if(";
  protected final String TEXT_755 = ".";
  protected final String TEXT_756 = "==null){";
  protected final String TEXT_757 = NL + "                    ";
  protected final String TEXT_758 = ".setNull(counter";
  protected final String TEXT_759 = ",java.sql.Types.DOUBLE);";
  protected final String TEXT_760 = NL + "                if(";
  protected final String TEXT_761 = ".";
  protected final String TEXT_762 = "==null){";
  protected final String TEXT_763 = NL + "                    ";
  protected final String TEXT_764 = ".setNull(counter";
  protected final String TEXT_765 = ",java.sql.Types.FLOAT);";
  protected final String TEXT_766 = NL + "                }else{";
  protected final String TEXT_767 = NL + "                    if(";
  protected final String TEXT_768 = ".";
  protected final String TEXT_769 = "==null){";
  protected final String TEXT_770 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_771 = ".";
  protected final String TEXT_772 = ").toLowerCase())){";
  protected final String TEXT_773 = NL + "                ";
  protected final String TEXT_774 = ".setNull(counter";
  protected final String TEXT_775 = ",java.sql.Types.CHAR);" + NL + "" + NL + "                }else if(";
  protected final String TEXT_776 = ".";
  protected final String TEXT_777 = " == '\\0'){" + NL;
  protected final String TEXT_778 = NL + "                    ";
  protected final String TEXT_779 = ".setString(counter";
  protected final String TEXT_780 = ",\"\");" + NL + "" + NL + "                }else{" + NL;
  protected final String TEXT_781 = NL + "                    ";
  protected final String TEXT_782 = ".setString(counter";
  protected final String TEXT_783 = ",String.valueOf(";
  protected final String TEXT_784 = ".";
  protected final String TEXT_785 = "));" + NL + "                }";
  protected final String TEXT_786 = NL + "                if(";
  protected final String TEXT_787 = ".";
  protected final String TEXT_788 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_789 = " = ";
  protected final String TEXT_790 = ".";
  protected final String TEXT_791 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_792 = " < year1_";
  protected final String TEXT_793 = " || date_";
  protected final String TEXT_794 = " >= year10000_";
  protected final String TEXT_795 = ") {";
  protected final String TEXT_796 = NL + "                        ";
  protected final String TEXT_797 = ".setString(counter";
  protected final String TEXT_798 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_799 = NL + "                        ";
  protected final String TEXT_800 = ".setTimestamp(counter";
  protected final String TEXT_801 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_802 = "));" + NL + "                    }" + NL + "                }else{" + NL;
  protected final String TEXT_803 = NL + "                    ";
  protected final String TEXT_804 = ".setNull(counter";
  protected final String TEXT_805 = ",java.sql.Types.DATE);" + NL + "" + NL + "                }";
  protected final String TEXT_806 = NL + "                ";
  protected final String TEXT_807 = ".set";
  protected final String TEXT_808 = "(counter";
  protected final String TEXT_809 = ",";
  protected final String TEXT_810 = ".";
  protected final String TEXT_811 = ");";
  protected final String TEXT_812 = NL + NL + "                }" + NL;
  protected final String TEXT_813 = NL + "        query_";
  protected final String TEXT_814 = " = new StringBuffer(\"\");";
  protected final String TEXT_815 = NL + "                commitEvery_";
  protected final String TEXT_816 = " = buffersSize_";
  protected final String TEXT_817 = ";";
  protected final String TEXT_818 = NL + "                    batchSize_";
  protected final String TEXT_819 = " = buffersSize_";
  protected final String TEXT_820 = ";";
  protected final String TEXT_821 = NL;
  protected final String TEXT_822 = NL + "        whetherReject_";
  protected final String TEXT_823 = " = false;";
  protected final String TEXT_824 = NL + "                        int counter";
  protected final String TEXT_825 = " = rowCount";
  protected final String TEXT_826 = " * ";
  protected final String TEXT_827 = " + 1;";
  ...
  protected final String TEXT_839 = NL + NL + "                    exInsertColValue";
  ...
  protected final String TEXT_847 = NL + "                    );" + NL + "" + NL + "                    exInsertColValueList";
  protected final String TEXT_848 = ".add(exInsertColValue";
  protected final String TEXT_849 = ");" + NL + "" + NL + "                    rowCount";
  protected final String TEXT_850 = "++;";
  protected final String TEXT_851 = NL + "                nb_line_";
  protected final String TEXT_852 = "++;";
  protected final String TEXT_853 = NL + "                    if(rowCount";
  protected final String TEXT_854 = " == ";
  protected final String TEXT_855 = "){" + NL + "                        try{" + NL + "                            insertedCount_";
  protected final String TEXT_856 = " = insertedCount_";
  protected final String TEXT_857 = " + pstmt_";
  protected final String TEXT_858 = ".executeUpdate();" + NL + "                        }catch(java.lang.Exception e){";
  protected final String TEXT_859 = NL + "                             throw e;";
  protected final String TEXT_860 = NL + "                             System.err.println(e.getMessage());";
  protected final String TEXT_861 = NL + "                        }" + NL + "                        exInsertColValueList";
  protected final String TEXT_862 = ".clear();" + NL + "                        rowCount";
  protected final String TEXT_863 = " = 0;" + NL + "                        counter";
  protected final String TEXT_864 = "=1;" + NL + "                    }";
  ...
  protected final String TEXT_877 = ", pstmt_";
  ...
  protected final String TEXT_889 = NL + "                    try {" + NL + "                        nb_line_";
  ...
  protected final String TEXT_893 = ".executeUpdate();";
  ...
  protected final String TEXT_934 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_935 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_936 = " = insertedCount_";
  protected final String TEXT_937 = " + pstmt_";
  protected final String TEXT_938 = ".executeUpdate();";
  protected final String TEXT_939 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_940 = " = true;";
  ...
  protected final String TEXT_964 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_965 = ",";
  protected final String TEXT_966 = ".";
  protected final String TEXT_967 = ", ";
  protected final String TEXT_968 = ",updateSQLSplits_";
  protected final String TEXT_969 = ");";
  protected final String TEXT_970 = NL + NL + "                int count_";
  protected final String TEXT_971 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_972 = ".";
  protected final String TEXT_973 = ", pstmt_";
  ...
  protected final String TEXT_993 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_994 = ".";
  protected final String TEXT_995 = ", pstmt_";
  protected final String TEXT_996 = ", (count_";
  ...
  protected final String TEXT_1006 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1007 = "++;" + NL;
  protected final String TEXT_1008 = NL + "              batchSizeCounter_";
  protected final String TEXT_1009 = "++;";
  protected final String TEXT_1010 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_1011 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_1012 = " = updatedCount_";
  protected final String TEXT_1013 = " + pstmt_";
  protected final String TEXT_1014 = ".executeUpdate();";
  protected final String TEXT_1015 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1016 = " = true;";
  protected final String TEXT_1017 = NL + "                    throw(e);";
  protected final String TEXT_1018 = NL + "                        ";
  protected final String TEXT_1019 = " = new ";
  protected final String TEXT_1020 = "Struct();";
  protected final String TEXT_1021 = NL + "                            ";
  protected final String TEXT_1022 = ".";
  protected final String TEXT_1023 = " = ";
  protected final String TEXT_1024 = ".";
  protected final String TEXT_1025 = ";";
  protected final String TEXT_1026 = NL + "                        rejectedCount_";
  protected final String TEXT_1027 = " =  rejectedCount_";
  protected final String TEXT_1028 = "+ 1;";
  protected final String TEXT_1029 = NL + "                        ";
  protected final String TEXT_1030 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1031 = NL + "                        ";
  protected final String TEXT_1032 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1033 = ";";
  protected final String TEXT_1034 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1035 = NL + "            }";
  protected final String TEXT_1036 = NL + "                        ";
  protected final String TEXT_1037 = NL + "                    ";
  protected final String TEXT_1038 = NL + "                    DynamicUtils.insertKeyInWhereClause(";
  ...
  protected final String TEXT_1045 = NL + "            int checkCount_";
  protected final String TEXT_1046 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_1047 = " = pstmt_";
  protected final String TEXT_1048 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_1049 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_1050 = " = rs_";
  protected final String TEXT_1051 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_1052 = " > 0) {";
  protected final String TEXT_1053 = NL + "                        ";
  protected final String TEXT_1054 = NL + "                            query_";
  protected final String TEXT_1055 = " = ";
  protected final String TEXT_1056 = ";";
  protected final String TEXT_1057 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1058 = ",";
  protected final String TEXT_1059 = ".";
  protected final String TEXT_1060 = ", ";
  protected final String TEXT_1061 = ",updateSQLSplits_";
  protected final String TEXT_1062 = ");";
  protected final String TEXT_1063 = NL + "                    int count_";
  protected final String TEXT_1064 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1065 = ".";
  protected final String TEXT_1066 = ", pstmtUpdate_";
  ...
  protected final String TEXT_1085 = NL + "                    routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_1086 = ".";
  protected final String TEXT_1087 = ", pstmtUpdate_";
  protected final String TEXT_1088 = ", (count_";
  ...
  protected final String TEXT_1093 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1094 = "_QUERY\", query_";
  protected final String TEXT_1095 = ".toString().trim());";
  protected final String TEXT_1096 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_1097 = " = updatedCount_";
  protected final String TEXT_1098 = " + pstmtUpdate_";
  protected final String TEXT_1099 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1100 = "++;";
  protected final String TEXT_1101 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1102 = " = true;";
  protected final String TEXT_1103 = NL + "                        throw(e);";
  protected final String TEXT_1104 = NL + "                        nb_line_";
  protected final String TEXT_1105 = "++;";
  protected final String TEXT_1106 = NL + "                        ";
  protected final String TEXT_1107 = " = new ";
  protected final String TEXT_1108 = "Struct();";
  ...
  protected final String TEXT_1114 = NL + "                            rejectedCount_";
  protected final String TEXT_1115 = " =  rejectedCount_";
  protected final String TEXT_1116 = "+ 1;";
  protected final String TEXT_1117 = NL + "                            ";
  protected final String TEXT_1118 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1119 = NL + "                            ";
  protected final String TEXT_1120 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1121 = ";";
  protected final String TEXT_1122 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1123 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_1124 = NL + "                        ";
  protected final String TEXT_1125 = NL + "                            query_";
  protected final String TEXT_1126 = " = ";
  protected final String TEXT_1127 = ";";
  protected final String TEXT_1128 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1129 = ",";
  protected final String TEXT_1130 = ".";
  protected final String TEXT_1131 = ", ";
  protected final String TEXT_1132 = ",insertSQLSplits_";
  protected final String TEXT_1133 = ");";
  protected final String TEXT_1134 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1135 = ".";
  protected final String TEXT_1136 = ", pstmtInsert_";
  protected final String TEXT_1137 = ", ";
  protected final String TEXT_1138 = ", \"";
  protected final String TEXT_1139 = "\");";
  protected final String TEXT_1140 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1141 = "_QUERY\", query_";
  protected final String TEXT_1142 = ".toString().trim());";
  protected final String TEXT_1143 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_1144 = " = insertedCount_";
  protected final String TEXT_1145 = " + pstmtInsert_";
  protected final String TEXT_1146 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1147 = "++;";
  protected final String TEXT_1148 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1149 = " = true;";
  protected final String TEXT_1150 = NL + "                        throw(e);";
  protected final String TEXT_1151 = NL + "                        nb_line_";
  protected final String TEXT_1152 = "++;";
  protected final String TEXT_1153 = NL + "                        ";
  protected final String TEXT_1154 = " = new ";
  protected final String TEXT_1155 = "Struct();";
  ...
  protected final String TEXT_1161 = NL + "                            rejectedCount_";
  protected final String TEXT_1162 = " =  rejectedCount_";
  protected final String TEXT_1163 = "+ 1;";
  protected final String TEXT_1164 = NL + "                            ";
  protected final String TEXT_1165 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1166 = NL + "                            ";
  protected final String TEXT_1167 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1168 = ";";
  protected final String TEXT_1169 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1170 = NL + "                }" + NL + "            }";
  protected final String TEXT_1171 = NL + "            int updateFlag_";
  protected final String TEXT_1172 = "=0;";
  protected final String TEXT_1173 = NL + "                    ";
  protected final String TEXT_1174 = NL + "                        query_";
  protected final String TEXT_1175 = " = ";
  protected final String TEXT_1176 = ";";
  protected final String TEXT_1177 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1178 = ",";
  protected final String TEXT_1179 = ".";
  protected final String TEXT_1180 = ", ";
  protected final String TEXT_1181 = ",updateSQLSplits_";
  protected final String TEXT_1182 = ");";
  protected final String TEXT_1183 = NL + "                int count_";
  protected final String TEXT_1184 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1185 = ".";
  protected final String TEXT_1186 = ", pstmtUpdate_";
  protected final String TEXT_1187 = ", ";
  protected final String TEXT_1188 = ", \"";
  protected final String TEXT_1189 = "\", true);";
  protected final String TEXT_1190 = NL + "                            ";
  protected final String TEXT_1191 = NL + "                            ";
  protected final String TEXT_1192 = NL + "                                query_";
  ...
  protected final String TEXT_1200 = NL + "                            query_";
  ...
  protected final String TEXT_1206 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_1207 = ".";
  protected final String TEXT_1208 = ", pstmtUpdate_";
  protected final String TEXT_1209 = ", (count_";
  ...
  protected final String TEXT_1214 = NL + "                globalMap.put(\"";
  protected final String TEXT_1215 = "_QUERY\", query_";
  protected final String TEXT_1216 = ".toString().trim());";
  protected final String TEXT_1217 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_1218 = "=pstmtUpdate_";
  protected final String TEXT_1219 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1220 = " = updatedCount_";
  protected final String TEXT_1221 = "+updateFlag_";
  protected final String TEXT_1222 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_1223 = " == 0) {" + NL;
  protected final String TEXT_1224 = NL + "                query_";
  protected final String TEXT_1225 = " = new StringBuffer(\"\");";
  protected final String TEXT_1226 = NL + "                        ";
  protected final String TEXT_1227 = NL + "                            query_";
  protected final String TEXT_1228 = " = ";
  protected final String TEXT_1229 = ";";
  protected final String TEXT_1230 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1231 = ",";
  protected final String TEXT_1232 = ".";
  protected final String TEXT_1233 = ", ";
  protected final String TEXT_1234 = ",insertSQLSplits_";
  protected final String TEXT_1235 = ");";
  protected final String TEXT_1236 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1237 = ".";
  protected final String TEXT_1238 = ", pstmtInsert_";
  protected final String TEXT_1239 = ", ";
  protected final String TEXT_1240 = ", \"";
  protected final String TEXT_1241 = "\");";
  protected final String TEXT_1242 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1243 = "_QUERY\", query_";
  protected final String TEXT_1244 = ".toString().trim());";
  protected final String TEXT_1245 = NL + "                    insertedCount_";
  protected final String TEXT_1246 = " = insertedCount_";
  protected final String TEXT_1247 = " + pstmtInsert_";
  protected final String TEXT_1248 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1249 = "++;";
  protected final String TEXT_1250 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_1251 = "++;";
  protected final String TEXT_1252 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1253 = " = true;";
  protected final String TEXT_1254 = NL + "                        throw(e);";
  protected final String TEXT_1255 = NL + "                        nb_line_";
  protected final String TEXT_1256 = "++;";
  protected final String TEXT_1257 = NL + "                        ";
  protected final String TEXT_1258 = " = new ";
  protected final String TEXT_1259 = "Struct();";
  ...
  protected final String TEXT_1265 = NL + "                            rejectedCount_";
  protected final String TEXT_1266 = " =  rejectedCount_";
  protected final String TEXT_1267 = "+ 1;";
  protected final String TEXT_1268 = NL + "                            ";
  protected final String TEXT_1269 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1270 = NL + "                            ";
  protected final String TEXT_1271 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1272 = ";";
  protected final String TEXT_1273 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1274 = NL + "                }";
  protected final String TEXT_1275 = NL + "                        ";
  protected final String TEXT_1276 = NL + "                            query_";
  protected final String TEXT_1277 = " = ";
  protected final String TEXT_1278 = ";";
  protected final String TEXT_1279 = NL + "                    ";
  protected final String TEXT_1280 = NL + "                        query_";
  protected final String TEXT_1281 = " = ";
  protected final String TEXT_1282 = ";";
  protected final String TEXT_1283 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_1284 = ".";
  protected final String TEXT_1285 = ", pstmt_";
  ...
  protected final String TEXT_1290 = NL + "                globalMap.put(\"";
  protected final String TEXT_1291 = "_QUERY\", query_";
  protected final String TEXT_1292 = ".toString().trim());";
  protected final String TEXT_1293 = NL + "            pstmt_";
  protected final String TEXT_1294 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1295 = "++;";
  protected final String TEXT_1296 = NL + "              batchSizeCounter_";
  protected final String TEXT_1297 = "++;";
  protected final String TEXT_1298 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1299 = " = deletedCount_";
  protected final String TEXT_1300 = " + pstmt_";
  protected final String TEXT_1301 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1302 = "++;";
  protected final String TEXT_1303 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_1330 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1331 = ".";
  protected final String TEXT_1332 = ", pstmt_";
  ...
  protected final String TEXT_1374 = NL + "                int count_";
  protected final String TEXT_1375 = " = DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1376 = ".";
  protected final String TEXT_1377 = ", pstmt_";
  ...
  protected final String TEXT_1382 = NL + "                        query_";
  protected final String TEXT_1383 = " = ";
  protected final String TEXT_1384 = ";";
  protected final String TEXT_1385 = NL + "                globalMap.put(\"";
  protected final String TEXT_1386 = "_QUERY\", query_";
  protected final String TEXT_1387 = ".toString().trim());";
  protected final String TEXT_1388 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1389 = ".";
  protected final String TEXT_1390 = ", pstmt_";
  protected final String TEXT_1391 = ", (count_";
  protected final String TEXT_1392 = " + ";
  protected final String TEXT_1393 = "), \"";
  protected final String TEXT_1394 = "\", true);";
  protected final String TEXT_1395 = NL + "            int count_on_duplicate_key_";
  protected final String TEXT_1396 = " = 0;" + NL + "            try {" + NL + "                count_on_duplicate_key_";
  ...
  protected final String TEXT_1419 = NL + "            }" + NL + "            if(count_on_duplicate_key_";
  protected final String TEXT_1420 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1421 = " += count_on_duplicate_key_";
  protected final String TEXT_1422 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1423 = " += 1;" + NL + "                updatedCount_";
  protected final String TEXT_1424 = " += count_on_duplicate_key_";
  ...
  protected final String TEXT_1430 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1431 = ".";
  protected final String TEXT_1432 = ", pstmt_";
  protected final String TEXT_1433 = ", ";
  protected final String TEXT_1434 = ", \"";
  protected final String TEXT_1435 = "\");";
  protected final String TEXT_1436 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1437 = "_QUERY\", query_";
  protected final String TEXT_1438 = ".toString().trim());";
  protected final String TEXT_1439 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_1440 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_1441 = " = insertedCount_";
  protected final String TEXT_1442 = " + pstmt_";
  protected final String TEXT_1443 = ".executeUpdate();";
  protected final String TEXT_1444 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1445 = " = true;";
  protected final String TEXT_1446 = NL + "                        throw(e);";
  ...
  protected final String TEXT_1455 = NL + "                            rejectedCount_";
  protected final String TEXT_1456 = " =  rejectedCount_";
  protected final String TEXT_1457 = "+ 1;";
  protected final String TEXT_1458 = NL + "                            ";
  protected final String TEXT_1459 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1460 = NL + "                            ";
  protected final String TEXT_1461 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1462 = ";";
  protected final String TEXT_1463 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1464 = NL + "                }";
  protected final String TEXT_1465 = NL + "            if(!whetherReject_";
  protected final String TEXT_1466 = ") {";
  protected final String TEXT_1467 = NL + "                            ";
  protected final String TEXT_1468 = " = new ";
  protected final String TEXT_1469 = "Struct();";
  ...
  protected final String TEXT_1476 = NL + "                if ( batchSize_";
  protected final String TEXT_1477 = " <= batchSizeCounter_";
  protected final String TEXT_1478 = ") {";
  protected final String TEXT_1479 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1480 = " = 0;";
  protected final String TEXT_1481 = NL + "                        for(int countEach_";
  protected final String TEXT_1482 = ": pstmt_";
  protected final String TEXT_1483 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1484 = " += (countEach_";
  protected final String TEXT_1485 = " == java.sql.Statement.EXECUTE_FAILED ? 0 : 1);" + NL + "                        }";
  protected final String TEXT_1486 = NL + "                        insertedCount_";
  protected final String TEXT_1487 = " += countSum_";
  protected final String TEXT_1488 = ";";
  protected final String TEXT_1489 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1490 = NL + "                        throw(e);";
  protected final String TEXT_1491 = NL + "                    int countSum_";
  protected final String TEXT_1492 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1493 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_1494 = " += (countEach_";
  protected final String TEXT_1495 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1496 = ");" + NL + "                    }";
  protected final String TEXT_1497 = NL + "                    insertedCount_";
  protected final String TEXT_1498 = " += countSum_";
  protected final String TEXT_1499 = ";";
  protected final String TEXT_1500 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1501 = NL + "                }";
  protected final String TEXT_1502 = NL + NL + "                batchSizeCounter_";
  protected final String TEXT_1503 = " = 0;" + NL + "            }";
  protected final String TEXT_1504 = NL + "                if ( batchSize_";
  protected final String TEXT_1505 = " <= batchSizeCounter_";
  protected final String TEXT_1506 = ") {";
  protected final String TEXT_1507 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1508 = " = 0;";
  protected final String TEXT_1509 = NL + "                        for(int countEach_";
  protected final String TEXT_1510 = ": pstmt_";
  protected final String TEXT_1511 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1515 = NL + "                        updatedCount_";
  protected final String TEXT_1516 = " += countSum_";
  protected final String TEXT_1517 = ";";
  protected final String TEXT_1518 = NL + "                        deletedCount_";
  protected final String TEXT_1519 = " += countSum_";
  protected final String TEXT_1520 = ";";
  protected final String TEXT_1521 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1522 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1523 = NL + "                        throw(e);";
  protected final String TEXT_1524 = NL + "                    int countSum_";
  protected final String TEXT_1525 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1526 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  ...
  protected final String TEXT_1530 = NL + "                    updatedCount_";
  protected final String TEXT_1531 = " += countSum_";
  protected final String TEXT_1532 = ";";
  protected final String TEXT_1533 = NL + "                    deletedCount_";
  protected final String TEXT_1534 = " += countSum_";
  protected final String TEXT_1535 = ";";
  protected final String TEXT_1536 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1537 = NL + "                }";
  protected final String TEXT_1538 = NL + NL + NL + NL + "                }";
  protected final String TEXT_1539 = NL + "                commitCounter_";
  protected final String TEXT_1540 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_1541 = " <= commitCounter_";
  protected final String TEXT_1542 = ") {" + NL;
  protected final String TEXT_1543 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1544 = " = 0;";
  protected final String TEXT_1545 = NL + "                        for(int countEach_";
  protected final String TEXT_1546 = ": pstmt_";
  protected final String TEXT_1547 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1548 = " += (countEach_";
  protected final String TEXT_1549 = " < 0 ? 0 : ";
  protected final String TEXT_1550 = ");" + NL + "                        }";
  protected final String TEXT_1551 = NL + "                        insertedCount_";
  protected final String TEXT_1552 = " += countSum_";
  protected final String TEXT_1553 = ";";
  protected final String TEXT_1554 = NL + "                        updatedCount_";
  protected final String TEXT_1555 = " += countSum_";
  protected final String TEXT_1556 = ";";
  protected final String TEXT_1557 = NL + "                        deletedCount_";
  protected final String TEXT_1558 = " += countSum_";
  protected final String TEXT_1559 = ";";
  protected final String TEXT_1560 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1561 = NL + "                        throw(e);";
  ...
  protected final String TEXT_1568 = NL + "                    insertedCount_";
  protected final String TEXT_1569 = " += countSum_";
  protected final String TEXT_1570 = ";";
  protected final String TEXT_1571 = NL + "                    updatedCount_";
  protected final String TEXT_1572 = " += countSum_";
  protected final String TEXT_1573 = ";";
  protected final String TEXT_1574 = NL + "                    deletedCount_";
  protected final String TEXT_1575 = " += countSum_";
  protected final String TEXT_1576 = ";";
  protected final String TEXT_1577 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1578 = NL + NL + "                }";
  protected final String TEXT_1579 = NL + "                    conn_";
  protected final String TEXT_1580 = ".commit();";
  protected final String TEXT_1581 = NL + "                    commitCounter_";
  protected final String TEXT_1582 = "=0;" + NL + "" + NL + "                }" + NL;
