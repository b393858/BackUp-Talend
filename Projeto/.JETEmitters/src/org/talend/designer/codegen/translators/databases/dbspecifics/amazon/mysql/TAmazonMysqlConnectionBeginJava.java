...
public class TAmazonMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_34 = " + \":\" + ";
  protected final String TEXT_35 = " + \"/\" + ";
  protected final String TEXT_36 = " + \"?\" + \"rewriteBatchedStatements=true\";";
  protected final String TEXT_37 = NL + "\t\tString proprtties_";
  protected final String TEXT_38 = " = ";
  protected final String TEXT_39 = ";" + NL + "\t\tif (proprtties_";
  protected final String TEXT_40 = " == null || proprtties_";
  protected final String TEXT_41 = ".trim().length() == 0) {" + NL + "\t\t\tproprtties_";
  protected final String TEXT_42 = " += \"rewriteBatchedStatements=true\";" + NL + "\t\t}else if (proprtties_";
  protected final String TEXT_43 = " != null && !proprtties_";
  protected final String TEXT_44 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproprtties_";
  protected final String TEXT_45 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString url_";
  protected final String TEXT_46 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_47 = " + \":\" + ";
  protected final String TEXT_48 = " + \"/\" + ";
  protected final String TEXT_49 = " + \"?\" + proprtties_";
  protected final String TEXT_50 = ";";
  protected final String TEXT_51 = NL + NL + "\t";
  protected final String TEXT_52 = NL + "\t\tString dbUser_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";";
  protected final String TEXT_55 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_56 = NL + "\t\t\tString dbPwd_";
  ...
  protected final String TEXT_65 = NL + "\t\t\tString dbPwd_";
  ...
  protected final String TEXT_71 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_73 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_74 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_76 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_77 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_79 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_80 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_82 = " - Written records count: \" + nb_line_";
  protected final String TEXT_83 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_85 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_87 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_88 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_90 = " - Writing the record \" + nb_line_";
  protected final String TEXT_91 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_93 = " - Processing the record \" + nb_line_";
  protected final String TEXT_94 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_96 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_97 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_99 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_100 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_101 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_102 = " - Uses an existing connection ";
  protected final String TEXT_103 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_104 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_105 = " - Uses an existing connection. Connection URL: \" + conn_";
  ...
  protected final String TEXT_121 = ".rollback();" + NL + "\t\t\t";
  ...
  protected final String TEXT_127 = ".setAutoCommit(";
  protected final String TEXT_128 = ");" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\tlog.";
  protected final String TEXT_130 = "(\"";
  protected final String TEXT_131 = " - \" + ";
  protected final String TEXT_132 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t    \t\tlog.";
  protected final String TEXT_134 = "(\"";
  protected final String TEXT_135 = "\");" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_137 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_139 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_140 = ": pstmt_";
  protected final String TEXT_141 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_142 = " += (countEach_";
  protected final String TEXT_143 = " < 0 ? 0 : ";
  protected final String TEXT_144 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_145 = NL + "\t";
  protected final String TEXT_146 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_147 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_148 = " == null) {";
  protected final String TEXT_149 = NL + "\t\t";
  protected final String TEXT_150 = NL + "\t\t";
  protected final String TEXT_151 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_152 = "\", conn_";
  protected final String TEXT_153 = ");";
  protected final String TEXT_154 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_155 = " = ";
  protected final String TEXT_156 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_157 = ".get(dsAlias_";
  protected final String TEXT_158 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_159 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_160 = " = dataSources_";
  protected final String TEXT_161 = ".get(dsAlias_";
  protected final String TEXT_162 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_163 = "\", conn_";
  protected final String TEXT_164 = ");" + NL + "\t}";
  protected final String TEXT_165 = NL + "\tif (null != conn_";
  protected final String TEXT_166 = ") {" + NL + "\t\t";
  protected final String TEXT_167 = NL + "\t}";
  protected final String TEXT_168 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_169 = "\",conn_";
  protected final String TEXT_170 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
