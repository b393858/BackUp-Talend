...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_55 = NL + "// schema is mandatory" + NL + "String tableName_";
  ...
  protected final String TEXT_71 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_72 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_73 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_74 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_75 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_76 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_77 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_78 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_94 = NL + "    java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "    String url_";
  protected final String TEXT_95 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_96 = " + \":\" + ";
  protected final String TEXT_97 = " + \";schema=\" + ";
  ...
  protected final String TEXT_122 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_125 = " = 0;";
  protected final String TEXT_126 = NL;
  protected final String TEXT_127 = NL + "   int batchSize_";
  protected final String TEXT_128 = " = ";
  protected final String TEXT_129 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_130 = "=0;";
  protected final String TEXT_131 = NL;
  protected final String TEXT_132 = NL + "int count_";
  protected final String TEXT_133 = "=0;";
  protected final String TEXT_134 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_146 = ".commit();";
  protected final String TEXT_147 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_155 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_156 = ".";
  protected final String TEXT_157 = ", \"";
  protected final String TEXT_158 = "\")";
  protected final String TEXT_159 = ".toUpperCase()";
  ...
  protected final String TEXT_166 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_202 = NL + "                                boolean whetherExist_";
  protected final String TEXT_203 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_209 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_218 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_219 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_223 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_224 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_225 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_226 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_229 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_230 = " = dbMetaData_";
  protected final String TEXT_231 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_245 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_246 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_252 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_271 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_272 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_273 = " = conn_";
  protected final String TEXT_274 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_275 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_276 = " = dbMetaData_";
  protected final String TEXT_277 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_278 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_279 = " == null || dbschema_";
  protected final String TEXT_280 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_287 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_296 = ")" + NL + "                                            && (schema_";
  ...
  protected final String TEXT_301 = " ==null || dbschema_";
  protected final String TEXT_302 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_303 = ".equals";
  protected final String TEXT_304 = "IgnoreCase";
  protected final String TEXT_305 = "(schema_";
  protected final String TEXT_306 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_307 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_320 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_321 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_322 = " = dbMetaData_";
  protected final String TEXT_323 = ".getTables(null, conn_";
  protected final String TEXT_324 = ".getSchema(), tableForSearch_";
  protected final String TEXT_325 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_326 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_327 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_328 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_329 = " = conn_";
  protected final String TEXT_330 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_331 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_332 = " = dbMetaData_";
  protected final String TEXT_333 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_334 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_335 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_336 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_337 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_338 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_344 = ".getTables(";
  protected final String TEXT_345 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_351 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_352 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_353 = " = conn_";
  protected final String TEXT_354 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_355 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_356 = " = dbMetaData_";
  protected final String TEXT_357 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_363 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_364 = NL + "                                if(!whetherExist_";
  protected final String TEXT_365 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_384 = NL + "                                if(whetherExist_";
  protected final String TEXT_385 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_389 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_398 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_419 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_429 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_430 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_436 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_437 = " = stmtTruncCount_";
  protected final String TEXT_438 = ".executeQuery(\"";
  protected final String TEXT_439 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_440 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_441 = " = rsTruncCount_";
  protected final String TEXT_442 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_459 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_466 = ".createStatement()) {";
  ...
  protected final String TEXT_472 = NL + "                while(rsTruncCount_";
  protected final String TEXT_473 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_474 = " += rsTruncCount_";
  protected final String TEXT_475 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_476 = NL + "        String insert_";
  protected final String TEXT_477 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_493 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_498 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_499 = " + \" WHERE ";
  protected final String TEXT_500 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_505 = ") VALUES (";
  protected final String TEXT_506 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_507 = " = conn_";
  protected final String TEXT_508 = ".prepareStatement(insert_";
  protected final String TEXT_509 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_510 = "\", pstmtInsert_";
  ...
  protected final String TEXT_515 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_516 = " = conn_";
  protected final String TEXT_517 = ".prepareStatement(update_";
  protected final String TEXT_518 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_519 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_528 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_533 = ") VALUES (";
  protected final String TEXT_534 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_540 = NL + "        String delete_";
  protected final String TEXT_541 = " = \"DELETE FROM \" + tableName_";
  ...
  protected final String TEXT_549 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_555 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_556 = " = update_";
  ...
  protected final String TEXT_561 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_562 = " = insert_";
  protected final String TEXT_563 = ".split(\"\\\\?\");";
  protected final String TEXT_564 = NL + "\t\t\tdelete_";
  protected final String TEXT_565 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_566 = " = delete_";
  protected final String TEXT_567 = ".split(\"\\\\?\");";
  protected final String TEXT_568 = NL + "\t\t\treplace_";
  protected final String TEXT_569 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_570 = " = replace_";
  protected final String TEXT_571 = ".split(\"\\\\?\");";
  protected final String TEXT_572 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_573 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_574 = " = insertIgnore_";
  protected final String TEXT_575 = ".split(\"\\\\?\");";
  protected final String TEXT_576 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_577 = " = insert_";
  protected final String TEXT_578 = ".split(\"\\\\?\");";
  protected final String TEXT_579 = NL + "    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_580 = " =null;" + NL + "    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_581 = " =null;" + NL + "    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_582 = " =null;";
  protected final String TEXT_583 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_589 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_590 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_594 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_598 = NL + "\t\t \tString[] insertSQLSplits_";
