...
public class TTeradataMultiLoadMainJava
{
  ...
  protected final String TEXT_86 = " = new StringBuilder();";
  protected final String TEXT_87 = NL + "\tfw_";
  protected final String TEXT_88 = ".write(\".LOGTABLE \"+";
  protected final String TEXT_89 = "+\".\"+";
  protected final String TEXT_90 = "+\"_lt;\"+ \"";
  protected final String TEXT_91 = "\");";
  protected final String TEXT_92 = NL + "\tfw_";
  protected final String TEXT_93 = ".write(\".LOGTABLE \"+";
  ...
  protected final String TEXT_104 = NL + NL + "fw_";
  protected final String TEXT_105 = ".write(\".LOGON \"+";
  protected final String TEXT_106 = "+\"/\"+";
  protected final String TEXT_107 = "+\",\"+decryptedPassword_";
  protected final String TEXT_108 = "+\";\"+ \"";
  protected final String TEXT_109 = "\");" + NL;
  protected final String TEXT_110 = NL + "fw_";
  protected final String TEXT_111 = ".write(\".BEGIN IMPORT MLOAD TABLES \"+tableFullName_";
  protected final String TEXT_112 = "+\" \"+";
  protected final String TEXT_113 = "+\";\"+ \"";
  protected final String TEXT_114 = "\");" + NL + "fw_";
  protected final String TEXT_115 = ".write(\".LAYOUT customer_layout;\"+ \"";
  protected final String TEXT_116 = "\");";
  protected final String TEXT_117 = NL + "fw_";
  protected final String TEXT_118 = ".write(\".FIELD \"+\"";
  protected final String TEXT_119 = "\"+\" * VARCHAR(";
  protected final String TEXT_120 = ");\"+ \"";
  protected final String TEXT_121 = "\");";
  protected final String TEXT_122 = NL + "fw_";
  protected final String TEXT_123 = ".write(\".DML LABEL DML_LABEL;\"+ \"";
  protected final String TEXT_124 = "\");" + NL;
  protected final String TEXT_125 = NL + "fw_";
  protected final String TEXT_126 = ".write(\"UPDATE \"+tableFullName_";
  protected final String TEXT_127 = "+\" SET \"+\"";
  protected final String TEXT_128 = "\"" + NL + "\t+\" WHERE \"+\"";
  protected final String TEXT_129 = "\"+\";\"+ \"";
  protected final String TEXT_130 = "\");";
  protected final String TEXT_131 = NL + "fw_";
  protected final String TEXT_132 = ".write(\"INSERT INTO \"+tableFullName_";
  protected final String TEXT_133 = "+\"(\"" + NL + "\t+\"";
  protected final String TEXT_134 = "\"+\") VAlUES(\"+\"";
  protected final String TEXT_135 = "\"+\");\"+ \"";
  protected final String TEXT_136 = "\");";
  protected final String TEXT_137 = NL + "fw_";
  protected final String TEXT_138 = ".write(\"DELETE FROM \"+tableFullName_";
  protected final String TEXT_139 = "+\" \"+";
  protected final String TEXT_140 = "+\" ;\"+ \"";
  protected final String TEXT_141 = "\");";
  protected final String TEXT_142 = NL + NL;
  protected final String TEXT_143 = NL + "fw_";
  protected final String TEXT_144 = ".write(\".IMPORT INFILE \\\"\"+";
  protected final String TEXT_145 = " +\"\\\"\");" + NL + "fw_";
  protected final String TEXT_146 = ".write(\" FORMAT VARText '\"+";
  protected final String TEXT_147 = "+\"' LAYOUT customer_layout APPLY DML_LABEL;\"+ \"";
  protected final String TEXT_148 = "\");" + NL + "fw_";
  protected final String TEXT_149 = ".write(\".END MLOAD;\"+ \"";
  protected final String TEXT_150 = "\");" + NL + "fw_";
  protected final String TEXT_151 = ".write(\".LOGOFF;\"+ \"";
  ...
  protected final String TEXT_156 = "= new String(\"mload -c \"+";
  protected final String TEXT_157 = "+\" < \\\"\"+";
  protected final String TEXT_158 = "+";
  protected final String TEXT_159 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_160 = "+\"\\\" 2>&1\");";
  protected final String TEXT_161 = "\t" + NL + "String sb_";
  protected final String TEXT_162 = "= new String(\"mload < \\\"\"+";
  ...
  protected final String TEXT_167 = " - Executing command '\" + sb_";
  protected final String TEXT_168 = " + \"'.\");";
  protected final String TEXT_169 = NL + "final Process process_";
  protected final String TEXT_170 = " = Runtime.getRuntime().exec(new String[]{\"cmd\",\"/c\",sb_";
  protected final String TEXT_171 = "}); ";
  protected final String TEXT_172 = NL + "final Process process_";
  protected final String TEXT_173 = " = Runtime.getRuntime().exec(new String[]{\"sh\",\"-c\",sb_";
  protected final String TEXT_174 = "});";
  protected final String TEXT_175 = NL + "Thread normal_";
  ...
  protected final String TEXT_177 = ".getInputStream()));" + NL + "    \t\tString line = \"\";" + NL + "    \t\ttry {" + NL + "    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "    \t\t\t   System.out.println(line);" + NL + "    \t        }" + NL + "    \t    } finally {" + NL + "    \t         reader.close();" + NL + "    \t    }" + NL + "        }catch(java.io.IOException ioe) {";
  ...
  protected final String TEXT_186 = ".interrupt();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_187 = "_EXIT_VALUE\", process_";
  protected final String TEXT_188 = ".exitValue());" + NL;
  protected final String TEXT_189 = NL + "\tif(process_";
  protected final String TEXT_190 = ".exitValue()>=";
  protected final String TEXT_191 = ") {" + NL + "\t\tthrow new RuntimeException(\"Multiload returned exit code \"+process_";
  protected final String TEXT_192 = ".exitValue());" + NL + "\t}";
  protected final String TEXT_193 = NL + "    log.info(\"";
  protected final String TEXT_194 = " - Excute '\" + sb_";
  protected final String TEXT_195 = " + \"' has finished.\");";
  protected final String TEXT_196 = NL + "}finally{" + NL + "\ttry{" + NL + "\t\tfile_";
  protected final String TEXT_197 = ".delete();" + NL + "\t}catch(Exception e_";
