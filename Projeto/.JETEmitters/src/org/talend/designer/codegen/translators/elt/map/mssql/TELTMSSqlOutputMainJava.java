...
public class TELTMSSqlOutputMainJava
{
  ...
  protected final String TEXT_130 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_131 = ";" + NL + "    String dbUser_";
  protected final String TEXT_132 = " = ";
  protected final String TEXT_133 = ";" + NL;
  protected final String TEXT_134 = NL;
  protected final String TEXT_135 = NL + "    ";
  protected final String TEXT_136 = "String decryptedPassword_";
  protected final String TEXT_137 = " = null;";
  protected final String TEXT_138 = " " + NL + "\tdecryptedPassword_";
  protected final String TEXT_139 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_140 = ");";
  protected final String TEXT_141 = NL + "\tdecryptedPassword_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = "; ";
  protected final String TEXT_144 = NL + NL + "    String dbPwd_";
  protected final String TEXT_145 = " = decryptedPassword_";
  protected final String TEXT_146 = ";" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_147 = " = null;";
  protected final String TEXT_148 = NL;
  protected final String TEXT_149 = NL + NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_150 = " =null;" + NL + "\t";
  protected final String TEXT_151 = "\t" + NL + "\tString insertQuery_";
  protected final String TEXT_152 = " = \"INSERT INTO \"+tableName_";
  protected final String TEXT_153 = "+\"(";
  protected final String TEXT_154 = ")  (\"+select_query_";
  protected final String TEXT_155 = "+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_156 = " = conn_";
  protected final String TEXT_157 = ".prepareStatement(insertQuery_";
  protected final String TEXT_158 = ");" + NL;
  protected final String TEXT_159 = NL + "\tString updateQuery_";
  protected final String TEXT_160 = " = \"UPDATE \"+tableName_";
  protected final String TEXT_161 = "+\" SET ";
  protected final String TEXT_162 = " \"";
  protected final String TEXT_163 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_164 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".prepareStatement(updateQuery_";
  protected final String TEXT_167 = ");" + NL;
  protected final String TEXT_168 = NL + "\t" + NL + "\tString deleteQuery_";
  protected final String TEXT_169 = " = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_170 = "+\" WHERE EXISTS (\"+select_query_";
  protected final String TEXT_171 = "+\") \" " + NL + "\t";
  protected final String TEXT_172 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_173 = NL + "\t";
  protected final String TEXT_174 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_177 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_178 = NL + "int nb_line_";
  protected final String TEXT_179 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_180 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_181 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_182 = " = 0;" + NL + "\t";
  protected final String TEXT_183 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery_";
  protected final String TEXT_184 = " + \"\\n\");";
  protected final String TEXT_185 = " " + NL + "nb_line_inserted_";
  protected final String TEXT_186 = " = pstmt_";
  protected final String TEXT_187 = ".executeUpdate();";
  protected final String TEXT_188 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_189 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_190 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_191 = " +\"\\n\");";
  protected final String TEXT_192 = " " + NL + "nb_line_updated_";
  protected final String TEXT_193 = " = pstmt_";
  protected final String TEXT_194 = ".executeUpdate();";
  protected final String TEXT_195 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_196 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_197 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_198 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_199 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_200 = " = pstmt_";
  protected final String TEXT_201 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_202 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_203 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_204 = NL + NL + "pstmt_";
  protected final String TEXT_205 = ".close();" + NL;
  protected final String TEXT_206 = NL + "    if(conn_";
  protected final String TEXT_207 = " != null && !conn_";
  protected final String TEXT_208 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_209 = NL + "    }";
  protected final String TEXT_210 = NL + "nb_line_";
  protected final String TEXT_211 = " = nb_line_updated_";
  protected final String TEXT_212 = " + nb_line_inserted_";
  protected final String TEXT_213 = " + nb_line_deleted_";
