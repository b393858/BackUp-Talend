...
public class TAmazonOracleConnectionBeginJava
{
  ...
  protected final String TEXT_96 = NL + "        globalMap.put(\"host_\" + \"";
  protected final String TEXT_97 = "\",";
  protected final String TEXT_98 = ");" + NL + "        globalMap.put(\"port_\" + \"";
  protected final String TEXT_99 = "\",";
  protected final String TEXT_100 = ");" + NL + "        globalMap.put(\"dbname_\" + \"";
  ...
  protected final String TEXT_117 = NL + "\t\t\tString dbPwd_";
  protected final String TEXT_118 = " = decryptedPassword_";
  protected final String TEXT_119 = ";" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_121 = " = null;" + NL + "\t";
  protected final String TEXT_122 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_123 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_125 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_126 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_128 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_129 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_131 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_132 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_134 = " - Written records count: \" + nb_line_";
  protected final String TEXT_135 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_137 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_139 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_140 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_142 = " - Writing the record \" + nb_line_";
  protected final String TEXT_143 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_145 = " - Processing the record \" + nb_line_";
  protected final String TEXT_146 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_148 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_149 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_151 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_152 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_154 = " - Uses an existing connection ";
  protected final String TEXT_155 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_157 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_158 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  ...
  protected final String TEXT_170 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_171 = ");" + NL + "\t\t\t";
  protected final String TEXT_172 = NL + "\t\t\tconn_";
  protected final String TEXT_173 = ".rollback();" + NL + "\t\t\t";
  ...
  protected final String TEXT_179 = ".setAutoCommit(";
  protected final String TEXT_180 = ");" + NL + "\t\t\t";
  protected final String TEXT_181 = NL + "\t\t\t\tlog.";
  protected final String TEXT_182 = "(\"";
  protected final String TEXT_183 = " - \" + ";
  protected final String TEXT_184 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t    \t\tlog.";
  protected final String TEXT_186 = "(\"";
  protected final String TEXT_187 = "\");" + NL + "\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_189 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_191 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_192 = ": pstmt_";
  protected final String TEXT_193 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_194 = " += (countEach_";
  ...
  protected final String TEXT_199 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_200 = " == null) {";
  protected final String TEXT_201 = NL + "\t\t";
  protected final String TEXT_202 = NL + "\t\t";
  protected final String TEXT_203 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_204 = "\", conn_";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_207 = " = ";
  protected final String TEXT_208 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_209 = ".get(dsAlias_";
  protected final String TEXT_210 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_211 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_212 = " = dataSources_";
  protected final String TEXT_213 = ".get(dsAlias_";
  protected final String TEXT_214 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_215 = "\", conn_";
  protected final String TEXT_216 = ");" + NL + "\t}";
  protected final String TEXT_217 = NL + "\tif (null != conn_";
  protected final String TEXT_218 = ") {" + NL + "\t\t";
  protected final String TEXT_219 = NL + "\t}";
  protected final String TEXT_220 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_221 = "\",conn_";
  protected final String TEXT_222 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_223 = "\", ";
  protected final String TEXT_224 = ");" + NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_225 = "\",";
  protected final String TEXT_226 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
  protected final String TEXT_227 = "\",dbPwd_";
