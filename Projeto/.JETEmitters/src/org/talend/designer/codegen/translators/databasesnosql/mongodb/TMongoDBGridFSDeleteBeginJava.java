...
public class TMongoDBGridFSDeleteBeginJava
{
  protected static String nl;
  public static synchronized TMongoDBGridFSDeleteBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMongoDBGridFSDeleteBeginJava result = new TMongoDBGridFSDeleteBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_149 = NL + "\t    \t\torg.bson.Document gridFSQuery_";
  protected final String TEXT_150 = " = new org.bson.Document(\"filename\",";
  protected final String TEXT_151 = ");" + NL + "\t\t\t ";
  protected final String TEXT_152 = NL + "\t\t\t \torg.bson.Document gridFSQuery_";
  protected final String TEXT_153 = " = org.bson.Document.parse(";
  protected final String TEXT_154 = ");" + NL + "\t\t\t ";
  protected final String TEXT_155 = NL + "\t\t\t com.mongodb.client.gridfs.GridFSFindIterable gridfsFiles_";
  protected final String TEXT_156 = " = gridfs_";
  protected final String TEXT_157 = ".find(gridFSQuery_";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "    \t\tcom.mongodb.gridfs.GridFS gridfs_";
  protected final String TEXT_160 = " = new com.mongodb.gridfs.GridFS(db_";
  protected final String TEXT_161 = ", ";
  protected final String TEXT_162 = ");" + NL + "\t\t\tjava.util.List<";
  protected final String TEXT_163 = "> gridfsFiles_";
  protected final String TEXT_164 = ";" + NL + "\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\t\t" + NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_166 = " = gridfs_";
  protected final String TEXT_167 = ".find(";
  protected final String TEXT_168 = ");" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t\tcom.mongodb.DBObject gridFSQuery_";
  protected final String TEXT_170 = " = com.mongodb.BasicDBObject.parse(";
  protected final String TEXT_171 = ");" + NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_172 = " = gridfs_";
  protected final String TEXT_173 = ".find(gridFSQuery_";
  protected final String TEXT_174 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_175 = NL + NL + "\t\t\tfor(";
  protected final String TEXT_176 = " gridFSfile : gridfsFiles_";
