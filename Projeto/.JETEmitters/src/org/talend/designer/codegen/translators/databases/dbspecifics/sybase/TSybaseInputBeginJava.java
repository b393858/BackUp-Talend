...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_189 = " + \":\" + ";
  protected final String TEXT_190 = " + \";DatabaseName=\" + ";
  protected final String TEXT_191 = "; ";
  protected final String TEXT_192 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_193 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_194 = " + \":\" + ";
  protected final String TEXT_195 = " + \";DatabaseName\" + ";
  protected final String TEXT_196 = " + \";\" + ";
  protected final String TEXT_197 = ";";
  protected final String TEXT_198 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_199 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_200 = " + \":\" + ";
  protected final String TEXT_201 = " + \"/\" + ";
  protected final String TEXT_202 = ";";
  protected final String TEXT_203 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_204 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_217 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_218 = " =  conn_";
  protected final String TEXT_219 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_220 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_221 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_222 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_223 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_224 = NL + "                 conn_";
  protected final String TEXT_225 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_226 = NL + "               ";
  protected final String TEXT_227 = " + \"=\" + ";
  protected final String TEXT_228 = " + \";\" +";
  protected final String TEXT_229 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_230 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_231 = ");";
  protected final String TEXT_232 = NL + "\t\t    ";
  protected final String TEXT_233 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_234 = " = ";
  protected final String TEXT_235 = ";" + NL + "\t\t\t";
  protected final String TEXT_236 = NL + "                log.debug(\"";
  protected final String TEXT_237 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_244 = "_QUERY\",dbquery_";
  protected final String TEXT_245 = ");";
  protected final String TEXT_246 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_247 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_248 = " = stmt_";
  protected final String TEXT_249 = ".executeQuery(dbquery_";
  protected final String TEXT_250 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_251 = " = rs_";
  protected final String TEXT_252 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_253 = " = rsmd_";
  protected final String TEXT_254 = ".getColumnCount();" + NL;
  protected final String TEXT_255 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_256 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_257 = ".setDbmsId(\"";
  protected final String TEXT_258 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_259 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_260 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_261 = ".add(\"";
  protected final String TEXT_262 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_263 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_264 = " = ";
  protected final String TEXT_265 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_266 = "; i <= rsmd_";
  protected final String TEXT_267 = ".getColumnCount()-";
  protected final String TEXT_268 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_269 = ".contains(rsmd_";
  protected final String TEXT_270 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_271 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_272 = ".setName(rsmd_";
  protected final String TEXT_273 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_274 = ".setDbName(rsmd_";
  protected final String TEXT_275 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_276 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_277 = "\", rsmd_";
  protected final String TEXT_278 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_279 = ".getPrecision(i), rsmd_";
  protected final String TEXT_280 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setDbType(rsmd_";
  protected final String TEXT_282 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setDbTypeId(rsmd_";
  protected final String TEXT_284 = ".getColumnType(i));";
  protected final String TEXT_285 = NL + "                \tdcm_";
  protected final String TEXT_286 = ".setFormat(";
  protected final String TEXT_287 = ");";
  protected final String TEXT_288 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_289 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_290 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_291 = ".setLength(rsmd_";
  protected final String TEXT_292 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_293 = ".setLength(rsmd_";
  protected final String TEXT_294 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_295 = NL + "\t\t\tdcm_";
  protected final String TEXT_296 = ".setLength(rsmd_";
  protected final String TEXT_297 = ".getPrecision(i));";
  protected final String TEXT_298 = NL + "                \tdcm_";
  protected final String TEXT_299 = ".setPrecision(rsmd_";
  protected final String TEXT_300 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_301 = ".setNullable(rsmd_";
  protected final String TEXT_302 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_304 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_305 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_306 = ".metadatas.add(dcm_";
  ...
  protected final String TEXT_310 = NL + "\t\t    \tint column_index_";
  ...
  protected final String TEXT_326 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_327 = " < ";
  protected final String TEXT_328 = "column_index_";
  protected final String TEXT_329 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_330 = ".";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_333 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_336 = NL + "\t\t                            ";
  protected final String TEXT_337 = ".";
  protected final String TEXT_338 = " = (List)rs_";
  ...
  protected final String TEXT_345 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_346 = ".getObject(";
  protected final String TEXT_347 = "column_index_";
  protected final String TEXT_348 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_349 = NL + "                                    ";
  protected final String TEXT_350 = ".";
  protected final String TEXT_351 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_360 = ".setEPSG(";
  protected final String TEXT_361 = ");" + NL + "                                        }";
  protected final String TEXT_362 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_363 = NL + "                                  ";
  protected final String TEXT_364 = ".";
  protected final String TEXT_365 = "=dcg_";
  protected final String TEXT_366 = ";";
  protected final String TEXT_367 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_368 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_369 = " = ";
  protected final String TEXT_370 = "; i_";
  protected final String TEXT_371 = "  <= rsmd_";
  protected final String TEXT_372 = ".getColumnCount(); i_";
  protected final String TEXT_373 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_374 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_375 = ".getColumnTypeName(i_";
  protected final String TEXT_376 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_377 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_378 = ".getClob(i_";
  protected final String TEXT_379 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_380 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_381 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_382 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_383 = ".add(tNTextImpl_";
  protected final String TEXT_384 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_385 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_386 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_387 = ".getColumnTypeName(i_";
  protected final String TEXT_388 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_389 = ".add(rs_";
  protected final String TEXT_390 = ".getString(i_";
  protected final String TEXT_391 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_392 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_393 = ".";
  protected final String TEXT_394 = ", rs_";
  protected final String TEXT_395 = ", fixedColumnCount_";
  protected final String TEXT_396 = ",list_";
  protected final String TEXT_397 = ",";
  protected final String TEXT_398 = ");";
  protected final String TEXT_399 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = ", rs_";
  protected final String TEXT_402 = ", fixedColumnCount_";
  protected final String TEXT_403 = ",";
  protected final String TEXT_404 = ");";
  protected final String TEXT_405 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = ", rs_";
  protected final String TEXT_408 = ", fixedColumnCount_";
  protected final String TEXT_409 = ",";
  protected final String TEXT_410 = ");";
  protected final String TEXT_411 = NL + "                                  Object geom = rs_";
  protected final String TEXT_412 = ".getObject(";
  protected final String TEXT_413 = "column_index_";
  protected final String TEXT_414 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_415 = ".";
  protected final String TEXT_416 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_423 = " - Retrieving the record \" + nb_line_";
