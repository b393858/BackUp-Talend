...
public class TCosmosDBInputEndJava
{
  protected static String nl;
  public static synchronized TCosmosDBInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBInputEndJava result = new TCosmosDBInputEndJava();
    nl = null;
    return result;
  }
