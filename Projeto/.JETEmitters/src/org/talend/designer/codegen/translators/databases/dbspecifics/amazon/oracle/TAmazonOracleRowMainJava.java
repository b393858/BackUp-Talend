...
public class TAmazonOracleRowMainJava
{
  ...
  protected final String TEXT_89 = "==null))" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\tpstmt_";
  protected final String TEXT_90 = ".setNull(";
  protected final String TEXT_91 = ", java.sql.Types.TIMESTAMP);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\telse{" + NL + "\t\t\t\t\tpstmt_";
  ...
  protected final String TEXT_126 = ".getUpdateCount();";
  protected final String TEXT_127 = NL + "\t\tnb_line_deleted_";
  protected final String TEXT_128 = " += stmt_";
  protected final String TEXT_129 = ".getUpdateCount();";
  protected final String TEXT_130 = NL + "\t} catch (java.lang.Exception e) {" + NL + "\t\twhetherReject_";
  protected final String TEXT_131 = " = true;" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t\t\tthrow(e);" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\t";
  protected final String TEXT_134 = " = new ";
  protected final String TEXT_135 = "Struct();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_142 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  protected final String TEXT_143 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_144 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_146 = NL + "\t}" + NL + "\t";
  protected final String TEXT_147 = NL + "\tif(!whetherReject_";
  protected final String TEXT_148 = ") {" + NL + "\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t";
  protected final String TEXT_150 = " = new ";
  protected final String TEXT_151 = "Struct();" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_162 = NL + "\t\tcommitCounter_";
  protected final String TEXT_163 = "++;" + NL + "\t\tif(commitEvery_";
  protected final String TEXT_164 = " <= commitCounter_";
  protected final String TEXT_165 = ") {" + NL + "\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\tcommitCounter_";
  protected final String TEXT_167 = "=0;" + NL + "\t\t}" + NL + "\t\t";
