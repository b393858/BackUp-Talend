...
public class TMapRStreamsInputEndJava
{
  ...
  protected final String TEXT_6 = NL + "\t\t} // end for ConsumerRecord";
  protected final String TEXT_7 = NL + "\t\t// Stop reading if the maximum number of input messages has been reached." + NL + "\t\tif (tos_count_";
  protected final String TEXT_8 = " >= ";
  protected final String TEXT_9 = ") {" + NL + "\t\t    break;" + NL + "\t\t}";
  protected final String TEXT_10 = NL + "    // Immediately stop processing messagesDeadline if the max duration deadline has passed." + NL + "    if (System.currentTimeMillis() > maxDurationDeadline_";
  protected final String TEXT_11 = ")" + NL + "        break;";
  protected final String TEXT_12 = NL + "    } catch (org.apache.kafka.common.KafkaException e) {" + NL + "    \t";
  protected final String TEXT_13 = "\t" + NL + "\t\t\tlog.error(\"";
  protected final String TEXT_14 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_15 = NL + "\t\tbreak;" + NL + "\t}" + NL + "} // end while(true)";
