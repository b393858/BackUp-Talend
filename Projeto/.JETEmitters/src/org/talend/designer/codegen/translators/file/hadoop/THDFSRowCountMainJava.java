...
public class THDFSRowCountMainJava
{
  ...
  protected final String TEXT_149 = NL + "\t  String filename_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "\t  int emptyLineCount_";
  protected final String TEXT_152 = " = 0;" + NL + "\t  org.apache.hadoop.fs.Path file_";
  protected final String TEXT_153 = " = new org.apache.hadoop.fs.Path(filename_";
  protected final String TEXT_154 = ");" + NL + "\t  org.apache.hadoop.fs.FSDataInputStream fsdis_";
  protected final String TEXT_155 = " = fs_";
  protected final String TEXT_156 = ".open(file_";
  protected final String TEXT_157 = ");" + NL + "\t" + NL + "\t  int lineCount_";
  protected final String TEXT_158 = " = 0;" + NL + "\t  " + NL + "\t  ";
  protected final String TEXT_159 = NL + "\t  \tjava.io.BufferedReader br_";
  protected final String TEXT_160 = " = new java.io.BufferedReader(new java.io.InputStreamReader(fsdis_";
  protected final String TEXT_161 = ", ";
  protected final String TEXT_162 = "));" + NL + "\t  ";
  protected final String TEXT_163 = NL + "\t    org.apache.hadoop.io.compress.GzipCodec codec_";
  protected final String TEXT_164 = " = new org.apache.hadoop.io.compress.GzipCodec();" + NL + "\t\tcodec_";
  protected final String TEXT_165 = ".setConf(conf_";
  protected final String TEXT_166 = ");\t" + NL + "\t  ";
  protected final String TEXT_167 = NL + "\t  \torg.apache.hadoop.io.compress.CompressionCodec codec_";
  protected final String TEXT_168 = " = org.apache.hadoop.util.ReflectionUtils.newInstance(org.apache.hadoop.io.compress.BZip2Codec.class, conf_";
  protected final String TEXT_169 = ");" + NL + "\t  ";
  protected final String TEXT_170 = NL + "\t  \torg.apache.hadoop.io.compress.CompressionInputStream in";
  protected final String TEXT_171 = " = codec_";
  protected final String TEXT_172 = ".createInputStream(fsdis_";
  protected final String TEXT_173 = ");" + NL + "\t  \tjava.io.BufferedReader br_";
  protected final String TEXT_174 = " = new java.io.BufferedReader(new java.io.InputStreamReader(in";
  protected final String TEXT_175 = ", ";
  protected final String TEXT_176 = "));" + NL + "\t  ";
  protected final String TEXT_177 = NL + "\t  " + NL + "\t  \t\t\t" + NL + "\t  String rowSeparator_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = ";" + NL + "\t  byte[] bytes_";
  protected final String TEXT_180 = " = rowSeparator_";
  protected final String TEXT_181 = ".getBytes();" + NL + "\t  int index_";
  protected final String TEXT_182 = " = 0, oneChar_";
  protected final String TEXT_183 = " = 0, tipEmptyLineCount_";
  protected final String TEXT_184 = " = 0; " + NL + "\t  boolean bTipEmptyFlagOpen_";
  protected final String TEXT_185 = " = true, bReadyEOF_";
  protected final String TEXT_186 = " = false;" + NL + "\t\t\t" + NL + "\t  if(bytes_";
  protected final String TEXT_187 = ".length > 0) {" + NL + "\t    while ((oneChar_";
  protected final String TEXT_188 = " = br_";
  protected final String TEXT_189 = ".read()) != -1) {" + NL + "\t      if (oneChar_";
  protected final String TEXT_190 = " == bytes_";
  protected final String TEXT_191 = "[index_";
  protected final String TEXT_192 = "]) {" + NL + "\t      " + NL + "\t        if (index_";
  protected final String TEXT_193 = " < bytes_";
  protected final String TEXT_194 = ".length - 1){" + NL + "\t          index_";
  protected final String TEXT_195 = " ++ ;" + NL + "\t          continue; // match next char" + NL + "\t        }" + NL + "\t        " + NL + "\t        if (index_";
  protected final String TEXT_196 = " == bytes_";
  protected final String TEXT_197 = ".length - 1) {                  " + NL + "\t          lineCount_";
  protected final String TEXT_198 = "++;" + NL + "\t          if(bTipEmptyFlagOpen_";
  protected final String TEXT_199 = ") {" + NL + "\t            tipEmptyLineCount_";
  protected final String TEXT_200 = " ++;" + NL + "\t            emptyLineCount_";
  protected final String TEXT_201 = " ++;" + NL + "\t          }" + NL + "\t          bReadyEOF_";
  protected final String TEXT_202 = " = false; // next row must be have char(or EOF flag)" + NL + "\t          bTipEmptyFlagOpen_";
  protected final String TEXT_203 = " = true; " + NL + "\t          index_";
  protected final String TEXT_204 = " = 0;" + NL + "\t        }" + NL + "\t        " + NL + "\t      }else{      " + NL + "\t        bReadyEOF_";
  protected final String TEXT_205 = " = true;" + NL + "\t        bTipEmptyFlagOpen_";
  protected final String TEXT_206 = " = false;" + NL + "\t        tipEmptyLineCount_";
  protected final String TEXT_207 = " = 0;" + NL + "\t        index_";
  protected final String TEXT_208 = " = 0;        " + NL + "\t      }" + NL + "\t    }" + NL + "\t    " + NL + "\t    if (bReadyEOF_";
  protected final String TEXT_209 = ") lineCount_";
  protected final String TEXT_210 = " ++ ; // add last row if not end by row separator" + NL + "\t    " + NL + "\t    if (bTipEmptyFlagOpen_";
  protected final String TEXT_211 = ") {" + NL + "\t      lineCount_";
  protected final String TEXT_212 = " -= tipEmptyLineCount_";
  protected final String TEXT_213 = ";" + NL + "\t      emptyLineCount_";
  protected final String TEXT_214 = " -= tipEmptyLineCount_";
  protected final String TEXT_215 = ";" + NL + "\t    }          " + NL + "\t  }" + NL + "\t  br_";
  protected final String TEXT_216 = ".close();" + NL + "\t";
  protected final String TEXT_217 = NL + "  \tlineCount_";
  protected final String TEXT_218 = " -= emptyLineCount_";
  protected final String TEXT_219 = ";" + NL + "\t";
  protected final String TEXT_220 = "   " + NL + "  \tglobalMap.put(\"";
  protected final String TEXT_221 = "_COUNT\",lineCount_";
  protected final String TEXT_222 = ");" + NL + "  \t" + NL + "\t";
  protected final String TEXT_223 = NL + "\tlog.info(\"";
  protected final String TEXT_224 = " - file : \" + file_";
  protected final String TEXT_225 = " + \" line count is \" + lineCount_";
