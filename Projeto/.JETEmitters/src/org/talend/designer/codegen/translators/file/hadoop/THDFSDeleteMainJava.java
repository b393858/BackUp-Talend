...
public class THDFSDeleteMainJava
{
  ...
  protected final String TEXT_151 = ");" + NL + "\tif(fs_";
  protected final String TEXT_152 = ".exists(path_";
  protected final String TEXT_153 = ")){" + NL + "\t\tif(fs_";
  protected final String TEXT_154 = ".delete(path_";
  protected final String TEXT_155 = ", true)){" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_156 = "_CURRENT_STATUS\", \"Path deleted.\");" + NL + "\t\t\t" + NL + "\t    \t";
  protected final String TEXT_157 = NL + "            log.info(\"";
  protected final String TEXT_158 = " - directory or file : \" + path_";
  protected final String TEXT_159 = " + \" is deleted.\");";
  protected final String TEXT_160 = NL + "\t\t}else{" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_161 = "_CURRENT_STATUS\", \"No path deleted.\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_162 = NL + "            log.info(\"";
  protected final String TEXT_163 = " - fail to delete directory or file : \" + path_";
  protected final String TEXT_164 = " + \".\");";
  protected final String TEXT_165 = NL + "\t\t}" + NL + "\t}else{" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_166 = "_CURRENT_STATUS\", \"Path does not exist.\");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_167 = NL + "       \tlog.warn(\"";
  protected final String TEXT_168 = " - directory or file : \" + path_";
  protected final String TEXT_169 = " + \" does not exist.\");";
  protected final String TEXT_170 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_171 = "_DELETE_PATH\",";
  protected final String TEXT_172 = ");" + NL + "\t" + NL + "" + NL + "" + NL + "" + NL + "\t";
