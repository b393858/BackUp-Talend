package org.talend.designer.codegen.translators.databases.dbspecifics.javadb;
...
public class TJavaDBOutputBeginJava {
  ...
  protected final String TEXT_56 = " " + NL + "" + NL + "String jdbcDriver_";
  protected final String TEXT_57 = " = null;" + NL + "String url_";
  protected final String TEXT_58 = " = null;";
  protected final String TEXT_59 = NL + "\tjdbcDriver_";
  protected final String TEXT_60 = " = \"org.apache.derby.jdbc.EmbeddedDriver\";" + NL + "\turl_";
  protected final String TEXT_61 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_62 = ";" + NL + "\t//set the root path of the database" + NL + "\tSystem.setProperty(\"derby.system.home\",";
  protected final String TEXT_63 = ");" + NL + "\t";
  protected final String TEXT_64 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_65 = " = \"com.ibm.db2.jcc.DB2Driver\";" + NL + "\t\turl_";
  protected final String TEXT_66 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_67 = " + \":\" + ";
  protected final String TEXT_68 = " + \"/\" + ";
  protected final String TEXT_69 = ";" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_71 = " = \"org.apache.derby.jdbc.ClientDriver\";" + NL + "\t\turl_";
  protected final String TEXT_72 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_73 = " + \":\" + ";
  protected final String TEXT_74 = " + \"/\" + ";
  protected final String TEXT_75 = ";" + NL + "\t\t";
  protected final String TEXT_76 = NL + "\t";
  protected final String TEXT_77 = NL + "    \torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_78 = ";" + NL + "    \tserverControl_";
  protected final String TEXT_79 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_80 = "),Integer.parseInt(";
  protected final String TEXT_81 = "));" + NL + "    \t//start server" + NL + "    \tserverControl_";
  protected final String TEXT_82 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "    \tboolean isServerUp_";
  protected final String TEXT_83 = " = false;" + NL + "    \tint timeOut_";
  protected final String TEXT_84 = " = 5;" + NL + "    \twhile(!isServerUp_";
  protected final String TEXT_85 = " && timeOut_";
  protected final String TEXT_86 = " > 0) {" + NL + "    \t\ttry {" + NL + "    \t\t\ttimeOut_";
  protected final String TEXT_87 = "--;" + NL + "    \t\t\t/*" + NL + "    \t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t*/" + NL + "    \t\t\tserverControl_";
  protected final String TEXT_88 = ".ping();" + NL + "    \t\t\tisServerUp_";
  protected final String TEXT_89 = " = true;" + NL + "    \t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t}    \t\t\t\t" + NL + "    \t}" + NL + "    \tif(!isServerUp_";
  protected final String TEXT_90 = ") {" + NL + "    \t\t/*" + NL + "    \t\t * can not obtain a connection to network server." + NL + "    \t\t */ \t " + NL + "    \t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "    \t}" + NL + "    \t//derby network server started." + NL + "\t";
  protected final String TEXT_91 = NL + NL + "int nb_line_";
  protected final String TEXT_92 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_93 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_94 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_95 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_96 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_97 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_98 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_99 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_100 = " = ";
  protected final String TEXT_101 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_102 = " = false;" + NL + "" + NL + "Class.forName(jdbcDriver_";
  protected final String TEXT_103 = ").newInstance();";
  protected final String TEXT_104 = NL + "java.util.Properties properties_";
  protected final String TEXT_105 = " = new java.util.Properties();" + NL + "properties_";
  protected final String TEXT_106 = ".put(\"user\",";
  ...
  protected final String TEXT_115 = NL + "  " + NL + "" + NL + "properties_";
  protected final String TEXT_116 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_120 = ",properties_";
  ...
  protected final String TEXT_126 = ".setAutoCommit(false);";
  protected final String TEXT_127 = NL + "        ";
  protected final String TEXT_128 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_140 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_149 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_150 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_151 = " = dbMetaData_";
  protected final String TEXT_152 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_158 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  protected final String TEXT_159 = NL + "                if(!whetherExist_";
  protected final String TEXT_160 = ") {" + NL + "                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_168 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_174 = NL + "                    }" + NL + "                }" + NL + "" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_181 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_190 = NL + "\t    String insert_";
  protected final String TEXT_191 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_192 = " + \"\\\" (";
  protected final String TEXT_193 = ") VALUES (";
  protected final String TEXT_194 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_195 = " = conn_";
  protected final String TEXT_196 = ".prepareStatement(insert_";
  protected final String TEXT_197 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_204 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".prepareStatement(update_";
  protected final String TEXT_207 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_208 = "\", pstmt_";
  protected final String TEXT_209 = ");" + NL + "\t    ";
  protected final String TEXT_210 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_213 = " + \"\\\" WHERE ";
  protected final String TEXT_214 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_215 = "\", pstmt_";
  protected final String TEXT_216 = ");" + NL + "\t    String insert_";
  protected final String TEXT_217 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_218 = " + \"\\\" (";
  protected final String TEXT_219 = ") VALUES (";
  protected final String TEXT_220 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".prepareStatement(insert_";
  protected final String TEXT_223 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_224 = "\", pstmtInsert_";
  protected final String TEXT_225 = ");" + NL + "\t    String update_";
  protected final String TEXT_226 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_227 = " + \"\\\" SET ";
  protected final String TEXT_228 = " WHERE ";
  protected final String TEXT_229 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".prepareStatement(update_";
  protected final String TEXT_232 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_233 = "\", pstmtUpdate_";
  protected final String TEXT_234 = ");" + NL + "\t    ";
  protected final String TEXT_235 = NL + "\t    String update_";
  protected final String TEXT_236 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_237 = " + \"\\\" SET ";
  protected final String TEXT_238 = " WHERE ";
  protected final String TEXT_239 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".prepareStatement(update_";
  protected final String TEXT_242 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_243 = "\", pstmtUpdate_";
  protected final String TEXT_244 = ");" + NL + "\t    String insert_";
  protected final String TEXT_245 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_246 = " + \"\\\" (";
  protected final String TEXT_247 = ") VALUES (";
  protected final String TEXT_248 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_249 = " = conn_";
  protected final String TEXT_250 = ".prepareStatement(insert_";
  protected final String TEXT_251 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_252 = "\", pstmtInsert_";
  protected final String TEXT_253 = ");" + NL + "\t    ";
  protected final String TEXT_254 = NL + "\t    String delete_";
  protected final String TEXT_255 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_256 = " + \"\\\" WHERE ";
  protected final String TEXT_257 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_258 = " = conn_";
  protected final String TEXT_259 = ".prepareStatement(delete_";
  protected final String TEXT_260 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_261 = "\", pstmt_";
  protected final String TEXT_262 = ");" + NL + "\t    ";
  protected final String TEXT_263 = NL + "        StringBuffer query_";
  protected final String TEXT_264 = " = null;";
  protected final String TEXT_265 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_266 = " = insert_";
  protected final String TEXT_267 = ".split(\"\\\\?\");";
  protected final String TEXT_268 = NL + "\t\t\tupdate_";
  protected final String TEXT_269 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_270 = " = update_";
  protected final String TEXT_271 = ".split(\"\\\\?\");";
  protected final String TEXT_272 = NL + "\t\t\tupdate_";
  protected final String TEXT_273 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_274 = " = update_";
  protected final String TEXT_275 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_276 = " = insert_";
  protected final String TEXT_277 = ".split(\"\\\\?\");";
  protected final String TEXT_278 = NL + "\t\t\tdelete_";
  protected final String TEXT_279 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_280 = " = delete_";
  protected final String TEXT_281 = ".split(\"\\\\?\");";
  protected final String TEXT_282 = NL + "\t\t\treplace_";
  protected final String TEXT_283 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_284 = " = replace_";
  protected final String TEXT_285 = ".split(\"\\\\?\");";
  protected final String TEXT_286 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_287 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_288 = " = insertIgnore_";
  protected final String TEXT_289 = ".split(\"\\\\?\");";
  protected final String TEXT_290 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_291 = " = insert_";
  protected final String TEXT_292 = ".split(\"\\\\?\");";
  protected final String TEXT_293 = NL + NL + "        int commitEvery_";
  protected final String TEXT_294 = " = ";
  protected final String TEXT_295 = ";" + NL + "" + NL + "        int commitCounter_";
