...
public class TMongoDBGridFSListBeginJava
{
  ...
  protected final String TEXT_145 = NL + "    " + NL + "    \tcom.mongodb.client.gridfs.GridFSBucket gridfs_";
  protected final String TEXT_146 = " = com.mongodb.client.gridfs.GridFSBuckets.create(db_";
  protected final String TEXT_147 = ", ";
  protected final String TEXT_148 = ");" + NL + "    \torg.bson.Document gridFSQuery_";
  protected final String TEXT_149 = " = org.bson.Document.parse(";
  protected final String TEXT_150 = ");" + NL + "    \torg.bson.Document sortField_";
  protected final String TEXT_151 = " = new org.bson.Document(\"";
  protected final String TEXT_152 = "\", ";
  protected final String TEXT_153 = ");" + NL + "    \tcom.mongodb.client.MongoCursor<com.mongodb.client.gridfs.model.GridFSFile>\tfilesCursor_";
  protected final String TEXT_154 = " = gridfs_";
  protected final String TEXT_155 = ".find(gridFSQuery_";
  protected final String TEXT_156 = ").sort(sortField_";
  protected final String TEXT_157 = ").iterator();" + NL + "    \t" + NL + "             while(filesCursor_";
  protected final String TEXT_158 = ".hasNext()){" + NL + "                 com.mongodb.client.gridfs.model.GridFSFile file_";
  protected final String TEXT_159 = " = filesCursor_";
  protected final String TEXT_160 = ".next();" + NL + "\t\t\t\t nb_line_";
  protected final String TEXT_161 = "++;";
  protected final String TEXT_162 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_163 = " - Current file \" + file_";
  protected final String TEXT_164 = ".getFilename());";
  protected final String TEXT_165 = NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_166 = "_CURRENT_FILEID\", file_";
  protected final String TEXT_167 = ".getObjectId().toString());" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_168 = "_CURRENT_FILENAME\", file_";
  protected final String TEXT_169 = ".getFilename());" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_170 = "_CURRENT_FILEUPLOADDATE\", file_";
  protected final String TEXT_171 = ".getUploadDate());" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_172 = "_CURRENT_FILELENGTH\", file_";
  protected final String TEXT_173 = ".getLength());" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_174 = "_CURRENT_FILEMD5\", file_";
  protected final String TEXT_175 = ".getMD5());" + NL;
  protected final String TEXT_176 = NL + "\t\t\tcom.mongodb.gridfs.GridFS gridfs_";
  protected final String TEXT_177 = " = new com.mongodb.gridfs.GridFS(db_";
  protected final String TEXT_178 = ", ";
  protected final String TEXT_179 = ");" + NL + "\t\t\tcom.mongodb.DBObject gridFSQuery_";
  protected final String TEXT_180 = " = com.mongodb.BasicDBObject.parse(";
  protected final String TEXT_181 = ");" + NL + "\t\t\tcom.mongodb.DBCursor filesCursor_";
  protected final String TEXT_182 = " = gridfs_";
  protected final String TEXT_183 = ".getFileList(gridFSQuery_";
  protected final String TEXT_184 = ");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\tcom.mongodb.DBObject sortField_";
  protected final String TEXT_186 = " = new com.mongodb.BasicDBObject();" + NL + "\t\t\tsortField_";
  protected final String TEXT_187 = ".put(\"";
  protected final String TEXT_188 = "\", ";
  protected final String TEXT_189 = ");" + NL + "\t\t\tfilesCursor_";
  protected final String TEXT_190 = " = filesCursor_";
  protected final String TEXT_191 = ".sort(sortField_";
  protected final String TEXT_192 = ");" + NL + "" + NL + "\t\t\twhile(filesCursor_";
  protected final String TEXT_193 = ".hasNext()){" + NL + "\t\t\t\tcom.mongodb.DBObject file_";
  protected final String TEXT_194 = " = filesCursor_";
  protected final String TEXT_195 = ".next();" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_196 = "++;";
  protected final String TEXT_197 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_198 = " - Current file \" + file_";
  protected final String TEXT_199 = ".get(\"filename\"));";
  protected final String TEXT_200 = NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_201 = "_CURRENT_FILEID\", (String) file_";
  protected final String TEXT_202 = ".get(\"_id\").toString() );" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_203 = "_CURRENT_FILENAME\", (String) file_";
  protected final String TEXT_204 = ".get(\"filename\"));" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_205 = "_CURRENT_FILEUPLOADDATE\", (java.util.Date) file_";
  protected final String TEXT_206 = ".get(\"uploadDate\"));" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_207 = "_CURRENT_FILELENGTH\", (Long) file_";
  protected final String TEXT_208 = ".get(\"length\"));" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_209 = "_CURRENT_FILEMD5\", (String) file_";
  protected final String TEXT_210 = ".get(\"md5\"));";
