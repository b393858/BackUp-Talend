...
public class TPivotToColumnsDelimitedBeginJava {
  ...
  protected final String TEXT_89 = " = new StringBuilder();" + NL + "" + NL + "java.util.Set<java.util.List<String>> group_Keys";
  protected final String TEXT_90 = " = new java.util.LinkedHashSet<java.util.List<String>>();" + NL + "" + NL + "java.util.List<String> gKvalue";
