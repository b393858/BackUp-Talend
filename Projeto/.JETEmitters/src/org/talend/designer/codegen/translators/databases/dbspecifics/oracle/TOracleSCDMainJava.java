...
public class TOracleSCDMainJava {
  ...
  protected final String TEXT_175 = "Struct();" + NL + "                " + NL + "                new Helper65535_";
  protected final String TEXT_176 = "().propagate(";
  protected final String TEXT_177 = ", ";
  protected final String TEXT_178 = ");" + NL + "                " + NL + "                nb_line_rejected_";
  ...
  protected final String TEXT_186 = NL + "\t}//end catch" + NL + "    ";
...
if(inputSchema != null && inputSchema.size() > 0 && outputSchema != null && outputSchema.size() > 0) {
    ...
    stringBuffer.append(TEXT_34);
			    	...
			    	if("ORACLE_18".equals(dbVersion) || "ORACLE_11".equals(dbVersion) || "ORACLE_12".equals(dbVersion) || "ORACLE_10".equals(dbVersion)){
			    		supportTSTZ = true;
			    	}
