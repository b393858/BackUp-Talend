...
public class TTeradataConnectionBeginJava
{
  ...
  protected final String TEXT_33 = NL + "                if(log.is";
  protected final String TEXT_34 = "Enabled())";
  ...
  protected final String TEXT_41 = NL + "            if (log.isDebugEnabled()) {" + NL + "                class BytesLimit65535_";
  protected final String TEXT_42 = "{" + NL + "                    public void limitLog4jByte() throws Exception{" + NL + "                    StringBuilder ";
  protected final String TEXT_43 = " = new StringBuilder();";
  protected final String TEXT_44 = NL + "                    ";
  protected final String TEXT_45 = ".append(\"Parameters:\");";
  protected final String TEXT_46 = NL + "                            ";
  protected final String TEXT_47 = ".append(\"";
  protected final String TEXT_48 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_49 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_56 = NL + "                    } " + NL + "                } " + NL + "            new BytesLimit65535_";
  protected final String TEXT_57 = "().limitLog4jByte();" + NL + "            }";
  protected final String TEXT_58 = NL + "            StringBuilder ";
  protected final String TEXT_59 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_68 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_76 = NL + "\t\tString dbProperties_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "\t\tString url_";
  protected final String TEXT_79 = " = null;" + NL + "\t\tif(dbProperties_";
  ...
  protected final String TEXT_84 = ";" + NL + "\t\t} else {" + NL + "\t\t    url_";
  protected final String TEXT_85 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_86 = " + \"/DATABASE=\" + ";
  ...
  protected final String TEXT_103 = NL + "\t\t\tString dbPwd_";
  ...
  protected final String TEXT_109 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_111 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_112 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_114 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_115 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_117 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_118 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_120 = " - Written records count: \" + nb_line_";
  protected final String TEXT_121 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_123 = " = new StringBuffer();" + NL + "\t\t\t";
  ...
  protected final String TEXT_128 = " - Writing the record \" + nb_line_";
  protected final String TEXT_129 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_131 = " - Processing the record \" + nb_line_";
  protected final String TEXT_132 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_134 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_135 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_137 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_138 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_140 = " - Uses an existing connection ";
  protected final String TEXT_141 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_143 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_144 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_146 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_147 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_148 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_156 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_157 = ");" + NL + "\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\tconn_";
  protected final String TEXT_159 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\tconn_";
  ...
  protected final String TEXT_167 = NL + "\t\t\t\tlog.";
  protected final String TEXT_168 = "(\"";
  protected final String TEXT_169 = " - \" + ";
  protected final String TEXT_170 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_171 = NL + "\t    \t\tlog.";
  protected final String TEXT_172 = "(\"";
  protected final String TEXT_173 = "\");" + NL + "\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_175 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_176 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_177 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_178 = ": pstmt_";
  protected final String TEXT_179 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_180 = " += (countEach_";
  protected final String TEXT_181 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_185 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_186 = " == null) {";
  protected final String TEXT_187 = NL + "\t\t";
  protected final String TEXT_188 = NL + "\t\t";
  protected final String TEXT_189 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_190 = "\", conn_";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_193 = " = ";
  protected final String TEXT_194 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_195 = ".get(dsAlias_";
  protected final String TEXT_196 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_197 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_198 = " = dataSources_";
  protected final String TEXT_199 = ".get(dsAlias_";
  protected final String TEXT_200 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_208 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_209 = "\", ";
  protected final String TEXT_210 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_211 = "\", ";
  protected final String TEXT_212 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_213 = "\", dbUser_";
  protected final String TEXT_214 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_215 = "\", dbPwd_";
  protected final String TEXT_216 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_217 = "\", url_";
  protected final String TEXT_218 = ");";
  protected final String TEXT_219 = NL;
  protected final String TEXT_220 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_221 = " =  conn_";
  protected final String TEXT_222 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_223 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_224 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_225 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_226 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_227 = NL + "                 conn_";
  protected final String TEXT_228 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_229 = NL + "               ";
  protected final String TEXT_230 = " + \"=\" + ";
  protected final String TEXT_231 = " + \";\" +";
  protected final String TEXT_232 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_233 = ".setAutoCommit(currentAutoCommitMode";
