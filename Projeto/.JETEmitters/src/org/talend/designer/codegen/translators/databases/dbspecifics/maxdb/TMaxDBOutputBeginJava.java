...
public class TMaxDBOutputBeginJava {
  ...
  protected final String TEXT_68 = " = false;" + NL + "java.lang.Class.forName(\"com.sap.dbtech.jdbc.DriverSapDB\");";
  protected final String TEXT_69 = NL + "String url_";
  protected final String TEXT_70 = " = \"jdbc:sapdb://\" + ";
  ...
  protected final String TEXT_86 = NL + "java.sql.Connection conn_";
  protected final String TEXT_87 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_88 = ",dbUser_";
  protected final String TEXT_89 = ",dbPwd_";
  protected final String TEXT_90 = ");";
  protected final String TEXT_91 = NL + NL + "resourceMap.put(\"conn_";
  protected final String TEXT_92 = "\", conn_";
  protected final String TEXT_93 = ");" + NL;
  protected final String TEXT_94 = NL + "                     conn_";
  protected final String TEXT_95 = ".setAutoCommit(false);";
  protected final String TEXT_96 = NL;
  protected final String TEXT_97 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_98 = " = conn_";
  protected final String TEXT_99 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_100 = " = conn_";
  protected final String TEXT_101 = ".createStatement()) {";
  protected final String TEXT_102 = NL + "                stmtDrop_";
  ...
  protected final String TEXT_109 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_118 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_119 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_127 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  protected final String TEXT_128 = NL + "                if(!whetherExist_";
  protected final String TEXT_129 = ") {" + NL + "                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_143 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_150 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement()) {";
  protected final String TEXT_153 = NL + "                deletedCount_";
  protected final String TEXT_154 = " = deletedCount_";
  protected final String TEXT_155 = " + stmtClear_";
  protected final String TEXT_156 = ".executeUpdate(\"";
  protected final String TEXT_157 = "\");";
  protected final String TEXT_158 = NL + "            }";
  protected final String TEXT_159 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "                    java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_162 = " = stmtTruncCount_";
  protected final String TEXT_163 = ".executeQuery(\"";
  protected final String TEXT_164 = "\");" + NL + "                    java.sql.Statement stmtTrunc_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement()) {";
  protected final String TEXT_167 = NL + "                stmtTrunc_";
  protected final String TEXT_168 = ".executeUpdate(\"";
  protected final String TEXT_169 = "\");";
  protected final String TEXT_170 = NL + "                while(rsTruncCount_";
  protected final String TEXT_171 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_172 = " += rsTruncCount_";
  protected final String TEXT_173 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_174 = NL + "\t    String insert_";
  protected final String TEXT_175 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_181 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_191 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_196 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_197 = " + \" WHERE ";
  protected final String TEXT_198 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_207 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_208 = "\", pstmtInsert_";
  protected final String TEXT_209 = ");" + NL + "\t    String update_";
  protected final String TEXT_210 = " = \"UPDATE \" + ";
  protected final String TEXT_211 = " + \" SET ";
  protected final String TEXT_212 = " WHERE ";
  protected final String TEXT_213 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".prepareStatement(update_";
  protected final String TEXT_216 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_217 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_226 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_227 = "\", pstmtUpdate_";
  protected final String TEXT_228 = ");" + NL + "\t    String insert_";
  protected final String TEXT_229 = " = \"INSERT INTO \" + ";
  protected final String TEXT_230 = " + \" (";
  protected final String TEXT_231 = ") VALUES (";
  protected final String TEXT_232 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".prepareStatement(insert_";
  protected final String TEXT_235 = ");\t\t" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_236 = "\", pstmtInsert_";
  protected final String TEXT_237 = ");" + NL + "\t    ";
  protected final String TEXT_238 = NL + "\t    String delete_";
  protected final String TEXT_239 = " = \"DELETE FROM \" + ";
  protected final String TEXT_240 = " + \" WHERE ";
  protected final String TEXT_241 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".prepareStatement(delete_";
  protected final String TEXT_244 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_245 = "\", pstmt_";
  protected final String TEXT_246 = ");" + NL + "\t    ";
  protected final String TEXT_247 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_252 = NL + "\t\t\tupdate_";
  protected final String TEXT_253 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_254 = " = update_";
  protected final String TEXT_255 = ".split(\"\\\\?\");";
  protected final String TEXT_256 = NL + "\t\t\tupdate_";
  protected final String TEXT_257 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_258 = " = update_";
  protected final String TEXT_259 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_260 = " = insert_";
  protected final String TEXT_261 = ".split(\"\\\\?\");";
  protected final String TEXT_262 = NL + "\t\t\tdelete_";
  protected final String TEXT_263 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_264 = " = delete_";
  protected final String TEXT_265 = ".split(\"\\\\?\");";
  protected final String TEXT_266 = NL + "\t\t\treplace_";
  protected final String TEXT_267 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_268 = " = replace_";
  protected final String TEXT_269 = ".split(\"\\\\?\");";
  protected final String TEXT_270 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_271 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_272 = " = insertIgnore_";
  protected final String TEXT_273 = ".split(\"\\\\?\");";
  protected final String TEXT_274 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_275 = " = insert_";
  protected final String TEXT_276 = ".split(\"\\\\?\");";
  protected final String TEXT_277 = NL + "        int commitEvery_";
  protected final String TEXT_278 = " = ";
  protected final String TEXT_279 = ";" + NL + "        int commitCounter_";
