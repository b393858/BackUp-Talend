...
public class TCosmosDBWriteConfFinallyJava
{
  protected static String nl;
  public static synchronized TCosmosDBWriteConfFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBWriteConfFinallyJava result = new TCosmosDBWriteConfFinallyJava();
    nl = null;
    return result;
  }
