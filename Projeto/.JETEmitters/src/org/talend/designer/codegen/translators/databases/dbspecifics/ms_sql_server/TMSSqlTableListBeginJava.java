...
public class TMSSqlTableListBeginJava
{
  ...
  protected final String TEXT_79 = NL + "String dbSchema_";
  protected final String TEXT_80 = " = (String)globalMap.get(\"";
  protected final String TEXT_81 = "\");" + NL + "" + NL + "String whereClause_";
  ...
  protected final String TEXT_86 = ".length() > 0){" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_87 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE' AND table_schema='\" + dbSchema_";
  protected final String TEXT_88 = " + \"'\";" + NL + "\t" + NL + "}else{" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_89 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE'\";" + NL + "\t" + NL + "}" + NL + "if(whereClause_";
  protected final String TEXT_90 = " != null && whereClause_";
  protected final String TEXT_91 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_92 = " = query_";
  protected final String TEXT_93 = " + \" AND (\" + whereClause_";
  protected final String TEXT_94 = " + \") ORDER BY table_name ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_95 = " = query_";
  protected final String TEXT_96 = " + \" ORDER BY table_name ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_97 = NL + "    log.info(\"";
  protected final String TEXT_98 = " - Query:'\"+query_";
  protected final String TEXT_99 = "+\"'.\");";
  protected final String TEXT_100 = NL + NL + "int nb_table_";
  protected final String TEXT_101 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_104 = " = stmt2_";
  protected final String TEXT_105 = ".executeQuery(query_";
  protected final String TEXT_106 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_107 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_108 = " = rs_";
  protected final String TEXT_109 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_110 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_111 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_112 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_113 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_114 = " - Name of table \"+nb_table_";
  protected final String TEXT_115 = "+\":\"+currentTableName_";
  protected final String TEXT_116 = "+\".\");" + NL + "\t";
  protected final String TEXT_117 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_118 = "_CURRENT_TABLE\", currentTableName_";
