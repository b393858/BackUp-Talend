...
public class TMapRDBInputEndJava
{
  protected static String nl;
  public static synchronized TMapRDBInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapRDBInputEndJava result = new TMapRDBInputEndJava();
    nl = null;
    return result;
  }
