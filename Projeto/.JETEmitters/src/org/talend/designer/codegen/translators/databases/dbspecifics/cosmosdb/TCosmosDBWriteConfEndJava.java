...
public class TCosmosDBWriteConfEndJava
{
  protected static String nl;
  public static synchronized TCosmosDBWriteConfEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBWriteConfEndJava result = new TCosmosDBWriteConfEndJava();
    nl = null;
    return result;
  }
