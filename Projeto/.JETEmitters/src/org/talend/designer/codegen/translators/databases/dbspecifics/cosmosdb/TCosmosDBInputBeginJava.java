...
public class TCosmosDBInputBeginJava
{
  ...
  protected final String TEXT_30 = NL + "final String applicationName_";
  protected final String TEXT_31 = " = \"Talend\";" + NL + "\tint nb_line_";
  protected final String TEXT_32 = " = 0;" + NL + "\t";
  protected final String TEXT_33 = NL + "\t\t\tcom.mongodb.Mongo mongo_";
  protected final String TEXT_34 = "=null;" + NL + "\t\t\tcom.mongodb.DB db_";
  protected final String TEXT_35 = "=null;" + NL + "\t\t\t";
  protected final String TEXT_36 = NL + "\t\t\t\tmongo_";
  protected final String TEXT_37 = "=(com.mongodb.Mongo)globalMap.get(\"mongo_";
  protected final String TEXT_38 = "\");" + NL + "\t\t\t\tdb_";
  protected final String TEXT_39 = " = (com.mongodb.DB) globalMap.get(\"db_";
  protected final String TEXT_40 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_41 = "\t" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_42 = " - Get an existing client from \" + \"";
  protected final String TEXT_43 = "\" + \".\");" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_44 = " - Get an existing DB from \" + \"";
  protected final String TEXT_45 = "\" + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\ttry{ // link with the \"finally\" on the \"finally.javajet\"" + NL + "\t\t\t\t";
  protected final String TEXT_47 = NL + NL + "                // Empty client options" + NL + "                com.mongodb.MongoClientOptions clientOptions_";
  protected final String TEXT_48 = " = new com.mongodb.MongoClientOptions.Builder().applicationName(applicationName_";
  protected final String TEXT_49 = ").build();";
  protected final String TEXT_50 = NL + "                    clientOptions_";
  protected final String TEXT_51 = " = new com.mongodb.MongoClientOptions.Builder().applicationName(applicationName_";
  protected final String TEXT_52 = ")" + NL + "                    .socketFactory(javax.net.ssl.SSLSocketFactory.getDefault())" + NL + "                    .build();";
  protected final String TEXT_53 = NL + "                // Empty client credentials list" + NL + "                java.util.List<com.mongodb.MongoCredential> mongoCredentialList_";
  protected final String TEXT_54 = " = new java.util.ArrayList<com.mongodb.MongoCredential>();" + NL;
  protected final String TEXT_55 = NL + "                    com.mongodb.MongoCredential mongoCredential_";
  ...
  protected final String TEXT_64 = " = com.mongodb.MongoCredential.createCredential(";
  ...
  protected final String TEXT_93 = "(addrs_";
  protected final String TEXT_94 = ", mongoCredentialList_";
  protected final String TEXT_95 = ", clientOptions_";
  protected final String TEXT_96 = ");";
  protected final String TEXT_97 = NL + "                    com.mongodb.ServerAddress serverAddress_";
  protected final String TEXT_98 = " = new com.mongodb.ServerAddress(";
  protected final String TEXT_99 = ", ";
  protected final String TEXT_100 = ");" + NL + "                    mongo_";
  protected final String TEXT_101 = " = new ";
  protected final String TEXT_102 = "(serverAddress_";
  protected final String TEXT_103 = ", mongoCredentialList_";
  protected final String TEXT_104 = ", clientOptions_";
  ...
  protected final String TEXT_121 = NL + "\t\t            mongo_";
  protected final String TEXT_122 = ".addOption(com.mongodb.Bytes.QUERYOPTION_NOTIMEOUT);" + NL + "\t\t        ";
  protected final String TEXT_123 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_124 = " - Connecting to \" + mongo_";
  protected final String TEXT_125 = ".getServerAddressList() + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_126 = NL + NL + "\t\t\t\tcom.mongodb.DBCollection coll_";
  protected final String TEXT_127 = " = db_";
  protected final String TEXT_128 = ".getCollection(";
  protected final String TEXT_129 = ");" + NL + "\t\t\t\t" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t// Add warning if an index is not in the query." + NL + "\t\t\t\t\tboolean needIndexWarning = true;" + NL + "\t\t\t\t\tString indexList = \"\";" + NL + "\t                for (com.mongodb.DBObject index: coll_";
  protected final String TEXT_130 = ".getIndexInfo()) {" + NL + "\t                    for (String key: ((com.mongodb.DBObject)index.get(\"key\")).keySet()) {" + NL + "\t                        // The regexp is:" + NL + "\t                        // - contain the db DBcolumnName between two backslashed quotes" + NL + "\t                        // - is followed at some point by a colon" + NL + "\t                        // - there is no comma between the the DBcolumnName and the colon" + NL + "\t                        if  ((";
  protected final String TEXT_131 = ").matches(\".*\" + key + \"[^,]*:.*\")) {" + NL + "\t                            // We have an index, do not print error message" + NL + "\t                            needIndexWarning = false;" + NL + "\t                        } else {" + NL + "\t                            // This index is not in the query, add it into the indexList" + NL + "\t                            indexList += \", \" + key;" + NL + "\t                        }" + NL + "\t                    }" + NL + "\t                }" + NL + "\t                if ((!\"\".equals(indexList)) && (needIndexWarning)) {" + NL + "\t                    ";
  protected final String TEXT_132 = NL + "\t                        log.warn(\"";
  protected final String TEXT_133 = " - The query does not contain any reference an index.  [\" + indexList.substring(1) + \" ]\");" + NL + "\t                        ";
  protected final String TEXT_134 = NL + "\t                        System.err.println(\"";
  protected final String TEXT_135 = " - The query does not contain any reference an index.  [\" + indexList.substring(1) + \" ]\");" + NL + "\t                        ";
  protected final String TEXT_136 = NL + "\t                }" + NL + "\t            }catch(com.mongodb.MongoException e){" + NL + "\t            \t// caught an exception after issuing the getIndexInfo()" + NL + "\t            \t// don't fail the whole job" + NL + "\t            \t// maybe due to authorization" + NL + "\t            }" + NL;
  protected final String TEXT_137 = NL + "\t                \tjava.util.List<com.mongodb.DBObject> aggregationStages = new java.util.ArrayList<com.mongodb.DBObject>();" + NL + "\t                ";
  protected final String TEXT_138 = NL + "\t                \taggregationStages.add((com.mongodb.DBObject) com.mongodb.util.JSON.parse(";
  protected final String TEXT_139 = "));" + NL + "\t                ";
  protected final String TEXT_140 = NL + "\t                com.mongodb.Cursor cursor_";
  protected final String TEXT_141 = " = coll_";
  protected final String TEXT_142 = ".aggregate(aggregationStages, com.mongodb.AggregationOptions.builder().outputMode(com.mongodb.AggregationOptions.OutputMode.CURSOR).allowDiskUse(";
  protected final String TEXT_143 = ").build());" + NL + "\t                ";
  protected final String TEXT_144 = NL + "\t                com.mongodb.DBObject myQuery_";
  protected final String TEXT_145 = " = (com.mongodb.DBObject) com.mongodb.util.JSON.parse(";
  protected final String TEXT_146 = ");" + NL + "\t\t    \t\tcom.mongodb.DBObject fields_";
  protected final String TEXT_147 = " = new com.mongodb.BasicDBObject();" + NL + "\t\t  \t\t\tcom.mongodb.DBCursor cursor_";
  protected final String TEXT_148 = " = coll_";
  protected final String TEXT_149 = ".find(myQuery_";
  protected final String TEXT_150 = ", fields_";
  protected final String TEXT_151 = ");" + NL + "\t                ";
  protected final String TEXT_152 = NL + "\t\t\t\t" + NL + "\t\t\t\tclass DBObjectInputUtil_";
  protected final String TEXT_153 = "{" + NL + "\t\t\t\t\t// Get the node value in embedded document, " + NL + "\t\t\t\t\t//If have no embedded document get root document node." + NL + "\t\t\t\t\tpublic Object getValue(String parentNode,String currentName,com.mongodb.DBObject dbObject){" + NL + "\t\t\t\t\t\tObject value=null;" + NL + "\t\t\t\t\t\tif(dbObject==null){" + NL + "\t\t\t\t\t\t\treturn null;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif (parentNode == null || \"\".equals(parentNode)) {" + NL + "\t\t\t\t\t\t    if (\"*\".equals(currentName)) {" + NL + "\t\t\t\t\t\t        value = dbObject;" + NL + "\t\t\t\t\t\t    } else if (dbObject.get(currentName)!=null){" + NL + "\t\t\t\t\t\t\t\tvalue=dbObject.get(currentName);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\tString objNames[] = objNames = parentNode.split(\"\\\\.\");" + NL + "\t\t\t\t\t\t\tcom.mongodb.DBObject currentObj=dbObject;" + NL + "\t\t\t\t\t\t\tfor(int i=0;i<objNames.length;i++){" + NL + "\t\t\t\t\t\t\t\tcurrentObj=(com.mongodb.DBObject)currentObj.get(objNames[i]);" + NL + "\t\t\t\t\t\t\t\tif(currentObj==null){" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tif (\"*\".equals(currentName)) {" + NL + "                                value = currentObj;" + NL + "                            } else if(currentObj!=null){" + NL + "\t\t\t\t\t\t\t\tvalue=currentObj.get(currentName);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\treturn value;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tDBObjectInputUtil_";
  protected final String TEXT_154 = " dbObjectInputUtil_";
  protected final String TEXT_155 = "=new DBObjectInputUtil_";
  protected final String TEXT_156 = "();" + NL + "\t\t\t\tjava.util.Map<String, String> pathMap_";
  protected final String TEXT_157 = "=new java.util.HashMap<String, String>();";
  protected final String TEXT_158 = NL + "\t\t\t\tpathMap_";
  protected final String TEXT_159 = ".put(\"";
  protected final String TEXT_160 = "\",";
  protected final String TEXT_161 = ");";
  protected final String TEXT_162 = NL + "\t  \t\t\tcursor_";
  protected final String TEXT_163 = " = cursor_";
  protected final String TEXT_164 = ".limit(";
  protected final String TEXT_165 = ");";
  protected final String TEXT_166 = NL + "\t\t  \t\tcom.mongodb.DBObject orderBy_";
  protected final String TEXT_167 = " = new com.mongodb.BasicDBObject();";
  protected final String TEXT_168 = NL + "\t\t  \t\torderBy_";
  protected final String TEXT_169 = ".put(";
  protected final String TEXT_170 = ",";
  protected final String TEXT_171 = ");";
  protected final String TEXT_172 = NL + "\t\t\t\tcursor_";
  protected final String TEXT_173 = ".sort(orderBy_";
  protected final String TEXT_174 = ");";
  protected final String TEXT_175 = NL + "\t\t\t\twhile (cursor_";
  protected final String TEXT_176 = ".hasNext()){";
  protected final String TEXT_177 = NL + "\t\t\t\tcom.mongodb.DBObject o_";
  protected final String TEXT_178 = " = cursor_";
  protected final String TEXT_179 = ".next();" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_180 = "++;";
  protected final String TEXT_181 = NL + "\t\t\t\tObject valueObj_";
  protected final String TEXT_182 = "=null;";
  protected final String TEXT_183 = NL + "                    valueObj_";
  protected final String TEXT_184 = "=dbObjectInputUtil_";
  protected final String TEXT_185 = ".getValue(pathMap_";
  protected final String TEXT_186 = ".get(\"";
  protected final String TEXT_187 = "\"),\"";
  protected final String TEXT_188 = "\",o_";
  protected final String TEXT_189 = ");";
  protected final String TEXT_190 = NL + "\t\t\t\t";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = " = valueObj_";
  protected final String TEXT_193 = ";";
  protected final String TEXT_194 = NL + "\t\t\t\tif(valueObj_";
  protected final String TEXT_195 = "!=null && valueObj_";
  protected final String TEXT_196 = ".toString().length() > 0) {";
  protected final String TEXT_197 = NL + "                            if (valueObj_";
  protected final String TEXT_198 = " instanceof java.util.Date) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = " = ParserUtils.parseTo_Date((java.util.Date)valueObj_";
  protected final String TEXT_201 = ", ";
  protected final String TEXT_202 = ");" + NL + "                            } else {";
  protected final String TEXT_203 = NL + "                                ";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = " = ParserUtils.parseTo_Date((String)valueObj_";
  protected final String TEXT_206 = ", ";
  protected final String TEXT_207 = ");" + NL + "                            }";
  protected final String TEXT_208 = NL + "\t\t\t\t\t";
  protected final String TEXT_209 = ".";
  protected final String TEXT_210 = " = java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap((byte[])valueObj_";
  protected final String TEXT_211 = ")).toString().getBytes(utf8Charset);";
  protected final String TEXT_212 = NL + "\t\t\t\t\t";
  protected final String TEXT_213 = ".";
  protected final String TEXT_214 = " = valueObj_";
  protected final String TEXT_215 = ".toString();";
  protected final String TEXT_216 = NL + "                            if (valueObj_";
  protected final String TEXT_217 = ".getClass().equals(Double.class)) {";
  protected final String TEXT_218 = NL + "                                ";
  protected final String TEXT_219 = ".";
  protected final String TEXT_220 = " = ParserUtils.parseTo_Double(valueObj_";
  protected final String TEXT_221 = ".toString()).intValue();" + NL + "                            } else {";
  protected final String TEXT_222 = NL + "                                ";
  protected final String TEXT_223 = ".";
  protected final String TEXT_224 = " = ParserUtils.parseTo_";
  protected final String TEXT_225 = "(valueObj_";
  protected final String TEXT_226 = ".toString());" + NL + "                            }";
  protected final String TEXT_227 = NL + "                            if (valueObj_";
  protected final String TEXT_228 = ".getClass().equals(Double.class)) {";
  protected final String TEXT_229 = NL + "                                ";
  protected final String TEXT_230 = ".";
  protected final String TEXT_231 = " = ParserUtils.parseTo_Double(valueObj_";
  protected final String TEXT_232 = ".toString()).longValue();" + NL + "                            } else {";
  ...
  protected final String TEXT_238 = NL + "                            if (valueObj_";
  protected final String TEXT_239 = ".getClass().equals(Double.class)) {";
  protected final String TEXT_240 = NL + "                                ";
  protected final String TEXT_241 = ".";
  protected final String TEXT_242 = " = ParserUtils.parseTo_Double(valueObj_";
  protected final String TEXT_243 = ".toString()).shortValue();" + NL + "                            } else {";
  protected final String TEXT_244 = NL + "                                ";
  protected final String TEXT_245 = ".";
  protected final String TEXT_246 = " = ParserUtils.parseTo_";
  protected final String TEXT_247 = "(valueObj_";
  protected final String TEXT_248 = ".toString());" + NL + "                            }";
  protected final String TEXT_249 = NL + "                            ";
  protected final String TEXT_250 = ".";
  protected final String TEXT_251 = " = ParserUtils.parseTo_";
  protected final String TEXT_252 = "(valueObj_";
