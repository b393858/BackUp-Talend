...
public class TAmazonMysqlRowFinallyJava
{
  protected static String nl;
  public static synchronized TAmazonMysqlRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonMysqlRowFinallyJava result = new TAmazonMysqlRowFinallyJava();
    nl = null;
    return result;
  }
