...
public class TNeo4jOutputRelationshipEndJava
{
  ...
  protected final String TEXT_129 = NL + "\t\t\tdatabaseService_";
  protected final String TEXT_130 = ".shutdown();" + NL + "\t\t\tresourceMap.put(\"finish_";
  protected final String TEXT_131 = "\", true); " + NL + "\t\t";
  protected final String TEXT_132 = NL + NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_133 = "\", true); " + NL + "\t\t";
  protected final String TEXT_134 = NL + "globalMap.put(\"";
  protected final String TEXT_135 = "_NB_LINE\", nb_line_";
