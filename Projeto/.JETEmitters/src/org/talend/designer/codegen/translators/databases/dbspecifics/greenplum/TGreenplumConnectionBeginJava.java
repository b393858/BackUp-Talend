...
public class TGreenplumConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_34 = " + \":\" + ";
  protected final String TEXT_35 = " + \"/\" + ";
  protected final String TEXT_36 = ";" + NL + "\t\t\t";
  protected final String TEXT_37 = NL + "\t\t\t\tString url_";
  protected final String TEXT_38 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_39 = "+\":\"+";
  protected final String TEXT_40 = "+\";DatabaseName=\"+";
  ...
  protected final String TEXT_59 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_60 = " = null;" + NL + "\t";
  protected final String TEXT_61 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_62 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_67 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_68 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_73 = " - Written records count: \" + nb_line_";
  protected final String TEXT_74 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_76 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_77 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_78 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_79 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_81 = " - Writing the record \" + nb_line_";
  protected final String TEXT_82 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_84 = " - Processing the record \" + nb_line_";
  protected final String TEXT_85 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_87 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_88 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_90 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_91 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_93 = " - Uses an existing connection ";
  protected final String TEXT_94 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_96 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_97 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_99 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_100 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_101 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_105 = ", dbUser_";
  ...
  protected final String TEXT_137 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_138 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_139 = " == null) {";
  protected final String TEXT_140 = NL + "\t\t";
  protected final String TEXT_141 = NL + "\t\t";
  protected final String TEXT_142 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_143 = "\", conn_";
  protected final String TEXT_144 = ");";
  protected final String TEXT_145 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_148 = ".get(dsAlias_";
  protected final String TEXT_149 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_150 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_151 = " = dataSources_";
  protected final String TEXT_152 = ".get(dsAlias_";
  protected final String TEXT_153 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_154 = "\", conn_";
  protected final String TEXT_155 = ");" + NL + "\t}";
  protected final String TEXT_156 = NL + "\tif (null != conn_";
  protected final String TEXT_157 = ") {" + NL + "\t\t";
  protected final String TEXT_158 = NL + "\t}";
  protected final String TEXT_159 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
