...
public class TSQLDWHOutputMainJava {
  protected static String nl;
  public static synchronized TSQLDWHOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHOutputMainJava result = new TSQLDWHOutputMainJava();
    nl = null;
    return result;
  }
