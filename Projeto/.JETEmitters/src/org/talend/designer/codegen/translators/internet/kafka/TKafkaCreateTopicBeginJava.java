...
public class TKafkaCreateTopicBeginJava
{
  ...
  protected final String TEXT_8 = "_topicProperties.put(\"retention.ms\", new java.lang.StringBuilder().append(";
  ...
  protected final String TEXT_43 = "_topicProperties.put(\"retention.ms\", new java.lang.StringBuilder().append(";
  ...
  protected final String TEXT_81 = "_topicProperties.put(\"retention.ms\", new java.lang.StringBuilder().append(";
  ...
  protected final String TEXT_116 = NL + NL + "// Topic configuration" + NL + "java.util.Properties ";
  protected final String TEXT_117 = "_topicProperties = new java.util.Properties();";
  protected final String TEXT_118 = NL + "\t\t";
  protected final String TEXT_119 = "_topicProperties.put(\"retention.ms\", new java.lang.StringBuilder().append(";
  protected final String TEXT_120 = ").toString());";
  protected final String TEXT_121 = NL + "\t\t";
  protected final String TEXT_122 = "_topicProperties.put(";
  protected final String TEXT_123 = ", ";
  protected final String TEXT_124 = ");";
  protected final String TEXT_125 = NL + "boolean isZkSecurityEnabled = ";
  protected final String TEXT_126 = "true";
  protected final String TEXT_127 = "false";
  protected final String TEXT_128 = ";" + NL + "kafka.utils.ZkUtils ";
  protected final String TEXT_129 = "_zkUtils =  kafka.utils.ZkUtils.apply(";
  protected final String TEXT_130 = ", 10000, 10000, isZkSecurityEnabled);";
  protected final String TEXT_131 = NL + "\t\ttry{" + NL + "\t\t\tkafka.admin.AdminUtils.createTopic(";
  protected final String TEXT_132 = "_zkUtils, ";
  protected final String TEXT_133 = ", Integer.valueOf(";
  protected final String TEXT_134 = "), Integer.valueOf(";
  protected final String TEXT_135 = "), ";
  protected final String TEXT_136 = "_topicProperties, kafka.admin.RackAwareMode.Safe$.MODULE$);" + NL + "\t\t} catch (org.apache.kafka.common.errors.TopicExistsException e) {";
  protected final String TEXT_137 = NL + "\t\t\t// nothing to do even through the topic already exists, continue the job";
  protected final String TEXT_138 = NL + "\t\t\t// topic already exists, stop the job" + NL + "\t\t\tthrow e;";
  protected final String TEXT_139 = NL + "\t\t}";
  protected final String TEXT_140 = NL + "\t\t// Existing topic configuration" + NL + "\t\tjava.util.Properties ";
  protected final String TEXT_141 = "_initialTopicProperties = kafka.admin.AdminUtils.fetchEntityConfig(";
  protected final String TEXT_142 = "_zkUtils, kafka.server.ConfigType.Topic(), ";
  protected final String TEXT_143 = ");" + NL + "" + NL + "\t\t// Merge existing configuration with the new one" + NL + "\t\tjava.util.Properties ";
  protected final String TEXT_144 = "_newTopicProperties = new java.util.Properties();" + NL + "\t\t";
  protected final String TEXT_145 = "_newTopicProperties.putAll(";
  protected final String TEXT_146 = "_initialTopicProperties);" + NL + "\t\t";
  protected final String TEXT_147 = "_newTopicProperties.putAll(";
  protected final String TEXT_148 = "_topicProperties);" + NL + "\t\t// Push the configuration changes into ZK" + NL + "\t\tkafka.admin.AdminUtils.changeTopicConfig(";
  protected final String TEXT_149 = "_zkUtils, ";
  protected final String TEXT_150 = ", ";
  protected final String TEXT_151 = "_newTopicProperties);";
...
} else if(tKafkaCreateTopicUtil.isKafkaVersion("KAFKA_1_1_0")){

    stringBuffer.append(TEXT_115);
    
	// This is the tKafkaCreateTopic_begin javajet part for Kafka 1.1.x
	
	// Since kafka.admin.AdminUtils methods have been changed in Kafka 1.1.x, we must split the javajets
	// in order to generate the relevant code depending of the current Kafka version.
