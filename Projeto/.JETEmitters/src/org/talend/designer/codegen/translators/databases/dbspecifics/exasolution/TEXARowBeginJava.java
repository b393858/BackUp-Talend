...
public class TEXARowBeginJava
{
  ...
  protected final String TEXT_92 = NL + "            \t\t\tString dsAlias_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "                \t\tif (dataSources_";
  protected final String TEXT_95 = ".get(dsAlias_";
  protected final String TEXT_96 = ") == null) {" + NL + "                   \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_97 = " + \" available!\");" + NL + "                      \t}" + NL + "                \t\tconn_";
  protected final String TEXT_98 = " = dataSources_";
  protected final String TEXT_99 = ".get(dsAlias_";
  ...
  protected final String TEXT_119 = ".getAutoCommit()) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\t\t}        " + NL + "\t\t\t\t\tint commitEvery_";
  protected final String TEXT_121 = " = ";
  protected final String TEXT_122 = ";" + NL + "\t\t\t\t\tint commitCounter_";
  protected final String TEXT_123 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_125 = " = ";
  protected final String TEXT_126 = ";" + NL + "\t        String url_";
  protected final String TEXT_127 = " = null;" + NL + "\t        if(dbProperties_";
  protected final String TEXT_128 = " == null || dbProperties_";
  protected final String TEXT_129 = ".trim().length() == 0) {" + NL + "\t            url_";
  protected final String TEXT_130 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_131 = " + \":\" + ";
  protected final String TEXT_132 = "+ \";schema=\" + ";
  protected final String TEXT_133 = "; " + NL + "\t        } else {" + NL + "\t            url_";
  protected final String TEXT_134 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_135 = " + \":\" + ";
  protected final String TEXT_136 = " + \";schema=\" + ";
  protected final String TEXT_137 = " + \";\" + ";
  protected final String TEXT_138 = ";" + NL + "\t        }" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_140 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_142 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\tint nb_line_deleted_";
  protected final String TEXT_144 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_145 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_146 = " = null;" + NL + "\tString query_";
  protected final String TEXT_147 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_148 = " = false;";
  protected final String TEXT_149 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_154 = ".prepareStatement(";
  protected final String TEXT_155 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_160 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
