...
public class TImpalaOutputEndJava {
  ...
  protected final String TEXT_47 = NL + "        if(rowCount";
  protected final String TEXT_48 = " != 0) {" + NL + "            try {" + NL + "                stmt_";
  protected final String TEXT_49 = ".executeUpdate(sbValue_";
  protected final String TEXT_50 = ".toString().substring(0, sbValue_";
  protected final String TEXT_51 = ".toString().length()-1));";
  protected final String TEXT_52 = NL + "            } catch(java.lang.Exception e) {";
  protected final String TEXT_53 = NL + "                    throw e;";
  protected final String TEXT_54 = NL + "                    System.err.print(\"Exception in the component ";
  protected final String TEXT_55 = ":\" + e.getMessage());";
