...
public class TSQLDWHInputBeginJava
{
  protected static String nl;
  public static synchronized TSQLDWHInputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHInputBeginJava result = new TSQLDWHInputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_219 = " += \";applicationName=Talend;\" + ";
