...
public class TImpalaInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:hive2://\"+";
  protected final String TEXT_189 = "+\":\"+";
  protected final String TEXT_190 = "+\"/\"+";
  protected final String TEXT_191 = " + ";
  protected final String TEXT_192 = "; ";
  protected final String TEXT_193 = NL + "\t\t\tString dbname_";
  ...
  protected final String TEXT_204 = NL + "\t\t\tString dbname_";
  protected final String TEXT_205 = " = ";
  protected final String TEXT_206 = ";" + NL + "\t\t\tif(dbname_";
  protected final String TEXT_207 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_208 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_209 = ".trim())) {" + NL + "\t\t\t\tjava.sql.Statement goToDatabase_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".createStatement();" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_212 = ".execute(\"use \" + dbname_";
  protected final String TEXT_213 = ");" + NL + "\t\t\t\tgoToDatabase_";
  ...
  protected final String TEXT_252 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_253 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_381 = ".getColumnTypeName(i_";
  protected final String TEXT_382 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_383 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_384 = ".getClob(i_";
  protected final String TEXT_385 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_386 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_387 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_388 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_389 = ".add(tNTextImpl_";
  protected final String TEXT_390 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_391 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_392 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_393 = ".getColumnTypeName(i_";
  protected final String TEXT_394 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_395 = ".add(rs_";
  protected final String TEXT_396 = ".getString(i_";
  protected final String TEXT_397 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_398 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
