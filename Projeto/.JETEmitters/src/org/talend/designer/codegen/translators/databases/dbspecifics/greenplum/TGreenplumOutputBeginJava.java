...
public class TGreenplumOutputBeginJava {
  ...
  protected final String TEXT_96 = " = \"org.postgresql.Driver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_97 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_98 = " + \":\" + ";
  protected final String TEXT_99 = " + \"/\" + ";
  protected final String TEXT_100 = ";" + NL + "\t\t";
  protected final String TEXT_101 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_102 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\tString url_";
  protected final String TEXT_103 = " = \"jdbc:pivotal:greenplum://\"+";
  ...
  protected final String TEXT_132 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_142 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_151 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_152 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_153 = " = dbMetaData_";
  protected final String TEXT_154 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                String defaultSchema_";
  protected final String TEXT_155 = " = \"public\";" + NL + "                if(dbschema_";
  protected final String TEXT_156 = " == null || dbschema_";
  protected final String TEXT_157 = ".trim().length() == 0) {" + NL + "                     try (java.sql.Statement stmtSchema_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".createStatement();" + NL + "                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_160 = " = stmtSchema_";
  protected final String TEXT_161 = ".executeQuery(\"select current_schema() \")) {" + NL + "                        while(rsSchema_";
  protected final String TEXT_162 = ".next()){" + NL + "                            defaultSchema_";
  protected final String TEXT_163 = " = rsSchema_";
  protected final String TEXT_164 = ".getString(\"current_schema\");" + NL + "                        }" + NL + "                    }" + NL + "                }" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_171 = ") && (schema_";
  ...
  protected final String TEXT_178 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_187 = NL + "                if(whetherExist_";
  protected final String TEXT_188 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_194 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_201 = NL + "            try (java.sql.Statement stmtClearCount_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".createStatement();" + NL + "                    java.sql.ResultSet rsClearCount_";
  protected final String TEXT_204 = " = stmtClearCount_";
  protected final String TEXT_205 = ".executeQuery(\"";
  protected final String TEXT_206 = "\");" + NL + "                    java.sql.Statement stmtClear_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".createStatement()) {";
  protected final String TEXT_209 = NL + "                stmtClear_";
  protected final String TEXT_210 = ".executeUpdate(\"";
  protected final String TEXT_211 = "\");";
  protected final String TEXT_212 = NL + "                while(rsClearCount_";
  protected final String TEXT_213 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_214 = " += rsClearCount_";
  protected final String TEXT_215 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_216 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_219 = " + \"\\\" (";
  protected final String TEXT_220 = ") VALUES (";
  protected final String TEXT_221 = ")\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_222 = "\", pstmt_";
  protected final String TEXT_223 = ");" + NL + "\t    ";
  protected final String TEXT_224 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_234 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_235 = " + \"\\\" WHERE ";
  protected final String TEXT_236 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_240 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_241 = " + \"\\\" (";
  protected final String TEXT_242 = ") VALUES (";
  protected final String TEXT_243 = ")\");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_244 = "\", pstmtInsert_";
  protected final String TEXT_245 = ");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_246 = " = conn_";
  protected final String TEXT_247 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_248 = " + \"\\\" SET ";
  protected final String TEXT_249 = " WHERE ";
  protected final String TEXT_250 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_251 = "\", pstmtUpdate_";
  protected final String TEXT_252 = ");" + NL + "\t    ";
  protected final String TEXT_253 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_254 = " = conn_";
  protected final String TEXT_255 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_256 = " + \"\\\" SET ";
  protected final String TEXT_257 = " WHERE ";
  protected final String TEXT_258 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_259 = "\", pstmtUpdate_";
  protected final String TEXT_260 = ");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_263 = " + \"\\\" (";
  protected final String TEXT_264 = ") VALUES (";
  protected final String TEXT_265 = ")\");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_266 = "\", pstmtInsert_";
  protected final String TEXT_267 = ");" + NL + "\t    ";
  protected final String TEXT_268 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_271 = " + \"\\\" WHERE ";
  protected final String TEXT_272 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_273 = "\", pstmt_";
  protected final String TEXT_274 = ");" + NL + "\t    ";
  protected final String TEXT_275 = NL + "            int commitEvery_";
  protected final String TEXT_276 = " = ";
  protected final String TEXT_277 = ";" + NL + "            int commitCounter_";
