...
public class TIngresRowFinallyJava
{
  protected static String nl;
  public static synchronized TIngresRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresRowFinallyJava result = new TIngresRowFinallyJava();
    nl = null;
    return result;
  }
