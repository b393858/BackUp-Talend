...
public class TMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_37 = " + \"?\" + \"rewriteBatchedStatements=true\";";
  protected final String TEXT_38 = NL + "\t\tString properties_";
  protected final String TEXT_39 = " = ";
  protected final String TEXT_40 = ";" + NL + "\t\tif (properties_";
  protected final String TEXT_41 = " == null || properties_";
  protected final String TEXT_42 = ".trim().length() == 0) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_43 = " += \"rewriteBatchedStatements=true\";" + NL + "\t\t}else if (properties_";
  protected final String TEXT_44 = " != null && !properties_";
  protected final String TEXT_45 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_46 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString url_";
  protected final String TEXT_47 = " = \"";
  protected final String TEXT_48 = "://\" + ";
  protected final String TEXT_49 = " + \":\" + ";
  protected final String TEXT_50 = " + \"/\" + ";
  protected final String TEXT_51 = " + \"?\" + properties_";
  ...
  protected final String TEXT_172 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
