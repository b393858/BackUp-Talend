...
public class TNetezzaBulkExecBeginJava {
  ...
  protected final String TEXT_76 = NL + "\tString bulkSQL_";
  protected final String TEXT_77 = "=\"\";";
  protected final String TEXT_78 = NL + "\tCharacter OUT_DELIM_";
  protected final String TEXT_79 = " = (";
  protected final String TEXT_80 = ").charAt(0); " + NL + "\tbulkSQL_";
  protected final String TEXT_81 = " += \"INSERT INTO \" + ";
  protected final String TEXT_82 = " + \" \"  " + NL + "            + \" SELECT * FROM EXTERNAL '\"+ ";
  protected final String TEXT_83 = " + \"'\"" + NL + "            + \" USING (DELIM '\"+OUT_DELIM_";
  protected final String TEXT_84 = "+\"' REMOTESOURCE 'JDBC' \"" + NL + "\t\t\t+ \" DATESTYLE '\"+";
  protected final String TEXT_85 = "+\"' DATEDELIM '\"+";
  protected final String TEXT_86 = "+\"' \"" + NL + "\t\t\t+ \" TIMESTYLE '";
  protected final String TEXT_87 = "' TIMEDELIM '\"+";
  protected final String TEXT_88 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t+ \" ESCAPECHAR '\"+";
  protected final String TEXT_90 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t+ \"\tMAXERRORS ";
  protected final String TEXT_92 = " SKIPROWS ";
  protected final String TEXT_93 = " LOGDIR '' ";
  ...
  protected final String TEXT_99 = " = \"org.netezza.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_100 = ").newInstance();" + NL + "\t\tString url_";
  ...
  protected final String TEXT_120 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_121 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_122 = " - Bulk inserting data into \" + ";
  protected final String TEXT_123 = " + \".\" );" + NL + "\t";
  protected final String TEXT_124 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_125 = " = conn_";
  protected final String TEXT_126 = ".createStatement();" + NL + "    stmtBulk_";
  protected final String TEXT_127 = ".execute(bulkSQL_";
  protected final String TEXT_128 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_129 = ".close();";
  protected final String TEXT_130 = NL + "\t\tlog.info(\"";
  protected final String TEXT_131 = " - Bulk insert data into \" + ";
  protected final String TEXT_132 = " + \" has finished.\");" + NL + "\t";
