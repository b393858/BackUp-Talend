...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_187 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_188 = ");";
  protected final String TEXT_189 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_190 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_191 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_192 = "),Integer.parseInt(";
  protected final String TEXT_193 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_194 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_195 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_196 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_197 = " && timeOut_";
  protected final String TEXT_198 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_199 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_200 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_201 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_202 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_203 = NL + "\t\t\t\tString url_";
  protected final String TEXT_204 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_205 = ";";
  protected final String TEXT_206 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_207 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_208 = " + \":\" + ";
  protected final String TEXT_209 = " + \"/\" + ";
  protected final String TEXT_210 = ";";
  protected final String TEXT_211 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_212 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_213 = " + \":\" + ";
  protected final String TEXT_214 = " + \"/\" + ";
  protected final String TEXT_215 = ";";
  protected final String TEXT_216 = NL + "\t\t\t    String driverClass_";
  protected final String TEXT_217 = " = \"";
  protected final String TEXT_218 = "\";" + NL + "\t\t\t    java.lang.Class.forName(driverClass_";
  protected final String TEXT_219 = ").newInstance();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_230 = NL + NL + "\t\t        String dbPwd_";
  ...
  protected final String TEXT_234 = NL + "\t\t    int nb_line_";
  protected final String TEXT_235 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_236 = " = null;";
  protected final String TEXT_237 = NL + "\t\t        conn_";
  protected final String TEXT_238 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_239 = "\");";
  protected final String TEXT_240 = NL + "\t\t\t\t";
  protected final String TEXT_241 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_242 = " =  conn_";
  protected final String TEXT_243 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_244 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_245 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_246 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_247 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_248 = NL + "                 conn_";
  protected final String TEXT_249 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_250 = NL + "               ";
  protected final String TEXT_251 = " + \"=\" + ";
  protected final String TEXT_252 = " + \";\" +";
  protected final String TEXT_253 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_254 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_255 = ");";
  protected final String TEXT_256 = NL + "\t\t    ";
  protected final String TEXT_257 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_258 = " = ";
  protected final String TEXT_259 = ";" + NL + "\t\t\t";
  protected final String TEXT_260 = NL + "                log.debug(\"";
  protected final String TEXT_261 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_271 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_294 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_295 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_296 = ".setName(rsmd_";
  protected final String TEXT_297 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_306 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_307 = ".setDbTypeId(rsmd_";
  protected final String TEXT_308 = ".getColumnType(i));";
  protected final String TEXT_309 = NL + "                \tdcm_";
  protected final String TEXT_310 = ".setFormat(";
  protected final String TEXT_311 = ");";
  protected final String TEXT_312 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_313 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_314 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_315 = ".setLength(rsmd_";
  protected final String TEXT_316 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_317 = ".setLength(rsmd_";
  protected final String TEXT_318 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_319 = NL + "\t\t\tdcm_";
  protected final String TEXT_320 = ".setLength(rsmd_";
  protected final String TEXT_321 = ".getPrecision(i));";
  protected final String TEXT_322 = NL + "                \tdcm_";
  protected final String TEXT_323 = ".setPrecision(rsmd_";
  protected final String TEXT_324 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_325 = ".setNullable(rsmd_";
  protected final String TEXT_326 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_327 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_328 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_329 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_330 = ".metadatas.add(dcm_";
  protected final String TEXT_331 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_332 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_333 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_334 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_335 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_336 = NL + "\t\t    ";
  protected final String TEXT_337 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_338 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_339 = NL + "\t\t    while (rs_";
  protected final String TEXT_340 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_341 = "++;" + NL + "\t\t        ";
  protected final String TEXT_342 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_343 = " = ";
  protected final String TEXT_344 = " + dcg_";
  protected final String TEXT_345 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_347 = " = ";
  protected final String TEXT_348 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_350 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_369 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_370 = ".getObject(";
  protected final String TEXT_371 = "column_index_";
  protected final String TEXT_372 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_373 = NL + "                                    ";
  protected final String TEXT_374 = ".";
  protected final String TEXT_375 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_384 = ".setEPSG(";
  protected final String TEXT_385 = ");" + NL + "                                        }";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_387 = NL + "                                  ";
  protected final String TEXT_388 = ".";
  protected final String TEXT_389 = "=dcg_";
  protected final String TEXT_390 = ";";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_392 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_393 = " = ";
  protected final String TEXT_394 = "; i_";
  protected final String TEXT_395 = "  <= rsmd_";
  protected final String TEXT_396 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_409 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_410 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_411 = ".getColumnTypeName(i_";
  protected final String TEXT_412 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_413 = ".add(rs_";
  protected final String TEXT_414 = ".getString(i_";
  protected final String TEXT_415 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_416 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_417 = ".";
  protected final String TEXT_418 = ", rs_";
  protected final String TEXT_419 = ", fixedColumnCount_";
  protected final String TEXT_420 = ",list_";
  protected final String TEXT_421 = ",";
  protected final String TEXT_422 = ");";
  protected final String TEXT_423 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_424 = ".";
  protected final String TEXT_425 = ", rs_";
  protected final String TEXT_426 = ", fixedColumnCount_";
  protected final String TEXT_427 = ",";
  protected final String TEXT_428 = ");";
  protected final String TEXT_429 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_430 = ".";
  protected final String TEXT_431 = ", rs_";
  protected final String TEXT_432 = ", fixedColumnCount_";
  protected final String TEXT_433 = ",";
  protected final String TEXT_434 = ");";
  protected final String TEXT_435 = NL + "                                  Object geom = rs_";
  protected final String TEXT_436 = ".getObject(";
  protected final String TEXT_437 = "column_index_";
  protected final String TEXT_438 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_439 = ".";
  protected final String TEXT_440 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_441 = ".";
  protected final String TEXT_442 = " = null;" + NL + "                                  }";
  protected final String TEXT_443 = NL + "\t\t                          ";
  protected final String TEXT_444 = NL + "\t\t                    }";
  protected final String TEXT_445 = NL + "\t\t\t\t\t";
  protected final String TEXT_446 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_447 = " - Retrieving the record \" + nb_line_";
