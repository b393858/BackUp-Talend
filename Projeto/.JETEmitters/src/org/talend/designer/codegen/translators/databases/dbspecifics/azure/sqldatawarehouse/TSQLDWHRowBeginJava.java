...
public class TSQLDWHRowBeginJava
{
  protected static String nl;
  public static synchronized TSQLDWHRowBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHRowBeginJava result = new TSQLDWHRowBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_123 = NL + "\t\t\tString port_";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_126 = " = ";
  protected final String TEXT_127 = " ;" + NL + "\t\t    ";
  protected final String TEXT_128 = NL + "\t\t\tString url_";
  protected final String TEXT_129 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_130 = " ;" + NL + "\t\t\t";
  protected final String TEXT_131 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_132 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_133 = " ;" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_135 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_136 = " += \":\" + ";
  protected final String TEXT_137 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_138 = ")) {" + NL + "\t\t   \t";
  protected final String TEXT_139 = NL + "\t\t\t\turl_";
  protected final String TEXT_140 = " += \"//\" + ";
  protected final String TEXT_141 = "; " + NL + "\t\t\t";
  protected final String TEXT_142 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_143 = " += \";databaseName=\" + ";
  protected final String TEXT_144 = "; " + NL + "\t\t\t";
  protected final String TEXT_145 = NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_146 = " += \";applicationName=Talend;\" + ";
  protected final String TEXT_147 = ";" + NL + "\t\t";
  protected final String TEXT_148 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_149 = " = (String)globalMap.get(\"";
  protected final String TEXT_150 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";" + NL + "\t    \t\t";
  protected final String TEXT_154 = NL + "\t\t        String  tableName_";
  protected final String TEXT_155 = " = null;" + NL + "\t\t        if(dbschema_";
  ...
  protected final String TEXT_162 = " + \"]\";" + NL + "\t\t        }" + NL + "\t\t        stmt_";
  protected final String TEXT_163 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_164 = " +\" ON\");" + NL + "\t\t\t";
  protected final String TEXT_165 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_166 = " = null;" + NL + "\tString query_";
  protected final String TEXT_167 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_168 = " = false;";
  protected final String TEXT_169 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_174 = ".prepareStatement(";
  protected final String TEXT_175 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_176 = "\", pstmt_";
  protected final String TEXT_177 = ");";
  protected final String TEXT_178 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_179 = " = conn_";
  protected final String TEXT_180 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_181 = "\", stmt_";
