...
public class TSQLDWHBulkExecBeginJava {
  protected static String nl;
  public static synchronized TSQLDWHBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHBulkExecBeginJava result = new TSQLDWHBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_46 = NL + NL + "    //AZURE DW CODE" + NL;
  protected final String TEXT_47 = NL + NL + "    final String OUT_DELIM_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";" + NL + "    " + NL + "    String randomIdentifier_";
  protected final String TEXT_50 = " = java.util.UUID.randomUUID().toString().replaceAll(\"-\",\"\");" + NL + "    " + NL + "    String azureCredIdentity_";
  protected final String TEXT_51 = " = \"\";" + NL + "    String azureCredName_";
  protected final String TEXT_52 = " = \"\";" + NL + "    String azureContainer_";
  protected final String TEXT_53 = " = \"\";    " + NL + "    " + NL + "    String dbschema_";
  protected final String TEXT_54 = " = null;" + NL + "    //external tableName" + NL + "    String ext_tableName_";
  protected final String TEXT_55 = " = null;" + NL + "" + NL + "    String tableName_";
  protected final String TEXT_56 = " = null;" + NL + "    String azureFolder_";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ";" + NL + "    " + NL + "    String clientId_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ";" + NL + "    String oauthEndpoint_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "    ";
  protected final String TEXT_63 = " " + NL + "        final String azureAccessKey_";
  protected final String TEXT_64 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_65 = ");";
  protected final String TEXT_66 = NL + "        final String azureAccessKey_";
  protected final String TEXT_67 = " = ";
  protected final String TEXT_68 = "; ";
  protected final String TEXT_69 = NL + "        azureCredIdentity_";
  protected final String TEXT_70 = " = clientId_";
  protected final String TEXT_71 = " + \"@\" + oauthEndpoint_";
  protected final String TEXT_72 = ";" + NL + "        azureCredName_";
  protected final String TEXT_73 = " = \"talend_ADLCredential_\" + randomIdentifier_";
  protected final String TEXT_74 = ";";
  protected final String TEXT_75 = NL + "        azureCredIdentity_";
  protected final String TEXT_76 = " = \"talend\";" + NL + "        azureCredName_";
  protected final String TEXT_77 = " = \"talend_AzureStorageCredential_\" + randomIdentifier_";
  protected final String TEXT_78 = ";" + NL + "        azureContainer_";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ";";
  protected final String TEXT_81 = NL + "    " + NL + "    String azureAccountName_";
  protected final String TEXT_82 = " = ";
  protected final String TEXT_83 = ";" + NL + "    String azureExtDataSrc_";
  protected final String TEXT_84 = " = \"talend_DataSource_\" + randomIdentifier_";
  protected final String TEXT_85 = ";" + NL + "    String azureExtFileFormat_";
  protected final String TEXT_86 = " = \"talend_FileFormat_\" + randomIdentifier_";
  protected final String TEXT_87 = ";" + NL + "    " + NL + "    String azureFileLoadType_";
  protected final String TEXT_88 = " = \"";
  protected final String TEXT_89 = "\";" + NL + "    " + NL + "    String dwDistributionOptions_";
  protected final String TEXT_90 = " = \"\";" + NL + "    String dwTableOptions_";
  protected final String TEXT_91 = " = \"\";" + NL + "    String dwPartition_";
  protected final String TEXT_92 = " = \"\";" + NL;
  protected final String TEXT_93 = NL + NL + "    //BEGIN CONNECTION Code " + NL + "    " + NL + "    java.sql.Connection conn_";
  protected final String TEXT_94 = " = null;";
  protected final String TEXT_95 = NL + "    String dbUser_";
  protected final String TEXT_96 = " = null;";
  protected final String TEXT_97 = NL + "        dbschema_";
  protected final String TEXT_98 = " = (String)globalMap.get(\"";
  protected final String TEXT_99 = "\");" + NL + "        conn_";
  protected final String TEXT_100 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_101 = "\");";
  protected final String TEXT_102 = NL + "        dbschema_";
  ...
  protected final String TEXT_106 = NL + "        java.lang.Class.forName(driverClass_";
  protected final String TEXT_107 = ");" + NL + "        String port_";
  protected final String TEXT_108 = " = ";
  protected final String TEXT_109 = ";" + NL + "        String dbname_";
  protected final String TEXT_110 = " = ";
  protected final String TEXT_111 = " ;" + NL + "        String url_";
  protected final String TEXT_112 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_113 = " ; " + NL + "        if (!\"\".equals(port_";
  protected final String TEXT_114 = ")) {" + NL + "            url_";
  protected final String TEXT_115 = " += \":\" + ";
  protected final String TEXT_116 = ";" + NL + "        }" + NL + "        if (!\"\".equals(dbname_";
  protected final String TEXT_117 = ")) {" + NL + "        url_";
  protected final String TEXT_118 = " += \";database=\" + ";
  protected final String TEXT_119 = "; " + NL + "        }" + NL + "        url_";
  protected final String TEXT_120 = " += \";applicationName=Talend;\" + ";
  protected final String TEXT_121 = ";" + NL + "        dbUser_";
  ...
  protected final String TEXT_135 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_136 = ",dbUser_";
  protected final String TEXT_137 = ",dbPwd_";
  protected final String TEXT_138 = ");";
  protected final String TEXT_139 = NL + NL + "// END CONNECTION Code" + NL;
  protected final String TEXT_140 = NL + "        resourceMap.put(\"conn_";
  protected final String TEXT_141 = "\", conn_";
  protected final String TEXT_142 = ");" + NL + "        conn_";
  protected final String TEXT_143 = ".setAutoCommit(true);";
  protected final String TEXT_144 = NL + "    if(dbschema_";
  protected final String TEXT_145 = " == null || dbschema_";
  protected final String TEXT_146 = ".trim().length() == 0) {" + NL + "        ext_tableName_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = " + \"_\" + randomIdentifier_";
  protected final String TEXT_149 = ";" + NL + "    } else {" + NL + "        ext_tableName_";
  protected final String TEXT_150 = " = dbschema_";
  protected final String TEXT_151 = " + \"].[\" + ";
  protected final String TEXT_152 = " + \"_\" + randomIdentifier_";
  protected final String TEXT_153 = ";" + NL + "    }" + NL + "" + NL + "    if(dbschema_";
  protected final String TEXT_154 = " == null || dbschema_";
  protected final String TEXT_155 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_156 = " = ";
  protected final String TEXT_157 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_158 = " = dbschema_";
  protected final String TEXT_159 = " + \"].[\" + ";
  protected final String TEXT_160 = ";" + NL + "    }";
  protected final String TEXT_161 = NL + "        String externalTableRejectOptions_";
  protected final String TEXT_162 = " = \"REJECT_TYPE = ";
  protected final String TEXT_163 = "\" + \",REJECT_VALUE = \" + ";
  protected final String TEXT_164 = ";";
  protected final String TEXT_165 = NL + "            externalTableRejectOptions_";
  protected final String TEXT_166 = " += \",REJECT_SAMPLE_VALUE = \" + ";
  protected final String TEXT_167 = ";";
  protected final String TEXT_168 = "    " + NL + "            dwTableOptions_";
  protected final String TEXT_169 = " = \"CLUSTERED COLUMNSTORE INDEX, \";";
  protected final String TEXT_170 = "    " + NL + "            dwTableOptions_";
  protected final String TEXT_171 = " = \"HEAP, \";";
  protected final String TEXT_172 = "    " + NL + "            dwTableOptions_";
  protected final String TEXT_173 = " = \"CLUSTERED INDEX (\" + ";
  protected final String TEXT_174 = " + \"), \";";
  protected final String TEXT_175 = "    " + NL + "            dwDistributionOptions_";
  protected final String TEXT_176 = " = \"DISTRIBUTION = ROUND_ROBIN\";";
  protected final String TEXT_177 = "    " + NL + "            dwDistributionOptions_";
  protected final String TEXT_178 = " = \"DISTRIBUTION = REPLICATE\";";
  protected final String TEXT_179 = "    " + NL + "            dwDistributionOptions_";
  protected final String TEXT_180 = " = \"DISTRIBUTION = HASH(\" + ";
  protected final String TEXT_181 = " + \")\";";
  protected final String TEXT_182 = NL + "            dwPartition_";
  protected final String TEXT_183 = " = \", PARTITION ( [\" + ";
  protected final String TEXT_184 = " + \"] RANGE ";
  protected final String TEXT_185 = " FOR VALUES (\" + ";
  protected final String TEXT_186 = " + \") )\";    ";
  protected final String TEXT_187 = NL + "            int count_";
  protected final String TEXT_188 = "=0;";
  protected final String TEXT_189 = NL + "            //Create a database scoped credential using Azure Access Key" + NL + "            //IDENTITY: Provide any string, it is not used for authentication to Azure storage." + NL + "            //SECRET: Provide your Azure storage account key." + NL + "    " + NL + "            java.sql.Statement stmtCreateDBCredentials_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".createStatement();" + NL + "            stmtCreateDBCredentials_";
  protected final String TEXT_192 = ".execute(\"CREATE DATABASE SCOPED CREDENTIAL \" + azureCredName_";
  protected final String TEXT_193 = " + \" WITH IDENTITY = '\" + azureCredIdentity_";
  protected final String TEXT_194 = " + \"', SECRET = '\" + azureAccessKey_";
  protected final String TEXT_195 = " + \"'\");" + NL + "            stmtCreateDBCredentials_";
  protected final String TEXT_196 = ".close();" + NL + "    ";
  protected final String TEXT_197 = NL + "                log.info(\"";
  protected final String TEXT_198 = " - Created Database Scoped Credential: \" + azureCredName_";
  protected final String TEXT_199 = " + \" WITH IDENTITY \" + azureCredIdentity_";
  protected final String TEXT_200 = " + \" successfully.\");";
  protected final String TEXT_201 = "     " + NL + "" + NL + "            //Create an external data source" + NL + "            //TYPE: HADOOP - PolyBase uses Hadoop APIs to access data in Azure blob storage." + NL + "            //LOCATION: Provide Azure storage account name and blob container name." + NL + "            //CREDENTIAL: Provide the credential created in the previous step." + NL + "    " + NL + "            java.sql.Statement stmtCreateExtDataSource_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".createStatement();" + NL + "        ";
  protected final String TEXT_204 = "    " + NL + "                stmtCreateExtDataSource_";
  protected final String TEXT_205 = ".execute(\"CREATE EXTERNAL DATA SOURCE \" + azureExtDataSrc_";
  protected final String TEXT_206 = " + \" WITH (TYPE=HADOOP, LOCATION = 'adl://\" + azureAccountName_";
  protected final String TEXT_207 = " + \".azuredatalakestore.net', CREDENTIAL = \" + azureCredName_";
  protected final String TEXT_208 = " + \")\");";
  protected final String TEXT_209 = "    " + NL + "                stmtCreateExtDataSource_";
  protected final String TEXT_210 = ".execute(\"CREATE EXTERNAL DATA SOURCE \" + azureExtDataSrc_";
  protected final String TEXT_211 = " + \" WITH (TYPE=HADOOP, LOCATION = 'wasbs://\" + azureContainer_";
  protected final String TEXT_212 = " + \"@\" + azureAccountName_";
  protected final String TEXT_213 = " + \".blob.core.windows.net', CREDENTIAL = \" + azureCredName_";
  protected final String TEXT_214 = " + \")\");";
  protected final String TEXT_215 = "    " + NL + "            stmtCreateExtDataSource_";
  protected final String TEXT_216 = ".close();" + NL + "    ";
  protected final String TEXT_217 = NL + "                log.info(\"";
  protected final String TEXT_218 = " - Created External Data Source: \" + azureExtDataSrc_";
  protected final String TEXT_219 = " + \" WITH Credential \" + azureCredName_";
  protected final String TEXT_220 = " + \" successfully.\");";
  protected final String TEXT_221 = " " + NL + "            //newCode END" + NL + "" + NL + "            StringBuilder cmdExtFileFormat_";
  protected final String TEXT_222 = " = new StringBuilder(); " + NL + "            java.sql.Statement stmtCreateExtFileFormat_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".createStatement();" + NL + "            " + NL + "            cmdExtFileFormat_";
  protected final String TEXT_225 = ".append(\"CREATE EXTERNAL FILE FORMAT \").append(azureExtFileFormat_";
  protected final String TEXT_226 = ").append(\" WITH (FORMAT_TYPE = ";
  protected final String TEXT_227 = "\");";
  protected final String TEXT_228 = "    " + NL + "                cmdExtFileFormat_";
  protected final String TEXT_229 = ".append(\", FORMAT_OPTIONS (FIELD_TERMINATOR = '\").append(OUT_DELIM_";
  protected final String TEXT_230 = ").append(\"'\");" + NL + "                cmdExtFileFormat_";
  protected final String TEXT_231 = ".append(\", USE_TYPE_DEFAULT = ";
  protected final String TEXT_232 = "\");";
  protected final String TEXT_233 = NL + "                    cmdExtFileFormat_";
  protected final String TEXT_234 = ".append(\", STRING_DELIMITER = '\").append(";
  protected final String TEXT_235 = ").append(\"'\");";
  protected final String TEXT_236 = NL + "                    cmdExtFileFormat_";
  protected final String TEXT_237 = ".append(\", DATE_FORMAT = '\").append(";
  protected final String TEXT_238 = ").append(\"'\");";
  protected final String TEXT_239 = NL + "                cmdExtFileFormat_";
  protected final String TEXT_240 = ".append(\")\");";
  protected final String TEXT_241 = "        " + NL + "                cmdExtFileFormat_";
  protected final String TEXT_242 = ".append(\", SERDE_METHOD = '";
  protected final String TEXT_243 = "'\");";
  protected final String TEXT_244 = NL + "                cmdExtFileFormat_";
  protected final String TEXT_245 = ".append(\", DATA_COMPRESSION = '";
  protected final String TEXT_246 = "'\");";
  protected final String TEXT_247 = NL + "            cmdExtFileFormat_";
  protected final String TEXT_248 = ".append(\")\");" + NL + "            stmtCreateExtFileFormat_";
  protected final String TEXT_249 = ".execute(cmdExtFileFormat_";
  protected final String TEXT_250 = ".toString());" + NL + "            stmtCreateExtFileFormat_";
  protected final String TEXT_251 = ".close();";
  protected final String TEXT_252 = NL + "                log.info(\"";
  protected final String TEXT_253 = " - Created External File Format: \" + azureExtFileFormat_";
  protected final String TEXT_254 = " + \" successfully.\");";
  protected final String TEXT_255 = " " + NL + "            //CREATE EXTERNAL TABLE" + NL + "            java.sql.Statement stmtCreateExt_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();";
  protected final String TEXT_258 = NL + "            stmtCreateExt_";
  protected final String TEXT_259 = ".execute(\"";
  protected final String TEXT_260 = ")  WITH (LOCATION='/ \" + azureFolder_";
  protected final String TEXT_261 = " + \"', DATA_SOURCE=\" + azureExtDataSrc_";
  protected final String TEXT_262 = " + \", FILE_FORMAT= \" + azureExtFileFormat_";
  protected final String TEXT_263 = " ";
  protected final String TEXT_264 = " " + NL + "            + \",\" + externalTableRejectOptions_";
  protected final String TEXT_265 = " ";
  protected final String TEXT_266 = "  " + NL + "            + \")\");";
  protected final String TEXT_267 = NL + "            stmtCreateExt_";
  protected final String TEXT_268 = ".close();";
  protected final String TEXT_269 = NL + "                log.info(\"";
  protected final String TEXT_270 = " - Created External Table : [\" + ext_tableName_";
  protected final String TEXT_271 = " + \"] successfully.\");";
  protected final String TEXT_272 = "  " + NL + "            // CREATE DW TABLE AND / OR INSERT INTO DW TABLE" + NL + "            try{";
  protected final String TEXT_273 = NL + "                        java.sql.Statement stmtDrop_";
  protected final String TEXT_274 = " = conn_";
  protected final String TEXT_275 = ".createStatement();";
  protected final String TEXT_276 = NL + "                        stmtDrop_";
  protected final String TEXT_277 = ".execute(\"DROP TABLE [\" + tableName_";
  ...
  protected final String TEXT_284 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_285 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_286 = " + dwDistributionOptions_";
  protected final String TEXT_287 = " + dwPartition_";
  protected final String TEXT_288 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_289 = " + \"] WHERE 1=2\");";
  protected final String TEXT_290 = NL + "                        stmtCreate_";
  protected final String TEXT_291 = ".close();" + NL + "" + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_295 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_296 = " + \"].\");";
  protected final String TEXT_297 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_298 = " = stmtInsert_";
  protected final String TEXT_299 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_300 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_301 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_302 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_303 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_304 = ".close();";
  protected final String TEXT_305 = NL + "                            log.info(\"";
  protected final String TEXT_306 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_307 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_308 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_309 = " + \".\");";
  protected final String TEXT_310 = NL + "                        java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_314 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_315 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_316 = " + dwDistributionOptions_";
  protected final String TEXT_317 = " + dwPartition_";
  protected final String TEXT_318 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_319 = " + \"] WHERE 1=2\");";
  protected final String TEXT_320 = NL + "                        stmtCreate_";
  protected final String TEXT_321 = ".close();" + NL + "" + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_325 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_326 = " + \"].\");";
  protected final String TEXT_327 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_328 = " = stmtInsert_";
  protected final String TEXT_329 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_330 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_331 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_332 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_333 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_334 = ".close();";
  protected final String TEXT_335 = NL + "                            log.info(\"";
  protected final String TEXT_336 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_337 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_338 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_339 = " + \".\");";
  protected final String TEXT_340 = NL + "                        //check if table exists" + NL + "                        java.sql.Statement isExistStmt_";
  protected final String TEXT_341 = " = conn_";
  protected final String TEXT_342 = ".createStatement();" + NL + "                        boolean whetherExist_";
  protected final String TEXT_343 = " = false;" + NL + "" + NL + "                        try {" + NL + "                            isExistStmt_";
  protected final String TEXT_344 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_345 = " + \"]\" );" + NL + "                            whetherExist_";
  protected final String TEXT_346 = " = true;" + NL + "                        } catch (java.lang.Exception e){" + NL + "                            whetherExist_";
  protected final String TEXT_347 = " = false;" + NL + "                        }" + NL + "                        isExistStmt_";
  protected final String TEXT_348 = ".close();";
  protected final String TEXT_349 = NL + "                            if(!whetherExist_";
  protected final String TEXT_350 = ") {" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_354 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_355 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_356 = " + dwDistributionOptions_";
  protected final String TEXT_357 = " + dwPartition_";
  protected final String TEXT_358 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_359 = " + \"] WHERE 1=2\");";
  protected final String TEXT_360 = NL + "                                stmtCreate_";
  protected final String TEXT_361 = ".close();" + NL + "                            }" + NL + "                    " + NL + "                            java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_365 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_366 = " + \"].\");";
  protected final String TEXT_367 = "  " + NL + "                            int insertedCount_";
  protected final String TEXT_368 = " = stmtInsert_";
  protected final String TEXT_369 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_370 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_371 = " + \"]\");" + NL + "                            globalMap.put(\"";
  protected final String TEXT_372 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_373 = ");" + NL + "                            stmtInsert_";
  protected final String TEXT_374 = ".close();";
  protected final String TEXT_375 = NL + "                                log.info(\"";
  protected final String TEXT_376 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_377 = " + \"] completed successfully.\");" + NL + "                                log.info(\"";
  protected final String TEXT_378 = " - Number of Rows Inserted : \" + insertedCount_";
  ...
  protected final String TEXT_385 = ".execute(\"DROP TABLE [\" + tableName_";
  protected final String TEXT_386 = " + \"]\");";
  protected final String TEXT_387 = NL + "                                stmtDrop_";
  protected final String TEXT_388 = ".close();" + NL + "                            }" + NL + "                            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_392 = ".execute(\"CREATE TABLE [\" +  tableName_";
  protected final String TEXT_393 = " + \"] WITH (\" + dwTableOptions_";
  protected final String TEXT_394 = " + dwDistributionOptions_";
  protected final String TEXT_395 = " + dwPartition_";
  protected final String TEXT_396 = " + \") AS SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_397 = " + \"] WHERE 1=2\");";
  protected final String TEXT_398 = NL + "                            stmtCreate_";
  protected final String TEXT_399 = ".close();" + NL + "                            java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_403 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_404 = " + \"].\");";
  protected final String TEXT_405 = "  " + NL + "                            int insertedCount_";
  protected final String TEXT_406 = " = stmtInsert_";
  protected final String TEXT_407 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_408 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_409 = " + \"]\");" + NL + "                            globalMap.put(\"";
  protected final String TEXT_410 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_411 = ");" + NL + "                            stmtInsert_";
  protected final String TEXT_412 = ".close();";
  protected final String TEXT_413 = NL + "                                log.info(\"";
  protected final String TEXT_414 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_415 = " + \"] completed successfully.\");" + NL + "                                log.info(\"";
  protected final String TEXT_416 = " - Number of Rows Inserted : \" + insertedCount_";
  ...
  protected final String TEXT_425 = ".close();" + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_429 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_430 = " + \"].\");";
  protected final String TEXT_431 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_432 = " = stmtInsert_";
  protected final String TEXT_433 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_434 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_435 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_436 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_437 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_438 = ".close();";
  protected final String TEXT_439 = NL + "                            log.info(\"";
  protected final String TEXT_440 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_441 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_442 = " - Number of Rows Inserted : \" + insertedCount_";
  ...
  protected final String TEXT_462 = " - Number of Rows Truncated : \" + rsTruncCountNumber_";
  protected final String TEXT_463 = " + \".\");";
  protected final String TEXT_464 = NL + "                        stmtTrunc_";
  protected final String TEXT_465 = ".close();" + NL + "                        " + NL + "                        java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_469 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_470 = " + \"].\");";
  protected final String TEXT_471 = "  " + NL + "                        int insertedCount_";
  protected final String TEXT_472 = " = stmtInsert_";
  protected final String TEXT_473 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_474 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_475 = " + \"]\");" + NL + "                        globalMap.put(\"";
  protected final String TEXT_476 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_477 = ");" + NL + "                        stmtInsert_";
  protected final String TEXT_478 = ".close();";
  protected final String TEXT_479 = NL + "                            log.info(\"";
  protected final String TEXT_480 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_481 = " + \"] completed successfully.\");" + NL + "                            log.info(\"";
  protected final String TEXT_482 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_483 = " + \".\");";
  protected final String TEXT_484 = NL + "                    java.sql.Statement stmtInsert_";
  ...
  protected final String TEXT_488 = " - Starting INSERT into table : [\" + tableName_";
  protected final String TEXT_489 = " + \"].\");";
  protected final String TEXT_490 = "  " + NL + "                    int insertedCount_";
  protected final String TEXT_491 = " = stmtInsert_";
  protected final String TEXT_492 = ".executeUpdate(\"INSERT INTO [\" +  tableName_";
  protected final String TEXT_493 = " + \"] SELECT * FROM [\" + ext_tableName_";
  protected final String TEXT_494 = " + \"]\");" + NL + "                    globalMap.put(\"";
  protected final String TEXT_495 = "_NB_LINE_INSERTED\",insertedCount_";
  protected final String TEXT_496 = ");" + NL + "                    stmtInsert_";
  protected final String TEXT_497 = ".close();";
  protected final String TEXT_498 = NL + "                        log.info(\"";
  protected final String TEXT_499 = " - INSERT into table : [\" + tableName_";
  protected final String TEXT_500 = " + \"] completed successfully.\");" + NL + "                        log.info(\"";
  protected final String TEXT_501 = " - Number of Rows Inserted : \" + insertedCount_";
  protected final String TEXT_502 = " + \".\");";
  protected final String TEXT_503 = NL + "            } catch (java.sql.SQLException e_";
  protected final String TEXT_504 = ") {";
  protected final String TEXT_505 = NL + "                    log.error(\"";
  protected final String TEXT_506 = " - \" + e_";
  protected final String TEXT_507 = ".getMessage());";
  protected final String TEXT_508 = NL + NL + "                java.sql.Statement stmtDropExtTable_";
  protected final String TEXT_509 = " = conn_";
  protected final String TEXT_510 = ".createStatement();" + NL + "                stmtDropExtTable_";
  protected final String TEXT_511 = ".execute(\"DROP EXTERNAL TABLE [\" + ext_tableName_";
  protected final String TEXT_512 = " + \"]\");" + NL + "                stmtDropExtTable_";
  protected final String TEXT_513 = ".close();";
  protected final String TEXT_514 = NL + "                    log.info(\"";
  protected final String TEXT_515 = " - Dropped External Table : [\" + ext_tableName_";
  protected final String TEXT_516 = " + \"] successfully.\");";
  protected final String TEXT_517 = "  " + NL + "                java.sql.Statement stmtDropExtFileFormat_";
  protected final String TEXT_518 = " = conn_";
  protected final String TEXT_519 = ".createStatement();" + NL + "                stmtDropExtFileFormat_";
  protected final String TEXT_520 = ".execute(\"DROP EXTERNAL FILE FORMAT [\" + azureExtFileFormat_";
  protected final String TEXT_521 = " + \"]\");" + NL + "                stmtDropExtFileFormat_";
  protected final String TEXT_522 = ".close();";
  protected final String TEXT_523 = NL + "                    log.info(\"";
  protected final String TEXT_524 = " - Dropped External File Format : [\" + azureExtFileFormat_";
  protected final String TEXT_525 = " + \"] successfully.\");";
  protected final String TEXT_526 = "  " + NL + "                java.sql.Statement stmtDropExtDataSrc_";
  protected final String TEXT_527 = " = conn_";
  protected final String TEXT_528 = ".createStatement();" + NL + "                stmtDropExtDataSrc_";
  protected final String TEXT_529 = ".execute(\"DROP EXTERNAL DATA SOURCE [\" + azureExtDataSrc_";
  protected final String TEXT_530 = " + \"]\");" + NL + "                stmtDropExtDataSrc_";
  protected final String TEXT_531 = ".close();";
  protected final String TEXT_532 = NL + "                    log.info(\"";
  protected final String TEXT_533 = " - Dropped External Data Source : [\" + azureExtDataSrc_";
  protected final String TEXT_534 = " + \"] successfully.\");";
  protected final String TEXT_535 = NL + "                java.sql.Statement stmtDropDatabaseCred_";
  protected final String TEXT_536 = " = conn_";
  protected final String TEXT_537 = ".createStatement();" + NL + "                stmtDropDatabaseCred_";
  protected final String TEXT_538 = ".execute(\"DROP DATABASE SCOPED CREDENTIAL [\" + azureCredName_";
  protected final String TEXT_539 = " + \"]\");" + NL + "                stmtDropDatabaseCred_";
  protected final String TEXT_540 = ".close();";
  protected final String TEXT_541 = NL + "                    log.info(\"";
  protected final String TEXT_542 = " - Dropped Database Scoped Credential : [\" + azureCredName_";
  protected final String TEXT_543 = " + \"] successfully.\");";
  protected final String TEXT_544 = "   " + NL + "                throw e_";
  protected final String TEXT_545 = ";" + NL + "            }" + NL + "        " + NL + "            java.sql.Statement stmtDropExtTable_";
  protected final String TEXT_546 = " = conn_";
  protected final String TEXT_547 = ".createStatement();" + NL + "            stmtDropExtTable_";
  protected final String TEXT_548 = ".execute(\"DROP EXTERNAL TABLE [\" + ext_tableName_";
  protected final String TEXT_549 = " + \"]\");" + NL + "            stmtDropExtTable_";
  protected final String TEXT_550 = ".close();";
  protected final String TEXT_551 = NL + "                log.info(\"";
  protected final String TEXT_552 = " - Dropped External Table : [\" + ext_tableName_";
  protected final String TEXT_553 = " + \"] successfully.\");";
  protected final String TEXT_554 = "  " + NL + "            java.sql.Statement stmtDropExtFileFormat_";
  protected final String TEXT_555 = " = conn_";
  protected final String TEXT_556 = ".createStatement();" + NL + "            stmtDropExtFileFormat_";
  protected final String TEXT_557 = ".execute(\"DROP EXTERNAL FILE FORMAT [\" + azureExtFileFormat_";
  protected final String TEXT_558 = " + \"]\");" + NL + "            stmtDropExtFileFormat_";
  protected final String TEXT_559 = ".close();";
  protected final String TEXT_560 = NL + "                log.info(\"";
  protected final String TEXT_561 = " - Dropped External File Format : [\" + azureExtFileFormat_";
  protected final String TEXT_562 = " + \"] successfully.\");";
  protected final String TEXT_563 = "  " + NL + "            java.sql.Statement stmtDropExtDataSrc_";
  protected final String TEXT_564 = " = conn_";
  protected final String TEXT_565 = ".createStatement();" + NL + "            stmtDropExtDataSrc_";
  protected final String TEXT_566 = ".execute(\"DROP EXTERNAL DATA SOURCE [\" + azureExtDataSrc_";
  protected final String TEXT_567 = " + \"]\");" + NL + "            stmtDropExtDataSrc_";
  protected final String TEXT_568 = ".close();";
  protected final String TEXT_569 = NL + "                log.info(\"";
  protected final String TEXT_570 = " - Dropped External Data Source : [\" + azureExtDataSrc_";
  protected final String TEXT_571 = " + \"] successfully.\");";
  protected final String TEXT_572 = NL + NL + "            java.sql.Statement stmtDropDatabaseCred_";
  protected final String TEXT_573 = " = conn_";
  protected final String TEXT_574 = ".createStatement();" + NL + "            stmtDropDatabaseCred_";
  protected final String TEXT_575 = ".execute(\"DROP DATABASE SCOPED CREDENTIAL [\" + azureCredName_";
  protected final String TEXT_576 = " + \"]\");" + NL + "            stmtDropDatabaseCred_";
  protected final String TEXT_577 = ".close();";
  protected final String TEXT_578 = NL + "                log.info(\"";
  protected final String TEXT_579 = " - Dropped Database Scoped Credential : [\" + azureCredName_";
  protected final String TEXT_580 = " + \"] successfully.\");";
  protected final String TEXT_581 = NL + "            boolean isShareIdentity_";
  protected final String TEXT_582 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_583 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_584 = "\") == true;";
  protected final String TEXT_585 = NL + "        conn_";
  protected final String TEXT_586 = ".close();";
...
DBLogUtil dbLog = null;
    ...
    stringBuffer.append(azureFolder);
    ...
    stringBuffer.append(oauthEndpoint);
    ...
    stringBuffer.append(loadFileFormat);
    ...
    stringBuffer.append(rejectType);
    stringBuffer.append(TEXT_163);
    stringBuffer.append(rejectValue);
    ...
    stringBuffer.append(rejectSampleValue);
    ...
    stringBuffer.append(IndexColumns);
    ...
    stringBuffer.append(DistributionColumnName);
    ...
    stringBuffer.append(PartitionColumnName);
    stringBuffer.append(TEXT_184);
    stringBuffer.append(PartitionRange);
    stringBuffer.append(TEXT_185);
    stringBuffer.append(PartitionValues);
    ...
    stringBuffer.append(fileFormatType);
    ...
    stringBuffer.append(isTypeDefault);
    ...
    stringBuffer.append(serdeMethod);
