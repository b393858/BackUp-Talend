...
public class TVectorWiseRowFinallyJava
{
  protected static String nl;
  public static synchronized TVectorWiseRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseRowFinallyJava result = new TVectorWiseRowFinallyJava();
    nl = null;
    return result;
  }
