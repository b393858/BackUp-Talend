...
public class THDFSPropertiesBeginJava
{
  ...
  protected final String TEXT_151 = "Struct();" + NL + "\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_152 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_153 = ");" + NL + "\t" + NL + "\tif(fs_";
  protected final String TEXT_154 = ".exists(path_";
  protected final String TEXT_155 = ")) {" + NL + "\t    ";
  protected final String TEXT_156 = ".abs_path = path_";
  protected final String TEXT_157 = ".toString();" + NL + "\t    ";
  protected final String TEXT_158 = ".dirname = path_";
  protected final String TEXT_159 = ".getParent().toString();" + NL + "\t    ";
  protected final String TEXT_160 = ".basename = path_";
  protected final String TEXT_161 = ".getName();" + NL + "\t    " + NL + "\t    org.apache.hadoop.fs.FileStatus statu_";
  protected final String TEXT_162 = " = fs_";
  protected final String TEXT_163 = ".getFileStatus(path_";
  protected final String TEXT_164 = ");" + NL + "\t    " + NL + "\t    StringBuffer stringBuffer_";
  protected final String TEXT_165 = " = new StringBuffer();" + NL + "\t    stringBuffer_";
  protected final String TEXT_166 = ".append(statu_";
  protected final String TEXT_167 = ".getPermission());" + NL + "\t    stringBuffer_";
  protected final String TEXT_168 = ".append(\"(owner=\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_169 = ".append(statu_";
  protected final String TEXT_170 = ".getOwner());" + NL + "\t    stringBuffer_";
  protected final String TEXT_171 = ".append(\",\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_172 = ".append(\"group=\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_173 = ".append(statu_";
  protected final String TEXT_174 = ".getGroup());" + NL + "\t    stringBuffer_";
  protected final String TEXT_175 = ".append(\")\");" + NL + "\t    ";
  protected final String TEXT_176 = ".mode_string = stringBuffer_";
  protected final String TEXT_177 = ".toString();" + NL + "\t    " + NL + "\t    ";
  protected final String TEXT_178 = ".size = statu_";
  protected final String TEXT_179 = ".getLen();" + NL + "\t    ";
  protected final String TEXT_180 = ".mtime = statu_";
  protected final String TEXT_181 = ".getModificationTime();" + NL + "\t    ";
  protected final String TEXT_182 = ".mtime_string =(new java.util.Date(statu_";
  protected final String TEXT_183 = ".getModificationTime())).toString();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_184 = NL + "\t\t\tif(!statu_";
  protected final String TEXT_185 = ".isDir()) {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileChecksum checksum_";
  protected final String TEXT_186 = " = fs_";
  protected final String TEXT_187 = ".getFileChecksum(path_";
  protected final String TEXT_188 = ");" + NL + "\t\t\t\tif(checksum_";
  protected final String TEXT_189 = "!=null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_190 = ".md5 = checksum_";
  protected final String TEXT_191 = ".toString();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t\t" + NL + "\t\t" + NL + "\t}" + NL + "\t";
  protected final String TEXT_193 = NL + "\telse {" + NL + "\t\tlog.warn(\"";
  protected final String TEXT_194 = " - file or directory : \" + path_";
  protected final String TEXT_195 = " + \" does not exist.\");" + NL + "\t}" + NL + "\t";
