...
public class TFirebirdOutputBeginJava {
  ...
  protected final String TEXT_79 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_96 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_111 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_112 = " = conn_";
  protected final String TEXT_113 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_123 = NL + "                if(!conn_";
  protected final String TEXT_124 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_125 = ".commit();" + NL + "                }";
  protected final String TEXT_126 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_159 = ".createStatement();" + NL + "                            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_169 = NL + "                if(!conn_";
  protected final String TEXT_170 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_171 = ".commit();" + NL + "                }";
  protected final String TEXT_172 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_188 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_214 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_223 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_224 = "\", pstmtUpdate_";
  protected final String TEXT_225 = ");" + NL + "\t    ";
  protected final String TEXT_226 = NL + "\t    String update_";
  protected final String TEXT_227 = " = \"UPDATE \" + ";
  protected final String TEXT_228 = " + \" SET ";
  protected final String TEXT_229 = " WHERE ";
  protected final String TEXT_230 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".prepareStatement(update_";
  protected final String TEXT_233 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_234 = "\", pstmtUpdate_";
  protected final String TEXT_235 = ");" + NL + "\t    String insert_";
  protected final String TEXT_236 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_241 = ".prepareStatement(insert_";
  protected final String TEXT_242 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_243 = "\", pstmtInsert_";
  protected final String TEXT_244 = ");" + NL + "\t    ";
  protected final String TEXT_245 = NL + "\t    String delete_";
  protected final String TEXT_246 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_247 = " + \" WHERE ";
  protected final String TEXT_248 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_249 = " = conn_";
  protected final String TEXT_250 = ".prepareStatement(delete_";
  protected final String TEXT_251 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_252 = "\", pstmt_";
  protected final String TEXT_253 = ");" + NL + "\t    ";
  protected final String TEXT_254 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_259 = NL + "\t\t\tupdate_";
  protected final String TEXT_260 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_261 = " = update_";
  ...
  protected final String TEXT_266 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_267 = " = insert_";
  protected final String TEXT_268 = ".split(\"\\\\?\");";
  protected final String TEXT_269 = NL + "\t\t\tdelete_";
  protected final String TEXT_270 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_271 = " = delete_";
  protected final String TEXT_272 = ".split(\"\\\\?\");";
  protected final String TEXT_273 = NL + "\t\t\treplace_";
  protected final String TEXT_274 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_275 = " = replace_";
  protected final String TEXT_276 = ".split(\"\\\\?\");";
  protected final String TEXT_277 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_278 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_279 = " = insertIgnore_";
  protected final String TEXT_280 = ".split(\"\\\\?\");";
  protected final String TEXT_281 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_282 = " = insert_";
  protected final String TEXT_283 = ".split(\"\\\\?\");";
