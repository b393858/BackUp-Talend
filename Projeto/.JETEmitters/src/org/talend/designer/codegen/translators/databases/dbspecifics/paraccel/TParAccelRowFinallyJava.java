...
public class TParAccelRowFinallyJava
{
  protected static String nl;
  public static synchronized TParAccelRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelRowFinallyJava result = new TParAccelRowFinallyJava();
    nl = null;
    return result;
  }
