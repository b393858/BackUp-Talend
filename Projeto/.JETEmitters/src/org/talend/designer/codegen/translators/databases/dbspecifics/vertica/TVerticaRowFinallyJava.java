...
public class TVerticaRowFinallyJava
{
  protected static String nl;
  public static synchronized TVerticaRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaRowFinallyJava result = new TVerticaRowFinallyJava();
    nl = null;
    return result;
  }
