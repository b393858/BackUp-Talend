...
public class TSybaseRowBeginJava
{
  ...
  protected final String TEXT_124 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_125 = " + \":\" + ";
  protected final String TEXT_126 = " + \";DatabaseName=\" + ";
  protected final String TEXT_127 = "; ";
  protected final String TEXT_128 = NL + "\t\t\t\tString url_";
  protected final String TEXT_129 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_130 = " + \":\" + ";
  protected final String TEXT_131 = " + \";DatabaseName\" + ";
  protected final String TEXT_132 = " + \";\" + ";
  protected final String TEXT_133 = ";";
  protected final String TEXT_134 = NL + "\t\t\t\tString url_";
  protected final String TEXT_135 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_136 = " + \":\" + ";
  protected final String TEXT_137 = " + \"/\" + ";
  protected final String TEXT_138 = "; " + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\tString url_";
  protected final String TEXT_140 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_141 = " + \":\" + ";
  protected final String TEXT_142 = " + \"/\" + ";
  protected final String TEXT_143 = " + \"?\" + ";
  protected final String TEXT_144 = ";" + NL + "\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\tString tableName_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = " ;" + NL + "\t\t\t\tString dbschema_";
  protected final String TEXT_148 = " = ";
  protected final String TEXT_149 = ";" + NL + "\t\t\t\tif (dbschema_";
  protected final String TEXT_150 = " != null && dbschema_";
  protected final String TEXT_151 = ".trim().length() != 0) {" + NL + "\t\t\t\t\ttableName_";
  protected final String TEXT_152 = " = dbschema_";
  protected final String TEXT_153 = " + \".\" + ";
  protected final String TEXT_154 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t\tstmt_";
  protected final String TEXT_155 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_156 = " +\" ON\");" + NL + "\t\t\t";
  protected final String TEXT_157 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_158 = " = null;" + NL + "\tString query_";
  protected final String TEXT_159 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_160 = " = false;";
  protected final String TEXT_161 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_167 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_172 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_173 = "\", stmt_";
