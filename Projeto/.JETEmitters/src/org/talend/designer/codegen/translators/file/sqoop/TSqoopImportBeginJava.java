...
public class TSqoopImportBeginJava
{
  ...
  protected final String TEXT_277 = "); // __USERNAME__" + NL + "\tif((";
  protected final String TEXT_278 = " != null) && !\"\".equals(";
  protected final String TEXT_279 = ")) {" + NL + "    \tcom.cloudera.sqoop.metastore.JobData jobData_";
  protected final String TEXT_280 = " = new com.cloudera.sqoop.metastore.JobData(sqoopOptions_";
  protected final String TEXT_281 = ", null);" + NL + "    \torg.apache.sqoop.manager.DefaultManagerFactory defaultManagerFactory_";
  protected final String TEXT_282 = " = new org.apache.sqoop.manager.DefaultManagerFactory();" + NL + "    \tif(null == defaultManagerFactory_";
  protected final String TEXT_283 = ".accept(jobData_";
  protected final String TEXT_284 = ")) {" + NL + "    \t\tsqoopOptions_";
  protected final String TEXT_285 = ".setDriverClassName(";
  protected final String TEXT_286 = ");//driver class name" + NL + "    \t}" + NL + "    }" + NL + "\t";
  protected final String TEXT_287 = NL + "\t\t";
  protected final String TEXT_288 = NL + "\t\t";
  protected final String TEXT_289 = " " + NL + "\tfinal String decryptedPassword_";
  ...
  protected final String TEXT_295 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_296 = ".setPassword(decryptedPassword_";
  protected final String TEXT_297 = "); // __PASSWORD__" + NL + "\t";
  protected final String TEXT_298 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_299 = ".setPasswordFilePath(";
  protected final String TEXT_300 = ");" + NL + "\t\tsqoopOptions_";
  protected final String TEXT_301 = ".setPassword(org.apache.sqoop.util.CredentialsUtil.fetchPassword";
  ...
  protected final String TEXT_306 = ".setSqlQuery(";
  protected final String TEXT_307 = ");" + NL + "\t";
  protected final String TEXT_308 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_309 = ".setTableName(";
  protected final String TEXT_310 = "); // __TABLE__" + NL + "\t\t";
  protected final String TEXT_311 = "sqoopOptions_";
  protected final String TEXT_312 = ".setColumns(lColumns_";
  protected final String TEXT_313 = ".toArray(new String[lColumns_";
  protected final String TEXT_314 = ".size()]));";
  protected final String TEXT_315 = NL + "\t\t";
  protected final String TEXT_316 = "sqoopOptions_";
  protected final String TEXT_317 = ".setWhereClause(";
  protected final String TEXT_318 = "); // __WHERE__";
  protected final String TEXT_319 = NL + "\t";
  protected final String TEXT_320 = NL + "\t";
  protected final String TEXT_321 = "sqoopOptions_";
  protected final String TEXT_322 = ".setAppendMode(true);";
  protected final String TEXT_323 = NL + "\t";
  protected final String TEXT_324 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_325 = ".setDirectMode(true);" + NL + "\t\t";
  protected final String TEXT_326 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_327 = ".setDirectSplitSize(Long.parseLong(";
  protected final String TEXT_328 = "));" + NL + "\t\t";
  protected final String TEXT_329 = NL + "\t";
  protected final String TEXT_330 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_331 = ".setUseCompression(true);" + NL + "\t\t";
  protected final String TEXT_332 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_333 = ".setCompressionCodec(";
  protected final String TEXT_334 = ");" + NL + "\t\t";
  protected final String TEXT_335 = NL + "\t";
  protected final String TEXT_336 = "sqoopOptions_";
  protected final String TEXT_337 = ".setTargetDir(";
  protected final String TEXT_338 = ");";
  protected final String TEXT_339 = NL + "\t";
  protected final String TEXT_340 = "sqoopOptions_";
  protected final String TEXT_341 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.SequenceFile);";
  protected final String TEXT_342 = "sqoopOptions_";
  protected final String TEXT_343 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.TextFile);";
  protected final String TEXT_344 = "sqoopOptions_";
  protected final String TEXT_345 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.ParquetFile);";
  protected final String TEXT_346 = "sqoopOptions_";
  protected final String TEXT_347 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.AvroDataFile);";
  protected final String TEXT_348 = NL + "\t";
  protected final String TEXT_349 = "sqoopOptions_";
  protected final String TEXT_350 = ".setNumMappers(Integer.valueOf(";
  protected final String TEXT_351 = "));";
  protected final String TEXT_352 = NL + "\t";
  protected final String TEXT_353 = "sqoopOptions_";
  protected final String TEXT_354 = ".setSplitByCol(";
  protected final String TEXT_355 = ");";
  protected final String TEXT_356 = NL + "\t";
  protected final String TEXT_357 = NL + "\t\t";
  protected final String TEXT_358 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_359 = ".setDeleteMode(true);" + NL + "\t\t";
  protected final String TEXT_360 = NL + "\t";
  protected final String TEXT_361 = NL + "\t" + NL + "\t";
  protected final String TEXT_362 = NL + "\t\t\tStringBuilder sb_java_";
  protected final String TEXT_363 = " = new StringBuilder();" + NL + "\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\tsb_java_";
  protected final String TEXT_365 = ".append(";
  protected final String TEXT_366 = " + \"=\" + ";
  protected final String TEXT_367 = ");" + NL + "\t";
  protected final String TEXT_368 = NL + "\t\t\t\t\tsb_java_";
  protected final String TEXT_369 = ".append(\",\" + ";
  protected final String TEXT_370 = " + \"=\" + ";
  protected final String TEXT_371 = ");" + NL + "\t";
  protected final String TEXT_372 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_373 = ".setMapColumnJava(sb_java_";
  protected final String TEXT_374 = ".toString());" + NL + "\t";
  protected final String TEXT_375 = NL + "\t\t\tStringBuilder sb_hive_";
  protected final String TEXT_376 = " = new StringBuilder();" + NL + "\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\tsb_hive_";
  protected final String TEXT_378 = ".append(";
  protected final String TEXT_379 = " + \"=\" + ";
  protected final String TEXT_380 = ");" + NL + "\t";
  protected final String TEXT_381 = NL + "\t\t\t\t\tsb_hive_";
  protected final String TEXT_382 = ".append(\",\" + ";
  protected final String TEXT_383 = " + \"=\" + ";
  protected final String TEXT_384 = ");" + NL + "\t";
  protected final String TEXT_385 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_386 = ".setMapColumnHive(sb_hive_";
  protected final String TEXT_387 = ".toString());" + NL + "\t";
  protected final String TEXT_388 = NL + "\t" + NL + "\tjava.util.Properties additionalProperties_";
  protected final String TEXT_389 = " = new java.util.Properties();" + NL + "\t";
  protected final String TEXT_390 = NL + "\t\tadditionalProperties_";
  protected final String TEXT_391 = ".put(\"customtool.options.jsonmap\", \"{\\\"\\\":\\\"\\\"}\");" + NL + "\t";
  protected final String TEXT_392 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_393 = ".put(";
  protected final String TEXT_394 = ", \"\"+";
  protected final String TEXT_395 = ".codePointAt(0)); ";
  protected final String TEXT_396 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_397 = ".put(";
  protected final String TEXT_398 = ", ";
  protected final String TEXT_399 = "); ";
  protected final String TEXT_400 = NL + NL + "\tjava.util.Properties storedJavaMapping_";
  protected final String TEXT_401 = " = sqoopOptions_";
  protected final String TEXT_402 = ".getMapColumnJava();" + NL + "\tjava.util.Properties storedHiveMapping_";
  protected final String TEXT_403 = " = sqoopOptions_";
  protected final String TEXT_404 = ".getMapColumnHive();" + NL + "" + NL + "\tfor (java.util.Map.Entry entry: additionalProperties_";
  protected final String TEXT_405 = ".entrySet()) {" + NL + "\t\tString curKey = entry.getKey() == null ? \"null\" : entry.getKey().toString();" + NL + "\t\tString curValue = entry.getValue() == null ? \"null\" : entry.getValue().toString();" + NL + "\t\t" + NL + "\t\tif (curKey.startsWith(\"map.column.java.\")) {" + NL + "\t\t\tstoredJavaMapping_";
  protected final String TEXT_406 = ".put(curKey.substring(\"map.column.java.\".length(), curKey.length()), curValue); " + NL + "\t\t}" + NL + "\t\tif (curKey.startsWith(\"map.column.hive.\")) {" + NL + "\t\t\tstoredHiveMapping_";
  protected final String TEXT_407 = ".put(curKey.substring(\"map.column.hive.\".length(), curKey.length()), curValue); " + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\tsqoopOptions_";
  protected final String TEXT_408 = ".loadProperties(additionalProperties_";
  protected final String TEXT_409 = ");" + NL + "\t" + NL + "\t//restoring java/hive mapping because SqoopOptions.loadProperties() rewrites it completely" + NL + "\t//all mapping from additional properties are preserved" + NL + "\tif ((storedJavaMapping_";
  protected final String TEXT_410 = " != null) && !storedJavaMapping_";
  protected final String TEXT_411 = ".isEmpty()) {" + NL + "\t\tString storedJavaMappingStr_";
  protected final String TEXT_412 = " = storedJavaMapping_";
  protected final String TEXT_413 = ".toString().replaceAll(\", \", \",\");" + NL + "\t\tstoredJavaMappingStr_";
  protected final String TEXT_414 = " = storedJavaMappingStr_";
  protected final String TEXT_415 = ".substring(1, storedJavaMappingStr_";
  protected final String TEXT_416 = ".length()-1);//removing \"{\" and \"}\"" + NL + "\t\tsqoopOptions_";
  protected final String TEXT_417 = ".setMapColumnJava(storedJavaMappingStr_";
  protected final String TEXT_418 = ");" + NL + "\t}" + NL + "" + NL + "\tif ((storedHiveMapping_";
  protected final String TEXT_419 = " != null) && !storedHiveMapping_";
  protected final String TEXT_420 = ".isEmpty()) {" + NL + "\t\tString storedHiveMappingStr_";
  protected final String TEXT_421 = " = storedJavaMapping_";
  protected final String TEXT_422 = ".toString().replaceAll(\", \", \",\");" + NL + "\t\tstoredHiveMappingStr_";
  protected final String TEXT_423 = " = storedHiveMappingStr_";
  protected final String TEXT_424 = ".substring(1, storedHiveMappingStr_";
  protected final String TEXT_425 = ".length()-1);//removing \"{\" and \"}\"" + NL + "\t\tsqoopOptions_";
  protected final String TEXT_426 = ".setMapColumnHive(storedHiveMappingStr_";
  protected final String TEXT_427 = ");" + NL + "\t}" + NL + "\t" + NL + "\torg.apache.sqoop.Sqoop sqoop_";
  protected final String TEXT_428 = " = new org.apache.sqoop.Sqoop(sqoopTool_";
  protected final String TEXT_429 = ", configuration_";
  protected final String TEXT_430 = ", sqoopOptions_";
  protected final String TEXT_431 = ");" + NL + "\t";
  protected final String TEXT_432 = NL + "\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_433 = " = new routines.system.GetJarsToRegister();" + NL + "\t\tjava.lang.StringBuilder sb_";
  protected final String TEXT_434 = " = new java.lang.StringBuilder();";
  protected final String TEXT_435 = NL + "\t\t\t\t\tsb_";
  protected final String TEXT_436 = ".append(getJarsToRegister_";
  protected final String TEXT_437 = ".replaceJarPaths(\"";
  protected final String TEXT_438 = "\", \"file:///\") + \",\");";
  protected final String TEXT_439 = NL + "\t";
  protected final String TEXT_440 = NL + "\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_441 = " = new routines.system.GetJarsToRegister();" + NL + "\t\tjava.lang.StringBuilder sb_";
  protected final String TEXT_442 = " = new java.lang.StringBuilder();";
  ...
  protected final String TEXT_446 = "\", \"file:///\") + \",\");";
  protected final String TEXT_447 = NL + "\ttry {";
  protected final String TEXT_448 = NL + "\t\t\tint result_";
  protected final String TEXT_449 = " = org.apache.sqoop.Sqoop.runSqoop(sqoop_";
  protected final String TEXT_450 = ", new String[] {\"-libjars\", sb_";
  protected final String TEXT_451 = ".toString()});";
  protected final String TEXT_452 = NL + "\t\t\tint result_";
  protected final String TEXT_453 = " = org.apache.sqoop.Sqoop.runSqoop(sqoop_";
  protected final String TEXT_454 = ", new String[] {});";
  protected final String TEXT_455 = NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_456 = "_EXIT_CODE\", result_";
  protected final String TEXT_457 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_458 = " != 0) {";
  protected final String TEXT_459 = NL + "\t\t\t\tthrow new Exception(\"The Sqoop import job has failed. Please check the logs.\");";
  protected final String TEXT_460 = NL + "\t\t\t\tSystem.err.println(\"The Sqoop import job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_461 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_462 = " - The Sqoop import job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_463 = NL + "\t\t}" + NL + "\t} catch (Exception e) {";
  protected final String TEXT_464 = NL + "\t\t\tthrow e;";
  protected final String TEXT_465 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_466 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_467 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_468 = NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_469 = NL + "String currentClientPathSeparator_";
  protected final String TEXT_470 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_471 = "!=null) {" + NL + "\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_472 = ");" + NL + "\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_473 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_474 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_475 = "!=null) {" + NL + "\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_476 = ");" + NL + "\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_477 = "\", null);" + NL + "} else {" + NL + "\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
