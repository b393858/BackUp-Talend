...
public class TSQLiteOutputBeginJava {
  ...
  protected final String TEXT_80 = NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_81 = "\");" + NL + "    String url_";
  protected final String TEXT_82 = " = \"jdbc:sqlite:\"+ \"/\" + ";
  ...
  protected final String TEXT_87 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_88 = "\", conn_";
  protected final String TEXT_89 = ");";
  protected final String TEXT_90 = NL + "        conn_";
  protected final String TEXT_91 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_94 = " = 0;";
  protected final String TEXT_95 = NL;
  protected final String TEXT_96 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_97 = " = conn_";
  protected final String TEXT_98 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_108 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_118 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_119 = " = dbMetaData_";
  protected final String TEXT_120 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_126 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  protected final String TEXT_127 = NL + "                if(!whetherExist_";
  protected final String TEXT_128 = ") {" + NL + "                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_142 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_149 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_180 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_181 = " + \"\\\" WHERE ";
  protected final String TEXT_182 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_188 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_189 = " = conn_";
  protected final String TEXT_190 = ".prepareStatement(insert_";
  protected final String TEXT_191 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_197 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".prepareStatement(update_";
  protected final String TEXT_200 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_210 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_228 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_229 = "\", pstmt_";
  protected final String TEXT_230 = ");" + NL + "\t    ";
  protected final String TEXT_231 = NL + "        StringBuffer query_";
  protected final String TEXT_232 = " = null;" + NL + "       \t";
  protected final String TEXT_233 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_240 = NL + "\t\t\tupdate_";
  protected final String TEXT_241 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_242 = " = update_";
  protected final String TEXT_243 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_244 = " = insert_";
  protected final String TEXT_245 = ".split(\"\\\\?\");";
  protected final String TEXT_246 = NL + "\t\t\tdelete_";
  protected final String TEXT_247 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_248 = " = delete_";
  protected final String TEXT_249 = ".split(\"\\\\?\");";
  protected final String TEXT_250 = NL + "\t\t\treplace_";
  protected final String TEXT_251 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_252 = " = replace_";
  protected final String TEXT_253 = ".split(\"\\\\?\");";
  protected final String TEXT_254 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_255 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_256 = " = insertIgnore_";
  protected final String TEXT_257 = ".split(\"\\\\?\");";
  protected final String TEXT_258 = NL + "\t\t \tString[] insertSQLSplits_";
