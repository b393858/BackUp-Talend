...
public class TIngresOutputMainJava {
  ...
  protected final String TEXT_203 = "_QUERY\", query_";
  protected final String TEXT_204 = ".toString().trim());";
  protected final String TEXT_205 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_206 = " = insertedCount_";
  protected final String TEXT_207 = " + pstmtInsert_";
  protected final String TEXT_208 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_213 = NL + "                        nb_line_";
  protected final String TEXT_214 = "++;";
  protected final String TEXT_215 = NL + "                            ";
  protected final String TEXT_216 = " = new ";
  protected final String TEXT_217 = "Struct();";
  protected final String TEXT_218 = NL + "                                ";
  protected final String TEXT_219 = ".";
  protected final String TEXT_220 = " = ";
  protected final String TEXT_221 = ".";
  protected final String TEXT_222 = ";";
  protected final String TEXT_223 = NL + "                            rejectedCount_";
  protected final String TEXT_224 = " = rejectedCount_";
  protected final String TEXT_225 = " + 1;";
  protected final String TEXT_226 = NL + "                            ";
  protected final String TEXT_227 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_228 = NL + "                            ";
  protected final String TEXT_229 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_230 = ";";
  protected final String TEXT_231 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_232 = NL + "                }" + NL + "            }";
  protected final String TEXT_233 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_256 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_257 = " == 0) {";
  protected final String TEXT_258 = NL + "                query_";
  protected final String TEXT_259 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_310 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_311 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_312 = "++;";
  protected final String TEXT_313 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_314 = " = deletedCount_";
  protected final String TEXT_315 = " + pstmt_";
  protected final String TEXT_316 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_317 = "++;";
  protected final String TEXT_318 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_319 = " = true;";
  protected final String TEXT_320 = NL + "                               throw(e);";
  ...
  protected final String TEXT_331 = NL + "                                   rejectedCount_";
  protected final String TEXT_332 = " = rejectedCount_";
  protected final String TEXT_333 = " + 1;";
  protected final String TEXT_334 = NL + "                                   ";
  protected final String TEXT_335 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_336 = NL + "                                   ";
  protected final String TEXT_337 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_338 = ";";
  protected final String TEXT_339 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_340 = NL + "                       }";
  protected final String TEXT_341 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_352 = NL + "                if ((batchSize_";
  protected final String TEXT_353 = " > 0) && (batchSize_";
  protected final String TEXT_354 = " <= batchSizeCounter_";
  protected final String TEXT_355 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_356 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_357 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_358 = " = 0;";
  protected final String TEXT_359 = NL + "                        status_";
  protected final String TEXT_360 = " = pstmt_";
  protected final String TEXT_361 = ".executeBatch();";
  protected final String TEXT_362 = NL + "                        for(int countEach_";
  protected final String TEXT_363 = ": status_";
  protected final String TEXT_364 = ") {" + NL + "                            countSum_";
  protected final String TEXT_365 = " += (countEach_";
  protected final String TEXT_366 = " < 0 ? 0 : countEach_";
  protected final String TEXT_367 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_368 = NL + "                            throw(e);";
  protected final String TEXT_369 = NL + "                        for(int countEach_";
  protected final String TEXT_370 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_371 = " += (countEach_";
  protected final String TEXT_372 = " < 0 ? 0 : countEach_";
  protected final String TEXT_373 = ");" + NL + "                        }";
  protected final String TEXT_374 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_375 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_376 = " = pstmt_";
  protected final String TEXT_377 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_378 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_379 = " = tmp_batchUpdateCount_";
  ...
  protected final String TEXT_394 = NL + "                commitCounter_";
  protected final String TEXT_395 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_396 = " <= commitCounter_";
  protected final String TEXT_397 = ") {";
  protected final String TEXT_398 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_399 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_400 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_401 = NL + "\t                    for(int countEach_";
  protected final String TEXT_402 = ": pstmt_";
  protected final String TEXT_403 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_404 = " += (countEach_";
  protected final String TEXT_405 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_418 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_419 = NL + "                        throw(e);";
  protected final String TEXT_420 = NL + "                        int countSum_";
  protected final String TEXT_421 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_422 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_423 = " += (countEach_";
  protected final String TEXT_424 = " < 0 ? 0 : countEach_";
  protected final String TEXT_425 = ");" + NL + "                        }";
  protected final String TEXT_426 = NL + "                            insertedCount_";
  protected final String TEXT_427 = " += countSum_";
  protected final String TEXT_428 = ";";
  protected final String TEXT_429 = NL + "                            updatedCount_";
  protected final String TEXT_430 = " += countSum_";
  protected final String TEXT_431 = ";";
  protected final String TEXT_432 = NL + "                            deletedCount_";
  protected final String TEXT_433 = " += countSum_";
  protected final String TEXT_434 = ";";
  protected final String TEXT_435 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_436 = NL + "                }";
  protected final String TEXT_437 = NL + "                ";
  protected final String TEXT_438 = NL + "                conn_";
  protected final String TEXT_439 = ".commit();";
  protected final String TEXT_440 = NL + "                commitCounter_";
  protected final String TEXT_441 = "=0;" + NL + "            }";
