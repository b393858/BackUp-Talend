package org.talend.designer.codegen.translators.databases.dbspecifics.paraccel;
...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_93 = NL + "\tString xpxSQL_";
  protected final String TEXT_94 = "=\"\";" + NL + "\tString bulkSQL_";
  protected final String TEXT_95 = "=\"\";";
  protected final String TEXT_96 = NL + "\txpxSQL_";
  protected final String TEXT_97 = " += \"xpx 'localize \\\"\" + tableName_";
  protected final String TEXT_98 = " +\"\\\"\" + ";
  protected final String TEXT_99 = " + \" ";
  protected final String TEXT_100 = "'\";" + NL + "\tbulkSQL_";
  protected final String TEXT_101 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_102 = " + \"\\\"\" + " + NL + "\t\t\" FROM 'local' WITH PARALLEL ";
  protected final String TEXT_103 = " \";";
  protected final String TEXT_104 = NL + "\tbulkSQL_";
  protected final String TEXT_105 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_106 = " + \"\\\"\" + \"";
  protected final String TEXT_107 = "FROM '\" +" + NL + "\t\t";
  protected final String TEXT_108 = " + \"' WITH ";
  protected final String TEXT_109 = " \";";
  protected final String TEXT_110 = NL + "\tbulkSQL_";
  protected final String TEXT_111 = " += \"DELIMITER '\" + (";
  protected final String TEXT_112 = ").charAt(0) + \"' \";";
  protected final String TEXT_113 = NL + "\t\t\tbulkSQL_";
  protected final String TEXT_114 = " += \"FIXEDWIDTH '\" + ";
  protected final String TEXT_115 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_116 = NL + "\t\tbulkSQL_";
  protected final String TEXT_117 = " += \"FIXEDWIDTH '\";" + NL + "\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\tbulkSQL_";
  ...
  protected final String TEXT_129 = " += \"REMOVEQUOTES \";";
  protected final String TEXT_130 = NL + "\tbulkSQL_";
  protected final String TEXT_131 = " += \"EXPLICIT_IDS \";";
  protected final String TEXT_132 = NL + "\tbulkSQL_";
  protected final String TEXT_133 = " += \"MAXERROR \" + ";
  protected final String TEXT_134 = " + \" \";";
  protected final String TEXT_135 = NL + "\tbulkSQL_";
  protected final String TEXT_136 = " += \"DATEFORMAT '\" + ";
  protected final String TEXT_137 = " + \"' \";";
  protected final String TEXT_138 = NL + "\tbulkSQL_";
  protected final String TEXT_139 = " += \"TIMEFORMAT '\" + ";
  protected final String TEXT_140 = " + \"' \";";
  protected final String TEXT_141 = NL + "\tbulkSQL_";
  protected final String TEXT_142 = " += ";
  protected final String TEXT_143 = " + \" \";";
  protected final String TEXT_144 = " " + NL + "if (";
  protected final String TEXT_145 = " > 0) {" + NL + "\tjava.io.Writer output_";
  protected final String TEXT_146 = " = new java.io.FileWriter(";
  protected final String TEXT_147 = ", true);" + NL + "\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_148 = ",true));" + NL + "}\t" + NL + "com.paraccel.Driver.setLogLevel(";
  protected final String TEXT_149 = ");" + NL + "" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_154 = NL + "\t \tString driverClass_";
  protected final String TEXT_155 = " = \"com.paraccel.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_156 = ").newInstance();" + NL + "\t\tString url_";
  protected final String TEXT_157 = " = \"jdbc:paraccel://\" + ";
  protected final String TEXT_158 = " + \":\" + ";
  protected final String TEXT_159 = " + \"/\" + ";
  protected final String TEXT_160 = "+\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_161 = "+\"&protocolVersion=3\";" + NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_180 = " - Droping table ";
  ...
  protected final String TEXT_188 = " - Drop table ";
  ...
  protected final String TEXT_193 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_215 = " - Creating table ";
  protected final String TEXT_216 = "\" + tableName_";
  ...
  protected final String TEXT_223 = " - Create table ";
  protected final String TEXT_224 = "\" + tableName_";
  protected final String TEXT_225 = " + \"";
  protected final String TEXT_226 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_232 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_233 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_234 = " = tableNameForSearch_";
  protected final String TEXT_235 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_236 = " = tableNameForSearch_";
  protected final String TEXT_237 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_241 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_242 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_243 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_244 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_257 = ".equalsIgnoreCase(";
  protected final String TEXT_258 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_259 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_260 = ") || dbschema_";
  protected final String TEXT_261 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_272 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_276 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_277 = ".equals(schema_";
  protected final String TEXT_278 = ") || (schema_";
  protected final String TEXT_279 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_280 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_348 = ".getTables(null, dbschema_";
  ...
  protected final String TEXT_352 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_360 = ".getTables(";
  protected final String TEXT_361 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_362 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_363 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_364 = " = rsTable_";
  protected final String TEXT_365 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  ...
  protected final String TEXT_372 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_373 = " = conn_";
  protected final String TEXT_374 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_375 = " = dbMetaData_";
  protected final String TEXT_376 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_377 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_378 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_379 = " = rsTable_";
  protected final String TEXT_380 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_390 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_392 = " - Creating table ";
  protected final String TEXT_393 = "\" + tableName_";
  ...
  protected final String TEXT_400 = " - Create table ";
  ...
  protected final String TEXT_405 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_407 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_411 = " - Droping table ";
  ...
  protected final String TEXT_419 = " - Drop table ";
  ...
  protected final String TEXT_424 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_446 = " - Clearing table ";
  protected final String TEXT_447 = "\" + tableName_";
  ...
  protected final String TEXT_454 = "- Clear table ";
  protected final String TEXT_455 = "\" + tableName_";
  protected final String TEXT_456 = " + \"";
  protected final String TEXT_457 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_458 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_467 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_468 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_469 = " - Trancating table ";
  ...
  protected final String TEXT_477 = " - Truncate table ";
  protected final String TEXT_478 = "\" + tableName_";
  protected final String TEXT_479 = " + \"";
  protected final String TEXT_480 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_487 = ".close();" + NL + "\t\t";
  protected final String TEXT_488 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_489 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_490 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_491 = NL + "\t";
  protected final String TEXT_492 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_493 = " = conn_";
  protected final String TEXT_494 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_495 = NL + "\t";
  protected final String TEXT_496 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_497 = " - Paralle bulk SQL:\"+xpxSQL_";
  protected final String TEXT_498 = "+\".\");" + NL + "\t\tlog.debug(\"";
  protected final String TEXT_499 = " - Executing parallel bulk SQL.\");" + NL + "\t";
  protected final String TEXT_500 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_501 = " = conn_";
  protected final String TEXT_502 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_503 = ".execute(xpxSQL_";
  protected final String TEXT_504 = ");";
  protected final String TEXT_505 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_506 = " - Execute parallel bulk SQL has finished.\");" + NL + "\t";
  protected final String TEXT_507 = NL + "    stmtXPX_";
  protected final String TEXT_508 = ".close();    ";
  protected final String TEXT_509 = NL + "\t";
  protected final String TEXT_510 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_511 = " - Bulk SQL:\"+bulkSQL_";
  ...
  protected final String TEXT_517 = NL + "    stmtBulk_";
  protected final String TEXT_518 = ".execute(bulkSQL_";
  protected final String TEXT_519 = ");" + NL + "\t";
  protected final String TEXT_520 = NL + "\t\tlog.info(\"";
  protected final String TEXT_521 = " - Bulk insert data into ";
  protected final String TEXT_522 = "\" + tableName_";
  protected final String TEXT_523 = " + \"";
  protected final String TEXT_524 = " has finished.\");" + NL + "\t";
  protected final String TEXT_525 = NL + "    stmtBulk_";
  protected final String TEXT_526 = ".close();    ";
