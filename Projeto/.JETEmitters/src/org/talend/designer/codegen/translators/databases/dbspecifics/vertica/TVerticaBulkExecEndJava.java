...
public class TVerticaBulkExecEndJava {
  protected static String nl;
  public static synchronized TVerticaBulkExecEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaBulkExecEndJava result = new TVerticaBulkExecEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_77 = NL + "    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_78 = ").finishCopyIn();" + NL + "    " + NL + "    rs_";
  protected final String TEXT_79 = "= stmt_";
  protected final String TEXT_80 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_81 = ");" + NL + "    int nbLineAfterLoad_";
  protected final String TEXT_82 = "= 0;" + NL + "    while (rs_";
  protected final String TEXT_83 = ".next()) {" + NL + "        nbLineAfterLoad_";
  protected final String TEXT_84 = "= rs_";
  protected final String TEXT_85 = ".getInt(1);" + NL + "    }" + NL + "    stmt_";
  protected final String TEXT_86 = ".close();" + NL + "    if(";
  protected final String TEXT_87 = "&& nbLineBeforeLoad_";
  protected final String TEXT_88 = ">= nbLineAfterLoad_";
  protected final String TEXT_89 = "){" + NL + "        throw new RuntimeException(\"No record was inserted in component";
  protected final String TEXT_90 = "\");" + NL + "    }" + NL + "    else{";
  protected final String TEXT_91 = NL + "        log.info(\"";
  protected final String TEXT_92 = "- Number of records inserted to table";
  protected final String TEXT_93 = "\" + tableName_";
  protected final String TEXT_94 = "+ \"";
  protected final String TEXT_95 = "by";
  protected final String TEXT_96 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_97 = "- nbLineBeforeLoad_";
  protected final String TEXT_98 = ")+\".\");";
  protected final String TEXT_99 = NL + "        System.out.println(\"Number of records inserted to table";
  protected final String TEXT_100 = "\" + tableName_";
  protected final String TEXT_101 = "+ \"";
  protected final String TEXT_102 = "by";
  protected final String TEXT_103 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_104 = "- nbLineBeforeLoad_";
  protected final String TEXT_105 = "));" + NL + "    }" + NL + "    globalMap.put(\"";
  protected final String TEXT_106 = "_ACCEPTED_ROW_NUMBER\",nbLineAfterLoad_";
  protected final String TEXT_107 = "- nbLineBeforeLoad_";
  protected final String TEXT_108 = ");";
  protected final String TEXT_109 = NL + "    vcs_";
  protected final String TEXT_110 = ".finish();" + NL + "" + NL + "    long copyNumber_";
  protected final String TEXT_111 = " = vcs_";
  protected final String TEXT_112 = ".getRowCount();" + NL + "    " + NL + "    //get rejected and accepted row number" + NL + "    java.sql.Statement stmt_accept_reject_";
  protected final String TEXT_113 = " = conn_";
  protected final String TEXT_114 = ".createStatement();" + NL + "    " + NL + "    java.sql.ResultSet rs_";
  protected final String TEXT_115 = " = stmt_accept_reject_";
  protected final String TEXT_116 = ".executeQuery(\"select get_num_accepted_rows()\");" + NL + "    int acceptedRowNumber_";
  protected final String TEXT_117 = " = 0;" + NL + "    while (rs_";
  protected final String TEXT_118 = ".next()) {" + NL + "        acceptedRowNumber_";
  protected final String TEXT_119 = " = rs_";
  protected final String TEXT_120 = ".getInt(1);" + NL + "    }" + NL + "    " + NL + "    rs_";
  protected final String TEXT_121 = " = stmt_accept_reject_";
  protected final String TEXT_122 = ".executeQuery(\"select get_num_rejected_rows()\");" + NL + "    int rejectedRowNumber_";
  protected final String TEXT_123 = " = 0;" + NL + "    while (rs_";
  protected final String TEXT_124 = ".next()) {" + NL + "        rejectedRowNumber_";
  protected final String TEXT_125 = " = rs_";
  protected final String TEXT_126 = ".getInt(1);" + NL + "    }" + NL + "    " + NL + "    stmt_accept_reject_";
  protected final String TEXT_127 = ".close();" + NL + "    " + NL + "    if(";
  protected final String TEXT_128 = " && copyNumber_";
  protected final String TEXT_129 = " <= 0){" + NL + "        throw new RuntimeException(\"No record was inserted into component ";
  protected final String TEXT_130 = "\");" + NL + "    }else{";
  protected final String TEXT_131 = NL + "            log.info(\"";
  protected final String TEXT_132 = " - Number of records inserted into table ";
  protected final String TEXT_133 = "\" + tableName_";
  protected final String TEXT_134 = " + \"";
  protected final String TEXT_135 = " by ";
  protected final String TEXT_136 = ": \" + (copyNumber_";
  protected final String TEXT_137 = ")+\".\");";
  protected final String TEXT_138 = NL + "        System.out.println(\"Number of records inserted into table ";
  protected final String TEXT_139 = "\" + tableName_";
  protected final String TEXT_140 = " + \"";
  protected final String TEXT_141 = " by ";
  protected final String TEXT_142 = ": \" + (copyNumber_";
  protected final String TEXT_143 = "));" + NL + "    }" + NL + "    " + NL + "    globalMap.put(\"";
  protected final String TEXT_144 = "_ACCEPTED_ROW_NUMBER\",acceptedRowNumber_";
  protected final String TEXT_145 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_146 = "_REJECTED_ROW_NUMBER\",rejectedRowNumber_";
  protected final String TEXT_147 = ");";
  protected final String TEXT_148 = NL + "}" + NL + "finally {";
