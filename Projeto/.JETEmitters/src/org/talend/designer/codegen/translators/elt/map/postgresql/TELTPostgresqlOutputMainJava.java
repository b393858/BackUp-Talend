...
public class TELTPostgresqlOutputMainJava
{
  ...
  protected final String TEXT_103 = " = \"org.postgresql.Driver\";" + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_125 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_126 = " =null;" + NL + "\t";
  protected final String TEXT_127 = "\t" + NL + "\tString insertQuery_";
  protected final String TEXT_128 = " = \"INSERT INTO \"+tableName_";
  protected final String TEXT_129 = "+\"(";
  protected final String TEXT_130 = ")  (\"+select_query_";
  protected final String TEXT_131 = "+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".prepareStatement(insertQuery_";
  protected final String TEXT_134 = ");" + NL;
  protected final String TEXT_135 = NL + "\tString updateQuery_";
  protected final String TEXT_136 = " = \"UPDATE \"+tableName_";
  protected final String TEXT_137 = "+\" SET ";
  protected final String TEXT_138 = " \"";
  protected final String TEXT_139 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_140 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".prepareStatement(updateQuery_";
  protected final String TEXT_143 = ");" + NL;
  protected final String TEXT_144 = NL + "\t" + NL + "\tString deleteQuery_";
  protected final String TEXT_145 = " = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_146 = "+\" WHERE EXISTS (\"+select_query_";
  protected final String TEXT_147 = "+\") \" " + NL + "\t";
  protected final String TEXT_148 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_149 = NL + "\t";
  protected final String TEXT_150 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_153 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_154 = NL + "int nb_line_";
  protected final String TEXT_155 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_156 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_157 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_158 = " = 0;" + NL + "\t";
  protected final String TEXT_159 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery_";
  ...
  protected final String TEXT_164 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_165 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_166 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_167 = " +\"\\n\");";
  protected final String TEXT_168 = " " + NL + "nb_line_updated_";
  protected final String TEXT_169 = " = pstmt_";
  protected final String TEXT_170 = ".executeUpdate();";
  protected final String TEXT_171 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_172 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_173 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_174 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_175 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_176 = " = pstmt_";
  protected final String TEXT_177 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_178 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_179 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_180 = NL + NL + "pstmt_";
  protected final String TEXT_181 = ".close();" + NL;
  protected final String TEXT_182 = NL + "    if(conn_";
  protected final String TEXT_183 = " != null && !conn_";
  protected final String TEXT_184 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_185 = NL + "    }";
  protected final String TEXT_186 = NL + "nb_line_";
  protected final String TEXT_187 = " = nb_line_updated_";
  protected final String TEXT_188 = " + nb_line_inserted_";
  protected final String TEXT_189 = " + nb_line_deleted_";
  protected final String TEXT_190 = ";" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_191 = "_NB_LINE\",nb_line_";
  protected final String TEXT_192 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_193 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_194 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_195 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_196 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_197 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_198 = ");" + NL;
  protected final String TEXT_199 = NL + "\tlog.info(\"";
  protected final String TEXT_200 = " - Has ";
  protected final String TEXT_201 = " records count: \" + nb_line_";
