...
public class THDFSRenameBeginJava
{
  ...
  protected final String TEXT_150 = " = 0;" + NL + "\t" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_151 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t";
  protected final String TEXT_152 = "    " + NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_153 = "_";
  protected final String TEXT_154 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_155 = "_";
  protected final String TEXT_156 = ".put(";
  protected final String TEXT_157 = ",";
  protected final String TEXT_158 = ");\t\t" + NL + "\t \tlist_";
  protected final String TEXT_159 = ".add(map_";
  protected final String TEXT_160 = "_";
  protected final String TEXT_161 = ");       " + NL + "\t";
  protected final String TEXT_162 = "\t" + NL + "" + NL + "\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_163 = " : list_";
