...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_55 = "=0;" + NL + "" + NL + "String dbschema_";
  ...
  protected final String TEXT_73 = " = (String)globalMap.get(\"dbschema_";
  ...
  protected final String TEXT_78 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_79 = " + \":\" + ";
  protected final String TEXT_80 = " + \"/\" + ";
  protected final String TEXT_81 = " + \":informixserver=\" + ";
  protected final String TEXT_82 = ";";
  protected final String TEXT_83 = NL + "    String url_";
  protected final String TEXT_84 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_85 = " + \":\" + ";
  protected final String TEXT_86 = " + \"/\" + ";
  protected final String TEXT_87 = " + \":informixserver=\" + ";
  protected final String TEXT_88 = " + \";\" + ";
  protected final String TEXT_89 = ";";
  protected final String TEXT_90 = NL + "\turl_";
  protected final String TEXT_91 = " +=\";IFX_USEPUT=1\";";
  protected final String TEXT_92 = NL + "\tjava.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "\t";
  protected final String TEXT_93 = NL + "\tdbschema_";
  ...
  protected final String TEXT_119 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_120 = NL + "\tif(!conn_";
  protected final String TEXT_121 = ".getAutoCommit()) {" + NL + "\t    conn_";
  protected final String TEXT_122 = ".setAutoCommit(true);" + NL + "\t}" + NL + "\t";
  ...
  protected final String TEXT_127 = ";" + NL + "} else {" + NL + "    tableName_";
  ...
  protected final String TEXT_133 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_145 = ".commit();";
  protected final String TEXT_146 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_201 = NL + "                                boolean whetherExist_";
  protected final String TEXT_202 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_208 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_209 = NL + "                                ";
  protected final String TEXT_210 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_213 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_214 = " = tableNameForSearch_";
  protected final String TEXT_215 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_216 = " = tableNameForSearch_";
  protected final String TEXT_217 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_218 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_222 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_223 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_224 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_225 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_245 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_251 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_276 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_277 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_278 = " == null || dbschema_";
  protected final String TEXT_279 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_286 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_306 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_307 = NL + "                                String tableForSearch_";
  protected final String TEXT_308 = " = ";
  protected final String TEXT_309 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_310 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_311 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_312 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_313 = " =  tableForSearch_";
  protected final String TEXT_314 = ".substring(1,tableForSearch_";
  protected final String TEXT_315 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_316 = " =  tableForSearch_";
  protected final String TEXT_317 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_318 = " = conn_";
  protected final String TEXT_319 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_320 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_324 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_325 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_326 = " = true;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_332 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_333 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_334 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_335 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_336 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_337 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_338 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_339 = " = conn_";
  protected final String TEXT_340 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_341 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_342 = " = dbMetaData_";
  protected final String TEXT_343 = ".getTables(";
  protected final String TEXT_344 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_348 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_353 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_354 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_355 = " = dbMetaData_";
  protected final String TEXT_356 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_364 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_384 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_395 = NL + "                                            conn_";
  protected final String TEXT_396 = ".commit();";
  protected final String TEXT_397 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_416 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_417 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_418 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_452 = NL + "                    if(!conn_";
  protected final String TEXT_453 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_454 = ".commit();" + NL + "                    }";
  ...
  protected final String TEXT_458 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_474 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_482 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_483 = "\", pstmt_";
  protected final String TEXT_484 = ");" + NL + "\t    ";
  protected final String TEXT_485 = NL + "\t    String update_";
  protected final String TEXT_486 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_491 = ".prepareStatement(update_";
  ...
  protected final String TEXT_497 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  protected final String TEXT_498 = " + \" WHERE ";
  protected final String TEXT_499 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_508 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_509 = "\", pstmtInsert_";
  ...
  protected final String TEXT_517 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_530 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_531 = " + \" (";
  protected final String TEXT_532 = ") VALUES (";
  protected final String TEXT_533 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_534 = " = conn_";
  protected final String TEXT_535 = ".prepareStatement(insert_";
  protected final String TEXT_536 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_537 = "\", pstmtInsert_";
  protected final String TEXT_538 = ");" + NL + "\t    ";
  protected final String TEXT_539 = NL + "\t    String delete_";
  protected final String TEXT_540 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_544 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_548 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_560 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_568 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_575 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_576 = " = insert_";
  protected final String TEXT_577 = ".split(\"\\\\?\");";
  protected final String TEXT_578 = NL + NL + "        int commitEvery_";
  protected final String TEXT_579 = " = ";
  protected final String TEXT_580 = ";" + NL + "" + NL + "        int commitCounter_";
  ...
  protected final String TEXT_585 = " =null;" + NL + "\t";
