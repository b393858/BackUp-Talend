package org.talend.designer.codegen.translators.databases.dbspecifics.firebird;
...
public class TFirebirdOutputMainJava {
  ...
  protected final String TEXT_134 = NL + "                                       rejectedCount_";
  ...
  protected final String TEXT_147 = NL + NL + "            int checkCount_";
  protected final String TEXT_148 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_149 = " = pstmt_";
  protected final String TEXT_150 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_151 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_152 = " = rs_";
  protected final String TEXT_153 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_199 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_259 = ";" + NL + "" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_307 = NL + "                        query_";
  protected final String TEXT_308 = " = ";
  protected final String TEXT_309 = ";";
  protected final String TEXT_310 = NL + "                globalMap.put(\"";
  protected final String TEXT_311 = "_QUERY\", query_";
  protected final String TEXT_312 = ".toString().trim());";
  protected final String TEXT_313 = NL;
  protected final String TEXT_314 = NL + "                       pstmt_";
  protected final String TEXT_315 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_316 = "++;" + NL + "                       nb_line_";
  ...
  protected final String TEXT_336 = NL + "                                   rejectedCount_";
  protected final String TEXT_337 = " = rejectedCount_";
  ...
  protected final String TEXT_347 = NL + "            if(!whetherReject_";
  protected final String TEXT_348 = ") {";
  protected final String TEXT_349 = NL + "                            ";
  protected final String TEXT_350 = " = new ";
  protected final String TEXT_351 = "Struct();";
  ...
  protected final String TEXT_358 = NL + "                if ((batchSize_";
  protected final String TEXT_359 = " > 0) && (batchSize_";
  protected final String TEXT_360 = " <= batchSizeCounter_";
  protected final String TEXT_361 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_362 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_363 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_364 = " = 0;";
  protected final String TEXT_365 = NL + "                        status_";
  protected final String TEXT_366 = " = pstmt_";
  protected final String TEXT_367 = ".executeBatch();";
  protected final String TEXT_368 = NL + "                        for(int countEach_";
  protected final String TEXT_369 = ": status_";
  protected final String TEXT_370 = ") {" + NL + "                            countSum_";
  protected final String TEXT_371 = " += (countEach_";
  protected final String TEXT_372 = " < 0 ? 0 : countEach_";
  protected final String TEXT_373 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_374 = NL + "                            throw(e);";
  protected final String TEXT_375 = NL + "                        for(int countEach_";
  protected final String TEXT_376 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_377 = " += (countEach_";
  protected final String TEXT_378 = " < 0 ? 0 : countEach_";
  protected final String TEXT_379 = ");" + NL + "                        }";
  protected final String TEXT_380 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_381 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_382 = " = pstmt_";
  protected final String TEXT_383 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_384 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_385 = " = tmp_batchUpdateCount_";
  protected final String TEXT_386 = " > countSum_";
  protected final String TEXT_387 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_388 = " : countSum_";
  protected final String TEXT_389 = ";";
  protected final String TEXT_390 = NL + "                        insertedCount_";
  protected final String TEXT_391 = " += tmp_batchUpdateCount_";
  protected final String TEXT_392 = ";";
  protected final String TEXT_393 = NL + "                        updatedCount_";
  protected final String TEXT_394 = " += tmp_batchUpdateCount_";
  protected final String TEXT_395 = ";";
  protected final String TEXT_396 = NL + "                        deletedCount_";
  protected final String TEXT_397 = " += tmp_batchUpdateCount_";
  protected final String TEXT_398 = ";";
  protected final String TEXT_399 = NL + "               }";
  protected final String TEXT_400 = NL + "                commitCounter_";
  protected final String TEXT_401 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_402 = " <= commitCounter_";
  protected final String TEXT_403 = ") {";
  protected final String TEXT_404 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_405 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_406 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_407 = NL + "\t                    for(int countEach_";
  protected final String TEXT_408 = ": pstmt_";
  protected final String TEXT_409 = ".executeBatch()) {" + NL + "\t                        countSum_";
  ...
  protected final String TEXT_421 = " += countSum_";
  protected final String TEXT_422 = ";" + NL + "\t                    ";
  protected final String TEXT_423 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_424 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_425 = NL + "                        throw(e);";
  protected final String TEXT_426 = NL + "                        int countSum_";
  protected final String TEXT_427 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_428 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_429 = " += (countEach_";
  protected final String TEXT_430 = " < 0 ? 0 : countEach_";
  protected final String TEXT_431 = ");" + NL + "                        }";
  protected final String TEXT_432 = NL + "                            insertedCount_";
  protected final String TEXT_433 = " += countSum_";
  protected final String TEXT_434 = ";";
  protected final String TEXT_435 = NL + "                            updatedCount_";
  protected final String TEXT_436 = " += countSum_";
  protected final String TEXT_437 = ";";
  protected final String TEXT_438 = NL + "                            deletedCount_";
  protected final String TEXT_439 = " += countSum_";
  protected final String TEXT_440 = ";";
  protected final String TEXT_441 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_442 = NL + "                }";
  protected final String TEXT_443 = NL + "                ";
  protected final String TEXT_444 = NL + "                conn_";
  protected final String TEXT_445 = ".commit();";
  protected final String TEXT_446 = NL + "                commitCounter_";
  protected final String TEXT_447 = "=0;" + NL + "            }";
