...
public class TNetezzaRowBeginJava
{
  ...
  protected final String TEXT_144 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_149 = ".prepareStatement(";
  protected final String TEXT_150 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_151 = "\", pstmt_";
  protected final String TEXT_152 = ");";
  protected final String TEXT_153 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_156 = "\", stmt_";
