...
public class TCosmosDBRowBeginJava
{
  protected static String nl;
  public static synchronized TCosmosDBRowBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBRowBeginJava result = new TCosmosDBRowBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_15 = NL + "final String applicationName_";
  protected final String TEXT_16 = " = \"Talend\";" + NL + "        // Empty client options" + NL + "        com.mongodb.MongoClientOptions clientOptions_";
  protected final String TEXT_17 = " = new com.mongodb.MongoClientOptions.Builder().applicationName(applicationName_";
  protected final String TEXT_18 = ").build();";
  protected final String TEXT_19 = NL + "            clientOptions_";
  protected final String TEXT_20 = " = new com.mongodb.MongoClientOptions.Builder().applicationName(applicationName_";
  protected final String TEXT_21 = ")" + NL + "            .socketFactory(javax.net.ssl.SSLSocketFactory.getDefault())" + NL + "            .build();";
  ...
  protected final String TEXT_38 = " = com.mongodb.MongoCredential.createPlainCredential(";
  protected final String TEXT_39 = ", \"$external\", new String(decryptedPassword_";
  protected final String TEXT_40 = ").toCharArray());";
  protected final String TEXT_41 = NL + "                    mongoCredential_";
  protected final String TEXT_42 = " = com.mongodb.MongoCredential.createScramSha1Credential(";
  protected final String TEXT_43 = ", ";
  protected final String TEXT_44 = ", new String(decryptedPassword_";
  protected final String TEXT_45 = ").toCharArray());";
  protected final String TEXT_46 = NL + "                System.setProperty(\"java.security.krb5.realm\", ";
  protected final String TEXT_47 = ");" + NL + "                System.setProperty(\"java.security.krb5.kdc\", ";
  protected final String TEXT_48 = ");" + NL + "                System.setProperty(\"javax.security.auth.useSubjectCredsOnly\", \"false\");" + NL + "                mongoCredential_";
  protected final String TEXT_49 = " = com.mongodb.MongoCredential.createGSSAPICredential(";
  protected final String TEXT_50 = ");";
  protected final String TEXT_51 = NL + "            mongoCredentialList_";
  protected final String TEXT_52 = ".add(mongoCredential_";
  protected final String TEXT_53 = ");";
  protected final String TEXT_54 = NL + "            List<com.mongodb.ServerAddress> addrs_";
  protected final String TEXT_55 = " = new java.util.ArrayList<com.mongodb.ServerAddress>();";
  protected final String TEXT_56 = NL + "                addrs_";
  protected final String TEXT_57 = ".add(new com.mongodb.ServerAddress(";
  protected final String TEXT_58 = ",";
  protected final String TEXT_59 = "));";
  protected final String TEXT_60 = NL + "            mongo_";
  protected final String TEXT_61 = " = new ";
  protected final String TEXT_62 = "(addrs_";
  protected final String TEXT_63 = ", mongoCredentialList_";
  protected final String TEXT_64 = ", clientOptions_";
  protected final String TEXT_65 = ");";
  protected final String TEXT_66 = NL + "            com.mongodb.ServerAddress serverAddress_";
  protected final String TEXT_67 = " = new com.mongodb.ServerAddress(";
  protected final String TEXT_68 = ", ";
  protected final String TEXT_69 = ");" + NL + "            mongo_";
  protected final String TEXT_70 = " = new ";
  protected final String TEXT_71 = "(serverAddress_";
  protected final String TEXT_72 = ", mongoCredentialList_";
  protected final String TEXT_73 = ", clientOptions_";
  protected final String TEXT_74 = ");";
  protected final String TEXT_75 = NL + "\t\tdb_";
  protected final String TEXT_76 = " = mongo_";
  protected final String TEXT_77 = ".getDB(";
  protected final String TEXT_78 = ");" + NL + "\t\t";
  protected final String TEXT_79 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_80 = " - Connecting to \" + mongo_";
  protected final String TEXT_81 = ".getServerAddressList() + \".\");" + NL + "\t";
  protected final String TEXT_82 = NL + "\tcom.mongodb.CommandResult result_";
