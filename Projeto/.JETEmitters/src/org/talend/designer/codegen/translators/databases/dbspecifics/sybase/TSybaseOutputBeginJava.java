...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_58 = " = false;" + NL + "String dbschema_";
  protected final String TEXT_59 = "= ";
  protected final String TEXT_60 = ";" + NL + "java.sql.Statement stmt_";
  ...
  protected final String TEXT_90 = NL + "\t\tjava.lang.Class.forName(\"sap.jdbc4.sqlanywhere.IDriver\");" + NL + "\t";
  protected final String TEXT_91 = NL + "\t\tjava.lang.Class.forName(\"com.sybase.jdbc4.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_92 = NL + "\t    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_93 = NL + "\t\t    String url_";
  protected final String TEXT_94 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_95 = " + \":\" + ";
  protected final String TEXT_96 = " + \";DatabaseName=\" + ";
  protected final String TEXT_97 = "; ";
  protected final String TEXT_98 = NL + "\t\t    String url_";
  protected final String TEXT_99 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_100 = " + \":\" + ";
  protected final String TEXT_101 = " + \";DatabaseName\" + ";
  protected final String TEXT_102 = " + \";\" + ";
  protected final String TEXT_103 = ";";
  protected final String TEXT_104 = NL + "\t\tString url_";
  protected final String TEXT_105 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = " + \"/\" + ";
  protected final String TEXT_108 = ";";
  protected final String TEXT_109 = NL + "\t\tString url_";
  protected final String TEXT_110 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_111 = " + \":\" + ";
  protected final String TEXT_112 = " + \"/\" + ";
  protected final String TEXT_113 = " + \"?\" + ";
  protected final String TEXT_114 = ";";
  protected final String TEXT_115 = NL + "\t";
  protected final String TEXT_116 = NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_125 = ".setAutoCommit(false);";
  ...
  protected final String TEXT_147 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_155 = ".commit();";
  protected final String TEXT_156 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_175 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_211 = NL + "                                boolean whetherExist_";
  protected final String TEXT_212 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_215 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_216 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_217 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_218 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_227 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_228 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_229 = " = dbMetaData_";
  protected final String TEXT_230 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_231 = ", tableNameForSearch_";
  protected final String TEXT_232 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_233 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_234 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_240 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_255 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_261 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_271 = ".toUpperCase()";
  protected final String TEXT_272 = ")" + NL + "                                            && (schema_";
  ...
  protected final String TEXT_277 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_278 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_286 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_287 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_288 = " == null || dbschema_";
  protected final String TEXT_289 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_290 = " = conn_";
  protected final String TEXT_291 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_292 = " = stmtSchema_";
  protected final String TEXT_293 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_294 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_295 = " = rsSchema_";
  protected final String TEXT_296 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_316 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_334 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_335 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_336 = " = true;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_342 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_343 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_347 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_353 = ".getTables(";
  protected final String TEXT_354 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_360 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_366 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_372 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_373 = NL + "                                if(!whetherExist_";
  protected final String TEXT_374 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_378 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_379 = "));";
  protected final String TEXT_380 = NL + "                                            stmtCreate_";
  protected final String TEXT_381 = ".execute(((\"";
  protected final String TEXT_382 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_383 = ".";
  protected final String TEXT_384 = ", \"";
  protected final String TEXT_385 = "\")";
  protected final String TEXT_386 = ".toUpperCase()";
  ...
  protected final String TEXT_394 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_400 = NL + "                                        stmtDrop_";
  ...
  protected final String TEXT_407 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_426 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_427 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_428 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_429 = " = conn_";
  protected final String TEXT_430 = ".createStatement()) {";
  protected final String TEXT_431 = NL + "                              stmtClear_";
  ...
  protected final String TEXT_438 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_439 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_440 = " = conn_";
  protected final String TEXT_441 = ".createStatement()) {";
  protected final String TEXT_442 = NL + "                              stmtTruncCount_";
  protected final String TEXT_443 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_444 = "));";
  protected final String TEXT_445 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_446 = " = stmtTruncCount_";
  protected final String TEXT_447 = ".executeQuery(\"";
  protected final String TEXT_448 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_449 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_450 = " = rsTruncCount_";
  protected final String TEXT_451 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = ".createStatement()) {";
  protected final String TEXT_454 = NL + "                              stmtTrunc_";
  protected final String TEXT_455 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_456 = "));";
  protected final String TEXT_457 = NL + "                conn_";
  protected final String TEXT_458 = ".commit();";
  protected final String TEXT_459 = NL + "                stmtTrunc_";
  protected final String TEXT_460 = ".executeUpdate(\"";
  protected final String TEXT_461 = "\");";
  protected final String TEXT_462 = NL + "                    if(!conn_";
  protected final String TEXT_463 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_464 = ".commit();" + NL + "                    }";
  protected final String TEXT_465 = NL + "                deletedCount_";
  protected final String TEXT_466 = " += rsTruncCountNumber_";
  protected final String TEXT_467 = ";" + NL + "            }";
  protected final String TEXT_468 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_484 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_489 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_502 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_503 = "\", pstmt_";
  ...
  protected final String TEXT_507 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_515 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_516 = " = conn_";
  protected final String TEXT_517 = ".prepareStatement(insert_";
  protected final String TEXT_518 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_524 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_525 = " = conn_";
  protected final String TEXT_526 = ".prepareStatement(update_";
  protected final String TEXT_527 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_528 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_537 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_538 = "\", pstmtUpdate_";
  protected final String TEXT_539 = ");" + NL + "\t    String insert_";
  protected final String TEXT_540 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_541 = " + \" (";
  protected final String TEXT_542 = ") VALUES (";
  protected final String TEXT_543 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_544 = " = conn_";
  protected final String TEXT_545 = ".prepareStatement(insert_";
  protected final String TEXT_546 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_547 = "\", pstmtInsert_";
  ...
  protected final String TEXT_554 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_568 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_569 = " = update_";
  protected final String TEXT_570 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_571 = " = insert_";
  protected final String TEXT_572 = ".split(\"\\\\?\");";
  protected final String TEXT_573 = NL + "\t\t\tdelete_";
  protected final String TEXT_574 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_575 = " = delete_";
  protected final String TEXT_576 = ".split(\"\\\\?\");";
  protected final String TEXT_577 = NL + "\t\t\treplace_";
  protected final String TEXT_578 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_579 = " = replace_";
  protected final String TEXT_580 = ".split(\"\\\\?\");";
  protected final String TEXT_581 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_582 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_583 = " = insertIgnore_";
  protected final String TEXT_584 = ".split(\"\\\\?\");";
  protected final String TEXT_585 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_586 = " = insert_";
  protected final String TEXT_587 = ".split(\"\\\\?\");";
  protected final String TEXT_588 = NL + "\t    stmt_";
  protected final String TEXT_589 = " = conn_";
  protected final String TEXT_590 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_591 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_592 = " +\" ON\");";
  protected final String TEXT_593 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_594 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_595 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_596 = " =null;" + NL + "\t";
  protected final String TEXT_597 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_604 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_605 = " = null;";
  protected final String TEXT_606 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_607 = " = null;";
  protected final String TEXT_608 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_609 = " = null;";
  protected final String TEXT_610 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
