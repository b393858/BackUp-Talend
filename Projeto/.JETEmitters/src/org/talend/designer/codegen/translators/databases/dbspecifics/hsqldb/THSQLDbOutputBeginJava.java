package org.talend.designer.codegen.translators.databases.dbspecifics.hsqldb;
...
public class THSQLDbOutputBeginJava {
  ...
  protected final String TEXT_49 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_50 = " + \":\" + ";
  protected final String TEXT_51 = " + \"/\" + ";
  protected final String TEXT_52 = ";" + NL + "\t\t\t";
  protected final String TEXT_53 = NL + "\t\t\turl_";
  protected final String TEXT_54 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_55 = " + \":\" + ";
  protected final String TEXT_56 = " + \"/\" + ";
  protected final String TEXT_57 = ";" + NL + "\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\turl_";
  protected final String TEXT_59 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_60 = " + \":\" + ";
  protected final String TEXT_61 = " + \"/\" + ";
  protected final String TEXT_62 = ";" + NL + "\t\t\t";
  protected final String TEXT_63 = NL + "\t\t\turl_";
  protected final String TEXT_64 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_65 = " + \":\" + ";
  protected final String TEXT_66 = " + \"/\" + ";
  protected final String TEXT_67 = ";" + NL + "\t\t\t";
  protected final String TEXT_68 = NL + "\t\turl_";
  protected final String TEXT_69 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_70 = " + \"/\" + ";
  protected final String TEXT_71 = " ;" + NL + "\t\t";
  protected final String TEXT_72 = NL + "\t\turl_";
  protected final String TEXT_73 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_74 = " ;" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t\turl_";
  protected final String TEXT_76 = " += \";\" + ";
  protected final String TEXT_77 = ";";
  protected final String TEXT_78 = NL + NL + "int nb_line_";
  ...
  protected final String TEXT_82 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_83 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_84 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_85 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_86 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_87 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_90 = " = false;";
  protected final String TEXT_91 = NL;
  protected final String TEXT_92 = NL + "        int updateKeyCount_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_95 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_96 = NL + "        int deleteKeyCount_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_99 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_100 = " " + NL + "java.lang.Class.forName(\"org.hsqldb.jdbcDriver\");";
  ...
  protected final String TEXT_114 = "\t" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_123 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_135 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_153 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  protected final String TEXT_154 = NL + "                if(!whetherExist_";
  protected final String TEXT_155 = ") {" + NL + "                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_163 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_169 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_176 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_192 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_202 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_209 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_210 = "\", pstmt_";
  protected final String TEXT_211 = ");" + NL + "\t    String insert_";
  protected final String TEXT_212 = " = \"INSERT INTO \" + ";
  protected final String TEXT_213 = " + \" (";
  protected final String TEXT_214 = ") VALUES (";
  protected final String TEXT_215 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = ".prepareStatement(insert_";
  protected final String TEXT_218 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_219 = "\", pstmtInsert_";
  ...
  protected final String TEXT_227 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_228 = "\", pstmtUpdate_";
  protected final String TEXT_229 = ");" + NL + "\t    ";
  protected final String TEXT_230 = NL + "\t    String update_";
  protected final String TEXT_231 = " = \"UPDATE \" + ";
  protected final String TEXT_232 = " + \" SET ";
  protected final String TEXT_233 = " WHERE ";
  protected final String TEXT_234 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".prepareStatement(update_";
  protected final String TEXT_237 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_238 = "\", pstmtUpdate_";
  protected final String TEXT_239 = ");" + NL + "\t    String insert_";
  protected final String TEXT_240 = " = \"INSERT INTO \" + ";
  protected final String TEXT_241 = " + \" (";
  protected final String TEXT_242 = ") VALUES (";
  ...
  protected final String TEXT_246 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_247 = "\", pstmtInsert_";
  protected final String TEXT_248 = ");" + NL + "\t    ";
  protected final String TEXT_249 = NL + "\t    String delete_";
  protected final String TEXT_250 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_251 = " + \" WHERE ";
  protected final String TEXT_252 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".prepareStatement(delete_";
  protected final String TEXT_255 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_256 = "\", pstmt_";
  protected final String TEXT_257 = ");" + NL + "\t    ";
  protected final String TEXT_258 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_263 = NL + "\t\t\tupdate_";
  protected final String TEXT_264 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_265 = " = update_";
  protected final String TEXT_266 = ".split(\"\\\\?\");";
  protected final String TEXT_267 = NL + "\t\t\tupdate_";
  protected final String TEXT_268 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_269 = " = update_";
  protected final String TEXT_270 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_271 = " = insert_";
  protected final String TEXT_272 = ".split(\"\\\\?\");";
  protected final String TEXT_273 = NL + "\t\t\tdelete_";
  protected final String TEXT_274 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_275 = " = delete_";
  protected final String TEXT_276 = ".split(\"\\\\?\");";
  protected final String TEXT_277 = NL + "\t\t\treplace_";
  protected final String TEXT_278 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_279 = " = replace_";
  protected final String TEXT_280 = ".split(\"\\\\?\");";
  protected final String TEXT_281 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_282 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_283 = " = insertIgnore_";
  protected final String TEXT_284 = ".split(\"\\\\?\");";
  protected final String TEXT_285 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_286 = " = insert_";
  protected final String TEXT_287 = ".split(\"\\\\?\");";
  protected final String TEXT_288 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_289 = " = ";
  protected final String TEXT_290 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_291 = " = 0;" + NL + "        ";
