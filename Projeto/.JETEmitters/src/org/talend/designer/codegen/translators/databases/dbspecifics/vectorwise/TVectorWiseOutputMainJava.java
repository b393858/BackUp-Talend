...
public class TVectorWiseOutputMainJava {
  ...
  protected final String TEXT_66 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_67 = "++;" + NL + "\t\t  \t\t";
  protected final String TEXT_68 = NL + " \t\t \t\t\tbatchSizeCounter_";
  ...
  protected final String TEXT_86 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_127 = NL + "                        nb_line_rejected_";
  protected final String TEXT_128 = "++;";
  protected final String TEXT_129 = NL + "                        ";
  protected final String TEXT_130 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_140 = NL + "            int checkCount_";
  protected final String TEXT_141 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_142 = " = pstmt_";
  protected final String TEXT_143 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_144 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_145 = " = rs_";
  protected final String TEXT_146 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_182 = NL + "                            nb_line_rejected_";
  protected final String TEXT_183 = "++;";
  protected final String TEXT_184 = NL + "                            ";
  protected final String TEXT_185 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_186 = NL + "                            ";
  protected final String TEXT_187 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_188 = ";";
  protected final String TEXT_189 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_201 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_202 = "++;";
  protected final String TEXT_203 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_216 = NL + "                            nb_line_rejected_";
  protected final String TEXT_217 = "++;";
  protected final String TEXT_218 = NL + "                            ";
  protected final String TEXT_219 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_220 = NL + "                            ";
  protected final String TEXT_221 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_222 = ";";
  protected final String TEXT_223 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_224 = NL + "                }" + NL + "            }";
  protected final String TEXT_225 = NL + "            int updateFlag_";
  protected final String TEXT_226 = "=0;";
  protected final String TEXT_227 = NL + "                    ";
  protected final String TEXT_228 = NL + "                        query_";
  ...
  protected final String TEXT_244 = NL + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_250 = " != 0){" + NL + "            \t\tnb_line_";
  ...
  protected final String TEXT_263 = NL + "                        nb_line_rejected_";
  protected final String TEXT_264 = "++;";
  protected final String TEXT_265 = NL + "                        ";
  protected final String TEXT_266 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_271 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_272 = " == 0) {" + NL + "            \t";
  protected final String TEXT_273 = NL + "\t\t\t\tquery_";
  protected final String TEXT_274 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_282 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_283 = " = insertedCount_";
  protected final String TEXT_284 = " + pstmtInsert_";
  protected final String TEXT_285 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_286 = "++;";
  protected final String TEXT_287 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_288 = " = true;";
  protected final String TEXT_289 = NL + "                        throw(e);";
  ...
  protected final String TEXT_300 = NL + "                            nb_line_rejected_";
  protected final String TEXT_301 = "++;";
  protected final String TEXT_302 = NL + "                            ";
  protected final String TEXT_303 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_321 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_322 = " = deletedCount_";
  protected final String TEXT_323 = " + pstmt_";
  protected final String TEXT_324 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_325 = "++;";
  protected final String TEXT_326 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_327 = " = true;";
  protected final String TEXT_328 = NL + "                    throw(e);";
  ...
  protected final String TEXT_339 = NL + "                        nb_line_rejected_";
  protected final String TEXT_340 = "++;";
  protected final String TEXT_341 = NL + "                        ";
  protected final String TEXT_342 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_343 = NL + "                        ";
  protected final String TEXT_344 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_345 = ";";
  protected final String TEXT_346 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_362 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_363 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_365 = ": pstmt_";
  protected final String TEXT_366 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_367 = " == -2 || countEach_";
  protected final String TEXT_368 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_369 = " += countEach_";
  protected final String TEXT_370 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_371 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_372 = " += countSum_";
  protected final String TEXT_373 = ";" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_374 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_375 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_376 = NL + "                \tint countSum_";
  protected final String TEXT_377 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_378 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_379 = " += (countEach_";
  protected final String TEXT_380 = " < 0 ? 0 : countEach_";
  protected final String TEXT_381 = ");" + NL + "\t\t\t\t\t}" + NL + "" + NL + "    \t    \t\tinsertedCount_";
  protected final String TEXT_382 = " += countSum_";
  protected final String TEXT_383 = ";" + NL + "    \t    \t\t";
  protected final String TEXT_384 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_385 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_386 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_387 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_388 = " <= commitCounter_";
  protected final String TEXT_389 = ") {";
  protected final String TEXT_390 = NL + "                if ((batchSize_";
  protected final String TEXT_391 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_392 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  ...
  protected final String TEXT_396 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_397 = " == -2 || countEach_";
  protected final String TEXT_398 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_403 = ";" + NL + "                        batchSizeCounter_";
  protected final String TEXT_404 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_405 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_406 = NL + "                \tint countSum_";
  protected final String TEXT_407 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_408 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_409 = " += (countEach_";
  protected final String TEXT_410 = " < 0 ? 0 : countEach_";
  protected final String TEXT_411 = ");" + NL + "\t\t\t\t\t}" + NL + "    \t    \t\tinsertedCount_";
  protected final String TEXT_412 = " += countSum_";
  protected final String TEXT_413 = ";" + NL + "\t    \t\t\t";
  protected final String TEXT_414 = NL + "                    System.err.println(e.getMessage());" + NL + "                \t";
  ...
  protected final String TEXT_419 = NL + "                \tcommitCounter_";
