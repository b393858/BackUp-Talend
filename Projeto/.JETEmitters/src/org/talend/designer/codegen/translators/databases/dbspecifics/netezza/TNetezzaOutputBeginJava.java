...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_87 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_88 = " + \":\" + ";
  protected final String TEXT_89 = " + \"/\" + ";
  protected final String TEXT_90 = ";" + NL + "\t    ";
  protected final String TEXT_91 = NL + "\t    String url_";
  protected final String TEXT_92 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_139 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_140 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_171 = NL + "            try (java.sql.Statement stmtClearCount_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".createStatement();" + NL + "                    java.sql.ResultSet rsClearCount_";
  protected final String TEXT_174 = " = stmtClearCount_";
  protected final String TEXT_175 = ".executeQuery(\"";
  ...
  protected final String TEXT_179 = NL + "                stmtClear_";
  protected final String TEXT_180 = ".executeUpdate(\"";
  protected final String TEXT_181 = "\");";
  protected final String TEXT_182 = NL + "                while(rsClearCount_";
  protected final String TEXT_183 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_184 = " += rsClearCount_";
  protected final String TEXT_185 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_186 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement()) {";
  protected final String TEXT_189 = NL + "                deletedCount_";
  protected final String TEXT_190 = " = deletedCount_";
  protected final String TEXT_191 = " + stmtClear_";
  protected final String TEXT_192 = ".executeUpdate(\"";
  ...
  protected final String TEXT_205 = NL + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_208 = " + \" SET ";
  protected final String TEXT_209 = " WHERE ";
  protected final String TEXT_210 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_211 = "\", pstmt_";
  ...
  protected final String TEXT_215 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_216 = " + \" WHERE ";
  protected final String TEXT_217 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_218 = "\", pstmt_";
  protected final String TEXT_219 = ");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_222 = " + \" (";
  protected final String TEXT_223 = ") VALUES (";
  protected final String TEXT_224 = ")\");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_225 = "\", pstmtInsert_";
  protected final String TEXT_226 = ");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_229 = " + \" SET ";
  ...
  protected final String TEXT_236 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_237 = " + \" SET ";
  protected final String TEXT_238 = " WHERE ";
  protected final String TEXT_239 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_240 = "\", pstmtUpdate_";
  protected final String TEXT_241 = ");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".prepareStatement(\"INSERT INTO \" + ";
  ...
  protected final String TEXT_249 = NL + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = ".prepareStatement(\"DELETE  FROM \" + ";
  ...
  protected final String TEXT_256 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_257 = " = ";
  protected final String TEXT_258 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_259 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_260 = NL + "\t   int batchSize_";
  protected final String TEXT_261 = " = ";
  protected final String TEXT_262 = ";" + NL + "\t   int batchSizeCounter_";
