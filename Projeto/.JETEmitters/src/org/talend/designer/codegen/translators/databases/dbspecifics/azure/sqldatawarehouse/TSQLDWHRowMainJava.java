...
public class TSQLDWHRowMainJava
{
  protected static String nl;
  public static synchronized TSQLDWHRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHRowMainJava result = new TSQLDWHRowMainJava();
    nl = null;
    return result;
  }
