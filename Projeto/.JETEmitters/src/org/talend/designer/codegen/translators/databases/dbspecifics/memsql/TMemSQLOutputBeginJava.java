package org.talend.designer.codegen.translators.databases.dbspecifics.memsql;
...
public class TMemSQLOutputBeginJava {
  ...
  protected final String TEXT_46 = NL + "           int batchSize_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "           int batchSizeCounter_";
  protected final String TEXT_49 = "=0;";
  protected final String TEXT_50 = NL + "            java.util.Calendar calendar_";
  protected final String TEXT_51 = " = java.util.Calendar.getInstance();" + NL + "            calendar_";
  protected final String TEXT_52 = ".set(1, 0, 1, 0, 0, 0);" + NL + "            long year1_";
  protected final String TEXT_53 = " = calendar_";
  protected final String TEXT_54 = ".getTime().getTime();" + NL + "            calendar_";
  protected final String TEXT_55 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "            long year10000_";
  protected final String TEXT_56 = " = calendar_";
  protected final String TEXT_57 = ".getTime().getTime();" + NL + "            long date_";
  ...
  protected final String TEXT_67 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_68 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_71 = " = false;";
  protected final String TEXT_72 = NL;
  protected final String TEXT_73 = NL + "        int updateKeyCount_";
  protected final String TEXT_74 = " = ";
  protected final String TEXT_75 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_76 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_77 = NL + "        int deleteKeyCount_";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_80 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_86 = " =\"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_105 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_116 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_117 = " = conn_";
  protected final String TEXT_118 = ".createStatement()) {";
  protected final String TEXT_119 = NL + "                stmtDrop_";
  protected final String TEXT_120 = ".execute(\"";
  protected final String TEXT_121 = "\");";
  protected final String TEXT_122 = NL + "            }" + NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_138 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_139 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_144 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  protected final String TEXT_145 = ".equalsIgnoreCase(";
  protected final String TEXT_146 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_147 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_156 = NL + "                if(whetherExist_";
  protected final String TEXT_157 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_163 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_170 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement()) {";
  protected final String TEXT_173 = NL + "                deletedCount_";
  protected final String TEXT_174 = " = deletedCount_";
  protected final String TEXT_175 = " + stmtClear_";
  ...
  protected final String TEXT_186 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_195 = ".prepareStatement(update_";
  protected final String TEXT_196 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_203 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_212 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_221 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_231 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_232 = "\", pstmtUpdate_";
  protected final String TEXT_233 = ");" + NL + "\t    String insert_";
  protected final String TEXT_234 = " = \"INSERT INTO \" + ";
  protected final String TEXT_235 = " + \" (";
  protected final String TEXT_236 = ") VALUES (";
  protected final String TEXT_237 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_238 = " = conn_";
  protected final String TEXT_239 = ".prepareStatement(insert_";
  protected final String TEXT_240 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_241 = "\", pstmtInsert_";
  protected final String TEXT_242 = ");" + NL + "\t    ";
  protected final String TEXT_243 = NL + "\t    String delete_";
  protected final String TEXT_244 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_245 = " + \" WHERE ";
  protected final String TEXT_246 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_247 = " = conn_";
  protected final String TEXT_248 = ".prepareStatement(delete_";
  protected final String TEXT_249 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_250 = "\", pstmt_";
  protected final String TEXT_251 = ");" + NL + "\t    ";
  protected final String TEXT_252 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_257 = NL + "\t\t\tupdate_";
  protected final String TEXT_258 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_259 = " = update_";
  protected final String TEXT_260 = ".split(\"\\\\?\");";
  protected final String TEXT_261 = NL + "\t\t\tupdate_";
  protected final String TEXT_262 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_263 = " = update_";
  protected final String TEXT_264 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_265 = " = insert_";
  protected final String TEXT_266 = ".split(\"\\\\?\");";
  protected final String TEXT_267 = NL + "\t\t\tdelete_";
  protected final String TEXT_268 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_269 = " = delete_";
  protected final String TEXT_270 = ".split(\"\\\\?\");";
  protected final String TEXT_271 = NL + "\t\t\treplace_";
  protected final String TEXT_272 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_273 = " = replace_";
  protected final String TEXT_274 = ".split(\"\\\\?\");";
  protected final String TEXT_275 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_276 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_277 = " = insertIgnore_";
  protected final String TEXT_278 = ".split(\"\\\\?\");";
  protected final String TEXT_279 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_280 = " = insert_";
