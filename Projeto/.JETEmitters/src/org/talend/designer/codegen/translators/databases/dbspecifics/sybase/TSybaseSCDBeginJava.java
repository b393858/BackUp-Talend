...
public class TSybaseSCDBeginJava {
  ...
  protected final String TEXT_17 = NL + "\t\t\tjava.lang.Class.forName(\"sap.jdbc4.sqlanywhere.IDriver\");";
  protected final String TEXT_18 = NL + "\t\t\t\tString connectionString_";
  protected final String TEXT_19 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_20 = " + \":\" + ";
  protected final String TEXT_21 = " + \";DatabaseName=\" + ";
  protected final String TEXT_22 = "; ";
  protected final String TEXT_23 = NL + "\t\t\t\tString connectionString_";
  protected final String TEXT_24 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_25 = " + \":\" + ";
  protected final String TEXT_26 = " + \";DatabaseName\" + ";
  protected final String TEXT_27 = " + \";\" + ";
  protected final String TEXT_28 = ";";
  protected final String TEXT_29 = NL + "\t\t\tjava.lang.Class.forName(\"com.sybase.jdbc4.jdbc.SybDriver\");" + NL + "\t\t    ";
  protected final String TEXT_30 = NL + "\t\t\tjava.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t\t    ";
  protected final String TEXT_31 = NL + "\t\t\tString connectionString_";
  protected final String TEXT_32 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_50 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_181 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_182 = " = ";
  protected final String TEXT_183 = ";" + NL + "            String datePattern_";
  protected final String TEXT_184 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_185 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_186 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_187 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_188 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_189 = ".setTimestamp(";
  protected final String TEXT_190 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_191 = ").parse(";
  protected final String TEXT_192 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_193 = ").getTime()));";
  protected final String TEXT_194 = NL + "        String updateSQLForType1_";
  protected final String TEXT_195 = " = \"";
  protected final String TEXT_196 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_197 = " = connection_";
  protected final String TEXT_198 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_199 = ");        ";
  protected final String TEXT_200 = NL + "        String updateSQLForType2_";
  protected final String TEXT_201 = " = \"";
  protected final String TEXT_202 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_203 = " = connection_";
  protected final String TEXT_204 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "            updateForType2_";
  protected final String TEXT_207 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_208 = "\")));";
  protected final String TEXT_209 = NL + "        String updateSQLForType3_";
  protected final String TEXT_210 = " = \"";
  protected final String TEXT_211 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_212 = " = connection_";
  protected final String TEXT_213 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "    ";
  protected final String TEXT_216 = NL + "        SCDSK_";
  protected final String TEXT_217 = " lookUpKey_";
  protected final String TEXT_218 = " = null;        ";
  protected final String TEXT_219 = NL + "    SCDStruct_";
  protected final String TEXT_220 = " lookUpValue_";
