...
public class TAS400RowBeginJava
{
  ...
  protected final String TEXT_130 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_131 = " + \"/\" + ";
  protected final String TEXT_132 = ";" + NL + "\t        } else {" + NL + "\t            url_";
  protected final String TEXT_133 = " = \"jdbc:as400://\" + ";
  ...
  protected final String TEXT_147 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_148 = "\", pstmt_";
  protected final String TEXT_149 = ");";
  protected final String TEXT_150 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
