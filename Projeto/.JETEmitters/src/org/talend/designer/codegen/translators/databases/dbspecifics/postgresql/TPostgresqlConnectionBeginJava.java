...
public class TPostgresqlConnectionBeginJava
{
  ...
  protected final String TEXT_36 = NL + "\t\tjava.util.Enumeration<java.sql.Driver> drivers_";
  protected final String TEXT_37 = " =  java.sql.DriverManager.getDrivers();" + NL + "    while (drivers_";
  protected final String TEXT_38 = ".hasMoreElements()) {" + NL + "        java.sql.Driver d_";
  protected final String TEXT_39 = " = drivers_";
  protected final String TEXT_40 = ".nextElement();" + NL + "        java.util.List<String> driverList_";
  protected final String TEXT_41 = " = java.util.Arrays.<String>asList(\"com.amazon.redshift.jdbc.Driver\",\"com.amazon.redshift.jdbc41.Driver\");" + NL + "        if (driverList_";
  protected final String TEXT_42 = ".contains(d_";
  protected final String TEXT_43 = ".getClass().getName())) {" + NL + "            try {" + NL + "                java.sql.DriverManager.deregisterDriver(d_";
  protected final String TEXT_44 = ");" + NL + "                java.sql.DriverManager.registerDriver(d_";
  protected final String TEXT_45 = ");" + NL + "            } catch (java.lang.Exception e_";
  protected final String TEXT_46 = ") {" + NL + "            \t\t//do nothing" + NL + "            }" + NL + "        }" + NL + "    }";
  ...
  protected final String TEXT_64 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_65 = " = null;" + NL + "\t";
  protected final String TEXT_66 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_67 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_72 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_73 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_78 = " - Written records count: \" + nb_line_";
  protected final String TEXT_79 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_81 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_83 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_84 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_86 = " - Writing the record \" + nb_line_";
  protected final String TEXT_87 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_89 = " - Processing the record \" + nb_line_";
  protected final String TEXT_90 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_92 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_93 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_95 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_96 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_97 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_98 = " - Uses an existing connection ";
  protected final String TEXT_99 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_101 = " - Uses an existing connection. Connection URL: \" + conn_";
  ...
  protected final String TEXT_164 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
