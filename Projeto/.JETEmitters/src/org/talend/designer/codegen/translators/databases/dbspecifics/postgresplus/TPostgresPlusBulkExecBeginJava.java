...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_103 = "FROM '\" + ";
  protected final String TEXT_104 = " + \"' WITH \";";
  protected final String TEXT_105 = NL + "    bulkSQL_";
  protected final String TEXT_106 = " += \"BINARY ";
  protected final String TEXT_107 = "\";";
  protected final String TEXT_108 = NL + "    Character field_separator_";
  protected final String TEXT_109 = " = (";
  protected final String TEXT_110 = ").charAt(0); " + NL + "    bulkSQL_";
  protected final String TEXT_111 = " += \"";
  protected final String TEXT_112 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_113 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_114 = " += \"NULL AS '\" + ";
  protected final String TEXT_115 = " + \"' \";";
  protected final String TEXT_116 = NL + "        Character text_enclosure_";
  protected final String TEXT_117 = " = (";
  protected final String TEXT_118 = ").charAt(0);" + NL + "        bulkSQL_";
  protected final String TEXT_119 = " += \"CSV ";
  protected final String TEXT_120 = " QUOTE AS '\" + text_enclosure_";
  protected final String TEXT_121 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";";
  protected final String TEXT_122 = "        " + NL + "        bulkSQL_";
  protected final String TEXT_123 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_124 = " + \"' \";";
  protected final String TEXT_125 = NL + "        bulkSQL_";
  protected final String TEXT_126 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_127 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";        ";
  ...
  protected final String TEXT_134 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_135 = "\");" + NL + "\t ";
  protected final String TEXT_136 = NL + "\t \tString driverClass_";
  protected final String TEXT_137 = " = \"org.postgresql.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_138 = ").newInstance();" + NL + "\t\tString url_";
  protected final String TEXT_139 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_140 = " + \":\" + ";
  protected final String TEXT_141 = " + \"/\" + ";
  protected final String TEXT_142 = ";" + NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_152 = NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_159 = " - Droping table ";
  ...
  protected final String TEXT_167 = " - Drop table ";
  ...
  protected final String TEXT_172 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_194 = " - Creating table ";
  protected final String TEXT_195 = "\" + tableName_";
  ...
  protected final String TEXT_202 = " - Create table ";
  protected final String TEXT_203 = "\" + tableName_";
  ...
  protected final String TEXT_238 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_251 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_255 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_256 = ".equals(schema_";
  protected final String TEXT_257 = ") || (schema_";
  protected final String TEXT_258 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_259 = ".equalsIgnoreCase(bkSchema_";
  protected final String TEXT_260 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_261 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_262 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_268 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_269 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_270 = " == null || dbschema_";
  protected final String TEXT_271 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_272 = " = conn_";
  protected final String TEXT_273 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_274 = " = stmtSchema_";
  protected final String TEXT_275 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_276 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_277 = " = rsSchema_";
  protected final String TEXT_278 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_279 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_280 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_294 = " ==null || dbschema_";
  protected final String TEXT_295 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_296 = ".equals";
  protected final String TEXT_297 = "IgnoreCase";
  protected final String TEXT_298 = "(schema_";
  ...
  protected final String TEXT_302 = NL + "            \tString tableForSearch_";
  protected final String TEXT_303 = " = ";
  protected final String TEXT_304 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_305 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_306 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_307 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_308 = " =  tableForSearch_";
  protected final String TEXT_309 = ".substring(1,tableForSearch_";
  protected final String TEXT_310 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_311 = " =  tableForSearch_";
  protected final String TEXT_312 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_316 = ".getTables(null, conn_";
  protected final String TEXT_317 = ".getSchema(), tableForSearch_";
  ...
  protected final String TEXT_327 = ".getTables(null, dbschema_";
  protected final String TEXT_328 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_329 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_330 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_331 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_339 = ".getTables(";
  protected final String TEXT_340 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_341 = " = false;" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_367 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_371 = " - Creating table ";
  protected final String TEXT_372 = "\" + tableName_";
  ...
  protected final String TEXT_379 = " - Create table ";
  protected final String TEXT_380 = "\" + tableName_";
  protected final String TEXT_381 = " + \"";
  protected final String TEXT_382 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_390 = " - Droping table ";
  ...
  protected final String TEXT_398 = " - Drop table ";
  protected final String TEXT_399 = "\" + tableName_";
  protected final String TEXT_400 = " + \"";
  protected final String TEXT_401 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_403 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_407 = " - Creating table ";
  ...
  protected final String TEXT_415 = " - Create table ";
  ...
  protected final String TEXT_425 = " - Clearing table ";
  ...
  protected final String TEXT_433 = "- Clear table ";
  ...
  protected final String TEXT_448 = " - Trancating table ";
  ...
  protected final String TEXT_456 = " - Truncate table ";
  ...
  protected final String TEXT_467 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_468 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_469 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_470 = NL + "\t";
  protected final String TEXT_471 = NL + "        int keyCount_";
  protected final String TEXT_472 = " = ";
  protected final String TEXT_473 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_474 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_475 = " = tableName_";
  protected final String TEXT_476 = ";" + NL + "        tableName_";
  protected final String TEXT_477 = " = \"tmp_";
  protected final String TEXT_478 = "\" + \"_\" + pid + Thread.currentThread().getId();        " + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_482 = " - Creating temp table ";
  protected final String TEXT_483 = "\" + tableName_";
  protected final String TEXT_484 = " + \"";
  protected final String TEXT_485 = ".\" );" + NL + "\t\t";
  protected final String TEXT_486 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_487 = ".execute(\"";
  protected final String TEXT_488 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_489 = ".close();";
  protected final String TEXT_490 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_491 = " - Create temp table ";
  protected final String TEXT_492 = "\" + tableName_";
  protected final String TEXT_493 = " + \"";
  protected final String TEXT_494 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_495 = NL + "        ";
  protected final String TEXT_496 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_497 = " =conn_";
  protected final String TEXT_498 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_499 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_500 = ".close();" + NL + "   \t\t";
  protected final String TEXT_501 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_502 = " = conn_";
  protected final String TEXT_503 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_504 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_505 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_506 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_507 = " - Bulk inserting data into ";
  protected final String TEXT_508 = "\" + tableName_";
  protected final String TEXT_509 = " + \"";
  protected final String TEXT_510 = ".\" );" + NL + "\t\t";
  protected final String TEXT_511 = NL + "        stmtTmpBulk_";
  protected final String TEXT_512 = ".execute(bulkSQL_";
  protected final String TEXT_513 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_514 = ".close();" + NL + "        " + NL + "\t\t";
  protected final String TEXT_515 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_516 = " - Bulk insert data into ";
  protected final String TEXT_517 = "\" + tableName_";
  protected final String TEXT_518 = " + \"";
  protected final String TEXT_519 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_520 = NL + "        tableName_";
  protected final String TEXT_521 = " = tmpTableName_";
  protected final String TEXT_522 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_523 = " = \"tmp_";
  protected final String TEXT_524 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_528 = " - Updating ";
  protected final String TEXT_529 = "\" + tableName_";
  protected final String TEXT_530 = " + \"";
  protected final String TEXT_531 = " from ";
  protected final String TEXT_532 = "\"+tmpTableName_";
  ...
  protected final String TEXT_538 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_539 = ".close();" + NL + "        tableName_";
  protected final String TEXT_540 = " = tmpTableName_";
  protected final String TEXT_541 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_542 = " = conn_";
  protected final String TEXT_543 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_544 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_545 = " - Droping temp table ";
  protected final String TEXT_546 = "\" + tableName_";
  protected final String TEXT_547 = " + \"";
  protected final String TEXT_548 = ".\");" + NL + "\t\t";
  protected final String TEXT_549 = NL + "        stmtTmpDrop_";
  protected final String TEXT_550 = ".execute(\"";
  protected final String TEXT_551 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_552 = ".close();" + NL + "\t\t";
  protected final String TEXT_553 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_554 = " - Drop temp table ";
  protected final String TEXT_555 = "\" + tableName_";
  protected final String TEXT_556 = "+ \"";
  protected final String TEXT_557 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_558 = NL + "\t    ";
  protected final String TEXT_559 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_560 = " =conn_";
  protected final String TEXT_561 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_562 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_563 = ".close();" + NL + "   \t\t";
  protected final String TEXT_564 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_565 = " = conn_";
  protected final String TEXT_566 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t";
  protected final String TEXT_567 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_568 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_569 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_570 = " - Inserting records in table ";
  protected final String TEXT_571 = "\" + tableName_";
  protected final String TEXT_572 = " + \"";
  protected final String TEXT_573 = ".\");" + NL + "\t";
  protected final String TEXT_574 = NL + "    stmtBulk_";
  protected final String TEXT_575 = ".execute(bulkSQL_";
  protected final String TEXT_576 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_577 = ".close();    " + NL + "\t";
  protected final String TEXT_578 = NL + "\t\tlog.info(\"";
  protected final String TEXT_579 = " - Insert records in table ";
  protected final String TEXT_580 = "\" + tableName_";
  protected final String TEXT_581 = " + \"";
  protected final String TEXT_582 = " has finished.\");" + NL + "\t";
