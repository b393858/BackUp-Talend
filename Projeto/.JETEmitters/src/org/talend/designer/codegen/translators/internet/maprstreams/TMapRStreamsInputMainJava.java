...
public class TMapRStreamsInputMainJava
{
  protected static String nl;
  public static synchronized TMapRStreamsInputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapRStreamsInputMainJava result = new TMapRStreamsInputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = "_consumerRecord.value() == null ? new ";
  protected final String TEXT_9 = "() : ";
  protected final String TEXT_10 = "_consumerRecord.value();";
  protected final String TEXT_11 = NL + "    ";
  protected final String TEXT_12 = ".offset = ";
  protected final String TEXT_13 = "_consumerRecord.offset();";
...
String outStructName = tMapRStreamsInputUtil.getOutStructName();
    ...
    stringBuffer.append(tMapRStreamsInputUtil.getOutgoingConnectionName());
