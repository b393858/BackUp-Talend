...
public class TMemSQLRowBeginJava
{
  ...
  protected final String TEXT_125 = " =\"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_140 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".prepareStatement(";
  ...
  protected final String TEXT_148 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_149 = "\", stmt_";
