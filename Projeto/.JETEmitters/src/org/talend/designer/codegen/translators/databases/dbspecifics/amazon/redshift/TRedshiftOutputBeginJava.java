...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_47 = NL + NL + "String dbschema_";
  protected final String TEXT_48 = " = null;";
  protected final String TEXT_49 = NL + "\tdbschema_";
  protected final String TEXT_50 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_51 = "\");" + NL + "\t";
  protected final String TEXT_52 = NL + "\tdbschema_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";" + NL + "\t";
  protected final String TEXT_55 = NL + "String tableName_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "String schemaForSearch_";
  protected final String TEXT_58 = " = null;" + NL + "String tableForSearch_";
  protected final String TEXT_59 = " = tableName_";
  protected final String TEXT_60 = ";";
  protected final String TEXT_61 = NL + "    if(tableName_";
  protected final String TEXT_62 = "!=null && tableName_";
  protected final String TEXT_63 = ".trim().length()>0){" + NL + "    \ttableName_";
  protected final String TEXT_64 = " = tableName_";
  protected final String TEXT_65 = ".replace(\"\\\".\\\"\",\".\");" + NL + "    \tString[] names_";
  protected final String TEXT_66 = " = tableName_";
  protected final String TEXT_67 = ".split(\"\\\\.\");" + NL + "    \tif(names_";
  protected final String TEXT_68 = ".length > 0){" + NL + "    \t\ttableForSearch_";
  protected final String TEXT_69 = " = names_";
  protected final String TEXT_70 = "[names_";
  protected final String TEXT_71 = ".length-1];" + NL + "    \t}" + NL + "    \tif(names_";
  protected final String TEXT_72 = ".length > 1){" + NL + "    \t\tschemaForSearch_";
  protected final String TEXT_73 = " = names_";
  protected final String TEXT_74 = "[names_";
  protected final String TEXT_75 = ".length-2];" + NL + "    \t}" + NL + "    \ttableName_";
  protected final String TEXT_76 = " = tableName_";
  protected final String TEXT_77 = ".replace(\".\",\"\\\".\\\"\");" + NL + "    }";
  ...
  protected final String TEXT_83 = ";" + NL + "    }" + NL + "" + NL + "    schemaForSearch_";
  protected final String TEXT_84 = " = dbschema_";
  protected final String TEXT_85 = ";";
  protected final String TEXT_86 = NL;
  protected final String TEXT_87 = NL + "        int updateKeyCount_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_90 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_91 = NL + "        int deleteKeyCount_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_94 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_95 = NL + "int nb_line_";
  protected final String TEXT_96 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_97 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_98 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_99 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_100 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_101 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_102 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_103 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_104 = "=0;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_105 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_106 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_107 = " = calendar_";
  protected final String TEXT_108 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_109 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_110 = " = calendar_";
  protected final String TEXT_111 = ".getTime().getTime();" + NL + "long date_";
  protected final String TEXT_112 = ";" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_113 = " = false;" + NL;
  protected final String TEXT_114 = NL + "   int batchSize_";
  protected final String TEXT_115 = " = ";
  protected final String TEXT_116 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_117 = "=0;" + NL + "   int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_125 = NL + "    java.lang.Class.forName(\"com.amazon.redshift.jdbc42.Driver\");";
  protected final String TEXT_126 = NL + "    StringBuilder sbuilder_";
  protected final String TEXT_127 = " = new StringBuilder();" + NL + "    sbuilder_";
  protected final String TEXT_128 = ".append(\"jdbc:redshift:\");";
  protected final String TEXT_129 = NL + "        sbuilder_";
  protected final String TEXT_130 = ".append(\"iam:\");";
  protected final String TEXT_131 = NL + "    sbuilder_";
  protected final String TEXT_132 = ".append(\"//\")" + NL + "                     .append(";
  protected final String TEXT_133 = ")" + NL + "                     .append(\":\")" + NL + "                     .append(";
  protected final String TEXT_134 = ")" + NL + "                     .append(\"/\")" + NL + "                     .append(";
  protected final String TEXT_135 = ");";
  protected final String TEXT_136 = NL + "        sbuilder_";
  protected final String TEXT_137 = ".append(\"?\").append(";
  protected final String TEXT_138 = ");";
  protected final String TEXT_139 = NL + "    String url_";
  protected final String TEXT_140 = " = sbuilder_";
  protected final String TEXT_141 = ".toString();" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\t";
  ...
  protected final String TEXT_146 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_167 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_168 = NL + "        int commitEvery_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_171 = " = 0;";
  protected final String TEXT_172 = NL + "\tclass Util_";
  protected final String TEXT_173 = " {" + NL + "\t\t" + NL + "\t\tint correctNumPerInsert(String source, int numPerInsert) {" + NL + "\t\t\tif(source == null) {" + NL + "\t\t\t\treturn numPerInsert;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint columnCountEveryRow = 0;" + NL + "\t\t\t" + NL + "\t\t\tfor(int i=0;i<source.length();i++) {" + NL + "\t\t\t\tif('?' == source.charAt(i)) {" + NL + "\t\t\t\t\tcolumnCountEveryRow++;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tif(columnCountEveryRow == 0) {" + NL + "\t\t\t\treturn numPerInsert;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint maxNumForParameterSize = 32767;" + NL + "\t\t\tint maxNumPerInsert = maxNumForParameterSize / columnCountEveryRow;" + NL + "\t\t\t" + NL + "\t\t\tif(numPerInsert > maxNumPerInsert) {" + NL + "\t\t\t\treturn maxNumPerInsert;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\treturn numPerInsert;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t}" + NL + "\t" + NL + "\tfinal Util_";
  protected final String TEXT_174 = " util_";
  protected final String TEXT_175 = " = new Util_";
  protected final String TEXT_176 = "();" + NL + "\tint numPerInsert_";
  protected final String TEXT_177 = " = ";
  protected final String TEXT_178 = ";";
  protected final String TEXT_179 = NL + "int count_";
  protected final String TEXT_180 = "=0;";
  protected final String TEXT_181 = NL + "\t";
  protected final String TEXT_182 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement()) {";
  protected final String TEXT_185 = NL + "                              stmtDrop_";
  protected final String TEXT_186 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_194 = ".commit();";
  protected final String TEXT_195 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_214 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_218 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_219 = "));";
  protected final String TEXT_220 = NL + "                    stmtCreate_";
  protected final String TEXT_221 = ".execute(((\"";
  protected final String TEXT_222 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_223 = ".";
  protected final String TEXT_224 = ", \"";
  protected final String TEXT_225 = "\")";
  protected final String TEXT_226 = ".toUpperCase()";
  ...
  protected final String TEXT_234 = NL + "                    String keyCheckTable_";
  protected final String TEXT_235 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_242 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_245 = " + \"]\";";
  protected final String TEXT_246 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_247 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_248 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_249 = ")== null){//}";
  protected final String TEXT_250 = NL + "                                boolean whetherExist_";
  protected final String TEXT_251 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_252 = " = conn_";
  protected final String TEXT_253 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_254 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_255 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_256 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_257 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_258 = NL + "                                ";
  protected final String TEXT_259 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_260 = " = conn_";
  protected final String TEXT_261 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_262 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_263 = " = tableNameForSearch_";
  protected final String TEXT_264 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_265 = " = tableNameForSearch_";
  protected final String TEXT_266 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_267 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_271 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_272 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_273 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_274 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_277 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_278 = " = dbMetaData_";
  protected final String TEXT_279 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_294 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_295 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_298 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_299 = " = dbMetaData_";
  protected final String TEXT_300 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_311 = ")" + NL + "                                            && (schema_";
  ...
  protected final String TEXT_316 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_317 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_318 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_319 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_320 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_321 = " = conn_";
  protected final String TEXT_322 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_323 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_324 = " = dbMetaData_";
  protected final String TEXT_325 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_326 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_327 = " == null || dbschema_";
  protected final String TEXT_328 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_335 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_368 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_369 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_373 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_374 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_375 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_376 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_377 = " = conn_";
  protected final String TEXT_378 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_379 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_380 = " = dbMetaData_";
  protected final String TEXT_381 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_382 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_383 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_384 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_385 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_386 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_387 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_388 = " = conn_";
  protected final String TEXT_389 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_390 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_391 = " = dbMetaData_";
  protected final String TEXT_392 = ".getTables(";
  protected final String TEXT_393 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_394 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_395 = " = rsTable_";
  protected final String TEXT_396 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_397 = ".equalsIgnoreCase(";
  protected final String TEXT_398 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_399 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_400 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_401 = " = conn_";
  protected final String TEXT_402 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_403 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_404 = " = dbMetaData_";
  protected final String TEXT_405 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_406 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_407 = " = rsTable_";
  protected final String TEXT_408 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_409 = ".equalsIgnoreCase(";
  protected final String TEXT_410 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_411 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_412 = NL + "                                if(!whetherExist_";
  protected final String TEXT_413 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_433 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_445 = ".commit();";
  protected final String TEXT_446 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_454 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_455 = ".";
  protected final String TEXT_456 = ", \"";
  protected final String TEXT_457 = "\")";
  protected final String TEXT_458 = ".toUpperCase()";
  ...
  protected final String TEXT_465 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_466 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_467 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_473 = NL + "                stmtClear_";
  ...
  protected final String TEXT_478 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_479 = " = conn_";
  protected final String TEXT_480 = ".createStatement()) {";
  protected final String TEXT_481 = NL + "                              stmtTruncCount_";
  protected final String TEXT_482 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_483 = "));";
  protected final String TEXT_484 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_485 = " = stmtTruncCount_";
  protected final String TEXT_486 = ".executeQuery(\"";
  protected final String TEXT_487 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_488 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_489 = " = rsTruncCount_";
  protected final String TEXT_490 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_491 = " = conn_";
  protected final String TEXT_492 = ".createStatement()) {";
  protected final String TEXT_493 = NL + "                              stmtTrunc_";
  protected final String TEXT_494 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_501 = NL + "                    if(!conn_";
  protected final String TEXT_502 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_503 = ".commit();" + NL + "                    }";
  protected final String TEXT_504 = NL + "                deletedCount_";
  protected final String TEXT_505 = " += rsTruncCountNumber_";
  protected final String TEXT_506 = ";" + NL + "            }";
  protected final String TEXT_507 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_508 = " = conn_";
  protected final String TEXT_509 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_510 = " = stmtTruncCount_";
  protected final String TEXT_511 = ".executeQuery(\"";
  protected final String TEXT_512 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_513 = " = conn_";
  protected final String TEXT_514 = ".createStatement()) {";
  protected final String TEXT_515 = NL + "                conn_";
  protected final String TEXT_516 = ".commit();";
  protected final String TEXT_517 = NL + "                stmtTrunc_";
  protected final String TEXT_518 = ".executeUpdate(\"";
  protected final String TEXT_519 = "\");";
  protected final String TEXT_520 = NL + "                while(rsTruncCount_";
  protected final String TEXT_521 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_522 = " += rsTruncCount_";
  protected final String TEXT_523 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_524 = NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_525 = " = conn_";
  protected final String TEXT_526 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_527 = " + \"\\\" (";
  protected final String TEXT_528 = ") VALUES (";
  protected final String TEXT_529 = ")\");" + NL + "\t\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_530 = "\", pstmt_";
  protected final String TEXT_531 = ");";
  protected final String TEXT_532 = NL + "\t\t\tint rowCount";
  protected final String TEXT_533 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_534 = " {";
  protected final String TEXT_535 = "\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_536 = " ";
  protected final String TEXT_537 = ";" + NL + "\t\t\t\t\t\t" + NL + "\t            \t\tpublic BufferLine_";
  protected final String TEXT_538 = " c";
  protected final String TEXT_539 = "(";
  protected final String TEXT_540 = " ";
  protected final String TEXT_541 = "){" + NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_542 = " = ";
  protected final String TEXT_543 = ";" + NL + "\t\t\t\t\t\t\treturn this;" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_544 = "\t\t" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_545 = "> exInsertColValueList";
  protected final String TEXT_546 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_547 = " exInsertColValue";
  protected final String TEXT_548 = " = null;" + NL + "" + NL + "\t\t\tString valueList_";
  protected final String TEXT_549 = " = \"(";
  protected final String TEXT_550 = ")\";" + NL + "\t\t\tnumPerInsert_";
  protected final String TEXT_551 = " = util_";
  protected final String TEXT_552 = ".correctNumPerInsert(valueList_";
  protected final String TEXT_553 = ", numPerInsert_";
  protected final String TEXT_554 = ");" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_555 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_556 = "=0;i_";
  protected final String TEXT_557 = " < numPerInsert_";
  protected final String TEXT_558 = ";i_";
  protected final String TEXT_559 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_560 = ".append(valueList_";
  protected final String TEXT_561 = ");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_562 = " !=numPerInsert_";
  protected final String TEXT_563 = "-1) extendInsertValueStmt_";
  protected final String TEXT_564 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  protected final String TEXT_565 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_566 = " + \"\\\" (";
  protected final String TEXT_567 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_568 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_569 = " =  conn_";
  protected final String TEXT_570 = ".prepareStatement(insert_";
  protected final String TEXT_571 = ");" + NL + "\t\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_572 = "\", pstmt_";
  protected final String TEXT_573 = ");";
  protected final String TEXT_574 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_575 = " = conn_";
  protected final String TEXT_576 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_584 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_588 = ");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_589 = " = conn_";
  protected final String TEXT_590 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_591 = " + \"\\\" (";
  protected final String TEXT_592 = ") VALUES (";
  protected final String TEXT_593 = ")\");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_594 = "\", pstmtInsert_";
  protected final String TEXT_595 = ");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_596 = " = conn_";
  protected final String TEXT_597 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_598 = " + \"\\\" SET ";
  protected final String TEXT_599 = " WHERE ";
  protected final String TEXT_600 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_601 = "\", pstmtUpdate_";
  protected final String TEXT_602 = ");" + NL + "\t    ";
  protected final String TEXT_603 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_604 = " = conn_";
  protected final String TEXT_605 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_606 = " + \"\\\" SET ";
  protected final String TEXT_607 = " WHERE ";
  protected final String TEXT_608 = "\");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_609 = "\", pstmtUpdate_";
  protected final String TEXT_610 = ");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_611 = " = conn_";
  protected final String TEXT_612 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_620 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_621 = " + \"\\\" WHERE ";
  protected final String TEXT_622 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_623 = "\", pstmt_";
  protected final String TEXT_624 = ");" + NL + "\t    ";
  protected final String TEXT_625 = NL + "\tclass BufferLine_";
  protected final String TEXT_626 = " {";
  protected final String TEXT_627 = NL + "\t\t\t";
  protected final String TEXT_628 = " ";
  protected final String TEXT_629 = ";" + NL + "\t\t\t" + NL + "    \t\tpublic BufferLine_";
  protected final String TEXT_630 = " c";
  protected final String TEXT_631 = "(";
  protected final String TEXT_632 = " ";
  protected final String TEXT_633 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_634 = " = ";
  protected final String TEXT_635 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}";
  protected final String TEXT_636 = NL + "\t\t\troutines.system.Dynamic ";
  protected final String TEXT_637 = ";" + NL + "\t\t\t" + NL + "\t\t\tpublic BufferLine_";
  protected final String TEXT_638 = " c";
  protected final String TEXT_639 = "(routines.system.Dynamic ";
  protected final String TEXT_640 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_641 = " = ";
  protected final String TEXT_642 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_643 = NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_644 = "> exInsertColValueList";
  protected final String TEXT_645 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_646 = " exInsertColValue";
  protected final String TEXT_647 = " = null;" + NL + "    String insert_";
  protected final String TEXT_648 = " = \"\";" + NL + "    int rowCount";
  protected final String TEXT_649 = " = 0;";
  protected final String TEXT_650 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_651 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_652 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
