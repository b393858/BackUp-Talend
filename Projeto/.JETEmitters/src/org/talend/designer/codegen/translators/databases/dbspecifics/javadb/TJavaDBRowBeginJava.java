...
public class TJavaDBRowBeginJava
{
  ...
  protected final String TEXT_123 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\",";
  protected final String TEXT_124 = ");" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_126 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_127 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_128 = "),Integer.parseInt(";
  protected final String TEXT_129 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_130 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_131 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_132 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_133 = " && timeOut_";
  protected final String TEXT_134 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_135 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_136 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_137 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_138 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_139 = NL + "\t\t\t\tString url_";
  protected final String TEXT_140 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_141 = ";" + NL + "\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_143 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_144 = " + \":\" + ";
  protected final String TEXT_145 = " + \"/\" + ";
  protected final String TEXT_146 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_148 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_149 = " + \":\" + ";
  protected final String TEXT_150 = " + \"/\" + ";
  protected final String TEXT_151 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_152 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_153 = " = null;" + NL + "\tString query_";
  protected final String TEXT_154 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_155 = " = false;";
  protected final String TEXT_156 = NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_157 = "\", conn_";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".prepareStatement(";
  protected final String TEXT_162 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_163 = "\", pstmt_";
  protected final String TEXT_164 = ");";
  protected final String TEXT_165 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_166 = " = conn_";
  protected final String TEXT_167 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_168 = "\", stmt_";
