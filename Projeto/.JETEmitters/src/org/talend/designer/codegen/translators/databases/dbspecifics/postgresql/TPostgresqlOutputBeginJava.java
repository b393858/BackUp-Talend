...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_55 = NL + NL + "String tableName_";
  protected final String TEXT_56 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_57 = " == null || dbschema_";
  protected final String TEXT_58 = ".trim().length() == 0) {" + NL + "\ttableName_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ";" + NL + "} else {" + NL + "\ttableName_";
  protected final String TEXT_61 = " = dbschema_";
  ...
  protected final String TEXT_72 = NL + "int nb_line_";
  protected final String TEXT_73 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_74 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_75 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_76 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_77 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_78 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_79 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_80 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_81 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_82 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_83 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_89 = NL + "\t\tjava.sql.Savepoint  sp_";
  ...
  protected final String TEXT_93 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_94 = " = ";
  protected final String TEXT_95 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_96 = ".get(dsAlias_";
  protected final String TEXT_97 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_98 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_99 = " = dataSources_";
  protected final String TEXT_100 = ".get(dsAlias_";
  protected final String TEXT_101 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_102 = NL + "\t";
  protected final String TEXT_103 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  protected final String TEXT_104 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_105 = "+\":\"+";
  protected final String TEXT_106 = "+\"/\"+";
  protected final String TEXT_107 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_130 = NL + "    \tjava.sql.Savepoint  sp_";
  protected final String TEXT_131 = " = null;" + NL + "\t";
  protected final String TEXT_132 = NL + "        conn_";
  protected final String TEXT_133 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_134 = " = ";
  protected final String TEXT_135 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_136 = " = 0;";
  protected final String TEXT_137 = NL;
  protected final String TEXT_138 = NL + "    if(conn_";
  protected final String TEXT_139 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\");" + NL + "    }";
  protected final String TEXT_140 = NL;
  protected final String TEXT_141 = NL + "   int batchSize_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_144 = "=0;";
  protected final String TEXT_145 = NL;
  protected final String TEXT_146 = NL + "int count_";
  protected final String TEXT_147 = "=0;";
  protected final String TEXT_148 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_152 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_160 = ".commit();";
  protected final String TEXT_161 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_200 = NL + "                    String keyCheckTable_";
  protected final String TEXT_201 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_208 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_211 = " + \"]\";";
  protected final String TEXT_212 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_213 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_214 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_215 = ")== null){//}";
  protected final String TEXT_216 = NL + "                                boolean whetherExist_";
  protected final String TEXT_217 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_220 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_221 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_222 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_223 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_232 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_233 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_234 = " = dbMetaData_";
  protected final String TEXT_235 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_239 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_240 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_241 = " = conn_";
  protected final String TEXT_242 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_243 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_244 = " = dbMetaData_";
  protected final String TEXT_245 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_259 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_260 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_261 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_264 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_265 = " = dbMetaData_";
  protected final String TEXT_266 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_267 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_268 = " = rsTable_";
  protected final String TEXT_269 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_270 = " = rsTable_";
  protected final String TEXT_271 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  ...
  protected final String TEXT_282 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_283 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_284 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_285 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_286 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_289 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_290 = " = dbMetaData_";
  protected final String TEXT_291 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_292 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_293 = " == null || dbschema_";
  protected final String TEXT_294 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_301 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_334 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_335 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_339 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_340 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_341 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_342 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_343 = " = conn_";
  protected final String TEXT_344 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_345 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_346 = " = dbMetaData_";
  protected final String TEXT_347 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_348 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_349 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_350 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_351 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_352 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_353 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_354 = " = conn_";
  protected final String TEXT_355 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_356 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_357 = " = dbMetaData_";
  protected final String TEXT_358 = ".getTables(";
  protected final String TEXT_359 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_371 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_372 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_373 = " = rsTable_";
  protected final String TEXT_374 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_375 = ".equalsIgnoreCase(";
  protected final String TEXT_376 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_377 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_378 = NL + "                                if(!whetherExist_";
  protected final String TEXT_379 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_383 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_384 = "));";
  protected final String TEXT_385 = NL + "                                            stmtCreate_";
  protected final String TEXT_386 = ".execute(((\"";
  protected final String TEXT_387 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_399 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_412 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_431 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_432 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_433 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_434 = " = conn_";
  protected final String TEXT_435 = ".createStatement()) {";
  protected final String TEXT_436 = NL + "                              stmtClear_";
  protected final String TEXT_437 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_438 = "));";
  protected final String TEXT_439 = NL + "                stmtClear_";
  protected final String TEXT_440 = ".executeUpdate(\"";
  protected final String TEXT_441 = "\");";
  protected final String TEXT_442 = NL + "            }";
  protected final String TEXT_443 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_444 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".createStatement()) {";
  protected final String TEXT_447 = NL + "                              stmtTruncCount_";
  protected final String TEXT_448 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_449 = "));";
  protected final String TEXT_450 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_451 = " = stmtTruncCount_";
  protected final String TEXT_452 = ".executeQuery(\"";
  protected final String TEXT_453 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_454 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_455 = " = rsTruncCount_";
  protected final String TEXT_456 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_463 = ".commit();";
  protected final String TEXT_464 = NL + "                stmtTrunc_";
  protected final String TEXT_465 = ".executeUpdate(\"";
  protected final String TEXT_466 = "\");";
  protected final String TEXT_467 = NL + "                    if(!conn_";
  protected final String TEXT_468 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_469 = ".commit();" + NL + "                    }";
  protected final String TEXT_470 = NL + "                deletedCount_";
  protected final String TEXT_471 = " += rsTruncCountNumber_";
  protected final String TEXT_472 = ";" + NL + "            }";
  protected final String TEXT_473 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_489 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_495 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_496 = " = conn_";
  protected final String TEXT_497 = ".prepareStatement(insert_";
  protected final String TEXT_498 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_502 = " = null;" + NL + "\t\t\tString keyPsmt_";
  protected final String TEXT_503 = " = conn_";
  protected final String TEXT_504 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_505 = " + \"]\";" + NL + "      pstmt_";
  protected final String TEXT_506 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_507 = ",insert_";
  protected final String TEXT_508 = ",keyPsmt_";
  ...
  protected final String TEXT_519 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_535 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_536 = "\", pstmtInsert_";
  ...
  protected final String TEXT_544 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_545 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_549 = " + \"\\\" SET ";
  protected final String TEXT_550 = " WHERE ";
  protected final String TEXT_551 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_552 = " = conn_";
  protected final String TEXT_553 = ".prepareStatement(update_";
  protected final String TEXT_554 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_555 = "\", pstmtUpdate_";
  protected final String TEXT_556 = ");" + NL + "\t    String insert_";
  protected final String TEXT_557 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_558 = " + \"\\\" (";
  protected final String TEXT_559 = ") VALUES (";
  protected final String TEXT_560 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_561 = " = conn_";
  protected final String TEXT_562 = ".prepareStatement(insert_";
  protected final String TEXT_563 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_564 = "\", pstmtInsert_";
  protected final String TEXT_565 = ");" + NL + "\t    ";
  protected final String TEXT_566 = NL + "\t    String delete_";
  protected final String TEXT_567 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_571 = ".prepareStatement(delete_";
  protected final String TEXT_572 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_582 = " = update_";
  protected final String TEXT_583 = ".split(\"\\\\?\");";
  protected final String TEXT_584 = NL + "\t\t\tupdate_";
  protected final String TEXT_585 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_586 = " = update_";
  protected final String TEXT_587 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_588 = " = insert_";
  protected final String TEXT_589 = ".split(\"\\\\?\");";
  protected final String TEXT_590 = NL + "\t\t\tdelete_";
  protected final String TEXT_591 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_592 = " = delete_";
  protected final String TEXT_593 = ".split(\"\\\\?\");";
  protected final String TEXT_594 = NL + "\t\t\treplace_";
  protected final String TEXT_595 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_596 = " = replace_";
  protected final String TEXT_597 = ".split(\"\\\\?\");";
  protected final String TEXT_598 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_599 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_600 = " = insertIgnore_";
  ...
  protected final String TEXT_605 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_606 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_607 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_608 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_609 = " = true;" + NL + "    \t";
  protected final String TEXT_610 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_611 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_612 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_613 = " =null;" + NL + "\t";
  protected final String TEXT_614 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_615 = " = null;" + NL + "\t\t";
  protected final String TEXT_616 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_617 = " = null;";
  protected final String TEXT_618 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_619 = " =  null;";
  protected final String TEXT_620 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_621 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_622 = " = null;";
  protected final String TEXT_623 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_624 = " = null;";
  protected final String TEXT_625 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_626 = " = null;";
  protected final String TEXT_627 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_628 = " = null;";
  protected final String TEXT_629 = NL + "\t\t \tString[] insertSQLSplits_";
