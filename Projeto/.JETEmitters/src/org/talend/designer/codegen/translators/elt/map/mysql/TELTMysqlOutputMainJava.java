...
public class TELTMysqlOutputMainJava
{
  ...
  protected final String TEXT_93 = "\";" + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_104 = "String decryptedPassword_";
  ...
  protected final String TEXT_114 = ";" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_115 = " = null;    ";
  protected final String TEXT_116 = NL;
  protected final String TEXT_117 = NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_118 = " =null;" + NL;
  protected final String TEXT_119 = NL + "\t\tString insertQuery_";
  protected final String TEXT_120 = " = \"INSERT INTO \"+";
  protected final String TEXT_121 = "+\"(";
  protected final String TEXT_122 = ") (\"+select_query_";
  protected final String TEXT_123 = "+\")\";" + NL + "\t\tpstmt_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".prepareStatement(insertQuery_";
  protected final String TEXT_126 = ");";
  protected final String TEXT_127 = NL + "\t\tString updateQuery_";
  protected final String TEXT_128 = " = \"UPDATE \"+";
  protected final String TEXT_129 = ";" + NL + "\t\tupdateQuery_";
  protected final String TEXT_130 = " +=\" SET ";
  protected final String TEXT_131 = " \"";
  protected final String TEXT_132 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_133 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_134 = " = conn_";
  protected final String TEXT_135 = ".prepareStatement(updateQuery_";
  protected final String TEXT_136 = ");" + NL;
  protected final String TEXT_137 = NL + "\t\tString deleteQuery_";
  protected final String TEXT_138 = " = \"DELETE  FROM \"+";
  protected final String TEXT_139 = ";" + NL + "\t\tdeleteQuery_";
  protected final String TEXT_140 = " += \" WHERE EXISTS (\"+select_query_";
  protected final String TEXT_141 = "+\")\"";
  protected final String TEXT_142 = NL + "\t\t+\"  AND \" + ";
  protected final String TEXT_143 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".prepareStatement(deleteQuery_";
  ...
  protected final String TEXT_155 = " += nb_line_inserted_";
  protected final String TEXT_156 = " = pstmt_";
  protected final String TEXT_157 = ".executeUpdate();";
  protected final String TEXT_158 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_159 = " + \" rows inserted. \\n\");";
  protected final String TEXT_160 = NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_161 = " +\"\\n\");";
  protected final String TEXT_162 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_163 = " += nb_line_updated_";
  protected final String TEXT_164 = " = pstmt_";
  protected final String TEXT_165 = ".executeUpdate();";
  protected final String TEXT_166 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_167 = " + \" rows updated. \\n\");";
  protected final String TEXT_168 = NL + "\t\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_169 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_170 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_171 = " += nb_line_deleted_";
  protected final String TEXT_172 = " = pstmt_";
  protected final String TEXT_173 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_174 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_175 = " + \" rows deleted. \\n\");";
  protected final String TEXT_176 = NL + NL + "\tpstmt_";
  protected final String TEXT_177 = ".close();" + NL;
  protected final String TEXT_178 = NL + "    if(conn_";
  protected final String TEXT_179 = " != null && !conn_";
  protected final String TEXT_180 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_181 = NL + "    }";
  protected final String TEXT_182 = NL + NL + "globalMap.put(\"";
  protected final String TEXT_183 = "_NB_LINE\",nb_line_";
  protected final String TEXT_184 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_185 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_192 = " - Has ";
  protected final String TEXT_193 = " records count: \" + nb_line_";
