...
public class TInterbaseOutputMainJava {
  ...
  protected final String TEXT_66 = ".addBatch();" + NL + "                      batchSizeCounter_";
  protected final String TEXT_67 = "++;" + NL + "                      nb_line_";
  protected final String TEXT_68 = "++;";
  protected final String TEXT_69 = NL + "                       try {" + NL + "                           insertedCount_";
  protected final String TEXT_70 = " = insertedCount_";
  protected final String TEXT_71 = " + pstmt_";
  protected final String TEXT_72 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_73 = "++;";
  protected final String TEXT_74 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_85 = NL + "                                   rejectedCount_";
  protected final String TEXT_86 = " = rejectedCount_";
  ...
  protected final String TEXT_144 = NL + NL + "            int checkCount_";
  protected final String TEXT_145 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_146 = " = pstmt_";
  protected final String TEXT_147 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_148 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_149 = " = rs_";
  protected final String TEXT_150 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_255 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_302 = "_QUERY\", query_";
  protected final String TEXT_303 = ".toString().trim());";
  protected final String TEXT_304 = NL + "                       pstmt_";
  protected final String TEXT_305 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_306 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_307 = "++;";
  protected final String TEXT_308 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_309 = " = deletedCount_";
  protected final String TEXT_310 = " + pstmt_";
  protected final String TEXT_311 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_312 = "++;";
  protected final String TEXT_313 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_326 = NL + "                                   rejectedCount_";
  protected final String TEXT_327 = " = rejectedCount_";
  protected final String TEXT_328 = " + 1;";
  protected final String TEXT_329 = NL + "                                   ";
  protected final String TEXT_330 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_331 = NL + "                                   ";
  protected final String TEXT_332 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_333 = ";";
  protected final String TEXT_334 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_335 = NL + "                       }";
  protected final String TEXT_336 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_347 = NL + "                if ((batchSize_";
  protected final String TEXT_348 = " > 0) && (batchSize_";
  protected final String TEXT_349 = " <= batchSizeCounter_";
  protected final String TEXT_350 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_351 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_352 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_353 = " = 0;";
  protected final String TEXT_354 = NL + "                        status_";
  protected final String TEXT_355 = " = pstmt_";
  protected final String TEXT_356 = ".executeBatch();" + NL + "                        pstmt_";
  protected final String TEXT_357 = ".clearBatch();";
  ...
  protected final String TEXT_391 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_392 = " <= commitCounter_";
  protected final String TEXT_393 = ") {";
  protected final String TEXT_394 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_395 = " > 0) {" + NL + "                        int countSum_";
  protected final String TEXT_396 = " = 0;";
  protected final String TEXT_397 = NL + "                        for(int countEach_";
  protected final String TEXT_398 = ": pstmt_";
  protected final String TEXT_399 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_400 = " += (countEach_";
  protected final String TEXT_401 = " < 0 ? 0 : countEach_";
  protected final String TEXT_402 = ");" + NL + "                        }" + NL + "                        pstmt_";
  protected final String TEXT_403 = ".clearBatch();";
  protected final String TEXT_404 = NL + "                            insertedCount_";
  protected final String TEXT_405 = " += countSum_";
  protected final String TEXT_406 = ";";
  protected final String TEXT_407 = NL + "                            updatedCount_";
  protected final String TEXT_408 = " += countSum_";
  protected final String TEXT_409 = ";";
  protected final String TEXT_410 = NL + "                            deletedCount_";
  protected final String TEXT_411 = " += countSum_";
  protected final String TEXT_412 = ";";
  protected final String TEXT_413 = NL + "                        batchSizeCounter_";
  protected final String TEXT_414 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_415 = NL + "                        throw(e);";
  protected final String TEXT_416 = NL + "                        int countSum_";
  protected final String TEXT_417 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_418 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_435 = ".commit();";
  protected final String TEXT_436 = NL + "                commitCounter_";
  protected final String TEXT_437 = "=0;" + NL + "            }";
