...
public class TMemSQLRowFinallyJava
{
  protected static String nl;
  public static synchronized TMemSQLRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLRowFinallyJava result = new TMemSQLRowFinallyJava();
    nl = null;
    return result;
  }
