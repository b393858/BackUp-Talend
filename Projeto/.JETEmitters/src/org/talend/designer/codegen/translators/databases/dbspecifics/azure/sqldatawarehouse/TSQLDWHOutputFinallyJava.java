...
public class TSQLDWHOutputFinallyJava {
  protected static String nl;
  public static synchronized TSQLDWHOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHOutputFinallyJava result = new TSQLDWHOutputFinallyJava();
    nl = null;
    return result;
  }
