...
public class TCosmosDBOutputFinallyJava
{
  protected static String nl;
  public static synchronized TCosmosDBOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBOutputFinallyJava result = new TCosmosDBOutputFinallyJava();
    nl = null;
    return result;
  }
