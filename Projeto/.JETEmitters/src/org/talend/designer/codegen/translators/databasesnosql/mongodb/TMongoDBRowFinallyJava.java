...
public class TMongoDBRowFinallyJava
{
  ...
  protected final String TEXT_5 = " - Closing the connection \" + ((com.mongodb.MongoClient)resourceMap.get(\"mongo_";
  protected final String TEXT_6 = "\")).getServerAddressList() + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_7 = NL + "\t\t\t\t\t((com.mongodb.MongoClient)resourceMap.get(\"mongo_";
