...
public class TInterbaseConnectionBeginJava
{
  ...
  protected final String TEXT_28 = " - Connection is set auto commit to '";
  protected final String TEXT_29 = "'.\");";
  protected final String TEXT_30 = NL + "\t\t\tconn_";
  protected final String TEXT_31 = ".setAutoCommit(";
  protected final String TEXT_32 = ");";
  protected final String TEXT_33 = NL + "\t\tString url_";
  protected final String TEXT_34 = " = \"jdbc:interbase://\"+";
  protected final String TEXT_35 = "+\"/\"+";
  protected final String TEXT_36 = ";";
  protected final String TEXT_37 = NL + NL + "\t";
  protected final String TEXT_38 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_54 = NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_59 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_60 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_61 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_62 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_63 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_68 = " - Written records count: \" + nb_line_";
  protected final String TEXT_69 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_71 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_73 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_74 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_76 = " - Writing the record \" + nb_line_";
  protected final String TEXT_77 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_79 = " - Processing the record \" + nb_line_";
  protected final String TEXT_80 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_82 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_83 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_85 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_86 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_88 = " - Uses an existing connection ";
  protected final String TEXT_89 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_91 = " - Uses an existing connection. Connection URL: \" + conn_";
  ...
  protected final String TEXT_154 = NL + "\t" + NL + " \t" + NL + " \tglobalMap.put(\"conn_\" + \"";
