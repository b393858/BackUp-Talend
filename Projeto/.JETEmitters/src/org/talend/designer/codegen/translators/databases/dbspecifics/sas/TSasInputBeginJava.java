package org.talend.designer.codegen.translators.databases.dbspecifics.sas;
...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:sasiom://\"+";
  protected final String TEXT_189 = "+\":\"+";
  protected final String TEXT_190 = ";";
  protected final String TEXT_191 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_192 = " = \"";
  protected final String TEXT_193 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_194 = ");" + NL + "\t\t\t" + NL + "\t\t\tString dbUser_";
  ...
  protected final String TEXT_206 = ";" + NL + "" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_207 = " = new java.util.Properties();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\tString librefs_";
  protected final String TEXT_209 = " = ";
  protected final String TEXT_210 = ";" + NL + "\t\t\t\tproperty_";
  protected final String TEXT_211 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_212 = ");" + NL + "\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\tproperty_";
  protected final String TEXT_214 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_215 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_216 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_217 = ");" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\t\tproperty_";
  protected final String TEXT_219 = ".setProperty(String.valueOf(";
  protected final String TEXT_220 = "), String.valueOf(";
  protected final String TEXT_221 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_222 = NL + "\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\tconn_";
  protected final String TEXT_225 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_226 = ", property_";
  protected final String TEXT_227 = ");";
  protected final String TEXT_228 = NL + "\t\t\tif(rs_";
  protected final String TEXT_229 = ".getString(";
  protected final String TEXT_230 = "column_index_";
  protected final String TEXT_231 = ")!=null&&(rs_";
  protected final String TEXT_232 = ".getString(";
  protected final String TEXT_233 = "column_index_";
  protected final String TEXT_234 = ")).length()>0){" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_245 = "=null;" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_246 = ".";
  protected final String TEXT_247 = "='\\0';" + NL + "\t\t\t  \t\t}";
  protected final String TEXT_248 = NL + "\t\t\t  \t\t" + NL + "\t\t\t  \t\tif((rs_";
  protected final String TEXT_249 = ".getString(";
  protected final String TEXT_250 = "column_index_";
  protected final String TEXT_251 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_252 = ".";
  protected final String TEXT_253 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_254 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  protected final String TEXT_255 = NL + "\t\t\t  " + NL + "\t\t\t}\t\t";
  protected final String TEXT_256 = NL + "    " + NL + "\t";
  protected final String TEXT_257 = NL + "\t\t    int nb_line_";
  protected final String TEXT_258 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_259 = " = null;";
  protected final String TEXT_260 = NL + "\t\t        conn_";
  protected final String TEXT_261 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_283 = NL + "                log.debug(\"";
  ...
  protected final String TEXT_293 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_294 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_322 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_392 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_393 = ".getObject(";
  protected final String TEXT_394 = "column_index_";
  protected final String TEXT_395 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_396 = NL + "                                    ";
  protected final String TEXT_397 = ".";
  protected final String TEXT_398 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  protected final String TEXT_399 = NL + "                                      ";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = " = null;" + NL + "                                    }";
  protected final String TEXT_402 = NL + "                                        if (";
  protected final String TEXT_403 = ".";
  protected final String TEXT_404 = " != null) {";
  protected final String TEXT_405 = NL + "                                        ";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = ".setEPSG(";
  protected final String TEXT_408 = ");" + NL + "                                        }";
  protected final String TEXT_409 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_410 = NL + "                                  ";
  protected final String TEXT_411 = ".";
  protected final String TEXT_412 = "=dcg_";
  protected final String TEXT_413 = ";";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_415 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_434 = ".getColumnTypeName(i_";
  protected final String TEXT_435 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_436 = ".add(rs_";
  protected final String TEXT_437 = ".getString(i_";
  protected final String TEXT_438 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_439 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_440 = ".";
  protected final String TEXT_441 = ", rs_";
  protected final String TEXT_442 = ", fixedColumnCount_";
  protected final String TEXT_443 = ",list_";
  protected final String TEXT_444 = ",";
  protected final String TEXT_445 = ");";
  protected final String TEXT_446 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_447 = ".";
  protected final String TEXT_448 = ", rs_";
  protected final String TEXT_449 = ", fixedColumnCount_";
  protected final String TEXT_450 = ",";
  protected final String TEXT_451 = ");";
  protected final String TEXT_452 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_453 = ".";
  protected final String TEXT_454 = ", rs_";
  protected final String TEXT_455 = ", fixedColumnCount_";
  protected final String TEXT_456 = ",";
  protected final String TEXT_457 = ");";
  protected final String TEXT_458 = NL + "                                  Object geom = rs_";
  protected final String TEXT_459 = ".getObject(";
  protected final String TEXT_460 = "column_index_";
  protected final String TEXT_461 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_462 = ".";
  protected final String TEXT_463 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_464 = ".";
  protected final String TEXT_465 = " = null;" + NL + "                                  }";
  protected final String TEXT_466 = NL + "\t\t                          ";
  protected final String TEXT_467 = NL + "\t\t                    }";
  protected final String TEXT_468 = NL + "\t\t\t\t\t";
  protected final String TEXT_469 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_470 = " - Retrieving the record \" + nb_line_";
