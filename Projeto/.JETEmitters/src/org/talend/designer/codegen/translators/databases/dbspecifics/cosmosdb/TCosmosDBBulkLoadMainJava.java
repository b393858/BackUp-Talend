...
public class TCosmosDBBulkLoadMainJava
{
  protected static String nl;
  public static synchronized TCosmosDBBulkLoadMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBBulkLoadMainJava result = new TCosmosDBBulkLoadMainJava();
    nl = null;
    return result;
  }
