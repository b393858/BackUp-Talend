...
public class TTeradataRowBeginJava
{
  ...
  protected final String TEXT_125 = NL + "                if(log.is";
  protected final String TEXT_126 = "Enabled())";
  protected final String TEXT_127 = NL + "            log.";
  protected final String TEXT_128 = "(\"";
  protected final String TEXT_129 = " - \" ";
  protected final String TEXT_130 = " + (";
  protected final String TEXT_131 = ") ";
  protected final String TEXT_132 = ");";
  protected final String TEXT_133 = NL + "            if (log.isDebugEnabled()) {" + NL + "                class BytesLimit65535_";
  protected final String TEXT_134 = "{" + NL + "                    public void limitLog4jByte() throws Exception{" + NL + "                    StringBuilder ";
  protected final String TEXT_135 = " = new StringBuilder();";
  protected final String TEXT_136 = NL + "                    ";
  protected final String TEXT_137 = ".append(\"Parameters:\");";
  protected final String TEXT_138 = NL + "                            ";
  protected final String TEXT_139 = ".append(\"";
  protected final String TEXT_140 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_141 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_148 = NL + "                    } " + NL + "                } " + NL + "            new BytesLimit65535_";
  protected final String TEXT_149 = "().limitLog4jByte();" + NL + "            }";
  protected final String TEXT_150 = NL + "            StringBuilder ";
  protected final String TEXT_151 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_160 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_168 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_171 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_172 = " == null || dbProperties_";
  protected final String TEXT_173 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_174 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_175 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_176 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_177 = " + \"/\" + ";
  protected final String TEXT_178 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_179 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_180 = " = null;" + NL + "\tString query_";
  protected final String TEXT_181 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_182 = " = false;";
  protected final String TEXT_183 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_188 = ".prepareStatement(";
  protected final String TEXT_189 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_190 = "\", pstmt_";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_195 = "\", stmt_";
