...
public class TInformixRowFinallyJava
{
  protected static String nl;
  public static synchronized TInformixRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixRowFinallyJava result = new TInformixRowFinallyJava();
    nl = null;
    return result;
  }
