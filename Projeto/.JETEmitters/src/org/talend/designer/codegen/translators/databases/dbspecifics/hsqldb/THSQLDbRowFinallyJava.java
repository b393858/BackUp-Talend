...
public class THSQLDbRowFinallyJava
{
  protected static String nl;
  public static synchronized THSQLDbRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THSQLDbRowFinallyJava result = new THSQLDbRowFinallyJava();
    nl = null;
    return result;
  }
