...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_209 = NL + "\tboolean bucketExist_";
  protected final String TEXT_210 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".doesBucketExist(";
  protected final String TEXT_213 = ");" + NL + "\t\t";
  protected final String TEXT_214 = "\t" + NL + "\t\t\tif(bucketExist_";
  protected final String TEXT_215 = "){" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_216 = " - Bucket \"+";
  protected final String TEXT_217 = "+\" exists.\");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_218 = " - Bucket \"+";
  protected final String TEXT_219 = "+\" does not exist.\");" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_220 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_221 = "){" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_223 = ");" + NL + "\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_225 = " - \" + e_";
  protected final String TEXT_226 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_227 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_228 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_229 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_230 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_231 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_232 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_233 = "_BUCKET_NAME\", ";
  protected final String TEXT_234 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_235 = "_BUCKET_EXIST\", bucketExist_";
