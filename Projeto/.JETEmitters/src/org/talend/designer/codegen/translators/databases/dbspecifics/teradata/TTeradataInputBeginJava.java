...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_186 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_189 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_190 = " == null || dbProperties_";
  protected final String TEXT_191 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_192 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_193 = " + \"/DATABASE=\" + ";
  protected final String TEXT_194 = ";    " + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_195 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_196 = " + \"/DATABASE=\" + ";
  protected final String TEXT_197 = " + \",\" + ";
  protected final String TEXT_198 = ";" + NL + "\t\t\t}       ";
  protected final String TEXT_199 = NL + "                stmt_";
  protected final String TEXT_200 = ".setFetchSize(200000);";
  protected final String TEXT_201 = NL + "    " + NL + "\t";
  protected final String TEXT_202 = NL + "\t\t    int nb_line_";
  protected final String TEXT_203 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_204 = " = null;";
  protected final String TEXT_205 = NL + "\t\t        conn_";
  protected final String TEXT_206 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_238 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_239 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_377 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_378 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_379 = ".getColumnTypeName(i_";
  protected final String TEXT_380 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_381 = ".add(rs_";
  protected final String TEXT_382 = ".getString(i_";
  protected final String TEXT_383 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_384 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = ", rs_";
  protected final String TEXT_387 = ", fixedColumnCount_";
  protected final String TEXT_388 = ",list_";
  protected final String TEXT_389 = ",";
  protected final String TEXT_390 = ");";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_392 = ".";
  protected final String TEXT_393 = ", rs_";
  protected final String TEXT_394 = ", fixedColumnCount_";
  protected final String TEXT_395 = ",";
  protected final String TEXT_396 = ");";
  protected final String TEXT_397 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = ", rs_";
  protected final String TEXT_400 = ", fixedColumnCount_";
  protected final String TEXT_401 = ",";
  protected final String TEXT_402 = ");";
  protected final String TEXT_403 = NL + "                                  Object geom = rs_";
  protected final String TEXT_404 = ".getObject(";
  protected final String TEXT_405 = "column_index_";
  protected final String TEXT_406 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_407 = ".";
  protected final String TEXT_408 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_415 = " - Retrieving the record \" + nb_line_";
