...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_211 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_212 = ");" + NL + "\t\t";
  protected final String TEXT_213 = NL + "\t\tconn_";
  protected final String TEXT_214 = ".deleteBucket(";
  protected final String TEXT_215 = ");" + NL + "\t\t";
  protected final String TEXT_216 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_217 = " - Delete the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_218 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_219 = "){" + NL + "\t\t";
  protected final String TEXT_220 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_221 = ");" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_223 = " - \" + e_";
  protected final String TEXT_224 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_226 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_228 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_229 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
