...
public class TImpalaRowBeginJava
{
  ...
  protected final String TEXT_174 = ".close();" + NL + "    }" + NL + "    " + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".createStatement();" + NL + "" + NL + "\tString query_";
  protected final String TEXT_177 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_178 = " = false;";
