...
public class TSQLDWHRowFinallyJava
{
  protected static String nl;
  public static synchronized TSQLDWHRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHRowFinallyJava result = new TSQLDWHRowFinallyJava();
    nl = null;
    return result;
  }
