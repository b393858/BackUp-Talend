...
public class TOracleRowBeginJava
{
  ...
  protected final String TEXT_129 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_130 = " + \":\" + ";
  protected final String TEXT_131 = " + \":\" + ";
  protected final String TEXT_132 = ";";
  protected final String TEXT_133 = NL + "\t\t\t\turl_";
  protected final String TEXT_134 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_135 = " + \")(port=\" + ";
  protected final String TEXT_136 = " + \"))(connect_data=(service_name=\" + ";
  ...
  protected final String TEXT_144 = NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_145 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_146 = ".put(\"user\",dbUser_";
  protected final String TEXT_147 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_148 = ".put(\"password\",dbPwd_";
  protected final String TEXT_149 = ");" + NL + "\t            if(";
  protected final String TEXT_150 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_151 = ") && !\"\".equals(";
  protected final String TEXT_152 = ")){" + NL + "                    atnParamsPrope_";
  protected final String TEXT_153 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_154 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "                }" + NL + "\t\t\t\tconn_";
  protected final String TEXT_155 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_156 = ", atnParamsPrope_";
  protected final String TEXT_157 = ");" + NL + "\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_159 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_161 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_162 = NL + "\t\t\t\tint nb_line_deleted_";
  ...
  protected final String TEXT_168 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_173 = ".prepareStatement(";
  ...
  protected final String TEXT_179 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_180 = "\", stmt_";
