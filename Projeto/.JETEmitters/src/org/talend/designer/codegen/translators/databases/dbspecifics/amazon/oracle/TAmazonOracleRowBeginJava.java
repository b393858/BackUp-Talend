...
public class TAmazonOracleRowBeginJava
{
  ...
  protected final String TEXT_124 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_125 = " + \":\" + ";
  protected final String TEXT_126 = " + \":\" + ";
  protected final String TEXT_127 = ";" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tString url_";
  protected final String TEXT_129 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_130 = " + \")(port=\" + ";
  protected final String TEXT_131 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_132 = " + \")))\";" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tString url_";
  protected final String TEXT_134 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_152 = " = null;" + NL + "\tString query_";
  protected final String TEXT_153 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_161 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_166 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_167 = "\", stmt_";
  protected final String TEXT_168 = ");";
  protected final String TEXT_169 = NL;
  protected final String TEXT_170 = NL + "\t\tint nb_line_inserted_";
  protected final String TEXT_171 = " = 0;";
  protected final String TEXT_172 = NL + "\t\tint nb_line_update_";
  protected final String TEXT_173 = " = 0;";
  protected final String TEXT_174 = NL + "\t\tint nb_line_deleted_";
