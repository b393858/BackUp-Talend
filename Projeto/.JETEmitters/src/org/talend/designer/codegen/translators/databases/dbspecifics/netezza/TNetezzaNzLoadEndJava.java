...
public class TNetezzaNzLoadEndJava {
  ...
  protected final String TEXT_19 = " - Execute '\"+command_";
  protected final String TEXT_20 = ".toString()+\"' has finished.\");" + NL + "\t\t\t\t";
  protected final String TEXT_21 = NL + "\t\t\t\t// added \"show log output\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_22 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t// System.out.println(\"reading log file :\" + ";
  protected final String TEXT_23 = " );" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t// Open the file and print contents " + NL + "\t\t\t\t\t\t\t java.io.FileInputStream fstream = new java.io.FileInputStream(";
  protected final String TEXT_24 = ");" + NL + "\t\t\t\t\t\t\t java.io.DataInputStream in = new java.io.DataInputStream(fstream);" + NL + "\t\t\t\t\t\t\t java.io.BufferedReader br = new java.io.BufferedReader(new java.io.InputStreamReader(in));" + NL + "\t\t\t\t\t\t\t String strLine;" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\twhile ((strLine = br.readLine()) != null)   {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println (strLine);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tin.close();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_25 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_26 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_27 = NL + "\t\t\t\t\t\t\t// System.err.println(\"Error Reading Log File \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_28 = NL + "\t\t\t\t// end \"show log output\"" + NL + "\t\t\t\t";
