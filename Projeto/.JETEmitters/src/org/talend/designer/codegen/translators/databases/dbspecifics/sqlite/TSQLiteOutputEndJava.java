...
public class TSQLiteOutputEndJava {
  ...
  protected final String TEXT_47 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_48 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_49 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_50 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_51 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_52 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_53 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_54 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_55 = "\");" + NL + "        }";
  protected final String TEXT_56 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_57 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_58 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_59 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_60 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_61 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_62 = "\");" + NL + "        }";
  protected final String TEXT_63 = NL;
  protected final String TEXT_64 = NL + "                    int[] status_";
  protected final String TEXT_65 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_66 = " = 0;" + NL + "                    try {" + NL + "                        if(pstmt_";
  protected final String TEXT_67 = "!=null && batchSizeCounter_";
  protected final String TEXT_68 = " > 0 ){";
  protected final String TEXT_69 = NL + "                            status_";
  protected final String TEXT_70 = " = pstmt_";
  protected final String TEXT_71 = ".executeBatch();";
  protected final String TEXT_72 = NL + "                            for(int countEach_";
  protected final String TEXT_73 = ": status_";
  protected final String TEXT_74 = ") {" + NL + "                                countSum_";
  protected final String TEXT_75 = " += (countEach_";
  protected final String TEXT_76 = " < 0 ? 0 : countEach_";
  protected final String TEXT_77 = ");" + NL + "                            }" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_78 = NL + "                            throw(e);";
  protected final String TEXT_79 = NL + "                        for(int countEach_";
  protected final String TEXT_80 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_81 = " += (countEach_";
  protected final String TEXT_82 = " < 0 ? 0 : countEach_";
  protected final String TEXT_83 = ");" + NL + "                        }" + NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_84 = NL + "                    }" + NL + "                    if(pstmt_";
  protected final String TEXT_85 = "!=null && batchSizeCounter_";
  protected final String TEXT_86 = " > 0 ){" + NL + "                        try {" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_87 = " = pstmt_";
  protected final String TEXT_88 = ".getUpdateCount();" + NL + "                        }catch (java.sql.SQLException e){" + NL + "" + NL + "                        }" + NL + "                        tmp_batchUpdateCount_";
  ...
  protected final String TEXT_94 = NL + "                            insertedCount_";
  protected final String TEXT_95 = " += tmp_batchUpdateCount_";
  protected final String TEXT_96 = ";";
  protected final String TEXT_97 = NL + "                            updatedCount_";
  protected final String TEXT_98 = " += tmp_batchUpdateCount_";
  protected final String TEXT_99 = ";";
  protected final String TEXT_100 = NL + "                            deletedCount_";
  protected final String TEXT_101 = " += tmp_batchUpdateCount_";
  protected final String TEXT_102 = ";";
  protected final String TEXT_103 = NL + "                    }";
  protected final String TEXT_104 = NL + "        if(pstmt_";
  protected final String TEXT_105 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_106 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_107 = "\");" + NL + "        }";
  protected final String TEXT_108 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_109 = "\", true);";
  protected final String TEXT_110 = NL + "        if (commitCounter_";
  protected final String TEXT_111 = " > 0) {";
  protected final String TEXT_112 = NL + "            conn_";
  protected final String TEXT_113 = ".commit();";
  protected final String TEXT_114 = NL + "        }";
  protected final String TEXT_115 = NL + "        conn_";
  protected final String TEXT_116 = " .close();";
  protected final String TEXT_117 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_118 = "\", true);";
  protected final String TEXT_119 = NL + NL + "\tint rejectedCount_";
  protected final String TEXT_120 = " = 0;";
  protected final String TEXT_121 = NL + "\tnb_line_deleted_";
  protected final String TEXT_122 = "=nb_line_deleted_";
  protected final String TEXT_123 = "+ deletedCount_";
  protected final String TEXT_124 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_125 = "=nb_line_update_";
  protected final String TEXT_126 = " + updatedCount_";
  ...
  protected final String TEXT_131 = "=nb_line_rejected_";
  protected final String TEXT_132 = " + rejectedCount_";
  protected final String TEXT_133 = ";" + NL + "\t";
  protected final String TEXT_134 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_135 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_136 = "_NB_LINE\",nb_line_";
  protected final String TEXT_137 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_139 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_140 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_141 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_142 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_143 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_144 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_145 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_146 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_147 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_148 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_149 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_150 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_153 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_156 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_157 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_158 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_159 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_160 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_161 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_162 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_168 = "_NB_LINE_UPDATED\",nb_line_update_";
  ...
  protected final String TEXT_174 = "_NB_LINE_REJECTED\", nb_line_rejected_";
