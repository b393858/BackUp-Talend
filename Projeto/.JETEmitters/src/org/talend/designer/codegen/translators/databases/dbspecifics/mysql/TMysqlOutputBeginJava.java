...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_64 = "=0;" + NL + "" + NL + "int rejectedCount_";
  protected final String TEXT_65 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_68 = " = false;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_69 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_70 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_71 = " = calendar_";
  protected final String TEXT_72 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_73 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_74 = " = calendar_";
  protected final String TEXT_75 = ".getTime().getTime();" + NL + "long date_";
  ...
  protected final String TEXT_102 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t\t} else {" + NL + "\t\t\tString properties_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";" + NL + "\t\t\tif (!properties_";
  protected final String TEXT_105 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\t\tproperties_";
  protected final String TEXT_106 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\turl_";
  protected final String TEXT_107 = " = \"";
  protected final String TEXT_108 = "://\" + ";
  protected final String TEXT_109 = " + \":\" + ";
  protected final String TEXT_110 = " + \"/\" + ";
  protected final String TEXT_111 = " + \"?\" + properties_";
  protected final String TEXT_112 = ";" + NL + "\t\t}" + NL + "\t\tString driverClass_";
  protected final String TEXT_113 = " = \"";
  protected final String TEXT_114 = "\";" + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_125 = NL + NL + "\t\tString dbPwd_";
  protected final String TEXT_126 = " = decryptedPassword_";
  protected final String TEXT_127 = ";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_136 = NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_144 = NL + "   int batchSize_";
  protected final String TEXT_145 = " = ";
  protected final String TEXT_146 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_147 = "=0;";
  protected final String TEXT_148 = NL;
  protected final String TEXT_149 = NL + "int count_";
  protected final String TEXT_150 = "=0;";
  protected final String TEXT_151 = NL + "    \t";
  protected final String TEXT_152 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_156 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_165 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_184 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_220 = NL + "                                boolean whetherExist_";
  protected final String TEXT_221 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_222 = " = conn_";
  protected final String TEXT_223 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_224 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_225 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_226 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_227 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_236 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_237 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_238 = " = dbMetaData_";
  protected final String TEXT_239 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_243 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_249 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_264 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_265 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_266 = " = conn_";
  protected final String TEXT_267 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_268 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_269 = " = dbMetaData_";
  protected final String TEXT_270 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_289 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_290 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_293 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_294 = " = dbMetaData_";
  protected final String TEXT_295 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_296 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_297 = " == null || dbschema_";
  protected final String TEXT_298 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_299 = " = conn_";
  protected final String TEXT_300 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_301 = " = stmtSchema_";
  protected final String TEXT_302 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_303 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_304 = " = rsSchema_";
  protected final String TEXT_305 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_325 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_326 = NL + "                                String tableForSearch_";
  protected final String TEXT_327 = " = ";
  protected final String TEXT_328 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_329 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_330 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_331 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_332 = " =  tableForSearch_";
  protected final String TEXT_333 = ".substring(1,tableForSearch_";
  protected final String TEXT_334 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_335 = " =  tableForSearch_";
  protected final String TEXT_336 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_337 = " = conn_";
  protected final String TEXT_338 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_339 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_343 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_344 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_345 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_346 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_347 = " = conn_";
  protected final String TEXT_348 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_349 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_350 = " = dbMetaData_";
  protected final String TEXT_351 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_352 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_353 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_354 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_355 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_356 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_357 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_358 = " = conn_";
  protected final String TEXT_359 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_360 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_361 = " = dbMetaData_";
  protected final String TEXT_362 = ".getTables(";
  protected final String TEXT_363 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_369 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_370 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_371 = " = conn_";
  protected final String TEXT_372 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_373 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_374 = " = dbMetaData_";
  protected final String TEXT_375 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_381 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_382 = NL + "                                if(!whetherExist_";
  protected final String TEXT_383 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_391 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_392 = ".";
  protected final String TEXT_393 = ", \"";
  protected final String TEXT_394 = "\")";
  protected final String TEXT_395 = ".toUpperCase()";
  ...
  protected final String TEXT_403 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_416 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_424 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_435 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_436 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_437 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_443 = NL + "                stmtClear_";
  protected final String TEXT_444 = ".executeUpdate(\"";
  protected final String TEXT_445 = "\");";
  protected final String TEXT_446 = NL + "            }";
  protected final String TEXT_447 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_448 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_449 = " = conn_";
  protected final String TEXT_450 = ".createStatement()) {";
  protected final String TEXT_451 = NL + "                              stmtTruncCount_";
  protected final String TEXT_452 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_453 = "));";
  protected final String TEXT_454 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_455 = " = stmtTruncCount_";
  protected final String TEXT_456 = ".executeQuery(\"";
  protected final String TEXT_457 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_458 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_459 = " = rsTruncCount_";
  protected final String TEXT_460 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_471 = NL + "                    if(!conn_";
  protected final String TEXT_472 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_473 = ".commit();" + NL + "                    }";
  protected final String TEXT_474 = NL + "                deletedCount_";
  protected final String TEXT_475 = " += rsTruncCountNumber_";
  protected final String TEXT_476 = ";" + NL + "            }";
  protected final String TEXT_477 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_478 = " = conn_";
  protected final String TEXT_479 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_480 = " = stmtTruncCount_";
  protected final String TEXT_481 = ".executeQuery(\"";
  protected final String TEXT_482 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_490 = NL + "                while(rsTruncCount_";
  protected final String TEXT_491 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_492 = " += rsTruncCount_";
  protected final String TEXT_493 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_494 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_495 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_496 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_497 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_498 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_499 = ".append (\"`\" +  ";
  protected final String TEXT_500 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_501 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_506 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_507 = " + \"` (";
  protected final String TEXT_508 = ") VALUES (";
  protected final String TEXT_509 = ")\";";
  protected final String TEXT_510 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_511 = " += \tduplidateClause_";
  protected final String TEXT_512 = ".toString();";
  ...
  protected final String TEXT_525 = ".prepareStatement(insert_";
  protected final String TEXT_526 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_527 = "\", pstmt_";
  protected final String TEXT_528 = ");";
  protected final String TEXT_529 = NL;
  protected final String TEXT_530 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_531 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_532 = " = conn_";
  protected final String TEXT_533 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_534 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_535 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_536 = ",insert_";
  protected final String TEXT_537 = ",keyPsmt_";
  protected final String TEXT_538 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_539 = "\", pstmt_";
  protected final String TEXT_540 = ");";
  protected final String TEXT_541 = NL;
  protected final String TEXT_542 = NL + "\t            class BufferLine_";
  protected final String TEXT_543 = " {" + NL + "    \t            ";
  protected final String TEXT_544 = NL + "                            ";
  protected final String TEXT_545 = " ";
  protected final String TEXT_546 = ";";
  protected final String TEXT_547 = NL + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_556 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_557 = "> exInsertColValueList";
  protected final String TEXT_558 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_559 = " exInsertColValue";
  protected final String TEXT_560 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_561 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_562 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_563 = ".append(\"(";
  protected final String TEXT_564 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_565 = "-1) extendInsertValueStmt_";
  protected final String TEXT_566 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_567 = " = \"INSERT INTO `\"+";
  protected final String TEXT_568 = "+\"` (";
  protected final String TEXT_569 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_570 = ".toString();";
  protected final String TEXT_571 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_572 = " += \tduplidateClause_";
  protected final String TEXT_573 = ".toString();";
  protected final String TEXT_574 = NL + "\t\t\t\t";
  protected final String TEXT_575 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_576 = " = new StringBuffer(insert_";
  protected final String TEXT_577 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_578 = ".insert(insert_";
  protected final String TEXT_579 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_580 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_581 = " =insertStringBuffer_";
  ...
  protected final String TEXT_585 = ".prepareStatement(insert_";
  protected final String TEXT_586 = ");" + NL + "\t            resourceMap.put(\"pstmt_";
  protected final String TEXT_587 = "\", pstmt_";
  protected final String TEXT_588 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_589 = " = \"";
  protected final String TEXT_590 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_591 = " =  \"";
  protected final String TEXT_592 = "\";" + NL + "\t            int rowCount";
  ...
  protected final String TEXT_600 = " += \tduplidateClause_";
  protected final String TEXT_601 = ".toString();";
  protected final String TEXT_602 = NL + "\t\t        int batchSize_";
  protected final String TEXT_603 = " = ";
  protected final String TEXT_604 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_605 = "=0;" + NL + "\t\t        ";
  ...
  protected final String TEXT_617 = ");" + NL + "\t\t        resourceMap.put(\"pstmt_";
  protected final String TEXT_618 = "\", pstmt_";
  protected final String TEXT_619 = ");" + NL;
  protected final String TEXT_620 = NL + "\t    String update_";
  protected final String TEXT_621 = " = \"UPDATE `\" + ";
  protected final String TEXT_622 = " + \"` SET ";
  protected final String TEXT_623 = " WHERE ";
  protected final String TEXT_624 = "\";" + NL + "\t    ";
  protected final String TEXT_625 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_626 = " = new StringBuffer(update_";
  protected final String TEXT_627 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_628 = ".insert(update_";
  protected final String TEXT_629 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_630 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_631 = " =updateStringBuffer_";
  protected final String TEXT_632 = ".toString(); ";
  protected final String TEXT_633 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_634 = " = conn_";
  protected final String TEXT_635 = ".prepareStatement(update_";
  protected final String TEXT_636 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_637 = "\", pstmt_";
  protected final String TEXT_638 = ");" + NL + "\t    ";
  protected final String TEXT_639 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_640 = " = conn_";
  protected final String TEXT_641 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_642 = " + \"` WHERE ";
  protected final String TEXT_643 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_644 = "\", pstmt_";
  protected final String TEXT_645 = ");" + NL + "\t    String insert_";
  protected final String TEXT_646 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_658 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_659 = " = conn_";
  protected final String TEXT_660 = ".prepareStatement(insert_";
  protected final String TEXT_661 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_662 = "\", pstmtInsert_";
  protected final String TEXT_663 = ");" + NL + "\t    String update_";
  protected final String TEXT_664 = " = \"UPDATE `\" + ";
  protected final String TEXT_665 = " + \"` SET ";
  protected final String TEXT_666 = " WHERE ";
  protected final String TEXT_667 = "\";" + NL + "\t    ";
  protected final String TEXT_668 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_669 = " = new StringBuffer(update_";
  protected final String TEXT_670 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_671 = ".insert(update_";
  protected final String TEXT_672 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_673 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_674 = " =updateStringBuffer_";
  protected final String TEXT_675 = ".toString(); ";
  protected final String TEXT_676 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_677 = " = conn_";
  protected final String TEXT_678 = ".prepareStatement(update_";
  protected final String TEXT_679 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_680 = "\", pstmtUpdate_";
  protected final String TEXT_681 = ");" + NL + "\t    ";
  protected final String TEXT_682 = NL + "\t    String update_";
  protected final String TEXT_683 = " = \"UPDATE `\" + ";
  protected final String TEXT_684 = " + \"` SET ";
  protected final String TEXT_685 = " WHERE ";
  protected final String TEXT_686 = "\";" + NL + "\t    ";
  protected final String TEXT_687 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_688 = " = new StringBuffer(update_";
  protected final String TEXT_689 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_690 = ".insert(update_";
  protected final String TEXT_691 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_692 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_693 = " =updateStringBuffer_";
  protected final String TEXT_694 = ".toString(); ";
  protected final String TEXT_695 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_696 = " = conn_";
  protected final String TEXT_697 = ".prepareStatement(update_";
  protected final String TEXT_698 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_699 = "\", pstmtUpdate_";
  protected final String TEXT_700 = ");" + NL + "\t    String insert_";
  protected final String TEXT_701 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_702 = " + \"` (";
  protected final String TEXT_703 = ") VALUES (";
  protected final String TEXT_704 = ")\";" + NL + "\t     ";
  protected final String TEXT_705 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_706 = " = new StringBuffer(insert_";
  protected final String TEXT_707 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_708 = ".insert(insert_";
  protected final String TEXT_709 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_710 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_711 = " =insertStringBuffer_";
  protected final String TEXT_712 = ".toString(); ";
  protected final String TEXT_713 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_714 = " = conn_";
  protected final String TEXT_715 = ".prepareStatement(insert_";
  protected final String TEXT_716 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_717 = "\", pstmtInsert_";
  protected final String TEXT_718 = ");" + NL + "\t    ";
  protected final String TEXT_719 = NL + "\t    String delete_";
  protected final String TEXT_720 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_721 = " + \"` WHERE ";
  protected final String TEXT_722 = "\";" + NL + "\t    ";
  protected final String TEXT_723 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_724 = " = new StringBuffer(delete_";
  protected final String TEXT_725 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_726 = ".insert(delete_";
  protected final String TEXT_727 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_728 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_729 = " =deleteStringBuffer_";
  protected final String TEXT_730 = ".toString();  ";
  protected final String TEXT_731 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_732 = " = conn_";
  protected final String TEXT_733 = ".prepareStatement(delete_";
  protected final String TEXT_734 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_735 = "\", pstmt_";
  protected final String TEXT_736 = ");" + NL + "\t    ";
  protected final String TEXT_737 = NL + "\t    String replace_";
  protected final String TEXT_738 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_739 = " + \"` (";
  protected final String TEXT_740 = ") VALUES (";
  protected final String TEXT_741 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_742 = " = conn_";
  protected final String TEXT_743 = ".prepareStatement(replace_";
  protected final String TEXT_744 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_745 = "\", pstmt_";
  protected final String TEXT_746 = ");" + NL + "\t    ";
  protected final String TEXT_747 = NL + "\t    String insertIgnore_";
  protected final String TEXT_748 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_749 = " + \"` (";
  protected final String TEXT_750 = ") VALUES (";
  protected final String TEXT_751 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_752 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_753 = " = conn_";
  protected final String TEXT_754 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_755 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_756 = "\", pstmt_";
  protected final String TEXT_757 = ");" + NL + "\t    ";
  protected final String TEXT_758 = NL + "\t    String insert_";
  protected final String TEXT_759 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_760 = " + \"` (";
  protected final String TEXT_761 = ") VALUES (";
  protected final String TEXT_762 = ")\";" + NL + "\t    ";
  protected final String TEXT_763 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_764 = " = new StringBuffer(insert_";
  protected final String TEXT_765 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_766 = ".insert(insert_";
  protected final String TEXT_767 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_768 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_769 = " =insertStringBuffer_";
  protected final String TEXT_770 = ".toString(); ";
  protected final String TEXT_771 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_772 = " = conn_";
  protected final String TEXT_773 = ".prepareStatement(insert_";
  protected final String TEXT_774 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_775 = "\", pstmt_";
  ...
  protected final String TEXT_780 = " = insert_";
  ...
  protected final String TEXT_786 = NL + "\t\t\tupdate_";
  protected final String TEXT_787 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_788 = " = update_";
  protected final String TEXT_789 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_790 = " = insert_";
  protected final String TEXT_791 = ".split(\"\\\\?\");";
  protected final String TEXT_792 = NL + "\t\t\tdelete_";
  protected final String TEXT_793 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_794 = " = delete_";
  protected final String TEXT_795 = ".split(\"\\\\?\");";
  protected final String TEXT_796 = NL + "\t\t\treplace_";
  protected final String TEXT_797 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_798 = " = replace_";
  protected final String TEXT_799 = ".split(\"\\\\?\");";
  protected final String TEXT_800 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_801 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_802 = " = insertIgnore_";
  protected final String TEXT_803 = ".split(\"\\\\?\");";
  protected final String TEXT_804 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_805 = " = insert_";
  protected final String TEXT_806 = ".split(\"\\\\?\");";
  protected final String TEXT_807 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_808 = " {" + NL + "    \t            ";
  protected final String TEXT_809 = NL + "                            ";
  protected final String TEXT_810 = " ";
  protected final String TEXT_811 = ";";
  protected final String TEXT_812 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_813 = ";" + NL + "\t\t\t";
  protected final String TEXT_814 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_815 = "(";
  protected final String TEXT_816 = NL + "                                ,";
  protected final String TEXT_817 = NL + "                            ";
  protected final String TEXT_818 = " ";
  protected final String TEXT_819 = NL + "\t\t\t\t, routines.system.Dynamic ";
  ...
  protected final String TEXT_828 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_829 = "> exInsertColValueList";
  protected final String TEXT_830 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_831 = " exInsertColValue";
  protected final String TEXT_832 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_833 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_834 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_835 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_836 = "=1;";
  protected final String TEXT_837 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_838 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_839 = "=0;";
  protected final String TEXT_840 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_841 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_842 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_843 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_844 = "=0;" + NL + "\t";
  protected final String TEXT_845 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_846 = " = null;" + NL + "\t\t";
  protected final String TEXT_847 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_848 = " = null;";
  protected final String TEXT_849 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_850 = " =  null;";
  protected final String TEXT_851 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_852 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_853 = " = null;";
  protected final String TEXT_854 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_855 = " = null;";
  protected final String TEXT_856 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_857 = " = null;";
  protected final String TEXT_858 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_859 = " = null;";
  protected final String TEXT_860 = NL + "\t\t \tString[] insertSQLSplits_";
