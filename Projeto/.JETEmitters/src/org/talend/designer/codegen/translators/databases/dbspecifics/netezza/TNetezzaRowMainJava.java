...
public class TNetezzaRowMainJava
{
  ...
  protected final String TEXT_180 = NL + "\tnb_";
  protected final String TEXT_181 = " += pstmt_";
  protected final String TEXT_182 = ".getUpdateCount();";
  protected final String TEXT_183 = NL + "\tnb_";
  protected final String TEXT_184 = " += stmt_";
  protected final String TEXT_185 = ".getUpdateCount();";
