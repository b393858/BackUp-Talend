...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_51 = " = 0;" + NL + "int nb_line_copied_";
  ...
  protected final String TEXT_56 = "=0;" + NL + "int copiedCount_";
  protected final String TEXT_57 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_58 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_59 = " = null;" + NL + "boolean whetherReject_";
  ...
  protected final String TEXT_82 = " = \"com.vertica.Driver\";" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\tString driverClass_";
  protected final String TEXT_84 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t\t";
  ...
  protected final String TEXT_89 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_90 = " + \":\" + ";
  protected final String TEXT_91 = " + \"/\" + ";
  protected final String TEXT_92 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\tString url_";
  protected final String TEXT_94 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_95 = " + \":\" + ";
  protected final String TEXT_96 = " + \"/\" + ";
  protected final String TEXT_97 = " + \"?\" + ";
  protected final String TEXT_98 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_99 = NL + NL + "\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_129 = ".setAutoCommit(false);" + NL + "" + NL + "int commitEvery_";
  protected final String TEXT_130 = " = ";
  protected final String TEXT_131 = ";" + NL + "" + NL + "int commitCounter_";
  ...
  protected final String TEXT_141 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_153 = ".commit();";
  protected final String TEXT_154 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_158 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_159 = "));";
  protected final String TEXT_160 = NL + "                        stmtCreate_";
  protected final String TEXT_161 = ".execute(((\"";
  protected final String TEXT_162 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = ", \"";
  protected final String TEXT_165 = "\")";
  protected final String TEXT_166 = ".toUpperCase()";
  ...
  protected final String TEXT_209 = NL + "                                boolean whetherExist_";
  protected final String TEXT_210 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_216 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_217 = NL + "                                ";
  protected final String TEXT_218 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_221 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_222 = " = tableNameForSearch_";
  protected final String TEXT_223 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_224 = " = tableNameForSearch_";
  protected final String TEXT_225 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_226 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_230 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_231 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_232 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_233 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_234 = " = conn_";
  protected final String TEXT_235 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_236 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_237 = " = dbMetaData_";
  protected final String TEXT_238 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_253 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_259 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_278 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_279 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_282 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_283 = " = dbMetaData_";
  protected final String TEXT_284 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_285 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_286 = " == null || dbschema_";
  protected final String TEXT_287 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_294 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_327 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_328 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_332 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_333 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_334 = " = true;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_341 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_342 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_343 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_344 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_345 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  ...
  protected final String TEXT_351 = ".getTables(";
  protected final String TEXT_352 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_353 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_354 = " = rsTable_";
  protected final String TEXT_355 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_356 = ".equalsIgnoreCase(";
  protected final String TEXT_357 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_358 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_364 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_365 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_366 = " = rsTable_";
  protected final String TEXT_367 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_368 = ".equalsIgnoreCase(";
  protected final String TEXT_369 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_370 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_371 = NL + "                                if(!whetherExist_";
  protected final String TEXT_372 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_392 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_405 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_424 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_425 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_426 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_437 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".createStatement()) {";
  protected final String TEXT_440 = NL + "                              stmtTruncCount_";
  protected final String TEXT_441 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_442 = "));";
  protected final String TEXT_443 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_444 = " = stmtTruncCount_";
  protected final String TEXT_445 = ".executeQuery(\"";
  protected final String TEXT_446 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_447 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_448 = " = rsTruncCount_";
  protected final String TEXT_449 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_453 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_460 = NL + "                    if(!conn_";
  protected final String TEXT_461 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_462 = ".commit();" + NL + "                    }";
  protected final String TEXT_463 = NL + "                deletedCount_";
  protected final String TEXT_464 = " += rsTruncCountNumber_";
  protected final String TEXT_465 = ";" + NL + "            }";
  protected final String TEXT_466 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_471 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_479 = NL + "                while(rsTruncCount_";
  protected final String TEXT_480 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_481 = " += rsTruncCount_";
  protected final String TEXT_482 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_483 = NL + "\t\t\t\ttry (java.sql.Statement stmtCreateProjection_";
  protected final String TEXT_484 = " = conn_";
  protected final String TEXT_485 = ".createStatement()) {" + NL + "\t\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_486 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_487 = " + \"_proj (";
  protected final String TEXT_488 = ") AS SELECT ";
  protected final String TEXT_489 = " FROM \" + tableName_";
  protected final String TEXT_490 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_491 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_501 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_502 = "\", pstmt_";
  protected final String TEXT_503 = ");";
  protected final String TEXT_504 = NL + "        int batchCount_";
  ...
  protected final String TEXT_513 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_514 = "\", pstmt_";
  ...
  protected final String TEXT_520 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_521 = "\", pstmt_";
  ...
  protected final String TEXT_538 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_539 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_545 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_546 = " = conn_";
  protected final String TEXT_547 = ".prepareStatement(update_";
  protected final String TEXT_548 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_554 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_555 = " = conn_";
  protected final String TEXT_556 = ".prepareStatement(insert_";
  protected final String TEXT_557 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_558 = "\", pstmtInsert_";
  protected final String TEXT_559 = ");";
  protected final String TEXT_560 = NL + "        String delete_";
  protected final String TEXT_561 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_562 = " + \" WHERE ";
  protected final String TEXT_563 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_564 = " = conn_";
  protected final String TEXT_565 = ".prepareStatement(delete_";
  protected final String TEXT_566 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_567 = "\", pstmt_";
  protected final String TEXT_568 = ");";
  protected final String TEXT_569 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_570 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_571 = " = conn_";
  protected final String TEXT_572 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_573 = "\", stmt_";
  protected final String TEXT_574 = ");" + NL + "        String template_";
  protected final String TEXT_575 = " = \"COPY \" + tableName_";
  protected final String TEXT_576 = " +\" (";
  protected final String TEXT_577 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_578 = "DIRECT";
  protected final String TEXT_579 = "\";" + NL + "\t\t";
  protected final String TEXT_580 = NL + "        StringBuffer query_";
  protected final String TEXT_581 = " = null;" + NL + "       \t";
  protected final String TEXT_582 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_592 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_600 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_607 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_631 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_632 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_633 = " = null;" + NL + "\t\tString template_";
