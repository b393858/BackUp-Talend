...
public class TFirebirdRowBeginJava
{
  ...
  protected final String TEXT_125 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_135 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_141 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_146 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
