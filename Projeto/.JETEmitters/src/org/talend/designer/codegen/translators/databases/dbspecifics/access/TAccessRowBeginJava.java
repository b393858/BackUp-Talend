...
public class TAccessRowBeginJava
{
  ...
  protected final String TEXT_124 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_125 = " + \";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true\";";
  protected final String TEXT_126 = NL + "\t\t\t\tconn_";
  protected final String TEXT_127 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_128 = "\");" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\tString driverClass_";
  protected final String TEXT_130 = " = \"";
  protected final String TEXT_131 = "\";" + NL + "\t\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_132 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_151 = NL + "\t\t\t\t\tString atnParams_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";" + NL + "\t\t\t\t\tatnParams_";
  protected final String TEXT_154 = " = atnParams_";
  protected final String TEXT_155 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_156 = " = new java.util.Properties();" + NL + "\t\t\t\t\tatnParamsPrope_";
  protected final String TEXT_157 = ".put(\"user\",dbUser_";
  protected final String TEXT_158 = ");" + NL + "\t\t\t\t\tatnParamsPrope_";
  protected final String TEXT_159 = ".put(\"password\",dbPwd_";
  protected final String TEXT_160 = ");" + NL + "\t\t\t\t\tatnParamsPrope_";
  protected final String TEXT_161 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_162 = ".getBytes()));" + NL + "\t\t\t\t  " + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_163 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_164 = ", atnParamsPrope_";
  protected final String TEXT_165 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_166 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_167 = " = null;" + NL + "\tString query_";
  protected final String TEXT_168 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_169 = " = false;";
  protected final String TEXT_170 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_175 = ".prepareStatement(";
  ...
  protected final String TEXT_181 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
  protected final String TEXT_182 = "\", stmt_";
