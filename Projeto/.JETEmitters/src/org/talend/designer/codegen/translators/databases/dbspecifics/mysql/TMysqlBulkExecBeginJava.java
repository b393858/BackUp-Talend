...
public class TMysqlBulkExecBeginJava {
  ...
  protected final String TEXT_76 = NL + "String charset_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "String tableName_";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ";" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_81 = "=0;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_88 = "\";" + NL + "\t\tClass.forName(driverClass_";
  protected final String TEXT_89 = ").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_110 = NL + "\t\tString dbUser_";
  protected final String TEXT_111 = " = ";
  protected final String TEXT_112 = ";" + NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_120 = " - Droping table ";
  protected final String TEXT_121 = "\" + tableName_";
  ...
  protected final String TEXT_128 = " - Drop table ";
  ...
  protected final String TEXT_137 = " - Creating table ";
  ...
  protected final String TEXT_145 = " - Create table ";
  protected final String TEXT_146 = "\" + tableName_";
  protected final String TEXT_147 = " + \"";
  protected final String TEXT_148 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_155 = " - Creating table ";
  ...
  protected final String TEXT_163 = " - Create table ";
  protected final String TEXT_164 = "\" + tableName_";
  protected final String TEXT_165 = " + \"";
  protected final String TEXT_166 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_172 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_173 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_174 = " = tableNameForSearch_";
  protected final String TEXT_175 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_176 = " = tableNameForSearch_";
  protected final String TEXT_177 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_178 = " = dbMetaData_";
  protected final String TEXT_179 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_180 = ", tableNameForSearch_";
  protected final String TEXT_181 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_182 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_183 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_184 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_191 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_192 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_193 = " = rsTable_";
  protected final String TEXT_194 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_195 = " = rsTable_";
  protected final String TEXT_196 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_197 = ".equalsIgnoreCase(";
  protected final String TEXT_198 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_199 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_200 = ") || dbschema_";
  protected final String TEXT_201 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_212 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_216 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_217 = ".equals(schema_";
  protected final String TEXT_218 = ") || (schema_";
  protected final String TEXT_219 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_220 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_229 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_230 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_231 = " == null || dbschema_";
  protected final String TEXT_232 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_235 = " = stmtSchema_";
  protected final String TEXT_236 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_237 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_238 = " = rsSchema_";
  protected final String TEXT_239 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_240 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_241 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_255 = " ==null || dbschema_";
  protected final String TEXT_256 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_257 = ".equals";
  protected final String TEXT_258 = "IgnoreCase";
  protected final String TEXT_259 = "(schema_";
  ...
  protected final String TEXT_263 = NL + "            \tString tableForSearch_";
  protected final String TEXT_264 = " = ";
  protected final String TEXT_265 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_266 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_267 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_268 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_269 = " =  tableForSearch_";
  protected final String TEXT_270 = ".substring(1,tableForSearch_";
  protected final String TEXT_271 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_272 = " =  tableForSearch_";
  protected final String TEXT_273 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_277 = ".getTables(null, conn_";
  protected final String TEXT_278 = ".getSchema(), tableForSearch_";
  ...
  protected final String TEXT_288 = ".getTables(null, dbschema_";
  protected final String TEXT_289 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_290 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_291 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_292 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_300 = ".getTables(";
  protected final String TEXT_301 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_302 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_303 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_304 = " = rsTable_";
  protected final String TEXT_305 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  ...
  protected final String TEXT_431 = NL + "String lines_separator_";
  protected final String TEXT_432 = " = ";
  protected final String TEXT_433 = ";" + NL + "String field_separator_";
  protected final String TEXT_434 = " = ";
  protected final String TEXT_435 = ";" + NL + "String escaped_str_";
  protected final String TEXT_436 = " = ";
  protected final String TEXT_437 = ";" + NL + "String enclosed_str_";
  protected final String TEXT_438 = " = ";
  protected final String TEXT_439 = ";" + NL + "String file_";
  protected final String TEXT_440 = " = ";
  protected final String TEXT_441 = ";" + NL + "file_";
  protected final String TEXT_442 = " = file_";
  protected final String TEXT_443 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "String replace_";
  ...
  protected final String TEXT_448 = " == 0) {" + NL + "\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "\t\t}" + NL + "\t\ttableName_";
  protected final String TEXT_449 = " = \"tmp_";
  protected final String TEXT_450 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtTmpCreate_";
  ...
  protected final String TEXT_454 = " - Creating temp table \" + tableName_";
  protected final String TEXT_455 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_456 = NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_457 = ".execute(\"";
  protected final String TEXT_458 = ")\");" + NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_459 = ".close();" + NL + "" + NL + "\t\tjava.sql.Statement stmtTmpBulk_";
  ...
  protected final String TEXT_463 = " - Create temp table \" + tableName_";
  protected final String TEXT_464 = " + \" has succeeded.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_465 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_466 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_467 = NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_468 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_469 = ");" + NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_470 = ".execute(" + NL + "\t\t\t\"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_471 = " + \"' \"" + NL + "\t\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_472 = NL + "\t\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_473 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_474 = ")?\"\\\\\":\"\")+ enclosed_str_";
  protected final String TEXT_475 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ESCAPED BY '\" +(\"'\".equals(escaped_str_";
  protected final String TEXT_476 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_477 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\")+ \"'\"" + NL + "\t\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_478 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_479 = "\"";
  protected final String TEXT_480 = NL + "\t\t\t+ \" SET\"";
  protected final String TEXT_481 = NL + "\t\t\t+ \" ";
  protected final String TEXT_482 = "=CAST(@";
  protected final String TEXT_483 = "_";
  protected final String TEXT_484 = " AS UNSIGNED)\"";
  protected final String TEXT_485 = NL + "\t\t\t+ \",\"";
  protected final String TEXT_486 = NL + "\t\t);" + NL + "\t\t";
  protected final String TEXT_487 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_488 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_489 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_490 = NL + "\t\ttableName_";
  protected final String TEXT_491 = " = ";
  protected final String TEXT_492 = ";" + NL + "\t\tString tmpTableName_";
  protected final String TEXT_493 = " = \"tmp_";
  protected final String TEXT_494 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_498 = " - Updating \" + tableName_";
  protected final String TEXT_499 = " + \" from \"+tmpTableName_";
  ...
  protected final String TEXT_511 = " - Droping temp table \" + tableName_";
  protected final String TEXT_512 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_513 = NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_514 = ".execute(\"";
  protected final String TEXT_515 = "\");" + NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_516 = ".close();" + NL + "\t\t";
  protected final String TEXT_517 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_518 = " - Drop temp table \" + tableName_";
  protected final String TEXT_519 = "+ \" has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_520 = NL + "\t\t";
  protected final String TEXT_521 = NL + "\t\treplace_";
  protected final String TEXT_522 = " = \"REPLACE\";" + NL + "\t\t";
  protected final String TEXT_523 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_524 = " - Replacing records in table \" + tableName_";
  protected final String TEXT_525 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_526 = NL + "\t\treplace_";
  protected final String TEXT_527 = " = \"IGNORE\";" + NL + "\t\t";
  protected final String TEXT_528 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_529 = " - Loading data ignore records in table \" + tableName_";
  protected final String TEXT_530 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_531 = NL + "\t\treplace_";
  protected final String TEXT_532 = " = \"\";" + NL + "\t\t";
  protected final String TEXT_533 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_534 = " - Inserting records in table \" + tableName_";
  protected final String TEXT_535 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_536 = NL + "\tString bulkSQL_";
  protected final String TEXT_537 = " = \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_538 = " + \"' \"" + NL + "\t\t+ replace_";
  protected final String TEXT_539 = NL + "\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_540 = NL + "\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_541 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_542 = ")?\"\\\\\":\"\") + enclosed_str_";
  protected final String TEXT_543 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ESCAPED BY '\" + (\"'\".equals(escaped_str_";
  protected final String TEXT_544 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_545 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_546 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_547 = "\"";
  protected final String TEXT_548 = NL + "\t\t+ \" SET\"";
  protected final String TEXT_549 = NL + "\t\t+ \" ";
  protected final String TEXT_550 = "=CAST(@";
  protected final String TEXT_551 = "_";
  protected final String TEXT_552 = " AS UNSIGNED)\"";
  protected final String TEXT_553 = NL + "\t\t+ \",\"";
  protected final String TEXT_554 = ";" + NL + "\t";
  protected final String TEXT_555 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_556 = "=conn_";
  protected final String TEXT_557 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_558 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_559 = ");" + NL + "\t" + NL + "\tstmt_";
  protected final String TEXT_560 = ".execute(bulkSQL_";
  protected final String TEXT_561 = ");" + NL + "\t";
  protected final String TEXT_562 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_563 = " - Replace records in table \" + tableName_";
  protected final String TEXT_564 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_565 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_566 = " - Load data ignore records in table \" + tableName_";
  protected final String TEXT_567 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_568 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_569 = " - Insert records in table \" + tableName_";
  protected final String TEXT_570 = " + \" has finished.\");" + NL + "\t\t";
