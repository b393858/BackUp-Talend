...
public class TMysqlTableListBeginJava
{
  ...
  protected final String TEXT_84 = " = \"\";" + NL + "" + NL + "if(whereClause_";
  protected final String TEXT_85 = " != null && whereClause_";
  protected final String TEXT_86 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_87 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type<>'VIEW' AND table_schema='\" + db_";
  protected final String TEXT_88 = " + \"' AND (\" + whereClause_";
  protected final String TEXT_89 = " + \") ORDER BY table_name ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_90 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type<>'VIEW' AND table_schema='\" + db_";
  protected final String TEXT_91 = " + \"' ORDER BY table_name ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_92 = NL + "    log.info(\"";
  protected final String TEXT_93 = " - Query:'\"+query_";
  protected final String TEXT_94 = "+\"'.\");";
  protected final String TEXT_95 = NL + NL + "int nb_table_";
  protected final String TEXT_96 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_97 = " = conn_";
  protected final String TEXT_98 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_99 = " = stmt2_";
  protected final String TEXT_100 = ".executeQuery(query_";
  protected final String TEXT_101 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_102 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_103 = " = rs_";
  protected final String TEXT_104 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_105 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_106 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_107 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_108 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_109 = " - Name of table \"+nb_table_";
  protected final String TEXT_110 = "+\":\"+currentTableName_";
  protected final String TEXT_111 = "+\".\");" + NL + "\t";
  protected final String TEXT_112 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_113 = "_CURRENT_TABLE\", currentTableName_";
