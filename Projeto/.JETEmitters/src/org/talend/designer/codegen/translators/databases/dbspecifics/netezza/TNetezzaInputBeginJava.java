...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_204 = "column_index_";
  protected final String TEXT_205 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_210 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_211 = " = null;";
  protected final String TEXT_212 = NL + "\t\t        conn_";
  protected final String TEXT_213 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_214 = "\");";
  protected final String TEXT_215 = NL + "\t\t\t\t";
  protected final String TEXT_216 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_217 = " =  conn_";
  protected final String TEXT_218 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_219 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_220 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_221 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_222 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_223 = NL + "                 conn_";
  protected final String TEXT_224 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_225 = NL + "               ";
  protected final String TEXT_226 = " + \"=\" + ";
  protected final String TEXT_227 = " + \";\" +";
  protected final String TEXT_228 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_229 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_230 = ");";
  protected final String TEXT_231 = NL + "\t\t    ";
  protected final String TEXT_232 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_233 = " = ";
  protected final String TEXT_234 = ";" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "                log.debug(\"";
  protected final String TEXT_236 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_245 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_246 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_247 = " = stmt_";
  protected final String TEXT_248 = ".executeQuery(dbquery_";
  protected final String TEXT_249 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_250 = " = rs_";
  protected final String TEXT_251 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_252 = " = rsmd_";
  protected final String TEXT_253 = ".getColumnCount();" + NL;
  protected final String TEXT_254 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_255 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_256 = ".setDbmsId(\"";
  protected final String TEXT_257 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_258 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_259 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_260 = ".add(\"";
  protected final String TEXT_261 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_262 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_263 = " = ";
  protected final String TEXT_264 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_265 = "; i <= rsmd_";
  protected final String TEXT_266 = ".getColumnCount()-";
  protected final String TEXT_267 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_268 = ".contains(rsmd_";
  protected final String TEXT_269 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_270 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_271 = ".setName(rsmd_";
  protected final String TEXT_272 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_273 = ".setDbName(rsmd_";
  protected final String TEXT_274 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_275 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_276 = "\", rsmd_";
  protected final String TEXT_277 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_278 = ".getPrecision(i), rsmd_";
  protected final String TEXT_279 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_280 = ".setDbType(rsmd_";
  protected final String TEXT_281 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_282 = ".setDbTypeId(rsmd_";
  protected final String TEXT_283 = ".getColumnType(i));";
  protected final String TEXT_284 = NL + "                \tdcm_";
  protected final String TEXT_285 = ".setFormat(";
  protected final String TEXT_286 = ");";
  protected final String TEXT_287 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_288 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_289 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_290 = ".setLength(rsmd_";
  protected final String TEXT_291 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_292 = ".setLength(rsmd_";
  protected final String TEXT_293 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_294 = NL + "\t\t\tdcm_";
  protected final String TEXT_295 = ".setLength(rsmd_";
  protected final String TEXT_296 = ".getPrecision(i));";
  protected final String TEXT_297 = NL + "                \tdcm_";
  protected final String TEXT_298 = ".setPrecision(rsmd_";
  protected final String TEXT_299 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_300 = ".setNullable(rsmd_";
  protected final String TEXT_301 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_302 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_304 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_305 = ".metadatas.add(dcm_";
  protected final String TEXT_306 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_307 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_308 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_309 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_310 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_311 = NL + "\t\t    ";
  protected final String TEXT_312 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_313 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_314 = NL + "\t\t    while (rs_";
  protected final String TEXT_315 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_316 = "++;" + NL + "\t\t        ";
  protected final String TEXT_317 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_318 = " = ";
  protected final String TEXT_319 = " + dcg_";
  protected final String TEXT_320 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_331 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  ...
  protected final String TEXT_344 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_345 = ".getObject(";
  protected final String TEXT_346 = "column_index_";
  protected final String TEXT_347 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_348 = NL + "                                    ";
  protected final String TEXT_349 = ".";
  protected final String TEXT_350 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_359 = ".setEPSG(";
  ...
  protected final String TEXT_366 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_367 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_368 = " = ";
  protected final String TEXT_369 = "; i_";
  protected final String TEXT_370 = "  <= rsmd_";
  protected final String TEXT_371 = ".getColumnCount(); i_";
  protected final String TEXT_372 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_374 = ".getColumnTypeName(i_";
  protected final String TEXT_375 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_376 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_377 = ".getClob(i_";
  protected final String TEXT_378 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_379 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_380 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_381 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_382 = ".add(tNTextImpl_";
  protected final String TEXT_383 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_384 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_385 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_386 = ".getColumnTypeName(i_";
  protected final String TEXT_387 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_388 = ".add(rs_";
  protected final String TEXT_389 = ".getString(i_";
  protected final String TEXT_390 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_391 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_392 = ".";
  protected final String TEXT_393 = ", rs_";
  protected final String TEXT_394 = ", fixedColumnCount_";
  protected final String TEXT_395 = ",list_";
  protected final String TEXT_396 = ",";
  protected final String TEXT_397 = ");";
  protected final String TEXT_398 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_399 = ".";
  protected final String TEXT_400 = ", rs_";
  protected final String TEXT_401 = ", fixedColumnCount_";
  protected final String TEXT_402 = ",";
  protected final String TEXT_403 = ");";
  protected final String TEXT_404 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_405 = ".";
  protected final String TEXT_406 = ", rs_";
  protected final String TEXT_407 = ", fixedColumnCount_";
  protected final String TEXT_408 = ",";
  protected final String TEXT_409 = ");";
  protected final String TEXT_410 = NL + "                                  Object geom = rs_";
  protected final String TEXT_411 = ".getObject(";
  protected final String TEXT_412 = "column_index_";
  protected final String TEXT_413 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_414 = ".";
  protected final String TEXT_415 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_416 = ".";
  protected final String TEXT_417 = " = null;" + NL + "                                  }";
  protected final String TEXT_418 = NL + "\t\t                          ";
  protected final String TEXT_419 = NL + "\t\t                    }";
  protected final String TEXT_420 = NL + "\t\t\t\t\t";
  protected final String TEXT_421 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_422 = " - Retrieving the record \" + nb_line_";
