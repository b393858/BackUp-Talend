...
public class TMysqlSCDMainJava {
  ...
  protected final String TEXT_147 = " += insertionStatement_";
  protected final String TEXT_148 = ".executeUpdate();";
  protected final String TEXT_149 = NL + "                    System.out.println(\"[";
  protected final String TEXT_150 = "] new history line\");";
  ...
  protected final String TEXT_163 = NL + "                nb_line_update_";
  protected final String TEXT_164 = " += updateForType3_";
  protected final String TEXT_165 = ".executeUpdate();";
  protected final String TEXT_166 = NL + "                    System.out.println(\"[";
  protected final String TEXT_167 = "] l3 update done\");";
  protected final String TEXT_168 = NL + "            }";
  protected final String TEXT_169 = NL + "    }" + NL + "    " + NL + "\t} catch (java.lang.Exception e) {//catch" + NL + "  \t\t";
  ...
  protected final String TEXT_188 = NL + "\t}//end catch";
  ...
  protected final String TEXT_199 = NL + "                lookUpValue_";
  protected final String TEXT_200 = ".";
  protected final String TEXT_201 = " = ";
  protected final String TEXT_202 = ".";
  protected final String TEXT_203 = ";";
  protected final String TEXT_204 = NL + "        cache_";
  protected final String TEXT_205 = ".put(lookUpKey_";
