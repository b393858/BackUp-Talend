...
public class TSybaseRowFinallyJava
{
  protected static String nl;
  public static synchronized TSybaseRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseRowFinallyJava result = new TSybaseRowFinallyJava();
    nl = null;
    return result;
  }
