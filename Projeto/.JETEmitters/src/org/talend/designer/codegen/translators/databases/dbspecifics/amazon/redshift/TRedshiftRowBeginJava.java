...
public class TRedshiftRowBeginJava
{
  ...
  protected final String TEXT_123 = NL + "            StringBuilder sbuilder_";
  protected final String TEXT_124 = " = new StringBuilder();" + NL + "            sbuilder_";
  protected final String TEXT_125 = ".append(\"jdbc:redshift:\");";
  protected final String TEXT_126 = NL + "                sbuilder_";
  protected final String TEXT_127 = ".append(\"iam:\");";
  protected final String TEXT_128 = NL + "            sbuilder_";
  protected final String TEXT_129 = ".append(\"//\")" + NL + "                             .append(";
  protected final String TEXT_130 = ")" + NL + "                             .append(\":\")" + NL + "                             .append(";
  protected final String TEXT_131 = ")" + NL + "                             .append(\"/\")" + NL + "                             .append(";
  protected final String TEXT_132 = ");";
  protected final String TEXT_133 = NL + "                sbuilder_";
  protected final String TEXT_134 = ".append(\"?\").append(";
  protected final String TEXT_135 = ");";
  protected final String TEXT_136 = NL + "            String url_";
  protected final String TEXT_137 = " = sbuilder_";
  protected final String TEXT_138 = ".toString();";
  protected final String TEXT_139 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_140 = " = null;" + NL + "\tString query_";
  protected final String TEXT_141 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_148 = ".prepareStatement(";
  protected final String TEXT_149 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_154 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
