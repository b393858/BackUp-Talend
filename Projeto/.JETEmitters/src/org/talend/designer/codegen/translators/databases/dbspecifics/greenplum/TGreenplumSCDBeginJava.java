...
public class TGreenplumSCDBeginJava {
  ...
  protected final String TEXT_16 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_17 = " = \"org.postgresql.Driver\";" + NL + "\t\t\tString connectionString_";
  protected final String TEXT_18 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_19 = " + \":\" + ";
  protected final String TEXT_20 = " + \"/\" + ";
  protected final String TEXT_21 = ";" + NL + "\t\t";
  protected final String TEXT_22 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_23 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\tString connectionString_";
  protected final String TEXT_24 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_25 = "+\":\"+";
  protected final String TEXT_26 = "+\";DatabaseName=\"+";
  ...
  protected final String TEXT_35 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  protected final String TEXT_36 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_48 = ";" + NL + "    }" + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_49 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_50 = " = null;    ";
  protected final String TEXT_51 = NL + "        String searching_";
  protected final String TEXT_52 = " = \"";
  protected final String TEXT_53 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_54 = " = connection_";
  protected final String TEXT_55 = ".prepareStatement(searching_";
  protected final String TEXT_56 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_57 = " = null;";
  protected final String TEXT_58 = NL + "        String search_";
  protected final String TEXT_59 = " = \"";
  protected final String TEXT_60 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_61 = " = connection_";
  protected final String TEXT_62 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_63 = " = statement_";
  protected final String TEXT_64 = ".executeQuery(search_";
  protected final String TEXT_65 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_66 = ", SCDStruct_";
  protected final String TEXT_67 = "> cache_";
  protected final String TEXT_68 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_69 = ", SCDStruct_";
  protected final String TEXT_70 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_71 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_72 = " sk_";
  protected final String TEXT_73 = " = new SCDSK_";
  protected final String TEXT_74 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_75 = " row_";
  protected final String TEXT_76 = " = new SCDStruct_";
  protected final String TEXT_77 = "();";
  protected final String TEXT_78 = NL + "                    tmpValue_";
  protected final String TEXT_79 = " = resultSet_";
  protected final String TEXT_80 = ".getString(";
  protected final String TEXT_81 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_82 = " != null && tmpValue_";
  protected final String TEXT_83 = ".length() > 0) {";
  protected final String TEXT_84 = NL + "                        ";
  protected final String TEXT_85 = ".";
  protected final String TEXT_86 = " = tmpValue_";
  protected final String TEXT_87 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_88 = NL + "                            if(tmpValue_";
  protected final String TEXT_89 = " == null) {";
  protected final String TEXT_90 = NL + "                                ";
  protected final String TEXT_91 = ".";
  protected final String TEXT_92 = " = null;" + NL + "                            } else {";
  protected final String TEXT_93 = NL + "                                ";
  protected final String TEXT_94 = ".";
  protected final String TEXT_95 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_96 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_97 = ")) {";
  protected final String TEXT_98 = NL + "                                ";
  protected final String TEXT_99 = ".";
  protected final String TEXT_100 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_101 = "' in '";
  protected final String TEXT_102 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_103 = NL + "                    }";
  protected final String TEXT_104 = NL + "                    timestamp_";
  protected final String TEXT_105 = " = resultSet_";
  protected final String TEXT_106 = ".getTimestamp(";
  protected final String TEXT_107 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_108 = " != null) {";
  protected final String TEXT_109 = NL + "                        ";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = " = new java.util.Date(timestamp_";
  protected final String TEXT_112 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_113 = NL + "                        ";
  protected final String TEXT_114 = ".";
  protected final String TEXT_115 = " = null;" + NL + "                    }";
  protected final String TEXT_116 = NL + "                    if(resultSet_";
  protected final String TEXT_117 = ".getObject(";
  ...
  protected final String TEXT_125 = NL + "            cache_";
  protected final String TEXT_126 = ".put(sk_";
  protected final String TEXT_127 = ", row_";
  protected final String TEXT_128 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_129 = ".close();" + NL + "        statement_";
  protected final String TEXT_130 = ".close();";
  protected final String TEXT_131 = NL + "            System.out.println(\"[";
  protected final String TEXT_132 = "] comparison cache loaded\");";
  protected final String TEXT_133 = NL + "        ";
  protected final String TEXT_134 = " nextSurrogateKey_";
  protected final String TEXT_135 = " = 1;";
  protected final String TEXT_136 = NL + "            if(cache_";
  protected final String TEXT_137 = ".size() > 0) {";
  protected final String TEXT_138 = NL + "        String tmpQuery_";
  protected final String TEXT_139 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_140 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_141 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_142 = " = connection_";
  protected final String TEXT_143 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_144 = " = tmpStmt_";
  protected final String TEXT_145 = ".executeQuery(tmpQuery_";
  protected final String TEXT_146 = ");";
  protected final String TEXT_147 = NL + "        if(tmpRS_";
  protected final String TEXT_148 = ".next() && tmpRS_";
  protected final String TEXT_149 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_150 = " = tmpRS_";
  protected final String TEXT_151 = ".get";
  protected final String TEXT_152 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_153 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_154 = ".close();";
  protected final String TEXT_155 = NL + "            }            ";
  protected final String TEXT_156 = NL + "    String insertionSQL_";
  protected final String TEXT_157 = " = \"";
  protected final String TEXT_158 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_159 = " = connection_";
  protected final String TEXT_160 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_161 = ");";
  protected final String TEXT_162 = NL + "            insertionStatement_";
  protected final String TEXT_163 = ".setTimestamp(";
  protected final String TEXT_164 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_165 = "\")));";
  protected final String TEXT_166 = NL + "            insertionStatement_";
  protected final String TEXT_167 = ".setNull(";
  protected final String TEXT_168 = ", java.sql.Types.DATE);";
  protected final String TEXT_169 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_170 = " = ";
  protected final String TEXT_171 = ";" + NL + "            String datePattern_";
  protected final String TEXT_172 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_173 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_174 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_175 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_176 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_177 = ".setTimestamp(";
  protected final String TEXT_178 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_179 = ").parse(";
  protected final String TEXT_180 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_181 = ").getTime()));";
  protected final String TEXT_182 = NL + "        String updateSQLForType1_";
  protected final String TEXT_183 = " = \"";
  protected final String TEXT_184 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_185 = " = connection_";
  protected final String TEXT_186 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_187 = ");        ";
  protected final String TEXT_188 = NL + "        String updateSQLForType2_";
  protected final String TEXT_189 = " = \"";
  protected final String TEXT_190 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_191 = " = connection_";
  protected final String TEXT_192 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + "            updateForType2_";
  protected final String TEXT_195 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_196 = "\")));";
  protected final String TEXT_197 = NL + "        String updateSQLForType3_";
  protected final String TEXT_198 = " = \"";
  protected final String TEXT_199 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_200 = " = connection_";
  protected final String TEXT_201 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_202 = ");";
  protected final String TEXT_203 = NL + "    ";
  protected final String TEXT_204 = NL + "        SCDSK_";
  protected final String TEXT_205 = " lookUpKey_";
  protected final String TEXT_206 = " = null;        ";
  protected final String TEXT_207 = NL + "    SCDStruct_";
  protected final String TEXT_208 = " lookUpValue_";
