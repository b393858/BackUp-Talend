...
public class TS3CopyBeginJava
{
  ...
  protected final String TEXT_209 = NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_210 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_211 = " - Copying an object with key:\" + ";
  protected final String TEXT_212 = ");" + NL + "\t\t";
  protected final String TEXT_213 = NL + "\t\t" + NL + "\t\tlong partSizeInBytes_";
  protected final String TEXT_214 = " = ";
  protected final String TEXT_215 = " * 1024 * 1024;" + NL + "\t\tlong maxBytes4SingleCopyCall_";
  protected final String TEXT_216 = " = 5 * 1024 * 1024 * 1024;//5GB" + NL + "\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_217 = " = null;" + NL + "\t\t";
  protected final String TEXT_218 = "\t" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_219 = " - No KMS - Normal SSE\");" + NL + "\t\t\t\t";
  protected final String TEXT_220 = NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_221 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_222 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t";
  protected final String TEXT_223 = NL + "\t\t" + NL + "\t\tfinal String from_bucket_";
  protected final String TEXT_224 = " = ";
  protected final String TEXT_225 = ";" + NL + "\t\tfinal String from_key_";
  protected final String TEXT_226 = " = ";
  protected final String TEXT_227 = ";" + NL + "\t\tfinal String to_bucket_";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = "; " + NL + "\t\tfinal String to_key_";
  protected final String TEXT_230 = " = ";
  protected final String TEXT_231 = ";" + NL + "\t\t" + NL + "\t\t//get the source metadata information" + NL + "\t\tcom.amazonaws.services.s3.model.GetObjectMetadataRequest metadataRequest_";
  protected final String TEXT_232 = " = new com.amazonaws.services.s3.model.GetObjectMetadataRequest(from_bucket_";
  protected final String TEXT_233 = ", from_key_";
  protected final String TEXT_234 = ");" + NL + "    com.amazonaws.services.s3.model.ObjectMetadata metadataResult_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".getObjectMetadata(metadataRequest_";
  protected final String TEXT_237 = ");" + NL + "    long objectSize_";
  protected final String TEXT_238 = " = metadataResult_";
  protected final String TEXT_239 = ".getContentLength();" + NL + "    " + NL + "    boolean multiUpload_";
  protected final String TEXT_240 = " = objectSize_";
  protected final String TEXT_241 = " > maxBytes4SingleCopyCall_";
  protected final String TEXT_242 = ";" + NL + "    " + NL + "    if(!multiUpload_";
  protected final String TEXT_243 = ") {" + NL + "    \t\tcom.amazonaws.services.s3.model.CopyObjectRequest putRequest_";
  protected final String TEXT_244 = " = new com.amazonaws.services.s3.model.CopyObjectRequest(from_bucket_";
  protected final String TEXT_245 = ", from_key_";
  protected final String TEXT_246 = ", to_bucket_";
  protected final String TEXT_247 = ", to_key_";
  protected final String TEXT_248 = ");" + NL + "    \t\tif(objectMetadata_";
  protected final String TEXT_249 = " != null) {" + NL + "    \t\t\t\tputRequest_";
  protected final String TEXT_250 = ".setNewObjectMetadata(objectMetadata_";
  protected final String TEXT_251 = ");" + NL + "    \t\t}" + NL + "    \t\t" + NL + "    \t\t";
  protected final String TEXT_252 = NL;
  protected final String TEXT_253 = NL + "\t";
  protected final String TEXT_254 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_255 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_256 = ");" + NL + "\t";
  protected final String TEXT_257 = NL + "\t";
  protected final String TEXT_258 = NL + "\t\t";
  protected final String TEXT_259 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_260 = " - No KMS key - use default\");" + NL + "\t\t";
  protected final String TEXT_261 = NL + "\t\tputRequest_";
  protected final String TEXT_262 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t";
  protected final String TEXT_263 = NL + "\t\t";
  protected final String TEXT_264 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_265 = " - Key found - use key\");" + NL + "\t\t";
  protected final String TEXT_266 = NL + "\t\tputRequest_";
  protected final String TEXT_267 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_268 = "));" + NL + "\t";
  protected final String TEXT_269 = NL + "    \t\t" + NL + "    \t\tconn_";
  protected final String TEXT_270 = ".copyObject(putRequest_";
  protected final String TEXT_271 = ");" + NL + "\t\t} else {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_272 = NL + "\t\t\t\t\t\tjava.util.Map<String,String> userMetadata_";
  protected final String TEXT_273 = " = metadataResult_";
  protected final String TEXT_274 = ".getUserMetadata();" + NL + "\t\t\t\t\t\tif((userMetadata_";
  protected final String TEXT_275 = "!=null) && userMetadata_";
  protected final String TEXT_276 = ".get(\"x-amz-iv\")!=null) {" + NL + "\t\t\t\t\t\t\t\tthrow new RuntimeException(\"the metadata key : \\\"x-amz-iv\\\" exists in the current object metadata, its value is important for client encrypt with KMS, which can't be copied as s3 service limit it\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "    \t\t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_";
  protected final String TEXT_277 = " = null;" + NL + "    \t\t\t\tif(objectMetadata_";
  protected final String TEXT_278 = " != null) {" + NL + "    \t\t\t\t\t\tputRequest_";
  protected final String TEXT_279 = " = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(to_bucket_";
  protected final String TEXT_280 = ", to_key_";
  protected final String TEXT_281 = ", objectMetadata_";
  protected final String TEXT_282 = ");" + NL + "    \t\t\t\t} else {" + NL + "    \t\t\t\t\t\t//even pass the source object metadata, some metadata will change too like \"x-amz-iv\"" + NL + "    \t\t\t\t\t\tputRequest_";
  protected final String TEXT_283 = " = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(to_bucket_";
  protected final String TEXT_284 = ", to_key_";
  protected final String TEXT_285 = ", metadataResult_";
  protected final String TEXT_286 = ");" + NL + "    \t\t\t\t}" + NL + "    \t\t\t\t" + NL + "    \t\t\t\t";
  protected final String TEXT_287 = NL;
  protected final String TEXT_288 = NL + "\t";
  protected final String TEXT_289 = "\t" + NL + "\t\tlog.info(\"";
  protected final String TEXT_290 = " - KMS-Enabled - kmsid=\"+";
  protected final String TEXT_291 = ");" + NL + "\t";
  protected final String TEXT_292 = NL + "\t";
  protected final String TEXT_293 = NL + "\t\t";
  protected final String TEXT_294 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_295 = " - No KMS key - use default\");" + NL + "\t\t";
  protected final String TEXT_296 = NL + "\t\tputRequest_";
  protected final String TEXT_297 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams ());" + NL + "\t";
  protected final String TEXT_298 = NL + "\t\t";
  protected final String TEXT_299 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_300 = " - Key found - use key\");" + NL + "\t\t";
  protected final String TEXT_301 = NL + "\t\tputRequest_";
  protected final String TEXT_302 = ".setSSEAwsKeyManagementParams(new com.amazonaws.services.s3.model.SSEAwsKeyManagementParams (";
  protected final String TEXT_303 = "));" + NL + "\t";
  protected final String TEXT_304 = NL + "    \t\t\t\t" + NL + "            com.amazonaws.services.s3.model.InitiateMultipartUploadResult initResult_";
  protected final String TEXT_305 = " = conn_";
  protected final String TEXT_306 = ".initiateMultipartUpload(putRequest_";
  protected final String TEXT_307 = ");" + NL + "            " + NL + "            long bytePosition_";
  protected final String TEXT_308 = " = 0;" + NL + "            int partNum_";
  protected final String TEXT_309 = " = 1;" + NL + "            " + NL + "            java.util.List<com.amazonaws.services.s3.model.PartETag> partTags_";
  protected final String TEXT_310 = " = new java.util.ArrayList<com.amazonaws.services.s3.model.PartETag>();" + NL + "            " + NL + "      \ttry {" + NL + "            while (bytePosition_";
  protected final String TEXT_311 = " < objectSize_";
  protected final String TEXT_312 = ") {" + NL + "                long lastByte_";
  protected final String TEXT_313 = " = java.lang.Math.min(bytePosition_";
  protected final String TEXT_314 = " + partSizeInBytes_";
  protected final String TEXT_315 = " - 1, objectSize_";
  protected final String TEXT_316 = " - 1);" + NL + "                " + NL + "                com.amazonaws.services.s3.model.CopyPartRequest copyPartRequest_";
  protected final String TEXT_317 = " = new com.amazonaws.services.s3.model.CopyPartRequest()" + NL + "                        .withSourceBucketName(from_bucket_";
  protected final String TEXT_318 = ")" + NL + "                        .withSourceKey(from_key_";
  protected final String TEXT_319 = ")" + NL + "                        .withDestinationBucketName(to_bucket_";
  protected final String TEXT_320 = ")" + NL + "                        .withDestinationKey(to_key_";
  protected final String TEXT_321 = ")" + NL + "                        .withUploadId(initResult_";
  protected final String TEXT_322 = ".getUploadId())" + NL + "                        .withFirstByte(bytePosition_";
  protected final String TEXT_323 = ")" + NL + "                        .withLastByte(lastByte_";
  protected final String TEXT_324 = ")" + NL + "                        .withPartNumber(partNum_";
  protected final String TEXT_325 = "++);" + NL + "                partTags_";
  protected final String TEXT_326 = ".add(conn_";
  protected final String TEXT_327 = ".copyPart(copyPartRequest_";
  protected final String TEXT_328 = ").getPartETag());" + NL + "                bytePosition_";
  protected final String TEXT_329 = " += partSizeInBytes_";
  protected final String TEXT_330 = ";" + NL + "            }" + NL + "    " + NL + "            com.amazonaws.services.s3.model.CompleteMultipartUploadRequest completeRequest_";
  protected final String TEXT_331 = " = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(" + NL + "                                                                       \tto_bucket_";
  protected final String TEXT_332 = "," + NL + "                                                                        to_key_";
  protected final String TEXT_333 = ", " + NL + "                                                                        initResult_";
  protected final String TEXT_334 = ".getUploadId()," + NL + "                                                                        partTags_";
  protected final String TEXT_335 = ");" + NL + "            conn_";
  protected final String TEXT_336 = ".completeMultipartUpload(completeRequest_";
  protected final String TEXT_337 = ");" + NL + "    \t\t} catch (java.lang.Exception uploadException_";
  protected final String TEXT_338 = ") {" + NL + "    \t\t\t\tconn_";
  protected final String TEXT_339 = ".abortMultipartUpload(new com.amazonaws.services.s3.model.AbortMultipartUploadRequest(to_bucket_";
  protected final String TEXT_340 = ", to_key_";
  protected final String TEXT_341 = ", initResult_";
  protected final String TEXT_342 = ".getUploadId()));" + NL + "    \t\t\t\tthrow uploadException_";
  protected final String TEXT_343 = ";" + NL + "    \t\t}" + NL + "    }" + NL + "    " + NL + "\t\t";
  protected final String TEXT_344 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_345 = " - Copied the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_346 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_347 = "){" + NL + "\t\t";
  protected final String TEXT_348 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_349 = ");" + NL + "\t\t";
  protected final String TEXT_350 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_351 = " - \" + e_";
  protected final String TEXT_352 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_353 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_354 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_355 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_356 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_357 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
