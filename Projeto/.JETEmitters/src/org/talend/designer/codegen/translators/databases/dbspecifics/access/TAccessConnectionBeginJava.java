...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_34 = " + \";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true\";";
  ...
  protected final String TEXT_40 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_41 = " = ";
  protected final String TEXT_42 = ";" + NL + "\t\t\tif (dbUser_";
  protected final String TEXT_43 = " == null) {" + NL + "\t\t\t\tdbUser_";
  protected final String TEXT_44 = " = \"\";" + NL + "\t\t\t}" + NL + "\t\t\tif (dbPwd_";
  protected final String TEXT_45 = " == null) {" + NL + "\t\t\t\tdbPwd_";
  protected final String TEXT_46 = " = \"\";" + NL + "\t\t\t}" + NL + "\t\t\tatnParams_";
  ...
  protected final String TEXT_50 = ".put(\"user\",dbUser_";
  protected final String TEXT_51 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_52 = ".put(\"password\",dbPwd_";
  ...
  protected final String TEXT_55 = ".getBytes()));" + NL + "\t\t\tconn_";
  ...
  protected final String TEXT_60 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_73 = NL + "\t\t\tString dbPwd_";
  ...
  protected final String TEXT_79 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_84 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_85 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_90 = " - Written records count: \" + nb_line_";
  protected final String TEXT_91 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_93 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_95 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_96 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_97 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_98 = " - Writing the record \" + nb_line_";
  protected final String TEXT_99 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_101 = " - Processing the record \" + nb_line_";
  protected final String TEXT_102 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_103 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_104 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_105 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_106 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_107 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_108 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_109 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_110 = " - Uses an existing connection ";
  protected final String TEXT_111 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_113 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_114 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_116 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_117 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_118 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_129 = ".rollback();" + NL + "\t\t\t";
  ...
  protected final String TEXT_135 = ".setAutoCommit(";
  protected final String TEXT_136 = ");" + NL + "\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\t\tlog.";
  protected final String TEXT_138 = "(\"";
  protected final String TEXT_139 = " - \" + ";
  protected final String TEXT_140 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_141 = NL + "\t    \t\tlog.";
  protected final String TEXT_142 = "(\"";
  protected final String TEXT_143 = "\");" + NL + "\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_145 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_147 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_148 = ": pstmt_";
  protected final String TEXT_149 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_150 = " += (countEach_";
  protected final String TEXT_151 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_155 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_156 = " == null) {";
  protected final String TEXT_157 = NL + "\t\t";
  protected final String TEXT_158 = NL + "\t\t";
  protected final String TEXT_159 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_160 = "\", conn_";
  protected final String TEXT_161 = ");";
  protected final String TEXT_162 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_165 = ".get(dsAlias_";
  protected final String TEXT_166 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_167 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_168 = " = dataSources_";
  protected final String TEXT_169 = ".get(dsAlias_";
  protected final String TEXT_170 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_171 = "\", conn_";
  protected final String TEXT_172 = ");" + NL + "\t}";
  protected final String TEXT_173 = NL + "\tif (null != conn_";
