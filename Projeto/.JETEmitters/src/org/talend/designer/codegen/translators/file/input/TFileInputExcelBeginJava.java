...
public class TFileInputExcelBeginJava
{
  ...
  protected final String TEXT_884 = " = new com.talend.excel.xssf.event.ExcelReader();" + NL + "\t\t\texcelReader_";
  protected final String TEXT_885 = ".setIncludePhoneticRuns(";
  protected final String TEXT_886 = ");" + NL + "\t\t}else{" + NL + "\t\t\tthrow new java.lang.Exception(\"The data source should be specified as Inputstream or File Path!\");" + NL + "\t\t}" + NL + "" + NL + "\t\ttry {";
  protected final String TEXT_887 = NL + "\t\texcelReader_";
  protected final String TEXT_888 = ".addSheetName(\".*\",true);";
  protected final String TEXT_889 = NL + "\t\texcelReader_";
  protected final String TEXT_890 = ".addSheetName(";
  protected final String TEXT_891 = ", ";
  protected final String TEXT_892 = ");";
  protected final String TEXT_893 = NL + "\t\tint start_column_";
  protected final String TEXT_894 = " = ";
  protected final String TEXT_895 = "0";
  protected final String TEXT_896 = "-1";
  protected final String TEXT_897 = ";" + NL + "\t\tint end_column_";
  protected final String TEXT_898 = " = ";
  protected final String TEXT_899 = "-1";
  protected final String TEXT_900 = "-1";
  protected final String TEXT_901 = ";" + NL + "\t\tif(start_column_";
  protected final String TEXT_902 = " >=0) {//follow start column" + NL + "\t\t\t";
  protected final String TEXT_903 = NL + "\t\t\t\t\tend_column_";
  protected final String TEXT_904 = " = 16384;" + NL + "\t\t\t\t";
  protected final String TEXT_905 = NL + "\t\t\t\t\tend_column_";
  protected final String TEXT_906 = " = ";
  protected final String TEXT_907 = "-1;" + NL + "\t\t\t\t";
  protected final String TEXT_908 = NL + "\t\t\t\tend_column_";
  protected final String TEXT_909 = " = start_column_";
  protected final String TEXT_910 = " + ";
  protected final String TEXT_911 = " - 1;" + NL + "\t\t\t";
  protected final String TEXT_912 = NL + "\t\t} else if(end_column_";
  protected final String TEXT_913 = " >= 0) {//follow end column" + NL + "\t\t\tstart_column_";
  protected final String TEXT_914 = " = end_column_";
  protected final String TEXT_915 = " - ";
  protected final String TEXT_916 = " + 1;" + NL + "\t\t}" + NL + "" + NL + "\t\tif(end_column_";
  protected final String TEXT_917 = "<0 || start_column_";
  protected final String TEXT_918 = "<0) {" + NL + "\t\t\tthrow new RuntimeException(\"Error start column and end column.\");" + NL + "\t\t}" + NL + "\t\tint actual_end_column_";
  protected final String TEXT_919 = " = end_column_";
  protected final String TEXT_920 = " ;" + NL + "" + NL + "\t\tint header_";
  protected final String TEXT_921 = " = ";
  protected final String TEXT_922 = "0";
  protected final String TEXT_923 = ";" + NL + "\t\tint limit_";
  protected final String TEXT_924 = " = ";
  protected final String TEXT_925 = "-1";
  protected final String TEXT_926 = ";" + NL + "" + NL + "\t\tint nb_line_";
  protected final String TEXT_927 = " = 0;" + NL + "" + NL + "\t\t//for the number format" + NL + "        java.text.DecimalFormat df_";
  protected final String TEXT_928 = " = new java.text.DecimalFormat(\"#.####################################\");" + NL + "        char decimalChar_";
  protected final String TEXT_929 = " = df_";
  protected final String TEXT_930 = ".getDecimalFormatSymbols().getDecimalSeparator();" + NL + "" + NL + "\t\tif(source_";
  protected final String TEXT_931 = " instanceof String){" + NL + "\t\t\texcelReader_";
  protected final String TEXT_932 = ".parse((String)source_";
  protected final String TEXT_933 = ",";
  protected final String TEXT_934 = ");" + NL + "\t\t} else if(source_";
  protected final String TEXT_935 = " instanceof java.io.InputStream) {" + NL + "\t\t\texcelReader_";
  protected final String TEXT_936 = ".parse((java.io.InputStream)source_";
  protected final String TEXT_937 = ",";
  protected final String TEXT_938 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_939 = NL + "\t\t\tif(header_";
  protected final String TEXT_940 = " > 0){" + NL + "\t\t\t\theader_";
  protected final String TEXT_941 = " = header_";
  protected final String TEXT_942 = " - 1;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_943 = NL + NL + NL + "\t\twhile((header_";
  protected final String TEXT_944 = "--)>0 && excelReader_";
  protected final String TEXT_945 = ".hasNext()) {//skip the header" + NL + "\t\t\texcelReader_";
  protected final String TEXT_946 = ".next();" + NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_947 = NL + "\t\twhile(excelReader_";
  protected final String TEXT_948 = ".hasNext()) {" + NL + "\t\t\tint emptyColumnCount_";
  protected final String TEXT_949 = " = 0;" + NL + "" + NL + "\t\t\tif (limit_";
  protected final String TEXT_950 = " != -1 && nb_line_";
  protected final String TEXT_951 = " >= limit_";
  protected final String TEXT_952 = ") {" + NL + "\t\t\t\texcelReader_";
  protected final String TEXT_953 = ".stopRead();" + NL + "        \t\tbreak;" + NL + "        \t}" + NL + "" + NL + "        \tjava.util.List<String> row_";
  protected final String TEXT_954 = " = excelReader_";
  protected final String TEXT_955 = ".next();";
  protected final String TEXT_956 = NL + "\t\t";
  protected final String TEXT_957 = " = null;";
  protected final String TEXT_958 = NL + "\t\t\t\t\t" + NL + "\t\tString[] temp_row_";
  protected final String TEXT_959 = " = new String[tempRowLength_";
  protected final String TEXT_960 = "];" + NL + "\t\t";
  protected final String TEXT_961 = NL + "\t\t\tactual_end_column_";
  protected final String TEXT_962 = " = end_column_";
  protected final String TEXT_963 = "+dynamic_";
  protected final String TEXT_964 = ".getColumnCount()-1;" + NL + "\t\t";
  protected final String TEXT_965 = NL + "\t\tfor(int i_";
  protected final String TEXT_966 = "=0;i_";
  protected final String TEXT_967 = " < tempRowLength_";
  protected final String TEXT_968 = ";i_";
  protected final String TEXT_969 = "++){" + NL + "\t\t\tint current_";
  protected final String TEXT_970 = " = i_";
  protected final String TEXT_971 = " + start_column_";
  protected final String TEXT_972 = ";" + NL + "\t\t\tif(current_";
  protected final String TEXT_973 = " <= actual_end_column_";
  protected final String TEXT_974 = "){" + NL + "\t\t\t\tif(current_";
  protected final String TEXT_975 = " < row_";
  protected final String TEXT_976 = ".size()){" + NL + "\t\t\t\t\tString column_";
  protected final String TEXT_977 = " = row_";
  protected final String TEXT_978 = ".get(current_";
  protected final String TEXT_979 = ");" + NL + "\t\t\t\t\tif(column_";
  protected final String TEXT_980 = "!=null) {" + NL + "\t\t\t\t\t\ttemp_row_";
  protected final String TEXT_981 = "[i_";
  protected final String TEXT_982 = "] = column_";
  protected final String TEXT_983 = ";" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\ttemp_row_";
  ...
  protected final String TEXT_987 = "]=\"\";" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\ttemp_row_";
  protected final String TEXT_988 = "[i_";
  protected final String TEXT_989 = "]=\"\";" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\tboolean whetherReject_";
  protected final String TEXT_990 = " = false;" + NL + "\t\t";
  protected final String TEXT_991 = " = new ";
  protected final String TEXT_992 = "Struct();" + NL + "\t\tint curColNum_";
  protected final String TEXT_993 = " = -1;" + NL + "\t\tString curColName_";
  protected final String TEXT_994 = " = \"\";" + NL + "" + NL + "\t\ttry{";
  protected final String TEXT_995 = NL + "\t\t\t\t\t\t\tcolumnIndex_";
  protected final String TEXT_996 = " = ";
  protected final String TEXT_997 = "+dynamic_column_count_";
  protected final String TEXT_998 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_999 = NL + "\t\t\t\t\t\t\tcolumnIndex_";
  protected final String TEXT_1000 = " = ";
  protected final String TEXT_1001 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1002 = NL + "\t\t\tif( temp_row_";
  protected final String TEXT_1003 = "[columnIndex_";
  protected final String TEXT_1004 = "]";
  protected final String TEXT_1005 = ".length() > 0) {";
  protected final String TEXT_1006 = NL + "\t\t\t\tcurColNum_";
  protected final String TEXT_1007 = "=columnIndex_";
  protected final String TEXT_1008 = " + start_column_";
  protected final String TEXT_1009 = " + 1;" + NL + "\t\t\t\tcurColName_";
  protected final String TEXT_1010 = " = \"";
  protected final String TEXT_1011 = "\";" + NL;
  protected final String TEXT_1012 = NL + "\t\t\t\t";
  protected final String TEXT_1013 = ".";
  protected final String TEXT_1014 = " = temp_row_";
  protected final String TEXT_1015 = "[columnIndex_";
  protected final String TEXT_1016 = "]";
  protected final String TEXT_1017 = ";";
  protected final String TEXT_1018 = NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_1019 = ".";
  protected final String TEXT_1020 = " = ParserUtils.parseTo_Date(temp_row_";
  protected final String TEXT_1021 = "[columnIndex_";
  protected final String TEXT_1022 = "]";
  protected final String TEXT_1023 = ", ";
  protected final String TEXT_1024 = ");" + NL + "\t\t\t\t}catch(java.lang.Exception e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_1025 = NL + "\t\t\t\t\tthrow new RuntimeException(\"The cell format is not Date in ( Row. \"+(nb_line_";
  protected final String TEXT_1026 = "+1)+ \" and ColumnNum. \" + curColNum_";
  protected final String TEXT_1027 = " + \" )\");" + NL + "\t\t\t\t}" + NL;
  protected final String TEXT_1028 = NL + "\t\t\t\t";
  protected final String TEXT_1029 = ".";
  protected final String TEXT_1030 = " = ParserUtils.parseTo_";
  protected final String TEXT_1031 = "(ParserUtils.parseTo_Number(temp_row_";
  protected final String TEXT_1032 = "[columnIndex_";
  ...
  protected final String TEXT_1039 = " = ParserUtils.parseTo_";
  protected final String TEXT_1040 = "(ParserUtils.parseTo_Number(temp_row_";
  protected final String TEXT_1041 = "[columnIndex_";
  protected final String TEXT_1042 = "]";
  protected final String TEXT_1043 = ", null, '.'==decimalChar_";
  protected final String TEXT_1044 = " ? null : decimalChar_";
  protected final String TEXT_1045 = "));";
  protected final String TEXT_1046 = NL + "\t\t\t\t";
  protected final String TEXT_1047 = ".";
  protected final String TEXT_1048 = " = temp_row_";
  protected final String TEXT_1049 = "[columnIndex_";
  protected final String TEXT_1050 = "]";
  protected final String TEXT_1051 = ".getBytes(";
  protected final String TEXT_1052 = ");";
  protected final String TEXT_1053 = NL + "\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_1054 = ".clearColumnValues();" + NL + "\t\t\t\t\t\t\tint fieldCount_";
  protected final String TEXT_1055 = " = row_";
  protected final String TEXT_1056 = ".size();" + NL + "\t\t\t\t\t\t\tdynamic_column_count_";
  protected final String TEXT_1057 = " = dynamic_";
  protected final String TEXT_1058 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\tfor (int i = 0; i < dynamic_column_count_";
  protected final String TEXT_1059 = " ; i++) {" + NL + "\t\t\t\t\t\t\t\tif ((";
  protected final String TEXT_1060 = "+i) < fieldCount_";
  protected final String TEXT_1061 = "){" + NL + "\t\t\t\t\t\t\t\t\tif(temp_row_";
  protected final String TEXT_1062 = "[";
  protected final String TEXT_1063 = "+i]";
  protected final String TEXT_1064 = ".length() < 1){" + NL + "\t\t\t\t\t\t\t\t\t\temptyColumnCount_";
  protected final String TEXT_1065 = "++;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_1066 = ".addColumnValue(temp_row_";
  protected final String TEXT_1067 = "[";
  protected final String TEXT_1068 = "+i]";
  protected final String TEXT_1069 = ");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_1070 = ".addColumnValue(\"\");" + NL + "\t\t\t\t\t\t\t\t\temptyColumnCount_";
  protected final String TEXT_1071 = "++;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1072 = ".";
  protected final String TEXT_1073 = " =dynamic_";
  protected final String TEXT_1074 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1075 = NL + "\t\t\t\t";
  protected final String TEXT_1076 = ".";
  protected final String TEXT_1077 = " = ParserUtils.parseTo_";
  protected final String TEXT_1078 = "(temp_row_";
  protected final String TEXT_1079 = "[columnIndex_";
  protected final String TEXT_1080 = "]";
  protected final String TEXT_1081 = ");";
  protected final String TEXT_1082 = NL + "\t\t\t}else{";
  protected final String TEXT_1083 = NL + "\t\t\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_1084 = "' in '";
  protected final String TEXT_1085 = "' connection, value is invalid or this column should be nullable or have a default value.\");";
  protected final String TEXT_1086 = NL + "\t\t\t\t";
  protected final String TEXT_1087 = ".";
  protected final String TEXT_1088 = " = ";
  protected final String TEXT_1089 = ";" + NL + "\t\t\t\temptyColumnCount_";
  ...
  protected final String TEXT_1096 = NL + "\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\twhetherReject_";
  protected final String TEXT_1097 = " = true;";
  protected final String TEXT_1098 = NL + "\t            throw(e);";
  protected final String TEXT_1099 = NL + "\t\t\t\t\t";
  protected final String TEXT_1100 = " = new ";
  protected final String TEXT_1101 = "Struct();";
  ...
  protected final String TEXT_1109 = "+ \" column: \" + curColName_";
  protected final String TEXT_1110 = " + \" (No. \" + curColNum_";
  protected final String TEXT_1111 = " + \")\";" + NL + "\t\t\t\t\t";
  protected final String TEXT_1112 = " = null;";
  protected final String TEXT_1113 = NL + "\t\t\t\t\t System.err.println(e.getMessage());" + NL + "\t\t\t\t\t ";
