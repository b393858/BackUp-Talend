...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_570 = NL + "        stmt_";
  protected final String TEXT_571 = " = conn_";
  protected final String TEXT_572 = ".createStatement();" + NL + "        stmt_";
  protected final String TEXT_573 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_574 = " +\" ON\");";
  protected final String TEXT_575 = NL + "        }";
  protected final String TEXT_576 = NL + "                commitEvery_";
  protected final String TEXT_577 = " = buffersSize_";
  protected final String TEXT_578 = ";";
  protected final String TEXT_579 = NL + "                batchSize_";
  protected final String TEXT_580 = " = buffersSize_";
  protected final String TEXT_581 = ";";
  protected final String TEXT_582 = NL + "        whetherReject_";
  protected final String TEXT_583 = " = false;";
  ...
  protected final String TEXT_603 = NL + "                pstmt_";
  protected final String TEXT_604 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_605 = "++;";
  protected final String TEXT_606 = NL + "              batchSizeCounter_";
  protected final String TEXT_607 = "++;";
  protected final String TEXT_608 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_609 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_610 = " = insertedCount_";
  protected final String TEXT_611 = " + pstmt_";
  protected final String TEXT_612 = ".executeUpdate();";
  protected final String TEXT_613 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_628 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_629 = NL + "                        ";
  protected final String TEXT_630 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_631 = ";";
  protected final String TEXT_632 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_638 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_639 = ",";
  protected final String TEXT_640 = ".";
  protected final String TEXT_641 = ", ";
  protected final String TEXT_642 = ",updateSQLSplits_";
  protected final String TEXT_643 = ");";
  protected final String TEXT_644 = NL + "                    int count_";
  protected final String TEXT_645 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_669 = NL + "            pstmt_";
  protected final String TEXT_670 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_671 = "++;";
  protected final String TEXT_672 = NL + "              batchSizeCounter_";
  protected final String TEXT_673 = "++;";
  protected final String TEXT_674 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_675 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_676 = " = updatedCount_";
  protected final String TEXT_677 = " + pstmt_";
  protected final String TEXT_678 = ".executeUpdate();";
  protected final String TEXT_679 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_680 = " = true;";
  protected final String TEXT_681 = NL + "                    throw(e);";
  ...
  protected final String TEXT_694 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_695 = NL + "                        ";
  protected final String TEXT_696 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_697 = ";";
  protected final String TEXT_698 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_699 = NL + "            }";
  protected final String TEXT_700 = NL + "                        ";
  protected final String TEXT_701 = NL + "                    ";
  protected final String TEXT_702 = NL + "            int checkCount_";
  protected final String TEXT_703 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_704 = " = pstmt_";
  protected final String TEXT_705 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_706 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_707 = " = rs_";
  protected final String TEXT_708 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_718 = ",updateSQLSplits_";
  protected final String TEXT_719 = ");";
  protected final String TEXT_720 = NL + NL + "                        int count_";
  protected final String TEXT_721 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_742 = NL + "                    globalMap.put(\"";
  protected final String TEXT_743 = "_QUERY\", query_";
  protected final String TEXT_744 = ".toString().trim());";
  protected final String TEXT_745 = NL + "                try {" + NL + "                    updatedCount_";
  ...
  protected final String TEXT_750 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_751 = " = true;";
  protected final String TEXT_752 = NL + "                        throw(e);";
  protected final String TEXT_753 = NL + "                        nb_line_";
  protected final String TEXT_754 = "++;";
  protected final String TEXT_755 = NL + "                            ";
  protected final String TEXT_756 = " = new ";
  protected final String TEXT_757 = "Struct();";
  protected final String TEXT_758 = NL + "                                ";
  protected final String TEXT_759 = ".";
  protected final String TEXT_760 = " = ";
  protected final String TEXT_761 = ".";
  protected final String TEXT_762 = ";";
  protected final String TEXT_763 = NL + "                            rejectedCount_";
  protected final String TEXT_764 = " = rejectedCount_";
  protected final String TEXT_765 = " + 1;";
  protected final String TEXT_766 = NL + "                            ";
  protected final String TEXT_767 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_768 = NL + "                            ";
  protected final String TEXT_769 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_770 = ";";
  protected final String TEXT_771 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_772 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_773 = NL + "                        ";
  protected final String TEXT_774 = NL + "                            query_";
  protected final String TEXT_775 = " = ";
  protected final String TEXT_776 = ";";
  protected final String TEXT_777 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_778 = ",";
  protected final String TEXT_779 = ".";
  protected final String TEXT_780 = ", ";
  protected final String TEXT_781 = ",insertSQLSplits_";
  ...
  protected final String TEXT_857 = NL + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_863 = " == 0) {";
  protected final String TEXT_864 = NL + "                query_";
  protected final String TEXT_865 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_923 = NL + "                globalMap.put(\"";
  protected final String TEXT_924 = "_QUERY\", query_";
  protected final String TEXT_925 = ".toString().trim());";
  protected final String TEXT_926 = NL + "                    pstmt_";
  protected final String TEXT_927 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_928 = "++;";
  protected final String TEXT_929 = NL + "                    batchSizeCounter_";
  protected final String TEXT_930 = "++;";
  protected final String TEXT_931 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_932 = " = deletedCount_";
  protected final String TEXT_933 = " + pstmt_";
  protected final String TEXT_934 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_935 = "++;";
  protected final String TEXT_936 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_937 = " = true;";
  protected final String TEXT_938 = NL + "                    throw(e);";
  protected final String TEXT_939 = NL + "                    nb_line_";
  protected final String TEXT_940 = "++;";
  protected final String TEXT_941 = NL + "                        ";
  protected final String TEXT_942 = " = new ";
  protected final String TEXT_943 = "Struct();";
  protected final String TEXT_944 = NL + "                            ";
  protected final String TEXT_945 = ".";
  protected final String TEXT_946 = " = ";
  protected final String TEXT_947 = ".";
  protected final String TEXT_948 = ";";
  protected final String TEXT_949 = NL + "                        rejectedCount_";
  protected final String TEXT_950 = " = rejectedCount_";
  protected final String TEXT_951 = " + 1;";
  protected final String TEXT_952 = NL + "                        ";
  protected final String TEXT_953 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_959 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_970 = NL + "                if ((batchSize_";
  protected final String TEXT_971 = " > 0) && (batchSize_";
  protected final String TEXT_972 = " <= batchSizeCounter_";
  protected final String TEXT_973 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_974 = " = 0;" + NL + "                        int countSum_";
  protected final String TEXT_975 = " = 0;";
  protected final String TEXT_976 = NL + "                        for(int countEach_";
  protected final String TEXT_977 = ": pstmt_";
  protected final String TEXT_978 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_982 = NL + "                            insertedCount_";
  protected final String TEXT_983 = " += countSum_";
  protected final String TEXT_984 = ";";
  protected final String TEXT_985 = NL + "                            updatedCount_";
  protected final String TEXT_986 = " += countSum_";
  protected final String TEXT_987 = ";";
  protected final String TEXT_988 = NL + "                            deletedCount_";
  protected final String TEXT_989 = " += countSum_";
  protected final String TEXT_990 = ";";
  protected final String TEXT_991 = NL + "                batchSizeCounter_";
  protected final String TEXT_992 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_993 = NL + "                        throw(e);";
  protected final String TEXT_994 = NL + "                    int countSum_";
  protected final String TEXT_995 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_996 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_997 = " += (countEach_";
  protected final String TEXT_998 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1009 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1010 = NL + "                }" + NL + "                }";
  protected final String TEXT_1011 = NL + "                commitCounter_";
  protected final String TEXT_1012 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1013 = " <= commitCounter_";
  protected final String TEXT_1014 = ") {";
  protected final String TEXT_1015 = NL + "                try {" + NL + "                        if ( batchSizeCounter_";
  protected final String TEXT_1016 = " > 0 ) {" + NL + "                        int countSum_";
  protected final String TEXT_1017 = " = 0;";
  protected final String TEXT_1018 = NL + "                        for(int countEach_";
  protected final String TEXT_1019 = ": pstmt_";
  protected final String TEXT_1020 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1021 = " += (countEach_";
  protected final String TEXT_1022 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1023 = ");" + NL + "                        }";
  protected final String TEXT_1024 = NL + "                            insertedCount_";
  protected final String TEXT_1025 = " += countSum_";
  protected final String TEXT_1026 = ";";
  protected final String TEXT_1027 = NL + "                            updatedCount_";
  protected final String TEXT_1028 = " += countSum_";
  protected final String TEXT_1029 = ";";
  protected final String TEXT_1030 = NL + "                            deletedCount_";
  protected final String TEXT_1031 = " += countSum_";
  protected final String TEXT_1032 = ";";
  protected final String TEXT_1033 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1034 = " = 0;" + NL + "                        }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1035 = NL + "                        throw(e);";
  protected final String TEXT_1036 = NL + "                        int countSum_";
  protected final String TEXT_1037 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_1038 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_1039 = " += (countEach_";
  protected final String TEXT_1040 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1041 = ");" + NL + "                        }";
  protected final String TEXT_1042 = NL + "                            insertedCount_";
  protected final String TEXT_1043 = " += countSum_";
  protected final String TEXT_1044 = ";";
  protected final String TEXT_1045 = NL + "                            updatedCount_";
  protected final String TEXT_1046 = " += countSum_";
  protected final String TEXT_1047 = ";";
  protected final String TEXT_1048 = NL + "                            deletedCount_";
  protected final String TEXT_1049 = " += countSum_";
  protected final String TEXT_1050 = ";";
  protected final String TEXT_1051 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1052 = NL + "                }";
  protected final String TEXT_1053 = NL + "                    conn_";
  protected final String TEXT_1054 = ".commit();";
  protected final String TEXT_1055 = NL + "                    commitCounter_";
  protected final String TEXT_1056 = "=0;" + NL + "                }";
