...
public class TSqoopImportAllTablesBeginJava
{
  ...
  protected final String TEXT_269 = "); // __USERNAME__" + NL + "\tif((";
  protected final String TEXT_270 = " != null) && !\"\".equals(";
  protected final String TEXT_271 = ")) {" + NL + "    \tcom.cloudera.sqoop.metastore.JobData jobData_";
  protected final String TEXT_272 = " = new com.cloudera.sqoop.metastore.JobData(sqoopOptions_";
  protected final String TEXT_273 = ", null);" + NL + "    \torg.apache.sqoop.manager.DefaultManagerFactory defaultManagerFactory_";
  protected final String TEXT_274 = " = new org.apache.sqoop.manager.DefaultManagerFactory();" + NL + "    \tif(null == defaultManagerFactory_";
  protected final String TEXT_275 = ".accept(jobData_";
  protected final String TEXT_276 = ")) {" + NL + "    \t\tsqoopOptions_";
  protected final String TEXT_277 = ".setDriverClassName(";
  protected final String TEXT_278 = ");//driver class name" + NL + "    \t}" + NL + "    }" + NL + "\t";
  ...
  protected final String TEXT_287 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_288 = ".setPassword(decryptedPassword_";
  protected final String TEXT_289 = "); // __PASSWORD__" + NL + "\t";
  protected final String TEXT_290 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_291 = ".setPasswordFilePath(";
  protected final String TEXT_292 = ");" + NL + "\t\tsqoopOptions_";
  protected final String TEXT_293 = ".setPassword(org.apache.sqoop.util.CredentialsUtil.fetchPassword";
  protected final String TEXT_294 = "(sqoopOptions_";
  protected final String TEXT_295 = "));" + NL + "\t";
  protected final String TEXT_296 = NL + NL + "\t";
  protected final String TEXT_297 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_298 = ".setDirectMode(true);" + NL + "\t\t";
  protected final String TEXT_299 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_300 = ".setDirectSplitSize(Long.parseLong(";
  protected final String TEXT_301 = "));" + NL + "\t\t";
  protected final String TEXT_302 = NL + "\t";
  protected final String TEXT_303 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_304 = ".setUseCompression(true);" + NL + "\t\t";
  protected final String TEXT_305 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_306 = ".setCompressionCodec(";
  protected final String TEXT_307 = ");" + NL + "\t\t";
  protected final String TEXT_308 = NL + "\t";
  protected final String TEXT_309 = "sqoopOptions_";
  protected final String TEXT_310 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.SequenceFile);";
  protected final String TEXT_311 = "sqoopOptions_";
  protected final String TEXT_312 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.TextFile);";
  protected final String TEXT_313 = "sqoopOptions_";
  protected final String TEXT_314 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.ParquetFile);";
  protected final String TEXT_315 = "sqoopOptions_";
  protected final String TEXT_316 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.AvroDataFile);";
  protected final String TEXT_317 = NL + NL + "\t";
  protected final String TEXT_318 = "sqoopOptions_";
  protected final String TEXT_319 = ".setNumMappers(Integer.valueOf(";
  protected final String TEXT_320 = "));";
  protected final String TEXT_321 = NL + "\t" + NL + "\tjava.util.Properties additionalProperties_";
  protected final String TEXT_322 = " = new java.util.Properties();" + NL + "\t";
  protected final String TEXT_323 = NL + "\t\tadditionalProperties_";
  protected final String TEXT_324 = ".put(\"customtool.options.jsonmap\", \"{\\\"\\\":\\\"\\\"}\");" + NL + "\t";
  protected final String TEXT_325 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_326 = ".put(";
  protected final String TEXT_327 = ", \"\"+";
  protected final String TEXT_328 = ".codePointAt(0)); ";
  protected final String TEXT_329 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_330 = ".put(";
  protected final String TEXT_331 = ", ";
  protected final String TEXT_332 = "); ";
  protected final String TEXT_333 = NL + "\t\t\t\tStringBuilder sb_exclude_";
  protected final String TEXT_334 = " = new StringBuilder();";
  protected final String TEXT_335 = NL + "\t\t\t\t\t\tsb_exclude_";
  protected final String TEXT_336 = ".append(";
  protected final String TEXT_337 = ");";
  protected final String TEXT_338 = NL + "\t\t\t\t\t\tsb_exclude_";
  protected final String TEXT_339 = ".append(\",\" + ";
  protected final String TEXT_340 = ");";
  protected final String TEXT_341 = NL + "\t\t\t\tsqoopOptions_";
  protected final String TEXT_342 = ".setAllTablesExclude(sb_exclude_";
  protected final String TEXT_343 = ".toString());";
  protected final String TEXT_344 = NL + "\t\t\tStringBuilder sb_hive_";
  protected final String TEXT_345 = " = new StringBuilder();" + NL + "\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\tsb_hive_";
  protected final String TEXT_347 = ".append(";
  protected final String TEXT_348 = " + \"=\" + ";
  protected final String TEXT_349 = ");" + NL + "\t";
  protected final String TEXT_350 = NL + "\t\t\t\t\tsb_hive_";
  protected final String TEXT_351 = ".append(\",\" + ";
  protected final String TEXT_352 = " + \"=\" + ";
  protected final String TEXT_353 = ");" + NL + "\t";
  protected final String TEXT_354 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_355 = ".setMapColumnHive(sb_hive_";
  protected final String TEXT_356 = ".toString());" + NL + "\t";
  protected final String TEXT_357 = NL + "\t" + NL + "\tsqoopOptions_";
  protected final String TEXT_358 = ".loadProperties(additionalProperties_";
  protected final String TEXT_359 = ");" + NL + "" + NL + "\torg.apache.sqoop.Sqoop sqoop_";
  protected final String TEXT_360 = " = new org.apache.sqoop.Sqoop(sqoopTool_";
  protected final String TEXT_361 = ", configuration_";
  protected final String TEXT_362 = ", sqoopOptions_";
  protected final String TEXT_363 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_364 = NL + "\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_365 = " = new routines.system.GetJarsToRegister();" + NL + "\t\tjava.lang.StringBuilder sb_";
  protected final String TEXT_366 = " = new java.lang.StringBuilder();";
  protected final String TEXT_367 = NL + "\t\t\t\t\tsb_";
  protected final String TEXT_368 = ".append(getJarsToRegister_";
  protected final String TEXT_369 = ".replaceJarPaths(\"";
  protected final String TEXT_370 = "\", \"file:///\") + \",\");";
  protected final String TEXT_371 = NL + "\t";
  protected final String TEXT_372 = NL + "\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_373 = " = new routines.system.GetJarsToRegister();" + NL + "\t\tjava.lang.StringBuilder sb_";
  protected final String TEXT_374 = " = new java.lang.StringBuilder();";
  protected final String TEXT_375 = NL + "\t\t\t\t\tsb_";
  protected final String TEXT_376 = ".append(getJarsToRegister_";
  protected final String TEXT_377 = ".replaceJarPaths(\"";
  protected final String TEXT_378 = "\", \"file:///\") + \",\");";
  protected final String TEXT_379 = NL + "\ttry {";
  protected final String TEXT_380 = NL + "\t\t\tint result_";
  protected final String TEXT_381 = " = org.apache.sqoop.Sqoop.runSqoop(sqoop_";
  protected final String TEXT_382 = ", new String[] {\"-libjars\", sb_";
  protected final String TEXT_383 = ".toString()});";
  protected final String TEXT_384 = NL + "\t\t\tint result_";
  protected final String TEXT_385 = " = org.apache.sqoop.Sqoop.runSqoop(sqoop_";
  protected final String TEXT_386 = ", new String[] {});";
  protected final String TEXT_387 = NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_388 = "_EXIT_CODE\", result_";
  protected final String TEXT_389 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_390 = " != 0) {";
  protected final String TEXT_391 = NL + "\t\t\t\tthrow new Exception(\"The Sqoop import job has failed. Please check the logs.\");";
  protected final String TEXT_392 = NL + "\t\t\t\tSystem.err.println(\"The Sqoop import job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_393 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_394 = " - The Sqoop import job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_395 = NL + "\t\t}" + NL + "\t} catch (Exception e) {";
  protected final String TEXT_396 = NL + "\t\t\tthrow e;";
  protected final String TEXT_397 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  ...
  protected final String TEXT_401 = NL + "String currentClientPathSeparator_";
  protected final String TEXT_402 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_403 = "!=null) {" + NL + "\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_404 = ");" + NL + "\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_405 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_406 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_407 = "!=null) {" + NL + "\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_408 = ");" + NL + "\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_409 = "\", null);" + NL + "} else {" + NL + "\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
