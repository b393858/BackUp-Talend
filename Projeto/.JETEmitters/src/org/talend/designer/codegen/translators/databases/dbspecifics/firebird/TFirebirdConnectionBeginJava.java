...
public class TFirebirdConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_40 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_93 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_94 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_96 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_97 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  ...
  protected final String TEXT_125 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_127 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_128 = ": pstmt_";
  protected final String TEXT_129 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_130 = " += (countEach_";
  protected final String TEXT_131 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_135 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  ...
  protected final String TEXT_142 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_145 = ".get(dsAlias_";
  protected final String TEXT_146 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  ...
  protected final String TEXT_150 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_151 = "\", conn_";
  protected final String TEXT_152 = ");" + NL + "\t}";
  protected final String TEXT_153 = NL + "\tif (null != conn_";
