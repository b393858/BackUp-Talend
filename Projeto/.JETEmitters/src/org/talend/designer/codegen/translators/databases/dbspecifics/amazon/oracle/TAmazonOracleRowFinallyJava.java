...
public class TAmazonOracleRowFinallyJava
{
  protected static String nl;
  public static synchronized TAmazonOracleRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonOracleRowFinallyJava result = new TAmazonOracleRowFinallyJava();
    nl = null;
    return result;
  }
