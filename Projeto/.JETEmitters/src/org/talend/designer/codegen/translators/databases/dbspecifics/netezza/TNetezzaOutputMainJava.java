...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_59 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_60 = "++;";
  protected final String TEXT_61 = NL + "                    batchSizeCounter_";
  protected final String TEXT_62 = "++;";
  protected final String TEXT_63 = NL + "                try{" + NL + "                    nb_line_";
  protected final String TEXT_64 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_65 = " = insertedCount_";
  protected final String TEXT_66 = " + pstmt_";
  protected final String TEXT_67 = ".executeUpdate();";
  protected final String TEXT_68 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_97 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_98 = "++;";
  protected final String TEXT_99 = NL + "            batchSizeCounter_";
  protected final String TEXT_100 = "++;";
  protected final String TEXT_101 = NL + "            try{" + NL + "                nb_line_";
  protected final String TEXT_102 = "++;" + NL + "                updatedCount_";
  ...
  protected final String TEXT_106 = NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_149 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_171 = NL + "                }" + NL + "            }" + NL + "            else" + NL + "            {";
  ...
  protected final String TEXT_178 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_211 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_212 = " = updatedCount_";
  protected final String TEXT_213 = "+updateFlag_";
  protected final String TEXT_214 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_215 = " == 0) {";
  protected final String TEXT_216 = NL + "                        ";
  protected final String TEXT_217 = NL + "                    insertedCount_";
  protected final String TEXT_218 = " = insertedCount_";
  protected final String TEXT_219 = " + pstmtInsert_";
  protected final String TEXT_220 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_221 = "++;";
  protected final String TEXT_222 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_223 = "++;";
  protected final String TEXT_224 = NL + "                }" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_253 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_254 = "++;";
  protected final String TEXT_255 = NL + "                batchSizeCounter_";
  ...
  protected final String TEXT_262 = NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  ...
  protected final String TEXT_299 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_300 = " = 0;";
  protected final String TEXT_301 = NL + "                        pstmt_";
  protected final String TEXT_302 = ".executeBatch();";
  protected final String TEXT_303 = NL + "                        pstmt_";
  protected final String TEXT_304 = ".clearBatch();";
  ...
  protected final String TEXT_313 = ". getUpdateCount();";
  protected final String TEXT_314 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_315 = NL + "                        throw(e);";
  protected final String TEXT_316 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_317 = NL + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_318 = NL + "                        throw(e);";
  protected final String TEXT_319 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_320 = NL + "                }" + NL + "                }";
  protected final String TEXT_321 = NL + "                commitCounter_";
  protected final String TEXT_322 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_323 = " <= commitCounter_";
  protected final String TEXT_324 = "){";
  protected final String TEXT_325 = NL + "                try {" + NL + "                    if(batchSizeCounter_";
  protected final String TEXT_326 = " >0){" + NL + "                        batchSizeCounter_";
  protected final String TEXT_327 = " = 0;";
  protected final String TEXT_328 = NL + "                        pstmt_";
  protected final String TEXT_329 = ".executeBatch();";
  protected final String TEXT_330 = NL + "                        pstmt_";
  protected final String TEXT_331 = ".clearBatch();" + NL + "          ";
  protected final String TEXT_332 = NL + "                            insertedCount_";
  protected final String TEXT_333 = " += pstmt_";
  protected final String TEXT_334 = ".getUpdateCount();";
  protected final String TEXT_335 = NL + "                            updatedCount_";
  ...
  protected final String TEXT_339 = " += pstmt_";
  protected final String TEXT_340 = ".getUpdateCount();";
  protected final String TEXT_341 = NL + "                    }    " + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_342 = NL + "                        throw(e);";
  protected final String TEXT_343 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_344 = NL + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_345 = NL + "                        throw(e);";
  protected final String TEXT_346 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_347 = NL + "                }";
  protected final String TEXT_348 = NL + "                    conn_";
  protected final String TEXT_349 = ".commit();";
  protected final String TEXT_350 = NL + "                    commitCounter_";
  protected final String TEXT_351 = "=0;" + NL + "" + NL + "                }" + NL;
