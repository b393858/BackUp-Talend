...
public class THiveCloseMainJava
{
  ...
  protected final String TEXT_79 = "\");" + NL + "\t\tif(conn_";
  protected final String TEXT_80 = " != null && !conn_";
  protected final String TEXT_81 = ".isClosed())" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t\t}";
  protected final String TEXT_83 = NL + "\t\torg.talend.bigdata.launcher.qubole.QuboleHiveClient client_";
  protected final String TEXT_84 = " = (org.talend.bigdata.launcher.qubole.QuboleHiveClient) globalMap.get(\"";
  protected final String TEXT_85 = "\");" + NL + "\t\tclient_";
  protected final String TEXT_86 = ".close();" + NL + "\t\t";
  protected final String TEXT_87 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_88 = " - ";
  protected final String TEXT_89 = " closed.\");" + NL + "\t\t";
