...
public class TRedshiftUnloadBeginJava
{
  ...
  protected final String TEXT_82 = " = \"com.amazon.redshift.jdbc42.Driver\";" + NL + "\t\tClass.forName(driverClass_";
  protected final String TEXT_83 = ").newInstance();" + NL + "        StringBuilder sbuilder_";
  protected final String TEXT_84 = " = new StringBuilder();" + NL + "        sbuilder_";
  protected final String TEXT_85 = ".append(\"jdbc:redshift:\");";
  protected final String TEXT_86 = NL + "            sbuilder_";
  protected final String TEXT_87 = ".append(\"iam:\");";
  protected final String TEXT_88 = NL + "        sbuilder_";
  protected final String TEXT_89 = ".append(\"//\")" + NL + "                         .append(";
  protected final String TEXT_90 = ")" + NL + "                         .append(\":\")" + NL + "                         .append(";
  protected final String TEXT_91 = ")" + NL + "                         .append(\"/\")" + NL + "                         .append(";
  protected final String TEXT_92 = ");";
  protected final String TEXT_93 = NL + "        sbuilder_";
  protected final String TEXT_94 = ".append(\"?\").append(";
  protected final String TEXT_95 = ");";
  protected final String TEXT_96 = NL + "        String url_";
  protected final String TEXT_97 = " = sbuilder_";
  protected final String TEXT_98 = ".toString();";
  protected final String TEXT_99 = " " + NL + "            final String decryptedPass_";
  protected final String TEXT_100 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_101 = ");";
  protected final String TEXT_102 = NL + "            final String decryptedPass_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = "; ";
  protected final String TEXT_105 = NL + "            String dbUser_";
  protected final String TEXT_106 = " = ";
  protected final String TEXT_107 = ";" + NL + "            String dbPwd_";
  protected final String TEXT_108 = " = decryptedPass_";
  protected final String TEXT_109 = ";";
  protected final String TEXT_110 = NL + "\tStringBuilder command_";
  protected final String TEXT_111 = " = new StringBuilder();";
  protected final String TEXT_112 = NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_113 = " = ";
  protected final String TEXT_114 = NL + "\t\t',';";
  protected final String TEXT_115 = NL + "\t\tString.valueOf(";
  protected final String TEXT_116 = ").charAt(0);";
  protected final String TEXT_117 = NL + "\tcommand_";
  protected final String TEXT_118 = ".append(\"UNLOAD ('\").append(";
  protected final String TEXT_119 = ").append(\"') TO \");";
  protected final String TEXT_120 = NL + "\t\t    final String decryptedPwd_";
  ...
  protected final String TEXT_126 = NL + "\tcommand_";
  protected final String TEXT_127 = ".append(\"'s3://\").append(";
  protected final String TEXT_128 = ").append(\"/\").append(";
  protected final String TEXT_129 = ").append(\"' \")" + NL + "\t.append(\"credentials '\")";
  protected final String TEXT_130 = NL + "\t\t\t.append(\"aws_iam_role=\")";
  protected final String TEXT_131 = NL + "\t\t\t\t    .append(\",\")\t";
  protected final String TEXT_132 = NL + "\t\t\t.append(";
  protected final String TEXT_133 = ")";
  protected final String TEXT_134 = NL + "\t    .append(\"aws_access_key_id=\").append(";
  protected final String TEXT_135 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_136 = ")";
  protected final String TEXT_137 = NL + "\t\t.append(\";master_symmetric_key=\")";
  protected final String TEXT_138 = NL + "\t\t\t.append(routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_139 = "))";
  protected final String TEXT_140 = NL + "\t\t\t.append(";
  protected final String TEXT_141 = ")";
  protected final String TEXT_142 = NL + "\t.append(\"' \")";
  protected final String TEXT_143 = NL + "\t\t.append(\"ENCRYPTED \")";
  protected final String TEXT_144 = NL + "\t\t.append(\"ADDQUOTES \")";
  protected final String TEXT_145 = NL + "\t\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_146 = ").append(\"' \")";
  protected final String TEXT_147 = NL + "\t\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_148 = ").append(\"' \")";
  protected final String TEXT_149 = NL + "\t\t.append(\"";
  protected final String TEXT_150 = " \")";
  protected final String TEXT_151 = NL + "\t\t.append(\"ESCAPE \")";
  protected final String TEXT_152 = NL + "\t\t.append(\"ALLOWOVERWRITE \")";
  protected final String TEXT_153 = NL + "\t\t.append(\"PARALLEL OFF \")";
  protected final String TEXT_154 = NL + "\t\t.append(\"NULL '\").append(";
  protected final String TEXT_155 = ").append(\"' \")";
  protected final String TEXT_156 = NL + "\t;" + NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_157 = "=conn_";
  protected final String TEXT_158 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_159 = ".execute(command_";
  protected final String TEXT_160 = ".toString());" + NL + "\t";
  protected final String TEXT_161 = NL + "\t\tlog.info(\"";
  protected final String TEXT_162 = " - Finish unloading data to s3.\");" + NL + "\t";
