...
public class TOracleRowFinallyJava
{
  protected static String nl;
  public static synchronized TOracleRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleRowFinallyJava result = new TOracleRowFinallyJava();
    nl = null;
    return result;
  }
