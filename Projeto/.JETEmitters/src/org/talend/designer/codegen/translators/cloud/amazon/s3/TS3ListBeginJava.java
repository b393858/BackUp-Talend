...
public class TS3ListBeginJava
{
  ...
  protected final String TEXT_209 = NL + NL + "\tint nb_bucket_";
  protected final String TEXT_210 = " = 0;" + NL + "\tint nb_bucket_object_";
  protected final String TEXT_211 = " = 0;" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_212 = NL + "\t\t\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".listBuckets();" + NL + "\t\t\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_215 = " : buckets_";
  protected final String TEXT_216 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_217 = " = bucket_";
  protected final String TEXT_218 = ".getName();" + NL + "\t\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_220 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_221 = " + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_222 = NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_223 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".listObjects(currentBucketName_";
  protected final String TEXT_226 = ",";
  protected final String TEXT_227 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_228 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_229 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_230 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_231 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_232 = " - \"+e_";
  protected final String TEXT_233 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_234 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_235 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_236 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_237 = "] \"+e_";
  protected final String TEXT_238 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t";
  protected final String TEXT_240 = NL + "\t\t\tjava.util.List<java.util.Map<String,String>> buckets_map_list_";
  protected final String TEXT_241 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "\t\t\tjava.util.Map<String,String> bucket_prefix_map_";
  protected final String TEXT_242 = " = null;" + NL + "\t\t\tString object_prefix_";
  protected final String TEXT_243 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\tobject_prefix_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_248 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_249 = ".put(";
  protected final String TEXT_250 = ",object_prefix_";
  protected final String TEXT_251 = ");" + NL + "\t\t\t\tbuckets_map_list_";
  protected final String TEXT_252 = ".add(bucket_prefix_map_";
  protected final String TEXT_253 = ");" + NL + "\t\t\t\tobject_prefix_";
  protected final String TEXT_254 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_255 = NL + "\t\t\tfor (java.util.Map<String,String> bucketMap_";
  protected final String TEXT_256 = ": buckets_map_list_";
  protected final String TEXT_257 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_258 = " = \"\";" + NL + "\t\t\t\tString currentPrefix_";
  protected final String TEXT_259 = " = \"\";" + NL + "\t\t\t\tfor(java.util.Map.Entry<String,String> entry_";
  protected final String TEXT_260 = ":bucketMap_";
  protected final String TEXT_261 = ".entrySet()){" + NL + "\t\t\t\t\tcurrentBucketName_";
  protected final String TEXT_262 = " = entry_";
  protected final String TEXT_263 = ".getKey();" + NL + "\t\t\t\t\tcurrentPrefix_";
  protected final String TEXT_264 = " = entry_";
  protected final String TEXT_265 = ".getValue();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_266 = " = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_268 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_269 = " + \".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\tobjects_";
  protected final String TEXT_271 = " = conn_";
  protected final String TEXT_272 = ".listObjects(currentBucketName_";
  protected final String TEXT_273 = ",currentPrefix_";
  protected final String TEXT_274 = ");" + NL + "\t\t\t\t}catch(com.amazonaws.AmazonClientException e_";
  protected final String TEXT_275 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_277 = " - Failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_278 = ");" + NL + "\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_279 = " - \"+e_";
  protected final String TEXT_280 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_282 = "] failed to list objects from bucket \"+currentBucketName_";
  protected final String TEXT_283 = ");" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARNING: [";
  protected final String TEXT_284 = "] \"+e_";
  protected final String TEXT_285 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_286 = NL + "\t\t\t\t\tcontinue;" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_287 = NL + "\t\t\t\twhile(true){" + NL + "\t\t\t\t\tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> list_objects_";
  protected final String TEXT_288 = " = objects_";
  protected final String TEXT_289 = ".getObjectSummaries();" + NL + "\t\t\t\t\tif(list_objects_";
  protected final String TEXT_290 = ".size()>0){" + NL + "\t\t\t\t\t\tnb_bucket_";
  protected final String TEXT_291 = "++;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tfor (com.amazonaws.services.s3.model.S3ObjectSummary objectSummary_";
  protected final String TEXT_292 = " : list_objects_";
  protected final String TEXT_293 = ") {" + NL + "\t\t\t\t\t\tnb_bucket_object_";
  protected final String TEXT_294 = "++;" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_295 = "_CURRENT_BUCKET\", currentBucketName_";
  protected final String TEXT_296 = ");" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_297 = "_CURRENT_KEY\", objectSummary_";
  protected final String TEXT_298 = ".getKey());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_300 = " - Retrieving the object \" + nb_bucket_object_";
  protected final String TEXT_301 = " + \".\");" + NL + "\t\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_302 = " - Key of current object : \" + objectSummary_";
  protected final String TEXT_303 = ".getKey());" + NL + "\t\t\t\t\t\t";
