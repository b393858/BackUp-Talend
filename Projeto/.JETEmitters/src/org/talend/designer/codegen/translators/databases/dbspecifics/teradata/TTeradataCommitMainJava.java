...
public class TTeradataCommitMainJava
{
  ...
  protected final String TEXT_121 = NL + "java.sql.Connection conn_";
  protected final String TEXT_122 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_123 = "\");" + NL + "if(conn_";
  protected final String TEXT_124 = " != null && !conn_";
  protected final String TEXT_125 = ".isClosed())" + NL + "{";
  protected final String TEXT_126 = NL + "    try{";
  protected final String TEXT_127 = NL + "    }finally{";
  protected final String TEXT_128 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_129 = ".setAutoCommit(true);" + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_130 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_131 = NL + "                           try{" + NL + "                              conn_";
  protected final String TEXT_132 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_133 = ");" + NL + "                           }catch(Exception e){" + NL + "                                  System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_134 = NL + "             }catch(Exception e){";
  protected final String TEXT_135 = NL + "                    System.err.println(e.getMessage());" + NL + "             }" + NL;
