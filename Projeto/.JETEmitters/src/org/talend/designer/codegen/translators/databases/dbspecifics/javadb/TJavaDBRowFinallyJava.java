...
public class TJavaDBRowFinallyJava
{
  protected static String nl;
  public static synchronized TJavaDBRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaDBRowFinallyJava result = new TJavaDBRowFinallyJava();
    nl = null;
    return result;
  }
