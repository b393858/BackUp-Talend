...
public class TMongoDBGridFSGetBeginJava
{
  protected static String nl;
  public static synchronized TMongoDBGridFSGetBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMongoDBGridFSGetBeginJava result = new TMongoDBGridFSGetBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_145 = NL + "\t\t\tString outputLocalPath_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "\t\t\tif(outputLocalPath_";
  protected final String TEXT_148 = " != null && !\"\".equals(outputLocalPath_";
  protected final String TEXT_149 = ")){" + NL + "\t\t\t\tjava.io.File outputLocalDir_";
  protected final String TEXT_150 = " = new java.io.File(outputLocalPath_";
  protected final String TEXT_151 = ");" + NL + "\t\t\t\toutputLocalDir_";
  protected final String TEXT_152 = ".mkdirs();" + NL + "\t\t\t} else {" + NL + "\t\t\t\tthrow new RuntimeException(\"The Output Folder cannot be left empty\");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_153 = NL + NL + "\t";
  protected final String TEXT_154 = NL + "\t\t\tcom.mongodb.client.gridfs.GridFSBucket gridfs_";
  protected final String TEXT_155 = " = com.mongodb.client.gridfs.GridFSBuckets.create(db_";
  protected final String TEXT_156 = ", ";
  protected final String TEXT_157 = ");" + NL + "\t    \t";
  protected final String TEXT_158 = NL + "\t    \t\torg.bson.Document gridFSQuery_";
  protected final String TEXT_159 = " = new org.bson.Document(\"filename\",";
  protected final String TEXT_160 = ");" + NL + "\t\t\t ";
  protected final String TEXT_161 = NL + "\t\t\t \torg.bson.Document gridFSQuery_";
  protected final String TEXT_162 = " = org.bson.Document.parse(";
  protected final String TEXT_163 = ");" + NL + "\t\t\t ";
  protected final String TEXT_164 = NL + "\t\t\t com.mongodb.client.gridfs.GridFSFindIterable gridfsFiles_";
  protected final String TEXT_165 = " = gridfs_";
  protected final String TEXT_166 = ".find(gridFSQuery_";
  protected final String TEXT_167 = ");";
  protected final String TEXT_168 = NL + "    \t\tcom.mongodb.gridfs.GridFS gridfs_";
  protected final String TEXT_169 = " = new com.mongodb.gridfs.GridFS(db_";
  protected final String TEXT_170 = ", ";
  protected final String TEXT_171 = ");" + NL + "\t\t\tjava.util.List<";
  protected final String TEXT_172 = "> gridfsFiles_";
  protected final String TEXT_173 = ";" + NL + "\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\t" + NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_175 = " = gridfs_";
  protected final String TEXT_176 = ".find(";
  protected final String TEXT_177 = ");" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_178 = NL + "\t\t\t\tcom.mongodb.DBObject gridFSQuery_";
  protected final String TEXT_179 = " = com.mongodb.BasicDBObject.parse(";
  protected final String TEXT_180 = ");" + NL + "\t\t\t\tgridfsFiles_";
  protected final String TEXT_181 = " = gridfs_";
  protected final String TEXT_182 = ".find(gridFSQuery_";
  protected final String TEXT_183 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_184 = NL + NL + "\t\t\tfor(";
  protected final String TEXT_185 = " gridFSfile : gridfsFiles_";
