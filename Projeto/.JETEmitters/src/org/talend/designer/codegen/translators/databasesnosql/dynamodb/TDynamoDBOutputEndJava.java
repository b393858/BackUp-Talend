...
public class TDynamoDBOutputEndJava
{
  protected static String nl;
  public static synchronized TDynamoDBOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDynamoDBOutputEndJava result = new TDynamoDBOutputEndJava();
    nl = null;
    return result;
  }
