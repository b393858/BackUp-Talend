...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_77 = "=0;" + NL + "String dbschema_";
  protected final String TEXT_78 = "= ";
  protected final String TEXT_79 = "; " + NL + "String tableName_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";";
  protected final String TEXT_82 = NL + "        int keyCount_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_85 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }";
  protected final String TEXT_86 = NL + "    String host_";
  protected final String TEXT_87 = " = (String)globalMap.get(\"host_";
  protected final String TEXT_88 = "\");" + NL + "    String port_";
  protected final String TEXT_89 = " = (String)globalMap.get(\"port_";
  protected final String TEXT_90 = "\");" + NL + "    String db_";
  protected final String TEXT_91 = " = (String)globalMap.get(\"db_";
  protected final String TEXT_92 = "\");" + NL + "    String dbUser_";
  protected final String TEXT_93 = " = (String)globalMap.get(\"user_";
  protected final String TEXT_94 = "\");" + NL + "    String dbPwd_";
  protected final String TEXT_95 = " = (String)globalMap.get(\"pass_";
  protected final String TEXT_96 = "\");" + NL + "    dbschema_";
  ...
  protected final String TEXT_101 = NL + "    String db_";
  ...
  protected final String TEXT_115 = ";" + NL + "    String host_";
  protected final String TEXT_116 = " = ";
  protected final String TEXT_117 = ";";
  protected final String TEXT_118 = NL + "    \tString port_";
  protected final String TEXT_119 = " = ";
  protected final String TEXT_120 = ";";
  protected final String TEXT_121 = NL + "\t\t\tString url_";
  protected final String TEXT_122 = " = \"jdbc:sqlanywhere:Host=\" + host_";
  protected final String TEXT_123 = " + \":\" + port_";
  protected final String TEXT_124 = " + \";DatabaseName=\" + db_";
  protected final String TEXT_125 = "; ";
  protected final String TEXT_126 = NL + "\t\t\tString url_";
  protected final String TEXT_127 = " = \"jdbc:sqlanywhere:Host=\" + host_";
  protected final String TEXT_128 = " + \":\" + port_";
  protected final String TEXT_129 = " + \";DatabaseName\" + db_";
  protected final String TEXT_130 = " + \";\" + ";
  protected final String TEXT_131 = ";";
  protected final String TEXT_132 = NL + "\t\t\tString url_";
  protected final String TEXT_133 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_134 = " + \":\" + port_";
  protected final String TEXT_135 = " + \"/\" + db_";
  protected final String TEXT_136 = ";";
  protected final String TEXT_137 = NL + "\t\t\tString url_";
  protected final String TEXT_138 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_139 = " + \":\" + port_";
  protected final String TEXT_140 = " + \"/\" + db_";
  protected final String TEXT_141 = " + \"?\" + ";
  protected final String TEXT_142 = ";";
  protected final String TEXT_143 = NL + "\t\t";
  protected final String TEXT_144 = NL + "\t\t\t String driverClass_";
  protected final String TEXT_145 = " = \"sap.jdbc4.sqlanywhere.IDriver\";" + NL + "\t\t";
  protected final String TEXT_146 = NL + "\t\t\t String driverClass_";
  protected final String TEXT_147 = " = \"com.sybase.jdbc4.jdbc.SybDriver\";" + NL + "\t\t";
  protected final String TEXT_148 = NL + "\t\t\t String driverClass_";
  protected final String TEXT_149 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";" + NL + "\t    ";
  ...
  protected final String TEXT_153 = NL + "if(dbschema_";
  ...
  protected final String TEXT_163 = " - Droping table ";
  ...
  protected final String TEXT_176 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_180 = " - Creating table ";
  ...
  protected final String TEXT_188 = " - Create table ";
  protected final String TEXT_189 = "\" + tableName_";
  protected final String TEXT_190 = " + \"";
  protected final String TEXT_191 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_196 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_198 = " - Creating table ";
  ...
  protected final String TEXT_206 = " - Create table ";
  protected final String TEXT_207 = "\" + tableName_";
  protected final String TEXT_208 = " + \"";
  protected final String TEXT_209 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_240 = ".equalsIgnoreCase(";
  protected final String TEXT_241 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_242 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_255 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_259 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_260 = ".equals(schema_";
  protected final String TEXT_261 = ") || (schema_";
  protected final String TEXT_262 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_263 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_331 = ".getTables(null, dbschema_";
  protected final String TEXT_332 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_333 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_334 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_335 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  protected final String TEXT_336 = ")) {" + NL + "                        whetherExist_";
  ...
  protected final String TEXT_343 = ".getTables(";
  protected final String TEXT_344 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_359 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_360 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_361 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_362 = " = rsTable_";
  protected final String TEXT_363 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_371 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_375 = " - Creating table ";
  ...
  protected final String TEXT_383 = " - Create table ";
  ...
  protected final String TEXT_388 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_389 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_390 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_411 = " - Creating table ";
  protected final String TEXT_412 = "\" + tableName_";
  ...
  protected final String TEXT_419 = " - Create table ";
  protected final String TEXT_420 = "\" + tableName_";
  protected final String TEXT_421 = " + \"";
  protected final String TEXT_422 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_424 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_429 = " - Clearing table ";
  protected final String TEXT_430 = "\" + tableName_";
  protected final String TEXT_431 = " + \"";
  protected final String TEXT_432 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_434 = ".executeUpdate(\"";
  protected final String TEXT_435 = "\");" + NL + "\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_437 = "- Clear table ";
  protected final String TEXT_438 = "\" + tableName_";
  protected final String TEXT_439 = " + \"";
  protected final String TEXT_440 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_448 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_449 = " = conn_";
  protected final String TEXT_450 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_452 = " - Trancating table ";
  ...
  protected final String TEXT_460 = " - Truncate table ";
  protected final String TEXT_461 = "\" + tableName_";
  protected final String TEXT_462 = " + \"";
  protected final String TEXT_463 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_465 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_466 = " += rsTruncCount_";
  protected final String TEXT_467 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_468 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_469 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_470 = ".close();" + NL + "\t\t";
  protected final String TEXT_471 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_472 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_473 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_474 = NL + "\t";
  protected final String TEXT_475 = NL + NL + "StringBuilder command_";
  protected final String TEXT_476 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_477 = ".append(";
  protected final String TEXT_478 = " + \" \");";
  protected final String TEXT_479 = NL + "    String tmpTableName_";
  protected final String TEXT_480 = " = tableName_";
  protected final String TEXT_481 = ";" + NL + "    tableName_";
  protected final String TEXT_482 = " = \"tmp_";
  protected final String TEXT_483 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_484 = " != null && dbschema_";
  protected final String TEXT_485 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  protected final String TEXT_486 = "=dbschema_";
  protected final String TEXT_487 = " + \".\" + tableName_";
  protected final String TEXT_488 = ";" + NL + "    }";
  protected final String TEXT_489 = NL + "if(dbschema_";
  protected final String TEXT_490 = " != null && dbschema_";
  protected final String TEXT_491 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_492 = ".append(db_";
  protected final String TEXT_493 = " + \".\" + tableName_";
  protected final String TEXT_494 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_495 = ".append(db_";
  protected final String TEXT_496 = " + \"..\" + tableName_";
  protected final String TEXT_497 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_498 = ".append(\" in \" + ";
  protected final String TEXT_499 = ");" + NL + "String headRow_";
  protected final String TEXT_500 = " = ";
  protected final String TEXT_501 = ";" + NL + "if(headRow_";
  protected final String TEXT_502 = " != null && headRow_";
  protected final String TEXT_503 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_504 = ".append(\" -F \" + headRow_";
  protected final String TEXT_505 = ");" + NL + "}" + NL;
  protected final String TEXT_506 = NL + "\tcommand_";
  protected final String TEXT_507 = ".append(\" -b \" + ";
  protected final String TEXT_508 = ");";
  protected final String TEXT_509 = NL + NL + "command_";
  protected final String TEXT_510 = ".append(\" -t \" + ";
  protected final String TEXT_511 = ");" + NL + "command_";
  protected final String TEXT_512 = ".append(\" -r \" + ";
  protected final String TEXT_513 = ");" + NL + "command_";
  protected final String TEXT_514 = ".append(\" -c -U \" + dbUser_";
  protected final String TEXT_515 = " + \" -P \" + dbPwd_";
  protected final String TEXT_516 = ");";
  protected final String TEXT_517 = NL + "command_";
  protected final String TEXT_518 = ".append(\" -I \" + ";
  protected final String TEXT_519 = ");";
  protected final String TEXT_520 = NL + "    command_";
  protected final String TEXT_521 = ".append(\" -S \" + ";
  protected final String TEXT_522 = ");";
  protected final String TEXT_523 = NL + "\tcommand_";
  protected final String TEXT_524 = ".append(\" -S \" + host_";
  protected final String TEXT_525 = ");";
  protected final String TEXT_526 = NL + "String encoding_";
  protected final String TEXT_527 = " = ";
  protected final String TEXT_528 = ";" + NL + "if(encoding_";
  protected final String TEXT_529 = " != null && encoding_";
  protected final String TEXT_530 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_531 = ".append(\" -J \" + encoding_";
  protected final String TEXT_532 = ");" + NL + "}" + NL;
  protected final String TEXT_533 = NL + "\tlog.info(\"";
  protected final String TEXT_534 = " - Executing command:'\" + command_";
  protected final String TEXT_535 = " + \"'.\");";
  protected final String TEXT_536 = NL + "    Runtime runtime_";
  protected final String TEXT_537 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_538 = " = runtime_";
  protected final String TEXT_539 = ".exec(command_";
  protected final String TEXT_540 = ".toString());";
  protected final String TEXT_541 = NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_542 = " = conn_";
  protected final String TEXT_543 = ".createStatement();";
  protected final String TEXT_544 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_545 = " - Creating temp table ";
  protected final String TEXT_546 = "\" + tableName_";
  protected final String TEXT_547 = " + \"";
  protected final String TEXT_548 = ".\" );" + NL + "\t\t";
  protected final String TEXT_549 = NL + "        stmtCreateTmp_";
  protected final String TEXT_550 = ".execute(\"";
  protected final String TEXT_551 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_552 = ".close();            ";
  protected final String TEXT_553 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_554 = " - Create temp table ";
  protected final String TEXT_555 = "\" + tableName_";
  protected final String TEXT_556 = " + \"";
  protected final String TEXT_557 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_558 = NL + "        Runtime runtime_";
  protected final String TEXT_559 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_560 = " = runtime_";
  protected final String TEXT_561 = ".exec(command_";
  protected final String TEXT_562 = ".toString());       ";
  protected final String TEXT_563 = NL + NL + "Thread normal_";
  protected final String TEXT_564 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_565 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_566 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_567 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_568 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_569 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_570 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_571 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_572 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_573 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_574 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_575 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_576 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_577 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_578 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_579 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_580 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_581 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_582 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_583 = ".interrupt();" + NL + "error_";
  protected final String TEXT_584 = ".interrupt();";
  protected final String TEXT_585 = NL + "\tlog.info(\"";
  protected final String TEXT_586 = " - Excute command: '\" + command_";
  protected final String TEXT_587 = " + \"' has finished.\");";
