...
public class TKafkaInputEndJava
{
  ...
  protected final String TEXT_20 = NL + "    } catch (org.apache.kafka.common.errors.AuthenticationException|org.apache.kafka.common.errors.AuthorizationException|org.apache.kafka.common.errors.UnknownServerException|org.apache.kafka.common.errors.UnsupportedVersionException e) {" + NL + "    \t// the process stops when there is AuthenticationException, AuthorizationException, UnknownServerException or UnsupportedVersionException" + NL + "\t\tthrow e;" + NL + "\t} catch (org.apache.kafka.common.KafkaException e) {" + NL + "\t\t";
  protected final String TEXT_21 = "\t" + NL + "\t\t\tlog.error(\"";
  protected final String TEXT_22 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_23 = NL + "\t\tbreak;" + NL + "\t}" + NL + "} // end while(true)";
  protected final String TEXT_24 = NL + "\t";
  protected final String TEXT_25 = NL + "\t\t} // end for ConsumerRecord";
  protected final String TEXT_26 = NL + "\t\t// Stop reading if the maximum number of input messages has been reached." + NL + "\t\tif (tos_count_";
  protected final String TEXT_27 = " >= ";
  protected final String TEXT_28 = ") {" + NL + "\t\t    break;" + NL + "\t\t}";
  protected final String TEXT_29 = NL + "    // Immediately stop processing messagesDeadline if the max duration deadline has passed." + NL + "    if (System.currentTimeMillis() > maxDurationDeadline_";
  protected final String TEXT_30 = ")" + NL + "        break;";
  protected final String TEXT_31 = NL + "    } catch (org.apache.kafka.common.errors.AuthenticationException|org.apache.kafka.common.errors.AuthorizationException|org.apache.kafka.common.errors.UnknownServerException|org.apache.kafka.common.errors.UnsupportedVersionException e) {" + NL + "    \t// the process stops when there is AuthenticationException, AuthorizationException, UnknownServerException or UnsupportedVersionException" + NL + "\t\tthrow e;" + NL + "\t} catch (org.apache.kafka.common.KafkaException e) {" + NL + "\t\t";
  protected final String TEXT_32 = "\t" + NL + "\t\t\tlog.error(\"";
  protected final String TEXT_33 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_34 = NL + "\t\tbreak;" + NL + "\t}" + NL + "} // end while(true)";
...
} else if(tKafkaInputUtil.isKafkaVersion("KAFKA_0_10_0_1") || tKafkaInputUtil.isKafkaVersion("KAFKA_1_1_0")) {
