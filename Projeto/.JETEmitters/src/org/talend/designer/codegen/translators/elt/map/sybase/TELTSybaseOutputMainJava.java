...
public class TELTSybaseOutputMainJava
{
  ...
  protected final String TEXT_103 = " = \"sap.jdbc4.sqlanywhere.IDriver\";";
  protected final String TEXT_104 = NL + "    String url_";
  protected final String TEXT_105 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = " + \";DatabaseName=\" + ";
  protected final String TEXT_108 = "; ";
  protected final String TEXT_109 = NL + "    String url_";
  protected final String TEXT_110 = " = \"jdbc:sqlanywhere:Host=\" + ";
  protected final String TEXT_111 = " + \":\" + ";
  protected final String TEXT_112 = " + \";DatabaseName\" + ";
  protected final String TEXT_113 = " + \";\" + ";
  protected final String TEXT_114 = ";";
  protected final String TEXT_115 = NL + "    String driverClass_";
  protected final String TEXT_116 = " = \"com.sybase.jdbc4.jdbc.SybDriver\";" + NL + "\t        ";
  protected final String TEXT_117 = NL + "\tString driverClass_";
  protected final String TEXT_118 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";" + NL + "\t        ";
  protected final String TEXT_119 = NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_132 = NL + "    String dbUser_";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = ";" + NL;
  protected final String TEXT_135 = NL;
  protected final String TEXT_136 = NL + "    ";
  protected final String TEXT_137 = "String decryptedPassword_";
  protected final String TEXT_138 = " = null;";
  protected final String TEXT_139 = " " + NL + "\tdecryptedPassword_";
  protected final String TEXT_140 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_141 = ");";
  protected final String TEXT_142 = NL + "\tdecryptedPassword_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = "; ";
  protected final String TEXT_145 = NL + NL + "    String dbPwd_";
  protected final String TEXT_146 = " = decryptedPassword_";
  protected final String TEXT_147 = ";" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_148 = " = null;";
  protected final String TEXT_149 = NL;
  protected final String TEXT_150 = NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_151 = " =null;" + NL;
  protected final String TEXT_152 = "\t" + NL + "\t\tString insertQuery_";
  protected final String TEXT_153 = " = \"INSERT INTO \"+tableName_";
  protected final String TEXT_154 = "+\" (";
  protected final String TEXT_155 = ") (\"+select_query_";
  protected final String TEXT_156 = "+\")\";" + NL + "\t\tpstmt_";
  protected final String TEXT_157 = " = conn_";
  protected final String TEXT_158 = ".prepareStatement(insertQuery_";
  protected final String TEXT_159 = ");";
  protected final String TEXT_160 = NL + "\t\tString updateQuery_";
  protected final String TEXT_161 = " = \"UPDATE \"+tableName_";
  protected final String TEXT_162 = "+\" SET ";
  protected final String TEXT_163 = " \"";
  protected final String TEXT_164 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_165 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_166 = " = conn_";
  protected final String TEXT_167 = ".prepareStatement(updateQuery_";
  protected final String TEXT_168 = ");" + NL;
  protected final String TEXT_169 = NL + "\t\tString deleteQuery_";
  protected final String TEXT_170 = " = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_171 = "+\" WHERE EXISTS (\"+ select_query_";
  protected final String TEXT_172 = ".replaceAll(selectQueryColumnsName_";
  protected final String TEXT_173 = ", \"*\")+\") \" ";
  protected final String TEXT_174 = NL + "\t\t+\"  AND \" + ";
  protected final String TEXT_175 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_178 = ");";
  protected final String TEXT_179 = NL + "\tint nb_line_";
  protected final String TEXT_180 = " = 0;" + NL + "\tint nb_line_updated_";
  protected final String TEXT_181 = " = 0;" + NL + "\tint nb_line_inserted_";
  protected final String TEXT_182 = " = 0;" + NL + "\tint nb_line_deleted_";
  protected final String TEXT_183 = " = 0;";
  protected final String TEXT_184 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery_";
  protected final String TEXT_185 = " + \"\\n\");";
  protected final String TEXT_186 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_187 = " += nb_line_inserted_";
  protected final String TEXT_188 = " = pstmt_";
  protected final String TEXT_189 = ".executeUpdate();";
  protected final String TEXT_190 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_191 = " + \" rows inserted. \\n\");";
  protected final String TEXT_192 = NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_193 = " +\"\\n\");";
  protected final String TEXT_194 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_195 = " += nb_line_updated_";
  protected final String TEXT_196 = " = pstmt_";
  protected final String TEXT_197 = ".executeUpdate();";
  protected final String TEXT_198 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_199 = " + \" rows updated. \\n\");";
  protected final String TEXT_200 = NL + "\t\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_201 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_202 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_203 = " += nb_line_deleted_";
  protected final String TEXT_204 = " = pstmt_";
  protected final String TEXT_205 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_206 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_207 = " + \" rows deleted. \\n\");";
  protected final String TEXT_208 = NL + "\tpstmt_";
  ...
  protected final String TEXT_212 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_213 = NL + "    }";
  protected final String TEXT_214 = NL + NL + "globalMap.put(\"";
  protected final String TEXT_215 = "_NB_LINE\",nb_line_";
  protected final String TEXT_216 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_217 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_218 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_219 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_220 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_221 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_222 = ");" + NL;
  protected final String TEXT_223 = NL + "\tlog.info(\"";
  protected final String TEXT_224 = " - Has ";
  protected final String TEXT_225 = " records count: \" + nb_line_";
