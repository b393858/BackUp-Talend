...
public class TTeradataSCDBeginJava {
  ...
  protected final String TEXT_74 = ".getTables(";
  protected final String TEXT_75 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_79 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  protected final String TEXT_80 = ".equalsIgnoreCase(";
  protected final String TEXT_81 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_82 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }";
  protected final String TEXT_83 = NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_89 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_90 = ".equalsIgnoreCase(";
  protected final String TEXT_91 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_92 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  protected final String TEXT_93 = "            " + NL + "            if(!whetherExist_";
  ...
  protected final String TEXT_100 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_101 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_102 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_103 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_104 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_105 = " = calendarYear0_";
  protected final String TEXT_106 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_107 = " = calendar_";
  protected final String TEXT_108 = ".getTime().getTime();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_109 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_110 = " = calendar_";
  protected final String TEXT_111 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_112 = " = 0;" + NL + "    " + NL + "    String dateStr_";
  protected final String TEXT_113 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_114 = " = null;" + NL + "    ";
  protected final String TEXT_115 = NL + NL + "        String searching_";
  protected final String TEXT_116 = " = \"";
  protected final String TEXT_117 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_118 = " = connection_";
  protected final String TEXT_119 = ".prepareStatement(searching_";
  protected final String TEXT_120 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_121 = " = null;" + NL;
  protected final String TEXT_122 = NL + NL + "        String search_";
  protected final String TEXT_123 = " = \"";
  protected final String TEXT_124 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_125 = " = connection_";
  protected final String TEXT_126 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_127 = " = statement_";
  protected final String TEXT_128 = ".executeQuery(search_";
  protected final String TEXT_129 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_130 = ", SCDStruct_";
  protected final String TEXT_131 = "> cache_";
  protected final String TEXT_132 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_133 = ", SCDStruct_";
  protected final String TEXT_134 = ">();" + NL + "" + NL + "        while(resultSet_";
  protected final String TEXT_135 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_136 = " sk_";
  protected final String TEXT_137 = " = new SCDSK_";
  protected final String TEXT_138 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_139 = " row_";
  protected final String TEXT_140 = " = new SCDStruct_";
  protected final String TEXT_141 = "();" + NL;
  protected final String TEXT_142 = NL + "                    tmpValue_";
  protected final String TEXT_143 = " = resultSet_";
  protected final String TEXT_144 = ".getString(";
  protected final String TEXT_145 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_146 = " != null && tmpValue_";
  protected final String TEXT_147 = ".length() > 0) {";
  protected final String TEXT_148 = NL + "                        ";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = " = tmpValue_";
  protected final String TEXT_151 = ".charAt(0);" + NL + "                    } else {" + NL;
  protected final String TEXT_152 = NL + NL + "                            if(tmpValue_";
  ...
  protected final String TEXT_159 = " = '\\0';" + NL + "                            }" + NL;
  protected final String TEXT_160 = NL + NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_161 = ")) {";
  protected final String TEXT_162 = NL + "                                ";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_165 = "' in '";
  protected final String TEXT_166 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }" + NL;
  protected final String TEXT_167 = NL + NL + "                    }" + NL;
  protected final String TEXT_168 = NL + "                    dateStr_";
  protected final String TEXT_169 = " = resultSet_";
  protected final String TEXT_170 = ".getString(";
  protected final String TEXT_171 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_172 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_173 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_174 = ")) {";
  protected final String TEXT_175 = NL + "                            ";
  protected final String TEXT_176 = ".";
  protected final String TEXT_177 = " = new java.util.Date(resultSet_";
  protected final String TEXT_178 = ".getTimestamp(";
  protected final String TEXT_179 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_180 = NL + "                            ";
  protected final String TEXT_181 = ".";
  protected final String TEXT_182 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_183 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  protected final String TEXT_184 = NL + "                        ";
  protected final String TEXT_185 = ".";
  protected final String TEXT_186 = " = null;" + NL + "                    }" + NL;
  protected final String TEXT_187 = NL + NL + "                    if(resultSet_";
  protected final String TEXT_188 = ".getObject(";
  protected final String TEXT_189 = ") != null) {";
  protected final String TEXT_190 = NL + "                        ";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = " = resultSet_";
  protected final String TEXT_193 = ".get";
  protected final String TEXT_194 = "(";
  protected final String TEXT_195 = ");" + NL + "                    }" + NL;
  protected final String TEXT_196 = NL + "            cache_";
  protected final String TEXT_197 = ".put(sk_";
  protected final String TEXT_198 = ", row_";
  protected final String TEXT_199 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_200 = ".close();" + NL + "        statement_";
  protected final String TEXT_201 = ".close();" + NL;
  protected final String TEXT_202 = NL + NL + "            System.out.println(\"[";
  protected final String TEXT_203 = "] comparison cache loaded\");" + NL;
  protected final String TEXT_204 = NL + NL + "\t\t";
  protected final String TEXT_205 = " nextSurrogateKey_";
  protected final String TEXT_206 = " = 1;";
  protected final String TEXT_207 = NL + NL + "\t\t\tif(cache_";
  protected final String TEXT_208 = ".size() > 0) {";
  protected final String TEXT_209 = NL + NL + "        String tmpQuery_";
  protected final String TEXT_210 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_211 = "\\\") FROM \\\"\" + dbName_";
  protected final String TEXT_212 = " + \"\\\".\\\"\" + tableName_";
  protected final String TEXT_213 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_214 = " = connection_";
  protected final String TEXT_215 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_216 = " = tmpStmt_";
  protected final String TEXT_217 = ".executeQuery(tmpQuery_";
  protected final String TEXT_218 = ");" + NL;
  protected final String TEXT_219 = NL + NL + "        if(tmpRS_";
  protected final String TEXT_220 = ".next() && tmpRS_";
  protected final String TEXT_221 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_222 = " = tmpRS_";
  protected final String TEXT_223 = ".get";
  protected final String TEXT_224 = "(1) + 1;" + NL + "        }" + NL + "" + NL + "        tmpRS_";
  protected final String TEXT_225 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_226 = ".close();" + NL;
  protected final String TEXT_227 = NL + NL + "            }            ";
  protected final String TEXT_228 = NL + "    String insertionSQL_";
  protected final String TEXT_229 = " = \"";
  protected final String TEXT_230 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_231 = " = connection_";
  protected final String TEXT_232 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_233 = ");" + NL;
  protected final String TEXT_234 = NL + NL + "            insertionStatement_";
  protected final String TEXT_235 = ".setTimestamp(";
  protected final String TEXT_236 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_237 = "\")));" + NL;
  protected final String TEXT_238 = NL + NL + "            insertionStatement_";
  protected final String TEXT_239 = ".setNull(";
  protected final String TEXT_240 = ", java.sql.Types.DATE);";
  protected final String TEXT_241 = NL + NL + "            insertionStatement_";
  protected final String TEXT_242 = ".setTimestamp(";
  protected final String TEXT_243 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_244 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_245 = NL + NL + "        String updateSQLForType1_";
  protected final String TEXT_246 = " = \"";
  protected final String TEXT_247 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_248 = " = connection_";
  protected final String TEXT_249 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_250 = ");        " + NL;
  protected final String TEXT_251 = NL + "        String updateSQLForType2_";
  protected final String TEXT_252 = " = \"";
  protected final String TEXT_253 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_254 = " = connection_";
  protected final String TEXT_255 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_256 = ");" + NL;
  protected final String TEXT_257 = NL + "            updateForType2_";
  protected final String TEXT_258 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_259 = "\")));" + NL;
  protected final String TEXT_260 = NL + NL + "        String updateSQLForType3_";
  protected final String TEXT_261 = " = \"";
  protected final String TEXT_262 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_263 = " = connection_";
  protected final String TEXT_264 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_265 = ");" + NL;
  protected final String TEXT_266 = NL + "    ";
  protected final String TEXT_267 = NL + NL + "        SCDSK_";
  protected final String TEXT_268 = " lookUpKey_";
  protected final String TEXT_269 = " = null;        " + NL;
  protected final String TEXT_270 = NL + NL + "    SCDStruct_";
  protected final String TEXT_271 = " lookUpValue_";
