...
public class TEXARowFinallyJava
{
  protected static String nl;
  public static synchronized TEXARowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXARowFinallyJava result = new TEXARowFinallyJava();
    nl = null;
    return result;
  }
