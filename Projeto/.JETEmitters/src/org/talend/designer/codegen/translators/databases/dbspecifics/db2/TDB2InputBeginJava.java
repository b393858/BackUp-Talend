...
public class TDB2InputBeginJava
{
  ...
  protected final String TEXT_188 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_189 = " + \":\" + ";
  protected final String TEXT_190 = " + \"/\" + ";
  protected final String TEXT_191 = ";";
  protected final String TEXT_192 = NL + "\t\t\tString url_";
  protected final String TEXT_193 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_200 = " = routines.system.JDBCUtil.getDoubleObject(rs_";
  protected final String TEXT_201 = ", ";
  protected final String TEXT_202 = "column_index_";
  protected final String TEXT_203 = ");";
  protected final String TEXT_204 = NL + "\t\t\t\t";
  protected final String TEXT_205 = ".";
  protected final String TEXT_206 = " = routines.system.JDBCUtil.getDouble(rs_";
  protected final String TEXT_207 = ", ";
  protected final String TEXT_208 = "column_index_";
  protected final String TEXT_209 = ");";
  protected final String TEXT_210 = NL + "\t\t\t\t";
  protected final String TEXT_211 = ".";
  protected final String TEXT_212 = " = routines.system.JDBCUtil.getBooleanObject(rs_";
  protected final String TEXT_213 = ", ";
  protected final String TEXT_214 = "column_index_";
  protected final String TEXT_215 = ");";
  protected final String TEXT_216 = NL + "\t\t\t\t";
  protected final String TEXT_217 = ".";
  protected final String TEXT_218 = " = routines.system.JDBCUtil.getBoolean(rs_";
  ...
  protected final String TEXT_230 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_231 = " =  conn_";
  protected final String TEXT_232 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_233 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_234 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_235 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_236 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  ...
  protected final String TEXT_257 = "_QUERY\",dbquery_";
  protected final String TEXT_258 = ");";
  protected final String TEXT_259 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_260 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_261 = " = stmt_";
  protected final String TEXT_262 = ".executeQuery(dbquery_";
  protected final String TEXT_263 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_264 = " = rs_";
  protected final String TEXT_265 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_266 = " = rsmd_";
  protected final String TEXT_267 = ".getColumnCount();" + NL;
  protected final String TEXT_268 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_269 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_270 = ".setDbmsId(\"";
  protected final String TEXT_271 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_272 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_273 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_274 = ".add(\"";
  protected final String TEXT_275 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_276 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_277 = " = ";
  protected final String TEXT_278 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_279 = "; i <= rsmd_";
  protected final String TEXT_280 = ".getColumnCount()-";
  protected final String TEXT_281 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_282 = ".contains(rsmd_";
  protected final String TEXT_283 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_284 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_285 = ".setName(rsmd_";
  protected final String TEXT_286 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_287 = ".setDbName(rsmd_";
  protected final String TEXT_288 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_289 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_290 = "\", rsmd_";
  protected final String TEXT_291 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_292 = ".getPrecision(i), rsmd_";
  protected final String TEXT_293 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_294 = ".setDbType(rsmd_";
  protected final String TEXT_295 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_296 = ".setDbTypeId(rsmd_";
  protected final String TEXT_297 = ".getColumnType(i));";
  protected final String TEXT_298 = NL + "                \tdcm_";
  protected final String TEXT_299 = ".setFormat(";
  protected final String TEXT_300 = ");";
  protected final String TEXT_301 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_302 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_303 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_304 = ".setLength(rsmd_";
  protected final String TEXT_305 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_306 = ".setLength(rsmd_";
  protected final String TEXT_307 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_308 = NL + "\t\t\tdcm_";
  protected final String TEXT_309 = ".setLength(rsmd_";
  protected final String TEXT_310 = ".getPrecision(i));";
  protected final String TEXT_311 = NL + "                \tdcm_";
  protected final String TEXT_312 = ".setPrecision(rsmd_";
  protected final String TEXT_313 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_314 = ".setNullable(rsmd_";
  protected final String TEXT_315 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_316 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_317 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_318 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_319 = ".metadatas.add(dcm_";
  protected final String TEXT_320 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_321 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_322 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_323 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_324 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_325 = NL + "\t\t    ";
  protected final String TEXT_326 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_327 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_328 = NL + "\t\t    while (rs_";
  protected final String TEXT_329 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_330 = "++;" + NL + "\t\t        ";
  protected final String TEXT_331 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_332 = " = ";
  protected final String TEXT_333 = " + dcg_";
  protected final String TEXT_334 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_336 = " = ";
  protected final String TEXT_337 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_338 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_339 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_351 = " = (List)rs_";
  ...
  protected final String TEXT_398 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_399 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_400 = ".getColumnTypeName(i_";
  protected final String TEXT_401 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_402 = ".add(rs_";
  protected final String TEXT_403 = ".getString(i_";
  protected final String TEXT_404 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_405 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
