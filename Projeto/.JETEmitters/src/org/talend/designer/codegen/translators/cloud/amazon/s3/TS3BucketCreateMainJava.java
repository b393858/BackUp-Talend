...
public class TS3BucketCreateMainJava
{
  ...
  protected final String TEXT_211 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_212 = ");" + NL + "\t\t";
  protected final String TEXT_213 = NL + "\t\tconn_";
  protected final String TEXT_214 = ".createBucket(";
  protected final String TEXT_215 = ");" + NL + "\t\t";
  protected final String TEXT_216 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_217 = " - Create the bucket successfully.\");" + NL + "\t\t";
