...
public class TMysqlRowFinallyJava
{
  protected static String nl;
  public static synchronized TMysqlRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlRowFinallyJava result = new TMysqlRowFinallyJava();
    nl = null;
    return result;
  }
