...
public class THSQLDbRowBeginJava
{
  ...
  protected final String TEXT_127 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_128 = " + \":\" + ";
  protected final String TEXT_129 = " + \"/\" + ";
  protected final String TEXT_130 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_132 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_133 = " + \":\" + ";
  protected final String TEXT_134 = " + \"/\" + ";
  protected final String TEXT_135 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_137 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_138 = " + \":\" + ";
  protected final String TEXT_139 = " + \"/\" + ";
  protected final String TEXT_140 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_142 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_143 = " + \":\" + ";
  protected final String TEXT_144 = " + \"/\" + ";
  protected final String TEXT_145 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\turl_";
  protected final String TEXT_147 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_148 = " + \"/\" + ";
  protected final String TEXT_149 = " ;" + NL + "\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\turl_";
  protected final String TEXT_151 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_152 = " ;" + NL + "\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\turl_";
  protected final String TEXT_154 = " += \";\" + ";
  protected final String TEXT_155 = ";" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_157 = " = null;" + NL + "\tString query_";
  protected final String TEXT_158 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_159 = " = false;";
  protected final String TEXT_160 = NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_161 = "\", conn_";
  protected final String TEXT_162 = ");";
  protected final String TEXT_163 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".prepareStatement(";
  protected final String TEXT_166 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_171 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
