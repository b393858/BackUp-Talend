...
public class TTeradataInputEndJava
{
  ...
  protected final String TEXT_121 = NL + NL + "\t}" + NL + "}finally{" + NL + "\tif (rs_";
  protected final String TEXT_122 = " != null) {" + NL + "\t\trs_";
  protected final String TEXT_123 = ".close();" + NL + "\t}" + NL + "\tif (stmt_";
  protected final String TEXT_124 = " != null) {" + NL + "\t\tstmt_";
  protected final String TEXT_125 = ".close();" + NL + "\t}";
  protected final String TEXT_126 = NL + "\tif(conn_";
  protected final String TEXT_127 = " != null && !conn_";
  protected final String TEXT_128 = ".isClosed()) {" + NL + "\t    ";
  protected final String TEXT_129 = NL;
  protected final String TEXT_130 = NL + "    conn_";
  protected final String TEXT_131 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_132 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_133 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_134 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_135 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
  protected final String TEXT_136 = NL + "     }catch(Exception e){";
