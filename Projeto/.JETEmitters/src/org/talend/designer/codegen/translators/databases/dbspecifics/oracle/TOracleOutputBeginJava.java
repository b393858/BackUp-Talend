...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_46 = NL + "            // TODO unable to parse integer: ";
  protected final String TEXT_47 = NL + "            // TODO error: ";
  protected final String TEXT_48 = NL + "        /* initialize feature count */" + NL + "        int nbFeature_";
  protected final String TEXT_49 = " = 0;" + NL + "" + NL + "        java.util.Map<String, com.vividsolutions.jts.geom.Envelope> geometryColumnToExtends = new java.util.HashMap<String, com.vividsolutions.jts.geom.Envelope>();";
  protected final String TEXT_50 = NL + NL;
  protected final String TEXT_51 = NL;
  protected final String TEXT_52 = NL + "            int updateKeyCount_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";" + NL + "            if(updateKeyCount_";
  protected final String TEXT_55 = " < 1) {" + NL + "                throw new RuntimeException(\"For update, the schema must have a key\");" + NL + "            }";
  protected final String TEXT_56 = NL + "            int deleteKeyCount_";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ";" + NL + "            if(deleteKeyCount_";
  protected final String TEXT_59 = " < 1) {" + NL + "                throw new RuntimeException(\"For delete, the schema must have a key\");" + NL + "            }";
  ...
  protected final String TEXT_65 = " = 0;" + NL + "" + NL + "    int tmp_batchUpdateCount_";
  protected final String TEXT_66 = " = 0;" + NL + "" + NL + "    int deletedCount_";
  protected final String TEXT_67 = "=0;" + NL + "    int updatedCount_";
  protected final String TEXT_68 = "=0;" + NL + "    int insertedCount_";
  protected final String TEXT_69 = "=0;" + NL + "    int rejectedCount_";
  protected final String TEXT_70 = "=0;" + NL + "" + NL + "    boolean whetherReject_";
  protected final String TEXT_71 = " = false;" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_72 = " = null;" + NL + "" + NL + "    //optional table" + NL + "    String dbschema_";
  protected final String TEXT_73 = " = null;" + NL + "    String tableName_";
  ...
  protected final String TEXT_82 = ") {" + NL + "    \t\t\tString dsAlias_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "        \t\tif (dataSources_";
  protected final String TEXT_85 = ".get(dsAlias_";
  protected final String TEXT_86 = ") == null) {" + NL + "           \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_87 = " + \" available!\");" + NL + "              \t}" + NL + "        \t\tconn_";
  protected final String TEXT_88 = " = dataSources_";
  protected final String TEXT_89 = ".get(dsAlias_";
  protected final String TEXT_90 = ").getConnection();" + NL + "    \t\t} else {";
  protected final String TEXT_91 = NL + "                    String driverClass_";
  protected final String TEXT_92 = " = \"oracle.jdbc.OracleDriver\";";
  protected final String TEXT_93 = NL + "                    String driverClass_";
  protected final String TEXT_94 = " = \"oracle.jdbc.driver.OracleDriver\";";
  protected final String TEXT_95 = NL;
  protected final String TEXT_96 = NL + NL + "                java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_104 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_105 = " + \":\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = ";";
  protected final String TEXT_108 = NL + "                    url_";
  protected final String TEXT_109 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_110 = " + \")(port=\" + ";
  protected final String TEXT_111 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_112 = " + \")))\";";
  protected final String TEXT_113 = NL + "                    url_";
  protected final String TEXT_114 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_131 = ";" + NL + "                dbschema_";
  ...
  protected final String TEXT_137 = ");" + NL + "                    if(dbschema_";
  protected final String TEXT_138 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_139 = ")) //get schema from connection" + NL + "                    {" + NL + "                        dbschema_";
  protected final String TEXT_140 = "=conn_";
  protected final String TEXT_141 = ".getMetaData().getUserName();" + NL + "                    }" + NL;
  protected final String TEXT_142 = NL + "                    conn_";
  protected final String TEXT_143 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_144 = ", dbUser_";
  protected final String TEXT_145 = ", dbPwd_";
  protected final String TEXT_146 = ");";
  protected final String TEXT_147 = NL + "                    java.util.Properties atnParamsPrope_";
  protected final String TEXT_148 = " = new java.util.Properties();" + NL + "                    atnParamsPrope_";
  protected final String TEXT_149 = ".put(\"user\",dbUser_";
  protected final String TEXT_150 = ");" + NL + "                    atnParamsPrope_";
  protected final String TEXT_151 = ".put(\"password\",dbPwd_";
  protected final String TEXT_152 = ");" + NL + "                    if(";
  protected final String TEXT_153 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_154 = ") && !\"\".equals(";
  protected final String TEXT_155 = ")){" + NL + "                        atnParamsPrope_";
  protected final String TEXT_156 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_157 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "                    }" + NL + "                    conn_";
  ...
  protected final String TEXT_162 = NL + "        resourceMap.put(\"conn_";
  protected final String TEXT_163 = "\", conn_";
  protected final String TEXT_164 = ");";
  protected final String TEXT_165 = NL + "            conn_";
  protected final String TEXT_166 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";" + NL + "            int commitCounter_";
  protected final String TEXT_169 = " = 0;";
  protected final String TEXT_170 = NL + "        int batchSize_";
  protected final String TEXT_171 = " = ";
  protected final String TEXT_172 = ";" + NL + "        int batchSizeCounter_";
  protected final String TEXT_173 = "=0;";
  protected final String TEXT_174 = NL + "        int count_";
  protected final String TEXT_175 = "=0;";
  protected final String TEXT_176 = NL + NL + "        if(dbschema_";
  protected final String TEXT_177 = " == null || dbschema_";
  protected final String TEXT_178 = ".trim().length() == 0) {" + NL + "            tableName_";
  protected final String TEXT_179 = " = (";
  protected final String TEXT_180 = ")";
  protected final String TEXT_181 = ";" + NL + "        } else {" + NL + "            tableName_";
  protected final String TEXT_182 = " = dbschema_";
  protected final String TEXT_183 = " + \".\" + (";
  protected final String TEXT_184 = ")";
  protected final String TEXT_185 = ";" + NL + "        }";
  protected final String TEXT_186 = NL + "  \ttableName_";
  protected final String TEXT_187 = " += \" \" +";
  protected final String TEXT_188 = ";";
  protected final String TEXT_189 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_193 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_201 = ".commit();";
  protected final String TEXT_202 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_221 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_241 = NL + "                    String keyCheckTable_";
  protected final String TEXT_242 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_243 = "+\"][\"+";
  protected final String TEXT_244 = "+\"][\"+";
  protected final String TEXT_245 = "+\"][\"+";
  protected final String TEXT_246 = "+\"][\"+";
  protected final String TEXT_247 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_248 = " + \"]\";";
  protected final String TEXT_249 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_252 = " + \"]\";";
  protected final String TEXT_253 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_254 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_255 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_256 = ")== null){//}";
  protected final String TEXT_257 = NL + "                                boolean whetherExist_";
  protected final String TEXT_258 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_259 = " = conn_";
  protected final String TEXT_260 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_264 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_273 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_274 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_278 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_279 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_280 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_300 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_301 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_302 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_303 = " = conn_";
  protected final String TEXT_304 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_305 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_306 = " = dbMetaData_";
  protected final String TEXT_307 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_308 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_309 = " = rsTable_";
  protected final String TEXT_310 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_311 = " = rsTable_";
  protected final String TEXT_312 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  protected final String TEXT_313 = ".equals";
  protected final String TEXT_314 = "IgnoreCase";
  protected final String TEXT_315 = "((";
  protected final String TEXT_316 = ")";
  protected final String TEXT_317 = ".toUpperCase()";
  ...
  protected final String TEXT_323 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_324 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_325 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_326 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_327 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_328 = " = conn_";
  protected final String TEXT_329 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_330 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_331 = " = dbMetaData_";
  protected final String TEXT_332 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_333 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_334 = " == null || dbschema_";
  protected final String TEXT_335 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_338 = " = stmtSchema_";
  protected final String TEXT_339 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_340 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_341 = " = rsSchema_";
  protected final String TEXT_342 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_343 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_344 = " = rsTable_";
  protected final String TEXT_345 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_346 = " = rsTable_";
  protected final String TEXT_347 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  ...
  protected final String TEXT_356 = " ==null || dbschema_";
  protected final String TEXT_357 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_358 = ".equals";
  protected final String TEXT_359 = "IgnoreCase";
  protected final String TEXT_360 = "(schema_";
  protected final String TEXT_361 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_362 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_363 = NL + "                                String tableForSearch_";
  protected final String TEXT_364 = " = ";
  protected final String TEXT_365 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_366 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_367 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_368 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_369 = " =  tableForSearch_";
  protected final String TEXT_370 = ".substring(1,tableForSearch_";
  protected final String TEXT_371 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_372 = " =  tableForSearch_";
  protected final String TEXT_373 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_374 = " = conn_";
  protected final String TEXT_375 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_376 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_377 = " = dbMetaData_";
  protected final String TEXT_378 = ".getTables(null, conn_";
  protected final String TEXT_379 = ".getSchema(), tableForSearch_";
  protected final String TEXT_380 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_381 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_382 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_383 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_384 = " = conn_";
  protected final String TEXT_385 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_386 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_387 = " = dbMetaData_";
  protected final String TEXT_388 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_389 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_390 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_391 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_392 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_393 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_394 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_395 = " = conn_";
  protected final String TEXT_396 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_397 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_398 = " = dbMetaData_";
  protected final String TEXT_399 = ".getTables(";
  protected final String TEXT_400 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_401 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_402 = " = rsTable_";
  protected final String TEXT_403 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_404 = ".equalsIgnoreCase(";
  protected final String TEXT_405 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_406 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_407 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_408 = " = conn_";
  protected final String TEXT_409 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_410 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_411 = " = dbMetaData_";
  protected final String TEXT_412 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_413 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_414 = " = rsTable_";
  protected final String TEXT_415 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_416 = ".equalsIgnoreCase(";
  protected final String TEXT_417 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_418 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_419 = NL + "                                if(!whetherExist_";
  protected final String TEXT_420 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_440 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_446 = NL + "                                        stmtDrop_";
  ...
  protected final String TEXT_453 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_461 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_472 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_473 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_474 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_475 = " = conn_";
  protected final String TEXT_476 = ".createStatement()) {";
  protected final String TEXT_477 = NL + "                              stmtClear_";
  protected final String TEXT_478 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_479 = "));";
  protected final String TEXT_480 = NL + "                stmtClear_";
  protected final String TEXT_481 = ".executeUpdate(\"";
  protected final String TEXT_482 = "\");";
  protected final String TEXT_483 = NL + "            }";
  protected final String TEXT_484 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_485 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_486 = " = conn_";
  protected final String TEXT_487 = ".createStatement()) {";
  protected final String TEXT_488 = NL + "                              stmtTruncCount_";
  protected final String TEXT_489 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_490 = "));";
  protected final String TEXT_491 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_492 = " = stmtTruncCount_";
  protected final String TEXT_493 = ".executeQuery(\"";
  protected final String TEXT_494 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_495 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_496 = " = rsTruncCount_";
  protected final String TEXT_497 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_501 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_502 = "));";
  protected final String TEXT_503 = NL + "                conn_";
  protected final String TEXT_504 = ".commit();";
  protected final String TEXT_505 = NL + "                stmtTrunc_";
  protected final String TEXT_506 = ".executeUpdate(\"";
  protected final String TEXT_507 = "\");";
  protected final String TEXT_508 = NL + "                    if(!conn_";
  protected final String TEXT_509 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_510 = ".commit();" + NL + "                    }";
  protected final String TEXT_511 = NL + "                deletedCount_";
  protected final String TEXT_512 = " += rsTruncCountNumber_";
  protected final String TEXT_513 = ";" + NL + "            }";
  protected final String TEXT_514 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_515 = " = conn_";
  protected final String TEXT_516 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_517 = " = stmtTruncCount_";
  protected final String TEXT_518 = ".executeQuery(\"";
  protected final String TEXT_519 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_520 = " = conn_";
  protected final String TEXT_521 = ".createStatement()) {";
  protected final String TEXT_522 = NL + "                conn_";
  protected final String TEXT_523 = ".commit();";
  protected final String TEXT_524 = NL + "                stmtTrunc_";
  protected final String TEXT_525 = ".executeUpdate(\"";
  protected final String TEXT_526 = "\");";
  protected final String TEXT_527 = NL + "                while(rsTruncCount_";
  protected final String TEXT_528 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_529 = " += rsTruncCount_";
  protected final String TEXT_530 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_548 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_549 = "\", pstmt_";
  protected final String TEXT_550 = ");";
  protected final String TEXT_551 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_552 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_553 = " = conn_";
  protected final String TEXT_554 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_555 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_556 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_557 = ",insert_";
  protected final String TEXT_558 = ",keyPsmt_";
  ...
  protected final String TEXT_565 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_566 = " = new StringBuffer(update_";
  protected final String TEXT_567 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_568 = ".insert(update_";
  protected final String TEXT_569 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_570 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_571 = " =updateStringBuffer_";
  ...
  protected final String TEXT_576 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_577 = "\", pstmt_";
  protected final String TEXT_578 = ");";
  protected final String TEXT_579 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_580 = " = conn_";
  protected final String TEXT_581 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_582 = " + \" WHERE ";
  protected final String TEXT_583 = "\");" + NL + "                resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_598 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_599 = " = conn_";
  protected final String TEXT_600 = ".prepareStatement(insert_";
  protected final String TEXT_601 = ");" + NL + "                resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_602 = "\", pstmtInsert_";
  ...
  protected final String TEXT_616 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_617 = " = conn_";
  protected final String TEXT_618 = ".prepareStatement(update_";
  protected final String TEXT_619 = ");" + NL + "                resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_620 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_627 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_628 = " = new StringBuffer(update_";
  protected final String TEXT_629 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_630 = ".insert(update_";
  protected final String TEXT_631 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_632 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_633 = " =updateStringBuffer_";
  protected final String TEXT_634 = ".toString(); ";
  protected final String TEXT_635 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_636 = " = conn_";
  protected final String TEXT_637 = ".prepareStatement(update_";
  protected final String TEXT_638 = ");" + NL + "                resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_639 = "\", pstmtUpdate_";
  protected final String TEXT_640 = ");" + NL + "                String insert_";
  protected final String TEXT_641 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_642 = " + \" (";
  protected final String TEXT_643 = ") VALUES (";
  protected final String TEXT_644 = ")\";";
  protected final String TEXT_645 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_646 = " = new StringBuffer(insert_";
  protected final String TEXT_647 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_648 = ".insert(insert_";
  protected final String TEXT_649 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_650 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_651 = " =insertStringBuffer_";
  protected final String TEXT_652 = ".toString(); ";
  protected final String TEXT_653 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_654 = " = conn_";
  protected final String TEXT_655 = ".prepareStatement(insert_";
  protected final String TEXT_656 = ");" + NL + "                resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_657 = "\", pstmtInsert_";
  protected final String TEXT_658 = ");";
  protected final String TEXT_659 = NL + "                String delete_";
  protected final String TEXT_660 = " = \"DELETE FROM \" + tableName_";
  ...
  protected final String TEXT_674 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_675 = "\", pstmt_";
  protected final String TEXT_676 = ");";
  protected final String TEXT_677 = NL + "                StringBuffer query_";
  protected final String TEXT_678 = " = null;";
  protected final String TEXT_679 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_680 = " = insert_";
  ...
  protected final String TEXT_684 = " = update_";
  protected final String TEXT_685 = ".split(\"\\\\?\");";
  protected final String TEXT_686 = NL + "\t\t\tupdate_";
  protected final String TEXT_687 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_688 = " = update_";
  protected final String TEXT_689 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_690 = " = insert_";
  protected final String TEXT_691 = ".split(\"\\\\?\");";
  protected final String TEXT_692 = NL + "\t\t\tdelete_";
  protected final String TEXT_693 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_694 = " = delete_";
  protected final String TEXT_695 = ".split(\"\\\\?\");";
  protected final String TEXT_696 = NL + "\t\t\treplace_";
  protected final String TEXT_697 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_698 = " = replace_";
  protected final String TEXT_699 = ".split(\"\\\\?\");";
  protected final String TEXT_700 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_701 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_702 = " = insertIgnore_";
  protected final String TEXT_703 = ".split(\"\\\\?\");";
  protected final String TEXT_704 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_705 = " = insert_";
  protected final String TEXT_706 = ".split(\"\\\\?\");";
  protected final String TEXT_707 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_708 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_709 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_710 = " = true;";
  protected final String TEXT_711 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_712 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_713 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_714 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_715 = " clobTypeUtil_";
  protected final String TEXT_716 = "=new ClobTypeUtil_";
  protected final String TEXT_717 = "();";
  protected final String TEXT_718 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_719 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_720 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_721 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_722 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_723 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_724 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_725 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_726 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_727 = " blobTypeUtil_";
  protected final String TEXT_728 = "=new BlobTypeUtil_";
  protected final String TEXT_729 = "();";
  protected final String TEXT_730 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_731 = " =null;" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_732 = " =null;" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_733 = " =null;";
  protected final String TEXT_734 = NL + "            StringBuffer query_";
  ...
  protected final String TEXT_738 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_739 = " =  null;";
  protected final String TEXT_740 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_741 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_742 = " = null;";
  protected final String TEXT_743 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_744 = " = null;";
  protected final String TEXT_745 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_746 = " = null;";
  protected final String TEXT_747 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_748 = " = null;";
  protected final String TEXT_749 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_750 = " = null;";
  protected final String TEXT_751 = NL + NL + NL + NL;
