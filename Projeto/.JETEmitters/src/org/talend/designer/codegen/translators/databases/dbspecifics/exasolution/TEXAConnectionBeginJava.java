...
public class TEXAConnectionBeginJava
{
  ...
  protected final String TEXT_37 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_38 = " + \":\" + ";
  protected final String TEXT_39 = " + \";schema=\" + ";
  ...
  protected final String TEXT_97 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_98 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_100 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_101 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_102 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_113 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\tconn_";
  protected final String TEXT_115 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\tconn_";
  protected final String TEXT_117 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\tconn_";
  protected final String TEXT_119 = ".setAutoCommit(";
  protected final String TEXT_120 = ");" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\tlog.";
  protected final String TEXT_122 = "(\"";
  protected final String TEXT_123 = " - \" + ";
  protected final String TEXT_124 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t    \t\tlog.";
  protected final String TEXT_126 = "(\"";
  protected final String TEXT_127 = "\");" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_129 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_131 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_132 = ": pstmt_";
  protected final String TEXT_133 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_134 = " += (countEach_";
  protected final String TEXT_135 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_139 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  ...
  protected final String TEXT_146 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_149 = ".get(dsAlias_";
  protected final String TEXT_150 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_151 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_152 = " = dataSources_";
  protected final String TEXT_153 = ".get(dsAlias_";
  protected final String TEXT_154 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_155 = "\", conn_";
  protected final String TEXT_156 = ");" + NL + "\t}";
  protected final String TEXT_157 = NL + "\tif (null != conn_";
  protected final String TEXT_158 = ") {" + NL + "\t\t";
  protected final String TEXT_159 = NL + "\t}";
  protected final String TEXT_160 = NL + "   // provide the schema for usage in input and output components" + NL + "   // schemas are always in upper case letters" + NL + "\tglobalMap.put(\"schema_\" + \"";
  protected final String TEXT_161 = "\",";
  protected final String TEXT_162 = ");" + NL + "    // provide the connection for further usage in other components" + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_163 = "\",conn_";
  protected final String TEXT_164 = ");" + NL + "\tglobalMap.put(\"host_\" + \"";
  protected final String TEXT_165 = "\", ";
  protected final String TEXT_166 = "); " + NL + "\tglobalMap.put(\"port_\" + \"";
  protected final String TEXT_167 = "\", ";
  protected final String TEXT_168 = ");" + NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_169 = "\", ";
  protected final String TEXT_170 = "); " + NL + "\tglobalMap.put(\"password_\" + \"";
