...
public class TMaxDBRowFinallyJava
{
  protected static String nl;
  public static synchronized TMaxDBRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMaxDBRowFinallyJava result = new TMaxDBRowFinallyJava();
    nl = null;
    return result;
  }
