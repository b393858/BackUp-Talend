...
public class TCosmosDBRowEndJava
{
  protected static String nl;
  public static synchronized TCosmosDBRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBRowEndJava result = new TCosmosDBRowEndJava();
    nl = null;
    return result;
  }
