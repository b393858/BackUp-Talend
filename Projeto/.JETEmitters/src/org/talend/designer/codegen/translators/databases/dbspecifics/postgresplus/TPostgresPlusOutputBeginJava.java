...
public class TPostgresPlusOutputBeginJava {
  ...
  protected final String TEXT_12 = NL + "            if (log.isDebugEnabled()) {" + NL + "                class BytesLimit65535_";
  protected final String TEXT_13 = "{" + NL + "                    public void limitLog4jByte() throws Exception{" + NL + "                    StringBuilder ";
  ...
  protected final String TEXT_27 = NL + "                    } " + NL + "                } " + NL + "            new BytesLimit65535_";
  protected final String TEXT_28 = "().limitLog4jByte();" + NL + "            }";
  ...
  protected final String TEXT_84 = NL + "       int batchSize_";
  protected final String TEXT_85 = " = ";
  protected final String TEXT_86 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_87 = "=0;" + NL + "       int tmp_batchUpdateCount_";
  protected final String TEXT_88 = " = 0;";
  protected final String TEXT_89 = NL + NL + "java.sql.Connection conn_";
  protected final String TEXT_90 = " = null;";
  protected final String TEXT_91 = NL + "\tconn_";
  protected final String TEXT_92 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_93 = "\");" + NL + "\t";
  protected final String TEXT_94 = NL + "\t";
  protected final String TEXT_95 = NL + "\t";
  protected final String TEXT_96 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  ...
  protected final String TEXT_127 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_139 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_148 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_149 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_150 = " = \"public\";" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_151 = " = dbMetaData_";
  protected final String TEXT_152 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                if(dbschema_";
  protected final String TEXT_153 = " == null || dbschema_";
  protected final String TEXT_154 = ".trim().length() == 0) {" + NL + "                    try (java.sql.Statement stmtSchema_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = ".createStatement();" + NL + "                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_157 = " = stmtSchema_";
  protected final String TEXT_158 = ".executeQuery(\"select current_schema() \")) {" + NL + "                        while(rsSchema_";
  protected final String TEXT_159 = ".next()){" + NL + "                            defaultSchema_";
  protected final String TEXT_160 = " = rsSchema_";
  protected final String TEXT_161 = ".getString(\"current_schema\");" + NL + "                        }" + NL + "                    }" + NL + "                }" + NL + "                while(rsTable_";
  protected final String TEXT_162 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_163 = " = rsTable_";
  protected final String TEXT_164 = ".getString(\"TABLE_NAME\");" + NL + "                    String schema_";
  protected final String TEXT_165 = " = rsTable_";
  protected final String TEXT_166 = ".getString(\"TABLE_SCHEM\");" + NL + "                    if(table_";
  protected final String TEXT_167 = ".equals(";
  protected final String TEXT_168 = ")" + NL + "                        && (schema_";
  protected final String TEXT_169 = ".equals(dbschema_";
  protected final String TEXT_170 = ") || ((dbschema_";
  protected final String TEXT_171 = " == null || dbschema_";
  protected final String TEXT_172 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_173 = ".equals(schema_";
  protected final String TEXT_174 = ")))) {" + NL + "                        whetherExist_";
  protected final String TEXT_175 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  protected final String TEXT_176 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_185 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_191 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_198 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement()) {";
  protected final String TEXT_201 = NL + "                deletedCount_";
  protected final String TEXT_202 = " = deletedCount_";
  protected final String TEXT_203 = " + stmtClear_";
  protected final String TEXT_204 = ".executeUpdate(\"";
  protected final String TEXT_205 = "\");";
  protected final String TEXT_206 = NL + "            }";
  protected final String TEXT_207 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".createStatement();" + NL + "                    java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_210 = " = stmtTruncCount_";
  protected final String TEXT_211 = ".executeQuery(\"";
  protected final String TEXT_212 = "\");" + NL + "                    java.sql.Statement stmtTrunc_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement()) {";
  protected final String TEXT_215 = NL + "                stmtTrunc_";
  protected final String TEXT_216 = ".executeUpdate(\"";
  protected final String TEXT_217 = "\");";
  protected final String TEXT_218 = NL + "                while(rsTruncCount_";
  protected final String TEXT_219 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_220 = " += rsTruncCount_";
  protected final String TEXT_221 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_229 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_230 = "\", pstmt_";
  protected final String TEXT_231 = ");" + NL + "\t    ";
  protected final String TEXT_232 = NL + "\t    String update_";
  protected final String TEXT_233 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_238 = ".prepareStatement(update_";
  protected final String TEXT_239 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_244 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_245 = " + \"\\\" WHERE ";
  protected final String TEXT_246 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_251 = ") VALUES (";
  protected final String TEXT_252 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".prepareStatement(insert_";
  protected final String TEXT_255 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_256 = "\", pstmtInsert_";
  protected final String TEXT_257 = ");" + NL + "\t    String update_";
  protected final String TEXT_258 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_259 = " + \"\\\" SET ";
  protected final String TEXT_260 = " WHERE ";
  protected final String TEXT_261 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = ".prepareStatement(update_";
  protected final String TEXT_264 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_265 = "\", pstmtUpdate_";
  protected final String TEXT_266 = ");" + NL + "\t    ";
  protected final String TEXT_267 = NL + "\t    String update_";
  protected final String TEXT_268 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_269 = " + \"\\\" SET ";
  protected final String TEXT_270 = " WHERE ";
  protected final String TEXT_271 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_272 = " = conn_";
  protected final String TEXT_273 = ".prepareStatement(update_";
  protected final String TEXT_274 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_275 = "\", pstmtUpdate_";
  protected final String TEXT_276 = ");" + NL + "\t    String insert_";
  protected final String TEXT_277 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_278 = " + \"\\\" (";
  protected final String TEXT_279 = ") VALUES (";
  protected final String TEXT_280 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_281 = " = conn_";
  protected final String TEXT_282 = ".prepareStatement(insert_";
  protected final String TEXT_283 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_284 = "\", pstmtInsert_";
  protected final String TEXT_285 = ");" + NL + "\t    ";
  protected final String TEXT_286 = NL + "\t    String delete_";
  protected final String TEXT_287 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_288 = " + \"\\\" WHERE ";
  protected final String TEXT_289 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_290 = " = conn_";
  protected final String TEXT_291 = ".prepareStatement(delete_";
  protected final String TEXT_292 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_293 = "\", pstmt_";
  protected final String TEXT_294 = ");" + NL + "\t    ";
  protected final String TEXT_295 = NL + "        StringBuffer query_";
  protected final String TEXT_296 = " = null;" + NL + "       \t";
  protected final String TEXT_297 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_298 = " = insert_";
  protected final String TEXT_299 = ".split(\"\\\\?\");";
  protected final String TEXT_300 = NL + "\t\t\tupdate_";
  protected final String TEXT_301 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_302 = " = update_";
  protected final String TEXT_303 = ".split(\"\\\\?\");";
  protected final String TEXT_304 = NL + "\t\t\tupdate_";
  protected final String TEXT_305 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_306 = " = update_";
  protected final String TEXT_307 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_308 = " = insert_";
  protected final String TEXT_309 = ".split(\"\\\\?\");";
  protected final String TEXT_310 = NL + "\t\t\tdelete_";
  protected final String TEXT_311 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_312 = " = delete_";
  protected final String TEXT_313 = ".split(\"\\\\?\");";
  protected final String TEXT_314 = NL + "\t\t\treplace_";
  protected final String TEXT_315 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_316 = " = replace_";
  protected final String TEXT_317 = ".split(\"\\\\?\");";
  protected final String TEXT_318 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_319 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_320 = " = insertIgnore_";
  protected final String TEXT_321 = ".split(\"\\\\?\");";
  protected final String TEXT_322 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_323 = " = insert_";
  protected final String TEXT_324 = ".split(\"\\\\?\");";
