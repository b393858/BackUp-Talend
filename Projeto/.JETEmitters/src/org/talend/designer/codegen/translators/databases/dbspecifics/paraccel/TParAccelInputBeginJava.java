...
public class TParAccelInputBeginJava
{
  ...
  protected final String TEXT_188 = " > 0) {" + NL + "\t\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_189 = " = new java.io.FileWriter(";
  protected final String TEXT_190 = ", true);" + NL + "\t\t\t\t\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_191 = ",true));" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\tcom.paraccel.Driver.setLogLevel(";
  protected final String TEXT_192 = ");" + NL + "" + NL + "\t\t\tString url_";
  protected final String TEXT_193 = " = \"jdbc:paraccel://\" + ";
  protected final String TEXT_194 = " + \":\" + ";
  protected final String TEXT_195 = " + \"/\" + ";
  protected final String TEXT_196 = " +\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_197 = "+\"&protocolVersion=3\";";
  protected final String TEXT_198 = NL + "                stmt_";
  protected final String TEXT_199 = ".setFetchSize(";
