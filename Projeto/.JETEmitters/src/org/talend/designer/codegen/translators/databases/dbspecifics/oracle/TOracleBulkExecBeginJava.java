...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_78 = NL + "        int keyCount_";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_81 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "        }";
  protected final String TEXT_82 = NL + NL + "java.sql.Connection conn_";
  protected final String TEXT_83 = " = null;" + NL + "String serviceUrl_";
  protected final String TEXT_84 = " = null;" + NL + "String host_";
  protected final String TEXT_85 = " = null;" + NL + "String dbname_";
  protected final String TEXT_86 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_87 = " = null;" + NL + "String dbUser_";
  protected final String TEXT_88 = " = null;" + NL + "String dbPwd_";
  protected final String TEXT_89 = " = null;" + NL + "String port_";
  protected final String TEXT_90 = " = null;" + NL + "String connectionType_";
  protected final String TEXT_91 = "=null;" + NL + "String url_";
  protected final String TEXT_92 = " = null;" + NL + "int deletedCount_";
  protected final String TEXT_93 = "=0;";
  protected final String TEXT_94 = NL + "    host_";
  protected final String TEXT_95 = " = (String)globalMap.get(\"";
  protected final String TEXT_96 = "\");" + NL + "    dbname_";
  ...
  protected final String TEXT_102 = "\");" + NL + "    dbPwd_";
  protected final String TEXT_103 = " = (String)globalMap.get(\"";
  protected final String TEXT_104 = "\");" + NL + "    port_";
  protected final String TEXT_105 = " = (String)globalMap.get(\"";
  protected final String TEXT_106 = "\");" + NL + "    connectionType_";
  protected final String TEXT_107 = " = (String)globalMap.get(\"";
  protected final String TEXT_108 = "\");" + NL + "    url_";
  protected final String TEXT_109 = " = (String)globalMap.get(\"";
  protected final String TEXT_110 = "\");" + NL + "    if (\"ORACLE_RAC\".equals(connectionType_";
  protected final String TEXT_111 = ")) {" + NL + "        serviceUrl_";
  protected final String TEXT_112 = " = url_";
  protected final String TEXT_113 = ".substring(url_";
  protected final String TEXT_114 = ".indexOf(\"@\")+1);" + NL + "    } else if(\"ORACLE_SID\".equals(connectionType_";
  protected final String TEXT_115 = ")) {" + NL + "        serviceUrl_";
  protected final String TEXT_116 = " = \"(description=(address=(protocol=tcp)(host=\" + host_";
  protected final String TEXT_117 = " + \")(port=\" + port_";
  protected final String TEXT_118 = " + \"))(connect_data=(SID=\" + dbname_";
  protected final String TEXT_119 = " + \")))\";" + NL + "    }else {" + NL + "        serviceUrl_";
  protected final String TEXT_120 = " = \"(description=(address=(protocol=tcp)(host=\" + host_";
  protected final String TEXT_121 = " + \")(port=\" + port_";
  protected final String TEXT_122 = " + \"))(connect_data=(service_name=\" + dbname_";
  protected final String TEXT_123 = " + \")))\";" + NL + "    }" + NL + "" + NL + "" + NL + "    conn_";
  protected final String TEXT_124 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_125 = "\");";
  protected final String TEXT_126 = NL + "        host_";
  protected final String TEXT_127 = " = ";
  protected final String TEXT_128 = ";" + NL + "        dbname_";
  protected final String TEXT_129 = " = ";
  protected final String TEXT_130 = ";" + NL + "        dbschema_";
  ...
  protected final String TEXT_143 = NL + NL + "    dbPwd_";
  protected final String TEXT_144 = " = decryptedPassword_";
  protected final String TEXT_145 = ";" + NL;
  protected final String TEXT_146 = NL + "        url_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";" + NL + "        serviceUrl_";
  protected final String TEXT_149 = " = url_";
  protected final String TEXT_150 = ".substring(url_";
  protected final String TEXT_151 = ".indexOf(\"@\")+1);";
  protected final String TEXT_152 = NL + "        serviceUrl_";
  protected final String TEXT_153 = " = \"(description=(address=(protocol=tcp)(host=\" + host_";
  protected final String TEXT_154 = " + \")(port=\" + ";
  protected final String TEXT_155 = " + \"))(connect_data=(SID=\" + dbname_";
  protected final String TEXT_156 = " + \")))\";" + NL + "        url_";
  protected final String TEXT_157 = " = \"jdbc:oracle:thin:@\" + host_";
  protected final String TEXT_158 = " + \":\" + ";
  protected final String TEXT_159 = " + \":\" + dbname_";
  protected final String TEXT_160 = ";";
  protected final String TEXT_161 = NL + "        serviceUrl_";
  protected final String TEXT_162 = " = \"(description=(address=(protocol=tcp)(host=\" + host_";
  protected final String TEXT_163 = " + \")(port=\" + ";
  protected final String TEXT_164 = " + \"))(connect_data=(service_name=\" + dbname_";
  protected final String TEXT_165 = " + \")))\";" + NL + "        url_";
  protected final String TEXT_166 = " = \"jdbc:oracle:thin:@\" + serviceUrl_";
  protected final String TEXT_167 = ";";
  protected final String TEXT_168 = NL + "        serviceUrl_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";" + NL + "        url_";
  protected final String TEXT_171 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_172 = ";";
  protected final String TEXT_173 = NL + "        String driverClass_";
  protected final String TEXT_174 = " = \"oracle.jdbc.OracleDriver\";";
  protected final String TEXT_175 = NL + "        String driverClass_";
  protected final String TEXT_176 = " = \"oracle.jdbc.driver.OracleDriver\";";
  protected final String TEXT_177 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_178 = ");";
  protected final String TEXT_179 = NL + "    java.util.Properties atnParamsPrope_";
  protected final String TEXT_180 = " = new java.util.Properties();" + NL + "    atnParamsPrope_";
  protected final String TEXT_181 = ".put(\"user\",dbUser_";
  protected final String TEXT_182 = ");" + NL + "    atnParamsPrope_";
  protected final String TEXT_183 = ".put(\"password\",dbPwd_";
  protected final String TEXT_184 = ");" + NL + "    if(";
  protected final String TEXT_185 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_186 = ") && !\"\".equals(";
  protected final String TEXT_187 = ")){" + NL + "        atnParamsPrope_";
  protected final String TEXT_188 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_189 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "    }";
  protected final String TEXT_190 = NL + "    conn_";
  protected final String TEXT_191 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_192 = ", atnParamsPrope_";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL;
  protected final String TEXT_195 = NL + "String tableName_";
  protected final String TEXT_196 = " = null;" + NL + "if(\"ORACLE_RAC\".equals(\"";
  protected final String TEXT_197 = "\")||dbschema_";
  protected final String TEXT_198 = " == null || dbschema_";
  protected final String TEXT_199 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_202 = " = dbschema_";
  protected final String TEXT_203 = " + \".\" + ";
  protected final String TEXT_204 = ";" + NL + "}";
  protected final String TEXT_205 = NL + "    String tmpTableName_";
  protected final String TEXT_206 = " = tableName_";
  protected final String TEXT_207 = ";" + NL + "" + NL + "    String uniqueTableName_";
  protected final String TEXT_208 = " = \"t\" + java.util.UUID.randomUUID().toString().replace(\"-\",\"\").substring(0,28);" + NL + "    tableName_";
  protected final String TEXT_209 = " = uniqueTableName_";
  protected final String TEXT_210 = ";";
  protected final String TEXT_211 = NL;
  protected final String TEXT_212 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_216 = " - Droping table ";
  protected final String TEXT_217 = "\" + tableName_";
  ...
  protected final String TEXT_224 = " - Drop table ";
  protected final String TEXT_225 = "\" + tableName_";
  protected final String TEXT_226 = " + \"";
  protected final String TEXT_227 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_228 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_229 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_233 = " - Creating table ";
  protected final String TEXT_234 = "\" + tableName_";
  ...
  protected final String TEXT_241 = " - Create table ";
  protected final String TEXT_242 = "\" + tableName_";
  protected final String TEXT_243 = " + \"";
  protected final String TEXT_244 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_245 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_246 = ".close();" + NL + "\t\t";
  protected final String TEXT_247 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_251 = " - Creating table ";
  protected final String TEXT_252 = "\" + tableName_";
  ...
  protected final String TEXT_259 = " - Create table ";
  protected final String TEXT_260 = "\" + tableName_";
  protected final String TEXT_261 = " + \"";
  protected final String TEXT_262 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_268 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_269 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_270 = " = tableNameForSearch_";
  protected final String TEXT_271 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_272 = " = tableNameForSearch_";
  protected final String TEXT_273 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_274 = " = dbMetaData_";
  protected final String TEXT_275 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_276 = ", tableNameForSearch_";
  ...
  protected final String TEXT_293 = ".equalsIgnoreCase(";
  protected final String TEXT_294 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_295 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_308 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_312 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_313 = ".equals(schema_";
  protected final String TEXT_314 = ") || (schema_";
  protected final String TEXT_315 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_316 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_384 = ".getTables(null, dbschema_";
  ...
  protected final String TEXT_388 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_396 = ".getTables(";
  protected final String TEXT_397 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_402 = ".equals";
  protected final String TEXT_403 = "IgnoreCase";
  protected final String TEXT_404 = "(";
  protected final String TEXT_405 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_406 = " = true;" + NL + "                    break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_407 = ".close();";
  protected final String TEXT_408 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_409 = " = conn_";
  protected final String TEXT_410 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_411 = " = dbMetaData_";
  protected final String TEXT_412 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_413 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_414 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_415 = " = rsTable_";
  protected final String TEXT_416 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_417 = ".equals";
  protected final String TEXT_418 = "IgnoreCase";
  protected final String TEXT_419 = "(";
  protected final String TEXT_420 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_421 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_422 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_424 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_428 = " - Creating table ";
  ...
  protected final String TEXT_436 = " - Create table ";
  ...
  protected final String TEXT_441 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_442 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_443 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_447 = " - Droping table ";
  protected final String TEXT_448 = "\" + tableName_";
  protected final String TEXT_449 = " + \"";
  protected final String TEXT_450 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_452 = ".execute(\"";
  protected final String TEXT_453 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_454 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_455 = " - Drop table ";
  protected final String TEXT_456 = "\" + tableName_";
  protected final String TEXT_457 = " + \"";
  protected final String TEXT_458 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_460 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_464 = " - Creating table ";
  protected final String TEXT_465 = "\" + tableName_";
  protected final String TEXT_466 = " + \"";
  protected final String TEXT_467 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_468 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_469 = ".execute(\"";
  protected final String TEXT_470 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_471 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_472 = " - Create table ";
  protected final String TEXT_473 = "\" + tableName_";
  protected final String TEXT_474 = " + \"";
  protected final String TEXT_475 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_476 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_477 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_478 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_482 = " - Clearing table ";
  protected final String TEXT_483 = "\" + tableName_";
  protected final String TEXT_484 = " + \"";
  protected final String TEXT_485 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_486 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_490 = "- Clear table ";
  protected final String TEXT_491 = "\" + tableName_";
  protected final String TEXT_492 = " + \"";
  protected final String TEXT_493 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_494 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_495 = ".close();" + NL + "\t\t";
  ...
  protected final String TEXT_503 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_504 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_505 = " - Trancating table ";
  protected final String TEXT_506 = "\" + tableName_";
  ...
  protected final String TEXT_513 = " - Truncate table ";
  protected final String TEXT_514 = "\" + tableName_";
  protected final String TEXT_515 = " + \"";
  protected final String TEXT_516 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_523 = ".close();" + NL + "\t\t";
  protected final String TEXT_524 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_525 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_526 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_527 = NL + "boolean isDirect_";
  protected final String TEXT_528 = " = false;\t";
  protected final String TEXT_529 = NL + NL + "    String ctlf_";
  protected final String TEXT_530 = " = ";
  protected final String TEXT_531 = ";" + NL + "    String logf_";
  protected final String TEXT_532 = " = ";
  protected final String TEXT_533 = "+\".log\";" + NL + "\t" + NL + "\ttry {" + NL + "\t\tjava.io.BufferedReader ctlf_br_";
  protected final String TEXT_534 = " = new java.io.BufferedReader(new java.io.FileReader(ctlf_";
  protected final String TEXT_535 = "));" + NL + "\t\t" + NL + "\t\ttry{" + NL + "\t\t\tString optionLine_";
  protected final String TEXT_536 = " = ctlf_br_";
  protected final String TEXT_537 = ".readLine();" + NL + "\t\t\tString regex_";
  protected final String TEXT_538 = " = \"\\\\bdirect\\\\s*=\\\\s*true\\\\b\";" + NL + "\t\t\tjava.util.regex.Pattern pattern_";
  protected final String TEXT_539 = " = java.util.regex.Pattern.compile(regex_";
  protected final String TEXT_540 = ", java.util.regex.Pattern.CASE_INSENSITIVE);" + NL + "\t\t\tjava.util.regex.Matcher matcher_";
  protected final String TEXT_541 = " = pattern_";
  protected final String TEXT_542 = ".matcher(optionLine_";
  protected final String TEXT_543 = ");" + NL + "\t\t\tisDirect_";
  protected final String TEXT_544 = " = matcher_";
  protected final String TEXT_545 = ".find();\t\t" + NL + "\t\t}" + NL + "\t\tfinally\t{" + NL + "\t\t\tctlf_br_";
  protected final String TEXT_546 = ".close();" + NL + "\t\t}" + NL + "\t}catch(java.io.IOException ioe) {";
  protected final String TEXT_547 = NL + "\t\tthrow ioe;" + NL + "    }" + NL + "\t";
  protected final String TEXT_548 = NL + "       isDirect_";
  protected final String TEXT_549 = " = ";
  protected final String TEXT_550 = ";";
  protected final String TEXT_551 = NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_552 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_553 = ".append(\"OPTIONS (\");";
  protected final String TEXT_554 = NL + "            optionClause_";
  protected final String TEXT_555 = ".append(\", \");";
  protected final String TEXT_556 = NL + "                    optionClause_";
  protected final String TEXT_557 = ".append(\"";
  protected final String TEXT_558 = "=(";
  protected final String TEXT_559 = ")\");";
  protected final String TEXT_560 = NL + "                    optionClause_";
  protected final String TEXT_561 = ".append(\"";
  protected final String TEXT_562 = "=";
  protected final String TEXT_563 = "\");";
  protected final String TEXT_564 = NL + "                if(";
  protected final String TEXT_565 = ".split(\",\").length>1){" + NL + "                    optionClause_";
  protected final String TEXT_566 = ".append(\"";
  protected final String TEXT_567 = "=(\"+";
  protected final String TEXT_568 = "+\")\");" + NL + "                }else{" + NL + "                    optionClause_";
  protected final String TEXT_569 = ".append(\"";
  protected final String TEXT_570 = "=\"+";
  protected final String TEXT_571 = ");" + NL + "                }";
  protected final String TEXT_572 = NL + "                optionClause_";
  protected final String TEXT_573 = ".append(\"";
  protected final String TEXT_574 = "=";
  protected final String TEXT_575 = "\");";
  protected final String TEXT_576 = NL + "                optionClause_";
  protected final String TEXT_577 = ".append(\"";
  protected final String TEXT_578 = "='\"+";
  protected final String TEXT_579 = "+\"'\");";
  protected final String TEXT_580 = NL + "                optionClause_";
  protected final String TEXT_581 = ".append(\"";
  protected final String TEXT_582 = "=";
  protected final String TEXT_583 = "\");";
  protected final String TEXT_584 = NL + "                optionClause_";
  protected final String TEXT_585 = ".append(\"";
  protected final String TEXT_586 = "=\"+";
  protected final String TEXT_587 = ");";
  protected final String TEXT_588 = NL + "    optionClause_";
  protected final String TEXT_589 = ".append(\")\");";
  protected final String TEXT_590 = NL + "    String dataf_";
  protected final String TEXT_591 = " = ";
  protected final String TEXT_592 = " + Thread.currentThread().getId();" + NL + "" + NL + "    String ctlf_";
  protected final String TEXT_593 = " = dataf_";
  protected final String TEXT_594 = " + \".ctl\";" + NL + "" + NL + "    String badf_";
  protected final String TEXT_595 = " = dataf_";
  protected final String TEXT_596 = " + \".bad\";" + NL + "" + NL + "    String dscf_";
  protected final String TEXT_597 = " = dataf_";
  protected final String TEXT_598 = " + \".dsc\";" + NL + "" + NL + "    String logf_";
  protected final String TEXT_599 = " = dataf_";
  protected final String TEXT_600 = " + \".log\";" + NL + "" + NL + "    dataf_";
  protected final String TEXT_601 = " = ";
  protected final String TEXT_602 = ";" + NL + "" + NL + "    java.io.File badFile_";
  protected final String TEXT_603 = " = new java.io.File(badf_";
  protected final String TEXT_604 = ");" + NL + "" + NL + "    if(badFile_";
  protected final String TEXT_605 = ".exists()){" + NL + "" + NL + "        badFile_";
  protected final String TEXT_606 = ".delete();" + NL + "" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_607 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_608 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_609 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_610 = " ,false) ;" + NL + "" + NL + "    pw_";
  protected final String TEXT_611 = ".println(optionClause_";
  protected final String TEXT_612 = ".toString());" + NL + "" + NL + "    pw_";
  protected final String TEXT_613 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_614 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_615 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_616 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_617 = " + \"'\");" + NL;
  protected final String TEXT_618 = NL + "        bw_";
  protected final String TEXT_619 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_620 = NL + NL + NL;
  protected final String TEXT_621 = NL + "        bw_";
  protected final String TEXT_622 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_623 = " + \"'\\\"\");";
  protected final String TEXT_624 = NL + "        bw_";
  protected final String TEXT_625 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_626 = " + \"\\\"\");";
  protected final String TEXT_627 = NL + "        bw_";
  protected final String TEXT_628 = ".write(\" \\\"var \" + ";
  protected final String TEXT_629 = " + \"\\\"\");";
  protected final String TEXT_630 = NL + "    pw_";
  protected final String TEXT_631 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_632 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_633 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_634 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_635 = " + \"'\");";
  protected final String TEXT_636 = NL + "        pw_";
  protected final String TEXT_637 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_638 = NL + "        bw_";
  protected final String TEXT_639 = ".write(";
  protected final String TEXT_640 = ");";
  protected final String TEXT_641 = NL + "            pw_";
  protected final String TEXT_642 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_643 = ");" + NL + "            pw_";
  protected final String TEXT_644 = ".println(\"INSERT\");";
  protected final String TEXT_645 = NL + "            pw_";
  protected final String TEXT_646 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_647 = ");" + NL + "            pw_";
  protected final String TEXT_648 = ".println(\"";
  protected final String TEXT_649 = "\");";
  protected final String TEXT_650 = NL + "                pw_";
  protected final String TEXT_651 = ".println(\"WHEN \" + ";
  protected final String TEXT_652 = ");";
  protected final String TEXT_653 = NL + "            bw_";
  protected final String TEXT_654 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_655 = "\");";
  protected final String TEXT_656 = NL + "            bw_";
  protected final String TEXT_657 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_658 = " + \"\\\"\");";
  protected final String TEXT_659 = NL + "                bw_";
  protected final String TEXT_660 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_661 = NL + "                bw_";
  protected final String TEXT_662 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_663 = NL + "            bw_";
  protected final String TEXT_664 = ".write(\"'\" + ";
  protected final String TEXT_665 = " + \"'\");";
  protected final String TEXT_666 = NL + "                bw_";
  protected final String TEXT_667 = ".write(\" AND '\" + ";
  protected final String TEXT_668 = " + \"'\");";
  protected final String TEXT_669 = NL + "            pw_";
  protected final String TEXT_670 = ".println(\"\");";
  protected final String TEXT_671 = NL + "            pw_";
  protected final String TEXT_672 = ".println(\"\");";
  protected final String TEXT_673 = NL + "            pw_";
  protected final String TEXT_674 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_675 = NL + "            pw_";
  protected final String TEXT_676 = ".println(\"";
  protected final String TEXT_677 = "\");";
  protected final String TEXT_678 = NL + "    bw_";
  protected final String TEXT_679 = ".close();" + NL + "    pw_";
  protected final String TEXT_680 = ".close();";
  protected final String TEXT_681 = NL + "String command_";
  protected final String TEXT_682 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_683 = " + \"/\" + dbPwd_";
  protected final String TEXT_684 = " + \"@\" + serviceUrl_";
  protected final String TEXT_685 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_686 = " + \"' LOG='\" + logf_";
  protected final String TEXT_687 = " + \"'\";" + NL + "String printableCommand_";
  protected final String TEXT_688 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_689 = " + \"/\" + \"....\" + \"@\" + serviceUrl_";
  protected final String TEXT_690 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_691 = " + \"' LOG='\" + logf_";
  protected final String TEXT_692 = " + \"'\";" + NL;
  protected final String TEXT_693 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_694 = " = conn_";
  protected final String TEXT_695 = ".createStatement();";
  protected final String TEXT_696 = NL + "        log.info(\"";
  protected final String TEXT_697 = " - Creating temp table ";
  protected final String TEXT_698 = "\" + tableName_";
  protected final String TEXT_699 = " + \"";
  protected final String TEXT_700 = ".\" );";
  protected final String TEXT_701 = NL + "    stmtCreateTmp_";
  protected final String TEXT_702 = ".execute(\"";
  protected final String TEXT_703 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_704 = ".close();";
  protected final String TEXT_705 = NL + "        log.info(\"";
  protected final String TEXT_706 = " - Create temp table ";
  protected final String TEXT_707 = "\" + tableName_";
  protected final String TEXT_708 = " + \"";
  protected final String TEXT_709 = " has succeeded.\");" + NL + "        log.info(\"";
  protected final String TEXT_710 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_711 = " + \"'.\");";
  protected final String TEXT_712 = NL + "    final Process process_";
  protected final String TEXT_713 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_714 = ");";
  protected final String TEXT_715 = NL + "        java.util.ArrayList<String> envParam_";
  protected final String TEXT_716 = "=new java.util.ArrayList<String>();" + NL + "        java.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_717 = " = System.getenv();" + NL + "        for (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_718 = ".entrySet())" + NL + "        {" + NL + "           envParam_";
  protected final String TEXT_719 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "        }";
  protected final String TEXT_720 = NL + "        envParam_";
  protected final String TEXT_721 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_722 = "\");";
  protected final String TEXT_723 = NL + "        envParam_";
  protected final String TEXT_724 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_725 = "\");";
  protected final String TEXT_726 = NL + "            envParam_";
  protected final String TEXT_727 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_728 = "\");";
  protected final String TEXT_729 = NL + "        envParam_";
  protected final String TEXT_730 = ".add(\"";
  protected final String TEXT_731 = "=";
  protected final String TEXT_732 = "\");";
  protected final String TEXT_733 = NL + "        log.info(\"";
  protected final String TEXT_734 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_735 = " + \"'.\");";
  protected final String TEXT_736 = NL + "    final Process process_";
  protected final String TEXT_737 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_738 = ",envParam_";
  protected final String TEXT_739 = ".toArray(new String[0]));";
  protected final String TEXT_740 = NL + NL + "//System.out.println(command_";
  protected final String TEXT_741 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_742 = " = new Thread() {" + NL + "    public void run() {" + NL + "        try {" + NL + "            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_743 = ".getInputStream()));" + NL + "            String line = \"\";" + NL + "            try {" + NL + "                while((line = reader.readLine()) != null) {";
  protected final String TEXT_744 = NL + "                        System.out.println(line);";
  protected final String TEXT_745 = NL + "                        globalMap.put(\"";
  protected final String TEXT_746 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_747 = "_OUTPUT\") + \"\\n\" + line);";
  protected final String TEXT_748 = NL + "                }" + NL + "            } finally {" + NL + "                 reader.close();" + NL + "            }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_749 = NL + "            ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_750 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_751 = " = new Thread() {" + NL + "    public void run() {" + NL + "       try {" + NL + "           java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_752 = ".getErrorStream()));" + NL + "           String line = \"\";" + NL + "           try {" + NL + "               while((line = reader.readLine()) != null) {" + NL + "                  globalMap.put(\"";
  protected final String TEXT_753 = "_SQLLOAD_ERROR\", \"true\");";
  protected final String TEXT_754 = NL + "                       System.err.println(line);";
  protected final String TEXT_755 = NL + "                       globalMap.put(\"";
  protected final String TEXT_756 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_757 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_758 = NL + "               }" + NL + "            } finally {" + NL + "                reader.close();" + NL + "            }" + NL + "        } catch(java.io.IOException ioe) {";
  protected final String TEXT_759 = NL + "           ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_760 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_761 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_762 = " = process_";
  protected final String TEXT_763 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_764 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_765 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_766 = "_SQLLOAD_ERROR\"))) {" + NL + "    throw new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_767 = "\" , globalMap);" + NL + "}";
  protected final String TEXT_768 = NL + "    log.info(\"";
  protected final String TEXT_769 = " - Excute command: '\" + printableCommand_";
  protected final String TEXT_770 = " + \"' has finished.\");" + NL + "    log.info(\"";
  protected final String TEXT_771 = " - Retrieving information from oracle log file: '\" + logf_";
  protected final String TEXT_772 = " + \"'.\");";
  protected final String TEXT_773 = NL + NL + "int nb_line_data_";
  protected final String TEXT_774 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_775 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_776 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_777 = " = 0;" + NL + "" + NL + "/*  1.get log file all lines count" + NL + "    2.get \"Total logical records read\" line number from file end." + NL + "    3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "" + NL + "//1" + NL + "" + NL + "class LogUtil_";
  protected final String TEXT_778 = "{" + NL + "    public int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "        int number=0;" + NL + "        java.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "        String tempLine = br.readLine();" + NL + "        if(tempLine!=null){" + NL + "            String str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "            boolean isNumber= pattern.matcher(str_number).matches();" + NL + "            if(isNumber){" + NL + "                number = Integer.parseInt(str_number);" + NL + "            }" + NL + "        }" + NL + "        return number;" + NL + "    }" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithDirect(String logf) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tjava.util.List<String> logLineList = new java.util.ArrayList<String>();" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tlogLineList.add(tempLine);" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "" + NL + "\t\tboolean isFirstEmptyLine = true;//Is the first empty line of empty block" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tint beforeNumLine = 0;" + NL + "\t\tfor(int i=logLineList.size()-1; i>=0; i--)" + NL + "\t\t{" + NL + "\t\t\ttempLine = logLineList.get(i);" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t}\t" + NL + "\t\t\telse if (isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t\tif(emptyLineNum==3){" + NL + "\t\t\t\t\tbeforeNumLine = i+1;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t" + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i <= beforeNumLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}\t" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithoutDirect(String logf, String tableName) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tint countLines =0;//log file lines count" + NL + "\t\tint lastTableLine = 0;//Line Number of the last table name" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tcountLines++;" + NL + "\t\t\tif(tempLine.toUpperCase().indexOf(\"TABLE \"+(tableName).toUpperCase())>-1){" + NL + "\t\t\t\tlastTableLine = countLines;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "\t\t//need new instance to readLine ." + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i<= lastTableLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}" + NL + "\t\tboolean isNumber=false;" + NL + "\t\ttempLine = lr.readLine();" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tboolean isFirstEmptyLine = false;//Is the first empty line of empty block" + NL + "\t\tfor (int i=lastTableLine+2; i<= countLines; i++) {" + NL + "\t\t\ttempLine = lr.readLine();" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tif(emptyLineNum==2){" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\tcontinue;//skip rows now empty" + NL + "\t\t\t}else if (!isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "" + NL + "LogUtil_";
  protected final String TEXT_779 = " lu_";
  protected final String TEXT_780 = " = new LogUtil_";
  protected final String TEXT_781 = "();" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_782 = " = null;" + NL + "try {" + NL + "\tif(isDirect_";
  protected final String TEXT_783 = "){" + NL + "\t\tlr_";
  protected final String TEXT_784 = " = lu_";
  protected final String TEXT_785 = ".parseLogFileWithDirect(logf_";
  protected final String TEXT_786 = ");\t\t" + NL + "\t}\t\t" + NL + "\telse{" + NL + "\t\tlr_";
  protected final String TEXT_787 = " = lu_";
  protected final String TEXT_788 = ".parseLogFileWithoutDirect(logf_";
  protected final String TEXT_789 = ", tableName_";
  protected final String TEXT_790 = ");\t" + NL + "\t}" + NL + "" + NL + "\tnb_line_data_";
  protected final String TEXT_791 = " = lu_";
  protected final String TEXT_792 = ".getNumber(lr_";
  protected final String TEXT_793 = ");//get the number of data line" + NL + "\tnb_line_bad_";
  protected final String TEXT_794 = " = lu_";
  protected final String TEXT_795 = ".getNumber(lr_";
  protected final String TEXT_796 = ");//get the number of reject data line" + NL + "\tnb_line_discarded_";
  protected final String TEXT_797 = " = lu_";
  protected final String TEXT_798 = ".getNumber(lr_";
  protected final String TEXT_799 = ");//get the number of discarded data line" + NL + "\tnb_line_inserted_";
  protected final String TEXT_800 = " = nb_line_data_";
  protected final String TEXT_801 = " - nb_line_bad_";
  protected final String TEXT_802 = " - nb_line_discarded_";
  protected final String TEXT_803 = ";" + NL + "} finally {" + NL + "\tlr_";
  protected final String TEXT_804 = ".close();" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_805 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_806 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_807 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_808 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_809 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_810 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_811 = "_RETURN_CODE\", exitCode_";
  protected final String TEXT_812 = ");";
  protected final String TEXT_813 = NL + "    log.info(\"";
  protected final String TEXT_814 = " - Retrieved number of line: \" + nb_line_data_";
  protected final String TEXT_815 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_816 = " - Retrieved number of bad line: \" + nb_line_bad_";
  protected final String TEXT_817 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_818 = " - Retrieved number of inserted line: \" + nb_line_inserted_";
  protected final String TEXT_819 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_820 = " - Retrieved information from oracle log file: '\" + logf_";
  protected final String TEXT_821 = " + \"' finish.\");";
...
if(("true").equals(use_existing_ctl_file)) {
    ...
    stringBuffer.append(directValueStr);
