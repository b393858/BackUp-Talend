...
public class TSQLDWHConnectionBeginJava
{
  protected static String nl;
  public static synchronized TSQLDWHConnectionBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHConnectionBeginJava result = new TSQLDWHConnectionBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_33 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_34 = " ;";
  protected final String TEXT_35 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_36 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_37 = " ;";
  protected final String TEXT_38 = NL + "\t\tString port_";
  protected final String TEXT_39 = " = ";
  protected final String TEXT_40 = ";" + NL + "\t\tString dbname_";
  protected final String TEXT_41 = " = ";
  protected final String TEXT_42 = " ;" + NL + "    \tif (!\"\".equals(port_";
  protected final String TEXT_43 = ")) {" + NL + "    \t\turl_";
  protected final String TEXT_44 = " += \":\" + ";
  protected final String TEXT_45 = ";" + NL + "    \t}" + NL + "    \tif (!\"\".equals(dbname_";
  protected final String TEXT_46 = ")) {" + NL + "    \t\t";
  protected final String TEXT_47 = NL + "\t\t\t\turl_";
  protected final String TEXT_48 = " += \"//\" + ";
  protected final String TEXT_49 = "; ";
  protected final String TEXT_50 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_51 = " += \";databaseName=\" + ";
  protected final String TEXT_52 = "; ";
  protected final String TEXT_53 = NL + "    \t}" + NL + "\t\turl_";
  protected final String TEXT_54 = " += \";applicationName=Talend;\" + ";
  ...
  protected final String TEXT_173 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_174 = "\", ";
  protected final String TEXT_175 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_176 = "\",  ";
  protected final String TEXT_177 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_178 = "\",conn_";
  protected final String TEXT_179 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
