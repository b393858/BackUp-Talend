...
public class TSQLDWHCommitMainJava
{
  protected static String nl;
  public static synchronized TSQLDWHCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLDWHCommitMainJava result = new TSQLDWHCommitMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_80 = ".isClosed())" + NL + "\t{" + NL + "\t";
  protected final String TEXT_81 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_82 = NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t";
  protected final String TEXT_84 = NL + "\t\t}finally{" + NL + "\t\t\t";
