...
public class TNetezzaRowFinallyJava
{
  protected static String nl;
  public static synchronized TNetezzaRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaRowFinallyJava result = new TNetezzaRowFinallyJava();
    nl = null;
    return result;
  }
