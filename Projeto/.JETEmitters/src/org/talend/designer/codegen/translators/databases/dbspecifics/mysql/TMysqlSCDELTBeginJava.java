...
public class TMysqlSCDELTBeginJava {
  ...
  protected final String TEXT_66 = ".getTables(";
  protected final String TEXT_67 = ", null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_68 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_69 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_70 = " = rsTable_";
  protected final String TEXT_71 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_72 = ".equalsIgnoreCase(";
  protected final String TEXT_73 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_74 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_89 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_95 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_98 = ".executeUpdate(\"";
  protected final String TEXT_99 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_100 = ".close();";
  protected final String TEXT_101 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_104 = ".executeUpdate(\"";
  protected final String TEXT_105 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_106 = ".close();";
  protected final String TEXT_107 = NL + "        System.out.println(\"[";
  protected final String TEXT_108 = "] table action ";
  protected final String TEXT_109 = " done\\n\");";
  protected final String TEXT_110 = NL + "    ";
  protected final String TEXT_111 = NL + "        String updateForType1_";
  protected final String TEXT_112 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_113 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_114 = " + \"` t SET ";
  protected final String TEXT_115 = " WHERE ";
  protected final String TEXT_116 = " AND (";
  protected final String TEXT_117 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_118 = " = conn_";
  protected final String TEXT_119 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_120 = ".executeUpdate(updateForType1_";
  protected final String TEXT_121 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_122 = ".close();";
  protected final String TEXT_123 = NL + "            System.out.println(\"[";
  protected final String TEXT_124 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_125 = " + \"\\ndone\");";
  protected final String TEXT_126 = "        " + NL + "        String changeDateTime_";
  protected final String TEXT_127 = " = (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_128 = "\"))).toString();" + NL + "\t";
  protected final String TEXT_129 = NL + "        String changeDateTime_";
  protected final String TEXT_130 = "_begin = changeDateTime_";
  protected final String TEXT_131 = ";" + NL + "        String changeDateTime_";
  protected final String TEXT_132 = "_end = changeDateTime_";
  protected final String TEXT_133 = ";" + NL + "        ";
  protected final String TEXT_134 = NL + "\t\t        changeDateTime_";
  protected final String TEXT_135 = "_begin = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_136 = "\").getDateString(\"";
  protected final String TEXT_137 = "\",\"";
  protected final String TEXT_138 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_139 = "\"),";
  protected final String TEXT_140 = ");" + NL + "\t\t";
  protected final String TEXT_141 = NL + "        \t\tchangeDateTime_";
  protected final String TEXT_142 = "_end = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_143 = "\").getDateString(\"";
  protected final String TEXT_144 = "\",\"";
  protected final String TEXT_145 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_146 = "\"),";
  protected final String TEXT_147 = ");";
  protected final String TEXT_148 = NL + "        String updateForType2_";
  protected final String TEXT_149 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_150 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_151 = " + \"` t SET `";
  protected final String TEXT_152 = "` = '\" + (changeDateTime_";
  protected final String TEXT_153 = ") + \"'";
  protected final String TEXT_154 = ", `";
  protected final String TEXT_155 = "` = 0";
  protected final String TEXT_156 = " WHERE ";
  protected final String TEXT_157 = " AND (";
  protected final String TEXT_158 = ") AND d.`";
  protected final String TEXT_159 = "` IS NULL\"; " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_162 = ".executeUpdate(updateForType2_";
  protected final String TEXT_163 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_164 = ".close();";
  protected final String TEXT_165 = NL + "        \tString updateForType2_";
  protected final String TEXT_166 = "_debug = \"UPDATE `\" + tableName_";
  protected final String TEXT_167 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_168 = " + \"` t SET `";
  protected final String TEXT_169 = "` = '\" + (changeDateTime_";
  protected final String TEXT_170 = "_end) + \"'";
  protected final String TEXT_171 = ", `";
  protected final String TEXT_172 = "` = 0";
  protected final String TEXT_173 = " WHERE ";
  protected final String TEXT_174 = " AND (";
  protected final String TEXT_175 = ") AND d.`";
  protected final String TEXT_176 = "` IS NULL\"; " + NL + "            System.out.println(\"[";
  protected final String TEXT_177 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_178 = "_debug + \"\\ndone\");";
  protected final String TEXT_179 = NL + "        String insertForType2_";
  protected final String TEXT_180 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_181 = " + \"`(";
  protected final String TEXT_182 = ") SELECT t.";
  protected final String TEXT_183 = ", '\" + " + NL + "        (changeDateTime_";
  protected final String TEXT_184 = ") + \"', NULL";
  protected final String TEXT_185 = ", 1";
  protected final String TEXT_186 = ", d.`";
  protected final String TEXT_187 = "` + 1";
  protected final String TEXT_188 = " FROM `\" + " + NL + "        sourceTable_";
  protected final String TEXT_189 = " + \"` t, `\" + tableName_";
  protected final String TEXT_190 = " + \"` d WHERE ";
  protected final String TEXT_191 = " AND (";
  protected final String TEXT_192 = ") AND d.`";
  protected final String TEXT_193 = "` = '\" + (changeDateTime_";
  protected final String TEXT_194 = ") + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_195 = " = conn_";
  protected final String TEXT_196 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_197 = ".executeUpdate(insertForType2_";
  protected final String TEXT_198 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_199 = ".close();";
  protected final String TEXT_200 = NL + "\t\t\tString insertForType2_";
  protected final String TEXT_201 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_202 = " + \"`(";
  protected final String TEXT_203 = ") SELECT t.";
  protected final String TEXT_204 = ", '\" + (changeDateTime_";
  protected final String TEXT_205 = "_begin) + \"', NULL";
  protected final String TEXT_206 = ", 1";
  protected final String TEXT_207 = ", d.`";
  protected final String TEXT_208 = "` + 1";
  protected final String TEXT_209 = " FROM `\" + sourceTable_";
  protected final String TEXT_210 = " + \"` t, `\" + tableName_";
  protected final String TEXT_211 = " + \"` d WHERE ";
  protected final String TEXT_212 = " AND (";
  protected final String TEXT_213 = ") AND d.`";
  protected final String TEXT_214 = "` = '\" + (changeDateTime_";
  protected final String TEXT_215 = "_end) + \"'\";" + NL + "            System.out.println(\"[";
  protected final String TEXT_216 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_217 = "_debug + \"\\ndone\");";
  protected final String TEXT_218 = NL + "    String insert_";
  protected final String TEXT_219 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_220 = " + \"`(";
  protected final String TEXT_221 = ") SELECT t.";
  protected final String TEXT_222 = "\"";
  protected final String TEXT_223 = " + \", '\" + (changeDateTime_";
  ...
  protected final String TEXT_229 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_230 = " + \"` d ON ";
  protected final String TEXT_231 = " WHERE (";
  protected final String TEXT_232 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_235 = ".executeUpdate(insert_";
  protected final String TEXT_236 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_237 = ".close();";
  protected final String TEXT_238 = NL + "    \tString insert_";
  protected final String TEXT_239 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_240 = " + \"`(";
  protected final String TEXT_241 = ") SELECT t.";
  protected final String TEXT_242 = "\"";
  protected final String TEXT_243 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_244 = "_begin) + \"', NULL\"";
  protected final String TEXT_245 = " + \"";
  protected final String TEXT_246 = ", 1";
  protected final String TEXT_247 = ", 1";
  protected final String TEXT_248 = " FROM `\" + sourceTable_";
  protected final String TEXT_249 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_250 = " + \"` d ON ";
  protected final String TEXT_251 = " WHERE (";
  protected final String TEXT_252 = ")\";" + NL + "        System.out.println(\"[";
  protected final String TEXT_253 = "] new rows sql\\n\" + insert_";
  protected final String TEXT_254 = "_debug + \"\\ndone\");";
