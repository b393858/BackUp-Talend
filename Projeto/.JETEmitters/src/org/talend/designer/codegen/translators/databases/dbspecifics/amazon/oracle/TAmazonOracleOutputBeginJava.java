...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_50 = NL + "\t/* initialize feature count */" + NL + "\tint nbFeature_";
  protected final String TEXT_51 = " = 0;" + NL + "" + NL + "\tjava.util.Map<String, com.vividsolutions.jts.geom.Envelope> geometryColumnToExtends = new java.util.HashMap<String, com.vividsolutions.jts.geom.Envelope>();" + NL + "\t";
  ...
  protected final String TEXT_66 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_67 = " = 0;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_68 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_69 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_70 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_71 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_72 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_73 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_74 = " = null;" + NL + "" + NL + "//optional table" + NL + "String dbschema_";
  protected final String TEXT_75 = " = null;" + NL + "String tableName_";
  ...
  protected final String TEXT_84 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");" + NL + "\t\t";
  protected final String TEXT_85 = NL + "\t";
  protected final String TEXT_86 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");" + NL + "\t\t";
  ...
  protected final String TEXT_97 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_98 = " + \")(port=\" + ";
  protected final String TEXT_99 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_100 = " + \")))\";" + NL + "\t\t";
  protected final String TEXT_101 = NL + "\t    url_";
  protected final String TEXT_102 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_119 = ";" + NL + "    dbschema_";
  ...
  protected final String TEXT_125 = ");" + NL + "\t\tif(dbschema_";
  protected final String TEXT_126 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_127 = ")) //get schema from connection" + NL + "\t\t\t{" + NL + "\t\t\tdbschema_";
  protected final String TEXT_128 = "=conn_";
  protected final String TEXT_129 = ".getMetaData().getUserName();" + NL + "\t\t\t}" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_151 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_152 = "\", conn_";
  protected final String TEXT_153 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_154 = NL + "        conn_";
  protected final String TEXT_155 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_156 = " = ";
  protected final String TEXT_157 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_158 = " = 0;";
  protected final String TEXT_159 = NL + "   int batchSize_";
  protected final String TEXT_160 = " = ";
  protected final String TEXT_161 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_162 = "=0;";
  protected final String TEXT_163 = NL;
  protected final String TEXT_164 = NL + "int count_";
  protected final String TEXT_165 = "=0;";
  protected final String TEXT_166 = NL + NL + "if(dbschema_";
  protected final String TEXT_167 = " == null || dbschema_";
  protected final String TEXT_168 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";" + NL + "} else {" + NL + "    tableName_";
  ...
  protected final String TEXT_177 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_181 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_189 = ".commit();";
  protected final String TEXT_190 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_209 = NL + "            try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_229 = NL + "                    String keyCheckTable_";
  protected final String TEXT_230 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_231 = "+\"][\"+";
  protected final String TEXT_232 = "+\"][\"+";
  protected final String TEXT_233 = "+\"][\"+";
  protected final String TEXT_234 = "+\"][\"+";
  protected final String TEXT_235 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_236 = " + \"]\";";
  protected final String TEXT_237 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_238 = " = conn_";
  protected final String TEXT_239 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_240 = " + \"]\";";
  protected final String TEXT_241 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_242 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_243 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_244 = ")== null){//}";
  protected final String TEXT_245 = NL + "                                boolean whetherExist_";
  protected final String TEXT_246 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_247 = " = conn_";
  protected final String TEXT_248 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_261 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_262 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_266 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_267 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_268 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_295 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_314 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_315 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_316 = " = conn_";
  protected final String TEXT_317 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_318 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_319 = " = dbMetaData_";
  protected final String TEXT_320 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_321 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_322 = " == null || dbschema_";
  protected final String TEXT_323 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_330 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_350 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_351 = NL + "                                String tableForSearch_";
  protected final String TEXT_352 = " = ";
  protected final String TEXT_353 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_354 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_355 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_356 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_357 = " =  tableForSearch_";
  protected final String TEXT_358 = ".substring(1,tableForSearch_";
  protected final String TEXT_359 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_360 = " =  tableForSearch_";
  protected final String TEXT_361 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_362 = " = conn_";
  protected final String TEXT_363 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_364 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_365 = " = dbMetaData_";
  protected final String TEXT_366 = ".getTables(null, conn_";
  protected final String TEXT_367 = ".getSchema(), tableForSearch_";
  protected final String TEXT_368 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_369 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_370 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_371 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_372 = " = conn_";
  protected final String TEXT_373 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_374 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_375 = " = dbMetaData_";
  protected final String TEXT_376 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_377 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_378 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_379 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_380 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_381 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_382 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_383 = " = conn_";
  protected final String TEXT_384 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_385 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_386 = " = dbMetaData_";
  protected final String TEXT_387 = ".getTables(";
  protected final String TEXT_388 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_395 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_396 = " = conn_";
  protected final String TEXT_397 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_398 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_399 = " = dbMetaData_";
  protected final String TEXT_400 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_407 = NL + "                                if(!whetherExist_";
  protected final String TEXT_408 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_416 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_417 = ".";
  protected final String TEXT_418 = ", \"";
  protected final String TEXT_419 = "\")";
  protected final String TEXT_420 = ".toUpperCase()";
  ...
  protected final String TEXT_428 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_441 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_442 = " = conn_";
  protected final String TEXT_443 = ".createStatement()) {";
  protected final String TEXT_444 = NL + "                                                  stmtCreate_";
  protected final String TEXT_445 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_446 = "));";
  protected final String TEXT_447 = NL + "                                        stmtCreate_";
  protected final String TEXT_448 = ".execute(((\"";
  protected final String TEXT_449 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_460 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_461 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_462 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_466 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_467 = "));";
  protected final String TEXT_468 = NL + "                stmtClear_";
  protected final String TEXT_469 = ".executeUpdate(\"";
  protected final String TEXT_470 = "\");";
  protected final String TEXT_471 = NL + "            }";
  protected final String TEXT_472 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_473 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_474 = " = conn_";
  protected final String TEXT_475 = ".createStatement()) {";
  protected final String TEXT_476 = NL + "                              stmtTruncCount_";
  protected final String TEXT_477 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_478 = "));";
  protected final String TEXT_479 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_480 = " = stmtTruncCount_";
  protected final String TEXT_481 = ".executeQuery(\"";
  protected final String TEXT_482 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_483 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_484 = " = rsTruncCount_";
  protected final String TEXT_485 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_486 = " = conn_";
  protected final String TEXT_487 = ".createStatement()) {";
  protected final String TEXT_488 = NL + "                              stmtTrunc_";
  protected final String TEXT_489 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_490 = "));";
  protected final String TEXT_491 = NL + "                conn_";
  protected final String TEXT_492 = ".commit();";
  protected final String TEXT_493 = NL + "                stmtTrunc_";
  protected final String TEXT_494 = ".executeUpdate(\"";
  protected final String TEXT_495 = "\");";
  protected final String TEXT_496 = NL + "                    if(!conn_";
  protected final String TEXT_497 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_498 = ".commit();" + NL + "                    }";
  protected final String TEXT_499 = NL + "                deletedCount_";
  protected final String TEXT_500 = " += rsTruncCountNumber_";
  protected final String TEXT_501 = ";" + NL + "            }";
  protected final String TEXT_502 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_518 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_532 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_543 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_544 = " = new StringBuffer(update_";
  protected final String TEXT_545 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_546 = ".insert(update_";
  protected final String TEXT_547 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_548 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_549 = " =updateStringBuffer_";
  ...
  protected final String TEXT_559 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_560 = " + \" WHERE ";
  protected final String TEXT_561 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_568 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_569 = " = new StringBuffer(insert_";
  protected final String TEXT_570 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_571 = ".insert(insert_";
  protected final String TEXT_572 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_573 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_574 = " =insertStringBuffer_";
  protected final String TEXT_575 = ".toString(); ";
  protected final String TEXT_576 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_577 = " = conn_";
  protected final String TEXT_578 = ".prepareStatement(insert_";
  protected final String TEXT_579 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_580 = "\", pstmtInsert_";
  ...
  protected final String TEXT_594 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_595 = " = conn_";
  protected final String TEXT_596 = ".prepareStatement(update_";
  protected final String TEXT_597 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_616 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  ...
  protected final String TEXT_631 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_649 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_686 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_687 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_688 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_689 = " = true;" + NL + "    \t";
  protected final String TEXT_690 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_691 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_692 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_693 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_694 = " clobTypeUtil_";
  protected final String TEXT_695 = "=new ClobTypeUtil_";
  protected final String TEXT_696 = "();";
  protected final String TEXT_697 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_698 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_699 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_700 = " =null;" + NL + "\t";
  protected final String TEXT_701 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_705 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_706 = " =  null;";
  protected final String TEXT_707 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_708 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_709 = " = null;";
  protected final String TEXT_710 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_711 = " = null;";
  protected final String TEXT_712 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_713 = " = null;";
  protected final String TEXT_714 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_715 = " = null;";
  protected final String TEXT_716 = NL + "\t\t \tString[] insertSQLSplits_";
