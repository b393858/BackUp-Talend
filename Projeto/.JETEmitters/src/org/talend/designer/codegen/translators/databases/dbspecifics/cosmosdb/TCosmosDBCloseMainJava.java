...
public class TCosmosDBCloseMainJava
{
  protected static String nl;
  public static synchronized TCosmosDBCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCosmosDBCloseMainJava result = new TCosmosDBCloseMainJava();
    nl = null;
    return result;
  }
