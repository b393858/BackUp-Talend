...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_209 = NL + "\tint nb_bucket_";
  protected final String TEXT_210 = " = 0;" + NL + "\t";
  protected final String TEXT_211 = NL + "\t\tlog.info(\"";
  protected final String TEXT_212 = " - Retrieving buckets from the server.\");" + NL + "\t";
  protected final String TEXT_213 = NL + "\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".listBuckets();" + NL + "\t";
  protected final String TEXT_216 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_217 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_218 = " : buckets_";
  protected final String TEXT_219 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_220 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_221 = " = bucket_";
  protected final String TEXT_222 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_223 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
  protected final String TEXT_224 = ");" + NL + "\t\t";
  protected final String TEXT_225 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_226 = " - Retrieving the bucket \" + nb_bucket_";
  protected final String TEXT_227 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_228 = " - Name of current bucket : \" + currentBucketName_";
