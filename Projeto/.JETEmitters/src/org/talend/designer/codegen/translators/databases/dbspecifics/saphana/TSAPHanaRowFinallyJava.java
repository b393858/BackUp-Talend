...
public class TSAPHanaRowFinallyJava
{
  protected static String nl;
  public static synchronized TSAPHanaRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaRowFinallyJava result = new TSAPHanaRowFinallyJava();
    nl = null;
    return result;
  }
