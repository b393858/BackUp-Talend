...
package fiap.mongo_bands_to_file_0_1;
...
/**
 * Job: mongo_bands_to_file Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class mongo_bands_to_file implements TalendJob {
	...
	private final String jobName = "mongo_bands_to_file";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					mongo_bands_to_file.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(mongo_bands_to_file.this, new Object[] {
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_FIAP_mongo_bands_to_file = new byte[0];
		static byte[] commonByteArray_FIAP_mongo_bands_to_file = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FIAP_mongo_bands_to_file.length) {
					if (length < 1024
							&& commonByteArray_FIAP_mongo_bands_to_file.length == 0) {
						commonByteArray_FIAP_mongo_bands_to_file = new byte[1024];
					} else {
						commonByteArray_FIAP_mongo_bands_to_file = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FIAP_mongo_bands_to_file, 0,
						length);
				strReturn = new String(
						commonByteArray_FIAP_mongo_bands_to_file, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FIAP_mongo_bands_to_file) {
				...
				try {
					...
					this.banda = readString(dis);

					this.instrumento = readString(dis);

					this.nascimento = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.banda, dos);

				// String

				writeString(this.instrumento, dos);

				// String

				writeString(this.nascimento, dos);
		...
		public String toString() {
			...
			sb.append(",instrumento=" + instrumento);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"/Applications/Talend/workspace/bandas_bkp_"
				...
				pathMap_tMongoDBInput_1.put("nome", "");
				pathMap_tMongoDBInput_1.put("banda", "");
				pathMap_tMongoDBInput_1.put("instrumento", "");
				pathMap_tMongoDBInput_1.put("nascimento", "");
				pathMap_tMongoDBInput_1.put("periodo", "");
				...
				while (cursor_tMongoDBInput_1.hasNext()) {
					...
					valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
							.getValue(pathMap_tMongoDBInput_1.get("nome"),
									"nome", o_tMongoDBInput_1);
					if (valueObj_tMongoDBInput_1 != null
							&& valueObj_tMongoDBInput_1.toString().length() > 0) {
						row1.nome = valueObj_tMongoDBInput_1.toString();
					} else {
						row1.nome = null;
					}
					valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
							.getValue(pathMap_tMongoDBInput_1.get("banda"),
									"banda", o_tMongoDBInput_1);
					if (valueObj_tMongoDBInput_1 != null
							&& valueObj_tMongoDBInput_1.toString().length() > 0) {
						row1.banda = valueObj_tMongoDBInput_1.toString();
					} else {
						row1.banda = null;
					}
					valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
							.getValue(
									pathMap_tMongoDBInput_1.get("instrumento"),
									"instrumento", o_tMongoDBInput_1);
					if (valueObj_tMongoDBInput_1 != null
							&& valueObj_tMongoDBInput_1.toString().length() > 0) {
						row1.instrumento = valueObj_tMongoDBInput_1.toString();
					} else {
						row1.instrumento = null;
					}
					valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
							.getValue(
									pathMap_tMongoDBInput_1.get("nascimento"),
									"nascimento", o_tMongoDBInput_1);
					if (valueObj_tMongoDBInput_1 != null
							&& valueObj_tMongoDBInput_1.toString().length() > 0) {
						row1.nascimento = valueObj_tMongoDBInput_1.toString();
					} else {
						row1.nascimento = null;
					}
					valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
							.getValue(pathMap_tMongoDBInput_1.get("periodo"),
									"periodo", o_tMongoDBInput_1);
					if (valueObj_tMongoDBInput_1 != null
							&& valueObj_tMongoDBInput_1.toString().length() > 0) {
						row1.periodo = valueObj_tMongoDBInput_1.toString();
					} else {
						row1.periodo = null;
					}
					...
					row2._id = row1._id;
					row2.nome = row1.nome;
					row2.banda = row1.banda;
					row2.instrumento = row1.instrumento;
					row2.nascimento = row1.nascimento;
					row2.periodo = row1.periodo;
					...
					if (row2._id != null) {
						sb_tFileOutputDelimited_1.append(row2._id);
					}
					sb_tFileOutputDelimited_1
							.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.nome != null) {
						sb_tFileOutputDelimited_1.append(row2.nome);
					}
					sb_tFileOutputDelimited_1
							.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.banda != null) {
						sb_tFileOutputDelimited_1.append(row2.banda);
					}
					sb_tFileOutputDelimited_1
							.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.instrumento != null) {
						sb_tFileOutputDelimited_1.append(row2.instrumento);
					}
					sb_tFileOutputDelimited_1
							.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.nascimento != null) {
						sb_tFileOutputDelimited_1.append(row2.nascimento);
					}
					sb_tFileOutputDelimited_1
							.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.periodo != null) {
						sb_tFileOutputDelimited_1.append(row2.periodo);
					}
					sb_tFileOutputDelimited_1
	...
	public static void main(String[] args) {
		final mongo_bands_to_file mongo_bands_to_fileClass = new mongo_bands_to_file();

		int exitCode = mongo_bands_to_fileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = mongo_bands_to_file.class
					.getClassLoader().getResourceAsStream(
							"fiap/mongo_bands_to_file_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = mongo_bands_to_file.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : mongo_bands_to_file");
		}
...
/************************************************************************************************
 * 66909 characters generated by Talend Open Studio for Big Data on the
 * September 16, 2019 7:00:56 PM BRT
 ************************************************************************************************/
