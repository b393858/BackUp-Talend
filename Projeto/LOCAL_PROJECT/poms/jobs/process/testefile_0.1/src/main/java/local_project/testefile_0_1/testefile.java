...
package local_project.testefile_0_1;
...
/**
 * Job: testefile Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class testefile implements TalendJob {
	...
	private final String jobName = "testefile";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(testefile.this, new Object[] { e,
	...
	public void tFileUnarchive_1_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFileUnarchive_1Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String zipFileURL_tFileUnarchive_1 = "/Users/leandro.mendes/tempfiles/saida/saida.gz";
				String tmpFileURL_tFileUnarchive_1 = zipFileURL_tFileUnarchive_1
						.toLowerCase();
				String outputPath_tFileUnarchive_1 = "/Applications/Talend/workspace";
				...
				if (tmpFileURL_tFileUnarchive_1.endsWith(".tar.gz")
					...
					try {
						...
						util_tFileUnarchive_1.output(
								outputPath_tFileUnarchive_1,
								filename_tFileUnarchive_1, is_tFileUnarchive_1);
					} catch (Exception e) {
						System.err.println(e.getMessage());
					} finally {
						if (zip_tFileUnarchive_1 != null) {
	...
	public static void main(String[] args) {
		final testefile testefileClass = new testefile();

		int exitCode = testefileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testefile.class.getClassLoader()
					.getResourceAsStream(
							"local_project/testefile_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = testefile.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : testefile");
		}
...
/************************************************************************************************
 * 29338 characters generated by Talend Open Studio for Big Data on the August
 * 23, 2019 9:08:28 PM BRT
 ************************************************************************************************/
